...
func TestTypedOpen(t *testing.T){
 ...
 if n:=testing.AllocsPerRun(50,func(){block.Open(nil,0)});n!=0{t.Fatalf("refused block open allocated %v",n)}
 ...
 if n:=testing.AllocsPerRun(50,func(){cook.Open(nil,0)});n!=0{t.Fatalf("refused cook open allocated %v",n)}
