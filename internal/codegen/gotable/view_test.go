...
func TestUnitViewPacketStorage(t *testing.T) {
 ...
 if desc.Fields[0].Offset!=uint32(unsafe.Offsetof(Packet{}.Nested))||desc.Fields[0].Id!=0||desc.Fields[0].Json!=""||desc.SaveBody!=nil||desc.LoadBody!=nil||desc.SaveMessageBody!=nil{t.Fatal("outside packet gained wire identity or codec")}
