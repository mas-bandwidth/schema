...
// emitTagEnum emits a union's tag set. docs is each arm's doc comment (SPEC
// §4.1), parallel to members: it reaches the tag's member as a line comment,
// the one place the arm is a declaration of its own.
