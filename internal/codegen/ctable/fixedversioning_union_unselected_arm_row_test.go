...
// promises. THIS ROW'S CONTENT IS THE ASSERTION IT REFUSES TO MAKE: it does not
// compare pick.beta or pick.gamma. THIS LEG OVERLAYS ITS ARMS — a real C union
// has no other arm to reset — so the question the row asks cannot even be put to
// this leg, and INDETERMINATE is the ruling word for it; whatever this leg does
// with an unselected arm is lawful. A reader who "completes" this test by
