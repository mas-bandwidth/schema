...
func (g *tableGen) retainMapIndex() string {
	if g.retain {
		return "retention=table_retain_index(retention,(uint32_t)(fill.value->count-1));"
	}
	return ""
}
