...
// pick.gamma.p == 0 reversed a ruling and should read the issue first. That JS
// happens to leave the caller's bytes is an OBSERVATION AND NOT A GUARANTEE, and
// nothing may be relied on it.
