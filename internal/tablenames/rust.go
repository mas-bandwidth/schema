...
func init() {
	define(Rust,
		Name{Name: "TableSpan", What: "the worker slab span", Scoped: true},
		Name{Name: "TableSlabs", What: "the worker slab allocator", Scoped: true},
		Name{Name: "TableRegionAlignment", What: "the unit native region alignment", RustConst: true},
		Name{Name: "TableReadView", What: "the attribution-free Rust region view"},
		Name{Name: "TableDecodeBuilder", What: "the Rust builder load runtime", Scoped: true},
		Name{Name: "TableGraphDecodeBuilder", What: "the Rust builder load runtime", Scoped: true},
		Name{Name: "TableGraphLoadBuilder", What: "the Rust builder load runtime", Scoped: true},
		Name{Name: "TableStorageWord", What: "the Rust builder load runtime"},

		Name{Name: "TableMapEntry", What: "the Rust map runtime"},
		Name{Name: "TableMapEntryRef", What: "the Rust map runtime"},
		Name{Name: "TableMapKey", What: "the Rust map runtime"},
		Name{Name: "TableMapView", What: "the Rust map runtime"},
		Name{Name: "TableJsonReadMap", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableJsonWriteMap", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapEntryKey", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapInteger", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapKeyFits", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapKeyRead", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapLoad", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapOrder", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapReadKey", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableMapSetKey", What: "the Rust map runtime", Scoped: true},
		Name{Name: "TableOwnedKey", What: "the Rust map runtime", Scoped: true},

		Name{Name: "TableSequenceSize", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TableJsonReadSequence", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TableJsonWriteSequence", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TablePack", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TablePackField", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TablePackRecord", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TablePackScalar", What: "the Rust container pack and text runtime", Scoped: true},
		Name{Name: "TableElementRef", What: "the Rust container runtime"},
		Name{Name: "TableExtent", What: "the Rust container runtime"},
		Name{Name: "TableListView", What: "the Rust container runtime"},
		Name{Name: "TableSequenceInfo", What: "the Rust container runtime"},
		Name{Name: "TableSequenceAllocation", What: "the Rust container runtime"},
		Name{Name: "TableSequenceCursor", What: "the Rust container runtime"},
		Name{Name: "TableSequenceExtent", What: "the Rust container runtime", Scoped: true},
		Name{Name: "TableSequenceSave", What: "the Rust container runtime", Scoped: true},
		Name{Name: "TableSequenceLoad", What: "the Rust container runtime", Scoped: true},
		Name{Name: "TableSequenceSegment", What: "the Rust container runtime", Scoped: true},
		Name{Name: "TableString", What: "the opaque UTF-8 blob header"},
		Name{Name: "TableBlobExtent", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableBlobId", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableBlobInfo", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableBytesTableType", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableJsonReadBlob", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableNodeLoadExtent", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableStringTableType", What: "the Rust blob runtime", Scoped: true},
		Name{Name: "TableRef", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableRecord", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableArena", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableBuilder", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableRegion", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableOwnedRegion", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableContext", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableNumbering", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableLoadSize", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableLoadError", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableNodeDirEntry", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableRefuseReason", What: "the Rust arena and region wire runtime"},
		Name{Name: "TableAlign", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableAllocation", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableGraphFromJson", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableGraphLoad", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableGraphLoadMeasure", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableGraphToJson", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableGraphWrite", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableInfo", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonGraphOut", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonLabel", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonReadContext", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonReadPointer", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonReadTableKeys", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonWriteContext", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableJsonWritePointer", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableNumberedNode", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableSource", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableNodeMap", What: "the Rust arena and region wire runtime", Scoped: true},
		Name{Name: "TableNodeScan", What: "the Rust arena and region wire runtime", Scoped: true},
		...
		Name{Name: "TableJsonWriteStringContent", What: "the shared JSON character escape writer", Scoped: true},
		Name{Name: "TableJsonReadWide", What: "the exact wide numeric text conversion", Scoped: true},
		Name{Name: "TableJsonWideLoad", What: "the exact wide numeric text conversion", Scoped: true},
		Name{Name: "TableJsonWideSigned", What: "the exact wide numeric text conversion", Scoped: true},
		Name{Name: "TableJsonWriteWide", What: "the exact wide numeric text conversion", Scoped: true},
