...
func init() {
	define(Rust,
		...
		Name{Name: "Announce", What: "the Rust message runtime", Scoped: true},
		Name{Name: "AnnounceMeasure", What: "the Rust message runtime", Scoped: true},
		Name{Name: "AnnounceRead", What: "the Rust message runtime", Scoped: true},
