...
func init() {
	define(Rust,
		Name{Name: "TableMessageReason", What: "the Rust message connection and bit stream"},
		Name{Name: "TableMessageError", What: "the Rust message connection and bit stream"},
		Name{Name: "TableMessageShape", What: "the Rust message connection and bit stream"},
		Name{Name: "TableMessageEntry", What: "the Rust message connection and bit stream"},
		Name{Name: "TableVocabulary", What: "the Rust message connection and bit stream"},
		Name{Name: "TableBitWriter", What: "the Rust message connection and bit stream"},
		Name{Name: "TableBitReader", What: "the Rust message connection and bit stream"},
		Name{Name: "TableMessageBatchWrite", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageBits", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageBlobSlots", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageNodeSlot", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageQuantize", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageQuantization", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageReport", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageSequenceSave", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageValue", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageWriteFixed", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageWriteGraph", What: "the Rust message runtime", Scoped: true},
		Name{Name: "TableMessageEntries", What: "the unit compiled message vocabulary", RustConst: true},
		Name{Name: "TableMessageRefBits", What: "the unit compiled message vocabulary", RustConst: true},
		Name{Name: "TableAnnouncement", What: "the unit compiled message vocabulary", RustConst: true},
