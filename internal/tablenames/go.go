...
func init() {
	define(Go,
		Name{Name: "TableRefuseReason", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseOk", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseNotACook", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseForeignOrder", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseWrongBuildVersion", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseReservedNotZero", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseBadAlignment", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseTruncated", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseUnalignedBase", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseBadLayout", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseUnknownForm", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseCountOverLength", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseCountOverExtentCap", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseBlobOverSizeCap", What: "typed file and accelerator refusal errors"},
		Name{Name: "TableRefuseDataCycle", What: "typed file and accelerator refusal errors"},
		...
		Name{Name: "tableRetainMessageMinimum", What: "the bounded retention codec family"},
		Name{Name: "TableRetain", What: "the bounded retention codec family"},
		Name{Name: "TableRetainId", What: "the bounded retention codec family"},
		Name{Name: "TableRetainIds", What: "the bounded retention codec family"},
		Name{Name: "TableRetainReader", What: "the bounded retention codec family"},
		Name{Name: "TableRetainWriter", What: "the bounded retention codec family"},
		Name{Name: "tableMessageLoadIntoRetain", What: "the bounded retention codec family"},
		Name{Name: "tableMessageRegionIntoRetain", What: "the bounded retention codec family"},
		Name{Name: "tableNodeMeasureRetain", What: "the bounded retention codec family"},
		Name{Name: "tableNodeWriteRetain", What: "the bounded retention codec family"},
		Name{Name: "tableRegionLoadRetain", What: "the bounded retention codec family"},
		Name{Name: "tableRegionSaveRetain", What: "the bounded retention codec family"},
		Name{Name: "tableRetainIn", What: "the bounded retention codec family"},
		Name{Name: "tableRetainKnown", What: "the bounded retention codec family"},
		Name{Name: "tableRetainOut", What: "the bounded retention codec family"},
		Name{Name: "tableRetainPath", What: "the bounded retention codec family"},
		Name{Name: "tableRetainPathDepth", What: "the bounded retention codec family"},
		Name{Name: "tableRetainPlainReader", What: "the bounded retention codec family"},
		Name{Name: "tableRetainRecordSize", What: "the bounded retention codec family"},
		Name{Name: "tableRetainStep", What: "the bounded retention codec family"},
		Name{Name: "tableRetainTail", What: "the bounded retention codec family"},
		...
		Name{Name: "tableMessageRecordScan", What: "the message region scan"},
		Name{Name: "tableMessageRecord", What: "the message region scan"},
		Name{Name: "tableMessageNodeOpen", What: "the message region scan"},
		Name{Name: "tableMessageMapReadKey", What: "the message region scan"},
		Name{Name: "tableMessageLoadInto", What: "the message region scan"},
		Name{Name: "tableMessageHasExtent", What: "the message region scan"},
		Name{Name: "tableMessageFieldHasExtent", What: "the message region scan"},
		Name{Name: "tableMessageExtentValue", What: "the message region scan"},
		Name{Name: "tableMessageExtentField", What: "the message region scan"},
		Name{Name: "tableMessageExtentBody", What: "the message region scan"},
		Name{Name: "tableMessageExtent", What: "the message region scan"},
		Name{Name: "tableMessageBodyStorage", What: "the message region scan"},
		Name{Name: "Announce", What: "the announced message bit codec"},
		Name{Name: "AnnounceMeasure", What: "the announced message bit codec"},
		Name{Name: "AnnounceRead", What: "the announced message bit codec"},
		Name{Name: "TableBitReader", What: "the announced message bit codec"},
		Name{Name: "TableBitWriter", What: "the announced message bit codec"},
		Name{Name: "TableMessageBatchMax", What: "the announced message bit codec"},
		Name{Name: "TableMessageEntriesHere", What: "the announced message bit codec"},
		Name{Name: "TableMessageEntry", What: "the announced message bit codec"},
		Name{Name: "TableMessageReader", What: "the announced message bit codec"},
		Name{Name: "TableMessageRefBitsHere", What: "the announced message bit codec"},
		Name{Name: "TableMessageShape", What: "the announced message bit codec"},
		Name{Name: "TableMessageWriter", What: "the announced message bit codec"},
		Name{Name: "TableVocabulary", What: "the announced message bit codec"},
		Name{Name: "tableAnnounceRead", What: "the announced message bit codec"},
		Name{Name: "tableAnnouncement", What: "the announced message bit codec"},
		Name{Name: "tableMessageBatchClose", What: "the announced message bit codec"},
		Name{Name: "tableMessageBatchOpen", What: "the announced message bit codec"},
		Name{Name: "tableMessageBits", What: "the announced message bit codec"},
		Name{Name: "tableMessageCount", What: "the announced message bit codec"},
		Name{Name: "tableMessageEntries", What: "the announced message bit codec"},
		Name{Name: "tableMessageEntryRead", What: "the announced message bit codec"},
		Name{Name: "tableMessageKindBits", What: "the announced message bit codec"},
		Name{Name: "tableMessageKnownKind", What: "the announced message bit codec"},
		Name{Name: "tableMessageNameSlot", What: "the announced message bit codec"},
		Name{Name: "tableMessageReadScalar", What: "the announced message bit codec"},
		Name{Name: "tableMessageRefuse", What: "the announced message bit codec"},
		Name{Name: "tableMessageShapeRead", What: "the announced message bit codec"},
		Name{Name: "tableMessageSkip", What: "the announced message bit codec"},
		Name{Name: "tableMessageSkipBody", What: "the announced message bit codec"},
		Name{Name: "tableMessageWriteScalar", What: "the announced message bit codec"},
		...
		Name{Name: "tableRegionMeasureReason", What: "typed file and authoring refusal reasons"},
		Name{Name: "tableRegionPackMeasureReason", What: "typed file and authoring refusal reasons"},
		Name{Name: "tableWireNodeBytesReason", What: "typed file and authoring refusal reasons"},
		Name{Name: "tableCookRegionReason", What: "typed file and authoring refusal reasons"},
		...
		Name{Name: "TableFixedHeaderBytes", What: "the fixed form's pinned header: sixteen bytes, the body at 16 (§3)"},
		Name{Name: "TableFixedHashAt", What: "the fixed form's pinned header: the layout hash at offset 8 (§3)"},
		...
		Name{Name: "tableFixedCount", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedText", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedOrdinal", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedWiden", What: "the fixed form (form 3)"},
		...
		Name{Name: "tableFixedNoGuard", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedEntryBytes", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPlan", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedWidens", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedSignedKind", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedKindKnown", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedRuns", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedArgWidth", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedTagAt", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedSrcEnd", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedRemapMax", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedBuildPlan", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPut8", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPut16", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPut32", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPut64", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPutF32", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPutF64", What: "the fixed form (form 3)"},
		...
		Name{Name: "tableFixedSubtree", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedUnionArmBytes", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedTagBytes", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedParseLayout", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedCompiler", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedPush", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedLayTable", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedMatchChildren", What: "the fixed form (form 3)"},
		Name{Name: "tableFixedCompileEntry", What: "the fixed form (form 3)"},
