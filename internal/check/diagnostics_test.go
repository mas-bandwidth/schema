...
func TestDiagnostics(t *testing.T) {
	cases := []struct {
		...
		{name: "a union declaration's qualification carries tags and nothing else", want: "this line takes no valued key at all",
			src: "package t\nunion U | max = 4\n{\n    a bool\n}\n"},
		{name: "a payload-free arm's qualification carries tags and nothing else", want: "this line takes no valued key at all",
			src: "package t\nunion U\n{\n    a | json = \"x\"\n}\n"},
		{name: "an enum variant's qualification carries tags and nothing else", want: "this line takes no valued key at all",
			src: "package t\nenum E\n{\n    A | max = 4\n}\n"},
		{name: "a flags variant's qualification carries tags and nothing else", want: "this line takes no valued key at all",
			src: "package t\nflags F\n{\n    A | max = 4\n}\n"},
		...
		{name: "a table declaration's qualification carries tags and nothing else", want: "this line takes no valued key at all",
			src: "package t\ntable T | json = \"t\"\n{\n    x int32\n}\n"},
