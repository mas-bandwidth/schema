...
func TestDiagnostics(t *testing.T) {
	cases := []struct {
		...
		{name: "union payload is an enum", want: "wrap the value in a type",
			src: "package t\nunion U {\n    e E\n}\nenum E { A }\n"},
		{name: "union payload is a message", want: "a message is not a union payload in v1",
			src: "package t\nunion U {\n    m M\n}\nmessage M { }\n"},
		...
		{name: "a union on a table-closure path", want: "may not sit on a table-closure path in v1",
			src: "package t\ntable T { u U }\nunion U { }\n"},
		{name: "a union named Message in a unit with messages", want: "generated message dispatch surface",
			src: "package t\nmessage Msg { }\nunion Message { }\n"},
