    ...
    public static partial class Schema
    {
        ...
        public static TableTypeInfo WeaponConfigTableType()
        {
            ...
            info.Fields = new TableFieldInfo[]
            {
                ...
                new TableFieldInfo { Name = "effect", Json = "effect", TypeName = "Effect", Id = 0x36c1c83b51f24394, Kind = 15, IsArray = false, Counted = false, Optional = false, ArrayBound = 0, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = 2, EnumName = delegate(ulong v) { switch (v) { case 0: return "None"; case 1: return "buff"; case 2: return "debuff"; default: return "???"; } }, VariantId = delegate(ulong v) { switch (v) { case 0: return (ulong)0; case 1: return (ulong)0xffb5be9be2e469cc; case 2: return (ulong)0x13cdc5ede73d2fd7; default: return (ulong)0; } }, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = new TableUnionInfo { GetTag = delegate(object o) { return (ulong)((Effect)o).Type; }, SetTag = delegate(object o, ulong t) { ((Effect)o).Type = unchecked((EffectType)t); }, Arms = new TableUnionArmInfo[] { new TableUnionArmInfo(), new TableUnionArmInfo { TableRef = delegate { return BuffTableType(); }, Payload = delegate(object o) { return ((Effect)o).Buff; } }, new TableUnionArmInfo { TableRef = delegate { return DebuffTableType(); }, Payload = delegate(object o) { return ((Effect)o).Debuff; } } } }, Doc = TableDocNone, NumTags = 0, Tags = null, GetChild = delegate(object o, int i) { return ((WeaponConfig)o).Effect; }, ResetField = delegate(object o) { var value = (WeaponConfig)o; value.Effect.Type = EffectType.None; } },
            };
