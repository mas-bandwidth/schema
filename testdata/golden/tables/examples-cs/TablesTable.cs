...
namespace Tabledemo
{
    ...
    public static partial class Schema
    {
        ...
        public static TableTypeInfo LoadoutConfigTableType()
        {
            ...
            info.Fields = new TableFieldInfo[]
            {
                new TableFieldInfo { Name = "grade", Json = "grade", TypeName = "Grade", Id = 0x32a89b2977c48ad4, Kind = 30, IsArray = false, Counted = false, Optional = false, ArrayBound = 0, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = 3, EnumName = delegate(ulong v) { return EnumNameGrade(v); }, VariantId = delegate(ulong v) { ulong id; TableEnumId((Grade)v, out id); return id; }, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetRaw = delegate(object o, int i) { return (ulong)((LoadoutConfig)o).Grade; }, SetRaw = delegate(object o, int i, ulong r) { ((LoadoutConfig)o).Grade = unchecked((Grade)r); }, MessageSlot = 20, NativeOffset = 0, NativeElementSize = 1, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; value.Grade = Grade.Silver; }, DefaultRaw = (ulong)Grade.Silver },
                new TableFieldInfo { Name = "grades", Json = "grades", TypeName = "Grade", Id = 0xd90a4e7682f799c5, Kind = 30, IsArray = true, Counted = true, Optional = false, ArrayBound = 4, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = 3, EnumName = delegate(ulong v) { return EnumNameGrade(v); }, VariantId = delegate(ulong v) { ulong id; TableEnumId((Grade)v, out id); return id; }, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetRaw = delegate(object o, int i) { return (ulong)((LoadoutConfig)o).Grades[i]; }, SetRaw = delegate(object o, int i, ulong r) { ((LoadoutConfig)o).Grades[i] = unchecked((Grade)r); }, GetCount = delegate(object o) { return ((LoadoutConfig)o).GradesCount; }, SetCount = delegate(object o, int n) { ((LoadoutConfig)o).GradesCount = n; }, MessageSlot = 21, NativeOffset = 1, NativeElementSize = 1, NativeCountOffset = 8, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; Array.Clear(value.Grades, 0, value.Grades.Length); value.GradesCount = 0; }, DefaultRaw = (ulong)Grade.None },
                new TableFieldInfo { Name = "podium", Json = "podium", TypeName = "Grade", Id = 0xb46ff45a23d72549, Kind = 30, IsArray = true, Counted = false, Optional = false, ArrayBound = 3, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = 3, EnumName = delegate(ulong v) { return EnumNameGrade(v); }, VariantId = delegate(ulong v) { ulong id; TableEnumId((Grade)v, out id); return id; }, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetRaw = delegate(object o, int i) { return (ulong)((LoadoutConfig)o).Podium[i]; }, SetRaw = delegate(object o, int i, ulong r) { ((LoadoutConfig)o).Podium[i] = unchecked((Grade)r); }, MessageSlot = 22, NativeOffset = 12, NativeElementSize = 1, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; Array.Clear(value.Podium, 0, value.Podium.Length); }, DefaultRaw = (ulong)Grade.None },
                new TableFieldInfo { Name = "perks", Json = "perks", TypeName = "Perks", Id = 0x4b06f5847096e54a, Kind = 9, IsArray = false, Counted = false, Optional = false, ArrayBound = 0, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = 2, EnumName = delegate(ulong v) { return FlagNamePerks((int)v); }, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetRaw = delegate(object o, int i) { return ((LoadoutConfig)o).Perks; }, SetRaw = delegate(object o, int i, ulong r) { ((LoadoutConfig)o).Perks = r; }, MessageSlot = 23, NativeOffset = 16, NativeElementSize = 8, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; value.Perks = 0; }, DefaultRaw = 0, ClampRaw = delegate(ulong raw, TableReport r) { ulong v = raw; return v; } },
                new TableFieldInfo { Name = "primary", Json = "primary", TypeName = "WeaponConfig", Id = 0xbf31137ff783e939, Kind = 13, IsArray = false, Counted = false, Optional = false, ArrayBound = 0, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = -1, EnumName = null, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = delegate { return WeaponConfigTableType(); }, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetChild = delegate(object o, int i) { return ((LoadoutConfig)o).Primary; }, MessageSlot = 24, NativeOffset = 24, NativeElementSize = 28, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; TableReset(value.Primary); } },
                new TableFieldInfo { Name = "backups", Json = "backups", TypeName = "WeaponConfig", Id = 0xde28f0f5118acc24, Kind = 13, IsArray = true, Counted = false, Optional = false, ArrayBound = 2, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = -1, EnumName = null, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = delegate { return WeaponConfigTableType(); }, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetChild = delegate(object o, int i) { return ((LoadoutConfig)o).Backups[i]; }, MessageSlot = 25, NativeOffset = 52, NativeElementSize = 28, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; for (int i = 0; i < value.Backups.Length; i++) { TableReset(value.Backups[i]); } } },
                new TableFieldInfo { Name = "attachments", Json = "attachments", TypeName = "Attachment", Id = 0xf901aa0340249a41, Kind = 13, IsArray = true, Counted = true, Optional = false, ArrayBound = 8, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = -1, EnumName = null, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = delegate { return AttachmentTableType(); }, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetChild = delegate(object o, int i) { return ((LoadoutConfig)o).Attachments[i]; }, GetCount = delegate(object o) { return ((LoadoutConfig)o).AttachmentsCount; }, SetCount = delegate(object o, int n) { ((LoadoutConfig)o).AttachmentsCount = n; }, MessageSlot = 26, NativeOffset = 108, NativeElementSize = 8, NativeCountOffset = 172, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (LoadoutConfig)o; for (int i = 0; i < value.Attachments.Length; i++) { TableReset(value.Attachments[i]); } value.AttachmentsCount = 0; } },
            };
