...
namespace Tabledemo
{
    ...
    public static partial class Schema
    {
        ...
        public static void RangedSignedFixedWriteBody(Span<byte> b, RangedSigned value)
        {
            ...
            BinaryPrimitives.WriteInt32LittleEndian(b.Slice(60), value.EdgesCount);
            if (value.Edges != null) { MemoryMarshal.AsBytes(value.Edges.AsSpan(0, Math.Min(value.Edges.Length, 4))).CopyTo(b.Slice(64)); }
        }

        // RangedSigned's identity scatter: straight-line read into dst from wire image b.
        // No delegate dispatches, no per-slot loops, no allocations.
        public static void RangedSignedFixedIdentityScatter(RangedSigned dst, ReadOnlySpan<byte> b, TableReport report = null)
        {
            if (dst == null) return;
            dst.I8Span = unchecked((sbyte)b[0]);
            dst.I8Low = unchecked((sbyte)b.Slice(1)[0]);
            dst.I8High = unchecked((sbyte)b.Slice(2)[0]);
            dst.I8Inside = unchecked((sbyte)b.Slice(3)[0]);
            dst.I16Span = BinaryPrimitives.ReadInt16LittleEndian(b.Slice(4));
            dst.I16Low = BinaryPrimitives.ReadInt16LittleEndian(b.Slice(6));
            dst.I16High = BinaryPrimitives.ReadInt16LittleEndian(b.Slice(8));
            dst.I16Inside = BinaryPrimitives.ReadInt16LittleEndian(b.Slice(10));
            dst.I32Span = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(12));
            dst.I32Low = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(16));
            dst.I32High = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(20));
            dst.I32Inside = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(24));
            dst.I64Span = BinaryPrimitives.ReadInt64LittleEndian(b.Slice(28));
            dst.I64Low = BinaryPrimitives.ReadInt64LittleEndian(b.Slice(36));
            dst.I64High = BinaryPrimitives.ReadInt64LittleEndian(b.Slice(44));
            dst.I64Inside = BinaryPrimitives.ReadInt64LittleEndian(b.Slice(52));
            int count_edges = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(60));
            if (count_edges < 0) { count_edges = 0; if (report != null) report.Clamped++; }
            else if ((uint)count_edges > 4) { count_edges = 4; if (report != null) report.Clamped++; }
            dst.EdgesCount = count_edges;
            if (count_edges > 0 && dst.Edges != null) { MemoryMarshal.Cast<byte, short>(b.Slice(64, Math.Min(count_edges, dst.Edges.Length) * 2)).CopyTo(dst.Edges); }
        }
        ...
        public static void RangedUnsignedFixedWriteBody(Span<byte> b, RangedUnsigned value)
        {
            ...
            BinaryPrimitives.WriteInt32LittleEndian(b.Slice(60), value.CountsCount);
            if (value.Counts != null) { MemoryMarshal.AsBytes(value.Counts.AsSpan(0, Math.Min(value.Counts.Length, 4))).CopyTo(b.Slice(64)); }
        }

        // RangedUnsigned's identity scatter: straight-line read into dst from wire image b.
        // No delegate dispatches, no per-slot loops, no allocations.
        public static void RangedUnsignedFixedIdentityScatter(RangedUnsigned dst, ReadOnlySpan<byte> b, TableReport report = null)
        {
            if (dst == null) return;
            dst.U8Span = b[0];
            dst.U8Low = b.Slice(1)[0];
            dst.U8High = b.Slice(2)[0];
            dst.U8Inside = b.Slice(3)[0];
            dst.U16Span = BinaryPrimitives.ReadUInt16LittleEndian(b.Slice(4));
            dst.U16Low = BinaryPrimitives.ReadUInt16LittleEndian(b.Slice(6));
            dst.U16High = BinaryPrimitives.ReadUInt16LittleEndian(b.Slice(8));
            dst.U16Inside = BinaryPrimitives.ReadUInt16LittleEndian(b.Slice(10));
            dst.U32Span = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(12));
            dst.U32Low = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(16));
            dst.U32High = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(20));
            dst.U32Inside = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(24));
            dst.U64Span = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(28));
            dst.U64Low = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(36));
            dst.U64High = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(44));
            dst.U64Inside = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(52));
            int count_counts = BinaryPrimitives.ReadInt32LittleEndian(b.Slice(60));
            if (count_counts < 0) { count_counts = 0; if (report != null) report.Clamped++; }
            else if ((uint)count_counts > 4) { count_counts = 4; if (report != null) report.Clamped++; }
            dst.CountsCount = count_counts;
            if (count_counts > 0 && dst.Counts != null) { MemoryMarshal.Cast<byte, ulong>(b.Slice(64, Math.Min(count_counts, dst.Counts.Length) * 8)).CopyTo(dst.Counts); }
        }
        ...
        // RangedWidths's identity scatter: straight-line read into dst from wire image b.
        // No delegate dispatches, no per-slot loops, no allocations.
        public static void RangedWidthsFixedIdentityScatter(RangedWidths dst, ReadOnlySpan<byte> b, TableReport report = null)
        {
            if (dst == null) return;
            dst.B8 = BinaryPrimitives.ReadUInt32LittleEndian(b);
            dst.B16 = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(4));
            dst.B32 = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(8));
            dst.B64 = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(12));
            dst.B12 = BinaryPrimitives.ReadUInt32LittleEndian(b.Slice(20));
            dst.B48 = BinaryPrimitives.ReadUInt64LittleEndian(b.Slice(24));
        }
            ...
            TableReport report = null)
        {
            ...
            if (hash != RangedSignedFixedHash)
            {
                ...
                int made = TableFixedWire.Compile(parsed, RangedSignedFixedLayout, RangedSignedFixedDst, plan, report);
                if (made < 0)
                {
            ...
            if (hash == RangedSignedFixedHash)
            {
                for (int k = 0; k < n; ++k)
                {
                    ...
                    RangedSignedFixedIdentityScatter(values[k], at.Slice(8), report);
            ...
            for (int k = 0; k < n; ++k)
            {
                ...
                TableFixedWire.Run(entries, RangedSignedFixedSlots, at.Slice(8), values[k], report, planBytes);
                at = at.Slice((int)record_bytes);
            }
            if (report != null) { report.Verdict = TableWire.Verdict.Ok; }
            return n;
        ...
        {
            TableFixedWire.Run(plan, RangedSignedFixedSlots, src, dst, report, planBytes);
        }
            ...
            TableReport report = null)
        {
            ...
            if (hash != RangedUnsignedFixedHash)
            {
                ...
                int made = TableFixedWire.Compile(parsed, RangedUnsignedFixedLayout, RangedUnsignedFixedDst, plan, report);
                if (made < 0)
                {
                    if (report != null) { report.Refused = true; report.Reason = "plan_too_large"; report.Verdict = TableWire.Verdict.Refused; }
                    return -1;
            ...
            if (hash == RangedUnsignedFixedHash)
            {
                for (int k = 0; k < n; ++k)
                {
                    ...
                    RangedUnsignedFixedIdentityScatter(values[k], at.Slice(8), report);
                    at = at.Slice((int)record_bytes);
                }
                if (report != null) { report.Verdict = TableWire.Verdict.Ok; }
                return n;
            ...
            for (int k = 0; k < n; ++k)
            {
                ...
                TableFixedWire.Run(entries, RangedUnsignedFixedSlots, at.Slice(8), values[k], report, planBytes);
                at = at.Slice((int)record_bytes);
            }
            if (report != null) { report.Verdict = TableWire.Verdict.Ok; }
            return n;
        ...
        public static void TableFixedRun(
            ...
            ReadOnlySpan<byte> planBytes = default)
        {
            TableFixedWire.Run(plan, RangedUnsignedFixedSlots, src, dst, report, planBytes);
        }
            ...
            TableReport report = null)
        {
            ...
            if (hash != RangedWidthsFixedHash)
            {
                ...
                int made = TableFixedWire.Compile(parsed, RangedWidthsFixedLayout, RangedWidthsFixedDst, plan, report);
                if (made < 0)
                {
                    if (report != null) { report.Refused = true; report.Reason = "plan_too_large"; report.Verdict = TableWire.Verdict.Refused; }
                    return -1;
            ...
            if (hash == RangedWidthsFixedHash)
            {
                for (int k = 0; k < n; ++k)
                {
                    ...
                    RangedWidthsFixedIdentityScatter(values[k], at.Slice(8), report);
                    at = at.Slice((int)record_bytes);
                }
                if (report != null) { report.Verdict = TableWire.Verdict.Ok; }
                return n;
            ...
            for (int k = 0; k < n; ++k)
            {
                ...
                TableFixedWire.Run(entries, RangedWidthsFixedSlots, at.Slice(8), values[k], report, planBytes);
                at = at.Slice((int)record_bytes);
            }
            if (report != null) { report.Verdict = TableWire.Verdict.Ok; }
            return n;
        ...
        public static void TableFixedRun(
            ...
            ReadOnlySpan<byte> planBytes = default)
        {
            TableFixedWire.Run(plan, RangedWidthsFixedSlots, src, dst, report, planBytes);
        }
    }
