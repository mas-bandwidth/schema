...
// package messagedemo — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several messagedemo Table.cpp files may be
...
#ifndef MESSAGEDEMO_SCHEMA_TABLE_JSON
#define MESSAGEDEMO_SCHEMA_TABLE_JSON
