...
// package messagedemo — protocol id 0x8248fac3393e5575 (packets only: tables version by field id, not by protocol id)
...
static const uint64_t BuildVersion = 0x5d6070501121763aull;
