...
// package blockhome — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several blockhome Table.cpp files may be
...
#ifndef BLOCKHOME_SCHEMA_TABLE_JSON
#define BLOCKHOME_SCHEMA_TABLE_JSON
