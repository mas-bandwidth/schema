...
static const TableFieldInfo schema_graphdemo_tally_fields_[] = {
    { "hits", "hits", "int32", 0x732dfbcc9b0cf0bbull, 4, 0, 0, 0, 0, 0, (uint32_t) offsetof( Tally, hits ), (uint32_t) sizeof( ( (Tally *) 0 )->hits ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 10000.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableFieldInfo schema_graphdemo_marker_fields_[] = {
    { "label", "label", "string", 0x39f7fcec8fcb623dull, 12, 0, 0, 1, 0, 8, (uint32_t) offsetof( Marker, label ), (uint32_t) sizeof( ( (Marker *) 0 )->label ), (uint32_t) offsetof( Marker, label_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "note", "note", "Tally", 0x3bf8fbbad1587cddull, 17, 0, 1, 0, 0, 0, (uint32_t) offsetof( Marker, note ), (uint32_t) sizeof( TableRef ), 0xffffffffu, 0xffffffffu, &schema_graphdemo_tally_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
{
    return table_json_read( value, &schema_graphdemo_tally_info_, text, bytes, report );
}

int64_t schema_graphdemo_tally_to_json_( const Tally * value, char * buffer, int64_t capacity )
{
    return table_json_write( value, &schema_graphdemo_tally_info_, buffer, capacity );
}

int schema_graphdemo_marker_from_json_( MarkerBuilder * builder, const char * text, int64_t bytes, TableReport * report )
{
    return table_json_read_graph(&builder->main,marker_builder_root(builder),&schema_graphdemo_marker_info_,text,bytes,report);
}

int64_t schema_graphdemo_marker_to_json_( const Marker * value, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return table_json_write_graph(value,&schema_graphdemo_marker_info_,buffer,capacity,allocator);
}
