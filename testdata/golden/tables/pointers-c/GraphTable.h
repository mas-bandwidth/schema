...
static SCHEMA_UNUSED const TableFixedGuard meta_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t meta_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry meta_fixed_plan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* build */
    { 4u, 16u, 8u, 4u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* tag */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) meta_fixed_guards;
...
/* THE GUARD POOL: every chain the plan's entries name, laid once and
   ...
   union first, and it is as long as the nesting is deep: there is no bound
   on how many unions may nest (§5.9). */
static SCHEMA_UNUSED const TableFixedGuard settings_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t settings_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry settings_fixed_plan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* quality */
    { 4u, 24u, 16u, 4u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* label */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) settings_fixed_guards;
