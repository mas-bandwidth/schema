...
static SCHEMA_UNUSED const TableFixedEntry stamp_fixed_plan[] = {
    { 0u, 12u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* tag length */
    { 4u, 0u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* tag */
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    if ( !identity )
    {
        ...
        else
        {
            ...
            made = table_fixed_compile( &parsed, stamp_fixed_layout, (int32_t) sizeof( stamp_fixed_layout ), stamp_fixed_dst, dest, dest_capacity, &compiled_guarded, report );
