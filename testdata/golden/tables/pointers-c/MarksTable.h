...
static SCHEMA_UNUSED int tally_save_body( TableWriter * w, const Tally * value )
{
    ...
    if ( w->buffer == NULL )
    {
        ...
        if ( !( value->hits == 0 ) )
        {
            table_writer_id_at( w, 20, 0x732dfbcc9b0cf0bbull );
    ...
    { /* hits */
        if ( !( value->hits == 0 ) )
        {
            table_writer_header_at( w, 20, 0x732dfbcc9b0cf0bbull, 4 );
...
static SCHEMA_UNUSED int marker_save_body( TableWriter * w, const Marker * value )
{
    ...
    { /* note */
        ...
        {
            if ( w->check_default ) { w->offset = 2; return 1; }
            table_writer_header_at( w, 8, 0x3bf8fbbad1587cddull, 17 );
...
static SCHEMA_UNUSED const TableFixedEntry tally_fixed_plan[] = {
    { 0u, 0u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* hits */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != tally_fixed_hash )
    {
        ...
        made = table_fixed_compile( &parsed, tally_fixed_layout, (int32_t) sizeof( tally_fixed_layout ), tally_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
