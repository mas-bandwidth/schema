...
static SCHEMA_UNUSED const TableFixedGuard tally_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t tally_fixed_guard_count = 0;
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) tally_fixed_guards;
