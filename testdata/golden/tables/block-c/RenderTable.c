...
static const TableFieldInfo schema_blockdemo_render_camera_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, position ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, rotation ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "camera_id", "camera_id", "uint32", 0x25bd, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, camera_id ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->camera_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "camera_type", "camera_type", "uint32", 0x9920, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, camera_type ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->camera_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "target_object_id", "target_object_id", "uint32", 0x38dc, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, target_object_id ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->target_object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "fov", "fov", "float32", 0x392f, 10, 0, 0, 0, 0, (uint32_t) offsetof( RenderCamera, fov ), (uint32_t) sizeof( ( (RenderCamera *) 0 )->fov ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_camera_info_ = { "RenderCamera", (uint32_t) sizeof( RenderCamera ), 6, schema_blockdemo_render_camera_fields_, schema_blockdemo_render_camera_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_ship_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, position ), (uint32_t) sizeof( ( (RenderShip *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, rotation ), (uint32_t) sizeof( ( (RenderShip *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "ShipFlags", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, flags ), (uint32_t) sizeof( ( (RenderShip *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_blockdemo_render_ship_flags_variants_, 0, NULL, NULL, -1, NULL, "" },
    { "object_id", "object_id", "uint32", 0xdc71, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, object_id ), (uint32_t) sizeof( ( (RenderShip *) 0 )->object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "target_object_id", "target_object_id", "uint32", 0x38dc, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, target_object_id ), (uint32_t) sizeof( ( (RenderShip *) 0 )->target_object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "thrust", "thrust", "float32", 0x9e51, 10, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, thrust ), (uint32_t) sizeof( ( (RenderShip *) 0 )->thrust ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_sequence", "object_sequence", "uint8", 0x57ee, 6, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, object_sequence ), (uint32_t) sizeof( ( (RenderShip *) 0 )->object_sequence ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "ship_type", "ship_type", "ShipType", 0x38e9, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, ship_type ), (uint32_t) sizeof( ( (RenderShip *) 0 )->ship_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_blockdemo_render_ship_ship_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, team ), (uint32_t) sizeof( ( (RenderShip *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_ship_team_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "has_target_lock", "has_target_lock", "bool", 0xf223, 1, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, has_target_lock ), (uint32_t) sizeof( ( (RenderShip *) 0 )->has_target_lock ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "predicted_explode", "predicted_explode", "bool", 0x88bd, 1, 0, 0, 0, 0, (uint32_t) offsetof( RenderShip, predicted_explode ), (uint32_t) sizeof( ( (RenderShip *) 0 )->predicted_explode ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_ship_info_ = { "RenderShip", (uint32_t) sizeof( RenderShip ), 11, schema_blockdemo_render_ship_fields_, schema_blockdemo_render_ship_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_turret_fields_[] = {
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, rotation ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "uint64", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, flags ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_id", "object_id", "uint32", 0xdc71, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, object_id ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "parent_object_id", "parent_object_id", "uint32", 0xeeb6, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, parent_object_id ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->parent_object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "turret_index", "turret_index", "uint32", 0xae10, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, turret_index ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->turret_index ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "target_object_id", "target_object_id", "uint32", 0x38dc, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, target_object_id ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->target_object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_sequence", "object_sequence", "uint8", 0x57ee, 6, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, object_sequence ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->object_sequence ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, team ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_turret_team_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "has_target_lock", "has_target_lock", "bool", 0xf223, 1, 0, 0, 0, 0, (uint32_t) offsetof( RenderTurret, has_target_lock ), (uint32_t) sizeof( ( (RenderTurret *) 0 )->has_target_lock ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_turret_info_ = { "RenderTurret", (uint32_t) sizeof( RenderTurret ), 9, schema_blockdemo_render_turret_fields_, schema_blockdemo_render_turret_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_missile_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, position ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, rotation ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "uint64", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, flags ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_id", "object_id", "uint32", 0xdc71, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, object_id ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_sequence", "object_sequence", "uint8", 0x57ee, 6, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, object_sequence ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->object_sequence ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "missile_type", "missile_type", "MissileType", 0x423a, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, missile_type ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->missile_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 2, schema_blockdemo_render_missile_missile_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderMissile, team ), (uint32_t) sizeof( ( (RenderMissile *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_missile_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_missile_info_ = { "RenderMissile", (uint32_t) sizeof( RenderMissile ), 7, schema_blockdemo_render_missile_fields_, schema_blockdemo_render_missile_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_dynamic_prop_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, position ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, rotation ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "uint64", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, flags ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_id", "object_id", "uint32", 0xdc71, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, object_id ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "object_sequence", "object_sequence", "uint8", 0x57ee, 6, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, object_sequence ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->object_sequence ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "prop_type", "prop_type", "PropType", 0xe338, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, prop_type ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->prop_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_blockdemo_render_dynamic_prop_prop_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderDynamicProp, team ), (uint32_t) sizeof( ( (RenderDynamicProp *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_dynamic_prop_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_dynamic_prop_info_ = { "RenderDynamicProp", (uint32_t) sizeof( RenderDynamicProp ), 7, schema_blockdemo_render_dynamic_prop_fields_, schema_blockdemo_render_dynamic_prop_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_static_prop_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, position ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, rotation ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "scale", "scale", "float64", 0x9ee6, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, scale ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->scale ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "uint64", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, flags ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "static_prop_id", "static_prop_id", "uint32", 0x0f74, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, static_prop_id ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->static_prop_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "prop_type", "prop_type", "PropType", 0xe338, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, prop_type ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->prop_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_blockdemo_render_static_prop_prop_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderStaticProp, team ), (uint32_t) sizeof( ( (RenderStaticProp *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_static_prop_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_static_prop_info_ = { "RenderStaticProp", (uint32_t) sizeof( RenderStaticProp ), 7, schema_blockdemo_render_static_prop_fields_, schema_blockdemo_render_static_prop_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_cosmetic_prop_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, position ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, rotation ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "scale", "scale", "float64", 0x9ee6, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, scale ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->scale ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flags", "flags", "uint64", 0xe64b, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, flags ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->flags ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "cosmetic_prop_id", "cosmetic_prop_id", "uint32", 0x0843, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, cosmetic_prop_id ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->cosmetic_prop_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "prop_sequence", "prop_sequence", "uint8", 0x3069, 6, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, prop_sequence ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->prop_sequence ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "prop_type", "prop_type", "PropType", 0xe338, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, prop_type ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->prop_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_blockdemo_render_cosmetic_prop_prop_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderCosmeticProp, team ), (uint32_t) sizeof( ( (RenderCosmeticProp *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_cosmetic_prop_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_cosmetic_prop_info_ = { "RenderCosmeticProp", (uint32_t) sizeof( RenderCosmeticProp ), 8, schema_blockdemo_render_cosmetic_prop_fields_, schema_blockdemo_render_cosmetic_prop_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_laser_fields_[] = {
    { "start", "start", "RenderVector3", 0x61f4, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, start ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->start ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "finish", "finish", "RenderVector3", 0x2d84, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, finish ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->finish ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "t", "t", "float64", 0xccaf, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, t ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->t ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "laser_id", "laser_id", "uint32", 0xc5ca, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, laser_id ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->laser_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "laser_type", "laser_type", "LaserType", 0xc46a, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, laser_type ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->laser_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 2, schema_blockdemo_render_laser_laser_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderLaser, team ), (uint32_t) sizeof( ( (RenderLaser *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_laser_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_laser_info_ = { "RenderLaser", (uint32_t) sizeof( RenderLaser ), 6, schema_blockdemo_render_laser_fields_, schema_blockdemo_render_laser_reset_raw_ };
...
static const TableFieldInfo schema_blockdemo_render_explosion_fields_[] = {
    { "position", "position", "RenderVector3", 0xdd45, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, position ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->position ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_vector3_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "rotation", "rotation", "RenderQuaternion", 0x60f3, 13, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, rotation ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->rotation ), 0xffffffffu, 0xffffffffu, &schema_blockdemo_render_quaternion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "t", "t", "float64", 0xccaf, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, t ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->t ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "explosion_id", "explosion_id", "uint32", 0x5be0, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, explosion_id ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->explosion_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "parent_object_id", "parent_object_id", "uint32", 0xeeb6, 8, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, parent_object_id ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->parent_object_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "explosion_type", "explosion_type", "ExplosionType", 0x98fa, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, explosion_type ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->explosion_type ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 2, schema_blockdemo_render_explosion_explosion_type_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "team", "team", "Team", 0xdff1, 7, 0, 0, 0, 0, (uint32_t) offsetof( RenderExplosion, team ), (uint32_t) sizeof( ( (RenderExplosion *) 0 )->team ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 4, schema_blockdemo_render_explosion_team_variants_, 1, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_explosion_info_ = { "RenderExplosion", (uint32_t) sizeof( RenderExplosion ), 7, schema_blockdemo_render_explosion_fields_, schema_blockdemo_render_explosion_reset_raw_ };

static const TableFieldInfo schema_blockdemo_render_frame_fields_[] = {
    { "version", "version", "uint64", 0xe8e6, 9, 0, 0, 0, 0, (uint32_t) offsetof( RenderFrame, version ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->version ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "cameras", "cameras", "RenderCamera", 0x8b0e, 13, 1, 1, 0, 1, (uint32_t) offsetof( RenderFrame, cameras ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->cameras[0] ), (uint32_t) offsetof( RenderFrame, cameras_count ), 0xffffffffu, &schema_blockdemo_render_camera_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "ships", "ships", "RenderShip", 0x2d39, 13, 1, 1, 0, 4096, (uint32_t) offsetof( RenderFrame, ships ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->ships[0] ), (uint32_t) offsetof( RenderFrame, ships_count ), 0xffffffffu, &schema_blockdemo_render_ship_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "turrets", "turrets", "RenderTurret", 0x48ad, 13, 1, 1, 0, 1024, (uint32_t) offsetof( RenderFrame, turrets ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->turrets[0] ), (uint32_t) offsetof( RenderFrame, turrets_count ), 0xffffffffu, &schema_blockdemo_render_turret_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "missiles", "missiles", "RenderMissile", 0xa532, 13, 1, 1, 0, 4096, (uint32_t) offsetof( RenderFrame, missiles ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->missiles[0] ), (uint32_t) offsetof( RenderFrame, missiles_count ), 0xffffffffu, &schema_blockdemo_render_missile_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "dynamic_props", "dynamic_props", "RenderDynamicProp", 0x810b, 13, 1, 1, 0, 4096, (uint32_t) offsetof( RenderFrame, dynamic_props ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->dynamic_props[0] ), (uint32_t) offsetof( RenderFrame, dynamic_props_count ), 0xffffffffu, &schema_blockdemo_render_dynamic_prop_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "static_props", "static_props", "RenderStaticProp", 0x55a9, 13, 1, 1, 0, 20000, (uint32_t) offsetof( RenderFrame, static_props ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->static_props[0] ), (uint32_t) offsetof( RenderFrame, static_props_count ), 0xffffffffu, &schema_blockdemo_render_static_prop_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "cosmetic_props", "cosmetic_props", "RenderCosmeticProp", 0x1142, 13, 1, 1, 0, 8192, (uint32_t) offsetof( RenderFrame, cosmetic_props ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->cosmetic_props[0] ), (uint32_t) offsetof( RenderFrame, cosmetic_props_count ), 0xffffffffu, &schema_blockdemo_render_cosmetic_prop_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "lasers", "lasers", "RenderLaser", 0x411a, 13, 1, 1, 0, 32000, (uint32_t) offsetof( RenderFrame, lasers ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->lasers[0] ), (uint32_t) offsetof( RenderFrame, lasers_count ), 0xffffffffu, &schema_blockdemo_render_laser_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "explosions", "explosions", "RenderExplosion", 0x6bfb, 13, 1, 1, 0, 32000, (uint32_t) offsetof( RenderFrame, explosions ), (uint32_t) sizeof( ( (RenderFrame *) 0 )->explosions[0] ), (uint32_t) offsetof( RenderFrame, explosions_count ), 0xffffffffu, &schema_blockdemo_render_explosion_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_frame_info_ = { "RenderFrame", (uint32_t) sizeof( RenderFrame ), 10, schema_blockdemo_render_frame_fields_, schema_blockdemo_render_frame_reset_raw_ };

static const TableFieldInfo schema_blockdemo_render_vector3_fields_[] = {
    { "x", "x", "float64", 0xad8b, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderVector3, x ), (uint32_t) sizeof( ( (RenderVector3 *) 0 )->x ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "y", "y", "float64", 0xb2f8, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderVector3, y ), (uint32_t) sizeof( ( (RenderVector3 *) 0 )->y ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "z", "z", "float64", 0xaca1, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderVector3, z ), (uint32_t) sizeof( ( (RenderVector3 *) 0 )->z ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_vector3_info_ = { "RenderVector3", (uint32_t) sizeof( RenderVector3 ), 3, schema_blockdemo_render_vector3_fields_, schema_blockdemo_render_vector3_reset_raw_ };

static const TableFieldInfo schema_blockdemo_render_quaternion_fields_[] = {
    { "x", "x", "float64", 0xad8b, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderQuaternion, x ), (uint32_t) sizeof( ( (RenderQuaternion *) 0 )->x ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "y", "y", "float64", 0xb2f8, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderQuaternion, y ), (uint32_t) sizeof( ( (RenderQuaternion *) 0 )->y ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "z", "z", "float64", 0xaca1, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderQuaternion, z ), (uint32_t) sizeof( ( (RenderQuaternion *) 0 )->z ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "w", "w", "float64", 0xcd3a, 11, 0, 0, 0, 0, (uint32_t) offsetof( RenderQuaternion, w ), (uint32_t) sizeof( ( (RenderQuaternion *) 0 )->w ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_blockdemo_render_quaternion_info_ = { "RenderQuaternion", (uint32_t) sizeof( RenderQuaternion ), 4, schema_blockdemo_render_quaternion_fields_, schema_blockdemo_render_quaternion_reset_raw_ };
