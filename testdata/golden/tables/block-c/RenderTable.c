...
{
    return TableJsonRead( value, &schema_blockdemo_render_dynamic_prop_info_, text, bytes, report );
}

int64_t schema_blockdemo_render_dynamic_prop_to_json_( const RenderDynamicProp * value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( value, &schema_blockdemo_render_dynamic_prop_info_, buffer, capacity );
}
...
{
    return TableJsonRead( value, &schema_blockdemo_render_static_prop_info_, text, bytes, report );
}

int64_t schema_blockdemo_render_static_prop_to_json_( const RenderStaticProp * value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( value, &schema_blockdemo_render_static_prop_info_, buffer, capacity );
}
...
{
    return TableJsonRead( value, &schema_blockdemo_render_quaternion_info_, text, bytes, report );
}

int64_t schema_blockdemo_render_quaternion_to_json_( const RenderQuaternion * value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( value, &schema_blockdemo_render_quaternion_info_, buffer, capacity );
}
