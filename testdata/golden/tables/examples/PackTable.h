...
{
    return 1 + 4 + GunnerSettingsFixedLayoutBytes + count * GunnerSettingsFixedRecordBytes;
}
...
inline int64_t GunnerSettingsFixedSave( const GunnerSettings * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) GunnerSettingsFixedLayoutBytes );
    memcpy( buffer + 5, GunnerSettingsFixedLayout, (size_t) GunnerSettingsFixedLayoutBytes );
    uint8_t * at = buffer + 5 + GunnerSettingsFixedLayoutBytes;
...
{
    return 1 + 4 + ShipEntryFixedLayoutBytes + count * ShipEntryFixedRecordBytes;
}
...
inline int64_t ShipEntryFixedSave( const ShipEntry * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    buffer[0] = kTableFixedForm;
    TableFixedPut32( buffer + 1, (uint32_t) ShipEntryFixedLayoutBytes );
    memcpy( buffer + 5, ShipEntryFixedLayout, (size_t) ShipEntryFixedLayoutBytes );
    uint8_t * at = buffer + 5 + ShipEntryFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
...
{
    return 1 + 4 + GlobalSettingsFixedLayoutBytes + count * GlobalSettingsFixedRecordBytes;
}
...
inline int64_t GlobalSettingsFixedSave( const GlobalSettings * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    buffer[0] = kTableFixedForm;
    TableFixedPut32( buffer + 1, (uint32_t) GlobalSettingsFixedLayoutBytes );
    memcpy( buffer + 5, GlobalSettingsFixedLayout, (size_t) GlobalSettingsFixedLayoutBytes );
    uint8_t * at = buffer + 5 + GlobalSettingsFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
...
{
    return 1 + 4 + PackConfigFixedLayoutBytes + count * PackConfigFixedRecordBytes;
}
...
inline int64_t PackConfigFixedSave( const PackConfig * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    buffer[0] = kTableFixedForm;
    TableFixedPut32( buffer + 1, (uint32_t) PackConfigFixedLayoutBytes );
    memcpy( buffer + 5, PackConfigFixedLayout, (size_t) PackConfigFixedLayoutBytes );
    uint8_t * at = buffer + 5 + PackConfigFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
