...
constexpr TableFixedGuard GunnerSettingsFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t GunnerSettingsFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) GunnerSettingsFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard ShipEntryFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t ShipEntryFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) ShipEntryFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard GlobalSettingsFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t GlobalSettingsFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) GlobalSettingsFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard PackConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t PackConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) PackConfigFixedGuards;
