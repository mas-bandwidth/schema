...
inline int64_t RangedSignedMeasureMessageBody( int64_t at, const RangedSigned & value );
inline bool RangedSignedSaveMessageBody( TableBitWriter & w, const RangedSigned & value );
inline bool RangedSignedLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedSigned & value );
inline int64_t RangedUnsignedMeasureMessageBody( int64_t at, const RangedUnsigned & value );
inline bool RangedUnsignedSaveMessageBody( TableBitWriter & w, const RangedUnsigned & value );
inline bool RangedUnsignedLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedUnsigned & value );
inline int64_t RangedWidthsMeasureMessageBody( int64_t at, const RangedWidths & value );
inline bool RangedWidthsSaveMessageBody( TableBitWriter & w, const RangedWidths & value );
inline bool RangedWidthsLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedWidths & value );
...
inline void TableReset( RangedSigned & value ) { RangedSignedReset( value ); }
inline void TableReset( RangedUnsigned & value ) { RangedUnsignedReset( value ); }
inline void TableReset( RangedWidths & value ) { RangedWidthsReset( value ); }
...
inline int64_t RangedSignedMeasureBodyRetain( TableRetainIds & ids, const RangedSigned & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedSignedSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const RangedSigned & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedSignedLoadBodyRetain( TableReader & r, RangedSigned & value, TableRetain * retain, const TableRetainPath & path );
inline bool RangedSignedLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedSigned & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t RangedUnsignedMeasureBodyRetain( TableRetainIds & ids, const RangedUnsigned & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedUnsignedSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const RangedUnsigned & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedUnsignedLoadBodyRetain( TableReader & r, RangedUnsigned & value, TableRetain * retain, const TableRetainPath & path );
inline bool RangedUnsignedLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedUnsigned & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t RangedWidthsMeasureBodyRetain( TableRetainIds & ids, const RangedWidths & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedWidthsSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const RangedWidths & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool RangedWidthsLoadBodyRetain( TableReader & r, RangedWidths & value, TableRetain * retain, const TableRetainPath & path );
inline bool RangedWidthsLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, RangedWidths & value, TableRetain * retain, const TableRetainPath & path );

inline int64_t RangedSignedMeasureBody( TableIds & ids, const RangedSigned & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.i8_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 44, 0x48121511bf702eb5ull ) ) + 1 + 1; } // i8_span
    if ( value.i8_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 77, 0x942bfe3168090f7dull ) ) + 1 + 1; } // i8_low
    if ( value.i8_high != 0 ) { bytes += TableLebBytes( ids.ref_at( 127, 0xd182acd105b55dd1ull ) ) + 1 + 1; } // i8_high
    if ( value.i8_inside != 0 ) { bytes += TableLebBytes( ids.ref_at( 142, 0xef9ded23c8912a81ull ) ) + 1 + 1; } // i8_inside
    if ( value.i16_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 101, 0xb655574ea23760b4ull ) ) + 1 + 2; } // i16_span
    if ( value.i16_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 128, 0xd217b3af8d7a2bdeull ) ) + 1 + 2; } // i16_low
    if ( value.i16_high != 0 ) { bytes += TableLebBytes( ids.ref_at( 76, 0x90652f70c9127900ull ) ) + 1 + 2; } // i16_high
    if ( value.i16_inside != 0 ) { bytes += TableLebBytes( ids.ref_at( 59, 0x6a659d7c354db158ull ) ) + 1 + 2; } // i16_inside
    if ( value.i32_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 138, 0xe693bd88532c91d6ull ) ) + 1 + 4; } // i32_span
    if ( value.i32_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 5, 0x065ee827cf99fbb4ull ) ) + 1 + 4; } // i32_low
    if ( value.i32_high != 0 ) { bytes += TableLebBytes( ids.ref_at( 119, 0xc9b121c4c2a186eeull ) ) + 1 + 4; } // i32_high
    if ( value.i32_inside != 0 ) { bytes += TableLebBytes( ids.ref_at( 130, 0xd363dfa465acf27aull ) ) + 1 + 4; } // i32_inside
    if ( value.i64_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 64, 0x7549c70700c49d6full ) ) + 1 + 8; } // i64_span
    if ( value.i64_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 16, 0x1cce6617419771dbull ) ) + 1 + 8; } // i64_low
    if ( value.i64_high != 0 ) { bytes += TableLebBytes( ids.ref_at( 37, 0x3b54fa60620b5597ull ) ) + 1 + 8; } // i64_high
    if ( value.i64_inside != 0 ) { bytes += TableLebBytes( ids.ref_at( 129, 0xd308fcb98ece5d23ull ) ) + 1 + 8; } // i64_inside
    if ( value.edges_count < 0 || value.edges_count > 4 ) { return -1; } // storage invariant
    if ( value.edges_count > 0 )
    {
        const uint64_t ref_edges = ids.ref_at( 118, 0xc70cde6b85b6197dull );
...
TABLEDEMO_TABLE_INLINE bool RangedSignedSaveBody( TableWriter & w, TableIds & ids, const RangedSigned & value )
{
    if ( value.i8_span != 0 )
    {
        w.header( ids.ref_at( 44, 0x48121511bf702eb5ull ), 2 ); // i8_span
        w.put8( uint8_t( value.i8_span ) );
    }
    if ( value.i8_low != 0 )
    {
        w.header( ids.ref_at( 77, 0x942bfe3168090f7dull ), 2 ); // i8_low
        w.put8( uint8_t( value.i8_low ) );
    }
    if ( value.i8_high != 0 )
    {
        w.header( ids.ref_at( 127, 0xd182acd105b55dd1ull ), 2 ); // i8_high
        w.put8( uint8_t( value.i8_high ) );
    }
    if ( value.i8_inside != 0 )
    {
        w.header( ids.ref_at( 142, 0xef9ded23c8912a81ull ), 2 ); // i8_inside
        w.put8( uint8_t( value.i8_inside ) );
    }
    if ( value.i16_span != 0 )
    {
        w.header( ids.ref_at( 101, 0xb655574ea23760b4ull ), 3 ); // i16_span
        w.put16( uint16_t( value.i16_span ) );
    }
    if ( value.i16_low != 0 )
    {
        w.header( ids.ref_at( 128, 0xd217b3af8d7a2bdeull ), 3 ); // i16_low
        w.put16( uint16_t( value.i16_low ) );
    }
    if ( value.i16_high != 0 )
    {
        w.header( ids.ref_at( 76, 0x90652f70c9127900ull ), 3 ); // i16_high
        w.put16( uint16_t( value.i16_high ) );
    }
    if ( value.i16_inside != 0 )
    {
        w.header( ids.ref_at( 59, 0x6a659d7c354db158ull ), 3 ); // i16_inside
        w.put16( uint16_t( value.i16_inside ) );
    }
    if ( value.i32_span != 0 )
    {
        w.header( ids.ref_at( 138, 0xe693bd88532c91d6ull ), 4 ); // i32_span
    ...
    if ( value.i32_high != 0 )
    {
        w.header( ids.ref_at( 119, 0xc9b121c4c2a186eeull ), 4 ); // i32_high
        w.put32( uint32_t( value.i32_high ) );
    }
    if ( value.i32_inside != 0 )
    {
        w.header( ids.ref_at( 130, 0xd363dfa465acf27aull ), 4 ); // i32_inside
        w.put32( uint32_t( value.i32_inside ) );
    }
    if ( value.i64_span != 0 )
    {
        w.header( ids.ref_at( 64, 0x7549c70700c49d6full ), 5 ); // i64_span
    ...
    if ( value.i64_high != 0 )
    {
        w.header( ids.ref_at( 37, 0x3b54fa60620b5597ull ), 5 ); // i64_high
        w.put64( uint64_t( value.i64_high ) );
    }
    if ( value.i64_inside != 0 )
    {
        w.header( ids.ref_at( 129, 0xd308fcb98ece5d23ull ), 5 ); // i64_inside
        ...
        switch ( field_id )
        {
            ...
            case 0xc70cde6b85b6197dull: // edges
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    {
                        if ( !TableKindWidens( elem_kind, 3 ) ) { r.report->kind_mismatch++; r.offset = body_end; break; }
                        ...
                        for ( uint64_t widened_i = 0; widened_i < widened_keep; widened_i++ )
                        {
                            ...
                            int16_t decoded_v = (int16_t) widened_v;
                            value.edges[(int32_t) widened_i] = decoded_v;
...
inline int64_t RangedSignedMeasureMessageBody( int64_t at, const RangedSigned & value )
{
    ...
    if ( value.edges_count > 0 )
    {
        bits += kTableMessageRefBitsHere;
        bits += 3;
        bits += (int64_t) ( value.edges_count ) * 16;
    }
...
inline bool RangedSignedSaveMessageBody( TableBitWriter & w, const RangedSigned & value )
{
    if ( value.i8_span != 0 )
    {
        ...
        w.put( (uint64_t) ( value.i8_span ) - 18446744073709551488ull, 8 );
    }
    if ( value.i8_low != 0 )
    {
        w.put( 53, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i8_low ) - 18446744073709551488ull, 8 );
    }
    if ( value.i8_high != 0 )
    {
        w.put( 54, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i8_high ) - 18446744073709551489ull, 8 );
    }
    if ( value.i8_inside != 0 )
    {
        w.put( 55, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i8_inside ) - 18446744073709551489ull, 8 );
    }
    if ( value.i16_span != 0 )
    {
        w.put( 56, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i16_span ) - 18446744073709518848ull, 16 );
    }
    if ( value.i16_low != 0 )
    {
        w.put( 57, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i16_low ) - 18446744073709518848ull, 16 );
    }
    if ( value.i16_high != 0 )
    {
        w.put( 58, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i16_high ) - 18446744073709518849ull, 16 );
    }
    if ( value.i16_inside != 0 )
    {
        w.put( 59, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i16_inside ) - 18446744073709518849ull, 16 );
    }
    if ( value.i32_span != 0 )
    {
        w.put( 60, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i32_span ) - 18446744071562067968ull, 32 );
    }
    if ( value.i32_low != 0 )
    {
        w.put( 61, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i32_low ) - 18446744071562067968ull, 32 );
    }
    if ( value.i32_high != 0 )
    {
        w.put( 62, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i32_high ) - 18446744071562067969ull, 32 );
    }
    if ( value.i32_inside != 0 )
    {
        w.put( 63, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i32_inside ) - 18446744071562067969ull, 32 );
    }
    if ( value.i64_span != 0 )
    {
        w.put( 64, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i64_span ) - 9223372036854775808ull, 64 );
    }
    if ( value.i64_low != 0 )
    {
        w.put( 65, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i64_low ) - 9223372036854775808ull, 64 );
    }
    if ( value.i64_high != 0 )
    {
        w.put( 66, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i64_high ) - 9223372036854775809ull, 64 );
    }
    if ( value.i64_inside != 0 )
    {
        w.put( 67, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.i64_inside ) - 9223372036854775809ull, 64 );
    }
    if ( value.edges_count < 0 || value.edges_count > 4 ) { return false; } // storage invariant
    if ( value.edges_count > 0 )
    {
        w.put( 68, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.edges_count ) - 0, 3 );
        for ( int32_t i = 0; i < value.edges_count; i++ )
        {
            w.put( (uint64_t) ( value.edges[i] ) - 18446744073709518848ull, 16 );
        }
    }
        ...
        switch ( entry.id )
        {
            ...
            case 0x942bfe3168090f7dull: // i8_low
            {
                ...
                }
                {
                    ...
                    if ( decoded_wide < -128ll ) { decoded_wide = -128ll; report->clamped++; }
                    if ( decoded_wide > 126ll ) { decoded_wide = 126ll; report->clamped++; }
                    int8_t decoded_v = (int8_t) decoded_wide;
                    value.i8_low = decoded_v;
                }
                break;
                    ...
                    {
                        {
                            ...
                            if ( decoded_wide < -32768ll ) { decoded_wide = -32768ll; report->clamped++; }
                            if ( decoded_wide > 32766ll ) { decoded_wide = 32766ll; report->clamped++; }
                            int16_t decoded_v = (int16_t) decoded_wide;
                            value.i16_low = decoded_v;
                        }
                        report->widened++;
                    ...
                    {
                        {
                            ...
                            if ( decoded_wide < -2147483648ll ) { decoded_wide = -2147483648ll; report->clamped++; }
                            if ( decoded_wide > 2147483646ll ) { decoded_wide = 2147483646ll; report->clamped++; }
                            int32_t decoded_v = (int32_t) decoded_wide;
                            value.i32_low = decoded_v;
                        }
                        report->widened++;
                    ...
                    {
                        {
                            ...
                            if ( decoded_wide > 9223372036854775806ll ) { decoded_wide = 9223372036854775806ll; report->clamped++; }
                            int64_t decoded_v = (int64_t) decoded_wide;
                            value.i64_low = decoded_v;
                        }
                        report->widened++;
                    ...
                    {
                        {
                            ...
                            if ( decoded_wide < -9223372036854775807ll ) { decoded_wide = -9223372036854775807ll; report->clamped++; }
                            int64_t decoded_v = (int64_t) decoded_wide;
                            value.i64_high = decoded_v;
                        }
                        report->widened++;
            ...
            case 0xc70cde6b85b6197dull: // edges
            {
                ...
                // A RANGE that moved is not one: the shapes differ and the entry
                // carries the SENDER's, so the field decodes and clamps (§4).
                if ( entry.kind != 14 || entry.elem_kind != 3 )
                {
                    if ( entry.kind == 14 && TableKindWidens( entry.elem_kind, 3 ) )
                    {
                        {
                            uint64_t n = (uint64_t) entry.min;
                            ...
                            for ( uint64_t i = 0; i < walk; i++ )
                            {
                                ...
                                int16_t scratch = 0;
                                {
                                    ...
                                    if ( decoded_wide_2 < -32768ll ) { decoded_wide_2 = -32768ll; report->clamped++; }
                                    if ( decoded_wide_2 > 32767ll ) { decoded_wide_2 = 32767ll; report->clamped++; }
                                    int16_t decoded_v_2 = (int16_t) decoded_wide_2;
                                    scratch = decoded_v_2;
                                }
                                if ( in_bounds ) { value.edges[i] = scratch; }
                            }
                            if ( walk < n && !TableMessageSkipRun( r, n - walk, surplus_bits ) ) { report->malformed = true; return false; }
                            value.edges_count = kept;
                        }
                        report->widened++;
                        break;
                    }
...
inline int64_t RangedSignedMeasureMessages( const RangedSigned * values, int64_t count, TableReport * report )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = RangedSignedMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
...
inline int64_t RangedSignedSaveMessages( const RangedSigned * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !RangedSignedSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == RangedSignedMeasureMessages( values, count, report )
}
...
inline bool RangedSignedLoadMessages( RangedSigned * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    ...
    *count = 0;
    ...
    {
        if ( !RangedSignedLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
...
inline int64_t RangedUnsignedMeasureBody( TableIds & ids, const RangedUnsigned & value )
{
    ...
    if ( value.u8_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 29, 0x2e17553f8200a2a1ull ) ) + 1 + 1; } // u8_low
    if ( value.u8_high != 1 ) { bytes += TableLebBytes( ids.ref_at( 85, 0xa0e5c60df9301b7dull ) ) + 1 + 1; } // u8_high
    if ( value.u8_inside != 1 ) { bytes += TableLebBytes( ids.ref_at( 15, 0x1cb2c073a6f5844dull ) ) + 1 + 1; } // u8_inside
    if ( value.u16_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 47, 0x4ca0c150b1790960ull ) ) + 1 + 2; } // u16_span
    if ( value.u16_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 144, 0xf252136836b04cb2ull ) ) + 1 + 2; } // u16_low
    if ( value.u16_high != 1 ) { bytes += TableLebBytes( ids.ref_at( 49, 0x4f37e1f216e7610cull ) ) + 1 + 2; } // u16_high
    if ( value.u16_inside != 1 ) { bytes += TableLebBytes( ids.ref_at( 126, 0xd176b605978f3304ull ) ) + 1 + 2; } // u16_inside
    if ( value.u32_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x200b924de7479cdaull ) ) + 1 + 4; } // u32_span
    if ( value.u32_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 88, 0xa53d2f2a31b5acb0ull ) ) + 1 + 4; } // u32_low
    if ( value.u32_high != 1 ) { bytes += TableLebBytes( ids.ref_at( 79, 0x9759be8ea1a4e3d2ull ) ) + 1 + 4; } // u32_high
    if ( value.u32_inside != 1 ) { bytes += TableLebBytes( ids.ref_at( 75, 0x8dc515fc082e3c0eull ) ) + 1 + 4; } // u32_inside
    if ( value.u64_span != 0 ) { bytes += TableLebBytes( ids.ref_at( 110, 0xbeecef11dbdf8973ull ) ) + 1 + 8; } // u64_span
    if ( value.u64_low != 0 ) { bytes += TableLebBytes( ids.ref_at( 0, 0x0117ad66e0fff227ull ) ) + 1 + 8; } // u64_low
    if ( value.u64_high != 1ull ) { bytes += TableLebBytes( ids.ref_at( 145, 0xf2b45af3b50689dbull ) ) + 1 + 8; } // u64_high
    if ( value.u64_inside != 1ull ) { bytes += TableLebBytes( ids.ref_at( 63, 0x713e12017eebcaf7ull ) ) + 1 + 8; } // u64_inside
    if ( value.counts_count < 0 || value.counts_count > 4 ) { return -1; } // storage invariant
    if ( value.counts_count > 0 )
    {
        const uint64_t ref_counts = ids.ref_at( 113, 0xc341febe5aae51e5ull );
...
TABLEDEMO_TABLE_INLINE bool RangedUnsignedSaveBody( TableWriter & w, TableIds & ids, const RangedUnsigned & value )
{
    ...
    if ( value.u8_low != 0 )
    {
        w.header( ids.ref_at( 29, 0x2e17553f8200a2a1ull ), 6 ); // u8_low
        w.put8( uint8_t( value.u8_low ) );
    }
    if ( value.u8_high != 1 )
    {
        w.header( ids.ref_at( 85, 0xa0e5c60df9301b7dull ), 6 ); // u8_high
    ...
    if ( value.u16_span != 0 )
    {
        w.header( ids.ref_at( 47, 0x4ca0c150b1790960ull ), 7 ); // u16_span
        w.put16( uint16_t( value.u16_span ) );
    }
    if ( value.u16_low != 0 )
    {
        w.header( ids.ref_at( 144, 0xf252136836b04cb2ull ), 7 ); // u16_low
        w.put16( uint16_t( value.u16_low ) );
    }
    if ( value.u16_high != 1 )
    {
        w.header( ids.ref_at( 49, 0x4f37e1f216e7610cull ), 7 ); // u16_high
        w.put16( uint16_t( value.u16_high ) );
    }
    if ( value.u16_inside != 1 )
    {
        w.header( ids.ref_at( 126, 0xd176b605978f3304ull ), 7 ); // u16_inside
    ...
    if ( value.u32_low != 0 )
    {
        w.header( ids.ref_at( 88, 0xa53d2f2a31b5acb0ull ), 8 ); // u32_low
        w.put32( uint32_t( value.u32_low ) );
    }
    if ( value.u32_high != 1 )
    {
        w.header( ids.ref_at( 79, 0x9759be8ea1a4e3d2ull ), 8 ); // u32_high
        w.put32( uint32_t( value.u32_high ) );
    }
    if ( value.u32_inside != 1 )
    {
        w.header( ids.ref_at( 75, 0x8dc515fc082e3c0eull ), 8 ); // u32_inside
        w.put32( uint32_t( value.u32_inside ) );
    }
    if ( value.u64_span != 0 )
    {
        w.header( ids.ref_at( 110, 0xbeecef11dbdf8973ull ), 9 ); // u64_span
    ...
    {
        w.header( ids.ref_at( 145, 0xf2b45af3b50689dbull ), 9 ); // u64_high
        w.put64( uint64_t( value.u64_high ) );
    }
    if ( value.u64_inside != 1ull )
    {
        w.header( ids.ref_at( 63, 0x713e12017eebcaf7ull ), 9 ); // u64_inside
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else if ( elem_kind != 9 )
                    {
                        ...
                        for ( uint64_t widened_i = 0; widened_i < widened_keep; widened_i++ )
                        {
                            ...
                            uint64_t decoded_v = (uint64_t) widened_v;
                            value.counts[(int32_t) widened_i] = decoded_v;
                            widened_decoded = widened_i + 1;
                        }
...
inline int64_t RangedUnsignedMeasureMessageBody( int64_t at, const RangedUnsigned & value )
{
    ...
    if ( value.counts_count > 0 )
    {
        bits += kTableMessageRefBitsHere;
        bits += 3;
        bits += (int64_t) ( value.counts_count ) * 64;
    }
    bits += kTableMessageRefBitsHere; // the ZERO REFERENCE that ends the body
    (void) at;
    return bits;
...
inline bool RangedUnsignedSaveMessageBody( TableBitWriter & w, const RangedUnsigned & value )
{
    if ( value.u8_span != 0 )
    {
        ...
        w.put( (uint64_t) ( value.u8_span ), 8 );
    }
    if ( value.u8_low != 0 )
    {
        w.put( 70, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u8_low ), 8 );
    }
    if ( value.u8_high != 1 )
    {
        w.put( 71, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u8_high ) - 1ull, 8 );
    }
    if ( value.u8_inside != 1 )
    {
        w.put( 72, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u8_inside ) - 1ull, 8 );
    }
    if ( value.u16_span != 0 )
    {
        w.put( 73, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u16_span ), 16 );
    }
    if ( value.u16_low != 0 )
    {
        w.put( 74, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u16_low ), 16 );
    }
    if ( value.u16_high != 1 )
    {
        w.put( 75, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u16_high ) - 1ull, 16 );
    }
    if ( value.u16_inside != 1 )
    {
        w.put( 76, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u16_inside ) - 1ull, 16 );
    }
    if ( value.u32_span != 0 )
    {
        w.put( 77, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u32_span ), 32 );
    }
    if ( value.u32_low != 0 )
    {
        w.put( 78, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u32_low ), 32 );
    }
    if ( value.u32_high != 1 )
    {
        w.put( 79, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u32_high ) - 1ull, 32 );
    }
    if ( value.u32_inside != 1 )
    {
        w.put( 80, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u32_inside ) - 1ull, 32 );
    }
    if ( value.u64_span != 0 )
    {
        w.put( 81, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u64_span ), 64 );
    }
    if ( value.u64_low != 0 )
    {
        w.put( 82, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u64_low ), 64 );
    }
    if ( value.u64_high != 1ull )
    {
        w.put( 83, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u64_high ) - 1ull, 64 );
    }
    if ( value.u64_inside != 1ull )
    {
        w.put( 84, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.u64_inside ) - 1ull, 64 );
    }
    if ( value.counts_count < 0 || value.counts_count > 4 ) { return false; } // storage invariant
    if ( value.counts_count > 0 )
    {
        w.put( 85, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.counts_count ) - 0, 3 );
        for ( int32_t i = 0; i < value.counts_count; i++ )
        {
            w.put( (uint64_t) ( value.counts[i] ), 64 );
        }
    }
    w.put( 0, kTableMessageRefBitsHere ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
        ...
        switch ( entry.id )
        {
            ...
            case 0x2e17553f8200a2a1ull: // u8_low
            {
                ...
                }
                {
                    ...
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
                    if ( (uint64_t) decoded_wide > 254ull ) { decoded_wide = (int64_t) 254ull; report->clamped++; }
                    uint8_t decoded_v = (uint8_t) decoded_wide;
                    value.u8_low = decoded_v;
                }
                break;
                    ...
                    {
                        {
                            ...
                            int64_t decoded_wide = (int64_t) raw;
                            if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
                            if ( (uint64_t) decoded_wide > 65534ull ) { decoded_wide = (int64_t) 65534ull; report->clamped++; }
                            uint16_t decoded_v = (uint16_t) decoded_wide;
                            value.u16_low = decoded_v;
                        }
                        report->widened++;
                    ...
                    {
                        {
                            ...
                            int64_t decoded_wide = (int64_t) raw;
                            if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
                            if ( (uint64_t) decoded_wide > 4294967294ull ) { decoded_wide = (int64_t) 4294967294ull; report->clamped++; }
                            uint32_t decoded_v = (uint32_t) decoded_wide;
                            value.u32_low = decoded_v;
                        }
                        report->widened++;
                    ...
                    {
                        {
                            ...
                            int64_t decoded_wide = (int64_t) raw;
                            if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
                            if ( (uint64_t) decoded_wide > 18446744073709551614ull ) { decoded_wide = (int64_t) 18446744073709551614ull; report->clamped++; }
                            uint64_t decoded_v = (uint64_t) decoded_wide;
                            value.u64_low = decoded_v;
                        }
                        report->widened++;
            ...
            case 0xc341febe5aae51e5ull: // counts
            {
                ...
                {
                    if ( entry.kind == 14 && TableKindWidens( entry.elem_kind, 9 ) )
                    {
                        {
                            uint64_t n = (uint64_t) entry.min;
                            const int64_t count_bits = TableBitsRequired( entry.min, entry.max );
                            ...
                            for ( uint64_t i = 0; i < walk; i++ )
                            {
                                ...
                                if ( in_bounds ) { value.counts[i] = scratch; }
                            }
                            if ( walk < n && !TableMessageSkipRun( r, n - walk, surplus_bits ) ) { report->malformed = true; return false; }
                            value.counts_count = kept;
                        }
                        report->widened++;
                        break;
                    }
...
// refusal is learned at MEASURE time, before a buffer is allocated, and a
// caller with more bodies calls again.
inline int64_t RangedUnsignedMeasureMessages( const RangedUnsigned * values, int64_t count, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    int64_t bits = 8; // the body count, a ranged integer over [1, 256]
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = RangedUnsignedMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8; // the form byte, then the stream padded to a byte
...
inline int64_t RangedUnsignedSaveMessages( const RangedUnsigned * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !RangedUnsignedSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == RangedUnsignedMeasureMessages( values, count, report )
}
...
// BODIES 1 TO k - 1: count says k - 1, one malformed counts, and the storage
// after it is not a body.
inline bool RangedUnsignedLoadMessages( RangedUnsigned * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    if ( values == NULL || count == NULL ) { to->malformed = true; return false; }
    ...
    *count = 0;
    ...
    for ( int64_t i = 0; i < bodies; i++ )
    {
        if ( !RangedUnsignedLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
inline int64_t RangedWidthsMeasureBody( TableIds & ids, const RangedWidths & value )
{
    ...
    if ( value.b16 != 0 ) { bytes += TableLebBytes( ids.ref_at( 150, 0xff95701912ad97beull ) ) + 1 + 2; } // b16
    if ( value.b32 != 0 ) { bytes += TableLebBytes( ids.ref_at( 152, 0xff9c5c1912b39470ull ) ) + 1 + 4; } // b32
    if ( value.b64 != 0 ) { bytes += TableLebBytes( ids.ref_at( 149, 0xff92701912ab61e7ull ) ) + 1 + 8; } // b64
    if ( value.b12 != 0 ) { bytes += TableLebBytes( ids.ref_at( 151, 0xff95741912ad9e8aull ) ) + 1 + 2; } // b12
    if ( value.b48 != 0 ) { bytes += TableLebBytes( ids.ref_at( 148, 0xff8b681912a535a1ull ) ) + 1 + 8; } // b48
    return bytes;
}
...
TABLEDEMO_TABLE_INLINE bool RangedWidthsSaveBody( TableWriter & w, TableIds & ids, const RangedWidths & value )
{
    ...
    if ( value.b16 != 0 )
    {
        w.header( ids.ref_at( 150, 0xff95701912ad97beull ), 7 ); // b16
        w.put16( uint16_t( value.b16 ) );
    }
    if ( value.b32 != 0 )
    {
        w.header( ids.ref_at( 152, 0xff9c5c1912b39470ull ), 8 ); // b32
        w.put32( uint32_t( value.b32 ) );
    }
    if ( value.b64 != 0 )
    {
        w.header( ids.ref_at( 149, 0xff92701912ab61e7ull ), 9 ); // b64
        w.put64( uint64_t( value.b64 ) );
    }
    if ( value.b12 != 0 )
    {
        w.header( ids.ref_at( 151, 0xff95741912ad9e8aull ), 7 ); // b12
        w.put16( uint16_t( value.b12 ) );
    }
    if ( value.b48 != 0 )
    {
        w.header( ids.ref_at( 148, 0xff8b681912a535a1ull ), 9 ); // b48
...
inline bool RangedWidthsSaveMessageBody( TableBitWriter & w, const RangedWidths & value )
{
    if ( value.b8 != 0 )
    {
        w.put( 86, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b8 ), 8 );
    }
    if ( value.b16 != 0 )
    {
        w.put( 87, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b16 ), 16 );
    }
    if ( value.b32 != 0 )
    {
        w.put( 88, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b32 ), 32 );
    }
    if ( value.b64 != 0 )
    {
        w.put( 89, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b64 ), 64 );
    }
    if ( value.b12 != 0 )
    {
        w.put( 90, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b12 ), 12 );
    }
    if ( value.b48 != 0 )
    {
        w.put( 91, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.b48 ), 48 );
    }
    w.put( 0, kTableMessageRefBitsHere ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
// refusal is learned at MEASURE time, before a buffer is allocated, and a
// caller with more bodies calls again.
inline int64_t RangedWidthsMeasureMessages( const RangedWidths * values, int64_t count, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    int64_t bits = 8; // the body count, a ranged integer over [1, 256]
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = RangedWidthsMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8; // the form byte, then the stream padded to a byte
...
inline int64_t RangedWidthsSaveMessages( const RangedWidths * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !RangedWidthsSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == RangedWidthsMeasureMessages( values, count, report )
}
...
// BODIES 1 TO k - 1: count says k - 1, one malformed counts, and the storage
// after it is not a body.
inline bool RangedWidthsLoadMessages( RangedWidths * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    if ( values == NULL || count == NULL ) { to->malformed = true; return false; }
    ...
    *count = 0;
    ...
    for ( int64_t i = 0; i < bodies; i++ )
    {
        if ( !RangedWidthsLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
{
    (void) b; (void) value;
    TableFixedPut8( b + 0, (uint8_t) value.i8_span );
    TableFixedPut8( b + 1, (uint8_t) value.i8_low );
    TableFixedPut8( b + 2, (uint8_t) value.i8_high );
    TableFixedPut8( b + 3, (uint8_t) value.i8_inside );
    TableFixedPut16( b + 4, (uint16_t) value.i16_span );
    TableFixedPut16( b + 6, (uint16_t) value.i16_low );
    TableFixedPut16( b + 8, (uint16_t) value.i16_high );
    TableFixedPut16( b + 10, (uint16_t) value.i16_inside );
    TableFixedPut32( b + 12, (uint32_t) value.i32_span );
    TableFixedPut32( b + 16, (uint32_t) value.i32_low );
    TableFixedPut32( b + 20, (uint32_t) value.i32_high );
    TableFixedPut32( b + 24, (uint32_t) value.i32_inside );
    TableFixedPut64( b + 28, (uint64_t) value.i64_span );
...
{
    (void) b; (void) value;
    TableFixedPut8( b + 0, (uint8_t) value.u8_span );
    TableFixedPut8( b + 1, (uint8_t) value.u8_low );
    TableFixedPut8( b + 2, (uint8_t) value.u8_high );
    TableFixedPut8( b + 3, (uint8_t) value.u8_inside );
    TableFixedPut16( b + 4, (uint16_t) value.u16_span );
    TableFixedPut16( b + 6, (uint16_t) value.u16_low );
    TableFixedPut16( b + 8, (uint16_t) value.u16_high );
    TableFixedPut16( b + 10, (uint16_t) value.u16_inside );
    TableFixedPut32( b + 12, (uint32_t) value.u32_span );
    TableFixedPut32( b + 16, (uint32_t) value.u32_low );
    TableFixedPut32( b + 20, (uint32_t) value.u32_high );
    TableFixedPut32( b + 24, (uint32_t) value.u32_inside );
    TableFixedPut64( b + 28, (uint64_t) value.u64_span );
...
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.b8 );
    TableFixedPut32( b + 4, (uint32_t) value.b16 );
    TableFixedPut32( b + 8, (uint32_t) value.b32 );
    TableFixedPut64( b + 12, (uint64_t) value.b64 );
    TableFixedPut32( b + 20, (uint32_t) value.b12 );
...
constexpr uint64_t RangedSignedFixedHash = 0xcbf32b9992cc8183ull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t RangedSignedFixedLayout[] = {
    ...
    ,
...
constexpr TableFixedEntry RangedSignedFixedPlan[] = {
    { 0u, 0u, 28u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // i8_span
    { 28u, 32u, 32u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // i64_span
    { 60u, 72u, 4u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0, 0, 1 }, // edges count
    { 64u, 64u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // edges, whole
};
...
constexpr TableFixedFill RangedSignedFixedCover[] = {
    { 0u, 28u },
    { 32u, 44u },
};
constexpr int32_t RangedSignedFixedCoverCount = 2;
...
constexpr uint64_t RangedSignedFixedLineage[] = {
    0xcbf32b9992cc8183ull, // identity
};
constexpr int32_t RangedSignedFixedLineageCount = 1;
constexpr int32_t RangedSignedFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t RangedSignedFixedFloorLive = RangedSignedFixedFloor;
inline void RangedSignedFixedSetFloorForTest( int32_t index ) { RangedSignedFixedFloorLive = index; }
#endif

constexpr uint8_t RangedSignedFixedKnown0Layout[] = {
    0x13, 0x00, 0x00, 0x00, 0x2e, 0xbe, 0x28, 0xda, 0x1d, 0x75, 0x79, 0xec, 0x0d, 0x48, 0x00, 0x00,
    0x00, 0x11, 0x00, 0x00, 0x00, 0xb5, 0x2e, 0x70, 0xbf, 0x11, 0x15, 0x12, 0x48, 0x02, 0x01, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7d, 0x0f, 0x09, 0x68, 0x31, 0xfe, 0x2b, 0x94, 0x02, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd1, 0x5d, 0xb5, 0x05, 0xd1, 0xac, 0x82, 0xd1, 0x02,
...
constexpr TableFixedKnownLayout RangedSignedFixedKnown[] = {
    { 0xcbf32b9992cc8183ull, RangedSignedFixedKnown0Layout, 327, 80 }, // identity
};

constexpr const TableFixedKnownRange * RangedSignedFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t RangedSignedFixedKnownRangeCounts[] = { 0 };
...
inline int64_t RangedSignedFixedSave( const RangedSigned * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = RangedSignedFixedMeasure( count );
    ...
    TableFixedPut64( buffer + kTableFixedHashAt, RangedSignedFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) RangedSignedFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, RangedSignedFixedLayout, (size_t) RangedSignedFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + RangedSignedFixedLayoutBytes;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    for ( int32_t i = 0; i < RangedSignedFixedLineageCount; ++i )
    {
        if ( RangedSignedFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = RangedSignedFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = RangedSignedFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = RangedSignedFixedKnown[lineage_at];
    ...
    if ( hash != RangedSignedFixedHash )
    {
        ...
        else
        {
            ...
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, RangedSignedFixedLayout, (int32_t) RangedSignedFixedLayoutBytes, RangedSignedFixedDst,
                                                   RangedSignedFixedCover, RangedSignedFixedCoverCount,
    ...
    RangedSigned defaults;
    if ( fill_count > 0 )
    {
        memset( (void *) &defaults, 0, sizeof( defaults ) );
        RangedSignedReset( defaults );
    }
    for ( int64_t k = 0; k < n; ++k )
    {
        ...
        TableFixedClampKnownRanges( RangedSignedFixedKnownRanges[lineage_at], RangedSignedFixedKnownRangeCounts[lineage_at],
...
constexpr uint64_t RangedUnsignedFixedHash = 0x8b7880ef6aaed3c0ull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t RangedUnsignedFixedLayout[] = {
    ...
    ,
...
constexpr TableFixedEntry RangedUnsignedFixedPlan[] = {
    { 0u, 0u, 28u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // u8_span
    { 28u, 32u, 32u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // u64_span
    { 60u, 96u, 4u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0, 0, 1 }, // counts count
    { 64u, 64u, 32u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // counts, whole
};
...
// twice; a plan compiled from a stranger's layout subtracts itself from it
// once, when the plan is compiled, and prefills exactly the rest.
constexpr TableFixedFill RangedUnsignedFixedCover[] = {
    { 0u, 28u },
    { 32u, 68u },
};
constexpr int32_t RangedUnsignedFixedCoverCount = 2;

// THE LINEAGE, oldest first, the reader's own last (bill §6b). LOAD looks
// the file's header hash up here and never parses a stranger's layout.
constexpr uint64_t RangedUnsignedFixedLineage[] = {
    0x8b7880ef6aaed3c0ull, // identity
};
constexpr int32_t RangedUnsignedFixedLineageCount = 1;
constexpr int32_t RangedUnsignedFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t RangedUnsignedFixedFloorLive = RangedUnsignedFixedFloor;
inline void RangedUnsignedFixedSetFloorForTest( int32_t index ) { RangedUnsignedFixedFloorLive = index; }
#endif

constexpr uint8_t RangedUnsignedFixedKnown0Layout[] = {
    0x13, 0x00, 0x00, 0x00, 0xf1, 0x8b, 0xd2, 0xb7, 0xc4, 0xc0, 0x1e, 0x03, 0x0d, 0x60, 0x00, 0x00,
    0x00, 0x11, 0x00, 0x00, 0x00, 0x21, 0xc0, 0x37, 0x7f, 0x55, 0x97, 0x88, 0x0f, 0x06, 0x01, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa1, 0xa2, 0x00, 0x82, 0x3f, 0x55, 0x17, 0x2e, 0x06, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7d, 0x1b, 0x30, 0xf9, 0x0d, 0xc6, 0xe5, 0xa0, 0x06,
...
constexpr TableFixedKnownLayout RangedUnsignedFixedKnown[] = {
    { 0x8b7880ef6aaed3c0ull, RangedUnsignedFixedKnown0Layout, 327, 104 }, // identity
};

constexpr const TableFixedKnownRange * RangedUnsignedFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t RangedUnsignedFixedKnownRangeCounts[] = { 0 };
...
inline int64_t RangedUnsignedFixedSave( const RangedUnsigned * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = RangedUnsignedFixedMeasure( count );
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); // the seven reserved bytes, and the rest of the header
    buffer[0] = kTableFixedForm;
    TableFixedPut64( buffer + kTableFixedHashAt, RangedUnsignedFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) RangedUnsignedFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, RangedUnsignedFixedLayout, (size_t) RangedUnsignedFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + RangedUnsignedFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const int64_t rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    int32_t lineage_at = -1;
    for ( int32_t i = 0; i < RangedUnsignedFixedLineageCount; ++i )
    {
        if ( RangedUnsignedFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = RangedUnsignedFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = RangedUnsignedFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = RangedUnsignedFixedKnown[lineage_at];
    if ( (int64_t) layout_bytes != known.layout_bytes || memcmp( layout, known.layout, (size_t) layout_bytes ) != 0 )
    {
        report->refused = true; report->reason = layout_malformed; return -1;
    }
    ...
    if ( hash != RangedUnsignedFixedHash )
    {
        ...
        else
        {
            ...
            int32_t compiled_guarded = 0;
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, RangedUnsignedFixedLayout, (int32_t) RangedUnsignedFixedLayoutBytes, RangedUnsignedFixedDst,
                                                   RangedUnsignedFixedCover, RangedUnsignedFixedCoverCount,
                                                   dest, dest_capacity, &compiled_guarded, &fill_at, &fill_count, report );
            if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_record_too_large : plan_too_large; return -1; }
            record_bytes = known.record_bytes;
            fill = ( fill_count > 0 ) ? (const TableFixedFill *) (const void *) ( (const uint8_t *) dest + fill_at ) : NULL;
    ...
    const int64_t n = rest / record_bytes;
    if ( n > capacity ) { report->refused = true; report->reason = batch_too_large; return -1; }
    RangedUnsigned defaults;
    if ( fill_count > 0 )
    {
        memset( (void *) &defaults, 0, sizeof( defaults ) );
        RangedUnsignedReset( defaults );
    }
    for ( int64_t k = 0; k < n; ++k )
    {
        if ( TableFixedGet64( at ) != hash ) { report->refused = true; report->reason = no_layout; return -1; }
        TableFixedFillRun( fill, fill_count, (const uint8_t *) &defaults, (uint8_t *) &values[k] );
        TableFixedRun( entries, entry_count, entry_guarded, at + 8, (uint8_t *) &values[k], report );
        TableFixedClampKnownRanges( RangedUnsignedFixedKnownRanges[lineage_at], RangedUnsignedFixedKnownRangeCounts[lineage_at],
                                    (uint8_t *) &values[k], report );
...
constexpr uint64_t RangedWidthsFixedHash = 0xe45869be02e1f158ull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t RangedWidthsFixedLayout[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, 0x94, 0xb3, 0x12, 0x19, 0x5c, 0x9c, 0xff, 0x08,
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xe7, 0x61, 0xab, 0x12, 0x19, 0x70, 0x92, 0xff,
    0x09, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8a, 0x9e, 0xad, 0x12, 0x19, 0x74, 0x95,
...
constexpr TableFixedEntry RangedWidthsFixedPlan[] = {
    { 0u, 0u, 12u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // b8
    { 12u, 16u, 12u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // b64
    { 24u, 32u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // b48
};
...
// twice; a plan compiled from a stranger's layout subtracts itself from it
// once, when the plan is compiled, and prefills exactly the rest.
constexpr TableFixedFill RangedWidthsFixedCover[] = {
    { 0u, 12u },
    { 16u, 12u },
    { 32u, 8u },
};
constexpr int32_t RangedWidthsFixedCoverCount = 3;

// THE LINEAGE, oldest first, the reader's own last (bill §6b). LOAD looks
// the file's header hash up here and never parses a stranger's layout.
constexpr uint64_t RangedWidthsFixedLineage[] = {
    0xe45869be02e1f158ull, // identity
};
constexpr int32_t RangedWidthsFixedLineageCount = 1;
constexpr int32_t RangedWidthsFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t RangedWidthsFixedFloorLive = RangedWidthsFixedFloor;
inline void RangedWidthsFixedSetFloorForTest( int32_t index ) { RangedWidthsFixedFloorLive = index; }
#endif

constexpr uint8_t RangedWidthsFixedKnown0Layout[] = {
    0x07, 0x00, 0x00, 0x00, 0xd7, 0x5e, 0x4f, 0x9e, 0x4e, 0x69, 0x59, 0xbf, 0x0d, 0x20, 0x00, 0x00,
    0x00, 0x06, 0x00, 0x00, 0x00, 0xc7, 0x8d, 0x4d, 0xb5, 0x07, 0x0c, 0xa6, 0x08, 0x06, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbe, 0x97, 0xad, 0x12, 0x19, 0x70, 0x95, 0xff, 0x07, 0x04,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, 0x94, 0xb3, 0x12, 0x19, 0x5c, 0x9c, 0xff, 0x08,
...
constexpr TableFixedKnownLayout RangedWidthsFixedKnown[] = {
    { 0xe45869be02e1f158ull, RangedWidthsFixedKnown0Layout, 123, 40 }, // identity
};

constexpr const TableFixedKnownRange * RangedWidthsFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t RangedWidthsFixedKnownRangeCounts[] = { 0 };
...
inline int64_t RangedWidthsFixedSave( const RangedWidths * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = RangedWidthsFixedMeasure( count );
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); // the seven reserved bytes, and the rest of the header
    buffer[0] = kTableFixedForm;
    TableFixedPut64( buffer + kTableFixedHashAt, RangedWidthsFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) RangedWidthsFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, RangedWidthsFixedLayout, (size_t) RangedWidthsFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + RangedWidthsFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const int64_t rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    int32_t lineage_at = -1;
    for ( int32_t i = 0; i < RangedWidthsFixedLineageCount; ++i )
    {
        if ( RangedWidthsFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = RangedWidthsFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = RangedWidthsFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = RangedWidthsFixedKnown[lineage_at];
    if ( (int64_t) layout_bytes != known.layout_bytes || memcmp( layout, known.layout, (size_t) layout_bytes ) != 0 )
    {
        report->refused = true; report->reason = layout_malformed; return -1;
    }
    ...
    if ( hash != RangedWidthsFixedHash )
    {
        ...
        else
        {
            ...
            int32_t compiled_guarded = 0;
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, RangedWidthsFixedLayout, (int32_t) RangedWidthsFixedLayoutBytes, RangedWidthsFixedDst,
                                                   RangedWidthsFixedCover, RangedWidthsFixedCoverCount,
                                                   dest, dest_capacity, &compiled_guarded, &fill_at, &fill_count, report );
            if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_record_too_large : plan_too_large; return -1; }
            record_bytes = known.record_bytes;
            fill = ( fill_count > 0 ) ? (const TableFixedFill *) (const void *) ( (const uint8_t *) dest + fill_at ) : NULL;
    ...
    const int64_t n = rest / record_bytes;
    if ( n > capacity ) { report->refused = true; report->reason = batch_too_large; return -1; }
    RangedWidths defaults;
    if ( fill_count > 0 )
    {
        memset( (void *) &defaults, 0, sizeof( defaults ) );
        RangedWidthsReset( defaults );
    }
    for ( int64_t k = 0; k < n; ++k )
    {
        if ( TableFixedGet64( at ) != hash ) { report->refused = true; report->reason = no_layout; return -1; }
        TableFixedFillRun( fill, fill_count, (const uint8_t *) &defaults, (uint8_t *) &values[k] );
        TableFixedRun( entries, entry_count, entry_guarded, at + 8, (uint8_t *) &values[k], report );
        TableFixedClampKnownRanges( RangedWidthsFixedKnownRanges[lineage_at], RangedWidthsFixedKnownRangeCounts[lineage_at],
                                    (uint8_t *) &values[k], report );
...
template <typename... Args>
inline void RangedSignedSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedSigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedSignedLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedSigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedSignedSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedSigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedUnsignedLoadRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedUnsigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}

template <typename... Args>
inline void RangedUnsignedMeasureRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedUnsigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedUnsignedSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedUnsigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedUnsignedLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedUnsigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedUnsignedSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedUnsigned is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedWidthsLoadRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedWidths is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}

template <typename... Args>
inline void RangedWidthsMeasureRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedWidths is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedWidthsSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedWidths is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedWidthsLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedWidths is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void RangedWidthsSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "RangedWidths is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
// parameter on a load.
inline const RangedSigned * RangedSignedOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const RangedSigned *) TableCookOpen( bytes, length, (uint64_t) sizeof( RangedSigned ), (uint64_t) alignof( RangedSigned ), reason );
}
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const RangedUnsigned * RangedUnsignedOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const RangedUnsigned *) TableCookOpen( bytes, length, (uint64_t) sizeof( RangedUnsigned ), (uint64_t) alignof( RangedUnsigned ), reason );
}
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const RangedWidths * RangedWidthsOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const RangedWidths *) TableCookOpen( bytes, length, (uint64_t) sizeof( RangedWidths ), (uint64_t) alignof( RangedWidths ), reason );
}
...
extern const TableTypeInfo RangedSignedTableInfo;
extern const TableTypeInfo RangedUnsignedTableInfo;
extern const TableTypeInfo RangedWidthsTableInfo;

inline const TableFieldInfo RangedSignedTableFields[] = {
    { "i8_span", "i8_span", "int8", 0x48121511bf702eb5ull, 2, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i8_span ), (uint32_t) sizeof( RangedSigned::i8_span ), 0xffffffffu, 0xffffffffu, NULL, true, -128.0, 127.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i8_low", "i8_low", "int8", 0x942bfe3168090f7dull, 2, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i8_low ), (uint32_t) sizeof( RangedSigned::i8_low ), 0xffffffffu, 0xffffffffu, NULL, true, -128.0, 126.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i8_high", "i8_high", "int8", 0xd182acd105b55dd1ull, 2, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i8_high ), (uint32_t) sizeof( RangedSigned::i8_high ), 0xffffffffu, 0xffffffffu, NULL, true, -127.0, 127.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i8_inside", "i8_inside", "int8", 0xef9ded23c8912a81ull, 2, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i8_inside ), (uint32_t) sizeof( RangedSigned::i8_inside ), 0xffffffffu, 0xffffffffu, NULL, true, -127.0, 126.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i16_span", "i16_span", "int16", 0xb655574ea23760b4ull, 3, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i16_span ), (uint32_t) sizeof( RangedSigned::i16_span ), 0xffffffffu, 0xffffffffu, NULL, true, -32768.0, 32767.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i16_low", "i16_low", "int16", 0xd217b3af8d7a2bdeull, 3, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i16_low ), (uint32_t) sizeof( RangedSigned::i16_low ), 0xffffffffu, 0xffffffffu, NULL, true, -32768.0, 32766.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i16_high", "i16_high", "int16", 0x90652f70c9127900ull, 3, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i16_high ), (uint32_t) sizeof( RangedSigned::i16_high ), 0xffffffffu, 0xffffffffu, NULL, true, -32767.0, 32767.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i16_inside", "i16_inside", "int16", 0x6a659d7c354db158ull, 3, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i16_inside ), (uint32_t) sizeof( RangedSigned::i16_inside ), 0xffffffffu, 0xffffffffu, NULL, true, -32767.0, 32766.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i32_span", "i32_span", "int32", 0xe693bd88532c91d6ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i32_span ), (uint32_t) sizeof( RangedSigned::i32_span ), 0xffffffffu, 0xffffffffu, NULL, true, -2.147483648e+09, 2.147483647e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i32_low", "i32_low", "int32", 0x065ee827cf99fbb4ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i32_low ), (uint32_t) sizeof( RangedSigned::i32_low ), 0xffffffffu, 0xffffffffu, NULL, true, -2.147483648e+09, 2.147483646e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i32_high", "i32_high", "int32", 0xc9b121c4c2a186eeull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i32_high ), (uint32_t) sizeof( RangedSigned::i32_high ), 0xffffffffu, 0xffffffffu, NULL, true, -2.147483647e+09, 2.147483647e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i32_inside", "i32_inside", "int32", 0xd363dfa465acf27aull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i32_inside ), (uint32_t) sizeof( RangedSigned::i32_inside ), 0xffffffffu, 0xffffffffu, NULL, true, -2.147483647e+09, 2.147483646e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i64_span", "i64_span", "int64", 0x7549c70700c49d6full, 5, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i64_span ), (uint32_t) sizeof( RangedSigned::i64_span ), 0xffffffffu, 0xffffffffu, NULL, true, -9.223372036854776e+18, 9.223372036854776e+18, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i64_low", "i64_low", "int64", 0x1cce6617419771dbull, 5, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i64_low ), (uint32_t) sizeof( RangedSigned::i64_low ), 0xffffffffu, 0xffffffffu, NULL, true, -9.223372036854776e+18, 9.223372036854776e+18, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i64_high", "i64_high", "int64", 0x3b54fa60620b5597ull, 5, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i64_high ), (uint32_t) sizeof( RangedSigned::i64_high ), 0xffffffffu, 0xffffffffu, NULL, true, -9.223372036854776e+18, 9.223372036854776e+18, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "i64_inside", "i64_inside", "int64", 0xd308fcb98ece5d23ull, 5, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedSigned, i64_inside ), (uint32_t) sizeof( RangedSigned::i64_inside ), 0xffffffffu, 0xffffffffu, NULL, true, -9.223372036854776e+18, 9.223372036854776e+18, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "edges", "edges", "int16", 0xc70cde6b85b6197dull, 3, true, false, NULL, NULL, true, false, 4, (uint32_t) offsetof( RangedSigned, edges ), (uint32_t) sizeof( RangedSigned::edges[0] ), (uint32_t) offsetof( RangedSigned, edges_count ), 0xffffffffu, NULL, true, -32768.0, 32767.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo RangedSignedTableInfo = { "RangedSigned", (uint32_t) sizeof( RangedSigned ), 17, RangedSignedTableFields, +[]( void * p ) { RangedSignedReset( *(RangedSigned *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * RangedSignedTableType() { return &RangedSignedTableInfo; }

inline const TableFieldInfo RangedUnsignedTableFields[] = {
    { "u8_span", "u8_span", "uint8", 0x0f8897557f37c021ull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u8_span ), (uint32_t) sizeof( RangedUnsigned::u8_span ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 255.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u8_low", "u8_low", "uint8", 0x2e17553f8200a2a1ull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u8_low ), (uint32_t) sizeof( RangedUnsigned::u8_low ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 254.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u8_high", "u8_high", "uint8", 0xa0e5c60df9301b7dull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u8_high ), (uint32_t) sizeof( RangedUnsigned::u8_high ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 255.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u8_inside", "u8_inside", "uint8", 0x1cb2c073a6f5844dull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u8_inside ), (uint32_t) sizeof( RangedUnsigned::u8_inside ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 254.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u16_span", "u16_span", "uint16", 0x4ca0c150b1790960ull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u16_span ), (uint32_t) sizeof( RangedUnsigned::u16_span ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 65535.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u16_low", "u16_low", "uint16", 0xf252136836b04cb2ull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u16_low ), (uint32_t) sizeof( RangedUnsigned::u16_low ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 65534.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u16_high", "u16_high", "uint16", 0x4f37e1f216e7610cull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u16_high ), (uint32_t) sizeof( RangedUnsigned::u16_high ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 65535.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u16_inside", "u16_inside", "uint16", 0xd176b605978f3304ull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u16_inside ), (uint32_t) sizeof( RangedUnsigned::u16_inside ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 65534.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u32_span", "u32_span", "uint32", 0x200b924de7479cdaull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u32_span ), (uint32_t) sizeof( RangedUnsigned::u32_span ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 4.294967295e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u32_low", "u32_low", "uint32", 0xa53d2f2a31b5acb0ull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u32_low ), (uint32_t) sizeof( RangedUnsigned::u32_low ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 4.294967294e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u32_high", "u32_high", "uint32", 0x9759be8ea1a4e3d2ull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u32_high ), (uint32_t) sizeof( RangedUnsigned::u32_high ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 4.294967295e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u32_inside", "u32_inside", "uint32", 0x8dc515fc082e3c0eull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u32_inside ), (uint32_t) sizeof( RangedUnsigned::u32_inside ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 4.294967294e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u64_span", "u64_span", "uint64", 0xbeecef11dbdf8973ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u64_span ), (uint32_t) sizeof( RangedUnsigned::u64_span ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u64_low", "u64_low", "uint64", 0x0117ad66e0fff227ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u64_low ), (uint32_t) sizeof( RangedUnsigned::u64_low ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u64_high", "u64_high", "uint64", 0xf2b45af3b50689dbull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u64_high ), (uint32_t) sizeof( RangedUnsigned::u64_high ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "u64_inside", "u64_inside", "uint64", 0x713e12017eebcaf7ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedUnsigned, u64_inside ), (uint32_t) sizeof( RangedUnsigned::u64_inside ), 0xffffffffu, 0xffffffffu, NULL, true, 1.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "counts", "counts", "uint64", 0xc341febe5aae51e5ull, 9, true, false, NULL, NULL, true, false, 4, (uint32_t) offsetof( RangedUnsigned, counts ), (uint32_t) sizeof( RangedUnsigned::counts[0] ), (uint32_t) offsetof( RangedUnsigned, counts_count ), 0xffffffffu, NULL, true, 0.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo RangedUnsignedTableInfo = { "RangedUnsigned", (uint32_t) sizeof( RangedUnsigned ), 17, RangedUnsignedTableFields, +[]( void * p ) { RangedUnsignedReset( *(RangedUnsigned *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * RangedUnsignedTableType() { return &RangedUnsignedTableInfo; }

inline const TableFieldInfo RangedWidthsTableFields[] = {
    { "b8", "b8", "bits(8)", 0x08a60c07b54d8dc7ull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b8 ), (uint32_t) sizeof( RangedWidths::b8 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 255.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "b16", "b16", "bits(16)", 0xff95701912ad97beull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b16 ), (uint32_t) sizeof( RangedWidths::b16 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 65535.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "b32", "b32", "bits(32)", 0xff9c5c1912b39470ull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b32 ), (uint32_t) sizeof( RangedWidths::b32 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 4.294967295e+09, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "b64", "b64", "bits(64)", 0xff92701912ab61e7ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b64 ), (uint32_t) sizeof( RangedWidths::b64 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 1.8446744073709552e+19, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "b12", "b12", "bits(12)", 0xff95741912ad9e8aull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b12 ), (uint32_t) sizeof( RangedWidths::b12 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 4095.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "b48", "b48", "bits(48)", 0xff8b681912a535a1ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( RangedWidths, b48 ), (uint32_t) sizeof( RangedWidths::b48 ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 2.81474976710655e+14, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo RangedWidthsTableInfo = { "RangedWidths", (uint32_t) sizeof( RangedWidths ), 6, RangedWidthsTableFields, +[]( void * p ) { RangedWidthsReset( *(RangedWidths *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * RangedWidthsTableType() { return &RangedWidthsTableInfo; }
