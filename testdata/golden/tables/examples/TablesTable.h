...
constexpr TableFixedDst WeaponConfigFixedDst[] = {
    ...
    { (uint32_t) __builtin_offsetof( WeaponConfig, damage ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // damage
    { (uint32_t) __builtin_offsetof( WeaponConfig, speed ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // speed
    { (uint32_t) __builtin_offsetof( WeaponConfig, penetration ), 0, 0, 0, 0, 0ull, 10ull, 7, 4 }, // penetration
    { (uint32_t) __builtin_offsetof( WeaponConfig, channel ), 0, 0, 0, 0, 0ull, 63ull, 2, 4 }, // channel
    { (uint32_t) __builtin_offsetof( WeaponConfig, homing ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // homing
    { (uint32_t) __builtin_offsetof( WeaponConfig, effect ), 0, (uint32_t) __builtin_offsetof( WeaponConfig, effect ) + (uint32_t) __builtin_offsetof( Effect, type ), 0, 0, 0ull, 0ull, 0, 0 }, // effect
    { (uint32_t) __builtin_offsetof( Effect, buff ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // buff
    { (uint32_t) __builtin_offsetof( Buff, multiplier ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // multiplier
    { (uint32_t) __builtin_offsetof( Effect, debuff ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // debuff
    { (uint32_t) __builtin_offsetof( Debuff, amount ), 0, 0, 0, 0, 0ull, 100ull, 7, 4 }, // amount
};
...
constexpr TableFixedDst LoadoutConfigFixedDst[] = {
    ...
    { (uint32_t) __builtin_offsetof( LoadoutConfig, grade ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // grade
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Bronze
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Silver
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Gold
    { (uint32_t) __builtin_offsetof( LoadoutConfig, grades ), (uint32_t) sizeof( Grade ), (uint32_t) __builtin_offsetof( LoadoutConfig, grades_count ), 1, 0, 0ull, 0ull, 0, 0 }, // grades
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // element
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Bronze
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Silver
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Gold
    { (uint32_t) __builtin_offsetof( LoadoutConfig, podium ), (uint32_t) sizeof( Grade ), 0, 0, 0, 0ull, 0ull, 0, 0 }, // podium
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // element
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Bronze
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Silver
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Gold
    { (uint32_t) __builtin_offsetof( LoadoutConfig, perks ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // perks
    { (uint32_t) __builtin_offsetof( LoadoutConfig, primary ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // primary
    { (uint32_t) __builtin_offsetof( WeaponConfig, damage ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // damage
    { (uint32_t) __builtin_offsetof( WeaponConfig, speed ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // speed
    { (uint32_t) __builtin_offsetof( WeaponConfig, penetration ), 0, 0, 0, 0, 0ull, 10ull, 7, 4 }, // penetration
    { (uint32_t) __builtin_offsetof( WeaponConfig, channel ), 0, 0, 0, 0, 0ull, 63ull, 2, 4 }, // channel
    ...
    { (uint32_t) __builtin_offsetof( Effect, debuff ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // debuff
    { (uint32_t) __builtin_offsetof( Debuff, amount ), 0, 0, 0, 0, 0ull, 100ull, 7, 4 }, // amount
    { (uint32_t) __builtin_offsetof( LoadoutConfig, backups ), (uint32_t) sizeof( WeaponConfig ), 0, 0, 0, 0ull, 0ull, 0, 0 }, // backups
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // element
    { (uint32_t) __builtin_offsetof( WeaponConfig, damage ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // damage
    { (uint32_t) __builtin_offsetof( WeaponConfig, speed ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // speed
    { (uint32_t) __builtin_offsetof( WeaponConfig, penetration ), 0, 0, 0, 0, 0ull, 10ull, 7, 4 }, // penetration
    ...
    { (uint32_t) __builtin_offsetof( Effect, debuff ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // debuff
    { (uint32_t) __builtin_offsetof( Debuff, amount ), 0, 0, 0, 0, 0ull, 100ull, 7, 4 }, // amount
    { (uint32_t) __builtin_offsetof( LoadoutConfig, attachments ), (uint32_t) sizeof( Attachment ), (uint32_t) __builtin_offsetof( LoadoutConfig, attachments_count ), 1, 0, 0ull, 0ull, 0, 0 }, // attachments
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // element
    { (uint32_t) __builtin_offsetof( Attachment, slot ), 0, 0, 0, 0, 0ull, 7ull, 7, 4 }, // slot
    { (uint32_t) __builtin_offsetof( Attachment, power ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // power
};
