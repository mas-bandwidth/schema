...
template <typename Ctx> inline int64_t ProfileConfigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ProfileConfig & value );
template <typename Ctx> inline bool ProfileConfigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ProfileConfig & value );
inline bool ProfileConfigLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, ProfileConfig & value );
template <typename Ctx> inline int64_t RootConfigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const RootConfig & value );
template <typename Ctx> inline bool RootConfigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const RootConfig & value );
inline bool RootConfigLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, RootConfig & value );
...
inline void TableReset( WeaponConfig & value ) { WeaponConfigReset( value ); }
inline void TableReset( LoadoutConfig & value ) { LoadoutConfigReset( value ); }
inline void TableReset( ProfileConfig & value ) { ProfileConfigReset( value ); }
inline void TableReset( RootConfig & value ) { RootConfigReset( value ); }
inline void TableReset( Attachment & value ) { AttachmentReset( value ); }
inline void TableReset( Buff & value ) { BuffReset( value ); }
inline void TableReset( Debuff & value ) { DebuffReset( value ); }
...
template <typename Ctx> inline int64_t ProfileConfigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ProfileConfig & value );
template <typename Ctx> inline bool ProfileConfigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ProfileConfig & value );
template <typename Ctx> inline bool ProfileConfigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ProfileConfig & value );
inline bool ProfileConfigLoadBody( TableReader & r, const TableNodeMap & nodes, ProfileConfig & value );
template <typename Ctx> inline int64_t RootConfigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const RootConfig & value );
template <typename Ctx> inline bool RootConfigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const RootConfig & value );
template <typename Ctx> inline bool RootConfigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const RootConfig & value );
inline bool RootConfigLoadBody( TableReader & r, const TableNodeMap & nodes, RootConfig & value );
...
template <typename Ctx> inline bool ProfileConfigNumber( const Ctx & ctx, TableNumbering & numbering, const ProfileConfig & value );
template <typename Ctx> inline int64_t ProfileConfigPackMeasure( const Ctx & ctx, TablePackMap & seen, const ProfileConfig & value );
template <typename Ctx> inline bool ProfileConfigPack( const Ctx & ctx, TablePackMap & seen, const ProfileConfig & src, ProfileConfig & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool RootConfigNumber( const Ctx & ctx, TableNumbering & numbering, const RootConfig & value );
template <typename Ctx> inline int64_t RootConfigPackMeasure( const Ctx & ctx, TablePackMap & seen, const RootConfig & value );
template <typename Ctx> inline bool RootConfigPack( const Ctx & ctx, TablePackMap & seen, const RootConfig & src, RootConfig & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ProfileConfig & value ) { return ProfileConfigMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ProfileConfig & value ) { return ProfileConfigSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ProfileConfig & value ) { return ProfileConfigMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ProfileConfig & value ) { return ProfileConfigSaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const RootConfig & value ) { return RootConfigMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const RootConfig & value ) { return RootConfigSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const RootConfig & value ) { return RootConfigMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const RootConfig & value ) { return RootConfigSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
TABLEDEMO_TABLE_INLINE bool WeaponConfigSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const WeaponConfig & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool WeaponConfigLoadBodyRetain( TableReader & r, WeaponConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool WeaponConfigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, WeaponConfig & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t LoadoutConfigMeasureBodyRetain( TableRetainIds & ids, const LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool LoadoutConfigSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool LoadoutConfigLoadBodyRetain( TableReader & r, LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool LoadoutConfigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t ProfileConfigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ProfileConfigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ProfileConfigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool ProfileConfigLoadBodyRetain( TableReader & r, const TableNodeMap & nodes, ProfileConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool ProfileConfigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, ProfileConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t RootConfigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RootConfigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RootConfigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool RootConfigLoadBodyRetain( TableReader & r, const TableNodeMap & nodes, RootConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool RootConfigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, RootConfig & value, TableRetain * retain, const TableRetainPath & path );
...
TABLEDEMO_TABLE_INLINE bool AttachmentSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const Attachment & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool AttachmentLoadBodyRetain( TableReader & r, Attachment & value, TableRetain * retain, const TableRetainPath & path );
inline bool AttachmentLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Attachment & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t BuffMeasureBodyRetain( TableRetainIds & ids, const Buff & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool BuffSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const Buff & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool BuffLoadBodyRetain( TableReader & r, Buff & value, TableRetain * retain, const TableRetainPath & path );
inline bool BuffLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Buff & value, TableRetain * retain, const TableRetainPath & path );
...
TABLEDEMO_TABLE_INLINE bool DebuffSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const Debuff & value, TableRetain * retain, const TableRetainPath & path );
TABLEDEMO_TABLE_INLINE bool DebuffLoadBodyRetain( TableReader & r, Debuff & value, TableRetain * retain, const TableRetainPath & path );
inline bool DebuffLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Debuff & value, TableRetain * retain, const TableRetainPath & path );
...
template <typename Ctx>
inline int64_t ProfileConfigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ProfileConfig & value )
{
...
template <typename Ctx>
inline bool ProfileConfigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ProfileConfig & value )
{
    (void) ctx; (void) numbering;
...
template <typename Ctx>
inline bool ProfileConfigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ProfileConfig & value )
{
    if ( !ProfileConfigSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t ProfileConfigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ProfileConfig & value )
{
...
// body is self-delimiting: it is written where the file form put an L.
template <typename Ctx>
inline bool ProfileConfigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ProfileConfig & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
...
template <typename Ctx>
inline int64_t RootConfigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const RootConfig & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    ...
    if ( value.profiles_count > 0 )
    {
        ...
        {
            const int64_t elem_bytes = ProfileConfigMeasureBody( ctx, numbering, ids, value.profiles[elem_i] );
            if ( elem_bytes < 0 ) { return -1; }
...
template <typename Ctx>
inline bool RootConfigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const RootConfig & value )
{
    ...
    if ( value.profiles_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = elem_i < 4 ? elem_cache[ elem_i ] : ProfileConfigMeasureBody( ctx, numbering, ids, value.profiles[elem_i] );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !ProfileConfigSaveBody( ctx, numbering, w, ids, value.profiles[elem_i] ) ) return false;
            }
        }
    }
    return !w.overflow;
...
template <typename Ctx>
inline bool RootConfigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const RootConfig & value )
{
    if ( !RootConfigSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x8181e61fc0436767ull: // profiles
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < keep; i++ )
                    {
                        ...
                        {
                            TableReader elem( sub.buffer + sub.offset, (int64_t) elem_len, r.report, r.ids );
                            ProfileConfigLoadBody( elem, nodes, value.profiles[(int32_t) i] );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t RootConfigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const RootConfig & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    if ( value.version_note_length < 0 || value.version_note_length > 16 ) { return -1; } // storage invariant
    ...
    if ( value.profiles_count > 0 )
    {
        ...
        {
            const int64_t elem = ProfileConfigMeasureMessageBody( ctx, numbering, index_bits, at + bits, value.profiles[i] );
            if ( elem < 0 ) { return -1; }
            bits += elem;
        }
    }
...
// body is self-delimiting: it is written where the file form put an L.
template <typename Ctx>
inline bool RootConfigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const RootConfig & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.version_note_length < 0 || value.version_note_length > 16 ) { return false; } // storage invariant
    if ( value.version_note_length > 0 )
    ...
    if ( value.profiles_count > 0 )
    {
        ...
        for ( int32_t i = 0; i < value.profiles_count; i++ )
        {
            if ( !ProfileConfigSaveMessageBody( ctx, numbering, index_bits, w, value.profiles[i] ) ) { return false; }
        }
    }
    w.put( 0, kTableMessageRefBitsHere ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
            ...
            case 0x8181e61fc0436767ull: // profiles
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        if ( !ProfileConfigLoadMessageBody( r, vocabulary, report, nodes, index_bits, ( in_bounds ? value.profiles[i] : scratch ) ) ) { return false; }
                    }
...
// ProfileConfigNumber: number everything ProfileConfig POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool ProfileConfigNumber( const Ctx & ctx, TableNumbering & numbering, const ProfileConfig & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// ProfileConfigPackMeasure: the packed region bytes of everything ProfileConfig POINTS AT.
...
template <typename Ctx>
inline int64_t ProfileConfigPackMeasure( const Ctx & ctx, TablePackMap & seen, const ProfileConfig & value )
{
    int64_t bytes = 0;
...
// ProfileConfigPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool ProfileConfigPack( const Ctx & ctx, TablePackMap & seen, const ProfileConfig & src, ProfileConfig & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( ProfileConfig ) ); // trivially copyable, by construction
    (void) ctx; (void) seen; (void) base; (void) capacity; (void) used;
    return true;
}

// RootConfigNumber: number everything RootConfig POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool RootConfigNumber( const Ctx & ctx, TableNumbering & numbering, const RootConfig & value )
{
    for ( int32_t i = 0; i < value.profiles_count && i < 4; i++ ) // profiles
    {
        if ( !ProfileConfigNumber( ctx, numbering, value.profiles[i] ) ) { return false; }
    }
    return true;
}

// RootConfigPackMeasure: the packed region bytes of everything RootConfig POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t RootConfigPackMeasure( const Ctx & ctx, TablePackMap & seen, const RootConfig & value )
{
    int64_t bytes = 0;
    for ( int32_t i = 0; i < value.profiles_count && i < 4; i++ ) // profiles
    {
        int64_t inner = ProfileConfigPackMeasure( ctx, seen, value.profiles[i] );
        if ( inner < 0 ) { return -1; }
        bytes += inner;
    }
    return bytes;
...
// RootConfigPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool RootConfigPack( const Ctx & ctx, TablePackMap & seen, const RootConfig & src, RootConfig & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( RootConfig ) ); // trivially copyable, by construction
    for ( int32_t i = 0; i < src.profiles_count && i < 4; i++ ) // profiles
    {
        if ( !ProfileConfigPack( ctx, seen, src.profiles[i], dst.profiles[i], base, capacity, used ) ) { return false; }
    }
    return true;
}
...
struct ProfileConfigBuilder
{
    ...
    ProfileConfigBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
        TableSlot<ProfileConfig> slot = main.Alloc<ProfileConfig>();
        root_ref = slot.ref;
    }
    ~ProfileConfigBuilder() { TableArenaShutdown( arena ); table_release( arena.allocator, region ); }
    ProfileConfigBuilder( const ProfileConfigBuilder & ) = delete;
    ProfileConfigBuilder & operator=( const ProfileConfigBuilder & ) = delete;
    ...
    ProfileConfig * GetRoot() { return arena.locked ? NULL : (ProfileConfig *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const ProfileConfig * AsConst() const { return (const ProfileConfig *) region; }
...
inline bool ProfileConfigBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const ProfileConfig & root = *(const ProfileConfig *) TableArenaAt( arena, (uint32_t) root_ref.value );
    ...
    {
        below = ProfileConfigPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t total = TableAlignUp64( (int64_t) sizeof( ProfileConfig ) ) + below;
    ...
    int64_t used = TableAlignUp64( (int64_t) sizeof( ProfileConfig ) );
    ProfileConfig * destination = new ( packed ) ProfileConfig; // lifetime only: the Pack below memcpy's the whole node over it
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) == NULL ||
         !ProfileConfigPack( ctx, seen, root, *destination, packed, total, used ) || used != total )
    {
...
// ---- ProfileConfig on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// ProfileConfigNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t ProfileConfigNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
...
// ProfileConfigNodePlace: start one record's node's lifetime in the storage pass one
...
inline void ProfileConfigNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    (void) at;
    switch ( type_id )
...
// ProfileConfigNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t ProfileConfigNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    (void) worker;
    switch ( type_id )
...
// ProfileConfigNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
// ProfileConfigNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t ProfileConfigNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    switch ( type_id )
...
// ProfileConfigNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool ProfileConfigNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// ProfileConfigNodeMessageBody: PASS TWO's half, which decodes one record's body into
...
template <typename Ctx>
inline bool ProfileConfigNumberFrom( const Ctx & ctx, TableNumbering & numbering, const ProfileConfig & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return ProfileConfigNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t ProfileConfigMeasureWire( const Ctx & ctx, const ProfileConfig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( ProfileConfigNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = ProfileConfigMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t ProfileConfigSaveWire( const Ctx & ctx, const ProfileConfig & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !ProfileConfigNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    ...
    bool ok = ProfileConfigSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == ProfileConfigMeasure( root )
}

inline int64_t ProfileConfigMeasure( const ProfileConfig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ProfileConfigMeasureWire( ctx, *root, allocator );
}

inline int64_t ProfileConfigSave( const ProfileConfig * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ProfileConfigSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t ProfileConfigMeasure( const ProfileConfigBuilder & builder )
{
    if ( builder.region != NULL ) { return ProfileConfigMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ProfileConfigMeasureWire( ctx, *(const ProfileConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t ProfileConfigSave( const ProfileConfigBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return ProfileConfigSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ProfileConfigSaveWire( ctx, *(const ProfileConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- ProfileConfig on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// ProfileConfigMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t ProfileConfigMessageBodyBits( const Ctx & ctx, const ProfileConfig & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( ProfileConfigNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = ProfileConfigMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool ProfileConfigMessageBodySave( const Ctx & ctx, const ProfileConfig & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && ProfileConfigSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t ProfileConfigMeasureMessages( const ProfileConfig * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = ProfileConfigMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t ProfileConfigSaveMessages( const ProfileConfig * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !ProfileConfigMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == ProfileConfigMeasureMessages( roots, count, report, allocator )
}

// ProfileConfigMessageRecordScan: one node record's type id and the extent its maps
...
inline bool ProfileConfigMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return ProfileConfigNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// ProfileConfigMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool ProfileConfigMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ProfileConfigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = ProfileConfigNodeMessageStorage( type_id, extent, length );
    ...
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( ProfileConfig ) ) + root_extent );
    return true;
}

// ProfileConfigLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t ProfileConfigLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !ProfileConfigMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// ProfileConfigLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool ProfileConfigLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const ProfileConfig * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !ProfileConfigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = ProfileConfigNodeMessageStorage( type_id, extent, length );
        ...
        ProfileConfigNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( ProfileConfig ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x19fffcb7859da778ull;
    ProfileConfig * root = new ( region + used ) ProfileConfig; // lifetime only: LoadMessageBody's first act is ProfileConfigReset
    ProfileConfigReset( *root );
    root_out = root;
    used += root_bytes;
    nodes.good = true;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ProfileConfigNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return ProfileConfigLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// ProfileConfigLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool ProfileConfigLoadMessages( const ProfileConfig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !ProfileConfigLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// ProfileConfigLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t ProfileConfigLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t data = TableAlignUp64( (int64_t) sizeof( ProfileConfig ) );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = ProfileConfigNodeStorage( type_id, length, reason );
...
// ProfileConfigLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const ProfileConfig * ProfileConfigLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( ProfileConfig ) ) { out->malformed = true; return NULL; }
    ...
    directory[0].type_id = 0x19fffcb7859da778ull;
    ProfileConfig * root = new ( region ) ProfileConfig; // lifetime only: LoadBody's first act is ProfileConfigReset
    ProfileConfigReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                ProfileConfigNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    ProfileConfigLoadBody( r, nodes, *root );
    return root;
}

// ProfileConfigLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool ProfileConfigLoadBuilder( ProfileConfigBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.arena = true; // a resolved slot holds the node's ARENA OFFSET here
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = ProfileConfigNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                ProfileConfigNodeBody( type_id, sub, nodes, TableArenaAt( builder.arena, (uint32_t) directory[k + 1].offset ) );
            }
            k++;
        }
    }
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    bool ok = ProfileConfigLoadBody( r, nodes, *root );
...
struct RootConfigBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    RootConfigBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
        TableSlot<RootConfig> slot = main.Alloc<RootConfig>();
        root_ref = slot.ref;
    }
    ~RootConfigBuilder() { TableArenaShutdown( arena ); table_release( arena.allocator, region ); }
    RootConfigBuilder( const RootConfigBuilder & ) = delete;
    RootConfigBuilder & operator=( const RootConfigBuilder & ) = delete;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    RootConfig * GetRoot() { return arena.locked ? NULL : (RootConfig *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const RootConfig * AsConst() const { return (const RootConfig *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool RootConfigBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const RootConfig & root = *(const RootConfig *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = RootConfigPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t total = TableAlignUp64( (int64_t) sizeof( RootConfig ) ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) table_allocate( arena.allocator, total );
    if ( packed == NULL ) { TablePackMapShutdown( seen ); return false; }
    int64_t used = TableAlignUp64( (int64_t) sizeof( RootConfig ) );
    RootConfig * destination = new ( packed ) RootConfig; // lifetime only: the Pack below memcpy's the whole node over it
    // The pack walk RE-DERIVES the same numbering rather than carrying the
    // measure's — nothing passes between them, which is what makes
    // `used == total` below a real check and not a tautology (§3.1). The
    // map keeps the capacity the measure paid for, so the second walk
    ...
    TablePackMapReset( seen );
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) == NULL ||
         !RootConfigPack( ctx, seen, root, *destination, packed, total, used ) || used != total )
    {
        TablePackMapShutdown( seen );
        table_release( arena.allocator, packed );
        return false;
...
// ---- RootConfig on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// RootConfigNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
inline int64_t RootConfigNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    (void) length; // no byte buffer below this root: every node's storage is its type's
    switch ( type_id )
    {
...
// RootConfigNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
inline void RootConfigNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    (void) at;
    switch ( type_id )
...
// RootConfigNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t RootConfigNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    (void) worker;
    switch ( type_id )
...
// RootConfigNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
// RootConfigNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t RootConfigNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    switch ( type_id )
...
// RootConfigNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool RootConfigNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    (void) type_id; // no map below any node this root can name
    return TableMessageSkipBody( r, vocabulary, index_bits );
...
// RootConfigNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool RootConfigNumberFrom( const Ctx & ctx, TableNumbering & numbering, const RootConfig & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return RootConfigNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t RootConfigMeasureWire( const Ctx & ctx, const RootConfig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( RootConfigNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = RootConfigMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t RootConfigSaveWire( const Ctx & ctx, const RootConfig & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !RootConfigNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    // the root's own fields, then the node table's field, then the
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = RootConfigSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == RootConfigMeasure( root )
}

inline int64_t RootConfigMeasure( const RootConfig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RootConfigMeasureWire( ctx, *root, allocator );
}

inline int64_t RootConfigSave( const RootConfig * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RootConfigSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t RootConfigMeasure( const RootConfigBuilder & builder )
{
    if ( builder.region != NULL ) { return RootConfigMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RootConfigMeasureWire( ctx, *(const RootConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t RootConfigSave( const RootConfigBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return RootConfigSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RootConfigSaveWire( ctx, *(const RootConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- RootConfig on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// RootConfigMessageBodyBits: one root body's bits at bit position `at` of the batch,
// with the numbering derived from the graph, the node table FIRST, then the
// fields, then the zero reference. Measure derives the numbering and save
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t RootConfigMessageBodyBits( const Ctx & ctx, const RootConfig & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( RootConfigNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = RootConfigMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool RootConfigMessageBodySave( const Ctx & ctx, const RootConfig & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && RootConfigSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t RootConfigMeasureMessages( const RootConfig * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = RootConfigMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t RootConfigSaveMessages( const RootConfig * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !RootConfigMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == RootConfigMeasureMessages( roots, count, report, allocator )
}

// RootConfigMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool RootConfigMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return RootConfigNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// RootConfigMessageBodyStorage: one body's node count and data bytes from the FRAMING
// alone, the reader left at the next body. The node table is walked record
// by record, a table record's body stepped over by its announced shapes and
// a blob's by its length, then the root's own fields. False is a numbering
// that could not be sized; `complete` false is a ROOT body whose own framing
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool RootConfigMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !RootConfigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = RootConfigNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !TableMessageSkipBody( r, vocabulary, index_bits ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( RootConfig ) ) + root_extent );
    return true;
}

// RootConfigLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t RootConfigLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !RootConfigMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// RootConfigLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool RootConfigLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const RootConfig * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !RootConfigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = RootConfigNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        RootConfigNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( RootConfig ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x5f4843f6def45e87ull;
    RootConfig * root = new ( region + used ) RootConfig; // lifetime only: LoadMessageBody's first act is RootConfigReset
    RootConfigReset( *root );
    root_out = root;
    used += root_bytes;
    nodes.good = true;
    out->unknown += unknown_records;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RootConfigNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return RootConfigLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// RootConfigLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool RootConfigLoadMessages( const RootConfig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !RootConfigLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// RootConfigLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t RootConfigLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableNodeScan scan = TableNodeScanBegin( wire, wire_bytes, &ignored, &ids_table );
    TableRefuseReason reason = count_over_length;
    int64_t data = TableAlignUp64( (int64_t) sizeof( RootConfig ) );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = RootConfigNodeStorage( type_id, length, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// RootConfigLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const RootConfig * RootConfigLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( RootConfig ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0x5f4843f6def45e87ull;
    RootConfig * root = new ( region ) RootConfig; // lifetime only: LoadBody's first act is RootConfigReset
    RootConfigReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RootConfigNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    RootConfigLoadBody( r, nodes, *root );
    return root;
}

// RootConfigLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool RootConfigLoadBuilder( RootConfigBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.arena = true; // a resolved slot holds the node's ARENA OFFSET here
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = RootConfigNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RootConfigNodeBody( type_id, sub, nodes, TableArenaAt( builder.arena, (uint32_t) directory[k + 1].offset ) );
            }
            k++;
        }
    }
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    bool ok = RootConfigLoadBody( r, nodes, *root );
    table_release( allocator, directory );
    return ok;
}
    ...
    if ( value.effect.type != EffectType::None ) // None elides — the absence of the field is the None
    {
        ...
        switch ( value.effect.type )
        {
            ...
            case EffectType::Debuff:
            {
                ...
                const uint64_t arm_ref = ids.ref_at( 10, 0x13cdc5ede73d2fd7ull );
                {
                    const int64_t arm_body = DebuffMeasureBodyRetain( ids, value.effect.debuff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 1 ) ) );
                    if ( arm_body < 0 ) { return -1; }
                    arm_payload += arm_body; // the arm's own table body (§3)
                }
                bytes += TableLebBytes( arm_ref ) + 1 + TableLebBytes( (uint64_t) ( arm_payload ) ) + ( arm_payload );
    ...
    if ( value.effect.type != EffectType::None )
    {
        ...
        switch ( value.effect.type )
        {
            case EffectType::Buff:
            {
                ...
                w.header( arm_ref, 13 ); w.putleb( (uint64_t) arm_payload ); // buff
                if ( !BuffSaveBodyRetain( w, ids, value.effect.buff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 0 ) ) ) ) { return false; }
                break;
            }
            case EffectType::Debuff:
            {
                ...
                w.header( arm_ref, 13 ); w.putleb( (uint64_t) arm_payload ); // debuff
                if ( !DebuffSaveBodyRetain( w, ids, value.effect.debuff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 1 ) ) ) ) { return false; }
                break;
            }
            default: return false; // write validates the tag before it rides
        }
    ...
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0x36c1c83b51f24394ull: // effect
            {
                ...
                TableRetainDiscardField( retain, path, 5 );
                uint64_t arm_ref = 0;
                if ( !r.getleb( arm_ref ) ) { r.report->malformed = true; return false; }
                if ( arm_ref == 0 ) { value.effect.type = EffectType::None; break; } // empty: the reference is the whole payload
                if ( arm_ref > (uint64_t) r.ids->count ) { r.report->malformed = true; return false; }
                ...
                if ( !r.getleb( body_len ) || !r.room( body_len ) ) { r.report->malformed = true; return false; }
                {
                    ...
                    switch ( arm_id ) // the arm's NAME hash (docs/SPEC-TABLES.md §5)
                    {
                        case 0xffb5be9be2e469ccull: // buff
                        {
                            ...
                            value.effect.type = EffectType::Buff;
                            BuffLoadBodyRetain( sub, value.effect.buff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 0 ) ) );
                            if ( sub.offset != sub.size ) { value.effect.type = EffectType::None; r.report->malformed = true; break; }
                            break;
                        }
                        case 0x13cdc5ede73d2fd7ull: // debuff
                        {
                            ...
                            value.effect.type = EffectType::Debuff;
                            DebuffLoadBodyRetain( sub, value.effect.debuff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 1 ) ) );
                            if ( sub.offset != sub.size ) { value.effect.type = EffectType::None; r.report->malformed = true; break; }
                            break;
                        }
                        default:
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                            case 0xffb5be9be2e469ccull: // buff
                            {
                                ...
                                value.effect.type = EffectType::Buff;
                                if ( !BuffLoadMessageBodyRetain( r, vocabulary, report, index_bits, value.effect.buff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 0 ) ) ) ) { return false; }
                                break;
                            }
                            case 0x13cdc5ede73d2fd7ull: // debuff
                            {
                                ...
                                value.effect.type = EffectType::Debuff;
                                if ( !DebuffLoadMessageBodyRetain( r, vocabulary, report, index_bits, value.effect.debuff, retain, TableRetainStepInto( path, 5, (uint32_t) ( 1 ) ) ) ) { return false; }
                                break;
                            }
                            default:
                                value.effect.type = EffectType::None; report->unknown++; report->retain_lost++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
inline int64_t LoadoutConfigMeasureBodyRetain( TableRetainIds & ids, const LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    }
    {
        ...
        for ( int32_t elem_i = 0; elem_i < 2; elem_i++ )
        {
            const int64_t elem_bytes = WeaponConfigMeasureBodyRetain( ids, value.backups[elem_i], retain, TableRetainStepInto( path, 5, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_backups += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_backups ) + 1 + TableLebBytes( (uint64_t) ( body_backups ) ) + ( body_backups ); // backups (fixed [2])
    ...
    if ( value.attachments_count > 0 )
    {
        ...
        for ( int32_t elem_i = 0; elem_i < value.attachments_count; elem_i++ )
        {
            const int64_t elem_bytes = AttachmentMeasureBodyRetain( ids, value.attachments[elem_i], retain, TableRetainStepInto( path, 6, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_attachments += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_attachments ) + 1 + TableLebBytes( (uint64_t) ( body_attachments ) ) + ( body_attachments ); // attachments
...
TABLEDEMO_TABLE_INLINE bool LoadoutConfigSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const LoadoutConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    }
    {
        ...
        {
            w.header( ref_primary, 13 ); w.putleb( (uint64_t) body_primary ); // primary
            if ( !WeaponConfigSaveBodyRetain( w, ids, value.primary, retain, TableRetainStepInto( path, 4, (uint32_t) ( 0 ) ) ) ) return false;
        }
        else { ids.truncate( mark_primary ); }
    }
    {
        ...
        {
            {
                const int64_t elem_len = WeaponConfigMeasureBodyRetain( ids, value.backups[elem_i], retain, TableRetainStepInto( path, 5, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !WeaponConfigSaveBodyRetain( w, ids, value.backups[elem_i], retain, TableRetainStepInto( path, 5, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( value.attachments_count < 0 || value.attachments_count > 8 ) { return false; } // storage invariant
    if ( value.attachments_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = AttachmentMeasureBodyRetain( ids, value.attachments[elem_i], retain, TableRetainStepInto( path, 6, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !AttachmentSaveBodyRetain( w, ids, value.attachments[elem_i], retain, TableRetainStepInto( path, 6, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( !TableRetainTailSave( retain, ids, w, path ) ) { return false; }
    ...
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0xbf31137ff783e939ull: // primary
            {
                ...
                {
                    TableReader sub( r.buffer + r.offset, (int64_t) body_len, r.report, r.ids );
                    WeaponConfigLoadBodyRetain( sub, value.primary, retain, TableRetainStepInto( path, 4, (uint32_t) ( 0 ) ) );
                    if ( sub.offset != sub.size )
                    {
                        r.report->malformed = true;
                        WeaponConfigReset( value.primary );
            ...
            case 0xde28f0f5118acc24ull: // backups
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < keep; i++ )
                    {
                        ...
                        {
                            TableReader elem( sub.buffer + sub.offset, (int64_t) elem_len, r.report, r.ids );
                            WeaponConfigLoadBodyRetain( elem, value.backups[(int32_t) i], retain, TableRetainStepInto( path, 5, (uint32_t) ( i ) ) );
                            if ( elem.offset != elem.size ) { r.report->malformed = true; WeaponConfigReset( value.backups[(int32_t) i] ); }
                        }
                        sub.offset += (int64_t) elem_len;
                    }
            ...
            case 0xf901aa0340249a41ull: // attachments
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < keep; i++ )
                    {
                        ...
                        {
                            TableReader elem( sub.buffer + sub.offset, (int64_t) elem_len, r.report, r.ids );
                            AttachmentLoadBodyRetain( elem, value.attachments[(int32_t) i], retain, TableRetainStepInto( path, 6, (uint32_t) ( i ) ) );
                            if ( elem.offset != elem.size ) { r.report->malformed = true; AttachmentReset( value.attachments[(int32_t) i] ); }
                        }
                        sub.offset += (int64_t) elem_len;
                        decoded = i + 1;
        ...
        switch ( entry.id )
        {
            case 0x32a89b2977c48ad4ull: // grade
            {
                ...
                }
                {
                    ...
                    else if ( !TableEnumValue( variant_entry.id, value.grade ) ) { value.grade = Grade::None; report->unknown++; report->retain_lost++; }
                }
                break;
            }
            case 0xd90a4e7682f799c5ull: // grades
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        Grade slot_value = Grade::None;
                        {
                            ...
                            else if ( !TableEnumValue( variant_entry_2.id, slot_value ) ) { slot_value = Grade::None; report->unknown++; report->retain_lost++; }
                        }
                        if ( in_bounds ) { value.grades[i] = slot_value; }
                    }
                    value.grades_count = kept;
            ...
            case 0xbf31137ff783e939ull: // primary
            {
                ...
                TableRetainDiscardField( retain, path, 4 );
                if ( !WeaponConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, value.primary, retain, TableRetainStepInto( path, 4, (uint32_t) ( 0 ) ) ) ) { return false; }
                break;
            }
            case 0xde28f0f5118acc24ull: // backups
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        WeaponConfig scratch;
                        WeaponConfigReset( scratch );
                        if ( !WeaponConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( in_bounds ? value.backups[i] : scratch ), ( in_bounds ? retain : NULL ), TableRetainStepInto( path, 5, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                }
                break;
            }
            case 0xf901aa0340249a41ull: // attachments
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        Attachment scratch;
                        AttachmentReset( scratch );
                        if ( !AttachmentLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( in_bounds ? value.attachments[i] : scratch ), ( in_bounds ? retain : NULL ), TableRetainStepInto( path, 6, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    value.attachments_count = kept;
                }
                break;
...
template <typename Ctx>
inline int64_t ProfileConfigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.name_length < 0 || value.name_length > 32 ) { return -1; } // storage invariant
...
template <typename Ctx>
inline bool ProfileConfigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    ...
    {
        {
            ...
            {
                w.header( ref_loadout, 13 ); w.putleb( (uint64_t) body_loadout ); // loadout
                if ( !LoadoutConfigSaveBodyRetain( w, ids, value.loadout, retain, TableRetainStepInto( path, 12, (uint32_t) ( 0 ) ) ) ) return false;
            }
            else { ids.truncate( mark_loadout ); }
        }
    }
...
template <typename Ctx>
inline bool ProfileConfigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ProfileConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !ProfileConfigSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
    ...
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0x5759ce7586bbb5a3ull: // loadout
            {
                ...
                TableRetainDiscardField( retain, path, 12 );
                uint64_t body_len = 0;
                if ( !r.getleb( body_len ) || !r.room( body_len ) ) { r.report->malformed = true; return false; }
                {
                    TableReader sub( r.buffer + r.offset, (int64_t) body_len, r.report, r.ids );
                    LoadoutConfigLoadBodyRetain( sub, value.loadout, retain, TableRetainStepInto( path, 12, (uint32_t) ( 0 ) ) );
                    if ( sub.offset != sub.size )
                    {
                        r.report->malformed = true;
                        LoadoutConfigReset( value.loadout );
    ...
    for ( ;; )
    {
        ...
        switch ( entry.id )
        {
            ...
            case 0x5759ce7586bbb5a3ull: // loadout
            {
                ...
                TableRetainDiscardField( retain, path, 12 );
                if ( !LoadoutConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, value.loadout, retain, TableRetainStepInto( path, 12, (uint32_t) ( 0 ) ) ) ) { return false; }
                break;
            }
            default:
                report->unknown++;
...
template <typename Ctx>
inline int64_t RootConfigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.version_note_length < 0 || value.version_note_length > 16 ) { return -1; } // storage invariant
    if ( value.version_note_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 72, 0x8a67c9728746d394ull ) ) + 1 + TableLebBytes( (uint64_t) ( value.version_note_length ) ) + ( value.version_note_length ); } // version_note
    ...
    if ( value.weapons_count > 0 )
    {
        ...
        for ( int32_t elem_i = 0; elem_i < value.weapons_count; elem_i++ )
        {
            const int64_t elem_bytes = WeaponConfigMeasureBodyRetain( ids, value.weapons[elem_i], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_weapons += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_weapons ) + 1 + TableLebBytes( (uint64_t) ( body_weapons ) ) + ( body_weapons ); // weapons
    ...
    if ( value.profiles_count > 0 )
    {
        ...
        for ( int32_t elem_i = 0; elem_i < value.profiles_count; elem_i++ )
        {
            const int64_t elem_bytes = ProfileConfigMeasureBodyRetain( ctx, numbering, ids, value.profiles[elem_i], retain, TableRetainStepInto( path, 2, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_profiles += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_profiles ) + 1 + TableLebBytes( (uint64_t) ( body_profiles ) ) + ( body_profiles ); // profiles
...
template <typename Ctx>
inline bool RootConfigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.version_note_length < 0 || value.version_note_length > 16 ) { return false; } // storage invariant
    if ( value.version_note_length > 0 )
    {
    ...
    if ( value.weapons_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = WeaponConfigMeasureBodyRetain( ids, value.weapons[elem_i], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !WeaponConfigSaveBodyRetain( w, ids, value.weapons[elem_i], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( value.profiles_count < 0 || value.profiles_count > 4 ) { return false; } // storage invariant
    if ( value.profiles_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = ProfileConfigMeasureBodyRetain( ctx, numbering, ids, value.profiles[elem_i], retain, TableRetainStepInto( path, 2, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !ProfileConfigSaveBodyRetain( ctx, numbering, w, ids, value.profiles[elem_i], retain, TableRetainStepInto( path, 2, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( !TableRetainTailSave( retain, ids, w, path ) ) { return false; }
...
template <typename Ctx>
inline bool RootConfigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const RootConfig & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !RootConfigSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x41cbd901b87fabb6ull: // weapons
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < keep; i++ )
                    {
                        ...
                        {
                            TableReader elem( sub.buffer + sub.offset, (int64_t) elem_len, r.report, r.ids );
                            WeaponConfigLoadBodyRetain( elem, value.weapons[(int32_t) i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) );
                            if ( elem.offset != elem.size ) { r.report->malformed = true; WeaponConfigReset( value.weapons[(int32_t) i] ); }
                        }
                        sub.offset += (int64_t) elem_len;
                        decoded = i + 1;
            ...
            case 0x8181e61fc0436767ull: // profiles
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < keep; i++ )
                    {
                        ...
                        {
                            TableReader elem( sub.buffer + sub.offset, (int64_t) elem_len, r.report, r.ids );
                            ProfileConfigLoadBodyRetain( elem, nodes, value.profiles[(int32_t) i], retain, TableRetainStepInto( path, 2, (uint32_t) ( i ) ) );
                            if ( elem.offset != elem.size ) { r.report->malformed = true; ProfileConfigReset( value.profiles[(int32_t) i] ); }
                        }
                        sub.offset += (int64_t) elem_len;
                        decoded = i + 1;
            ...
            case 0x41cbd901b87fabb6ull: // weapons
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        WeaponConfig scratch;
                        WeaponConfigReset( scratch );
                        if ( !WeaponConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( in_bounds ? value.weapons[i] : scratch ), ( in_bounds ? retain : NULL ), TableRetainStepInto( path, 1, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    value.weapons_count = kept;
                }
                break;
            ...
            case 0x8181e61fc0436767ull: // profiles
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        ProfileConfig scratch;
                        ProfileConfigReset( scratch );
                        if ( !ProfileConfigLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, ( in_bounds ? value.profiles[i] : scratch ), ( in_bounds ? retain : NULL ), TableRetainStepInto( path, 2, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    value.profiles_count = kept;
                }
                break;
...
// ProfileConfigNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
// ProfileConfigLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const ProfileConfig * ProfileConfigLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                ProfileConfigNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    ProfileConfigLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// ProfileConfigNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
// ProfileConfigLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool ProfileConfigLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const ProfileConfig * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ProfileConfigNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return ProfileConfigLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// ProfileConfigLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool ProfileConfigLoadRetainMessages( const ProfileConfig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !ProfileConfigLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// ProfileConfigMeasureRetain and ProfileConfigSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t ProfileConfigMeasureWireRetain( const Ctx & ctx, const ProfileConfig & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( ProfileConfigNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = ProfileConfigMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t ProfileConfigSaveWireRetain( const Ctx & ctx, const ProfileConfig & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = ProfileConfigSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t ProfileConfigMeasureRetain( const ProfileConfig * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ProfileConfigMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t ProfileConfigSaveRetain( const ProfileConfig * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ProfileConfigSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// ProfileConfigSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
// RootConfigLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const RootConfig * RootConfigLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RootConfigNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    RootConfigLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// RootConfigNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is this body's own directory position, which the batch's load fills
// from the framing and nothing afterwards renumbers.
...
// RootConfigLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
// each body carries its own node directory inside that one region and a
// record's first step is an index into it (docs/SPEC-TABLES.md §3.3, §6.6).
inline bool RootConfigLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const RootConfig * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RootConfigNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return RootConfigLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// RootConfigLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
// SaveRetain from `roots[k]` takes `retains[k]` and is the file form's own
// pair unchanged: retention writing FORM 2 refuses by name (§3.3).
inline bool RootConfigLoadRetainMessages( const RootConfig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !RootConfigLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// RootConfigMeasureRetain and RootConfigSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t RootConfigMeasureWireRetain( const Ctx & ctx, const RootConfig & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( RootConfigNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = RootConfigMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t RootConfigSaveWireRetain( const Ctx & ctx, const RootConfig & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = RootConfigSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t RootConfigMeasureRetain( const RootConfig * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RootConfigMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t RootConfigSaveRetain( const RootConfig * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RootConfigSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// RootConfigSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the FILE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t RootConfigSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH ProfileConfigAt: the slot holds
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH RootConfigAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
template <typename Ctx> inline bool ProfileConfigCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const ProfileConfig & value, TableByteOrder order );
template <typename Ctx> inline bool RootConfigCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const RootConfig & value, TableByteOrder order );
...
template <typename Ctx> inline bool RootConfigCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const RootConfig & value, TableByteOrder order )
{
    ...
    for ( int32_t i = 0; i < 4; i++ )
    {
        if ( !ProfileConfigCookBody( ctx, region, at + 256 + i * 304, value.profiles[ i ], order ) ) { return false; }
    }
...
// ProfileConfigCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
inline bool ProfileConfigCookLayout( const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    int64_t offset = 304; // the root, at zero
    int64_t align = 8;
...
// ProfileConfigCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t ProfileConfigCookMeasureFrom( const Ctx & ctx, const ProfileConfig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( ProfileConfigNumberFrom( ctx, numbering, root ) && ProfileConfigCookLayout( numbering, region ) )
    {
...
// ProfileConfigCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool ProfileConfigCookFrom( const Ctx & ctx, const ProfileConfig & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    bool ok = ProfileConfigNumberFrom( ctx, numbering, root );
    if ( ok )
    {
        region.offsets = (int64_t *) table_allocate( allocator, ( numbering.count + 1 ) * (int64_t) sizeof( int64_t ) );
        ok = region.offsets != NULL && ProfileConfigCookLayout( numbering, region );
    }
    if ( ok )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        ...
        if ( ok )
        {
            ...
            ok = ProfileConfigCookBody( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x19fffcb7859da778ull, 8, order ); // the root: fnv1a64( "ProfileConfig" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// ProfileConfigCookMeasure / ProfileConfigCook over a REGION root — a locked builder's AsConst, a
// region ProfileConfigLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t ProfileConfigCookMeasure( const ProfileConfig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ProfileConfigCookMeasureFrom( ctx, *root, allocator );
}

inline bool ProfileConfigCook( const ProfileConfig * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return ProfileConfigCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t ProfileConfigCookMeasure( const ProfileConfigBuilder & builder )
{
    if ( builder.region != NULL ) { return ProfileConfigCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ProfileConfigCookMeasureFrom( ctx, *(const ProfileConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool ProfileConfigCook( const ProfileConfigBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return ProfileConfigCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ProfileConfigCookFrom( ctx, *(const ProfileConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}

// RootConfigCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
// summed when it does not (a measure). A type id the numbering carries that
// this root cannot name is the two walks disagreeing, and it is refused.
inline bool RootConfigCookLayout( const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    int64_t offset = 1480; // the root, at zero
    int64_t align = 8;
    if ( region.offsets != NULL ) { region.offsets[0] = 0; }
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
...
// RootConfigCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t RootConfigCookMeasureFrom( const Ctx & ctx, const RootConfig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( RootConfigNumberFrom( ctx, numbering, root ) && RootConfigCookLayout( numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// RootConfigCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool RootConfigCookFrom( const Ctx & ctx, const RootConfig & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    bool ok = RootConfigNumberFrom( ctx, numbering, root );
    if ( ok )
    {
        region.offsets = (int64_t *) table_allocate( allocator, ( numbering.count + 1 ) * (int64_t) sizeof( int64_t ) );
        ok = region.offsets != NULL && RootConfigCookLayout( numbering, region );
    }
    if ( ok )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = RootConfigCookBody( ctx, region, region.base, root, order );
            // the ATTRIBUTION part: the node directory (§6.3), one entry per node
            // in index order, for `schema cook-check`
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0x5f4843f6def45e87ull, 8, order ); // the root: fnv1a64( "RootConfig" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// RootConfigCookMeasure / RootConfigCook over a REGION root — a locked builder's AsConst, a
// region RootConfigLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t RootConfigCookMeasure( const RootConfig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RootConfigCookMeasureFrom( ctx, *root, allocator );
}

inline bool RootConfigCook( const RootConfig * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return RootConfigCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t RootConfigCookMeasure( const RootConfigBuilder & builder )
{
    if ( builder.region != NULL ) { return RootConfigCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RootConfigCookMeasureFrom( ctx, *(const RootConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool RootConfigCook( const RootConfigBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return RootConfigCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RootConfigCookFrom( ctx, *(const RootConfig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
extern const TableTypeInfo WeaponConfigTableInfo;
extern const TableTypeInfo LoadoutConfigTableInfo;
extern const TableTypeInfo ProfileConfigTableInfo;
extern const TableTypeInfo RootConfigTableInfo;
extern const TableTypeInfo AttachmentTableInfo;
extern const TableTypeInfo BuffTableInfo;
extern const TableTypeInfo DebuffTableInfo;
...
inline const TableFieldInfo WeaponConfigTableFields[] = {
    { "damage", "damage", "float32", 0x7f6308be8ab37fc0ull, 10, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, damage ), (uint32_t) sizeof( WeaponConfig::damage ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", " Damage per hit, before armor.\n\nThe armor curve is written \"hardness \\ hit\" in the design notes,\nand the backslash is part of the name.", 3, WeaponConfig_damage_tags },
    { "speed", "speed", "float32", 0x1733055702acb1d2ull, 10, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, speed ), (uint32_t) sizeof( WeaponConfig::speed ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "penetration", "penetration", "int32", 0x4f31c5309e13e932ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, penetration ), (uint32_t) sizeof( WeaponConfig::penetration ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 10.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "channel", "channel", "bits(6)", 0xa5013e9ad5caeda4ull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, channel ), (uint32_t) sizeof( WeaponConfig::channel ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 63.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "homing", "homing", "bool", 0xad6587bc602e3f59ull, 1, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, homing ), (uint32_t) sizeof( WeaponConfig::homing ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "effect", "effect", "Effect", 0x36c1c83b51f24394ull, 15, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( WeaponConfig, effect ), (uint32_t) sizeof( WeaponConfig::effect ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, 2, +[]( uint64_t v ) -> const char * { switch ( v ) { case 0: return "None"; case 1: return "buff"; case 2: return "debuff"; default: return "???"; } }, +[]( uint64_t v ) -> uint64_t { switch ( v ) { case 0: return 0; case 1: return 0xffb5be9be2e469ccull; case 2: return 0x13cdc5ede73d2fd7ull; default: return 0; } }, NULL, NULL, NULL, +[]() -> const TableUnionInfo * { static const TableUnionArmInfo arms[] = { { 0, NULL, NULL, 0 }, { (uint32_t) offsetof( Effect, buff ), &BuffTableInfo, NULL, 4 }, { (uint32_t) offsetof( Effect, debuff ), &DebuffTableInfo, NULL, 4 }, }; static const TableUnionInfo info = { (uint32_t) offsetof( Effect, type ), (uint32_t) sizeof( Effect::type ), arms }; return &info; }, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo WeaponConfigTableInfo = { "WeaponConfig", (uint32_t) sizeof( WeaponConfig ), 6, WeaponConfigTableFields, +[]( void * p ) { WeaponConfigReset( *(WeaponConfig *) p ); }, false, "One weapon's tuning. A designer edits this table and nothing else.", 1, WeaponConfig_tags };
inline const TableTypeInfo * WeaponConfigTableType() { return &WeaponConfigTableInfo; }

inline const TableFieldInfo LoadoutConfigTableFields[] = {
    { "grade", "grade", "Grade", 0x32a89b2977c48ad4ull, 30, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( LoadoutConfig, grade ), (uint32_t) sizeof( LoadoutConfig::grade ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, 3, +[]( uint64_t v ) { return EnumName( Grade( v ) ); }, +[]( uint64_t v ) -> uint64_t { uint64_t id = 0; TableEnumId( Grade( v ), id ); return id; }, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "grades", "grades", "Grade", 0xd90a4e7682f799c5ull, 30, true, false, NULL, NULL, true, false, 4, (uint32_t) offsetof( LoadoutConfig, grades ), (uint32_t) sizeof( LoadoutConfig::grades[0] ), (uint32_t) offsetof( LoadoutConfig, grades_count ), 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, 3, +[]( uint64_t v ) { return EnumName( Grade( v ) ); }, +[]( uint64_t v ) -> uint64_t { uint64_t id = 0; TableEnumId( Grade( v ), id ); return id; }, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "podium", "podium", "Grade", 0xb46ff45a23d72549ull, 30, true, false, NULL, NULL, false, false, 3, (uint32_t) offsetof( LoadoutConfig, podium ), (uint32_t) sizeof( LoadoutConfig::podium[0] ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, 3, +[]( uint64_t v ) { return EnumName( Grade( v ) ); }, +[]( uint64_t v ) -> uint64_t { uint64_t id = 0; TableEnumId( Grade( v ), id ); return id; }, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "perks", "perks", "Perks", 0x4b06f5847096e54aull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( LoadoutConfig, perks ), (uint32_t) sizeof( LoadoutConfig::perks ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, 2, +[]( uint64_t v ) { return FlagNamePerks( (int) v ); }, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "primary", "primary", "WeaponConfig", 0xbf31137ff783e939ull, 13, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( LoadoutConfig, primary ), (uint32_t) sizeof( LoadoutConfig::primary ), 0xffffffffu, 0xffffffffu, &WeaponConfigTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "backups", "backups", "WeaponConfig", 0xde28f0f5118acc24ull, 13, true, false, NULL, NULL, false, false, 2, (uint32_t) offsetof( LoadoutConfig, backups ), (uint32_t) sizeof( LoadoutConfig::backups[0] ), 0xffffffffu, 0xffffffffu, &WeaponConfigTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "attachments", "attachments", "Attachment", 0xf901aa0340249a41ull, 13, true, false, NULL, NULL, true, false, 8, (uint32_t) offsetof( LoadoutConfig, attachments ), (uint32_t) sizeof( LoadoutConfig::attachments[0] ), (uint32_t) offsetof( LoadoutConfig, attachments_count ), 0xffffffffu, &AttachmentTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo LoadoutConfigTableInfo = { "LoadoutConfig", (uint32_t) sizeof( LoadoutConfig ), 7, LoadoutConfigTableFields, +[]( void * p ) { LoadoutConfigReset( *(LoadoutConfig *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * LoadoutConfigTableType() { return &LoadoutConfigTableInfo; }

inline const TableFieldInfo ProfileConfigTableFields[] = {
    { "name", "name", "string", 0xc4bcadba8e631b86ull, 12, false, false, NULL, NULL, true, false, 32, (uint32_t) offsetof( ProfileConfig, name ), (uint32_t) sizeof( ProfileConfig::name ), (uint32_t) offsetof( ProfileConfig, name_length ), 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "icon", "icon", "bytes", 0xdbff4cc56c2092f0ull, 6, true, false, NULL, NULL, true, false, 16, (uint32_t) offsetof( ProfileConfig, icon ), (uint32_t) sizeof( ProfileConfig::icon[0] ), (uint32_t) offsetof( ProfileConfig, icon_length ), 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "experience", "experience", "uint32", 0xab8b6d521f80b969ull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, experience ), (uint32_t) sizeof( ProfileConfig::experience ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "tilt", "tilt", "int8", 0x1e5088ef2e9bafc6ull, 2, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, tilt ), (uint32_t) sizeof( ProfileConfig::tilt ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "heading", "heading", "int16", 0xb128829190ca0f75ull, 3, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, heading ), (uint32_t) sizeof( ProfileConfig::heading ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "timestamp", "timestamp", "int64", 0x5ddc92338ef53403ull, 5, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, timestamp ), (uint32_t) sizeof( ProfileConfig::timestamp ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "badge", "badge", "uint8", 0x10bda981fe095518ull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, badge ), (uint32_t) sizeof( ProfileConfig::badge ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "port", "port", "uint16", 0x8c2cdb0da8933fa6ull, 7, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, port ), (uint32_t) sizeof( ProfileConfig::port ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "epoch", "epoch", "uint64", 0xfc9697d1196e6ba6ull, 9, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, epoch ), (uint32_t) sizeof( ProfileConfig::epoch ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "precision", "precision", "float64", 0x288427f5babd05f7ull, 11, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, precision ), (uint32_t) sizeof( ProfileConfig::precision ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "ratings", "ratings", "float32", 0xb921eb8a3d0cb0f9ull, 10, true, false, NULL, NULL, false, false, 4, (uint32_t) offsetof( ProfileConfig, ratings ), (uint32_t) sizeof( ProfileConfig::ratings[0] ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "has_loadout", "has_loadout", "bool", 0xa06f5e0a148e253cull, 1, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, has_loadout ), (uint32_t) sizeof( ProfileConfig::has_loadout ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "loadout", "loadout", "LoadoutConfig", 0x5759ce7586bbb5a3ull, 13, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ProfileConfig, loadout ), (uint32_t) sizeof( ProfileConfig::loadout ), 0xffffffffu, 0xffffffffu, &LoadoutConfigTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "has_loadout", TableDocNone, 0, NULL },
};
inline const TableTypeInfo ProfileConfigTableInfo = { "ProfileConfig", (uint32_t) sizeof( ProfileConfig ), 13, ProfileConfigTableFields, +[]( void * p ) { ProfileConfigReset( *(ProfileConfig *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * ProfileConfigTableType() { return &ProfileConfigTableInfo; }

inline const TableFieldInfo RootConfigTableFields[] = {
    { "version_note", "version_note", "string", 0x8a67c9728746d394ull, 12, false, false, NULL, NULL, true, false, 16, (uint32_t) offsetof( RootConfig, version_note ), (uint32_t) sizeof( RootConfig::version_note ), (uint32_t) offsetof( RootConfig, version_note_length ), 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "weapons", "weapons", "WeaponConfig", 0x41cbd901b87fabb6ull, 13, true, false, NULL, NULL, true, false, 8, (uint32_t) offsetof( RootConfig, weapons ), (uint32_t) sizeof( RootConfig::weapons[0] ), (uint32_t) offsetof( RootConfig, weapons_count ), 0xffffffffu, &WeaponConfigTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "profiles", "profiles", "ProfileConfig", 0x8181e61fc0436767ull, 13, true, false, NULL, NULL, true, false, 4, (uint32_t) offsetof( RootConfig, profiles ), (uint32_t) sizeof( RootConfig::profiles[0] ), (uint32_t) offsetof( RootConfig, profiles_count ), 0xffffffffu, &ProfileConfigTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo RootConfigTableInfo = { "RootConfig", (uint32_t) sizeof( RootConfig ), 3, RootConfigTableFields, +[]( void * p ) { RootConfigReset( *(RootConfig *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * RootConfigTableType() { return &RootConfigTableInfo; }

inline const TableFieldInfo AttachmentTableFields[] = {
    { "slot", "slot", "int32", 0x6a771618f6fe31d1ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Attachment, slot ), (uint32_t) sizeof( Attachment::slot ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 7.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "power", "power", "float32", 0xeef9d1358ae7b4e6ull, 10, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Attachment, power ), (uint32_t) sizeof( Attachment::power ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo AttachmentTableInfo = { "Attachment", (uint32_t) sizeof( Attachment ), 2, AttachmentTableFields, +[]( void * p ) { AttachmentReset( *(Attachment *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * AttachmentTableType() { return &AttachmentTableInfo; }

inline const TableFieldInfo BuffTableFields[] = {
    { "multiplier", "multiplier", "float32", 0x9adc623a805c87c6ull, 10, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Buff, multiplier ), (uint32_t) sizeof( Buff::multiplier ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo BuffTableInfo = { "Buff", (uint32_t) sizeof( Buff ), 1, BuffTableFields, +[]( void * p ) { BuffReset( *(Buff *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * BuffTableType() { return &BuffTableInfo; }

inline const TableFieldInfo DebuffTableFields[] = {
    { "amount", "amount", "int32", 0x8113fe7ea2b16969ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Debuff, amount ), (uint32_t) sizeof( Debuff::amount ), 0xffffffffu, 0xffffffffu, NULL, true, 0.0, 100.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo DebuffTableInfo = { "Debuff", (uint32_t) sizeof( Debuff ), 1, DebuffTableFields, +[]( void * p ) { DebuffReset( *(Debuff *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * DebuffTableType() { return &DebuffTableInfo; }
...
// ProfileConfig in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in TablesTable.cpp; link it to use them.
bool ProfileConfigFromJson( ProfileConfigBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t ProfileConfigToJsonMeasure( const ProfileConfig * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t ProfileConfigToJson( const ProfileConfig * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );

// RootConfig in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in TablesTable.cpp; link it to use them.
bool RootConfigFromJson( RootConfigBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t RootConfigToJsonMeasure( const RootConfig * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t RootConfigToJson( const RootConfig * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
