...
constexpr TableFixedGuard ArchiveConfigFixedGuards[] = {
...
constexpr int32_t ArchiveConfigFixedGuardCount = 40;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) ArchiveConfigFixedGuards;
