...
constexpr TableFixedGuard TeamConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t TeamConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) TeamConfigFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard GunnerConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t GunnerConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) GunnerConfigFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard TurretConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t TurretConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) TurretConfigFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard HullConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t HullConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) HullConfigFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard KeyedConfigFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t KeyedConfigFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) KeyedConfigFixedGuards;
