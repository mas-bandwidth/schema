...
{
    return TableJsonRead( &value, WeaponConfigTableType(), text, bytes, report );
}

int64_t WeaponConfigToJsonMeasure( const WeaponConfig & value )
{
    return TableJsonWrite( &value, WeaponConfigTableType(), NULL, 0 );
}

int64_t WeaponConfigToJson( const WeaponConfig & value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( &value, WeaponConfigTableType(), buffer, capacity );
}

bool LoadoutConfigFromJson( LoadoutConfig & value, const char * text, int64_t bytes, TableReport * report )
{
    return TableJsonRead( &value, LoadoutConfigTableType(), text, bytes, report );
}

int64_t LoadoutConfigToJsonMeasure( const LoadoutConfig & value )
{
    return TableJsonWrite( &value, LoadoutConfigTableType(), NULL, 0 );
}
...
{
    return TableJsonRead( &value, AttachmentTableType(), text, bytes, report );
}

int64_t AttachmentToJsonMeasure( const Attachment & value )
{
    return TableJsonWrite( &value, AttachmentTableType(), NULL, 0 );
}

int64_t AttachmentToJson( const Attachment & value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( &value, AttachmentTableType(), buffer, capacity );
}

bool BuffFromJson( Buff & value, const char * text, int64_t bytes, TableReport * report )
{
    return TableJsonRead( &value, BuffTableType(), text, bytes, report );
}

int64_t BuffToJsonMeasure( const Buff & value )
{
    return TableJsonWrite( &value, BuffTableType(), NULL, 0 );
}

int64_t BuffToJson( const Buff & value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( &value, BuffTableType(), buffer, capacity );
}

bool DebuffFromJson( Debuff & value, const char * text, int64_t bytes, TableReport * report )
{
    return TableJsonRead( &value, DebuffTableType(), text, bytes, report );
}

int64_t DebuffToJsonMeasure( const Debuff & value )
{
    return TableJsonWrite( &value, DebuffTableType(), NULL, 0 );
}

int64_t DebuffToJson( const Debuff & value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( &value, DebuffTableType(), buffer, capacity );
}
