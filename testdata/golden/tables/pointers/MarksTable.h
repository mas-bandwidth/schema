...
constexpr uint64_t TallyFixedHash = 0x772fc9106c65a1e0ull; // fnv1a64 over the block's bytes
...
constexpr uint8_t TallyFixedVocab[] = {
...
constexpr int64_t TallyFixedVocabBytes = (int64_t) sizeof( TallyFixedVocab );
...
{
    return 1 + 4 + TallyFixedVocabBytes + count * TallyFixedRecordBytes;
}
...
inline int64_t TallyFixedSave( const Tally * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) TallyFixedVocabBytes );
    memcpy( buffer + 5, TallyFixedVocab, (size_t) TallyFixedVocabBytes );
    uint8_t * at = buffer + 5 + TallyFixedVocabBytes;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != TallyFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, TallyFixedVocab, (int32_t) TallyFixedVocabBytes, TallyFixedDst, plan, plan_capacity, &compiled_guarded, report );
