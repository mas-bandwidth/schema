...
{
    return 1 + 4 + TallyFixedLayoutBytes + count * TallyFixedRecordBytes;
}
...
inline int64_t TallyFixedSave( const Tally * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) TallyFixedLayoutBytes );
    memcpy( buffer + 5, TallyFixedLayout, (size_t) TallyFixedLayoutBytes );
    uint8_t * at = buffer + 5 + TallyFixedLayoutBytes;
