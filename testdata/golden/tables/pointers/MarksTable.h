...
constexpr TableFixedGuard TallyFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t TallyFixedGuardCount = 0;
...
constexpr TableFixedEntry TallyFixedPlan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, // hits
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) TallyFixedGuards;
