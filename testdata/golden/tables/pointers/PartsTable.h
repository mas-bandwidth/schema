...
constexpr TableFixedDst StampFixedDst[] = {
    ...
    { (uint32_t) __builtin_offsetof( Stamp, tag_length ), 0, (uint32_t) __builtin_offsetof( Stamp, tag ), 0, 1, 0ull, 0ull, 0, 0 }, // tag
    { (uint32_t) __builtin_offsetof( Stamp, seq ), 0, 0, 0, 0, 0ull, 1000ull, 7, 4 }, // seq
};
