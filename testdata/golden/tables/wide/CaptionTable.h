...
constexpr TableFixedGuard StampFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t StampFixedGuardCount = 0;
...
constexpr TableFixedEntry StampFixedPlan[] = {
    { 0u, 12u, 8u, 0u, 0u, 0, kTableFixedText, 2, 0, 0 }, // label
    { 12u, 16u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, // seq
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) StampFixedGuards;
