...
constexpr TableFixedDst StampFixedDst[] = {
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Stamp
    { (uint32_t) __builtin_offsetof( Stamp, label_length ), 0, (uint32_t) __builtin_offsetof( Stamp, label ), 0, 2, 0ull, 0ull, 0, 0 }, // label
    { (uint32_t) __builtin_offsetof( Stamp, seq ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // seq
};
