// Code generated by the schema compiler from Assets.schema. DO NOT EDIT.
// SPDX-License-Identifier: NONE — this generated output is yours, under terms of
// your choice. See the LICENSE exception in the schema compiler; the compiler is
// AGPL-3.0, its output is not.
// package blobdemo — protocol id 0xa844824278770488 (packets only: tables version by field id, not by protocol id)
...
#ifndef BLOBDEMO_SCHEMA_TABLE_PRIMITIVES
#define BLOBDEMO_SCHEMA_TABLE_PRIMITIVES
...
#if defined( _MSC_VER )
#define BLOBDEMO_TABLE_INLINE __forceinline
#elif defined( __GNUC__ ) || defined( __clang__ )
#define BLOBDEMO_TABLE_INLINE inline __attribute__(( always_inline ))
#else
#define BLOBDEMO_TABLE_INLINE inline
#endif
...
struct TableWriter
{
    ...
    BLOBDEMO_TABLE_INLINE void raw( const void * data, int64_t bytes )
    {
        if ( offset + bytes > capacity ) { overflow = true; return; }
        memcpy( buffer + offset, data, (size_t) bytes );
        offset += bytes;
    }
    BLOBDEMO_TABLE_INLINE void put8( uint8_t v )   { raw( &v, 1 ); }
    BLOBDEMO_TABLE_INLINE void put16( uint16_t v ) { uint8_t b[2] = { uint8_t( v ), uint8_t( v >> 8 ) }; raw( b, 2 ); }
    BLOBDEMO_TABLE_INLINE void put32( uint32_t v ) { uint8_t b[4] = { uint8_t( v ), uint8_t( v >> 8 ), uint8_t( v >> 16 ), uint8_t( v >> 24 ) }; raw( b, 4 ); }
    ...
    BLOBDEMO_TABLE_INLINE void put64( uint64_t v )
    {
    ...
    BLOBDEMO_TABLE_INLINE void putleb( uint64_t v )
    {
        uint8_t b[10];
        int64_t n = 0;
...
struct TableIds
{
    static const int32_t kCapacity = 14;
    static const int32_t kBuckets = 32;
    ...
    {
        return uint32_t( ( id * 0x9E3779B97F4A7C15ull ) >> 59 ) & uint32_t( kBuckets - 1 );
    }
    ...
    BLOBDEMO_TABLE_INLINE uint64_t ref( uint64_t id )
    {
...
struct TableReader
{
    ...
    BLOBDEMO_TABLE_INLINE bool has( int64_t bytes ) const { return offset + bytes <= size; }
    ...
    BLOBDEMO_TABLE_INLINE bool room( uint64_t bytes ) const { return bytes <= (uint64_t) ( size - offset ); }
    BLOBDEMO_TABLE_INLINE uint8_t get8()   { return buffer[offset++]; }
    BLOBDEMO_TABLE_INLINE uint16_t get16() { uint16_t v = uint16_t( buffer[offset] ) | uint16_t( buffer[offset+1] ) << 8; offset += 2; return v; }
    BLOBDEMO_TABLE_INLINE uint32_t get32() { uint32_t v = uint32_t( buffer[offset] ) | uint32_t( buffer[offset+1] ) << 8 | uint32_t( buffer[offset+2] ) << 16 | uint32_t( buffer[offset+3] ) << 24; offset += 4; return v; }
    BLOBDEMO_TABLE_INLINE uint64_t get64() { uint64_t lo = get32(); uint64_t hi = get32(); return lo | ( hi << 32 ); }
    BLOBDEMO_TABLE_INLINE void get128( uint64_t & lo, uint64_t & hi ) { lo = get64(); hi = get64(); }
...
static const int64_t kTableMessageRefBitsHere = 4;
...
static const int64_t kTableMessageEntriesHere = 15;
...
static const uint64_t kTableNodeTableFieldSlot = 10;
...
// THE UNIT'S ANNOUNCEMENT, byte for byte: 15 entries and 180 bytes. It is an
...
static const uint8_t kTableAnnounce[ kTableAnnounceBytes ] = {
    ...
    0x08, 0x00, 0x05, 0x4a, 0xa3, 0x30, 0x67, 0x55, 0x5b, 0x85, 0x11, 0xa5,
    0x02, 0x4c, 0x86, 0xeb, 0x28, 0xaa, 0x5d, 0x11, 0x28, 0xf0, 0x25, 0xa0,
    0xba, 0x6c, 0x31, 0xe5, 0x11, 0x03, 0x0c, 0x9a, 0x5f, 0xcc, 0x12, 0x8f,
    0x0a, 0x11, 0x03, 0xb2, 0xf4, 0x0f, 0x72, 0x19, 0x3b, 0x61, 0x11, 0xdd,
    0x7c, 0x58, 0xd1, 0xba, 0xfb, 0xf8, 0x3b, 0x11, 0xb7, 0x46, 0xa6, 0x65,
    0xbb, 0x20, 0x92, 0x50, 0x11, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0x00, 0xe4, 0x4f, 0x1c, 0x4f, 0x47, 0xc0, 0x2e, 0x2f, 0x00, 0x58,
    0xfc, 0xaf, 0xfa, 0xd8, 0xe0, 0x4b, 0x70, 0x00, 0xc7, 0xd4, 0x7b, 0x26,
    0xb0, 0x9d, 0x29, 0x5f, 0x00, 0xfb, 0x64, 0x5f, 0xfe, 0xcc, 0x6d, 0x4e,
    0x8e, 0x00, 0x38, 0x66, 0x91, 0xbc, 0xc1, 0x50, 0x17, 0x1f, 0x00, 0x00,
...
#endif // BLOBDEMO_SCHEMA_TABLE_PRIMITIVES

#ifndef BLOBDEMO_SCHEMA_TABLE_ARENA
#define BLOBDEMO_SCHEMA_TABLE_ARENA
...
#endif // BLOBDEMO_SCHEMA_TABLE_ARENA

#ifndef BLOBDEMO_SCHEMA_TABLE_MESSAGE_NODES
#define BLOBDEMO_SCHEMA_TABLE_MESSAGE_NODES
...
#endif // BLOBDEMO_SCHEMA_TABLE_MESSAGE_NODES

#ifndef BLOBDEMO_SCHEMA_TABLE_RETAIN
#define BLOBDEMO_SCHEMA_TABLE_RETAIN
...
static const uint64_t kTableRetainKnown[ kTableRetainKnownIds ] = {
    ...
    0xef9c96d721673243ull, 0xffffffffffffffffull,
};
...
#endif // BLOBDEMO_SCHEMA_TABLE_RETAIN

#ifndef BLOBDEMO_SCHEMA_BUILD_VERSION
#define BLOBDEMO_SCHEMA_BUILD_VERSION
...
static const uint64_t BuildVersion = 0xb003052c0ddd7685ull;

} // namespace blobdemo

#endif // BLOBDEMO_SCHEMA_BUILD_VERSION

#ifndef BLOBDEMO_SCHEMA_TABLE_COOK
#define BLOBDEMO_SCHEMA_TABLE_COOK
...
#endif // BLOBDEMO_SCHEMA_TABLE_COOK

#ifndef BLOBDEMO_SCHEMA_TABLE_COOK_VARIABLE
#define BLOBDEMO_SCHEMA_TABLE_COOK_VARIABLE
...
#endif // BLOBDEMO_SCHEMA_TABLE_COOK_VARIABLE

namespace blobdemo {

// table Asset — TABLE-wire storage: relocatable, bounded, defaults in the
...
struct Asset {
    ...
    TableRef caption; // *string — a byte buffer at its used size, null until assigned
    TableRef next; // *Asset — null until assigned
};

// table Catalog — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Catalog {
    char name[32 + 1] = {}; // string(32): max length, used length beside it
    int32_t name_length = 0;
    TableRef head; // *Asset — null until assigned
    TableRef thumb; // *bytes — a byte buffer at its used size, null until assigned
    TableRef note; // *string — a byte buffer at its used size, null until assigned
    TableRef alias; // *bytes — a byte buffer at its used size, null until assigned
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void AssetReset( Asset & value );
inline void CatalogReset( Catalog & value );
...
inline void AssetReset( Asset & value )
{
    ...
    value.name_length = 0;
    value.kind = 0;
    value.data.value = 0; // *bytes — null
    value.caption.value = 0; // *string — null
    value.next.value = 0; // *Asset — null
}
...
inline void CatalogReset( Catalog & value )
{
    memset( value.name, 0, sizeof( value.name ) );
    value.name_length = 0;
    value.head.value = 0; // *Asset — null
    value.thumb.value = 0; // *bytes — null
    value.note.value = 0; // *string — null
    value.alias.value = 0; // *bytes — null
}

template <typename Ctx> inline int64_t AssetMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Asset & value );
template <typename Ctx> inline bool AssetSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Asset & value );
inline bool AssetLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Asset & value );
template <typename Ctx> inline int64_t CatalogMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Catalog & value );
template <typename Ctx> inline bool CatalogSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Catalog & value );
inline bool CatalogLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Catalog & value );
...
inline void TableReset( Asset & value ) { AssetReset( value ); }
inline void TableReset( Catalog & value ) { CatalogReset( value ); }
...
// Asset is a pointer target.
inline const Asset * AssetAt( const TableRef & ref ) // the const form's hot path: one add, no base
{
    return ref.value != 0 ? (const Asset *) ( (const uint8_t *) &ref + ref.value ) : NULL;
}
inline Asset * AssetAt( TableRef & ref )
{
    return ref.value != 0 ? (Asset *) ( (uint8_t *) &ref + ref.value ) : NULL;
}
inline const Asset * AssetAt( const TableRegionCtx &, const TableRef & ref ) { return AssetAt( ref ); }
inline const Asset * AssetAt( const TableArenaCtx & ctx, const TableRef & ref )
{
    return ref.value != 0 ? (const Asset *) TableArenaAt( *ctx.arena, (uint32_t) ref.value ) : NULL;
}
// while the builder is mutable, resolve against the arena itself
inline Asset * AssetAt( TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (Asset *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
inline const Asset * AssetAt( const TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (const Asset *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
// allocate one Asset in the arena; the slot holds the arena offset
inline Asset * AssetEmplace( TableWorker & worker, TableRef & slot )
{
    TableSlot<Asset> allocated = worker.Alloc<Asset>();
    slot = allocated.ref;
...
template <typename Ctx> inline int64_t AssetMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Asset & value );
template <typename Ctx> inline bool AssetSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Asset & value );
template <typename Ctx> inline bool AssetSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Asset & value );
inline bool AssetLoadBody( TableReader & r, const TableNodeMap & nodes, Asset & value );
template <typename Ctx> inline int64_t CatalogMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Catalog & value );
template <typename Ctx> inline bool CatalogSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Catalog & value );
template <typename Ctx> inline bool CatalogSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Catalog & value );
inline bool CatalogLoadBody( TableReader & r, const TableNodeMap & nodes, Catalog & value );

// ---- pointer-graph walkers: number (measure/save), pack (Lock) ----

template <typename Ctx> inline bool AssetNumber( const Ctx & ctx, TableNumbering & numbering, const Asset & value );
template <typename Ctx> inline int64_t AssetPackMeasure( const Ctx & ctx, TablePackMap & seen, const Asset & value );
template <typename Ctx> inline bool AssetPack( const Ctx & ctx, TablePackMap & seen, const Asset & src, Asset & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool CatalogNumber( const Ctx & ctx, TableNumbering & numbering, const Catalog & value );
template <typename Ctx> inline int64_t CatalogPackMeasure( const Ctx & ctx, TablePackMap & seen, const Catalog & value );
template <typename Ctx> inline bool CatalogPack( const Ctx & ctx, TablePackMap & seen, const Catalog & src, Catalog & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Asset & value ) { return AssetMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Asset & value ) { return AssetSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Asset & value ) { return AssetMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Asset & value ) { return AssetSaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Catalog & value ) { return CatalogMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Catalog & value ) { return CatalogSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Catalog & value ) { return CatalogMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Catalog & value ) { return CatalogSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
template <typename Ctx> inline int64_t AssetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool AssetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool AssetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path );
inline bool AssetLoadBodyRetain( TableReader & r, const TableNodeMap & nodes, Asset & value, TableRetain * retain, const TableRetainPath & path );
inline bool AssetLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Asset & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t CatalogMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CatalogSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CatalogSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path );
inline bool CatalogLoadBodyRetain( TableReader & r, const TableNodeMap & nodes, Catalog & value, TableRetain * retain, const TableRetainPath & path );
inline bool CatalogLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Catalog & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t AssetMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Asset & value )
{
    ...
    if ( value.kind != 0 ) { bytes += TableLebBytes( ids.ref_at( 12, 0xef9c96d721673243ull ) ) + 1 + 4; } // kind
    {
        ...
        // §3.1): the header and the index here, the bytes themselves as a
        // record in the node table. Null is elided and a non-null blob always
        // rides, even at length zero — null and empty are two values.
        if ( blob_data != NULL )
        {
    ...
    {
        const TableBlob * blob_caption = TableBlobAt( ctx, value.caption ); // *string
        // A BYTE BUFFER RIDES AS A NODE INDEX too (docs/SPEC-TABLES.md §2.5,
        // §3.1): the header and the index here, the bytes themselves as a
        // record in the node table. Null is elided and a non-null blob always
        // rides, even at length zero — null and empty are two values.
        if ( blob_caption != NULL )
        {
    ...
    {
        const Asset * pointee_next = AssetAt( ctx, value.next ); // *Asset
...
template <typename Ctx>
inline bool AssetSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Asset & value )
{
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    {
        w.header( ids.ref_at( 10, 0xc4bcadba8e631b86ull ), 12 ); // name
        w.putleb( (uint64_t) value.name_length );
        w.raw( value.name, value.name_length );
    }
    if ( value.kind != 0 )
    {
        w.header( ids.ref_at( 12, 0xef9c96d721673243ull ), 8 ); // kind
    ...
    }
    {
        ...
        if ( blob_data != NULL )
        {
            ...
            w.header( ids.ref_at( 8, 0x855b556730a34a05ull ), 17 ); // data — a NODE INDEX into the flat node table
            w.putleb( index_data );
        }
    }
    {
        ...
        if ( blob_caption != NULL )
        {
            ...
            w.header( ids.ref_at( 5, 0x5daa28eb864c02a5ull ), 17 ); // caption — a NODE INDEX into the flat node table
    ...
    }
    {
        ...
        if ( pointee_next != NULL )
        {
            ...
            w.header( ids.ref_at( 11, 0xe5316cbaa025f028ull ), 17 ); // next — a NODE INDEX into the flat node table
            w.putleb( index_next );
        }
    }
    return !w.overflow;
...
template <typename Ctx>
inline bool AssetSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Asset & value )
{
    if ( !AssetSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
...
inline bool AssetLoadBody( TableReader & r, const TableNodeMap & nodes, Asset & value )
{
    AssetReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0x855b556730a34a05ull: // data
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    ...
                    TableNodeResolve( nodes, value.data, node_index, kTableBytesTypeId, r.report ); // *bytes
                }
                break;
            }
            case 0x5daa28eb864c02a5ull: // caption
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.caption, node_index, kTableStringTypeId, r.report ); // *string
                }
                break;
            }
            case 0xe5316cbaa025f028ull: // next
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.next, node_index, 0x8e4e6dccfe5f64fbull, r.report ); // *Asset
                }
                break;
            }
...
template <typename Ctx>
inline int64_t AssetMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Asset & value )
{
    ...
    {
        const TableBlob * pointee_data = TableBlobAt( ctx, value.data ); // *bytes: a byte buffer
        if ( pointee_data != NULL )
        {
            uint64_t index_data = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_data, index_data ) ) { return -1; }
            bits += kTableMessageRefBitsHere;
            bits += index_bits;
        }
    }
    {
        const TableBlob * pointee_caption = TableBlobAt( ctx, value.caption ); // *string: a byte buffer
        if ( pointee_caption != NULL )
        {
            uint64_t index_caption = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_caption, index_caption ) ) { return -1; }
            bits += kTableMessageRefBitsHere;
            bits += index_bits;
        }
    }
...
template <typename Ctx>
inline bool AssetSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Asset & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    ...
    }
    {
        ...
        {
            uint64_t index_data = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_data, index_data ) ) { return false; }
            w.put( 3, kTableMessageRefBitsHere );
            w.put( index_data, index_bits );
        }
    }
    {
        const TableBlob * pointee_caption = TableBlobAt( ctx, value.caption ); // *string: a byte buffer
        ...
        {
            uint64_t index_caption = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_caption, index_caption ) ) { return false; }
            w.put( 4, kTableMessageRefBitsHere );
            w.put( index_caption, index_bits );
        }
    }
    {
        const Asset * pointee_next = AssetAt( ctx, value.next ); // *Asset
        ...
        switch ( entry.id )
        {
            ...
            case 0x855b556730a34a05ull: // data
            {
                ...
                }
                {
                    ...
                    TableNodeResolve( nodes, value.data, node_index, kTableBytesTypeId, report ); // *bytes
                }
                break;
            }
            case 0x5daa28eb864c02a5ull: // caption
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.caption, node_index, kTableStringTypeId, report ); // *string
                }
                break;
            }
            case 0xe5316cbaa025f028ull: // next
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.next, node_index, 0x8e4e6dccfe5f64fbull, report ); // *Asset
                }
                break;
            }
            default:
...
template <typename Ctx>
inline int64_t CatalogMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Catalog & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.name_length < 0 || value.name_length > 32 ) { return -1; } // storage invariant
    if ( value.name_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 10, 0xc4bcadba8e631b86ull ) ) + 1 + TableLebBytes( (uint64_t) ( value.name_length ) ) + ( value.name_length ); } // name
    ...
    {
        const TableBlob * blob_thumb = TableBlobAt( ctx, value.thumb ); // *bytes
        // A BYTE BUFFER RIDES AS A NODE INDEX too (docs/SPEC-TABLES.md §2.5,
        // §3.1): the header and the index here, the bytes themselves as a
        // record in the node table. Null is elided and a non-null blob always
        // rides, even at length zero — null and empty are two values.
    ...
    {
        const TableBlob * blob_note = TableBlobAt( ctx, value.note ); // *string
        // A BYTE BUFFER RIDES AS A NODE INDEX too (docs/SPEC-TABLES.md §2.5,
        // §3.1): the header and the index here, the bytes themselves as a
        // record in the node table. Null is elided and a non-null blob always
        // rides, even at length zero — null and empty are two values.
    ...
    {
        const TableBlob * blob_alias = TableBlobAt( ctx, value.alias ); // *bytes
        // A BYTE BUFFER RIDES AS A NODE INDEX too (docs/SPEC-TABLES.md §2.5,
        // §3.1): the header and the index here, the bytes themselves as a
        // record in the node table. Null is elided and a non-null blob always
        // rides, even at length zero — null and empty are two values.
...
template <typename Ctx>
inline bool CatalogSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Catalog & value )
{
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    {
    ...
    }
    {
        ...
        if ( blob_thumb != NULL )
        {
            ...
            w.header( ids.ref_at( 6, 0x613b19720ff4b203ull ), 17 ); // thumb — a NODE INDEX into the flat node table
    ...
    }
    {
        ...
        if ( blob_note != NULL )
        {
            ...
            w.header( ids.ref_at( 3, 0x3bf8fbbad1587cddull ), 17 ); // note — a NODE INDEX into the flat node table
            w.putleb( index_note );
        }
    }
    {
        ...
        if ( blob_alias != NULL )
        {
            ...
            w.header( ids.ref_at( 4, 0x509220bb65a646b7ull ), 17 ); // alias — a NODE INDEX into the flat node table
...
template <typename Ctx>
inline bool CatalogSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Catalog & value )
{
    if ( !CatalogSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
inline bool CatalogLoadBody( TableReader & r, const TableNodeMap & nodes, Catalog & value )
{
    CatalogReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
        uint64_t field_ref = 0;
        if ( !r.getleb( field_ref ) ) { r.report->malformed = true; return false; }
        ...
        switch ( field_id )
        {
            ...
            case 0x0a8f12cc5f9a0c03ull: // head
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.head, node_index, 0x8e4e6dccfe5f64fbull, r.report ); // *Asset
                }
                break;
            }
            case 0x613b19720ff4b203ull: // thumb
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.thumb, node_index, kTableBytesTypeId, r.report ); // *bytes
                }
                break;
            }
            case 0x3bf8fbbad1587cddull: // note
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.note, node_index, kTableStringTypeId, r.report ); // *string
                }
                break;
            }
            case 0x509220bb65a646b7ull: // alias
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    uint64_t node_index = 0;
                    if ( !r.getleb( node_index ) ) { r.report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.alias, node_index, kTableBytesTypeId, r.report ); // *bytes
                }
                break;
            }
            case 0xffffffffffffffffull:
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t CatalogMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Catalog & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    if ( value.name_length < 0 || value.name_length > 32 ) { return -1; } // storage invariant
    ...
    {
        const TableBlob * pointee_thumb = TableBlobAt( ctx, value.thumb ); // *bytes: a byte buffer
        if ( pointee_thumb != NULL )
        {
            uint64_t index_thumb = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_thumb, index_thumb ) ) { return -1; }
            bits += kTableMessageRefBitsHere;
            bits += index_bits;
        }
    }
    {
        const TableBlob * pointee_note = TableBlobAt( ctx, value.note ); // *string: a byte buffer
    ...
    {
        const TableBlob * pointee_alias = TableBlobAt( ctx, value.alias ); // *bytes: a byte buffer
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool CatalogSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Catalog & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    ...
    }
    {
        ...
        {
            uint64_t index_thumb = 0;
            if ( !TableNumberingIndex( numbering, (const void *) pointee_thumb, index_thumb ) ) { return false; }
            w.put( 7, kTableMessageRefBitsHere );
            w.put( index_thumb, index_bits );
        }
    }
    {
        const TableBlob * pointee_note = TableBlobAt( ctx, value.note ); // *string: a byte buffer
        ...
        switch ( entry.id )
        {
            ...
            case 0x0a8f12cc5f9a0c03ull: // head
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.head, node_index, 0x8e4e6dccfe5f64fbull, report ); // *Asset
                }
                break;
            }
            case 0x613b19720ff4b203ull: // thumb
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.thumb, node_index, kTableBytesTypeId, report ); // *bytes
                }
                break;
            }
            case 0x3bf8fbbad1587cddull: // note
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.note, node_index, kTableStringTypeId, report ); // *string
                }
                break;
            }
            case 0x509220bb65a646b7ull: // alias
            {
                ...
                }
                {
                    uint64_t node_index = 0;
                    if ( !r.get( node_index, index_bits ) ) { report->malformed = true; return false; }
                    TableNodeResolve( nodes, value.alias, node_index, kTableBytesTypeId, report ); // *bytes
                }
                break;
            }
            default:
...
template <typename Ctx>
inline bool AssetNumber( const Ctx & ctx, TableNumbering & numbering, const Asset & value )
{
    {
        const TableBlob * blob = TableBlobAt( ctx, value.data ); // data: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            const TablePackEntry * entry = TablePackMapReach( numbering.seen, (const void *) blob,
            ...
            {
                TableNodeEntry node;
                node.node = (const void *) blob;
                node.type_id = kTableBytesTypeId;
                node.type_slot = 11; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableBlobMeasureThunk<Ctx>;
                node.save = &TableBlobSaveThunk<Ctx>;
                node.message_measure = &TableBlobMessageMeasureThunk<Ctx>;
                node.message_save = &TableBlobMessageSaveThunk<Ctx>;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.caption ); // caption: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            if ( taken )
            {
                ...
                node.type_slot = 12; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableBlobMeasureThunk<Ctx>;
                node.save = &TableBlobSaveThunk<Ctx>;
                node.message_measure = &TableBlobMessageMeasureThunk<Ctx>;
                node.message_save = &TableBlobMessageSaveThunk<Ctx>;
    ...
    {
        const Asset * pointee = AssetAt( ctx, value.next ); // next
        if ( pointee != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            else
            {
                ...
                node.type_id = 0x8e4e6dccfe5f64fbull; // fnv1a64( "Asset" )
                node.type_slot = 14; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableNodeMeasureThunk<Ctx, Asset>;
                node.save = &TableNodeSaveThunk<Ctx, Asset>;
                node.message_measure = &TableNodeMessageMeasureThunk<Ctx, Asset>;
                node.message_save = &TableNodeMessageSaveThunk<Ctx, Asset>;
                if ( !TableNumberingAppend( numbering, node ) ) { return false; }
                if ( !AssetNumber( ctx, numbering, *pointee ) ) { return false; }
...
// AssetPackMeasure: the packed region bytes of everything Asset POINTS AT.
...
template <typename Ctx>
inline int64_t AssetPackMeasure( const Ctx & ctx, TablePackMap & seen, const Asset & value )
{
    int64_t bytes = 0;
    {
        const TableBlob * blob = TableBlobAt( ctx, value.data ); // data: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            const TablePackEntry * entry = TablePackMapReach( seen, (const void *) blob, 0, taken, slot );
            if ( entry == NULL ) { return -1; } // the map could not grow
            if ( taken )
            {
                TablePackMapClose( seen, (const void *) blob, slot );
                bytes += TableBlobStorage( (int64_t) blob->length, false );
            }
        }
    }
    {
        const TableBlob * blob = TableBlobAt( ctx, value.caption ); // caption: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            {
                TablePackMapClose( seen, (const void *) blob, slot );
                bytes += TableBlobStorage( (int64_t) blob->length, true );
            }
        }
    }
    {
        ...
        if ( pointee != NULL )
        {
            ...
            {
                int64_t inner = AssetPackMeasure( ctx, seen, *pointee );
                if ( inner < 0 ) { return -1; }
                TablePackMapClose( seen, (const void *) pointee, slot );
                bytes += TableAlignUp64( (int64_t) sizeof( Asset ) ) + inner;
            }
        }
    }
    return bytes;
...
// AssetPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool AssetPack( const Ctx & ctx, TablePackMap & seen, const Asset & src, Asset & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Asset ) ); // trivially copyable, by construction
    {
        dst.data.value = 0; // data: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.data );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
            int64_t slot = 0;
            const TablePackEntry * entry = TablePackMapReach( seen, (const void *) blob, at, taken, slot );
            if ( entry == NULL ) { return false; } // the map could not grow
            if ( !taken )
            {
                dst.data.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.data ); // the one body it already has
            }
            else
            {
                int64_t storage = TableBlobStorage( (int64_t) blob->length, false );
                if ( at + storage > capacity ) { return false; }
                memcpy( base + at, (const void *) blob, (size_t) ( kTableBlobHeader + (int64_t) blob->length ) );
                used = at + storage;
                dst.data.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.data );
                TablePackMapClose( seen, (const void *) blob, slot );
            }
        }
    }
    {
        dst.caption.value = 0; // caption: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.caption );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
            ...
            if ( !taken )
            {
                dst.caption.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.caption ); // the one body it already has
            }
            else
            {
                int64_t storage = TableBlobStorage( (int64_t) blob->length, true );
                if ( at + storage > capacity ) { return false; }
                memcpy( base + at, (const void *) blob, (size_t) ( kTableBlobHeader + (int64_t) blob->length ) );
                used = at + storage;
                dst.caption.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.caption );
                TablePackMapClose( seen, (const void *) blob, slot );
            }
        }
    }
    {
        ...
        const Asset * pointee = AssetAt( ctx, src.next );
        if ( pointee != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
            ...
            {
                if ( at + (int64_t) sizeof( Asset ) > capacity ) { return false; }
                used = at + TableAlignUp64( (int64_t) sizeof( Asset ) );
                Asset * child = new ( base + at ) Asset; // lifetime only: the Pack below memcpy's the whole node over it
                dst.next.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.next );
                if ( !AssetPack( ctx, seen, *pointee, *child, base, capacity, used ) ) { return false; }
                TablePackMapClose( seen, (const void *) pointee, slot );
            }
        }
    }
...
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool CatalogNumber( const Ctx & ctx, TableNumbering & numbering, const Catalog & value )
{
    {
        const Asset * pointee = AssetAt( ctx, value.head ); // head
        if ( pointee != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.thumb ); // thumb: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.note ); // note: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.alias ); // alias: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
...
// CatalogPackMeasure: the packed region bytes of everything Catalog POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t CatalogPackMeasure( const Ctx & ctx, TablePackMap & seen, const Catalog & value )
{
    int64_t bytes = 0;
    {
        const Asset * pointee = AssetAt( ctx, value.head ); // head
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.thumb ); // thumb: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.note ); // note: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
    ...
    {
        const TableBlob * blob = TableBlobAt( ctx, value.alias ); // alias: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
...
// CatalogPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool CatalogPack( const Ctx & ctx, TablePackMap & seen, const Catalog & src, Catalog & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Catalog ) ); // trivially copyable, by construction
    {
        dst.head.value = 0; // head
        const Asset * pointee = AssetAt( ctx, src.head );
        if ( pointee != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
    ...
    {
        dst.thumb.value = 0; // thumb: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.thumb );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
            ...
            if ( !taken )
            {
                dst.thumb.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.thumb ); // the one body it already has
            }
            else
            {
                int64_t storage = TableBlobStorage( (int64_t) blob->length, false );
                ...
                memcpy( base + at, (const void *) blob, (size_t) ( kTableBlobHeader + (int64_t) blob->length ) );
                used = at + storage;
                dst.thumb.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.thumb );
                TablePackMapClose( seen, (const void *) blob, slot );
            }
        }
    }
    {
        dst.note.value = 0; // note: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.note );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
    ...
    {
        dst.alias.value = 0; // alias: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.alias );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
...
// ---- Asset: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: AssetBuilder — allocate nodes, wire them together, then Lock.
...
// Asset is never held by value — a file-format-scale structure is a region
...
struct AssetBuilder
{
    ...
    AssetBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Asset * GetRoot() { return arena.locked ? NULL : (Asset *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Asset * AsConst() const { return (const Asset *) region; }
...
inline bool AssetBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Asset & root = *(const Asset *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Asset on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// AssetNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t AssetNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return TableAlignUp64( (int64_t) sizeof( Asset ) ); // Asset
        case kTableBytesTypeId: if ( length > kTableBlobMaxLength ) { reason = blob_over_size_cap; return kTableNodeRefused; } return TableBlobStorage( length, false ); // *bytes
        case kTableStringTypeId: if ( length > kTableBlobMaxLength ) { reason = blob_over_size_cap; return kTableNodeRefused; } return TableBlobStorage( length, true ); // *string
        default: break;
    }
    return -1;
}

// AssetNodePlace: start one record's node's lifetime in the storage pass one
...
inline void AssetNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: { Asset * node = new ( at ) Asset; AssetReset( *node ); break; } // Asset
        case kTableBytesTypeId: { TableBlob * blob = (TableBlob *) at; blob->length = (uint32_t) length; blob->zero = 0; break; } // *bytes
        case kTableStringTypeId: { TableBlob * blob = (TableBlob *) at; blob->length = (uint32_t) length; blob->zero = 0; break; } // *string
        default: break;
    }
}

// AssetNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t AssetNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return (uint32_t) worker.Alloc<Asset>().ref.value; // Asset
        case kTableBytesTypeId: return (uint32_t) worker.AllocBytes( length ).ref.value; // *bytes
        case kTableStringTypeId: return (uint32_t) worker.AllocString( length ).ref.value; // *string
        default: break;
    }
    return 0;
}
...
inline void AssetNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: AssetLoadBody( r, nodes, *(Asset *) at ); break; // Asset
        case kTableBytesTypeId: if ( r.size > 0 ) { memcpy( at + kTableBlobHeader, r.buffer, (size_t) r.size ); } break; // *bytes
        case kTableStringTypeId: if ( r.size > 0 ) { memcpy( at + kTableBlobHeader, r.buffer, (size_t) r.size ); } break; // *string
        default: break;
    }
}

// AssetNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t AssetNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Asset ) ) + extent ); // Asset
        case kTableBytesTypeId: return TableBlobStorage( length, false ); // *bytes
        case kTableStringTypeId: return TableBlobStorage( length, true ); // *string
        default: break;
    }
    return -1;
}

// AssetNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool AssetNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// AssetNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool AssetNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    bool ok = false;
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: ok = AssetLoadMessageBody( r, vocabulary, report, nodes, index_bits, *(Asset *) at ); break; // Asset
...
template <typename Ctx>
inline bool AssetNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Asset & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return AssetNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t AssetMeasureWire( const Ctx & ctx, const Asset & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( AssetNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = AssetMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t AssetSaveWire( const Ctx & ctx, const Asset & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !AssetNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = AssetSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == AssetMeasure( root )
}

inline int64_t AssetMeasure( const Asset * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return AssetMeasureWire( ctx, *root, allocator );
}

inline int64_t AssetSave( const Asset * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return AssetSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t AssetMeasure( const AssetBuilder & builder )
{
    if ( builder.region != NULL ) { return AssetMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return AssetMeasureWire( ctx, *(const Asset *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t AssetSave( const AssetBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return AssetSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return AssetSaveWire( ctx, *(const Asset *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Asset on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// AssetMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t AssetMessageBodyBits( const Ctx & ctx, const Asset & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( AssetNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = AssetMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool AssetMessageBodySave( const Ctx & ctx, const Asset & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && AssetSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t AssetMeasureMessages( const Asset * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = AssetMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t AssetSaveMessages( const Asset * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !AssetMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == AssetMeasureMessages( roots, count, report, allocator )
}

// AssetMessageRecordScan: one node record's type id and the extent its maps
...
inline bool AssetMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return AssetNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// AssetMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool AssetMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !AssetMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = AssetNodeMessageStorage( type_id, extent, length );
    ...
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Asset ) ) + root_extent );
    return true;
}

// AssetLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t AssetLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !AssetMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// AssetLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool AssetLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Asset * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !AssetMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = AssetNodeMessageStorage( type_id, extent, length );
        ...
        AssetNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Asset ) ) + root_extent );
    ...
    Asset * root = new ( region + used ) Asset; // lifetime only: LoadMessageBody's first act is AssetReset
    AssetReset( *root );
    root_out = root;
    used += root_bytes;
    nodes.good = true;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !AssetNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return AssetLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// AssetLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool AssetLoadMessages( const Asset ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !AssetLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// AssetLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t AssetLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t data = TableAlignUp64( (int64_t) sizeof( Asset ) );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = AssetNodeStorage( type_id, length, reason );
...
// AssetLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Asset * AssetLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Asset ) ) { out->malformed = true; return NULL; }
    ...
    directory[0].type_id = 0x8e4e6dccfe5f64fbull;
    Asset * root = new ( region ) Asset; // lifetime only: LoadBody's first act is AssetReset
    AssetReset( *root );
    ...
    // resolves whichever way it points. It reads no body.
    {
        ...
        {
            int64_t storage = AssetNodeStorage( type_id, length, reason );
            if ( type_id == kTableStringTypeId && !TableUtf8Valid( body, length ) )
            {
                out->malformed = true;
                directory[k + 1].offset = kTableNodeAbsent;
                directory[k + 1].type_id = type_id;
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                AssetNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    AssetLoadBody( r, nodes, *root );
    return root;
}

// AssetLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool AssetLoadBuilder( AssetBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                AssetNodeBody( type_id, sub, nodes, TableArenaAt( builder.arena, (uint32_t) directory[k + 1].offset ) );
            }
            k++;
        }
    }
...
// ---- Catalog: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: CatalogBuilder — allocate nodes, wire them together, then Lock.
// CONST:   one packed region, root at its base. Lock produces it and Load
//          produces it, so a locked structure and a loaded one are the
//          SAME representation with one view API. There is no unlock:
//          re-editing means loading the const form into a fresh builder.
// Catalog is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.
...
struct CatalogBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    CatalogBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    Catalog * GetRoot() { return arena.locked ? NULL : (Catalog *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Catalog * AsConst() const { return (const Catalog *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool CatalogBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Catalog & root = *(const Catalog *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = CatalogPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t total = TableAlignUp64( (int64_t) sizeof( Catalog ) ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) table_allocate( arena.allocator, total );
...
// ---- Catalog on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// CatalogNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
inline int64_t CatalogNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return TableAlignUp64( (int64_t) sizeof( Asset ) ); // Asset
...
// CatalogNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
inline void CatalogNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: { Asset * node = new ( at ) Asset; AssetReset( *node ); break; } // Asset
...
// CatalogNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t CatalogNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return (uint32_t) worker.Alloc<Asset>().ref.value; // Asset
...
// CatalogNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t CatalogNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Asset ) ) + extent ); // Asset
...
// CatalogNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool CatalogNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    (void) type_id; // no map below any node this root can name
    return TableMessageSkipBody( r, vocabulary, index_bits );
...
// CatalogNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool CatalogNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    bool ok = false;
    switch ( type_id )
    {
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool CatalogNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Catalog & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return CatalogNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t CatalogMeasureWire( const Ctx & ctx, const Catalog & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( CatalogNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = CatalogMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t CatalogSaveWire( const Ctx & ctx, const Catalog & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !CatalogNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    // the root's own fields, then the node table's field, then the
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = CatalogSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == CatalogMeasure( root )
}

inline int64_t CatalogMeasure( const Catalog * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CatalogMeasureWire( ctx, *root, allocator );
}

inline int64_t CatalogSave( const Catalog * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CatalogSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t CatalogMeasure( const CatalogBuilder & builder )
{
    if ( builder.region != NULL ) { return CatalogMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CatalogMeasureWire( ctx, *(const Catalog *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t CatalogSave( const CatalogBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return CatalogSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CatalogSaveWire( ctx, *(const Catalog *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Catalog on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// CatalogMessageBodyBits: one root body's bits at bit position `at` of the batch,
// with the numbering derived from the graph, the node table FIRST, then the
// fields, then the zero reference. Measure derives the numbering and save
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t CatalogMessageBodyBits( const Ctx & ctx, const Catalog & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( CatalogNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = CatalogMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool CatalogMessageBodySave( const Ctx & ctx, const Catalog & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && CatalogSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t CatalogMeasureMessages( const Catalog * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = CatalogMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t CatalogSaveMessages( const Catalog * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !CatalogMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == CatalogMeasureMessages( roots, count, report, allocator )
}

// CatalogMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool CatalogMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return CatalogNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// CatalogMessageBodyStorage: one body's node count and data bytes from the FRAMING
// alone, the reader left at the next body. The node table is walked record
// by record, a table record's body stepped over by its announced shapes and
// a blob's by its length, then the root's own fields. False is a numbering
// that could not be sized; `complete` false is a ROOT body whose own framing
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool CatalogMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !CatalogMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = CatalogNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !TableMessageSkipBody( r, vocabulary, index_bits ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Catalog ) ) + root_extent );
    return true;
}

// CatalogLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t CatalogLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !CatalogMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// CatalogLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool CatalogLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Catalog * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !CatalogMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = CatalogNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        CatalogNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Catalog ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x1f1750c1bc916638ull;
    Catalog * root = new ( region + used ) Catalog; // lifetime only: LoadMessageBody's first act is CatalogReset
    CatalogReset( *root );
    root_out = root;
    used += root_bytes;
    nodes.good = true;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !CatalogNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return CatalogLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// CatalogLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool CatalogLoadMessages( const Catalog ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !CatalogLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// CatalogLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t CatalogLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableNodeScan scan = TableNodeScanBegin( wire, wire_bytes, &ignored, &ids_table );
    TableRefuseReason reason = count_over_length;
    int64_t data = TableAlignUp64( (int64_t) sizeof( Catalog ) );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = CatalogNodeStorage( type_id, length, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// CatalogLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const Catalog * CatalogLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Catalog ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0x1f1750c1bc916638ull;
    Catalog * root = new ( region ) Catalog; // lifetime only: LoadBody's first act is CatalogReset
    CatalogReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                CatalogNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    CatalogLoadBody( r, nodes, *root );
    return root;
}

// CatalogLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool CatalogLoadBuilder( CatalogBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                CatalogNodeBody( type_id, sub, nodes, TableArenaAt( builder.arena, (uint32_t) directory[k + 1].offset ) );
            }
            k++;
        }
    }
...
template <typename Ctx>
inline int64_t AssetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.name_length < 0 || value.name_length > 32 ) { return -1; } // storage invariant
    if ( value.name_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 10, 0xc4bcadba8e631b86ull ) ) + 1 + TableLebBytes( (uint64_t) ( value.name_length ) ) + ( value.name_length ); } // name
...
template <typename Ctx>
inline bool AssetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    {
...
template <typename Ctx>
inline bool AssetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Asset & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !AssetSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t CatalogMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.name_length < 0 || value.name_length > 32 ) { return -1; } // storage invariant
    if ( value.name_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 10, 0xc4bcadba8e631b86ull ) ) + 1 + TableLebBytes( (uint64_t) ( value.name_length ) ) + ( value.name_length ); } // name
...
template <typename Ctx>
inline bool CatalogSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.name_length < 0 || value.name_length > 32 ) { return false; } // storage invariant
    if ( value.name_length > 0 )
    {
...
template <typename Ctx>
inline bool CatalogSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Catalog & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !CatalogSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
inline void AssetNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: AssetLoadBodyRetain( r, nodes, *(Asset *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Asset
        case kTableBytesTypeId: if ( r.size > 0 ) { memcpy( at + kTableBlobHeader, r.buffer, (size_t) r.size ); } break; // *bytes
        case kTableStringTypeId: if ( r.size > 0 ) { memcpy( at + kTableBlobHeader, r.buffer, (size_t) r.size ); } break; // *string
        default: break;
    }
...
// AssetLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Asset * AssetLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                AssetNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    AssetLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// AssetNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool AssetNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    bool ok = false;
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: ok = AssetLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *(Asset *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Asset
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    return ok;
...
// AssetLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool AssetLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Asset * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !AssetNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return AssetLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// AssetLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool AssetLoadRetainMessages( const Asset ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !AssetLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// AssetMeasureRetain and AssetSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t AssetMeasureWireRetain( const Ctx & ctx, const Asset & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0x8e4e6dccfe5f64fbull: return AssetMeasureBodyRetain( c, nn, ii, *(const Asset *) node, rt, at ); // Asset
            case kTableBytesTypeId: return (int64_t) ( (const TableBlob *) node )->length;
            case kTableStringTypeId: return (int64_t) ( (const TableBlob *) node )->length;
            default: break;
        }
        return -1;
    };
    if ( AssetNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = AssetMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t AssetSaveWireRetain( const Ctx & ctx, const Asset & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0x8e4e6dccfe5f64fbull: return AssetSaveBodyRetain( c, nn, ww, ii, *(const Asset *) node, rt, at ); // Asset
            case kTableBytesTypeId:
            {
                const TableBlob * blob = (const TableBlob *) node;
                ww.raw( (const void *) ( blob + 1 ), (int64_t) blob->length );
                return true;
            }
            case kTableStringTypeId:
            {
                const TableBlob * blob = (const TableBlob *) node;
                ww.raw( (const void *) ( blob + 1 ), (int64_t) blob->length );
                return true;
    ...
    bool ok = AssetSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t AssetMeasureRetain( const Asset * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return AssetMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t AssetSaveRetain( const Asset * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return AssetSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// AssetSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void CatalogNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    switch ( type_id )
    {
        case 0x8e4e6dccfe5f64fbull: AssetLoadBodyRetain( r, nodes, *(Asset *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Asset
...
// CatalogLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Catalog * CatalogLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                CatalogNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    TableReader r( wire, wire_bytes, out, &ids_table );
    r.nested = false; // the ROOT body, the one that carries the node table
    CatalogLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// CatalogNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is this body's own directory position, which the batch's load fills
// from the framing and nothing afterwards renumbers.
inline bool CatalogNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    bool ok = false;
    switch ( type_id )
    {
...
// CatalogLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
// each body carries its own node directory inside that one region and a
// record's first step is an index into it (docs/SPEC-TABLES.md §3.3, §6.6).
inline bool CatalogLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Catalog * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !CatalogNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    return CatalogLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// CatalogLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
// SaveRetain from `roots[k]` takes `retains[k]` and is the VARIABLE form's own
// pair unchanged: retention writing FORM 2 refuses by name (§3.3).
inline bool CatalogLoadRetainMessages( const Catalog ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !CatalogLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// CatalogMeasureRetain and CatalogSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t CatalogMeasureWireRetain( const Ctx & ctx, const Catalog & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( CatalogNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = CatalogMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t CatalogSaveWireRetain( const Ctx & ctx, const Catalog & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = CatalogSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t CatalogMeasureRetain( const Catalog * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CatalogMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t CatalogSaveRetain( const Catalog * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CatalogSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// CatalogSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the VARIABLE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t CatalogSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Catalog: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the VARIABLE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}

// ---- the cooked form: point at a cook (docs/SPEC-TABLES.md §7) ----

// AssetOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH AssetAt: the slot holds
...
// parameter on a load.
inline const Asset * AssetOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Asset *) TableCookOpen( bytes, length, (uint64_t) sizeof( Asset ), (uint64_t) alignof( Asset ), reason );
}

// CatalogOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH CatalogAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Catalog * CatalogOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Catalog *) TableCookOpen( bytes, length, (uint64_t) sizeof( Catalog ), (uint64_t) alignof( Catalog ), reason );
}
...
template <typename Ctx> inline bool AssetCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Asset & value, TableByteOrder order );
template <typename Ctx> inline bool CatalogCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Catalog & value, TableByteOrder order );

template <typename Ctx> inline bool AssetCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Asset & value, TableByteOrder order )
{
    table_cook_bytes( at + 0, value.name, value.name_length, 33 );
    table_cook_put( at + 36, (uint64_t) (uint32_t) value.name_length, 4, order );
    table_cook_put( at + 40, (uint64_t) value.kind, 4, order );
    if ( !table_cook_ref( region, at + 48, (const void *) TableBlobAt( ctx, value.data ), order ) ) { return false; } // data
    if ( !table_cook_ref( region, at + 56, (const void *) TableBlobAt( ctx, value.caption ), order ) ) { return false; } // caption
    if ( !table_cook_ref( region, at + 64, (const void *) AssetAt( ctx, value.next ), order ) ) { return false; } // next
    return true;
}
...
template <typename Ctx> inline bool CatalogCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Catalog & value, TableByteOrder order )
{
    table_cook_bytes( at + 0, value.name, value.name_length, 33 );
    table_cook_put( at + 36, (uint64_t) (uint32_t) value.name_length, 4, order );
    if ( !table_cook_ref( region, at + 40, (const void *) AssetAt( ctx, value.head ), order ) ) { return false; } // head
    if ( !table_cook_ref( region, at + 48, (const void *) TableBlobAt( ctx, value.thumb ), order ) ) { return false; } // thumb
    if ( !table_cook_ref( region, at + 56, (const void *) TableBlobAt( ctx, value.note ), order ) ) { return false; } // note
    if ( !table_cook_ref( region, at + 64, (const void *) TableBlobAt( ctx, value.alias ), order ) ) { return false; } // alias
    return true;
}

// AssetCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
inline bool AssetCookLayout( const TableNumbering & numbering, TableCookRegion & region )
{
    ...
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
        ...
        {
            case 0x8e4e6dccfe5f64fbull: size = 72; node_align = 8; break; // Asset
            case kTableBytesTypeId: size = kTableBlobHeader + (int64_t) ( (const TableBlob *) numbering.entries[k].node )->length + 0; node_align = 8; break; // *bytes
            case kTableStringTypeId: size = kTableBlobHeader + (int64_t) ( (const TableBlob *) numbering.entries[k].node )->length + 1; node_align = 8; break; // *string
            default: return false;
        }
...
// AssetCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t AssetCookMeasureFrom( const Ctx & ctx, const Asset & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( AssetNumberFrom( ctx, numbering, root ) && AssetCookLayout( numbering, region ) )
    {
...
// AssetCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool AssetCookFrom( const Ctx & ctx, const Asset & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = AssetCookBody( ctx, region, region.base, root, order );
            for ( int64_t k = 0; ok && k < numbering.count; k++ )
            {
                ...
                switch ( numbering.entries[k].type_id )
                {
                    case 0x8e4e6dccfe5f64fbull: ok = AssetCookBody( ctx, region, at, *(const Asset *) node, order ); break; // Asset
                    case kTableBytesTypeId:
                    {
                        const TableBlob * blob = (const TableBlob *) node; // *bytes
                        table_cook_put( at, (uint64_t) blob->length, 4, order );
                        table_cook_bytes( at + kTableBlobHeader, (const void *) ( blob + 1 ), (int64_t) blob->length, (int64_t) blob->length );
                        break;
                    }
                    case kTableStringTypeId:
                    {
                        const TableBlob * blob = (const TableBlob *) node; // *string
                        table_cook_put( at, (uint64_t) blob->length, 4, order );
                        table_cook_bytes( at + kTableBlobHeader, (const void *) ( blob + 1 ), (int64_t) blob->length, (int64_t) blob->length );
                        break;
                    }
            ...
            table_cook_put( entry + 8, 0x8e4e6dccfe5f64fbull, 8, order ); // the root: fnv1a64( "Asset" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// AssetCookMeasure / AssetCook over a REGION root — a locked builder's AsConst, a
// region AssetLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t AssetCookMeasure( const Asset * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return AssetCookMeasureFrom( ctx, *root, allocator );
}

inline bool AssetCook( const Asset * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return AssetCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t AssetCookMeasure( const AssetBuilder & builder )
{
    if ( builder.region != NULL ) { return AssetCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return AssetCookMeasureFrom( ctx, *(const Asset *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool AssetCook( const AssetBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return AssetCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return AssetCookFrom( ctx, *(const Asset *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}

// CatalogCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
// summed when it does not (a measure). A type id the numbering carries that
// this root cannot name is the two walks disagreeing, and it is refused.
inline bool CatalogCookLayout( const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    int64_t offset = 72; // the root, at zero
...
// CatalogCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t CatalogCookMeasureFrom( const Ctx & ctx, const Catalog & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( CatalogNumberFrom( ctx, numbering, root ) && CatalogCookLayout( numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// CatalogCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool CatalogCookFrom( const Ctx & ctx, const Catalog & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = CatalogCookBody( ctx, region, region.base, root, order );
            for ( int64_t k = 0; ok && k < numbering.count; k++ )
            {
                uint8_t * at = region.base + region.offsets[k + 1];
                const void * node = numbering.entries[k].node;
            ...
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0x1f1750c1bc916638ull, 8, order ); // the root: fnv1a64( "Catalog" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// CatalogCookMeasure / CatalogCook over a REGION root — a locked builder's AsConst, a
// region CatalogLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t CatalogCookMeasure( const Catalog * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CatalogCookMeasureFrom( ctx, *root, allocator );
}

inline bool CatalogCook( const Catalog * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return CatalogCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t CatalogCookMeasure( const CatalogBuilder & builder )
{
    if ( builder.region != NULL ) { return CatalogCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CatalogCookMeasureFrom( ctx, *(const Catalog *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool CatalogCook( const CatalogBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return CatalogCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CatalogCookFrom( ctx, *(const Catalog *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( Asset ), "Asset must stay relocatable" );
static_assert( __is_standard_layout( Asset ), "Asset must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Catalog ), "Catalog must stay relocatable" );
static_assert( __is_standard_layout( Catalog ), "Catalog must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( Asset ) == 72, "Asset's sizeof moved: the build version was taken over 72, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Asset ) == 8, "Asset's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Asset, name ) == 0, "Asset's field name moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Asset, kind ) == 40, "Asset's field kind moved: the build version was taken over offset 40 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Asset, data ) == 48, "Asset's field data moved: the build version was taken over offset 48 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Asset, caption ) == 56, "Asset's field caption moved: the build version was taken over offset 56 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Asset, next ) == 64, "Asset's field next moved: the build version was taken over offset 64 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Catalog ) == 72, "Catalog's sizeof moved: the build version was taken over 72, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Catalog ) == 8, "Catalog's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Catalog, name ) == 0, "Catalog's field name moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Catalog, head ) == 40, "Catalog's field head moved: the build version was taken over offset 40 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Catalog, thumb ) == 48, "Catalog's field thumb moved: the build version was taken over offset 48 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Catalog, note ) == 56, "Catalog's field note moved: the build version was taken over offset 56 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Catalog, alias ) == 64, "Catalog's field alias moved: the build version was taken over offset 64 (docs/SPEC-TABLES.md §20.3)" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * AssetTableType();
inline const TableTypeInfo * CatalogTableType();
...
extern const TableTypeInfo AssetTableInfo;
...
// Asset in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in AssetsTable.cpp; link it to use them.
bool AssetFromJson( AssetBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t AssetToJsonMeasure( const Asset * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t AssetToJson( const Asset * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );

// Catalog in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in AssetsTable.cpp; link it to use them.
bool CatalogFromJson( CatalogBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t CatalogToJsonMeasure( const Catalog * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t CatalogToJson( const Catalog * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
