...
bool LeafFromJson( LeafBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    return TableJsonReadGraph( builder.main, root, LeafTableType(), text, bytes, report );
}

int64_t LeafToJsonMeasure( const Leaf * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, LeafTableType(), NULL, 0, allocator );
}

int64_t LeafToJson( const Leaf * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, LeafTableType(), buffer, capacity, allocator );
}
...
bool HolderFromJson( HolderBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, HolderTableType(), text, bytes, report );
}

int64_t HolderToJsonMeasure( const Holder * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, HolderTableType(), NULL, 0, allocator );
}

int64_t HolderToJson( const Holder * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, HolderTableType(), buffer, capacity, allocator );
}
...
bool HandFromJson( HandBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, HandTableType(), text, bytes, report );
}

int64_t HandToJsonMeasure( const Hand * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, HandTableType(), NULL, 0, allocator );
}

int64_t HandToJson( const Hand * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
