...
// InnerType: union Inner's tag — None = 0, then each variant in declared order (SPEC §4.8)
...
// arm's storage is established when the arm is selected — by InnerLoadBody
...
struct Inner
{
    ...
    Inner() : type( InnerType::None ) {} // the tag only — arms are established at selection
};

// table Twig — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Twig {
    Inner inner;
};

// OuterType: union Outer's tag — None = 0, then each variant in declared order (SPEC §4.8)
enum class OuterType : uint8_t {
    None = 0,
    Inner = 1,
    Plain = 2,
    Count = 2, // the declared variant count (SPEC §4.2)
...
// `value_length` or `value_count`. Such a union has no packet wire and lives
// here, after its arms. Construction is None: the tag alone is initialized; an
// arm's storage is established when the arm is selected — by OuterLoadBody
// before it decodes, or by assigning it: value.inner = a Inner.
// Bytes of unselected arms are indeterminate.
struct Outer
{
    OuterType type;
    ...
    Outer() : type( OuterType::None ) {} // the tag only — arms are established at selection
};

// table Nest — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Nest {
    Outer outer;
...
inline void TwigReset( Twig & value );
inline void NestReset( Nest & value );

inline void TwigReset( Twig & value )
{
    LeafReset( value.inner.leaf );
    value.inner.plain = 0;
    value.inner.type = InnerType::None;
}

inline void NestReset( Nest & value )
{
    LeafReset( value.outer.inner.leaf );
    value.outer.inner.plain = 0;
    value.outer.inner.type = InnerType::None;
    value.outer.plain = 0;
    value.outer.type = OuterType::None;
    value.tail.elements.value = 0; // int32: empty
    value.tail.count = 0;
    value.tail.padding = 0;
}

template <typename Ctx> inline int64_t TwigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Twig & value );
template <typename Ctx> inline bool TwigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Twig & value );
inline bool TwigLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Twig & value );
inline bool TwigMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
template <typename Ctx> inline int64_t NestMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Nest & value );
template <typename Ctx> inline bool NestSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Nest & value );
inline bool NestLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Nest & value );
inline bool NestMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
...
inline void TableReset( Twig & value ) { TwigReset( value ); }
inline void TableReset( Nest & value ) { NestReset( value ); }
...
template <typename Ctx> inline int64_t TwigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Twig & value );
template <typename Ctx> inline bool TwigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Twig & value );
template <typename Ctx> inline bool TwigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Twig & value );
inline bool TwigLoadBody( TableReader & r, const TableNodeMap & nodes, Twig & value );
template <typename Ctx> inline int64_t NestMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Nest & value );
template <typename Ctx> inline bool NestSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Nest & value );
template <typename Ctx> inline bool NestSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Nest & value );
...
template <typename Ctx> inline bool TwigNumber( const Ctx & ctx, TableNumbering & numbering, const Twig & value );
template <typename Ctx> inline int64_t TwigPackMeasure( const Ctx & ctx, TablePackMap & seen, const Twig & value );
template <typename Ctx> inline bool TwigPack( const Ctx & ctx, TablePackMap & seen, const Twig & src, Twig & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool NestNumber( const Ctx & ctx, TableNumbering & numbering, const Nest & value );
template <typename Ctx> inline int64_t NestPackMeasure( const Ctx & ctx, TablePackMap & seen, const Nest & value );
template <typename Ctx> inline bool NestPack( const Ctx & ctx, TablePackMap & seen, const Nest & src, Nest & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Twig & value ) { return TwigMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Twig & value ) { return TwigSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Twig & value ) { return TwigMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Twig & value ) { return TwigSaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Nest & value ) { return NestMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Nest & value ) { return NestSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Nest & value ) { return NestMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Nest & value ) { return NestSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
template <typename Ctx> inline int64_t TwigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TwigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TwigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool TwigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Twig & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t NestMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool NestSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool NestSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool NestLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Nest & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t TwigMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Twig & value )
{
...
template <typename Ctx>
inline bool TwigSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Twig & value )
{
    if ( value.inner.type != InnerType::None )
    {
        w.header( ids.ref_at( 4, 0x2d4c068f5f889287ull ), 15 ); // inner
        switch ( value.inner.type )
        {
            case InnerType::Leaf:
            {
                ...
                if ( !LeafSaveBody( ctx, numbering, w, ids, value.inner.leaf ) ) { return false; }
                break;
            }
            case InnerType::Plain:
            {
                ...
                w.put32( uint32_t( value.inner.plain ) );
                break;
            }
...
template <typename Ctx>
inline bool TwigSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Twig & value )
{
    if ( !TwigSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
                        ...
                        case 0xfd4d194e1652b207ull: // plain
                        {
                            if ( arm_kind != 4 )
                            {
                                if ( TableKindWidens( arm_kind, 4 ) )
                                {
                                    ...
                                    if ( sub.size != TableKindWidth( arm_kind ) ) { value.inner.type = InnerType::None; r.report->malformed = true; break; }
                                    memset( (void *) &value.inner.plain, 0, sizeof( value.inner.plain ) ); // selection establishes the arm (§2.6)
                                    int64_t widened_v = 0;
                                    if ( !TableReadSignedAt( sub, arm_kind, widened_v ) ) { value.inner.type = InnerType::None; r.report->malformed = true; break; }
                                    int32_t decoded_v = (int32_t) widened_v;
                                    value.inner.plain = decoded_v;
                            ...
                            value.inner.type = InnerType::Plain;
                            if ( sub.size != 4 ) { value.inner.type = InnerType::None; r.report->malformed = true; break; } // an L that is not the kind's width is that arm's own framing damage (§3)
                            if ( !sub.has( 4 ) ) { value.inner.type = InnerType::None; r.report->malformed = true; break; }
...
template <typename Ctx>
inline int64_t TwigMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Twig & value )
{
    ...
    if ( value.inner.type != InnerType::None )
    {
        ...
        switch ( value.inner.type )
        {
            case InnerType::Leaf:
            {
                bits += kTableMessageRefBitsHere;
                {
                    const int64_t arm_bits = LeafMeasureMessageBody( ctx, numbering, index_bits, at + bits, value.inner.leaf );
...
template <typename Ctx>
inline bool TwigSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Twig & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.inner.type != InnerType::None )
    {
        ...
        switch ( value.inner.type )
        {
            case InnerType::Leaf:
            {
                ...
                if ( !LeafSaveMessageBody( ctx, numbering, index_bits, w, value.inner.leaf ) ) { return false; }
                break;
            }
            case InnerType::Plain:
            {
                w.put( 14, kTableMessageRefBitsHere );
                w.put( (uint64_t) ( value.inner.plain ), 32 );
                break;
            }
...
// TwigMessageExtent: the extent Twig's maps command on the message wire, from
...
inline bool TwigMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x2d4c068f5f889287ull && entry.kind == 15 ) // inner: a union arm that holds a map
        {
            uint64_t arm_ref = 0;
        ...
        switch ( entry.id )
        {
            case 0x2d4c068f5f889287ull: // inner
            {
                ...
                }
                {
                    ...
                    TableMessageEntry arm;
                    if ( arm_ref == 0 ) { value.inner.type = InnerType::None; }
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                            case 0x24ad84ada20208d5ull: // leaf
                            {
                                ...
                                value.inner.type = InnerType::Leaf;
                                if ( !LeafLoadMessageBody( r, vocabulary, report, nodes, index_bits, value.inner.leaf ) ) { return false; }
                                break;
                            }
                            case 0xfd4d194e1652b207ull: // plain
                            {
                            ...
                            default:
                                value.inner.type = InnerType::None; report->unknown++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
template <typename Ctx>
inline int64_t NestMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Nest & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
...
template <typename Ctx>
inline bool NestSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Nest & value )
{
    if ( value.outer.type != OuterType::None )
    {
        w.header( ids.ref_at( 6, 0x30e6ed678f5e1bd4ull ), 15 ); // outer
        switch ( value.outer.type )
        {
            case OuterType::Inner:
            {
                ...
                w.header( arm_ref, 15 ); w.putleb( (uint64_t) arm_payload ); // inner
                if ( value.outer.inner.type == InnerType::None ) { w.putleb( 0 ); } // the inner union's None (§3)
                else
                {
                    switch ( value.outer.inner.type )
                    {
                        case InnerType::Leaf:
                        {
                            ...
                            w.header( arm_refa, 13 ); w.putleb( (uint64_t) arm_payloada ); // leaf
                            if ( !LeafSaveBody( ctx, numbering, w, ids, value.outer.inner.leaf ) ) { return false; }
                            break;
                        }
                        case InnerType::Plain:
                        {
                            ...
                            int64_t arm_payloada = 0;
                            arm_payloada += 4; // int32
                            w.header( arm_refa, 4 ); w.putleb( (uint64_t) arm_payloada ); // plain
                            w.put32( uint32_t( value.outer.inner.plain ) );
                            break;
                        }
                        default: return false; // write validates the tag before it rides
                    }
            ...
            case OuterType::Plain:
            {
                ...
                arm_payload += 4; // int32
                w.header( arm_ref, 4 ); w.putleb( (uint64_t) arm_payload ); // plain
                w.put32( uint32_t( value.outer.plain ) );
                break;
            }
            default: return false; // write validates the tag before it rides
        }
...
template <typename Ctx>
inline bool NestSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Nest & value )
{
    if ( !NestSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                ...
                if ( !r.getleb( body_len ) || !r.room( body_len ) ) { r.report->malformed = true; return false; }
                {
                    ...
                    switch ( arm_id ) // the arm's NAME hash (docs/SPEC-TABLES.md §5)
                    {
                        case 0x2d4c068f5f889287ull: // inner
                        {
                            ...
                            value.outer.type = OuterType::Inner;
                            {
                                uint64_t arm_inner_ref = 0;
                                if ( !sub.getleb( arm_inner_ref ) ) { value.outer.type = OuterType::None; r.report->malformed = true; break; }
                                value.outer.inner.type = InnerType::None;
                                if ( arm_inner_ref != 0 ) // the zero reference is the inner union's None
                                {
                                    ...
                                    switch ( arm_inner_id ) // the arm's NAME hash (§5)
                                    {
                                        case 0x24ad84ada20208d5ull: // leaf
                                        {
                                            ...
                                            {
                                                value.outer.inner.type = InnerType::None; r.report->kind_mismatch++; break;
                                            }
                                        ...
                                        case 0xfd4d194e1652b207ull: // plain
                                        {
                                            if ( arm_inner_kind != 4 )
                                            {
                                                if ( TableKindWidens( arm_inner_kind, 4 ) )
                                                {
                                                    // WIDENED AT AN ARM (§4): the payload decodes at its own width; an L
                                                    // that is not that width is the arm's own framing damage (§3)
                                                    if ( arm_inner.size != TableKindWidth( arm_inner_kind ) ) { value.outer.inner.type = InnerType::None; r.report->malformed = true; break; }
                                                    memset( (void *) &value.outer.inner.plain, 0, sizeof( value.outer.inner.plain ) ); // selection establishes the arm (§2.6)
                                                    int64_t widened_v = 0;
                                                    if ( !TableReadSignedAt( arm_inner, arm_inner_kind, widened_v ) ) { value.outer.inner.type = InnerType::None; r.report->malformed = true; break; }
                                                    int32_t decoded_v = (int32_t) widened_v;
                                                    value.outer.inner.plain = decoded_v;
                                            ...
                                            value.outer.inner.type = InnerType::Plain;
                                            if ( arm_inner.size != 4 ) { value.outer.inner.type = InnerType::None; r.report->malformed = true; break; } // an L that is not the kind's width is that arm's own framing damage (§3)
                                            if ( !arm_inner.has( 4 ) ) { value.outer.inner.type = InnerType::None; r.report->malformed = true; break; }
                                            int32_t decoded_v = int32_t( arm_inner.get32( ) );
                                            value.outer.inner.plain = decoded_v;
                                            break;
                                        }
                        ...
                        case 0xfd4d194e1652b207ull: // plain
                        {
                            if ( arm_kind != 4 )
                            {
                                if ( TableKindWidens( arm_kind, 4 ) )
                                {
                                    // WIDENED AT AN ARM (§4): the payload decodes at its own width; an L
                                    // that is not that width is the arm's own framing damage (§3)
                                    if ( sub.size != TableKindWidth( arm_kind ) ) { value.outer.type = OuterType::None; r.report->malformed = true; break; }
                                    memset( (void *) &value.outer.plain, 0, sizeof( value.outer.plain ) ); // selection establishes the arm (§2.6)
                                    int64_t widened_v = 0;
                                    if ( !TableReadSignedAt( sub, arm_kind, widened_v ) ) { value.outer.type = OuterType::None; r.report->malformed = true; break; }
                                    int32_t decoded_v = (int32_t) widened_v;
                                    value.outer.plain = decoded_v;
                            ...
                            value.outer.type = OuterType::Plain;
                            if ( sub.size != 4 ) { value.outer.type = OuterType::None; r.report->malformed = true; break; } // an L that is not the kind's width is that arm's own framing damage (§3)
                            if ( !sub.has( 4 ) ) { value.outer.type = OuterType::None; r.report->malformed = true; break; }
                            int32_t decoded_v = int32_t( sub.get32( ) );
                            value.outer.plain = decoded_v;
                            break;
                        }
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t NestMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Nest & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    if ( value.outer.type != OuterType::None )
    {
        ...
        switch ( value.outer.type )
        {
            ...
            {
                bits += kTableMessageRefBitsHere;
                if ( value.outer.inner.type == InnerType::None )
                {
                    bits += kTableMessageRefBitsHere;
                }
                else
                {
                    switch ( value.outer.inner.type )
                    {
                        case InnerType::Leaf:
                        {
                            bits += kTableMessageRefBitsHere;
                            {
                                const int64_t arm_bits_2 = LeafMeasureMessageBody( ctx, numbering, index_bits, at + bits, value.outer.inner.leaf );
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool NestSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Nest & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.outer.type != OuterType::None )
    {
        ...
        switch ( value.outer.type )
        {
            case OuterType::Inner:
            {
                ...
                else
                {
                    switch ( value.outer.inner.type )
                    {
                        ...
                        {
                            w.put( 13, kTableMessageRefBitsHere );
                            if ( !LeafSaveMessageBody( ctx, numbering, index_bits, w, value.outer.inner.leaf ) ) { return false; }
                            break;
                        }
                        case InnerType::Plain:
                        {
                            w.put( 14, kTableMessageRefBitsHere );
                            w.put( (uint64_t) ( value.outer.inner.plain ), 32 );
                            break;
                        }
                        default: return false; // a tag no arm names has no wire identity
                    }
            ...
            {
                w.put( 14, kTableMessageRefBitsHere );
                w.put( (uint64_t) ( value.outer.plain ), 32 );
                break;
            }
            default: return false; // a tag no arm names has no wire identity
        }
...
// NestMessageExtent: the extent Nest's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool NestMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
        ...
        switch ( entry.id )
        {
            case 0x30e6ed678f5e1bd4ull: // outer
            {
                ...
                }
                {
                    ...
                    if ( !r.get( arm_ref, vocabulary.ref_bits ) ) { report->malformed = true; return false; }
                    TableMessageEntry arm;
                    if ( arm_ref == 0 ) { value.outer.type = OuterType::None; }
                    else if ( !TableMessageArmEntry( vocabulary, arm_ref, arm ) ) { report->malformed = true; return false; }
                    else
                    {
                        switch ( arm.id )
                        {
                            case 0x2d4c068f5f889287ull: // inner
                            {
                                ...
                                value.outer.type = OuterType::Inner;
                                {
                                    ...
                                    if ( arm_ref_2 == 0 ) { value.outer.inner.type = InnerType::None; }
                                    ...
                                    else
                                    {
                                        switch ( arm_2.id )
                                        {
                                            case 0x24ad84ada20208d5ull: // leaf
                                            {
                                                ...
                                                value.outer.inner.type = InnerType::Leaf;
                                                if ( !LeafLoadMessageBody( r, vocabulary, report, nodes, index_bits, value.outer.inner.leaf ) ) { return false; }
                                                break;
                                            }
                                            case 0xfd4d194e1652b207ull: // plain
                                            {
                                            ...
                                            default:
                                                value.outer.inner.type = InnerType::None; report->unknown++;
                                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm_2 ) ) { report->malformed = true; return false; }
                                                break;
                                        }
                                    }
                            ...
                            default:
                                value.outer.type = OuterType::None; report->unknown++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
inline bool InnerWireArmExtent( TableReader & r, int64_t & at, TableRefuseReason & reason );
inline bool InnerWireArmsExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason );
inline bool OuterWireArmExtent( TableReader & r, int64_t & at, TableRefuseReason & reason );
inline bool OuterWireArmsExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason );

// TwigWireExtent: the extent Twig's lists and maps command, from the FRAMING alone.
...
inline bool TwigWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
...
// TwigExtentAt: the node extent Twig's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as TwigExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool TwigExtentAt( const Ctx & ctx, const Twig & value, int64_t & at )
{
    switch ( value.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            if ( !LeafExtentAt( ctx, value.inner.leaf, at ) ) { return false; }
            break;
        }
        default: break;
    }
...
template <typename Ctx>
inline int64_t TwigExtent( const Ctx & ctx, const Twig & value )
{
    int64_t at = 0;
    if ( !TwigExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// TwigExtentPack: carve Twig's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset TwigExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool TwigExtentPack( const Ctx & ctx, const Twig & src, Twig & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    switch ( src.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            if ( !LeafExtentPack( ctx, src.inner.leaf, dst.inner.leaf, extent, at, capacity ) ) { return false; }
            break;
        }
        default: break;
    }
...
// NestWireExtent: the extent Nest's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool NestWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
...
// NestExtentAt: the node extent Nest's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as NestExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool NestExtentAt( const Ctx & ctx, const Nest & value, int64_t & at )
{
    switch ( value.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( value.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    if ( !LeafExtentAt( ctx, value.outer.inner.leaf, at ) ) { return false; }
                    break;
                }
                default: break;
            }
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t NestExtent( const Ctx & ctx, const Nest & value )
{
    int64_t at = 0;
    if ( !NestExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// NestExtentPack: carve Nest's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset NestExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool NestExtentPack( const Ctx & ctx, const Nest & src, Nest & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    switch ( src.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( src.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    if ( !LeafExtentPack( ctx, src.outer.inner.leaf, dst.outer.inner.leaf, extent, at, capacity ) ) { return false; }
                    break;
                }
                default: break;
            }
...
// InnerWireArmExtent: the extent one Inner value's set arm commands, from the FRAMING alone (§2.6, §6.5).
inline bool InnerWireArmExtent( TableReader & r, int64_t & at, TableRefuseReason & reason )
{
    uint64_t arm_ref = 0;
...
// InnerWireArmsExtent: that walk over an ARRAY of Inner values, one arm header per element in its place (§2.6, §3).
inline bool InnerWireArmsExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch;
    TableReader r( body, length, &scratch, ids );
...
// OuterWireArmExtent: the extent one Outer value's set arm commands, from the FRAMING alone (§2.6, §6.5).
inline bool OuterWireArmExtent( TableReader & r, int64_t & at, TableRefuseReason & reason )
{
    uint64_t arm_ref = 0;
    if ( !r.getleb( arm_ref ) ) { r.offset = r.size; return true; }
...
// OuterWireArmsExtent: that walk over an ARRAY of Outer values, one arm header per element in its place (§2.6, §3).
inline bool OuterWireArmsExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch;
    TableReader r( body, length, &scratch, ids );
...
// ---- Nest.tail: the builder's three (§2.9) ----
...
inline int32_t * NestTailAdd( TableWorker & worker, TableList<int32_t> & list )
{
...
inline bool NestTailErase( TableArena & arena, TableList<int32_t> & list, const int32_t * element )
{
...
inline TableListEach<int32_t> NestTailEach( const TableArena & arena, const TableList<int32_t> & list )
{
    return TableListEachOf( arena, list );
}

// TwigNumber: number everything Twig POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool TwigNumber( const Ctx & ctx, TableNumbering & numbering, const Twig & value )
{
    switch ( value.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            if ( !LeafNumber( ctx, numbering, value.inner.leaf ) ) { return false; }
            break;
        }
        default: break;
    }
...
// TwigPackMeasure: the packed region bytes of everything Twig POINTS AT.
...
template <typename Ctx>
inline int64_t TwigPackMeasure( const Ctx & ctx, TablePackMap & seen, const Twig & value )
{
    int64_t bytes = 0;
    switch ( value.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            int64_t inner = LeafPackMeasure( ctx, seen, value.inner.leaf );
            if ( inner < 0 ) { return -1; }
            bytes += inner;
            break;
        }
...
// TwigPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool TwigPackEdges( const Ctx & ctx, TablePackMap & seen, const Twig & src, Twig & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool TwigPack( const Ctx & ctx, TablePackMap & seen, const Twig & src, Twig & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Twig ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Twig ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !TwigExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return TwigPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
inline bool TwigPackEdges( const Ctx & ctx, TablePackMap & seen, const Twig & src, Twig & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    switch ( src.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            if ( !LeafPackEdges( ctx, seen, src.inner.leaf, dst.inner.leaf, base, capacity, used ) ) { return false; }
            break;
        }
        default: break;
    }
...
// NestNumber: number everything Nest POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool NestNumber( const Ctx & ctx, TableNumbering & numbering, const Nest & value )
{
    switch ( value.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( value.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    if ( !LeafNumber( ctx, numbering, value.outer.inner.leaf ) ) { return false; }
                    break;
                }
                default: break;
            }
...
// NestPackMeasure: the packed region bytes of everything Nest POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t NestPackMeasure( const Ctx & ctx, TablePackMap & seen, const Nest & value )
{
    int64_t bytes = 0;
    switch ( value.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( value.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    int64_t inner = LeafPackMeasure( ctx, seen, value.outer.inner.leaf );
                    if ( inner < 0 ) { return -1; }
                    bytes += inner;
                    break;
                }
...
// NestPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool NestPackEdges( const Ctx & ctx, TablePackMap & seen, const Nest & src, Nest & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool NestPack( const Ctx & ctx, TablePackMap & seen, const Nest & src, Nest & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Nest ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Nest ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !NestExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return NestPackEdges( ctx, seen, src, dst, base, capacity, used );
}
    ...
    switch ( src.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( src.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    if ( !LeafPackEdges( ctx, seen, src.outer.inner.leaf, dst.outer.inner.leaf, base, capacity, used ) ) { return false; }
                    break;
                }
                default: break;
            }
...
// ---- Twig: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: TwigBuilder — allocate nodes, wire them together, then Lock.
...
// Twig is never held by value — a file-format-scale structure is a region
...
struct TwigBuilder
{
    ...
    TwigBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Twig * GetRoot() { return arena.locked ? NULL : (Twig *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Twig * AsConst() const { return (const Twig *) region; }
...
inline bool TwigBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Twig & root = *(const Twig *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Twig on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// TwigNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t TwigNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
...
// TwigNodePlace: start one record's node's lifetime in the storage pass one
...
inline void TwigNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) at;
...
// TwigNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t TwigNodeRecordBytes( uint64_t type_id )
{
    (void) type_id;
    return 0;
}

// TwigNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t TwigNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) worker;
...
inline void TwigNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = TwigNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? TwigNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// TwigNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t TwigNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    (void) type_id;
...
// TwigNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool TwigNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// TwigNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool TwigNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + TwigNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !TwigNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool TwigNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Twig & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return TwigNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t TwigMeasureWire( const Ctx & ctx, const Twig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( TwigNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = TwigMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t TwigSaveWire( const Ctx & ctx, const Twig & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !TwigNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = TwigSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == TwigMeasure( root )
}

inline int64_t TwigMeasure( const Twig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TwigMeasureWire( ctx, *root, allocator );
}

inline int64_t TwigSave( const Twig * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TwigSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t TwigMeasure( const TwigBuilder & builder )
{
    if ( builder.region != NULL ) { return TwigMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TwigMeasureWire( ctx, *(const Twig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t TwigSave( const TwigBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return TwigSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TwigSaveWire( ctx, *(const Twig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Twig on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// TwigMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t TwigMessageBodyBits( const Ctx & ctx, const Twig & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( TwigNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = TwigMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool TwigMessageBodySave( const Ctx & ctx, const Twig & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && TwigSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t TwigMeasureMessages( const Twig * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = TwigMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t TwigSaveMessages( const Twig * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !TwigMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == TwigMeasureMessages( roots, count, report, allocator )
}

// TwigMessageRecordScan: one node record's type id and the extent its maps
...
inline bool TwigMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return TwigNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// TwigMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool TwigMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TwigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = TwigNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !TwigMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Twig ) ) + root_extent );
    return true;
}

// TwigLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t TwigLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !TwigMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// TwigLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool TwigLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Twig * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !TwigMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = TwigNodeMessageStorage( type_id, extent, length );
        ...
        TwigNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !TwigMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Twig ) ) + root_extent );
    ...
    Twig * root = new ( region + used ) Twig; // lifetime only: LoadMessageBody's first act is TwigReset
    TwigReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Twig ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TwigNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return TwigLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// TwigLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool TwigLoadMessages( const Twig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !TwigLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// TwigLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t TwigLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !TwigWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Twig ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = TwigNodeStorage( type_id, length, reason );
...
// TwigLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Twig * TwigLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Twig ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !TwigWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Twig ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x9f8e22fb612a2f78ull;
    Twig * root = new ( region ) Twig; // lifetime only: LoadBody's first act is TwigReset
    TwigReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                TwigNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Twig ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    TwigLoadBody( r, nodes, *root );
    return root;
}

// TwigLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool TwigLoadBuilder( TwigBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = TwigNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = TwigLoadBody( r, nodes, *root );
...
// ---- Nest: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: NestBuilder — allocate nodes, wire them together, then Lock.
// CONST:   one packed region, root at its base. Lock produces it and Load
//          produces it, so a locked structure and a loaded one are the
//          SAME representation with one view API. There is no unlock:
//          re-editing means loading the const form into a fresh builder.
// Nest is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.
...
struct NestBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    NestBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    Nest * GetRoot() { return arena.locked ? NULL : (Nest *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Nest * AsConst() const { return (const Nest *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool NestBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Nest & root = *(const Nest *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = NestPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t root_extent = NestExtent( ctx, root );
    if ( root_extent < 0 ) { TablePackMapShutdown( seen ); return false; } // the sort could not run
    int64_t total = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Nest ) ) + root_extent ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) table_allocate( arena.allocator, total );
...
// ---- Nest on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// NestNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
...
// depth, summed from the FRAMING: N is framing and not a value, and this
// reads no field. kTableNodeRefused is a wire whose N its L cannot carry.
inline int64_t NestNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    (void) length; // no byte buffer below this root: every node's storage is its type's
    (void) type_id;
    (void) reason; // no blob and no extent below this root: nothing here refuses
...
// NestNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
inline void NestNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) at;
...
// NestNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t NestNodeRecordBytes( uint64_t type_id )
{
    (void) type_id;
    return 0;
}

// NestNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t NestNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) worker;
...
inline void NestNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    {
        TableRefuseReason reason = count_over_length; // pass one already refused what this could refuse
        const int64_t storage = NestNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? NestNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
        carve.left = storage > record ? storage - record : 0;
    }
    nodes.carve = &carve;
...
// NestNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t NestNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    (void) type_id;
...
// NestNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool NestNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    (void) type_id; // no map below any node this root can name
    return TableMessageSkipBody( r, vocabulary, index_bits );
...
// NestNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool NestNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + NestNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !NestNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    TableExtentCarve * const outer = nodes.carve;
    nodes.carve = &carve;
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool NestNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Nest & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return NestNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t NestMeasureWire( const Ctx & ctx, const Nest & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( NestNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = NestMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t NestSaveWire( const Ctx & ctx, const Nest & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !NestNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    // the root's own fields, then the node table's field, then the
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = NestSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == NestMeasure( root )
}

inline int64_t NestMeasure( const Nest * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return NestMeasureWire( ctx, *root, allocator );
}

inline int64_t NestSave( const Nest * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return NestSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t NestMeasure( const NestBuilder & builder )
{
    if ( builder.region != NULL ) { return NestMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return NestMeasureWire( ctx, *(const Nest *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t NestSave( const NestBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return NestSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return NestSaveWire( ctx, *(const Nest *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Nest on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// NestMessageBodyBits: one root body's bits at bit position `at` of the batch,
// with the numbering derived from the graph, the node table FIRST, then the
// fields, then the zero reference. Measure derives the numbering and save
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t NestMessageBodyBits( const Ctx & ctx, const Nest & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( NestNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = NestMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool NestMessageBodySave( const Ctx & ctx, const Nest & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && NestSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t NestMeasureMessages( const Nest * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = NestMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t NestSaveMessages( const Nest * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !NestMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == NestMeasureMessages( roots, count, report, allocator )
}

// NestMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool NestMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return NestNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// NestMessageBodyStorage: one body's node count and data bytes from the FRAMING
// alone, the reader left at the next body. The node table is walked record
// by record, a table record's body stepped over by its announced shapes and
// a blob's by its length, then the root's own fields. False is a numbering
// that could not be sized; `complete` false is a ROOT body whose own framing
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool NestMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !NestMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = NestNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !NestMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Nest ) ) + root_extent );
    return true;
}

// NestLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t NestLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !NestMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// NestLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool NestLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Nest * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !NestMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = NestNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        NestNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    {
        TableBitReader walk = r;
        if ( !NestMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Nest ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x0fe46fc6a1b583abull;
    Nest * root = new ( region + used ) Nest; // lifetime only: LoadMessageBody's first act is NestReset
    NestReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Nest ) );
    root_carve.left = root_extent;
    used += root_bytes;
    nodes.good = true;
    out->unknown += unknown_records;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !NestNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return NestLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// NestLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool NestLoadMessages( const Nest ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !NestLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// NestLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t NestLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableRefuseReason reason = count_over_length;
    int64_t root_extent = 0;
    if ( !NestWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Nest ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = NestNodeStorage( type_id, length, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// NestLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const Nest * NestLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Nest ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    TableRefuseReason reason = count_over_length; // LoadMeasure is where a caller reads it; a Load past a refusal is malformed
    int64_t root_extent = 0;
    if ( !NestWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Nest ) ) + root_extent );
    int64_t records = 0;
    {
        TableReport counting;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0x0fe46fc6a1b583abull;
    Nest * root = new ( region ) Nest; // lifetime only: LoadBody's first act is NestReset
    NestReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                NestNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    r.nested = false; // the ROOT body, the one that carries the node table
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Nest ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    NestLoadBody( r, nodes, *root );
    return root;
}

// NestLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool NestLoadBuilder( NestBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = NestNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    root_carve.worker = &builder.main;
    nodes.carve = &root_carve;
    bool ok = NestLoadBody( r, nodes, *root );
    // A COUNT ABOVE THE int32 CAP is this path's refusal (docs/SPEC-TABLES.md
    // §2.9): the partial builder is the caller's to discard, and the report
    // holds what it held when the count was met
    ok = ok && !nodes.refused;
...
template <typename Ctx>
inline int64_t TwigMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.inner.type != InnerType::None ) // None elides — the absence of the field is the None
    {
...
template <typename Ctx>
inline bool TwigSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.inner.type != InnerType::None )
    {
        w.header( ids.ref_at( 4, 0x2d4c068f5f889287ull ), 15 ); // inner
        switch ( value.inner.type )
        {
            case InnerType::Leaf:
            {
                ...
                w.header( arm_ref, 13 ); w.putleb( (uint64_t) arm_payload ); // leaf
                if ( !LeafSaveBodyRetain( ctx, numbering, w, ids, value.inner.leaf, retain, TableRetainStepInto( path, 0, (uint32_t) ( 0 ) ) ) ) { return false; }
                break;
            }
            case InnerType::Plain:
            {
...
template <typename Ctx>
inline bool TwigSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Twig & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !TwigSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                            case 0x24ad84ada20208d5ull: // leaf
                            {
                                ...
                                value.inner.type = InnerType::Leaf;
                                if ( !LeafLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, value.inner.leaf, retain, TableRetainStepInto( path, 0, (uint32_t) ( 0 ) ) ) ) { return false; }
                                break;
                            }
                            case 0xfd4d194e1652b207ull: // plain
                            {
                            ...
                            default:
                                value.inner.type = InnerType::None; report->unknown++; report->retain_lost++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
template <typename Ctx>
inline int64_t NestMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.outer.type != OuterType::None ) // None elides — the absence of the field is the None
    {
...
template <typename Ctx>
inline bool NestSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.outer.type != OuterType::None )
    {
        w.header( ids.ref_at( 6, 0x30e6ed678f5e1bd4ull ), 15 ); // outer
                ...
                else
                {
                    switch ( value.outer.inner.type )
                    {
                        case InnerType::Leaf:
                        {
                            ...
                            w.header( arm_refa, 13 ); w.putleb( (uint64_t) arm_payloada ); // leaf
                            if ( !LeafSaveBodyRetain( ctx, numbering, w, ids, value.outer.inner.leaf, retain, TableRetainStepInto( path, 0, (uint32_t) ( 0 ) ) ) ) { return false; }
                            break;
                        }
                        case InnerType::Plain:
                        {
...
template <typename Ctx>
inline bool NestSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Nest & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !NestSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                            ...
                            value.outer.type = OuterType::Inner;
                            {
                                ...
                                if ( arm_inner_ref != 0 ) // the zero reference is the inner union's None
                                {
                                    ...
                                    switch ( arm_inner_id ) // the arm's NAME hash (§5)
                                    {
                                        ...
                                        default: r.report->unknown++; r.report->retain_lost++; break; // an arm this reader cannot name
                                    }
                                    sub.offset += (int64_t) arm_inner_len;
                                }
                            }
                ...
                TableRetainDiscardField( retain, path, 0 );
                {
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                                    ...
                                    else
                                    {
                                        switch ( arm_2.id )
                                        {
                                            case 0x24ad84ada20208d5ull: // leaf
                                            {
                                                ...
                                                value.outer.inner.type = InnerType::Leaf;
                                                if ( !LeafLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, value.outer.inner.leaf, retain, TableRetainStepInto( path, 0, (uint32_t) ( 0 ) ) ) ) { return false; }
                                                break;
                                            }
                                            case 0xfd4d194e1652b207ull: // plain
                                            {
                                            ...
                                            default:
                                                value.outer.inner.type = InnerType::None; report->unknown++; report->retain_lost++;
                                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm_2 ) ) { report->malformed = true; return false; }
                                                break;
                                        }
                                    }
                            ...
                            default:
                                value.outer.type = OuterType::None; report->unknown++; report->retain_lost++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
inline void TwigNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// TwigLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Twig * TwigLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                TwigNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    TwigLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// TwigNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool TwigNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + TwigNodeRecordBytes( type_id );
    carve.left = 0;
...
// TwigLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool TwigLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Twig * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TwigNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return TwigLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// TwigLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool TwigLoadRetainMessages( const Twig ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !TwigLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// TwigMeasureRetain and TwigSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t TwigMeasureWireRetain( const Ctx & ctx, const Twig & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( TwigNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = TwigMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t TwigSaveWireRetain( const Ctx & ctx, const Twig & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = TwigSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t TwigMeasureRetain( const Twig * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TwigMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t TwigSaveRetain( const Twig * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TwigSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// TwigSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void NestNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// NestLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Nest * NestLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                NestNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    NestLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// NestNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is this body's own directory position, which the batch's load fills
// from the framing and nothing afterwards renumbers.
inline bool NestNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + NestNodeRecordBytes( type_id );
    carve.left = 0;
...
// NestLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
// each body carries its own node directory inside that one region and a
// record's first step is an index into it (docs/SPEC-TABLES.md §3.3, §6.6).
inline bool NestLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Nest * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !NestNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return NestLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// NestLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
// SaveRetain from `roots[k]` takes `retains[k]` and is the VARIABLE form's own
// pair unchanged: retention writing FORM 2 refuses by name (§3.3).
inline bool NestLoadRetainMessages( const Nest ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !NestLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// NestMeasureRetain and NestSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t NestMeasureWireRetain( const Ctx & ctx, const Nest & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( NestNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = NestMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t NestSaveWireRetain( const Ctx & ctx, const Nest & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = NestSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t NestMeasureRetain( const Nest * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return NestMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t NestSaveRetain( const Nest * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return NestSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// NestSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the VARIABLE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t NestSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Nest: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the VARIABLE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}

// ---- the cooked form: point at a cook (docs/SPEC-TABLES.md §7) ----

// TwigOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH TwigAt: the slot holds
...
// parameter on a load.
inline const Twig * TwigOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Twig *) TableCookOpen( bytes, length, (uint64_t) sizeof( Twig ), (uint64_t) alignof( Twig ), reason );
}

// NestOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH NestAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Nest * NestOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Nest *) TableCookOpen( bytes, length, (uint64_t) sizeof( Nest ), (uint64_t) alignof( Nest ), reason );
}
...
template <typename Ctx> inline bool TwigCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Twig & value, TableByteOrder order );
template <typename Ctx> inline bool NestCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Nest & value, TableByteOrder order );

template <typename Ctx> inline bool TwigCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Twig & value, TableByteOrder order )
{
    {
        table_cook_put( at + 0, (uint64_t) value.inner.type, 1, order ); // the tag; None is the tag alone
        switch ( value.inner.type )
        {
            case InnerType::Leaf: if ( !LeafCookBody( ctx, region, at + 0 + 8, value.inner.leaf, order ) ) { return false; } break;
            case InnerType::Plain:
            {
                table_cook_put( at + 0 + 8, (uint64_t) value.inner.plain, 4, order );
                break;
            }
...
{
    {
        table_cook_put( at + 0, (uint64_t) value.outer.type, 1, order ); // the tag; None is the tag alone
        switch ( value.outer.type )
        {
            case OuterType::Inner:
            {
                {
                    table_cook_put( at + 0 + 8, (uint64_t) value.outer.inner.type, 1, order ); // the tag; None is the tag alone
                    switch ( value.outer.inner.type )
                    {
                        case InnerType::Leaf: if ( !LeafCookBody( ctx, region, at + 0 + 8 + 8, value.outer.inner.leaf, order ) ) { return false; } break;
                        case InnerType::Plain:
                        {
                table_cook_put( at + 0 + 8 + 8, (uint64_t) value.outer.inner.plain, 4, order );
                            break;
                        }
                        default: break; // every byte outside the set arm stays zero
                    }
            ...
            case OuterType::Plain:
            {
                table_cook_put( at + 0 + 8, (uint64_t) value.outer.plain, 4, order );
                break;
            }
            default: break; // every byte outside the set arm stays zero
        }
    }
    table_cook_put( at + 32, 0, 8, order ); // tail: the array's delta, filled by the extent writer
    table_cook_put( at + 40, 0, 4, order ); // and its count
    return true;
}

template <typename Ctx> inline bool TwigCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Twig & value, TableByteOrder order );
template <typename Ctx> inline bool NestCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Nest & value, TableByteOrder order );

// TwigCookExtent: Twig's arrays into the node's extent, PRE-ORDER, a map's entries
...
template <typename Ctx> inline bool TwigCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Twig & value, TableByteOrder order )
{
    ...
    switch ( value.inner.type ) // inner: the set arm is the edge
    {
        case InnerType::Leaf:
        {
            if ( !LeafCookExtent( ctx, region, extent, at, record + 8, value.inner.leaf, order ) ) { return false; }
            break;
        }
        default: break;
    }
...
// NestCookExtent: Nest's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool NestCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Nest & value, TableByteOrder order )
{
    ...
    switch ( value.outer.type ) // outer: the set arm is the edge
    {
        case OuterType::Inner:
        {
            switch ( value.outer.inner.type ) // outer: the set arm is the edge
            {
                case InnerType::Leaf:
                {
                    if ( !LeafCookExtent( ctx, region, extent, at, record + 16, value.outer.inner.leaf, order ) ) { return false; }
                    break;
                }
                default: break;
            }
...
// TwigCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool TwigCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Twig & value, TableByteOrder order )
{
    if ( !TwigCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !TwigCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == TwigExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// NestCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool NestCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Nest & value, TableByteOrder order )
{
    if ( !NestCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !NestCookExtent( ctx, region, at + 48, extent_at, at, value, order ) ) { return false; }
    return extent_at == NestExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// TwigCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool TwigCookLayout( const Ctx & ctx, const Twig & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = TwigExtent( ctx, root );
...
// TwigCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t TwigCookMeasureFrom( const Ctx & ctx, const Twig & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( TwigNumberFrom( ctx, numbering, root ) && TwigCookLayout( ctx, root, numbering, region ) )
    {
...
// TwigCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool TwigCookFrom( const Ctx & ctx, const Twig & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = TwigCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x9f8e22fb612a2f78ull, 8, order ); // the root: fnv1a64( "Twig" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// TwigCookMeasure / TwigCook over a REGION root — a locked builder's AsConst, a
// region TwigLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t TwigCookMeasure( const Twig * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TwigCookMeasureFrom( ctx, *root, allocator );
}

inline bool TwigCook( const Twig * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return TwigCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t TwigCookMeasure( const TwigBuilder & builder )
{
    if ( builder.region != NULL ) { return TwigCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TwigCookMeasureFrom( ctx, *(const Twig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool TwigCook( const TwigBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return TwigCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TwigCookFrom( ctx, *(const Twig *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}

// NestCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
...
// the numbering walked and reads the same arrays that walk read.
template <typename Ctx>
inline bool NestCookLayout( const Ctx & ctx, const Nest & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = NestExtent( ctx, root );
    if ( root_extent < 0 ) { return false; }
...
// NestCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t NestCookMeasureFrom( const Ctx & ctx, const Nest & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( NestNumberFrom( ctx, numbering, root ) && NestCookLayout( ctx, root, numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// NestCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool NestCookFrom( const Ctx & ctx, const Nest & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = NestCookNode( ctx, region, region.base, root, order );
            // the ATTRIBUTION part: the node directory (§6.3), one entry per node
            // in index order, for `schema cook-check`
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0x0fe46fc6a1b583abull, 8, order ); // the root: fnv1a64( "Nest" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// NestCookMeasure / NestCook over a REGION root — a locked builder's AsConst, a
// region NestLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t NestCookMeasure( const Nest * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return NestCookMeasureFrom( ctx, *root, allocator );
}

inline bool NestCook( const Nest * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return NestCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t NestCookMeasure( const NestBuilder & builder )
{
    if ( builder.region != NULL ) { return NestCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return NestCookMeasureFrom( ctx, *(const Nest *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool NestCook( const NestBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return NestCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return NestCookFrom( ctx, *(const Nest *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( Twig ), "Twig must stay relocatable" );
static_assert( __is_standard_layout( Twig ), "Twig must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Nest ), "Nest must stay relocatable" );
static_assert( __is_standard_layout( Nest ), "Nest must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( Twig ) == 24, "Twig's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Twig ) == 8, "Twig's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Twig, inner ) == 0, "Twig's field inner moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Nest ) == 48, "Nest's sizeof moved: the build version was taken over 48, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Nest ) == 8, "Nest's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Nest, outer ) == 0, "Nest's field outer moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Nest, tail ) == 32, "Nest's field tail moved: the build version was taken over offset 32 (docs/SPEC-TABLES.md §20.3)" );

static_assert( alignof( int32_t ) <= kTableAlign, "Nest.tail: an unbounded array's element alignment must fit the arena's" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * TwigTableType();
inline const TableTypeInfo * NestTableType();
...
extern const TableTypeInfo TwigTableInfo;
...
// Twig in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in NestTable.cpp; link it to use them.
bool TwigFromJson( TwigBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t TwigToJsonMeasure( const Twig * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t TwigToJson( const Twig * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );

// Nest in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in NestTable.cpp; link it to use them.
bool NestFromJson( NestBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t NestToJsonMeasure( const Nest * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t NestToJson( const Nest * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
