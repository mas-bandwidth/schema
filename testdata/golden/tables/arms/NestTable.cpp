// Code generated by the schema compiler from Nest.schema. DO NOT EDIT.
// SPDX-License-Identifier: NONE — this generated output is yours, under terms of
// your choice. See the LICENSE exception in the schema compiler; the compiler is
// AGPL-3.0, its output is not.
// package armdemo — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several armdemo Table.cpp files may be
...
#ifndef ARMDEMO_SCHEMA_TABLE_JSON
#define ARMDEMO_SCHEMA_TABLE_JSON
...
#endif // ARMDEMO_SCHEMA_TABLE_JSON

namespace armdemo {

bool TwigFromJson( TwigBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    Twig * root = builder.GetRoot();
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, TwigTableType(), text, bytes, report );
}

int64_t TwigToJsonMeasure( const Twig * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, TwigTableType(), NULL, 0, allocator );
}

int64_t TwigToJson( const Twig * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, TwigTableType(), buffer, capacity, allocator );
}

bool NestFromJson( NestBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    Nest * root = builder.GetRoot();
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, NestTableType(), text, bytes, report );
}

int64_t NestToJsonMeasure( const Nest * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, NestTableType(), NULL, 0, allocator );
}

int64_t NestToJson( const Nest * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, NestTableType(), buffer, capacity, allocator );
}
