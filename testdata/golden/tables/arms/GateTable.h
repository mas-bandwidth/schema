// Code generated by the schema compiler from Gate.schema. DO NOT EDIT.
...
// table Only — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Only {
    int32_t w = 0;
};

// ReachType: union Reach's tag — None = 0, then each variant in declared order (SPEC §4.8)
enum class ReachType : uint8_t {
    None = 0,
    Only = 1,
    Text = 2,
    Plain = 3,
...
// arm's storage is established when the arm is selected — by ReachLoadBody
// before it decodes, or by assigning it: value.only = a *Only.
...
struct Reach
{
    ...
    union
    {
        TableRef only; // *Only — a node index on the wire (§3.1)
        TableRef text; // *string — a byte buffer at its used size (§2.5)
        int32_t plain;
    };

    Reach() : type( ReachType::None ) {} // the tag only — arms are established at selection
};

// table Gate — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Gate {
    Reach reach;
    int32_t after = 0;
...
inline void OnlyReset( Only & value );
inline void GateReset( Gate & value );
...
inline void GateReset( Gate & value )
{
    value.reach.only.value = 0; // *Only — null
    value.reach.text.value = 0; // *string — null
    value.reach.plain = 0;
    value.reach.type = ReachType::None;
    value.after = 0;
}

inline int64_t OnlyMeasureMessageBody( int64_t at, const Only & value );
inline bool OnlySaveMessageBody( TableBitWriter & w, const Only & value );
inline bool OnlyLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Only & value );
template <typename Ctx> inline int64_t GateMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Gate & value );
template <typename Ctx> inline bool GateSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Gate & value );
inline bool GateLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Gate & value );
...
inline void TableReset( Only & value ) { OnlyReset( value ); }
inline void TableReset( Gate & value ) { GateReset( value ); }
...
// Only is a pointer target.
inline const Only * OnlyAt( const TableRef & ref ) // the const form's hot path: one add, no base
{
    return ref.value != 0 ? (const Only *) ( (const uint8_t *) &ref + ref.value ) : NULL;
}
inline Only * OnlyAt( TableRef & ref )
{
    return ref.value != 0 ? (Only *) ( (uint8_t *) &ref + ref.value ) : NULL;
}
inline const Only * OnlyAt( const TableRegionCtx &, const TableRef & ref ) { return OnlyAt( ref ); }
inline const Only * OnlyAt( const TableArenaCtx & ctx, const TableRef & ref )
{
    return ref.value != 0 ? (const Only *) TableArenaAt( *ctx.arena, (uint32_t) ref.value ) : NULL;
}
// while the builder is mutable, resolve against the arena itself
inline Only * OnlyAt( TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (Only *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
inline const Only * OnlyAt( const TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (const Only *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
// allocate one Only in the arena; the slot holds the arena offset
inline Only * OnlyEmplace( TableWorker & worker, TableRef & slot )
{
    TableSlot<Only> allocated = worker.Alloc<Only>();
    slot = allocated.ref;
...
ARMDEMO_TABLE_INLINE bool OnlyLoadBody( TableReader & r, Only & value );
template <typename Ctx> inline int64_t GateMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Gate & value );
template <typename Ctx> inline bool GateSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Gate & value );
template <typename Ctx> inline bool GateSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Gate & value );
...
template <typename Ctx> inline bool OnlyNumber( const Ctx & ctx, TableNumbering & numbering, const Only & value );
template <typename Ctx> inline int64_t OnlyPackMeasure( const Ctx & ctx, TablePackMap & seen, const Only & value );
template <typename Ctx> inline bool OnlyPack( const Ctx & ctx, TablePackMap & seen, const Only & src, Only & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool GateNumber( const Ctx & ctx, TableNumbering & numbering, const Gate & value );
template <typename Ctx> inline int64_t GatePackMeasure( const Ctx & ctx, TablePackMap & seen, const Gate & value );
template <typename Ctx> inline bool GatePack( const Ctx & ctx, TablePackMap & seen, const Gate & src, Gate & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx &, const TableNumbering &, TableIds & ids, const Only & value ) { return OnlyMeasureBody( ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx &, const TableNumbering &, TableWriter & w, TableIds & ids, const Only & value ) { return OnlySaveBody( w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx &, const TableNumbering &, int64_t, int64_t at, const Only & value ) { return OnlyMeasureMessageBody( at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx &, const TableNumbering &, int64_t, TableBitWriter & w, const Only & value ) { return OnlySaveMessageBody( w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Gate & value ) { return GateMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Gate & value ) { return GateSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Gate & value ) { return GateMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Gate & value ) { return GateSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
ARMDEMO_TABLE_INLINE bool OnlyLoadBodyRetain( TableReader & r, Only & value, TableRetain * retain, const TableRetainPath & path );
inline bool OnlyLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Only & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t GateMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool GateSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool GateSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool GateLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Gate & value, TableRetain * retain, const TableRetainPath & path );
...
inline int64_t OnlyMeasure( const Only & value )
{
    TableIds ids;
    const int64_t body = OnlyMeasureBody( ids, value );
...
inline int64_t OnlySave( const Only & value, uint8_t * buffer, int64_t capacity )
{
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    if ( !OnlySaveBody( w, ids, value ) || ids.overflow ) { return -1; }
    TableIdsWrite( w, ids ); // the ID TABLE is the last thing in the file
    if ( w.overflow ) { return -1; }
    return w.offset; // == OnlyMeasure( value )
}

ARMDEMO_TABLE_INLINE bool OnlyLoadBody( TableReader & r, Only & value )
{
    OnlyReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
...
inline TableOpenVerdict OnlyLoadVerdict( Only & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    TableIdTable table;
    ...
    if ( !OnlyLoadBody( r, value ) ) { return TableOpenBodyStopped; }
    return TableOpenOk;
}
...
inline bool OnlyLoad( Only & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    return OnlyLoadVerdict( value, buffer, bytes, report ) == TableOpenOk;
}
...
inline int64_t OnlyMeasureMessages( const Only * values, int64_t count, TableReport * report )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = OnlyMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
...
inline int64_t OnlySaveMessages( const Only * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !OnlySaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == OnlyMeasureMessages( values, count, report )
}
...
inline bool OnlyLoadMessages( Only * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    ...
    *count = 0;
    ...
    {
        if ( !OnlyLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
...
template <typename Ctx>
inline int64_t GateMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Gate & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
        ...
        switch ( value.reach.type )
        {
            ...
            case ReachType::Text:
            {
                ...
                const uint64_t arm_ref = ids.ref_at( 29, 0xfa04f4ef1995407eull );
                {
                    ...
                    uint64_t arm_index = 0;
                    if ( arm_blob != NULL && !TableNumberingIndex( numbering, (const void *) arm_blob, arm_index ) ) { return -1; }
                    arm_payload += TableLebBytes( arm_index ); // a node index, null as 0 (§3.1)
                }
                bytes += TableLebBytes( arm_ref ) + 1 + TableLebBytes( (uint64_t) ( arm_payload ) ) + ( arm_payload );
                break;
...
template <typename Ctx>
inline bool GateSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Gate & value )
{
    if ( value.reach.type != ReachType::None )
    {
        w.header( ids.ref_at( 16, 0x891da1f305deb858ull ), 15 ); // reach
        switch ( value.reach.type )
        {
            case ReachType::Only:
            {
                ...
                w.header( arm_ref, 17 ); w.putleb( (uint64_t) arm_payload ); // only
                {
                    const Only * arm_pointee = OnlyAt( ctx, value.reach.only );
                    uint64_t arm_index = 0;
                    if ( arm_pointee != NULL && !TableNumberingIndex( numbering, (const void *) arm_pointee, arm_index ) ) { return false; }
            ...
            case ReachType::Text:
            {
                ...
                int64_t arm_payload = 0;
                {
                    const TableBlob * arm_blob = TableBlobAt( ctx, value.reach.text );
                    uint64_t arm_index = 0;
                    if ( arm_blob != NULL && !TableNumberingIndex( numbering, (const void *) arm_blob, arm_index ) ) { return false; }
                    arm_payload += TableLebBytes( arm_index ); // a node index, null as 0 (§3.1)
                }
                w.header( arm_ref, 17 ); w.putleb( (uint64_t) arm_payload ); // text
                {
                    const TableBlob * arm_blob = TableBlobAt( ctx, value.reach.text );
                    uint64_t arm_index = 0;
                    if ( arm_blob != NULL && !TableNumberingIndex( numbering, (const void *) arm_blob, arm_index ) ) { return false; }
            ...
            case ReachType::Plain:
            {
                ...
                w.put32( uint32_t( value.reach.plain ) );
                break;
            }
...
template <typename Ctx>
inline bool GateSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Gate & value )
{
    if ( !GateSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                ...
                if ( !r.getleb( body_len ) || !r.room( body_len ) ) { r.report->malformed = true; return false; }
                {
                    ...
                    switch ( arm_id ) // the arm's NAME hash (docs/SPEC-TABLES.md §5)
                    {
                        case 0x072ddab46af04ab7ull: // only
                        {
                            ...
                            value.reach.type = ReachType::Only;
                            {
                                uint64_t node_index = 0;
                                if ( !sub.getleb( node_index ) ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                if ( sub.offset != sub.size ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                TableNodeResolve( nodes, value.reach.only, node_index, 0x31badbc06c5f0b97ull, r.report ); // *Only
                            }
                            break;
                        }
                        case 0xfa04f4ef1995407eull: // text
                        {
                            ...
                            value.reach.type = ReachType::Text;
                            {
                                uint64_t node_index = 0;
                                if ( !sub.getleb( node_index ) ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                if ( sub.offset != sub.size ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                TableNodeResolve( nodes, value.reach.text, node_index, kTableStringTypeId, r.report ); // *string
                            }
                            break;
                        }
                        case 0xfd4d194e1652b207ull: // plain
                        {
                            if ( arm_kind != 4 )
                            {
                                if ( TableKindWidens( arm_kind, 4 ) )
                                {
                                    ...
                                    if ( sub.size != TableKindWidth( arm_kind ) ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                    memset( (void *) &value.reach.plain, 0, sizeof( value.reach.plain ) ); // selection establishes the arm (§2.6)
                                    int64_t widened_v = 0;
                                    if ( !TableReadSignedAt( sub, arm_kind, widened_v ) ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
                                    int32_t decoded_v = (int32_t) widened_v;
                                    value.reach.plain = decoded_v;
                                    value.reach.type = ReachType::Plain;
                                    r.report->widened++;
                                    break;
                                }
                                // A RETYPED ARM IS JUDGED BY THE FIELD RULES (§3): the
                            ...
                            value.reach.type = ReachType::Plain;
                            if ( sub.size != 4 ) { value.reach.type = ReachType::None; r.report->malformed = true; break; } // an L that is not the kind's width is that arm's own framing damage (§3)
                            if ( !sub.has( 4 ) ) { value.reach.type = ReachType::None; r.report->malformed = true; break; }
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t GateMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Gate & value )
{
    ...
    if ( value.reach.type != ReachType::None )
    {
        ...
        switch ( value.reach.type )
        {
            case ReachType::Only:
            {
                bits += kTableMessageRefBitsHere;
                {
                    const Only * pointee_only = OnlyAt( ctx, value.reach.only ); // *Only
                    uint64_t index_only = 0;
                    if ( pointee_only != NULL && !TableNumberingIndex( numbering, (const void *) pointee_only, index_only ) ) { return -1; }
                    bits += index_bits;
                }
                break;
            }
            case ReachType::Text:
            {
                bits += kTableMessageRefBitsHere;
                {
                    const TableBlob * pointee_text = TableBlobAt( ctx, value.reach.text ); // *string: a byte buffer
                    uint64_t index_text = 0;
                    if ( pointee_text != NULL && !TableNumberingIndex( numbering, (const void *) pointee_text, index_text ) ) { return -1; }
                    bits += index_bits;
                }
                break;
            }
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool GateSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Gate & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.reach.type != ReachType::None )
    {
        ...
        switch ( value.reach.type )
        {
            case ReachType::Only:
            {
                w.put( 15, kTableMessageRefBitsHere );
                {
                    const Only * pointee_only = OnlyAt( ctx, value.reach.only ); // *Only
                    uint64_t index_only = 0;
                    if ( pointee_only != NULL && !TableNumberingIndex( numbering, (const void *) pointee_only, index_only ) ) { return false; }
                    w.put( index_only, index_bits );
                }
                break;
            }
            case ReachType::Text:
            {
                w.put( 16, kTableMessageRefBitsHere );
                {
                    const TableBlob * pointee_text = TableBlobAt( ctx, value.reach.text ); // *string: a byte buffer
                    uint64_t index_text = 0;
                    if ( pointee_text != NULL && !TableNumberingIndex( numbering, (const void *) pointee_text, index_text ) ) { return false; }
                    w.put( index_text, index_bits );
                }
                break;
            }
            case ReachType::Plain:
            {
                ...
                w.put( (uint64_t) ( value.reach.plain ), 32 );
                break;
            }
        ...
        switch ( entry.id )
        {
            case 0x891da1f305deb858ull: // reach
            {
                ...
                }
                {
                    ...
                    TableMessageEntry arm;
                    if ( arm_ref == 0 ) { value.reach.type = ReachType::None; }
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                            case 0x072ddab46af04ab7ull: // only
                            {
                                ...
                                {
                                    value.reach.type = ReachType::None; report->kind_mismatch++;
                                ...
                                value.reach.type = ReachType::Only;
                                {
                                    ...
                                    TableNodeResolve( nodes, value.reach.only, node_index_2, 0x31badbc06c5f0b97ull, report ); // *Only
                                }
                                break;
                            }
                            case 0xfa04f4ef1995407eull: // text
                            {
                                ...
                                value.reach.type = ReachType::Text;
                                {
                                    uint64_t node_index_2 = 0;
                                    if ( !r.get( node_index_2, index_bits ) ) { report->malformed = true; return false; }
                                    TableNodeResolve( nodes, value.reach.text, node_index_2, kTableStringTypeId, report ); // *string
                                }
                                break;
                            }
                            case 0xfd4d194e1652b207ull: // plain
                            ...
                            default:
                                value.reach.type = ReachType::None; report->unknown++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
static_assert( sizeof( Only ) == 4, "Only: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( Only, w ) == 0, "Only.w: the fixed form's plan lands here" );

// Only's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void OnlyFixedWriteBody( uint8_t * b, const Only & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.w );
}
...
constexpr int64_t OnlyFixedBodyBytes = 4;
constexpr int64_t OnlyFixedRecordBytes = 8 + OnlyFixedBodyBytes; // the hash and the body
constexpr uint64_t OnlyFixedHash = 0x2078b2b4cf504f6eull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t OnlyFixedLayout[] = {
    0x02, 0x00, 0x00, 0x00, 0x97, 0x0b, 0x5f, 0x6c, 0xc0, 0xdb, 0xba, 0x31, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x56, 0x04, 0x02, 0x86, 0x4c, 0xea, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t OnlyFixedLayoutBytes = (int64_t) sizeof( OnlyFixedLayout );
...
constexpr TableFixedDst OnlyFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // Only
    { (uint32_t) __builtin_offsetof( Only, w ), 0, 0, 0, 0 }, // w
};
...
// test a guard at all.
constexpr TableFixedEntry OnlyFixedPlan[] = {
    { 0u, 0u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1, kTableFixedNoGuard, 0, 1 }, // w
};
constexpr int32_t OnlyFixedPlanCount = 1;
constexpr int32_t OnlyFixedPlanGuarded = 1;
...
constexpr TableFixedFill OnlyFixedCover[] = {
    { 0u, 4u },
};
constexpr int32_t OnlyFixedCoverCount = 1;
...
constexpr uint64_t OnlyFixedLineage[] = {
    0x2078b2b4cf504f6eull, // identity
};
constexpr int32_t OnlyFixedLineageCount = 1;
constexpr int32_t OnlyFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t OnlyFixedFloorLive = OnlyFixedFloor;
inline void OnlyFixedSetFloorForTest( int32_t index ) { OnlyFixedFloorLive = index; }
#endif

constexpr uint8_t OnlyFixedKnown0Layout[] = {
    0x02, 0x00, 0x00, 0x00, 0x97, 0x0b, 0x5f, 0x6c, 0xc0, 0xdb, 0xba, 0x31, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x56, 0x04, 0x02, 0x86, 0x4c, 0xea, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr TableFixedKnownLayout OnlyFixedKnown[] = {
    { 0x2078b2b4cf504f6eull, OnlyFixedKnown0Layout, 38, 12 }, // identity
};

constexpr const TableFixedKnownRange * OnlyFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t OnlyFixedKnownRangeCounts[] = { 0 };
...
constexpr int64_t OnlyFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + OnlyFixedLayoutBytes + count * OnlyFixedRecordBytes;
}

inline int64_t OnlyFixedSave( const Only * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = OnlyFixedMeasure( count );
    ...
    TableFixedPut64( buffer + kTableFixedHashAt, OnlyFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) OnlyFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, OnlyFixedLayout, (size_t) OnlyFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + OnlyFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, OnlyFixedHash );
        memset( at + 8, 0, (size_t) OnlyFixedBodyBytes ); // the prefill's zeros
        OnlyFixedWriteBody( at + 8, values[k] );
        at += OnlyFixedRecordBytes;
    }
    return need;
}
...
inline int64_t OnlyFixedLoad( Only * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    for ( int32_t i = 0; i < OnlyFixedLineageCount; ++i )
    {
        if ( OnlyFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = OnlyFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = OnlyFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = OnlyFixedKnown[lineage_at];
    ...
    const TableFixedEntry * entries = OnlyFixedPlan;
    int32_t entry_count = OnlyFixedPlanCount;
    int32_t entry_guarded = OnlyFixedPlanGuarded;
    int64_t record_bytes = OnlyFixedRecordBytes;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    if ( hash != OnlyFixedHash )
    {
        ...
        else
        {
            ...
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, OnlyFixedLayout, (int32_t) OnlyFixedLayoutBytes, OnlyFixedDst,
                                                   OnlyFixedCover, OnlyFixedCoverCount,
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        ...
        TableFixedClampKnownRanges( OnlyFixedKnownRanges[lineage_at], OnlyFixedKnownRangeCounts[lineage_at],
...
// OnlyWireExtent: the extent Only's lists and maps command, from the FRAMING alone.
...
inline bool OnlyWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// OnlyExtentAt: the node extent Only's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as OnlyExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool OnlyExtentAt( const Ctx & ctx, const Only & value, int64_t & at )
{
...
template <typename Ctx>
inline int64_t OnlyExtent( const Ctx & ctx, const Only & value )
{
    (void) ctx; (void) value; // no list or map below this record
    return 0;
}

// OnlyExtentPack: carve Only's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset OnlyExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool OnlyExtentPack( const Ctx & ctx, const Only & src, Only & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// GateWireExtent: the extent Gate's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool GateWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// GateExtentAt: the node extent Gate's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as GateExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool GateExtentAt( const Ctx & ctx, const Gate & value, int64_t & at )
{
    (void) ctx; (void) value; (void) at; // no list or map below this record
    return true;
}
...
template <typename Ctx>
inline int64_t GateExtent( const Ctx & ctx, const Gate & value )
{
    (void) ctx; (void) value; // no list or map below this record
    return 0;
}

// GateExtentPack: carve Gate's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset GateExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool GateExtentPack( const Ctx & ctx, const Gate & src, Gate & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// OnlyNumber: number everything Only POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool OnlyNumber( const Ctx & ctx, TableNumbering & numbering, const Only & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// OnlyPackMeasure: the packed region bytes of everything Only POINTS AT.
...
template <typename Ctx>
inline int64_t OnlyPackMeasure( const Ctx & ctx, TablePackMap & seen, const Only & value )
{
    int64_t bytes = 0;
...
// OnlyPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool OnlyPackEdges( const Ctx & ctx, TablePackMap & seen, const Only & src, Only & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool OnlyPack( const Ctx & ctx, TablePackMap & seen, const Only & src, Only & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Only ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Only ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !OnlyExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return OnlyPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
// GateNumber: number everything Gate POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool GateNumber( const Ctx & ctx, TableNumbering & numbering, const Gate & value )
{
    switch ( value.reach.type ) // reach: the set arm is the edge
    {
        case ReachType::Only:
        {
    {
        const Only * pointee = OnlyAt( ctx, value.reach.only ); // only
        if ( pointee != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            else
            {
                ...
                node.type_id = 0x31badbc06c5f0b97ull; // fnv1a64( "Only" )
                node.type_slot = 30; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableNodeMeasureThunk<Ctx, Only>;
                node.save = &TableNodeSaveThunk<Ctx, Only>;
                node.message_measure = &TableNodeMessageMeasureThunk<Ctx, Only>;
                node.message_save = &TableNodeMessageSaveThunk<Ctx, Only>;
                if ( !TableNumberingAppend( numbering, node ) ) { return false; }
                if ( !OnlyNumber( ctx, numbering, *pointee ) ) { return false; }
        ...
        {
    {
        const TableBlob * blob = TableBlobAt( ctx, value.reach.text ); // text: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            if ( taken )
            {
                ...
                node.type_slot = 21; // its slot in the unit's vocabulary (§3.3)
...
// GatePackMeasure: the packed region bytes of everything Gate POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t GatePackMeasure( const Ctx & ctx, TablePackMap & seen, const Gate & value )
{
    int64_t bytes = 0;
    switch ( value.reach.type ) // reach: the set arm is the edge
    {
        ...
        {
    {
        ...
        if ( pointee != NULL )
        {
            ...
            {
                int64_t inner = OnlyPackMeasure( ctx, seen, *pointee );
                if ( inner < 0 ) { return -1; }
                TablePackMapClose( seen, (const void *) pointee, slot );
                bytes += TableAlignUp64( (int64_t) sizeof( Only ) ) + inner;
            }
        }
    }
            break;
        ...
        {
    {
        const TableBlob * blob = TableBlobAt( ctx, value.reach.text ); // text: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
...
// GatePack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool GatePackEdges( const Ctx & ctx, TablePackMap & seen, const Gate & src, Gate & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool GatePack( const Ctx & ctx, TablePackMap & seen, const Gate & src, Gate & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Gate ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Gate ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !GateExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return GatePackEdges( ctx, seen, src, dst, base, capacity, used );
}

template <typename Ctx>
inline bool GatePackEdges( const Ctx & ctx, TablePackMap & seen, const Gate & src, Gate & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    switch ( src.reach.type ) // reach: the set arm is the edge
    {
        case ReachType::Only:
        {
    {
        dst.reach.only.value = 0; // only
        const Only * pointee = OnlyAt( ctx, src.reach.only );
        if ( pointee != NULL )
        {
            ...
            {
                if ( entry->open != 0 ) { return false; } // a data cycle
                dst.reach.only.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.reach.only ); // the one body it already has
            }
            else
            {
                if ( at + (int64_t) sizeof( Only ) > capacity ) { return false; }
                used = at + TableAlignUp64( (int64_t) sizeof( Only ) );
                Only * child = new ( base + at ) Only; // lifetime only: the Pack below memcpy's the whole node over it
                dst.reach.only.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.reach.only );
                if ( !OnlyPack( ctx, seen, *pointee, *child, base, capacity, used ) ) { return false; }
                TablePackMapClose( seen, (const void *) pointee, slot );
            }
        }
    }
        ...
        {
    {
        dst.reach.text.value = 0; // text: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.reach.text );
        if ( blob != NULL )
        {
            int64_t at = TableAlignUp64( used ); // where it WOULD land, if this is its first visit
            bool taken = false;
            ...
            if ( !taken )
            {
                dst.reach.text.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.reach.text ); // the one body it already has
            }
            else
            {
                ...
                used = at + storage;
                dst.reach.text.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.reach.text );
                TablePackMapClose( seen, (const void *) blob, slot );
            }
        }
    }
...
// ---- Gate: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: GateBuilder — allocate nodes, wire them together, then Lock.
...
// Gate is never held by value — a file-format-scale structure is a region
...
struct GateBuilder
{
    ...
    GateBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Gate * GetRoot() { return arena.locked ? NULL : (Gate *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Gate * AsConst() const { return (const Gate *) region; }
...
inline bool GateBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Gate & root = *(const Gate *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Gate on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// GateNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t GateNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: return TableAlignUp64( (int64_t) sizeof( Only ) ); // Only
...
// GateNodePlace: start one record's node's lifetime in the storage pass one
...
inline void GateNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: { Only * node = new ( at ) Only; OnlyReset( *node ); break; } // Only
        case kTableStringTypeId: { TableBlob * blob = (TableBlob *) at; blob->length = (uint32_t) length; blob->zero = 0; break; } // *string
        default: break;
    }
}

// GateNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t GateNodeRecordBytes( uint64_t type_id )
{
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: return TableAlignUp64( (int64_t) sizeof( Only ) ); // Only
...
// GateNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t GateNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: return (uint32_t) worker.Alloc<Only>().ref.value; // Only
...
inline void GateNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = GateNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? GateNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
    ...
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: OnlyLoadBody( r, *(Only *) at ); break; // Only
...
// GateNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t GateNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Only ) ) + extent ); // Only
...
// GateNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool GateNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// GateNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool GateNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + GateNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !GateNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    ...
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: ok = OnlyLoadMessageBody( r, vocabulary, report, index_bits, *(Only *) at ); break; // Only
...
template <typename Ctx>
inline bool GateNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Gate & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return GateNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t GateMeasureWire( const Ctx & ctx, const Gate & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( GateNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = GateMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t GateSaveWire( const Ctx & ctx, const Gate & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !GateNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    ...
    bool ok = GateSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == GateMeasure( root )
}

inline int64_t GateMeasure( const Gate * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return GateMeasureWire( ctx, *root, allocator );
}

inline int64_t GateSave( const Gate * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return GateSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t GateMeasure( const GateBuilder & builder )
{
    if ( builder.region != NULL ) { return GateMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return GateMeasureWire( ctx, *(const Gate *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t GateSave( const GateBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return GateSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return GateSaveWire( ctx, *(const Gate *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Gate on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// GateMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t GateMessageBodyBits( const Ctx & ctx, const Gate & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( GateNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = GateMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool GateMessageBodySave( const Ctx & ctx, const Gate & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && GateSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t GateMeasureMessages( const Gate * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = GateMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t GateSaveMessages( const Gate * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !GateMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == GateMeasureMessages( roots, count, report, allocator )
}

// GateMessageRecordScan: one node record's type id and the extent its maps
...
inline bool GateMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return GateNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// GateMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool GateMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !GateMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = GateNodeMessageStorage( type_id, extent, length );
    ...
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Gate ) ) + root_extent );
    return true;
}

// GateLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t GateLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !GateMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// GateLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool GateLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Gate * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !GateMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = GateNodeMessageStorage( type_id, extent, length );
        ...
        GateNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Gate ) ) + root_extent );
    ...
    Gate * root = new ( region + used ) Gate; // lifetime only: LoadMessageBody's first act is GateReset
    GateReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Gate ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !GateNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return GateLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// GateLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool GateLoadMessages( const Gate ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !GateLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// GateLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t GateLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !GateWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Gate ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = GateNodeStorage( type_id, length, reason );
...
// GateLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Gate * GateLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Gate ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !GateWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Gate ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0xb5877a7e05bbfed2ull;
    Gate * root = new ( region ) Gate; // lifetime only: LoadBody's first act is GateReset
    GateReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                GateNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Gate ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    GateLoadBody( r, nodes, *root );
    return root;
}

// GateLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool GateLoadBuilder( GateBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = GateNodeAlloc( type_id, builder.main, length );
            if ( type_id == kTableStringTypeId && !TableUtf8Valid( body, length ) )
            {
                out->malformed = true;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = GateLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t GateMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.reach.type != ReachType::None ) // None elides — the absence of the field is the None
    {
...
template <typename Ctx>
inline bool GateSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.reach.type != ReachType::None )
    {
        w.header( ids.ref_at( 16, 0x891da1f305deb858ull ), 15 ); // reach
...
template <typename Ctx>
inline bool GateSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Gate & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !GateSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                ...
                TableRetainDiscardField( retain, path, 0 );
                {
                    ...
                    else
                    {
                        switch ( arm.id )
                        {
                            ...
                            default:
                                value.reach.type = ReachType::None; report->unknown++; report->retain_lost++;
                                if ( !TableMessageSkip( r, vocabulary, index_bits, arm ) ) { report->malformed = true; return false; }
                                break;
                        }
                    }
...
inline void GateNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: OnlyLoadBodyRetain( r, *(Only *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Only
        case kTableStringTypeId: if ( r.size > 0 ) { memcpy( at + kTableBlobHeader, r.buffer, (size_t) r.size ); } break; // *string
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
...
// GateLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Gate * GateLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                GateNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    GateLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// GateNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool GateNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + GateNodeRecordBytes( type_id );
    carve.left = 0;
    ...
    switch ( type_id )
    {
        case 0x31badbc06c5f0b97ull: ok = OnlyLoadMessageBodyRetain( r, vocabulary, report, index_bits, *(Only *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Only
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    nodes.carve = outer;
...
// GateLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool GateLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Gate * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !GateNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return GateLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// GateLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool GateLoadRetainMessages( const Gate ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !GateLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// GateMeasureRetain and GateSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t GateMeasureWireRetain( const Ctx & ctx, const Gate & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0x31badbc06c5f0b97ull: return OnlyMeasureBodyRetain( ii, *(const Only *) node, rt, at ); // Only
    ...
    if ( GateNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = GateMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t GateSaveWireRetain( const Ctx & ctx, const Gate & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0x31badbc06c5f0b97ull: return OnlySaveBodyRetain( ww, ii, *(const Only *) node, rt, at ); // Only
    ...
    bool ok = GateSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t GateMeasureRetain( const Gate * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return GateMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t GateSaveRetain( const Gate * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return GateSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// GateSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
template <typename... Args>
inline void OnlyLoadRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
...
template <typename... Args>
inline void OnlyMeasureRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Only is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void OnlySaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Only is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void OnlyLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Only is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void OnlySaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Only is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
// OnlyOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// Only IS FIXED-SIZE, so its cook is ONE REGION OF ONE NODE and not a second
...
// parameter on a load.
inline const Only * OnlyOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Only *) TableCookOpen( bytes, length, (uint64_t) sizeof( Only ), (uint64_t) alignof( Only ), reason );
}

// GateOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH GateAt: the slot holds
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Gate * GateOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Gate *) TableCookOpen( bytes, length, (uint64_t) sizeof( Gate ), (uint64_t) alignof( Gate ), reason );
}
...
inline void OnlyCookBody( uint8_t * at, const Only & value, TableByteOrder order );
template <typename Ctx> inline bool GateCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Gate & value, TableByteOrder order );

inline void OnlyCookBody( uint8_t * at, const Only & value, TableByteOrder order )
{
    table_cook_put( at + 0, (uint64_t) value.w, 4, order );
}

template <typename Ctx> inline bool GateCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Gate & value, TableByteOrder order )
{
    {
        table_cook_put( at + 0, (uint64_t) value.reach.type, 1, order ); // the tag; None is the tag alone
        switch ( value.reach.type )
        {
            case ReachType::Only:
            {
                if ( !table_cook_ref( region, at + 0 + 8, (const void *) OnlyAt( ctx, value.reach.only ), order ) ) { return false; } // only
                break;
            }
            case ReachType::Text:
            {
                if ( !table_cook_ref( region, at + 0 + 8, (const void *) TableBlobAt( ctx, value.reach.text ), order ) ) { return false; } // text
                break;
            }
            case ReachType::Plain:
            {
                table_cook_put( at + 0 + 8, (uint64_t) value.reach.plain, 4, order );
                break;
            }
...
template <typename Ctx> inline bool OnlyCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Only & value, TableByteOrder order );
template <typename Ctx> inline bool GateCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Gate & value, TableByteOrder order );

// OnlyCookExtent: Only's arrays into the node's extent, PRE-ORDER, a map's entries
...
// GateCookExtent: Gate's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool GateCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Gate & value, TableByteOrder order )
{
...
// OnlyCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool OnlyCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Only & value, TableByteOrder order )
{
    OnlyCookBody( at, value, order );
    int64_t extent_at = 0;
    return OnlyCookExtent( ctx, region, at + 8, extent_at, at, value, order );
}

// GateCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool GateCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Gate & value, TableByteOrder order )
{
    if ( !GateCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    return GateCookExtent( ctx, region, at + 24, extent_at, at, value, order );
}

// OnlyCookMeasure: the whole cooked file's bytes — the header, the data part
...
//
// Only IS FIXED-SIZE, so the answer does not depend on the value: its cook is
...
inline int64_t OnlyCookMeasure( const Only & value )
{
    (void) value;
    return 88; // 64 header + 8 data + 16 attribution
}

// OnlyCook: write one cooked file for the build this code is compiled into,
...
// the same contract OnlyMeasure/OnlySave has on the wire (§6.1).
//
...
inline bool OnlyCook( const Only & value, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( out == NULL ) { return false; }
    const uint64_t need = (uint64_t) OnlyCookMeasure( value );
    ...
    OnlyCookBody( raw + 64, value, order );
    ...
    table_cook_put( raw + 80, 0x31badbc06c5f0b97ull, 8, order );
    return true;
}

// GateCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool GateCookLayout( const Ctx & ctx, const Gate & root, const TableNumbering & numbering, TableCookRegion & region )
{
    ...
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
        ...
        {
            case 0x31badbc06c5f0b97ull: size = 4; node_align = 4; break; // Only
...
// GateCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t GateCookMeasureFrom( const Ctx & ctx, const Gate & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( GateNumberFrom( ctx, numbering, root ) && GateCookLayout( ctx, root, numbering, region ) )
    {
...
// GateCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool GateCookFrom( const Ctx & ctx, const Gate & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = GateCookNode( ctx, region, region.base, root, order );
            for ( int64_t k = 0; ok && k < numbering.count; k++ )
            {
                ...
                switch ( numbering.entries[k].type_id )
                {
                    case 0x31badbc06c5f0b97ull: ok = OnlyCookNode( ctx, region, at, *(const Only *) node, order ); break; // Only
                    case kTableStringTypeId:
                    {
            ...
            table_cook_put( entry + 8, 0xb5877a7e05bbfed2ull, 8, order ); // the root: fnv1a64( "Gate" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// GateCookMeasure / GateCook over a REGION root — a locked builder's AsConst, a
// region GateLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t GateCookMeasure( const Gate * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return GateCookMeasureFrom( ctx, *root, allocator );
}

inline bool GateCook( const Gate * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return GateCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t GateCookMeasure( const GateBuilder & builder )
{
    if ( builder.region != NULL ) { return GateCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return GateCookMeasureFrom( ctx, *(const Gate *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool GateCook( const GateBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return GateCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return GateCookFrom( ctx, *(const Gate *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( Only ), "Only must stay relocatable" );
static_assert( __is_standard_layout( Only ), "Only must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Gate ), "Gate must stay relocatable" );
static_assert( __is_standard_layout( Gate ), "Gate must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( Only ) == 4, "Only's sizeof moved: the build version was taken over 4, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Only ) == 4, "Only's alignof moved: the build version was taken over 4 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Only, w ) == 0, "Only's field w moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Gate ) == 24, "Gate's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Gate ) == 8, "Gate's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Gate, reach ) == 0, "Gate's field reach moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Gate, after ) == 16, "Gate's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );


// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * OnlyTableType();
inline const TableTypeInfo * GateTableType();
...
extern const TableTypeInfo OnlyTableInfo;
...
// Only in and out of a JSON text — one instance, one text, the generic
// walk over this type's descriptors (docs/SPEC-TABLES.md §16). Defined in
// GateTable.cpp; link it to use them.
bool OnlyFromJson( Only & value, const char * text, int64_t bytes, TableReport * report );
int64_t OnlyToJsonMeasure( const Only & value );
int64_t OnlyToJson( const Only & value, char * buffer, int64_t capacity );

// Gate in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in GateTable.cpp; link it to use them.
bool GateFromJson( GateBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t GateToJsonMeasure( const Gate * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t GateToJson( const Gate * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
