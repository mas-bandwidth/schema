...
constexpr uint64_t OnlyFixedHash = 0x2078b2b4cf504f6eull; // fnv1a64 over the block's bytes
...
constexpr uint8_t OnlyFixedVocab[] = {
...
constexpr int64_t OnlyFixedVocabBytes = (int64_t) sizeof( OnlyFixedVocab );
...
{
    return 1 + 4 + OnlyFixedVocabBytes + count * OnlyFixedRecordBytes;
}
...
inline int64_t OnlyFixedSave( const Only * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) OnlyFixedVocabBytes );
    memcpy( buffer + 5, OnlyFixedVocab, (size_t) OnlyFixedVocabBytes );
    uint8_t * at = buffer + 5 + OnlyFixedVocabBytes;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != OnlyFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, OnlyFixedVocab, (int32_t) OnlyFixedVocabBytes, OnlyFixedDst, plan, plan_capacity, &compiled_guarded, report );
