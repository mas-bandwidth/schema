...
constexpr TableFixedEntry OnlyFixedPlan[] = {
    { 0u, 0u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // w
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != OnlyFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, OnlyFixedLayout, (int32_t) OnlyFixedLayoutBytes, OnlyFixedDst, plan, plan_capacity, &compiled_guarded, report );
    ...
    {
        OnlyReset( values[k] ); // the declared defaults, one prefill
