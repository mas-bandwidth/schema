...
// RingNodeMessageBody: PASS TWO's half — decode one record's body into the
...
// RackNodeMessageBody: PASS TWO's half — decode one record's body into the
// storage it already owns, its map entries carved from its own extent.
...
// TrayNodeMessageBody: PASS TWO's half — decode one record's body into the
// storage it already owns, its map entries carved from its own extent.
