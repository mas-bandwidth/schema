...
inline void TrayReset( Tray & value )
{
    for ( int32_t i = 0; i < 2; i++ ) { value.entries[0].many.value[i].value = 0; } // [..2]*Node — every slot null
    value.entries[0].many.value_count = 0;
    value.entries[0].plain = 0;
    value.entries[0].type = SlotsType::None;
...
inline int64_t NodeMeasureBodyRetain( TableRetainIds & ids, const Node & value, TableRetain * retain, const TableRetainPath & path );
ARMDEMO_TABLE_INLINE bool NodeSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const Node & value, TableRetain * retain, const TableRetainPath & path );
ARMDEMO_TABLE_INLINE bool NodeLoadBodyRetain( TableReader & r, Node & value, TableRetain * retain, const TableRetainPath & path );
inline bool NodeLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Node & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t RingMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RingSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RingSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool RingLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Ring & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t RackMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RackSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RackSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool RackLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Rack & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t TrayMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TraySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TraySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool TrayLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Tray & value, TableRetain * retain, const TableRetainPath & path );

inline int64_t NodeMeasureBody( TableIds & ids, const Node & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.v != 0 ) { bytes += TableLebBytes( ids.ref_at( 22, 0xaf63eb4c86020609ull ) ) + 1 + 4; } // v
    return bytes;
}
...
ARMDEMO_TABLE_INLINE bool NodeSaveBody( TableWriter & w, TableIds & ids, const Node & value )
{
    if ( value.v != 0 )
    {
        w.header( ids.ref_at( 22, 0xaf63eb4c86020609ull ), 4 ); // v
                ...
                else
                {
                    switch ( cursor_items[elem_i_items].type )
                    {
                        ...
                        case SlotType::Node:
                        {
                            ...
                            const uint64_t arm_ref_itemsu = ids.ref_at( 8, 0x3c2f1bbad18642adull );
                            {
                        ...
                        {
                            int64_t arm_payload_itemsu = 0;
                            const uint64_t arm_ref_itemsu = ids.ref_at( 30, 0xfd4d194e1652b207ull );
                ...
                else
                {
                    switch ( cursor_items[elem_i_items].type )
                    {
                        case SlotType::Node:
                        {
                            ...
                            w.header( arm_ref_itemsu, 17 ); w.putleb( (uint64_t) arm_payload_itemsu ); // node
                            {
                                const Node * arm_pointee_itemsu = NodeAt( ctx, cursor_items[elem_i_items].node );
                                uint64_t arm_index_itemsu = 0;
                                if ( arm_pointee_itemsu != NULL && !TableNumberingIndex( numbering, (const void *) arm_pointee_itemsu, arm_index_itemsu ) ) { return false; }
                        ...
                        case SlotType::Plain:
                        {
                            ...
                            int64_t arm_payload_itemsu = 0;
                            arm_payload_itemsu += 4; // int32
                            w.header( arm_ref_itemsu, 4 ); w.putleb( (uint64_t) arm_payload_itemsu ); // plain
            ...
            for ( int32_t elem_i_items = 0; elem_i_items < cursor_items.count; elem_i_items++ )
            {
                ...
                else
                {
                    switch ( cursor_items[elem_i_items].type )
                    {
                        ...
                        {
                            int64_t arm_payload_itemsu = 0;
                            const uint64_t arm_ref_itemsu = ids.ref_at( 2, 0x1f6459a2cea1fc02ull );
                ...
                else
                {
                    switch ( cursor_items[elem_i_items].type )
                    {
                        case SlotsType::Many:
                        {
                            ...
                            w.header( arm_ref_itemsu, 14 ); w.putleb( (uint64_t) arm_payload_itemsu ); // many
                            if ( cursor_items[elem_i_items].many.value_count < 0 || cursor_items[elem_i_items].many.value_count > 2 ) { return false; } // storage invariant
            ...
            else
            {
                switch ( value.entries[elem_i].type )
                {
                    ...
                    case SlotsType::Many:
                    {
                        ...
                        const uint64_t arm_refu = ids.ref_at( 2, 0x1f6459a2cea1fc02ull );
            ...
            else
            {
                switch ( value.entries[elem_i].type )
                {
                    case SlotsType::Many:
                    {
                        ...
                        w.header( arm_refu, 14 ); w.putleb( (uint64_t) arm_payloadu ); // many
                        if ( value.entries[elem_i].many.value_count < 0 || value.entries[elem_i].many.value_count > 2 ) { return false; } // storage invariant
            ...
            case 0xc5b2a72c0845a253ull: // entries
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( int32_t tail = value.entries_count; tail < previous_count; tail++ ) {
                        for ( int32_t i = 0; i < 2; i++ ) { value.entries[tail].many.value[i].value = 0; } // [..2]*Node — every slot null
                        value.entries[tail].many.value_count = 0;
                        value.entries[tail].plain = 0;
                        value.entries[tail].type = SlotsType::None;
                    }
                    }
                }
...
static_assert( sizeof( Node ) == 4, "Node: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( Node, v ) == 0, "Node.v: the fixed form's plan lands here" );

// Node's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void NodeFixedWriteBody( uint8_t * b, const Node & value )
{
    (void) b; (void) value;
...
constexpr int64_t NodeFixedBodyBytes = 4;
constexpr int64_t NodeFixedRecordBytes = 8 + NodeFixedBodyBytes; // the hash and the body
constexpr uint64_t NodeFixedHash = 0x79d3bdf48b9c6647ull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t NodeFixedLayout[] = {
    0x02, 0x00, 0x00, 0x00, 0x8d, 0xb6, 0xf6, 0xd2, 0xc6, 0x1c, 0xbd, 0x66, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t NodeFixedLayoutBytes = (int64_t) sizeof( NodeFixedLayout );
...
constexpr TableFixedDst NodeFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // Node
    { (uint32_t) __builtin_offsetof( Node, v ), 0, 0, 0, 0 }, // v
};
...
constexpr TableFixedGuard NodeFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t NodeFixedGuardCount = 0;
...
// guard at all.
constexpr TableFixedEntry NodeFixedPlan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, // v
};
constexpr int32_t NodeFixedPlanCount = 1;
constexpr int32_t NodeFixedPlanGuarded = 1;
...
constexpr TableFixedFill NodeFixedCover[] = {
    { 0u, 4u },
};
constexpr int32_t NodeFixedCoverCount = 1;
...
constexpr uint64_t NodeFixedLineage[] = {
    0x79d3bdf48b9c6647ull, // identity
};
constexpr int32_t NodeFixedLineageCount = 1;
constexpr int32_t NodeFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t NodeFixedFloorLive = NodeFixedFloor;
inline void NodeFixedSetFloorForTest( int32_t index ) { NodeFixedFloorLive = index; }
#endif

constexpr uint8_t NodeFixedKnown0Layout[] = {
    0x02, 0x00, 0x00, 0x00, 0x8d, 0xb6, 0xf6, 0xd2, 0xc6, 0x1c, 0xbd, 0x66, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr TableFixedKnownLayout NodeFixedKnown[] = {
    { 0x79d3bdf48b9c6647ull, NodeFixedKnown0Layout, 38, 12 }, // identity
};

constexpr const TableFixedKnownRange * NodeFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t NodeFixedKnownRangeCounts[] = { 0 };
...
constexpr int64_t NodeFixedMeasure( int64_t count )
{
...
inline int64_t NodeFixedSave( const Node * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    for ( int64_t k = 0; k < count; ++k )
    {
        ...
        memset( at + 8, 0, (size_t) NodeFixedBodyBytes ); // the prefill's zeros
        NodeFixedWriteBody( at + 8, values[k] );
        at += NodeFixedRecordBytes;
    }
    return need;
}
...
inline int64_t NodeFixedLoad( Node * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    for ( int32_t i = 0; i < NodeFixedLineageCount; ++i )
    {
        if ( NodeFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = NodeFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = NodeFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = NodeFixedKnown[lineage_at];
    ...
    const TableFixedEntry * entries = NodeFixedPlan;
    const uint8_t * guard_pool = (const uint8_t *) NodeFixedGuards;
    int32_t entry_count = NodeFixedPlanCount;
    int32_t entry_guarded = NodeFixedPlanGuarded;
    int64_t record_bytes = NodeFixedRecordBytes;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    if ( hash != NodeFixedHash )
    {
        ...
        else
        {
            ...
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, NodeFixedLayout, (int32_t) NodeFixedLayoutBytes, NodeFixedDst,
                                                   NodeFixedCover, NodeFixedCoverCount,
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        ...
        TableFixedClampKnownRanges( NodeFixedKnownRanges[lineage_at], NodeFixedKnownRangeCounts[lineage_at],
...
template <typename Ctx>
inline int64_t RingMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // items: a kind 14 array of kind 15 elements, INDEX order (§2.9)
...
template <typename Ctx>
inline bool RingSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableListCursor<Slot> cursor_items = TableListElements( ctx, value.items ); // items
        if ( !cursor_items.ok ) { return false; }
...
template <typename Ctx>
inline bool RingSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Ring & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !RingSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        {
                            ...
                            else
                            {
                                switch ( arm_2.id )
                                {
                                    ...
                                    default:
                                        ( *slot ).type = SlotType::None; report->unknown++; report->retain_lost++;
                                        if ( !TableMessageSkip( r, vocabulary, index_bits, arm_2 ) ) { report->malformed = true; return false; }
                                        break;
                                }
                            }
...
template <typename Ctx>
inline int64_t RackMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // items: a kind 14 array of kind 15 elements, INDEX order (§2.9)
...
template <typename Ctx>
inline bool RackSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableListCursor<Slots> cursor_items = TableListElements( ctx, value.items ); // items
        if ( !cursor_items.ok ) { return false; }
...
template <typename Ctx>
inline bool RackSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Rack & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !RackSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        {
                            ...
                            else
                            {
                                switch ( arm_2.id )
                                {
                                    ...
                                    default:
                                        ( *slot ).type = SlotsType::None; report->unknown++; report->retain_lost++;
                                        if ( !TableMessageSkip( r, vocabulary, index_bits, arm_2 ) ) { report->malformed = true; return false; }
                                        break;
                                }
                            }
...
template <typename Ctx>
inline int64_t TrayMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.entries_count < 0 || value.entries_count > 2 ) { return -1; } // storage invariant
    if ( value.entries_count > 0 )
...
template <typename Ctx>
inline bool TraySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.entries_count < 0 || value.entries_count > 2 ) { return false; } // storage invariant
    if ( value.entries_count > 0 )
    {
...
template <typename Ctx>
inline bool TraySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Tray & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !TraySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
                        ...
                        Slots scratch;
                        {
                            ...
                            else
                            {
                                switch ( arm_2.id )
                                {
                                    ...
                                    default:
                                        ( in_bounds ? value.entries[i] : scratch ).type = SlotsType::None; report->unknown++; report->retain_lost++;
                                        if ( !TableMessageSkip( r, vocabulary, index_bits, arm_2 ) ) { report->malformed = true; return false; }
                                        break;
                                }
                            }
...
inline void RingNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    switch ( type_id )
    {
        case 0x66bd1cc6d2f6b68dull: NodeLoadBodyRetain( r, *(Node *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Node
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// RingLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Ring * RingLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RingNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    RingLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// RingNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool RingNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + RingNodeRecordBytes( type_id );
    carve.left = 0;
    ...
    switch ( type_id )
    {
        case 0x66bd1cc6d2f6b68dull: ok = NodeLoadMessageBodyRetain( r, vocabulary, report, index_bits, *(Node *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Node
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    nodes.carve = outer;
...
// RingLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool RingLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Ring * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RingNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return RingLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// RingLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool RingLoadRetainMessages( const Ring ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !RingLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// RingMeasureRetain and RingSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t RingMeasureWireRetain( const Ctx & ctx, const Ring & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0x66bd1cc6d2f6b68dull: return NodeMeasureBodyRetain( ii, *(const Node *) node, rt, at ); // Node
            default: break;
        }
        return -1;
    };
    if ( RingNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = RingMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t RingSaveWireRetain( const Ctx & ctx, const Ring & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0x66bd1cc6d2f6b68dull: return NodeSaveBodyRetain( ww, ii, *(const Node *) node, rt, at ); // Node
            default: break;
        }
        return false;
    };
    ...
    bool ok = RingSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t RingMeasureRetain( const Ring * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RingMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t RingSaveRetain( const Ring * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RingSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}
...
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void RackNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// RackLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Rack * RackLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RackNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    RackLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// RackNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is this body's own directory position, which the batch's load fills
// from the framing and nothing afterwards renumbers.
inline bool RackNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + RackNodeRecordBytes( type_id );
    carve.left = 0;
...
// RackLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
// each body carries its own node directory inside that one region and a
// record's first step is an index into it (docs/SPEC-TABLES.md §3.3, §6.6).
inline bool RackLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Rack * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RackNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return RackLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// RackLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool RackLoadRetainMessages( const Rack ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !RackLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// RackMeasureRetain and RackSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t RackMeasureWireRetain( const Ctx & ctx, const Rack & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( RackNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = RackMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t RackSaveWireRetain( const Ctx & ctx, const Rack & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = RackSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t RackMeasureRetain( const Rack * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RackMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t RackSaveRetain( const Rack * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RackSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}
...
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void TrayNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// TrayLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Tray * TrayLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                TrayNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    TrayLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// TrayNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is this body's own directory position, which the batch's load fills
// from the framing and nothing afterwards renumbers.
inline bool TrayNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + TrayNodeRecordBytes( type_id );
    carve.left = 0;
...
// TrayLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
// each body carries its own node directory inside that one region and a
// record's first step is an index into it (docs/SPEC-TABLES.md §3.3, §6.6).
inline bool TrayLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Tray * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TrayNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return TrayLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// TrayLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool TrayLoadRetainMessages( const Tray ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !TrayLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// TrayMeasureRetain and TraySaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t TrayMeasureWireRetain( const Ctx & ctx, const Tray & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( TrayNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = TrayMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t TraySaveWireRetain( const Ctx & ctx, const Tray & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = TraySaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t TrayMeasureRetain( const Tray * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrayMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t TraySaveRetain( const Tray * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TraySaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}
...
template <typename... Args>
inline void NodeSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Node is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void NodeLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Node is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void NodeSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Node is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
