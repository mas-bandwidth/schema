...
// package blockdemo — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several blockdemo Table.cpp files may be
...
#ifndef BLOCKDEMO_SCHEMA_TABLE_JSON
#define BLOCKDEMO_SCHEMA_TABLE_JSON
