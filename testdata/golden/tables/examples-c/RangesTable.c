...
static const TableFieldInfo schema_tabledemo_ranged_signed_fields_[] = {
    { "i8_span", "i8_span", "int8", 0x8d4f, 2, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i8_span ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i8_span ), 0xffffffffu, 0xffffffffu, NULL, 1, -128.0, 127.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i8_low", "i8_low", "int8", 0xe337, 2, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i8_low ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i8_low ), 0xffffffffu, 0xffffffffu, NULL, 1, -128.0, 126.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i8_high", "i8_high", "int8", 0x6a5f, 2, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i8_high ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i8_high ), 0xffffffffu, 0xffffffffu, NULL, 1, -127.0, 127.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i8_inside", "i8_inside", "int8", 0x8eee, 2, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i8_inside ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i8_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, -127.0, 126.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i16_span", "i16_span", "int16", 0x0a1e, 3, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i16_span ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i16_span ), 0xffffffffu, 0xffffffffu, NULL, 1, -32768.0, 32767.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i16_low", "i16_low", "int16", 0xaaae, 3, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i16_low ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i16_low ), 0xffffffffu, 0xffffffffu, NULL, 1, -32768.0, 32766.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i16_high", "i16_high", "int16", 0xe8f2, 3, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i16_high ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i16_high ), 0xffffffffu, 0xffffffffu, NULL, 1, -32767.0, 32767.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i16_inside", "i16_inside", "int16", 0x1a0e, 3, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i16_inside ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i16_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, -32767.0, 32766.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i32_span", "i32_span", "int32", 0x6bd1, 4, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i32_span ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i32_span ), 0xffffffffu, 0xffffffffu, NULL, 1, -2.147483648e+09, 2.147483647e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i32_low", "i32_low", "int32", 0xb8e0, 4, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i32_low ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i32_low ), 0xffffffffu, 0xffffffffu, NULL, 1, -2.147483648e+09, 2.147483646e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i32_high", "i32_high", "int32", 0x3806, 4, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i32_high ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i32_high ), 0xffffffffu, 0xffffffffu, NULL, 1, -2.147483647e+09, 2.147483647e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i32_inside", "i32_inside", "int32", 0x9a24, 4, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i32_inside ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i32_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, -2.147483647e+09, 2.147483646e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i64_span", "i64_span", "int64", 0xf086, 5, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i64_span ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i64_span ), 0xffffffffu, 0xffffffffu, NULL, 1, -9.223372036854776e+18, 9.223372036854776e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i64_low", "i64_low", "int64", 0xc705, 5, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i64_low ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i64_low ), 0xffffffffu, 0xffffffffu, NULL, 1, -9.223372036854776e+18, 9.223372036854776e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i64_high", "i64_high", "int64", 0x328e, 5, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i64_high ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i64_high ), 0xffffffffu, 0xffffffffu, NULL, 1, -9.223372036854776e+18, 9.223372036854776e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "i64_inside", "i64_inside", "int64", 0x7d51, 5, 0, 0, 0, 0, (uint32_t) offsetof( RangedSigned, i64_inside ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->i64_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, -9.223372036854776e+18, 9.223372036854776e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "edges", "edges", "int16", 0xb1cb, 3, 1, 1, 0, 4, (uint32_t) offsetof( RangedSigned, edges ), (uint32_t) sizeof( ( (RangedSigned *) 0 )->edges[0] ), (uint32_t) offsetof( RangedSigned, edges_count ), 0xffffffffu, NULL, 1, -32768.0, 32767.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_tabledemo_ranged_signed_info_ = { "RangedSigned", (uint32_t) sizeof( RangedSigned ), 17, schema_tabledemo_ranged_signed_fields_, schema_tabledemo_ranged_signed_reset_raw_ };

static const TableFieldInfo schema_tabledemo_ranged_unsigned_fields_[] = {
    { "u8_span", "u8_span", "uint8", 0x6434, 6, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u8_span ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u8_span ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u8_low", "u8_low", "uint8", 0xb24e, 6, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u8_low ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u8_low ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 254.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u8_high", "u8_high", "uint8", 0x202a, 6, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u8_high ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u8_high ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u8_inside", "u8_inside", "uint8", 0x8fbf, 6, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u8_inside ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u8_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 254.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u16_span", "u16_span", "uint16", 0xd410, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u16_span ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u16_span ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u16_low", "u16_low", "uint16", 0x6f72, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u16_low ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u16_low ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65534.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u16_high", "u16_high", "uint16", 0x1364, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u16_high ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u16_high ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u16_inside", "u16_inside", "uint16", 0xbf32, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u16_inside ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u16_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 65534.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u32_span", "u32_span", "uint32", 0x0513, 8, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u32_span ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u32_span ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4.294967295e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u32_low", "u32_low", "uint32", 0x4cce, 8, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u32_low ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u32_low ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4.294967294e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u32_high", "u32_high", "uint32", 0xa2da, 8, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u32_high ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u32_high ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 4.294967295e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u32_inside", "u32_inside", "uint32", 0xf596, 8, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u32_inside ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u32_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 4.294967294e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u64_span", "u64_span", "uint64", 0x6e8d, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u64_span ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u64_span ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u64_low", "u64_low", "uint64", 0x95b5, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u64_low ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u64_low ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u64_high", "u64_high", "uint64", 0x15e4, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u64_high ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u64_high ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "u64_inside", "u64_inside", "uint64", 0x2ce0, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedUnsigned, u64_inside ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->u64_inside ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "counts", "counts", "uint64", 0xe27a, 9, 1, 1, 0, 4, (uint32_t) offsetof( RangedUnsigned, counts ), (uint32_t) sizeof( ( (RangedUnsigned *) 0 )->counts[0] ), (uint32_t) offsetof( RangedUnsigned, counts_count ), 0xffffffffu, NULL, 1, 0.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_tabledemo_ranged_unsigned_info_ = { "RangedUnsigned", (uint32_t) sizeof( RangedUnsigned ), 17, schema_tabledemo_ranged_unsigned_fields_, schema_tabledemo_ranged_unsigned_reset_raw_ };

static const TableFieldInfo schema_tabledemo_ranged_widths_fields_[] = {
    { "b8", "b8", "bits(8)", 0xa7cb, 6, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b8 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b8 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "b16", "b16", "bits(16)", 0xb643, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b16 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b16 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "b32", "b32", "bits(32)", 0x33f2, 8, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b32 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b32 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4.294967295e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "b64", "b64", "bits(64)", 0x75dc, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b64 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b64 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.8446744073709552e+19, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "b12", "b12", "bits(12)", 0xbcf7, 7, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b12 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b12 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "b48", "b48", "bits(48)", 0x9797, 9, 0, 0, 0, 0, (uint32_t) offsetof( RangedWidths, b48 ), (uint32_t) sizeof( ( (RangedWidths *) 0 )->b48 ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 2.81474976710655e+14, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_tabledemo_ranged_widths_info_ = { "RangedWidths", (uint32_t) sizeof( RangedWidths ), 6, schema_tabledemo_ranged_widths_fields_, schema_tabledemo_ranged_widths_reset_raw_ };
