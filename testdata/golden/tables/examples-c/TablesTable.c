...
static const TableFieldInfo schema_tabledemo_weapon_config_fields_[] = {
    { "damage", "damage", "float32", 0x7f6308be8ab37fc0ull, 10, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, damage ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->damage ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", " Damage per hit, before armor.\n\nThe armor curve is written \"hardness \\ hit\" in the design notes,\nand the backslash is part of the name.", 3, schema_tabledemo_weapon_config_damage_tags_, 0, NULL },
    { "speed", "speed", "float32", 0x1733055702acb1d2ull, 10, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, speed ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->speed ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "penetration", "penetration", "int32", 0x4f31c5309e13e932ull, 4, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, penetration ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->penetration ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 10.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "channel", "channel", "bits(6)", 0xa5013e9ad5caeda4ull, 6, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, channel ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->channel ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 63.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "homing", "homing", "bool", 0xad6587bc602e3f59ull, 1, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, homing ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->homing ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "effect", "effect", "Effect", 0x36c1c83b51f24394ull, 15, 0, 0, 0, 0, 0, (uint32_t) offsetof( WeaponConfig, effect ), (uint32_t) sizeof( ( (WeaponConfig *) 0 )->effect ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 2, schema_tabledemo_weapon_config_effect_variants_, 1, NULL, NULL, -1, &schema_tabledemo_weapon_config_effect_union_, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_weapon_config_info_ = { "WeaponConfig", (uint32_t) sizeof( WeaponConfig ), 6, schema_tabledemo_weapon_config_fields_, schema_tabledemo_weapon_config_reset_raw_, 0, "One weapon's tuning. A designer edits this table and nothing else.", 1, schema_tabledemo_weapon_config_tags_ };
...
static const TableFieldInfo schema_tabledemo_loadout_config_fields_[] = {
    { "grade", "grade", "Grade", 0x32a89b2977c48ad4ull, 30, 0, 0, 0, 0, 0, (uint32_t) offsetof( LoadoutConfig, grade ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->grade ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 3, schema_tabledemo_loadout_config_grade_variants_, 1, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "grades", "grades", "Grade", 0xd90a4e7682f799c5ull, 30, 1, 0, 1, 0, 4, (uint32_t) offsetof( LoadoutConfig, grades ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->grades[0] ), (uint32_t) offsetof( LoadoutConfig, grades_count ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 3, schema_tabledemo_loadout_config_grades_variants_, 1, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "podium", "podium", "Grade", 0xb46ff45a23d72549ull, 30, 1, 0, 0, 0, 3, (uint32_t) offsetof( LoadoutConfig, podium ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->podium[0] ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 3, schema_tabledemo_loadout_config_podium_variants_, 1, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "perks", "perks", "Perks", 0x4b06f5847096e54aull, 9, 0, 0, 0, 0, 0, (uint32_t) offsetof( LoadoutConfig, perks ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->perks ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 2, schema_tabledemo_loadout_config_perks_variants_, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "primary", "primary", "WeaponConfig", 0xbf31137ff783e939ull, 13, 0, 0, 0, 0, 0, (uint32_t) offsetof( LoadoutConfig, primary ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->primary ), 0xffffffffu, 0xffffffffu, &schema_tabledemo_weapon_config_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "backups", "backups", "WeaponConfig", 0xde28f0f5118acc24ull, 13, 1, 0, 0, 0, 2, (uint32_t) offsetof( LoadoutConfig, backups ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->backups[0] ), 0xffffffffu, 0xffffffffu, &schema_tabledemo_weapon_config_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "attachments", "attachments", "Attachment", 0xf901aa0340249a41ull, 13, 1, 0, 1, 0, 8, (uint32_t) offsetof( LoadoutConfig, attachments ), (uint32_t) sizeof( ( (LoadoutConfig *) 0 )->attachments[0] ), (uint32_t) offsetof( LoadoutConfig, attachments_count ), 0xffffffffu, &schema_tabledemo_attachment_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_loadout_config_info_ = { "LoadoutConfig", (uint32_t) sizeof( LoadoutConfig ), 7, schema_tabledemo_loadout_config_fields_, schema_tabledemo_loadout_config_reset_raw_, 0, TableDocNone, 0, NULL };

static const TableFieldInfo schema_tabledemo_profile_config_fields_[] = {
    { "name", "name", "string", 0xc4bcadba8e631b86ull, 12, 0, 0, 1, 0, 32, (uint32_t) offsetof( ProfileConfig, name ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->name ), (uint32_t) offsetof( ProfileConfig, name_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "icon", "icon", "bytes", 0xdbff4cc56c2092f0ull, 6, 1, 0, 1, 0, 16, (uint32_t) offsetof( ProfileConfig, icon ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->icon[0] ), (uint32_t) offsetof( ProfileConfig, icon_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "experience", "experience", "uint32", 0xab8b6d521f80b969ull, 8, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, experience ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->experience ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "tilt", "tilt", "int8", 0x1e5088ef2e9bafc6ull, 2, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, tilt ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->tilt ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "heading", "heading", "int16", 0xb128829190ca0f75ull, 3, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, heading ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->heading ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "timestamp", "timestamp", "int64", 0x5ddc92338ef53403ull, 5, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, timestamp ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->timestamp ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "badge", "badge", "uint8", 0x10bda981fe095518ull, 6, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, badge ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->badge ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "port", "port", "uint16", 0x8c2cdb0da8933fa6ull, 7, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, port ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->port ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "epoch", "epoch", "uint64", 0xfc9697d1196e6ba6ull, 9, 0, 0, 0, 0, 0, (uint32_t) offsetof( ProfileConfig, epoch ), (uint32_t) sizeof( ( (ProfileConfig *) 0 )->epoch ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
...
static const TableFieldInfo schema_tabledemo_root_config_fields_[] = {
    ...
    { "weapons", "weapons", "WeaponConfig", 0x41cbd901b87fabb6ull, 13, 1, 0, 1, 0, 8, (uint32_t) offsetof( RootConfig, weapons ), (uint32_t) sizeof( ( (RootConfig *) 0 )->weapons[0] ), (uint32_t) offsetof( RootConfig, weapons_count ), 0xffffffffu, &schema_tabledemo_weapon_config_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
...
static const TableFieldInfo schema_tabledemo_attachment_fields_[] = {
    ...
    { "power", "power", "float32", 0xeef9d1358ae7b4e6ull, 10, 0, 0, 0, 0, 0, (uint32_t) offsetof( Attachment, power ), (uint32_t) sizeof( ( (Attachment *) 0 )->power ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_attachment_info_ = { "Attachment", (uint32_t) sizeof( Attachment ), 2, schema_tabledemo_attachment_fields_, schema_tabledemo_attachment_reset_raw_, 0, TableDocNone, 0, NULL };

static const TableFieldInfo schema_tabledemo_buff_fields_[] = {
    { "multiplier", "multiplier", "float32", 0x9adc623a805c87c6ull, 10, 0, 0, 0, 0, 0, (uint32_t) offsetof( Buff, multiplier ), (uint32_t) sizeof( ( (Buff *) 0 )->multiplier ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_buff_info_ = { "Buff", (uint32_t) sizeof( Buff ), 1, schema_tabledemo_buff_fields_, schema_tabledemo_buff_reset_raw_, 0, TableDocNone, 0, NULL };

static const TableFieldInfo schema_tabledemo_debuff_fields_[] = {
    { "amount", "amount", "int32", 0x8113fe7ea2b16969ull, 4, 0, 0, 0, 0, 0, (uint32_t) offsetof( Debuff, amount ), (uint32_t) sizeof( ( (Debuff *) 0 )->amount ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 100.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_debuff_info_ = { "Debuff", (uint32_t) sizeof( Debuff ), 1, schema_tabledemo_debuff_fields_, schema_tabledemo_debuff_reset_raw_, 0, TableDocNone, 0, NULL };
