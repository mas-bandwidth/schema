...
static SCHEMA_UNUSED int ranged_signed_save_body( TableWriter * w, const RangedSigned * value )
{
    ...
    { /* i8_span */
        if ( !( value->i8_span == 0 ) )
        {
            table_writer_header_at( w, 44, 0x48121511bf702eb5ull, 2 );
    ...
    { /* i8_low */
        if ( !( value->i8_low == 0 ) )
        {
            table_writer_header_at( w, 77, 0x942bfe3168090f7dull, 2 );
    ...
    { /* i8_high */
        if ( !( value->i8_high == 0 ) )
        {
            table_writer_header_at( w, 127, 0xd182acd105b55dd1ull, 2 );
    ...
    { /* i8_inside */
        ...
        {
            table_writer_header_at( w, 142, 0xef9ded23c8912a81ull, 2 );
    ...
    { /* i16_span */
        if ( !( value->i16_span == 0 ) )
        {
            table_writer_header_at( w, 101, 0xb655574ea23760b4ull, 3 );
    ...
    { /* i16_low */
        if ( !( value->i16_low == 0 ) )
        {
            table_writer_header_at( w, 128, 0xd217b3af8d7a2bdeull, 3 );
    ...
    { /* i16_high */
        if ( !( value->i16_high == 0 ) )
        {
            table_writer_header_at( w, 76, 0x90652f70c9127900ull, 3 );
    ...
    { /* i16_inside */
        ...
        {
            table_writer_header_at( w, 59, 0x6a659d7c354db158ull, 3 );
    ...
    { /* i32_span */
        if ( !( value->i32_span == 0 ) )
        {
            table_writer_header_at( w, 138, 0xe693bd88532c91d6ull, 4 );
    ...
    { /* i32_high */
        if ( !( value->i32_high == 0 ) )
        {
            table_writer_header_at( w, 119, 0xc9b121c4c2a186eeull, 4 );
    ...
    { /* i32_inside */
        ...
        {
            table_writer_header_at( w, 130, 0xd363dfa465acf27aull, 4 );
    ...
    { /* i64_span */
        if ( !( value->i64_span == 0 ) )
        {
            table_writer_header_at( w, 64, 0x7549c70700c49d6full, 5 );
    ...
    { /* i64_high */
        if ( !( value->i64_high == 0 ) )
        {
            table_writer_header_at( w, 37, 0x3b54fa60620b5597ull, 5 );
    ...
    { /* i64_inside */
        ...
        {
            table_writer_header_at( w, 129, 0xd308fcb98ece5d23ull, 5 );
    ...
    { /* edges */
        ...
        {
            table_writer_header_at( w, 118, 0xc70cde6b85b6197dull, 14 );
            if ( w->buffer == NULL )
            {
...
static SCHEMA_UNUSED int ranged_unsigned_save_body( TableWriter * w, const RangedUnsigned * value )
{
    ...
    { /* u8_low */
        if ( !( value->u8_low == 0 ) )
        {
            table_writer_header_at( w, 29, 0x2e17553f8200a2a1ull, 6 );
    ...
    { /* u8_high */
        if ( !( value->u8_high == 1 ) )
        {
            table_writer_header_at( w, 85, 0xa0e5c60df9301b7dull, 6 );
    ...
    { /* u16_span */
        if ( !( value->u16_span == 0 ) )
        {
            table_writer_header_at( w, 47, 0x4ca0c150b1790960ull, 7 );
    ...
    { /* u16_low */
        if ( !( value->u16_low == 0 ) )
        {
            table_writer_header_at( w, 144, 0xf252136836b04cb2ull, 7 );
    ...
    { /* u16_high */
        if ( !( value->u16_high == 1 ) )
        {
            table_writer_header_at( w, 49, 0x4f37e1f216e7610cull, 7 );
    ...
    { /* u16_inside */
        ...
        {
            table_writer_header_at( w, 126, 0xd176b605978f3304ull, 7 );
    ...
    { /* u32_low */
        if ( !( value->u32_low == 0 ) )
        {
            table_writer_header_at( w, 88, 0xa53d2f2a31b5acb0ull, 8 );
    ...
    { /* u32_high */
        if ( !( value->u32_high == 1 ) )
        {
            table_writer_header_at( w, 79, 0x9759be8ea1a4e3d2ull, 8 );
    ...
    { /* u32_inside */
        ...
        {
            table_writer_header_at( w, 75, 0x8dc515fc082e3c0eull, 8 );
    ...
    { /* u64_span */
        if ( !( value->u64_span == 0 ) )
        {
            table_writer_header_at( w, 110, 0xbeecef11dbdf8973ull, 9 );
    ...
    { /* u64_high */
        ...
        {
            table_writer_header_at( w, 145, 0xf2b45af3b50689dbull, 9 );
    ...
    { /* u64_inside */
        ...
        {
            table_writer_header_at( w, 63, 0x713e12017eebcaf7ull, 9 );
    ...
    { /* counts */
        ...
        {
            table_writer_header_at( w, 113, 0xc341febe5aae51e5ull, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
...
static SCHEMA_UNUSED int ranged_widths_save_body( TableWriter * w, const RangedWidths * value )
{
    ...
    if ( w->buffer == NULL )
    {
        ...
        if ( !( value->b16 == 0 ) )
        {
            table_writer_id_at( w, 150, 0xff95701912ad97beull );
            payload_bytes += 3; /* kind and fixed-width payload */
        }
        if ( !( value->b32 == 0 ) )
        {
            table_writer_id_at( w, 152, 0xff9c5c1912b39470ull );
            payload_bytes += 5; /* kind and fixed-width payload */
        }
        if ( !( value->b64 == 0 ) )
        {
            table_writer_id_at( w, 149, 0xff92701912ab61e7ull );
            payload_bytes += 9; /* kind and fixed-width payload */
        }
        if ( !( value->b12 == 0 ) )
        {
            table_writer_id_at( w, 151, 0xff95741912ad9e8aull );
            payload_bytes += 3; /* kind and fixed-width payload */
        }
        if ( !( value->b48 == 0 ) )
        {
            table_writer_id_at( w, 148, 0xff8b681912a535a1ull );
            payload_bytes += 9; /* kind and fixed-width payload */
        }
    ...
    { /* b16 */
        if ( !( value->b16 == 0 ) )
        {
            table_writer_header_at( w, 150, 0xff95701912ad97beull, 7 );
    ...
    { /* b32 */
        if ( !( value->b32 == 0 ) )
        {
            table_writer_header_at( w, 152, 0xff9c5c1912b39470ull, 8 );
    ...
    { /* b64 */
        if ( !( value->b64 == 0 ) )
        {
            table_writer_header_at( w, 149, 0xff92701912ab61e7ull, 9 );
    ...
    { /* b12 */
        if ( !( value->b12 == 0 ) )
        {
            table_writer_header_at( w, 151, 0xff95741912ad9e8aull, 7 );
    ...
    { /* b48 */
        if ( !( value->b48 == 0 ) )
        {
            table_writer_header_at( w, 148, 0xff8b681912a535a1ull, 9 );
...
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_size, sizeof( RangedSigned ) == 80, "RangedSigned: the fixed form's plan is laid out for this size" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i8_span, offsetof( RangedSigned, i8_span ) == 0, "RangedSigned.i8_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i8_low, offsetof( RangedSigned, i8_low ) == 1, "RangedSigned.i8_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i8_high, offsetof( RangedSigned, i8_high ) == 2, "RangedSigned.i8_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i8_inside, offsetof( RangedSigned, i8_inside ) == 3, "RangedSigned.i8_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i16_span, offsetof( RangedSigned, i16_span ) == 4, "RangedSigned.i16_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i16_low, offsetof( RangedSigned, i16_low ) == 6, "RangedSigned.i16_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i16_high, offsetof( RangedSigned, i16_high ) == 8, "RangedSigned.i16_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i16_inside, offsetof( RangedSigned, i16_inside ) == 10, "RangedSigned.i16_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i32_span, offsetof( RangedSigned, i32_span ) == 12, "RangedSigned.i32_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i32_low, offsetof( RangedSigned, i32_low ) == 16, "RangedSigned.i32_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i32_high, offsetof( RangedSigned, i32_high ) == 20, "RangedSigned.i32_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i32_inside, offsetof( RangedSigned, i32_inside ) == 24, "RangedSigned.i32_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i64_span, offsetof( RangedSigned, i64_span ) == 32, "RangedSigned.i64_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i64_low, offsetof( RangedSigned, i64_low ) == 40, "RangedSigned.i64_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i64_high, offsetof( RangedSigned, i64_high ) == 48, "RangedSigned.i64_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_i64_inside, offsetof( RangedSigned, i64_inside ) == 56, "RangedSigned.i64_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_edges, offsetof( RangedSigned, edges ) == 64, "RangedSigned.edges: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_signed_edges_count, offsetof( RangedSigned, edges_count ) == 72, "RangedSigned.edges_count: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_size, sizeof( RangedUnsigned ) == 104, "RangedUnsigned: the fixed form's plan is laid out for this size" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u8_span, offsetof( RangedUnsigned, u8_span ) == 0, "RangedUnsigned.u8_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u8_low, offsetof( RangedUnsigned, u8_low ) == 1, "RangedUnsigned.u8_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u8_high, offsetof( RangedUnsigned, u8_high ) == 2, "RangedUnsigned.u8_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u8_inside, offsetof( RangedUnsigned, u8_inside ) == 3, "RangedUnsigned.u8_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u16_span, offsetof( RangedUnsigned, u16_span ) == 4, "RangedUnsigned.u16_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u16_low, offsetof( RangedUnsigned, u16_low ) == 6, "RangedUnsigned.u16_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u16_high, offsetof( RangedUnsigned, u16_high ) == 8, "RangedUnsigned.u16_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u16_inside, offsetof( RangedUnsigned, u16_inside ) == 10, "RangedUnsigned.u16_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u32_span, offsetof( RangedUnsigned, u32_span ) == 12, "RangedUnsigned.u32_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u32_low, offsetof( RangedUnsigned, u32_low ) == 16, "RangedUnsigned.u32_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u32_high, offsetof( RangedUnsigned, u32_high ) == 20, "RangedUnsigned.u32_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u32_inside, offsetof( RangedUnsigned, u32_inside ) == 24, "RangedUnsigned.u32_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u64_span, offsetof( RangedUnsigned, u64_span ) == 32, "RangedUnsigned.u64_span: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u64_low, offsetof( RangedUnsigned, u64_low ) == 40, "RangedUnsigned.u64_low: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u64_high, offsetof( RangedUnsigned, u64_high ) == 48, "RangedUnsigned.u64_high: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_u64_inside, offsetof( RangedUnsigned, u64_inside ) == 56, "RangedUnsigned.u64_inside: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_counts, offsetof( RangedUnsigned, counts ) == 64, "RangedUnsigned.counts: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_unsigned_counts_count, offsetof( RangedUnsigned, counts_count ) == 96, "RangedUnsigned.counts_count: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_size, sizeof( RangedWidths ) == 40, "RangedWidths: the fixed form's plan is laid out for this size" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b8, offsetof( RangedWidths, b8 ) == 0, "RangedWidths.b8: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b16, offsetof( RangedWidths, b16 ) == 4, "RangedWidths.b16: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b32, offsetof( RangedWidths, b32 ) == 8, "RangedWidths.b32: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b64, offsetof( RangedWidths, b64 ) == 16, "RangedWidths.b64: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b12, offsetof( RangedWidths, b12 ) == 24, "RangedWidths.b12: the fixed form's plan lands here" );
SCHEMA_TABLE_STATIC_ASSERT( fixed_ranged_widths_b48, offsetof( RangedWidths, b48 ) == 32, "RangedWidths.b48: the fixed form's plan lands here" );

static SCHEMA_UNUSED SCHEMA_TABLEDEMO_TABLE_INLINE void schema_tabledemo_ranged_signed_fixed_write_body_( uint8_t * b, const RangedSigned * value );
static SCHEMA_UNUSED SCHEMA_TABLEDEMO_TABLE_INLINE void schema_tabledemo_ranged_unsigned_fixed_write_body_( uint8_t * b, const RangedUnsigned * value );
static SCHEMA_UNUSED SCHEMA_TABLEDEMO_TABLE_INLINE void schema_tabledemo_ranged_widths_fixed_write_body_( uint8_t * b, const RangedWidths * value );
...
{
    (void) b; (void) value;
    table_fixed_put8( b + 0, (uint8_t) value->i8_span );
    table_fixed_put8( b + 1, (uint8_t) value->i8_low );
    table_fixed_put8( b + 2, (uint8_t) value->i8_high );
    table_fixed_put8( b + 3, (uint8_t) value->i8_inside );
    table_fixed_put16( b + 4, (uint16_t) value->i16_span );
    table_fixed_put16( b + 6, (uint16_t) value->i16_low );
    table_fixed_put16( b + 8, (uint16_t) value->i16_high );
    table_fixed_put16( b + 10, (uint16_t) value->i16_inside );
    table_fixed_put32( b + 12, (uint32_t) value->i32_span );
    table_fixed_put32( b + 16, (uint32_t) value->i32_low );
    table_fixed_put32( b + 20, (uint32_t) value->i32_high );
    table_fixed_put32( b + 24, (uint32_t) value->i32_inside );
    table_fixed_put64( b + 28, (uint64_t) value->i64_span );
...
{
    (void) b; (void) value;
    table_fixed_put8( b + 0, (uint8_t) value->u8_span );
    table_fixed_put8( b + 1, (uint8_t) value->u8_low );
    table_fixed_put8( b + 2, (uint8_t) value->u8_high );
    table_fixed_put8( b + 3, (uint8_t) value->u8_inside );
    table_fixed_put16( b + 4, (uint16_t) value->u16_span );
    table_fixed_put16( b + 6, (uint16_t) value->u16_low );
    table_fixed_put16( b + 8, (uint16_t) value->u16_high );
    table_fixed_put16( b + 10, (uint16_t) value->u16_inside );
    table_fixed_put32( b + 12, (uint32_t) value->u32_span );
    table_fixed_put32( b + 16, (uint32_t) value->u32_low );
    table_fixed_put32( b + 20, (uint32_t) value->u32_high );
    table_fixed_put32( b + 24, (uint32_t) value->u32_inside );
    table_fixed_put64( b + 28, (uint64_t) value->u64_span );
...
{
    (void) b; (void) value;
    table_fixed_put32( b + 0, (uint32_t) value->b8 );
    table_fixed_put32( b + 4, (uint32_t) value->b16 );
    table_fixed_put32( b + 8, (uint32_t) value->b32 );
    table_fixed_put64( b + 12, (uint64_t) value->b64 );
    table_fixed_put32( b + 20, (uint32_t) value->b12 );
...
static SCHEMA_UNUSED const int64_t ranged_signed_fixed_body_bytes = 72;
static SCHEMA_UNUSED const int64_t ranged_signed_fixed_record_bytes = 8 + 72; /* the hash and the body */
static SCHEMA_UNUSED const uint64_t ranged_signed_fixed_hash = 0xcbf32b9992cc8183ull; /* fnv1a64 over the layout and the definitions digest (bill §13) */
...
static SCHEMA_UNUSED const uint8_t ranged_signed_fixed_layout[] = {
...
static SCHEMA_UNUSED const int64_t ranged_signed_fixed_layout_bytes = (int64_t) sizeof( ranged_signed_fixed_layout );
...
static SCHEMA_UNUSED const TableFixedDst ranged_signed_fixed_dst[] = {
    ...
    { 6, 0, 0, 0, 0 }, /* i16_low */
    { 8, 0, 0, 0, 0 }, /* i16_high */
    { 10, 0, 0, 0, 0 }, /* i16_inside */
    { 12, 0, 0, 0, 0 }, /* i32_span */
    { 16, 0, 0, 0, 0 }, /* i32_low */
    { 20, 0, 0, 0, 0 }, /* i32_high */
    { 24, 0, 0, 0, 0 }, /* i32_inside */
    { 32, 0, 0, 0, 0 }, /* i64_span */
    { 40, 0, 0, 0, 0 }, /* i64_low */
    { 48, 0, 0, 0, 0 }, /* i64_high */
    { 56, 0, 0, 0, 0 }, /* i64_inside */
    { 64, 2, 72, 1, 0 }, /* edges */
    { 0, 0, 0, 0, 0 }, /* element */
};
...
/* THE IDENTITY PLAN, coalesced out of 18 leaves by the schema compiler —
   ...
   guard at all. */
static SCHEMA_UNUSED const TableFixedEntry ranged_signed_fixed_plan[] = {
    { 0u, 0u, 28u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* i8_span */
    { 28u, 32u, 32u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* i64_span */
    { 60u, 72u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1 }, /* edges count */
    { 64u, 64u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* edges, whole */
};
static SCHEMA_UNUSED const int32_t ranged_signed_fixed_plan_count = 4;
static SCHEMA_UNUSED const int32_t ranged_signed_fixed_plan_guarded = 4;
...
static SCHEMA_UNUSED const TableFixedFill ranged_signed_fixed_cover[] = {
    { 0u, 28u },
    { 32u, 44u },
};
static SCHEMA_UNUSED const int32_t ranged_signed_fixed_cover_count = 2;
...
/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   ...
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout ranged_signed_fixed_known[] = {
    { 0xcbf32b9992cc8183ull, ranged_signed_fixed_layout, (int64_t) sizeof( ranged_signed_fixed_layout ), 80 },
};
static SCHEMA_UNUSED const int32_t ranged_signed_fixed_known_count = 1;
...
static SCHEMA_UNUSED const int32_t ranged_signed_fixed_floor = 0;
...
static SCHEMA_UNUSED int64_t ranged_signed_fixed_measure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_signed_fixed_layout ) + count * ( 8 + 72 );
}

static SCHEMA_UNUSED int64_t ranged_signed_fixed_save( const RangedSigned * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = ranged_signed_fixed_measure( count );
    uint8_t * at;
    int64_t k;
    ...
    table_fixed_put64( buffer + kTableFixedHashAt, ranged_signed_fixed_hash );
    table_fixed_put32( buffer + kTableFixedHeaderBytes, (uint32_t) sizeof( ranged_signed_fixed_layout ) );
    memcpy( buffer + kTableFixedHeaderBytes + 4, ranged_signed_fixed_layout, sizeof( ranged_signed_fixed_layout ) );
    at = buffer + kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_signed_fixed_layout );
    for ( k = 0; k < count; ++k )
    {
        table_fixed_put64( at, ranged_signed_fixed_hash );
        memset( at + 8, 0, (size_t) 72 ); /* the prefill's zeros */
        schema_tabledemo_ranged_signed_fixed_write_body_( at + 8, values + k );
        at += 8 + 72;
    }
    return need;
}
...
/* THE READ: SELECT BY HASH, NEVER PARSE A STRANGER (docs/FIXED-FORM-ALGORITHM.md
   ...
   not API). */
static SCHEMA_UNUSED int64_t ranged_signed_fixed_load( RangedSigned * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const TableFixedEntry * entries = ranged_signed_fixed_plan;
    int32_t entry_count = ranged_signed_fixed_plan_count;
    int32_t entry_guarded = ranged_signed_fixed_plan_guarded;
    ...
    pick = table_fixed_select( ranged_signed_fixed_known, ranged_signed_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < ranged_signed_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    ...
    if ( (int64_t) layout_bytes != ranged_signed_fixed_known[pick].layout_bytes ||
         memcmp( layout, ranged_signed_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    ...
    record_bytes = ranged_signed_fixed_known[pick].record_bytes;
...
/* THE BODY IS ONE CONSTANT on this form: it is the same size for every
   value the type can hold (docs/SPEC-TABLES.md §3.4). */
static SCHEMA_UNUSED const int64_t ranged_unsigned_fixed_body_bytes = 96;
static SCHEMA_UNUSED const int64_t ranged_unsigned_fixed_record_bytes = 8 + 96; /* the hash and the body */
static SCHEMA_UNUSED const uint64_t ranged_unsigned_fixed_hash = 0x8b7880ef6aaed3c0ull; /* fnv1a64 over the layout and the definitions digest (bill §13) */

/* THE LAYOUT (form 1 calls this the vocabulary block): 19 entries, a
   PRE-ORDER walk of the closure in the writer's declared order.
   Every byte is settled by the schema compiler. */
static SCHEMA_UNUSED const uint8_t ranged_unsigned_fixed_layout[] = {
...
static SCHEMA_UNUSED const int64_t ranged_unsigned_fixed_layout_bytes = (int64_t) sizeof( ranged_unsigned_fixed_layout );

/* MY SIDE of the layout, one row per entry: the storage facts a layout
   entry cannot carry, which is what a plan compiled from another writer's
   layout lands values through. */
static SCHEMA_UNUSED const TableFixedDst ranged_unsigned_fixed_dst[] = {
    ...
    { 6, 0, 0, 0, 0 }, /* u16_low */
    { 8, 0, 0, 0, 0 }, /* u16_high */
    { 10, 0, 0, 0, 0 }, /* u16_inside */
    { 12, 0, 0, 0, 0 }, /* u32_span */
    { 16, 0, 0, 0, 0 }, /* u32_low */
    { 20, 0, 0, 0, 0 }, /* u32_high */
    { 24, 0, 0, 0, 0 }, /* u32_inside */
    { 32, 0, 0, 0, 0 }, /* u64_span */
    { 40, 0, 0, 0, 0 }, /* u64_low */
    { 48, 0, 0, 0, 0 }, /* u64_high */
    { 56, 0, 0, 0, 0 }, /* u64_inside */
    { 64, 8, 96, 1, 0 }, /* counts */
    { 0, 0, 0, 0, 0 }, /* element */
};
...
/* THE IDENTITY PLAN, coalesced out of 18 leaves by the schema compiler —
   ...
   then the arms: the entries that are nearly all of a plan never test a
   guard at all. */
static SCHEMA_UNUSED const TableFixedEntry ranged_unsigned_fixed_plan[] = {
    { 0u, 0u, 28u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* u8_span */
    { 28u, 32u, 32u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* u64_span */
    { 60u, 96u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1 }, /* counts count */
    { 64u, 64u, 32u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* counts, whole */
};
static SCHEMA_UNUSED const int32_t ranged_unsigned_fixed_plan_count = 4;
static SCHEMA_UNUSED const int32_t ranged_unsigned_fixed_plan_guarded = 4;
...
/* THE TYPE'S VALUE BYTES: every byte of this build's own storage that holds
   ...
   twice; a plan compiled from a stranger's layout subtracts itself from it
   once, when the plan is compiled, and prefills exactly the rest. */
static SCHEMA_UNUSED const TableFixedFill ranged_unsigned_fixed_cover[] = {
    { 0u, 28u },
    { 32u, 68u },
};
static SCHEMA_UNUSED const int32_t ranged_unsigned_fixed_cover_count = 2;

/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   A FILE IS MATCHED ON IS THE HASH; the layout bytes are what a known hash
   is held to by memcmp, and the record size is taken from here and NEVER
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout ranged_unsigned_fixed_known[] = {
    { 0x8b7880ef6aaed3c0ull, ranged_unsigned_fixed_layout, (int64_t) sizeof( ranged_unsigned_fixed_layout ), 104 },
};
static SCHEMA_UNUSED const int32_t ranged_unsigned_fixed_known_count = 1;
/* THE FLOOR IS ONE NUMBER AND THE LINEAGE IS ONE ARRAY, so "retired" is an
   index cut and the operator's two answers stay distinct: below the floor is
   layout_unsupported (upgrade the client), outside the lineage is
   layout_newer (ship the reader). A retired entry stays forever (§5.2). */
static SCHEMA_UNUSED const int32_t ranged_unsigned_fixed_floor = 0;

/* A FILE: THE HEADER (docs/SPEC-TABLES.md §3, one rule for all five forms)
   — form byte, seven reserved zero bytes, the LAYOUT HASH at 8, body at 16 —
   then the layout behind its u32 length, then the records to the end of it. */
static SCHEMA_UNUSED int64_t ranged_unsigned_fixed_measure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_unsigned_fixed_layout ) + count * ( 8 + 96 );
}

static SCHEMA_UNUSED int64_t ranged_unsigned_fixed_save( const RangedUnsigned * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = ranged_unsigned_fixed_measure( count );
    uint8_t * at;
    int64_t k;
    if ( count < 0 || values == NULL || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); /* the seven reserved bytes, and the rest of the header */
    buffer[0] = kTableFixedForm;
    table_fixed_put64( buffer + kTableFixedHashAt, ranged_unsigned_fixed_hash );
    table_fixed_put32( buffer + kTableFixedHeaderBytes, (uint32_t) sizeof( ranged_unsigned_fixed_layout ) );
    memcpy( buffer + kTableFixedHeaderBytes + 4, ranged_unsigned_fixed_layout, sizeof( ranged_unsigned_fixed_layout ) );
    at = buffer + kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_unsigned_fixed_layout );
    for ( k = 0; k < count; ++k )
    {
        table_fixed_put64( at, ranged_unsigned_fixed_hash );
        memset( at + 8, 0, (size_t) 96 ); /* the prefill's zeros */
        schema_tabledemo_ranged_unsigned_fixed_write_body_( at + 8, values + k );
        at += 8 + 96;
    }
    return need;
}
...
/* THE READ: SELECT BY HASH, NEVER PARSE A STRANGER (docs/FIXED-FORM-ALGORITHM.md
   ...
   test/c-tables and the paired bench still compiles (§5.6 retires mechanisms,
   not API). */
static SCHEMA_UNUSED int64_t ranged_unsigned_fixed_load( RangedUnsigned * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    TableReport local;
    uint32_t layout_bytes;
    ...
    int32_t census_unknown = 0;
    int32_t census_kind = 0;
    const TableFixedEntry * entries = ranged_unsigned_fixed_plan;
    int32_t entry_count = ranged_unsigned_fixed_plan_count;
    int32_t entry_guarded = ranged_unsigned_fixed_plan_guarded;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    ...
    hash = table_fixed_get64( data + kTableFixedHashAt );
    /* 5 and 6. SELECT BY HASH, THEN THE FLOOR. Both report THE FILE'S hash. */
    pick = table_fixed_select( ranged_unsigned_fixed_known, ranged_unsigned_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < ranged_unsigned_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    /* 7. A KNOWN HASH IS READ UNDER THE LOCK'S LAYOUT BYTES. A difference is ONE
       name — a lie about a known version — and §1.1's seven rules do not run at
       read time at all: no stranger's layout is ever walked. */
    if ( (int64_t) layout_bytes != ranged_unsigned_fixed_known[pick].layout_bytes ||
         memcmp( layout, ranged_unsigned_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    { report->refused = 1; report->reason = SCHEMA_TABLE_LAYOUT_MALFORMED; return -1; }
    /* 8. the plan this peer resolves to, and the record size FROM THE LOCK. */
    record_bytes = ranged_unsigned_fixed_known[pick].record_bytes;
    /* 9 and 10. the tail must be whole records, and they must fit the caller. */
    at = layout + layout_bytes;
    rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    if ( record_bytes <= 8 || rest % record_bytes != 0 ) { report->malformed = 1; return -1; }
    ...
    {
        memset( (void *) &defaults, 0, sizeof( defaults ) ); /* padding included, so the prefill is deterministic */
        ranged_unsigned_reset( &defaults );
    }
    for ( k = 0; k < count; ++k )
    {
        if ( table_fixed_get64( at ) != hash ) { report->refused = 1; report->reason = SCHEMA_TABLE_NO_LAYOUT; return -1; }
...
/* THE BODY IS ONE CONSTANT on this form: it is the same size for every
   value the type can hold (docs/SPEC-TABLES.md §3.4). */
static SCHEMA_UNUSED const int64_t ranged_widths_fixed_body_bytes = 32;
static SCHEMA_UNUSED const int64_t ranged_widths_fixed_record_bytes = 8 + 32; /* the hash and the body */
static SCHEMA_UNUSED const uint64_t ranged_widths_fixed_hash = 0xe45869be02e1f158ull; /* fnv1a64 over the layout and the definitions digest (bill §13) */

/* THE LAYOUT (form 1 calls this the vocabulary block): 7 entries, a
   PRE-ORDER walk of the closure in the writer's declared order.
   Every byte is settled by the schema compiler. */
static SCHEMA_UNUSED const uint8_t ranged_widths_fixed_layout[] = {
...
static SCHEMA_UNUSED const int64_t ranged_widths_fixed_layout_bytes = (int64_t) sizeof( ranged_widths_fixed_layout );

/* MY SIDE of the layout, one row per entry: the storage facts a layout
   entry cannot carry, which is what a plan compiled from another writer's
   layout lands values through. */
static SCHEMA_UNUSED const TableFixedDst ranged_widths_fixed_dst[] = {
...
/* THE IDENTITY PLAN, coalesced out of 6 leaves by the schema compiler —
   ...
   then the arms: the entries that are nearly all of a plan never test a
   guard at all. */
static SCHEMA_UNUSED const TableFixedEntry ranged_widths_fixed_plan[] = {
    { 0u, 0u, 12u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* b8 */
    { 12u, 16u, 12u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* b64 */
    { 24u, 32u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* b48 */
};
static SCHEMA_UNUSED const int32_t ranged_widths_fixed_plan_count = 3;
static SCHEMA_UNUSED const int32_t ranged_widths_fixed_plan_guarded = 3;
...
/* THE TYPE'S VALUE BYTES: every byte of this build's own storage that holds
   ...
   twice; a plan compiled from a stranger's layout subtracts itself from it
   once, when the plan is compiled, and prefills exactly the rest. */
static SCHEMA_UNUSED const TableFixedFill ranged_widths_fixed_cover[] = {
    { 0u, 12u },
    { 16u, 12u },
    { 32u, 8u },
};
static SCHEMA_UNUSED const int32_t ranged_widths_fixed_cover_count = 3;

/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   A FILE IS MATCHED ON IS THE HASH; the layout bytes are what a known hash
   is held to by memcmp, and the record size is taken from here and NEVER
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout ranged_widths_fixed_known[] = {
    { 0xe45869be02e1f158ull, ranged_widths_fixed_layout, (int64_t) sizeof( ranged_widths_fixed_layout ), 40 },
};
static SCHEMA_UNUSED const int32_t ranged_widths_fixed_known_count = 1;
/* THE FLOOR IS ONE NUMBER AND THE LINEAGE IS ONE ARRAY, so "retired" is an
   index cut and the operator's two answers stay distinct: below the floor is
   layout_unsupported (upgrade the client), outside the lineage is
   layout_newer (ship the reader). A retired entry stays forever (§5.2). */
static SCHEMA_UNUSED const int32_t ranged_widths_fixed_floor = 0;

/* A FILE: THE HEADER (docs/SPEC-TABLES.md §3, one rule for all five forms)
   — form byte, seven reserved zero bytes, the LAYOUT HASH at 8, body at 16 —
   then the layout behind its u32 length, then the records to the end of it. */
static SCHEMA_UNUSED int64_t ranged_widths_fixed_measure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_widths_fixed_layout ) + count * ( 8 + 32 );
}

static SCHEMA_UNUSED int64_t ranged_widths_fixed_save( const RangedWidths * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = ranged_widths_fixed_measure( count );
    uint8_t * at;
    int64_t k;
    if ( count < 0 || values == NULL || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); /* the seven reserved bytes, and the rest of the header */
    buffer[0] = kTableFixedForm;
    table_fixed_put64( buffer + kTableFixedHashAt, ranged_widths_fixed_hash );
    table_fixed_put32( buffer + kTableFixedHeaderBytes, (uint32_t) sizeof( ranged_widths_fixed_layout ) );
    memcpy( buffer + kTableFixedHeaderBytes + 4, ranged_widths_fixed_layout, sizeof( ranged_widths_fixed_layout ) );
    at = buffer + kTableFixedHeaderBytes + 4 + (int64_t) sizeof( ranged_widths_fixed_layout );
    for ( k = 0; k < count; ++k )
    {
        table_fixed_put64( at, ranged_widths_fixed_hash );
        memset( at + 8, 0, (size_t) 32 ); /* the prefill's zeros */
        schema_tabledemo_ranged_widths_fixed_write_body_( at + 8, values + k );
        at += 8 + 32;
    }
    return need;
}
...
/* THE READ: SELECT BY HASH, NEVER PARSE A STRANGER (docs/FIXED-FORM-ALGORITHM.md
   ...
   test/c-tables and the paired bench still compiles (§5.6 retires mechanisms,
   not API). */
static SCHEMA_UNUSED int64_t ranged_widths_fixed_load( RangedWidths * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    TableReport local;
    uint32_t layout_bytes;
    ...
    int32_t census_unknown = 0;
    int32_t census_kind = 0;
    const TableFixedEntry * entries = ranged_widths_fixed_plan;
    int32_t entry_count = ranged_widths_fixed_plan_count;
    int32_t entry_guarded = ranged_widths_fixed_plan_guarded;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    ...
    hash = table_fixed_get64( data + kTableFixedHashAt );
    /* 5 and 6. SELECT BY HASH, THEN THE FLOOR. Both report THE FILE'S hash. */
    pick = table_fixed_select( ranged_widths_fixed_known, ranged_widths_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < ranged_widths_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    /* 7. A KNOWN HASH IS READ UNDER THE LOCK'S LAYOUT BYTES. A difference is ONE
       name — a lie about a known version — and §1.1's seven rules do not run at
       read time at all: no stranger's layout is ever walked. */
    if ( (int64_t) layout_bytes != ranged_widths_fixed_known[pick].layout_bytes ||
         memcmp( layout, ranged_widths_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    { report->refused = 1; report->reason = SCHEMA_TABLE_LAYOUT_MALFORMED; return -1; }
    /* 8. the plan this peer resolves to, and the record size FROM THE LOCK. */
    record_bytes = ranged_widths_fixed_known[pick].record_bytes;
    /* 9 and 10. the tail must be whole records, and they must fit the caller. */
    at = layout + layout_bytes;
    rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    if ( record_bytes <= 8 || rest % record_bytes != 0 ) { report->malformed = 1; return -1; }
...
static SCHEMA_UNUSED int ranged_signed_save_body_retain(TableWriter *,const RangedSigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_signed_load_body_retain(TableReader *,RangedSigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_unsigned_save_body_retain(TableWriter *,const RangedUnsigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_unsigned_load_body_retain(TableReader *,RangedUnsigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_widths_save_body_retain(TableWriter *,const RangedWidths *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_widths_load_body_retain(TableReader *,RangedWidths *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_signed_load_message_body_retain(TableMessageReader *,RangedSigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_unsigned_load_message_body_retain(TableMessageReader *,RangedUnsigned *, TableRetainWalk retention);
static SCHEMA_UNUSED int ranged_widths_load_message_body_retain(TableMessageReader *,RangedWidths *, TableRetainWalk retention);
static SCHEMA_UNUSED int schema_tabledemo_ranged_signed_wire_edges__retain( TableWriter * w, const RangedSigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    table_writer_leb( w, (uint64_t) value->edges_count );
    for ( i = 0; i < value->edges_count; i++ )
    {
        table_writer_put16( w, (uint16_t) ( value->edges[i] ) );
    }
...
static SCHEMA_UNUSED int ranged_signed_save_body_retain( TableWriter * w, const RangedSigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,0,0);
        if ( !( value->i8_span == 0 ) )
        {
            table_retain_writer_id( w, 0x48121511bf702eb5ull , retention);
    ...
    retention=table_retain_step(body_keep,1,0);
        if ( !( value->i8_low == 0 ) )
        {
            table_retain_writer_id( w, 0x942bfe3168090f7dull , retention);
            table_writer_put8( w, 2 );
            table_writer_put8( w, (uint8_t) ( value->i8_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,2,0);
        if ( !( value->i8_high == 0 ) )
        {
            table_retain_writer_id( w, 0xd182acd105b55dd1ull , retention);
            table_writer_put8( w, 2 );
            table_writer_put8( w, (uint8_t) ( value->i8_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,3,0);
        if ( !( value->i8_inside == 0 ) )
        {
            table_retain_writer_id( w, 0xef9ded23c8912a81ull , retention);
            table_writer_put8( w, 2 );
            table_writer_put8( w, (uint8_t) ( value->i8_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,4,0);
        if ( !( value->i16_span == 0 ) )
        {
            table_retain_writer_id( w, 0xb655574ea23760b4ull , retention);
            table_writer_put8( w, 3 );
            table_writer_put16( w, (uint16_t) ( value->i16_span ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,5,0);
        if ( !( value->i16_low == 0 ) )
        {
            table_retain_writer_id( w, 0xd217b3af8d7a2bdeull , retention);
            table_writer_put8( w, 3 );
            table_writer_put16( w, (uint16_t) ( value->i16_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,6,0);
        if ( !( value->i16_high == 0 ) )
        {
            table_retain_writer_id( w, 0x90652f70c9127900ull , retention);
            table_writer_put8( w, 3 );
            table_writer_put16( w, (uint16_t) ( value->i16_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,7,0);
        if ( !( value->i16_inside == 0 ) )
        {
            table_retain_writer_id( w, 0x6a659d7c354db158ull , retention);
            table_writer_put8( w, 3 );
            table_writer_put16( w, (uint16_t) ( value->i16_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,8,0);
        if ( !( value->i32_span == 0 ) )
        {
            table_retain_writer_id( w, 0xe693bd88532c91d6ull , retention);
    ...
    retention=table_retain_step(body_keep,9,0);
        if ( !( value->i32_low == 0 ) )
        {
            table_retain_writer_id( w, 0x065ee827cf99fbb4ull , retention);
            table_writer_put8( w, 4 );
            table_writer_put32( w, (uint32_t) ( value->i32_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,10,0);
        if ( !( value->i32_high == 0 ) )
        {
            table_retain_writer_id( w, 0xc9b121c4c2a186eeull , retention);
            table_writer_put8( w, 4 );
            table_writer_put32( w, (uint32_t) ( value->i32_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,11,0);
        if ( !( value->i32_inside == 0 ) )
        {
            table_retain_writer_id( w, 0xd363dfa465acf27aull , retention);
            table_writer_put8( w, 4 );
            table_writer_put32( w, (uint32_t) ( value->i32_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,12,0);
        if ( !( value->i64_span == 0 ) )
        {
            table_retain_writer_id( w, 0x7549c70700c49d6full , retention);
    ...
    retention=table_retain_step(body_keep,13,0);
        if ( !( value->i64_low == 0 ) )
        {
            table_retain_writer_id( w, 0x1cce6617419771dbull , retention);
            table_writer_put8( w, 5 );
            table_writer_put64( w, (uint64_t) ( value->i64_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,14,0);
        if ( !( value->i64_high == 0 ) )
        {
            table_retain_writer_id( w, 0x3b54fa60620b5597ull , retention);
            table_writer_put8( w, 5 );
            table_writer_put64( w, (uint64_t) ( value->i64_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,15,0);
        if ( !( value->i64_inside == 0 ) )
        {
            table_retain_writer_id( w, 0xd308fcb98ece5d23ull , retention);
            table_writer_put8( w, 5 );
            table_writer_put64( w, (uint64_t) ( value->i64_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,16,0);
        ...
        if ( value->edges_count > 0 )
        {
            table_retain_writer_id( w, 0xc70cde6b85b6197dull , retention);
            table_writer_put8( w, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_ranged_signed_wire_edges__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                ...
                if ( !schema_tabledemo_ranged_signed_wire_edges__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_ranged_signed_wire_edges__retain( w, value , retention) ) { return 0;
...
static SCHEMA_UNUSED int ranged_signed_load_body_retain( TableReader * r, RangedSigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
            ...
            case 0x942bfe3168090f7dull: /* i8_low */
            {
                ...
                {
                    int8_t decoded_v = (int8_t) table_reader_get8( &(*r) );
                    if ( decoded_v > 126 ) { decoded_v = 126;
                    r->report->clamped++;
                    }
                    value->i8_low = decoded_v;
                }
            ...
            case 0xd182acd105b55dd1ull: /* i8_high */
            {
                ...
                {
                    int8_t decoded_v = (int8_t) table_reader_get8( &(*r) );
                    if ( decoded_v < -127 ) { decoded_v = -127;
                    r->report->clamped++;
                    }
                    value->i8_high = decoded_v;
                }
            ...
            case 0xef9ded23c8912a81ull: /* i8_inside */
            {
                ...
                }
                {
                    ...
                    else if ( decoded_v > 126 ) { decoded_v = 126;
                    r->report->clamped++;
                    }
                    value->i8_inside = decoded_v;
                }
                    ...
                    if ( table_kind_widens( kind, 3 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                int64_t decoded_wide = (int8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide < -32768ll ) { decoded_wide = -32768ll;
                                r->report->clamped++;
                                }
                                if ( decoded_wide > 32767ll ) { decoded_wide = 32767ll;
                                r->report->clamped++;
                                }
                                value->i16_span = decoded_wide;
                                break;
                    ...
                    if ( table_kind_widens( kind, 3 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                if ( decoded_wide > 32766ll ) { decoded_wide = 32766ll;
                                r->report->clamped++;
                                }
                                value->i16_low = decoded_wide;
                                break;
                            ...
                            case 3:
                            {
                                ...
                                {
                                    int16_t decoded_v = (int16_t) table_reader_get16( &(*r) );
                                    if ( decoded_v > 32766 ) { decoded_v = 32766;
                                    r->report->clamped++;
                                    }
                                    value->i16_low = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 3 ) )
                    {
                        switch ( kind )
                        {
                            ...
                            case 3:
                            {
                                ...
                                {
                                    int16_t decoded_v = (int16_t) table_reader_get16( &(*r) );
                                    if ( decoded_v < -32767 ) { decoded_v = -32767;
                                    r->report->clamped++;
                                    }
                                    value->i16_high = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 3:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 32766 ) { decoded_v = 32766;
                                    r->report->clamped++;
                                    }
                                    value->i16_inside = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 4 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                int64_t decoded_wide = (int8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide < -2147483648ll ) { decoded_wide = -2147483648ll;
                                r->report->clamped++;
                                }
                                if ( decoded_wide > 2147483647ll ) { decoded_wide = 2147483647ll;
                                r->report->clamped++;
                                }
                                value->i32_span = decoded_wide;
                                break;
                    ...
                    if ( table_kind_widens( kind, 4 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                if ( decoded_wide > 2147483646ll ) { decoded_wide = 2147483646ll;
                                r->report->clamped++;
                                }
                                value->i32_low = decoded_wide;
                                break;
                            ...
                            case 4:
                            {
                                ...
                                {
                                    int32_t decoded_v = (int32_t) table_reader_get32( &(*r) );
                                    if ( decoded_v > 2147483646 ) { decoded_v = 2147483646;
                                    r->report->clamped++;
                                    }
                                    value->i32_low = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 4 ) )
                    {
                        switch ( kind )
                        {
                            ...
                            case 4:
                            {
                                ...
                                {
                                    int32_t decoded_v = (int32_t) table_reader_get32( &(*r) );
                                    if ( decoded_v < -2147483647 ) { decoded_v = -2147483647;
                                    r->report->clamped++;
                                    }
                                    value->i32_high = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 4:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 2147483646 ) { decoded_v = 2147483646;
                                    r->report->clamped++;
                                    }
                                    value->i32_inside = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 5 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                int64_t decoded_wide = (int8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide > 9223372036854775806ll ) { decoded_wide = 9223372036854775806ll;
                                r->report->clamped++;
                                }
                                value->i64_low = decoded_wide;
                                break;
                            ...
                            case 5:
                            {
                                ...
                                {
                                    int64_t decoded_v = (int64_t) table_reader_get64( &(*r) );
                                    if ( decoded_v > 9223372036854775806ll ) { decoded_v = 9223372036854775806ll;
                                    r->report->clamped++;
                                    }
                                    value->i64_low = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 5 ) )
                    {
                        switch ( kind )
                        {
                            case 2:
                            {
                                ...
                                int64_t decoded_wide = (int8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide < -9223372036854775807ll ) { decoded_wide = -9223372036854775807ll;
                                r->report->clamped++;
                                }
                                value->i64_high = decoded_wide;
                                break;
                            ...
                            case 5:
                            {
                                ...
                                {
                                    int64_t decoded_v = (int64_t) table_reader_get64( &(*r) );
                                    if ( decoded_v < -9223372036854775807ll ) { decoded_v = -9223372036854775807ll;
                                    r->report->clamped++;
                                    }
                                    value->i64_high = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 5:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 9223372036854775806ll ) { decoded_v = 9223372036854775806ll;
                                    r->report->clamped++;
                                    }
                                    value->i64_inside = decoded_v;
                                }
            ...
            case 0xc70cde6b85b6197dull: /* edges */
            {
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    else
                    {
                        if ( elem_kind != 3 )
                        {
                            if ( !(table_kind_widens(elem_kind,3)) ) { r->report->kind_mismatch++;
                            break;
                            }
                            r->report->widened++;
                        }
                        ...
                        end_edges: ;
                        { uint32_t tail;
                        for (tail=(uint32_t)value->edges_count;tail<(uint32_t)previous_count && tail<4;tail++) {
                         memset(&value->edges[tail],0,sizeof(value->edges[tail]));
                        } }
                    }
                }
...
static SCHEMA_UNUSED int ranged_signed_load_message_body_retain(TableMessageReader * r,RangedSigned * value, TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_ranged_unsigned_wire_counts__retain( TableWriter * w, const RangedUnsigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    table_writer_leb( w, (uint64_t) value->counts_count );
    for ( i = 0; i < value->counts_count; i++ )
    {
        table_writer_put64( w, (uint64_t) ( value->counts[i] ) );
    }
...
static SCHEMA_UNUSED int ranged_unsigned_save_body_retain( TableWriter * w, const RangedUnsigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,0,0);
        if ( !( value->u8_span == 0 ) )
        {
            table_retain_writer_id( w, 0x0f8897557f37c021ull , retention);
    ...
    retention=table_retain_step(body_keep,1,0);
        if ( !( value->u8_low == 0 ) )
        {
            table_retain_writer_id( w, 0x2e17553f8200a2a1ull , retention);
            table_writer_put8( w, 6 );
            table_writer_put8( w, (uint8_t) ( value->u8_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,2,0);
        if ( !( value->u8_high == 1 ) )
        {
            table_retain_writer_id( w, 0xa0e5c60df9301b7dull , retention);
            table_writer_put8( w, 6 );
            table_writer_put8( w, (uint8_t) ( value->u8_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,3,0);
        if ( !( value->u8_inside == 1 ) )
        {
            table_retain_writer_id( w, 0x1cb2c073a6f5844dull , retention);
            table_writer_put8( w, 6 );
            table_writer_put8( w, (uint8_t) ( value->u8_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,4,0);
        if ( !( value->u16_span == 0 ) )
        {
            table_retain_writer_id( w, 0x4ca0c150b1790960ull , retention);
    ...
    retention=table_retain_step(body_keep,5,0);
        if ( !( value->u16_low == 0 ) )
        {
            table_retain_writer_id( w, 0xf252136836b04cb2ull , retention);
            table_writer_put8( w, 7 );
            table_writer_put16( w, (uint16_t) ( value->u16_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,6,0);
        if ( !( value->u16_high == 1 ) )
        {
            table_retain_writer_id( w, 0x4f37e1f216e7610cull , retention);
            table_writer_put8( w, 7 );
            table_writer_put16( w, (uint16_t) ( value->u16_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,7,0);
        if ( !( value->u16_inside == 1 ) )
        {
            table_retain_writer_id( w, 0xd176b605978f3304ull , retention);
            table_writer_put8( w, 7 );
            table_writer_put16( w, (uint16_t) ( value->u16_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,8,0);
        if ( !( value->u32_span == 0 ) )
        {
            table_retain_writer_id( w, 0x200b924de7479cdaull , retention);
    ...
    retention=table_retain_step(body_keep,9,0);
        if ( !( value->u32_low == 0 ) )
        {
            table_retain_writer_id( w, 0xa53d2f2a31b5acb0ull , retention);
            table_writer_put8( w, 8 );
            table_writer_put32( w, (uint32_t) ( value->u32_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,10,0);
        if ( !( value->u32_high == 1 ) )
        {
            table_retain_writer_id( w, 0x9759be8ea1a4e3d2ull , retention);
            table_writer_put8( w, 8 );
            table_writer_put32( w, (uint32_t) ( value->u32_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,11,0);
        if ( !( value->u32_inside == 1 ) )
        {
            table_retain_writer_id( w, 0x8dc515fc082e3c0eull , retention);
            table_writer_put8( w, 8 );
            table_writer_put32( w, (uint32_t) ( value->u32_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,12,0);
        if ( !( value->u64_span == 0 ) )
        {
            table_retain_writer_id( w, 0xbeecef11dbdf8973ull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->u64_span ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,13,0);
        if ( !( value->u64_low == 0 ) )
        {
            table_retain_writer_id( w, 0x0117ad66e0fff227ull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->u64_low ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,14,0);
        if ( !( value->u64_high == 1ull ) )
        {
            table_retain_writer_id( w, 0xf2b45af3b50689dbull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->u64_high ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,15,0);
        if ( !( value->u64_inside == 1ull ) )
        {
            table_retain_writer_id( w, 0x713e12017eebcaf7ull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->u64_inside ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,16,0);
        ...
        if ( value->counts_count > 0 )
        {
            table_retain_writer_id( w, 0xc341febe5aae51e5ull , retention);
            table_writer_put8( w, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_ranged_unsigned_wire_counts__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_ranged_unsigned_wire_counts__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_ranged_unsigned_wire_counts__retain( w, value , retention) ) { return 0;
...
static SCHEMA_UNUSED int ranged_unsigned_load_body_retain( TableReader * r, RangedUnsigned * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
            ...
            case 0x2e17553f8200a2a1ull: /* u8_low */
            {
                ...
                {
                    uint8_t decoded_v = (uint8_t) table_reader_get8( &(*r) );
                    if ( decoded_v > 254 ) { decoded_v = 254;
                    r->report->clamped++;
                    }
                    value->u8_low = decoded_v;
                }
            ...
            case 0x1cb2c073a6f5844dull: /* u8_inside */
            {
                ...
                }
                {
                    ...
                    else if ( decoded_v > 254 ) { decoded_v = 254;
                    r->report->clamped++;
                    }
                    value->u8_inside = decoded_v;
                }
                    ...
                    if ( table_kind_widens( kind, 7 ) )
                    {
                        switch ( kind )
                        {
                            case 6:
                            {
                                ...
                                uint64_t decoded_wide = (uint8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide > 65534ull ) { decoded_wide = 65534ull;
                                r->report->clamped++;
                                }
                                value->u16_low = decoded_wide;
                                break;
                            ...
                            case 7:
                            {
                                ...
                                {
                                    uint16_t decoded_v = (uint16_t) table_reader_get16( &(*r) );
                                    if ( decoded_v > 65534 ) { decoded_v = 65534;
                                    r->report->clamped++;
                                    }
                                    value->u16_low = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 7:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 65534 ) { decoded_v = 65534;
                                    r->report->clamped++;
                                    }
                                    value->u16_inside = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 8 ) )
                    {
                        switch ( kind )
                        {
                            case 6:
                            {
                                ...
                                uint64_t decoded_wide = (uint8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide > 4294967294ull ) { decoded_wide = 4294967294ull;
                                r->report->clamped++;
                                }
                                value->u32_low = decoded_wide;
                                break;
                            ...
                            case 8:
                            {
                                ...
                                {
                                    uint32_t decoded_v = (uint32_t) table_reader_get32( &(*r) );
                                    if ( decoded_v > 4294967294 ) { decoded_v = 4294967294;
                                    r->report->clamped++;
                                    }
                                    value->u32_low = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 8:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 4294967294 ) { decoded_v = 4294967294;
                                    r->report->clamped++;
                                    }
                                    value->u32_inside = decoded_v;
                                }
                    ...
                    if ( table_kind_widens( kind, 9 ) )
                    {
                        switch ( kind )
                        {
                            case 6:
                            {
                                ...
                                uint64_t decoded_wide = (uint8_t) table_reader_get8( &(*r) );
                                if ( decoded_wide > 18446744073709551614ull ) { decoded_wide = 18446744073709551614ull;
                                r->report->clamped++;
                                }
                                value->u64_low = decoded_wide;
                                break;
                            ...
                            case 9:
                            {
                                ...
                                {
                                    uint64_t decoded_v = (uint64_t) table_reader_get64( &(*r) );
                                    if ( decoded_v > 18446744073709551614ull ) { decoded_v = 18446744073709551614ull;
                                    r->report->clamped++;
                                    }
                                    value->u64_low = decoded_v;
                                }
                        ...
                        switch ( kind )
                        {
                            ...
                            case 9:
                            {
                                ...
                                }
                                {
                                    ...
                                    else if ( decoded_v > 18446744073709551614ull ) { decoded_v = 18446744073709551614ull;
                                    r->report->clamped++;
                                    }
                                    value->u64_inside = decoded_v;
                                }
            ...
            case 0xc341febe5aae51e5ull: /* counts */
            {
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    else
                    {
                        if ( elem_kind != 9 )
                        {
                            if ( !(table_kind_widens(elem_kind,9)) ) { r->report->kind_mismatch++;
                            break;
                            }
                            r->report->widened++;
                        }
                        ...
                        for ( i = 0; i < kept; i++ )
                        {
                            switch ( elem_kind )
                            {
                                ...
                                case 9:
                                {
                                    if ( !table_reader_has( &sub, 8 ) ) { r->report->malformed = 1;
                                    goto end_counts;
                                    }
                                    {
                                        uint64_t decoded_v = (uint64_t) table_reader_get64( &sub );
                        ...
                        end_counts: ;
                        { uint32_t tail;
                        for (tail=(uint32_t)value->counts_count;tail<(uint32_t)previous_count && tail<4;tail++) {
                         memset(&value->counts[tail],0,sizeof(value->counts[tail]));
                        } }
                    }
                }
...
static SCHEMA_UNUSED int ranged_unsigned_load_message_body_retain(TableMessageReader * r,RangedUnsigned * value, TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int ranged_widths_save_body_retain( TableWriter * w, const RangedWidths * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,0,0);
        if ( !( value->b8 == 0 ) )
        {
            table_retain_writer_id( w, 0x08a60c07b54d8dc7ull , retention);
            table_writer_put8( w, 6 );
            table_writer_put8( w, (uint8_t) ( value->b8 ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,1,0);
        if ( !( value->b16 == 0 ) )
        {
            table_retain_writer_id( w, 0xff95701912ad97beull , retention);
            table_writer_put8( w, 7 );
            table_writer_put16( w, (uint16_t) ( value->b16 ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,2,0);
        if ( !( value->b32 == 0 ) )
        {
            table_retain_writer_id( w, 0xff9c5c1912b39470ull , retention);
            table_writer_put8( w, 8 );
            table_writer_put32( w, (uint32_t) ( value->b32 ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,3,0);
        if ( !( value->b64 == 0 ) )
        {
            table_retain_writer_id( w, 0xff92701912ab61e7ull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->b64 ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,4,0);
        if ( !( value->b12 == 0 ) )
        {
            table_retain_writer_id( w, 0xff95741912ad9e8aull , retention);
            table_writer_put8( w, 7 );
            table_writer_put16( w, (uint16_t) ( value->b12 ) );
        }
    }
    ...
    retention=table_retain_step(body_keep,5,0);
        if ( !( value->b48 == 0 ) )
        {
            table_retain_writer_id( w, 0xff8b681912a535a1ull , retention);
            table_writer_put8( w, 9 );
            table_writer_put64( w, (uint64_t) ( value->b48 ) );
        }
    }
...
static SCHEMA_UNUSED int ranged_widths_load_body_retain( TableReader * r, RangedWidths * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int ranged_widths_load_message_body_retain(TableMessageReader * r,RangedWidths * value, TableRetainWalk retention)
{
    (void)retention;
...
#define ranged_signed_load_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_signed_measure_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_signed_save_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_signed_load_retain_messages(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retained fields have no announced slots: save the VARIABLE form or relay the original message. */
#define ranged_signed_save_retain_messages(...) ((void)sizeof(struct { int retention_message_write_requires_file_form : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_unsigned_load_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_unsigned_measure_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_unsigned_save_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_unsigned_load_retain_messages(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retained fields have no announced slots: save the VARIABLE form or relay the original message. */
#define ranged_unsigned_save_retain_messages(...) ((void)sizeof(struct { int retention_message_write_requires_file_form : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_widths_load_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_widths_measure_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_widths_save_retain(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retention requires a variable root loaded into a region (SPEC-TABLES section 6.6). */
#define ranged_widths_load_retain_messages(...) ((void)sizeof(struct { int retention_requires_variable_region_root : -1; }))
/* Retained fields have no announced slots: save the VARIABLE form or relay the original message. */
#define ranged_widths_save_retain_messages(...) ((void)sizeof(struct { int retention_message_write_requires_file_form : -1; }))
...
/* ranged_signed_open: match the header and POINT. On a match the bytes ARE what this
   ...
   parameter on a load. */
static SCHEMA_UNUSED const RangedSigned * ranged_signed_open_ex(const void * bytes,uint64_t length,TableRefuseReason * reason)
{ return (const RangedSigned *)table_cook_open_ex(bytes,length,sizeof(RangedSigned),SCHEMA_TABLE_ALIGNOF(RangedSigned),reason); }
...
/* ranged_unsigned_open: match the header and POINT. On a match the bytes ARE what this
   ...
   the ATTRIBUTION part beside the data — a person's decision, never a
   parameter on a load. */
static SCHEMA_UNUSED const RangedUnsigned * ranged_unsigned_open_ex(const void * bytes,uint64_t length,TableRefuseReason * reason)
{ return (const RangedUnsigned *)table_cook_open_ex(bytes,length,sizeof(RangedUnsigned),SCHEMA_TABLE_ALIGNOF(RangedUnsigned),reason); }
...
/* ranged_widths_open: match the header and POINT. On a match the bytes ARE what this
   ...
   the ATTRIBUTION part beside the data — a person's decision, never a
   parameter on a load. */
static SCHEMA_UNUSED const RangedWidths * ranged_widths_open_ex(const void * bytes,uint64_t length,TableRefuseReason * reason)
{ return (const RangedWidths *)table_cook_open_ex(bytes,length,sizeof(RangedWidths),SCHEMA_TABLE_ALIGNOF(RangedWidths),reason); }
...
static SCHEMA_UNUSED int schema_tabledemo_ranged_signed_cook_body_(struct TableNumbering * n,uint8_t * at,const void * storage,int order)
{
    const RangedSigned * value=(const RangedSigned *)storage;
    ...
    { int32_t cook_i1; for(cook_i1=0;cook_i1<4;cook_i1++) {
        table_cook_put(at+64+cook_i1*2,(uint64_t)value->edges[cook_i1],2,order);
    } }
    table_cook_put(at+64+8,(uint32_t)value->edges_count,4,order);
    return 1;
}
static SCHEMA_UNUSED int64_t ranged_signed_cook_measure(const RangedSigned * value) { (void)value; return 160; }
static SCHEMA_UNUSED int ranged_signed_cook(const RangedSigned * value,void * output,uint64_t capacity,TableByteOrder order)
{
    uint8_t * raw=(uint8_t *)output;
    if(value==NULL || raw==NULL || capacity<160) { return 0; }
    memset(raw,0,160);
    if(!schema_tabledemo_ranged_signed_cook_body_(NULL,raw+64,value,order)) { return 0; }
    table_cook_put(raw+152,UINT64_C(0xec79751dda28be2e),8,order);
    table_cook_header(raw,SCHEMA_TABLEDEMO_BUILD_VERSION_VALUE,80,1,8,order); return 1;
}
static SCHEMA_UNUSED int schema_tabledemo_ranged_unsigned_cook_body_(struct TableNumbering * n,uint8_t * at,const void * storage,int order)
{
    const RangedUnsigned * value=(const RangedUnsigned *)storage;
    (void)n; (void)at; (void)value; (void)order;
    ...
    { int32_t cook_i1; for(cook_i1=0;cook_i1<4;cook_i1++) {
        table_cook_put(at+64+cook_i1*8,(uint64_t)value->counts[cook_i1],8,order);
    } }
    table_cook_put(at+64+32,(uint32_t)value->counts_count,4,order);
    return 1;
}
static SCHEMA_UNUSED int64_t ranged_unsigned_cook_measure(const RangedUnsigned * value) { (void)value; return 184; }
static SCHEMA_UNUSED int ranged_unsigned_cook(const RangedUnsigned * value,void * output,uint64_t capacity,TableByteOrder order)
{
    uint8_t * raw=(uint8_t *)output;
    if(value==NULL || raw==NULL || capacity<184) { return 0; }
    memset(raw,0,184);
    if(!schema_tabledemo_ranged_unsigned_cook_body_(NULL,raw+64,value,order)) { return 0; }
    table_cook_put(raw+176,UINT64_C(0x031ec0c4b7d28bf1),8,order);
    table_cook_header(raw,SCHEMA_TABLEDEMO_BUILD_VERSION_VALUE,104,1,8,order); return 1;
}
static SCHEMA_UNUSED int schema_tabledemo_ranged_widths_cook_body_(struct TableNumbering * n,uint8_t * at,const void * storage,int order)
{
    const RangedWidths * value=(const RangedWidths *)storage;
    (void)n; (void)at; (void)value; (void)order;
...
static SCHEMA_UNUSED int64_t ranged_widths_cook_measure(const RangedWidths * value) { (void)value; return 120; }
static SCHEMA_UNUSED int ranged_widths_cook(const RangedWidths * value,void * output,uint64_t capacity,TableByteOrder order)
{
    uint8_t * raw=(uint8_t *)output;
    if(value==NULL || raw==NULL || capacity<120) { return 0; }
    memset(raw,0,120);
    if(!schema_tabledemo_ranged_widths_cook_body_(NULL,raw+64,value,order)) { return 0; }
    table_cook_put(raw+112,UINT64_C(0xbf59694e9e4f5ed7),8,order);
