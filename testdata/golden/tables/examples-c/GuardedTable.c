...
static const TableFieldInfo schema_tabledemo_patrol_fields_[] = {
    { "active", "active", "bool", 0x6580790b036f0c6full, 1, 0, 0, 0, 0, (uint32_t) offsetof( Patrol, active ), (uint32_t) sizeof( ( (Patrol *) 0 )->active ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL },
    { "speed", "speed", "float32", 0x2281498aa0200e40ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( Patrol, speed ), (uint32_t) sizeof( ( (Patrol *) 0 )->speed ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "active", TableDocNone, 0, NULL },
    { "has_target", "has_target", "bool", 0x247f0e7f55aacfbdull, 1, 0, 0, 0, 0, (uint32_t) offsetof( Patrol, has_target ), (uint32_t) sizeof( ( (Patrol *) 0 )->has_target ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "active", TableDocNone, 0, NULL },
    { "target_id", "target_id", "int32", 0xb7bc9ac015a25050ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( Patrol, target_id ), (uint32_t) sizeof( ( (Patrol *) 0 )->target_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1000.0, -1, NULL, 0, NULL, NULL, -1, NULL, "active && has_target", TableDocNone, 0, NULL },
    { "wander", "wander", "float32", 0xb8c758d8bd1845d4ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( Patrol, wander ), (uint32_t) sizeof( ( (Patrol *) 0 )->wander ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "active && !has_target", TableDocNone, 0, NULL },
    { "note", "note", "string", 0x3bf8fbbad1587cddull, 12, 0, 1, 0, 8, (uint32_t) offsetof( Patrol, note ), (uint32_t) sizeof( ( (Patrol *) 0 )->note ), (uint32_t) offsetof( Patrol, note_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "!active", TableDocNone, 0, NULL },
};
