...
static const TableFieldInfo schema_tabledemo_archive_config_fields_[] = {
    { "root", "root", "RootConfig", 0xa354fd1ff0c467c5ull, 13, 0, 0, 0, 0, 0, (uint32_t) offsetof( ArchiveConfig, root ), (uint32_t) sizeof( ( (ArchiveConfig *) 0 )->root ), 0xffffffffu, 0xffffffffu, &schema_tabledemo_root_config_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
