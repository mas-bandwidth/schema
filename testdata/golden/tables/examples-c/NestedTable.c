...
static const TableFieldInfo schema_tabledemo_archive_config_fields_[] = {
    { "root", "root", "RootConfig", 0xa354fd1ff0c467c5ull, 13, 0, 0, 0, 0, (uint32_t) offsetof( ArchiveConfig, root ), (uint32_t) sizeof( ( (ArchiveConfig *) 0 )->root ), 0xffffffffu, 0xffffffffu, &schema_tabledemo_root_config_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL },
    { "count", "count", "int32", 0xb1e5e28e4479a274ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( ArchiveConfig, count ), (uint32_t) sizeof( ( (ArchiveConfig *) 0 )->count ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 100.0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL },
};
