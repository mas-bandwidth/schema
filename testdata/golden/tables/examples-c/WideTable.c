...
static const TableFieldInfo schema_tabledemo_wide_blob_fields_[] = {
    { "label", "label", "string", 0x39f7fcec8fcb623dull, 12, 0, 0, 1, 0, 70000, (uint32_t) offsetof( WideBlob, label ), (uint32_t) sizeof( ( (WideBlob *) 0 )->label ), (uint32_t) offsetof( WideBlob, label_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "payload", "payload", "bytes", 0xcfb8a9d063b5e9e5ull, 6, 1, 0, 1, 0, 70000, (uint32_t) offsetof( WideBlob, payload ), (uint32_t) sizeof( ( (WideBlob *) 0 )->payload[0] ), (uint32_t) offsetof( WideBlob, payload_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "samples", "samples", "uint16", 0xe3b1ca6a3b48dddcull, 7, 1, 0, 1, 0, 70000, (uint32_t) offsetof( WideBlob, samples ), (uint32_t) sizeof( ( (WideBlob *) 0 )->samples[0] ), (uint32_t) offsetof( WideBlob, samples_count ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};

const TableTypeInfo schema_tabledemo_wide_blob_info_ = { "WideBlob", (uint32_t) sizeof( WideBlob ), 3, schema_tabledemo_wide_blob_fields_, schema_tabledemo_wide_blob_reset_raw_, 0, TableDocNone, 0, NULL };
