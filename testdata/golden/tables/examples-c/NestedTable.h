...
static SCHEMA_UNUSED const uint64_t archive_config_fixed_hash = 0x0914256792928e9full; /* fnv1a64 over the layout's bytes */
...
static SCHEMA_UNUSED const TableFixedEntry archive_config_fixed_plan[] = {
    ...
    { 1248u, 1480u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1 }, /* count */
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    if ( hash != archive_config_fixed_hash )
    {
        ...
        else
        {
            ...
            made = table_fixed_compile( &parsed, archive_config_fixed_layout, (int32_t) sizeof( archive_config_fixed_layout ), archive_config_fixed_dst,
                                        archive_config_fixed_cover, archive_config_fixed_cover_count,
