...
static SCHEMA_UNUSED const TableFixedEntry archive_config_fixed_plan[] = {
    ...
    { 1248u, 1480u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* count */
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != archive_config_fixed_hash )
    {
        ...
        made = table_fixed_compile( &parsed, archive_config_fixed_layout, (int32_t) sizeof( archive_config_fixed_layout ), archive_config_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
    ...
    for ( k = 0; k < count; ++k )
    {
        archive_config_reset( values + k ); /* the declared defaults, one prefill */
