...
static SCHEMA_UNUSED int gunner_settings_save_body( TableWriter * w, const GunnerSettings * value )
{
    ...
    { /* callsign */
        ...
        {
            table_writer_header_at( w, 54, 0x5bc44627b9848818ull, 12 );
            if ( w->buffer == NULL )
            {
...
static SCHEMA_UNUSED int ship_entry_save_body( TableWriter * w, const ShipEntry * value )
{
    ...
    { /* display_name */
        ...
        if ( value->display_name_length != 0 )
        {
            ...
            table_writer_header_at( w, 28, 0x2d21d7cd66bd5a5dull, 12 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
    ...
    { /* hardpoints */
        ...
        {
            if ( w->check_default ) { w->offset = 2; return 1; }
            table_writer_header_at( w, 78, 0x95d0cce09ca82b73ull, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
...
static SCHEMA_UNUSED int global_settings_save_body( TableWriter * w, const GlobalSettings * value )
{
    ...
    { /* tick_rate */
        ...
        {
            if ( w->check_default ) { w->offset = 2; return 1; }
            table_writer_header_at( w, 89, 0xa65f859b617deaf3ull, 8 );
    ...
    { /* difficulty */
        ...
        {
            if ( w->check_default ) { w->offset = 2; return 1; }
            table_writer_header_at( w, 42, 0x467f35a74c6e4a70ull, 30 );
...
static SCHEMA_UNUSED int global_settings_save_message_body(TableBitWriter * w,const GlobalSettings * value)
{
 ...
 if(!(value->difficulty == DIFFICULTY_NORMAL)) {
  ...
  switch(value->difficulty) {
   ...
   break;
   case DIFFICULTY_EASY: table_bit_put(w,111,kTableMessageRefBitsHere);
   break;
   case DIFFICULTY_NORMAL: table_bit_put(w,112,kTableMessageRefBitsHere);
   break;
   case DIFFICULTY_HARD: table_bit_put(w,113,kTableMessageRefBitsHere);
   break;
   default: return 0;
  }
 }
...
static SCHEMA_UNUSED int pack_config_save_body( TableWriter * w, const PackConfig * value )
{
    ...
    { /* version */
        if ( !( value->version == 1 ) )
        {
            table_writer_header_at( w, 108, 0xbb62c62c9808ea37ull, 8 );
    ...
    { /* global */
        ...
        {
            table_writer_header_at( w, 69, 0x7fb43557b54149ceull, 13 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
    ...
    { /* ships */
        ...
        if ( rides )
        {
            table_writer_header_at( w, 26, 0x294a5c4913e1ad44ull, 16 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
    ...
    { /* thresholds */
        ...
        if ( rides )
        {
            table_writer_header_at( w, 81, 0x9cda940a344e1571ull, 16 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
    ...
    { /* reserves */
        ...
        {
            table_writer_header_at( w, 65, 0x77707fccd201c228ull, 14 );
  ...
  int32_t i;
   ...
   for(i=0;i<3;i++) {
    ...
    switch(i+1) {
     ...
     break;
     case SHIP_TYPE_FIGHTER: table_bit_put(w,120,kTableMessageRefBitsHere);
     break;
     case SHIP_TYPE_BOMBER: table_bit_put(w,121,kTableMessageRefBitsHere);
     break;
     case SHIP_TYPE_SCOUT: table_bit_put(w,122,kTableMessageRefBitsHere);
     break;
     default: return 0;
    }
