...
static SCHEMA_UNUSED const uint64_t gunner_settings_fixed_hash = 0x096e203e5991edb3ull; /* fnv1a64 over the layout and the definitions digest (bill §13) */
...
static SCHEMA_UNUSED const TableFixedEntry gunner_settings_fixed_plan[] = {
    ...
    { 5u, 32u, 24u, 5u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
};
...
static SCHEMA_UNUSED const TableFixedFill gunner_settings_fixed_cover[] = {
    { 0u, 30u },
    { 32u, 4u },
};
static SCHEMA_UNUSED const int32_t gunner_settings_fixed_cover_count = 2;
...
/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   ...
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout gunner_settings_fixed_known[] = {
    { 0x096e203e5991edb3ull, gunner_settings_fixed_layout, (int64_t) sizeof( gunner_settings_fixed_layout ), 41 },
};
static SCHEMA_UNUSED const int32_t gunner_settings_fixed_known_count = 1;
...
static SCHEMA_UNUSED const int32_t gunner_settings_fixed_floor = 0;
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    pick = table_fixed_select( gunner_settings_fixed_known, gunner_settings_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < gunner_settings_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    ...
    if ( (int64_t) layout_bytes != gunner_settings_fixed_known[pick].layout_bytes ||
         memcmp( layout, gunner_settings_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    ...
    record_bytes = gunner_settings_fixed_known[pick].record_bytes;
    ...
    if ( fill_count > 0 )
    {
        ...
        gunner_settings_reset( &defaults );
    }
    for ( k = 0; k < count; ++k )
    {
...
static SCHEMA_UNUSED const uint64_t ship_entry_fixed_hash = 0xfe5a81cf85f6ddd1ull; /* fnv1a64 over the layout and the definitions digest (bill §13) */
...
static SCHEMA_UNUSED const TableFixedDst ship_entry_fixed_dst[] = {
    { 0, 0, 0, 0, 0 }, /* ShipEntry */
    { 36, 0, 0, 0, 1 }, /* display_name */
    { 40, 0, 0, 0, 0 }, /* health */
    { 44, 0, 0, 0, 0 }, /* mass */
    { 48, 4, 64, 1, 0 }, /* hardpoints */
    { 0, 0, 0, 0, 0 }, /* element */
    { 0, 0, 104, 0, 0 }, /* gunner ? */
    { 68, 0, 0, 0, 0 }, /* gunner */
    { 0, 0, 0, 0, 0 }, /* reaction */
...
static SCHEMA_UNUSED const TableFixedEntry ship_entry_fixed_plan[] = {
    { 0u, 36u, 32u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 36u, 40u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 44u, 64u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 48u, 48u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 64u, 104u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 65u, 68u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 69u, 72u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 70u, 100u, 24u, 73u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
};
...
/* THE TYPE'S VALUE BYTES: every byte of this build's own storage that holds
   ...
   twice; a plan compiled from a stranger's layout subtracts itself from it
   once, when the plan is compiled, and prefills exactly the rest. */
static SCHEMA_UNUSED const TableFixedFill ship_entry_fixed_cover[] = {
    { 0u, 33u },
    { 36u, 62u },
    { 100u, 5u },
};
static SCHEMA_UNUSED const int32_t ship_entry_fixed_cover_count = 3;

/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   A FILE IS MATCHED ON IS THE HASH; the layout bytes are what a known hash
   is held to by memcmp, and the record size is taken from here and NEVER
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout ship_entry_fixed_known[] = {
    { 0xfe5a81cf85f6ddd1ull, ship_entry_fixed_layout, (int64_t) sizeof( ship_entry_fixed_layout ), 106 },
};
static SCHEMA_UNUSED const int32_t ship_entry_fixed_known_count = 1;
/* THE FLOOR IS ONE NUMBER AND THE LINEAGE IS ONE ARRAY, so "retired" is an
   index cut and the operator's two answers stay distinct: below the floor is
   layout_unsupported (upgrade the client), outside the lineage is
   layout_newer (ship the reader). A retired entry stays forever (§5.2). */
static SCHEMA_UNUSED const int32_t ship_entry_fixed_floor = 0;
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    hash = table_fixed_get64( data + kTableFixedHashAt );
    /* 5 and 6. SELECT BY HASH, THEN THE FLOOR. Both report THE FILE'S hash. */
    pick = table_fixed_select( ship_entry_fixed_known, ship_entry_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < ship_entry_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    /* 7. A KNOWN HASH IS READ UNDER THE LOCK'S LAYOUT BYTES. A difference is ONE
       name — a lie about a known version — and §1.1's seven rules do not run at
       read time at all: no stranger's layout is ever walked. */
    if ( (int64_t) layout_bytes != ship_entry_fixed_known[pick].layout_bytes ||
         memcmp( layout, ship_entry_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    { report->refused = 1; report->reason = SCHEMA_TABLE_LAYOUT_MALFORMED; return -1; }
    /* 8. the plan this peer resolves to, and the record size FROM THE LOCK. */
    record_bytes = ship_entry_fixed_known[pick].record_bytes;
    /* 9 and 10. the tail must be whole records, and they must fit the caller. */
    at = layout + layout_bytes;
    rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    if ( record_bytes <= 8 || rest % record_bytes != 0 ) { report->malformed = 1; return -1; }
...
static SCHEMA_UNUSED const uint64_t global_settings_fixed_hash = 0x14b8c217ea989d2aull; /* fnv1a64 over the layout and the definitions digest (bill §13) */
...
static SCHEMA_UNUSED const TableFixedDst global_settings_fixed_dst[] = {
    { 0, 0, 0, 0, 0 }, /* GlobalSettings */
    { 0, 0, 0, 0, 0 }, /* tick_rate */
    { 4, 0, 0, 0, 0 }, /* difficulty */
    { 0, 0, 0, 0, 0 }, /* Easy */
    { 0, 0, 0, 0, 0 }, /* Normal */
    { 0, 0, 0, 0, 0 }, /* Hard */
    { 56, 0, 5, 0, 1 }, /* build_note */
    { 60, 4, 0, 0, 0 }, /* spawn_delays */
    { 0, 0, 0, 0, 0 }, /* element */
};
...
static SCHEMA_UNUSED const TableFixedEntry global_settings_fixed_plan[] = {
    { 0u, 0u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tick_rate */
    { 5u, 56u, 48u, 5u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* build_note */
    { 57u, 60u, 12u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* spawn_delays, whole */
};
...
/* THE TYPE'S VALUE BYTES: every byte of this build's own storage that holds
   ...
   twice; a plan compiled from a stranger's layout subtracts itself from it
   once, when the plan is compiled, and prefills exactly the rest. */
static SCHEMA_UNUSED const TableFixedFill global_settings_fixed_cover[] = {
    { 0u, 54u },
    { 56u, 16u },
};
static SCHEMA_UNUSED const int32_t global_settings_fixed_cover_count = 2;

/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   A FILE IS MATCHED ON IS THE HASH; the layout bytes are what a known hash
   is held to by memcmp, and the record size is taken from here and NEVER
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout global_settings_fixed_known[] = {
    { 0x14b8c217ea989d2aull, global_settings_fixed_layout, (int64_t) sizeof( global_settings_fixed_layout ), 77 },
};
static SCHEMA_UNUSED const int32_t global_settings_fixed_known_count = 1;
/* THE FLOOR IS ONE NUMBER AND THE LINEAGE IS ONE ARRAY, so "retired" is an
   index cut and the operator's two answers stay distinct: below the floor is
   layout_unsupported (upgrade the client), outside the lineage is
   layout_newer (ship the reader). A retired entry stays forever (§5.2). */
static SCHEMA_UNUSED const int32_t global_settings_fixed_floor = 0;
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    hash = table_fixed_get64( data + kTableFixedHashAt );
    /* 5 and 6. SELECT BY HASH, THEN THE FLOOR. Both report THE FILE'S hash. */
    pick = table_fixed_select( global_settings_fixed_known, global_settings_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < global_settings_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    /* 7. A KNOWN HASH IS READ UNDER THE LOCK'S LAYOUT BYTES. A difference is ONE
       name — a lie about a known version — and §1.1's seven rules do not run at
       read time at all: no stranger's layout is ever walked. */
    if ( (int64_t) layout_bytes != global_settings_fixed_known[pick].layout_bytes ||
         memcmp( layout, global_settings_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    { report->refused = 1; report->reason = SCHEMA_TABLE_LAYOUT_MALFORMED; return -1; }
    /* 8. the plan this peer resolves to, and the record size FROM THE LOCK. */
    record_bytes = global_settings_fixed_known[pick].record_bytes;
    /* 9 and 10. the tail must be whole records, and they must fit the caller. */
    at = layout + layout_bytes;
    rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    if ( record_bytes <= 8 || rest % record_bytes != 0 ) { report->malformed = 1; return -1; }
    ...
    {
        memset( (void *) &defaults, 0, sizeof( defaults ) ); /* padding included, so the prefill is deterministic */
        global_settings_reset( &defaults );
    }
    for ( k = 0; k < count; ++k )
    {
        if ( table_fixed_get64( at ) != hash ) { report->refused = 1; report->reason = SCHEMA_TABLE_NO_LAYOUT; return -1; }
...
static SCHEMA_UNUSED const uint64_t pack_config_fixed_hash = 0x519afb907887584bull; /* fnv1a64 over the layout and the definitions digest (bill §13) */
...
static SCHEMA_UNUSED const TableFixedDst pack_config_fixed_dst[] = {
    ...
    { 4, 0, 0, 0, 0 }, /* tracking */
    { 32, 0, 5, 0, 1 }, /* callsign */
    { 400, 4, 0, 0, 0 }, /* thresholds */
    { 0, 0, 0, 0, 0 }, /* Difficulty */
    { 0, 0, 0, 0, 0 }, /* Easy */
    { 0, 0, 0, 0, 0 }, /* Normal */
    { 0, 0, 0, 0, 0 }, /* Hard */
    { 0, 0, 0, 0, 0 }, /* element */
    { 412, 108, 736, 1, 0 }, /* reserves */
    { 0, 0, 0, 0, 0 }, /* element */
    { 36, 0, 0, 0, 1 }, /* display_name */
    { 40, 0, 0, 0, 0 }, /* health */
    { 44, 0, 0, 0, 0 }, /* mass */
...
static SCHEMA_UNUSED const TableFixedEntry pack_config_fixed_plan[] = {
    { 0u, 0u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* version */
    { 9u, 60u, 48u, 9u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* build_note */
    { 61u, 64u, 12u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* spawn_delays, whole */
    { 73u, 112u, 32u, 76u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 109u, 116u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 117u, 140u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 121u, 124u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 137u, 180u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 138u, 144u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 142u, 148u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 143u, 176u, 24u, 149u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
    { 171u, 220u, 32u, 184u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 207u, 224u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 215u, 248u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 219u, 232u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 235u, 288u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 236u, 252u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 240u, 256u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 241u, 284u, 24u, 257u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
    { 269u, 328u, 32u, 292u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 305u, 332u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 313u, 356u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 317u, 340u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 333u, 396u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 334u, 360u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 338u, 364u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 339u, 392u, 24u, 365u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
    { 367u, 400u, 12u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* thresholds, whole */
    { 379u, 736u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reserves count */
    { 383u, 448u, 32u, 412u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 419u, 452u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 427u, 476u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 431u, 460u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 447u, 516u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 448u, 480u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 452u, 484u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 453u, 512u, 24u, 485u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
    { 481u, 556u, 32u, 520u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 517u, 560u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 525u, 584u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 529u, 568u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 545u, 624u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 546u, 588u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 550u, 592u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 551u, 620u, 24u, 593u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
    { 579u, 664u, 32u, 628u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* display_name */
    { 615u, 668u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* health */
    { 623u, 692u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints count */
    { 627u, 676u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* hardpoints, whole */
    { 643u, 732u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* gunner present */
    { 644u, 696u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* reaction */
    { 648u, 700u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedBool, 0, 0, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* tracking */
    { 649u, 728u, 24u, 701u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 0, 1, 0, 0, 1, SCHEMA_TABLE_FIXED_NO_GUARD, 0, 1 }, /* callsign */
};
...
/* THE TYPE'S VALUE BYTES: every byte of this build's own storage that holds
   ...
   twice; a plan compiled from a stranger's layout subtracts itself from it
   once, when the plan is compiled, and prefills exactly the rest. */
static SCHEMA_UNUSED const TableFixedFill pack_config_fixed_cover[] = {
    { 0u, 58u },
    { 60u, 49u },
    { 112u, 62u },
    { 176u, 5u },
...
static SCHEMA_UNUSED const int32_t pack_config_fixed_cover_count = 20;

/* THE LINEAGE, OLDEST FIRST, THE CURRENT LAYOUT LAST (§5.2). THE ONLY FACT
   A FILE IS MATCHED ON IS THE HASH; the layout bytes are what a known hash
   is held to by memcmp, and the record size is taken from here and NEVER
   from the file. */
static SCHEMA_UNUSED const TableFixedKnownLayout pack_config_fixed_known[] = {
    { 0x519afb907887584bull, pack_config_fixed_layout, (int64_t) sizeof( pack_config_fixed_layout ), 685 },
};
static SCHEMA_UNUSED const int32_t pack_config_fixed_known_count = 1;
/* THE FLOOR IS ONE NUMBER AND THE LINEAGE IS ONE ARRAY, so "retired" is an
   index cut and the operator's two answers stay distinct: below the floor is
   layout_unsupported (upgrade the client), outside the lineage is
   layout_newer (ship the reader). A retired entry stays forever (§5.2). */
static SCHEMA_UNUSED const int32_t pack_config_fixed_floor = 0;
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    hash = table_fixed_get64( data + kTableFixedHashAt );
    /* 5 and 6. SELECT BY HASH, THEN THE FLOOR. Both report THE FILE'S hash. */
    pick = table_fixed_select( pack_config_fixed_known, pack_config_fixed_known_count, hash );
    if ( pick < 0 ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_NEWER, hash ); }
    if ( pick < pack_config_fixed_floor ) { return table_fixed_refuse_hash( report, SCHEMA_TABLE_LAYOUT_UNSUPPORTED, hash ); }
    /* 7. A KNOWN HASH IS READ UNDER THE LOCK'S LAYOUT BYTES. A difference is ONE
       name — a lie about a known version — and §1.1's seven rules do not run at
       read time at all: no stranger's layout is ever walked. */
    if ( (int64_t) layout_bytes != pack_config_fixed_known[pick].layout_bytes ||
         memcmp( layout, pack_config_fixed_known[pick].layout, (size_t) layout_bytes ) != 0 )
    { report->refused = 1; report->reason = SCHEMA_TABLE_LAYOUT_MALFORMED; return -1; }
    /* 8. the plan this peer resolves to, and the record size FROM THE LOCK. */
    record_bytes = pack_config_fixed_known[pick].record_bytes;
    /* 9 and 10. the tail must be whole records, and they must fit the caller. */
    at = layout + layout_bytes;
    rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    if ( record_bytes <= 8 || rest % record_bytes != 0 ) { report->malformed = 1; return -1; }
...
static SCHEMA_UNUSED int gunner_settings_save_body_retain(TableWriter *,const GunnerSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int gunner_settings_load_body_retain(TableReader *,GunnerSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int ship_entry_save_body_retain(TableWriter *,const ShipEntry *, TableRetainWalk retention);
static SCHEMA_UNUSED int ship_entry_load_body_retain(TableReader *,ShipEntry *, TableRetainWalk retention);
static SCHEMA_UNUSED int global_settings_save_body_retain(TableWriter *,const GlobalSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int global_settings_load_body_retain(TableReader *,GlobalSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int pack_config_save_body_retain(TableWriter *,const PackConfig *, TableRetainWalk retention);
static SCHEMA_UNUSED int pack_config_load_body_retain(TableReader *,PackConfig *, TableRetainWalk retention);
static SCHEMA_UNUSED int gunner_settings_load_message_body_retain(TableMessageReader *,GunnerSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int ship_entry_load_message_body_retain(TableMessageReader *,ShipEntry *, TableRetainWalk retention);
static SCHEMA_UNUSED int global_settings_load_message_body_retain(TableMessageReader *,GlobalSettings *, TableRetainWalk retention);
static SCHEMA_UNUSED int pack_config_load_message_body_retain(TableMessageReader *,PackConfig *, TableRetainWalk retention);
static SCHEMA_UNUSED int schema_tabledemo_gunner_settings_wire_callsign__retain( TableWriter * w, const GunnerSettings * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int gunner_settings_save_body_retain( TableWriter * w, const GunnerSettings * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,2,0);
        ...
        if ( value->callsign_length != 0 )
        {
            table_retain_writer_id( w, 0x5bc44627b9848818ull , retention);
            table_writer_put8( w, 12 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_gunner_settings_wire_callsign__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                ...
                if ( !schema_tabledemo_gunner_settings_wire_callsign__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_gunner_settings_wire_callsign__retain( w, value , retention) ) { return 0;
...
static SCHEMA_UNUSED int gunner_settings_load_body_retain( TableReader * r, GunnerSettings * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
            ...
            case 0x5bc44627b9848818ull: /* callsign */
            {
                ...
                memcpy( value->callsign, sub.buffer, (size_t) keep );
...
static SCHEMA_UNUSED int gunner_settings_load_message_body_retain(TableMessageReader * r,GunnerSettings * value, TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_ship_entry_wire_display_name__retain( TableWriter * w, const ShipEntry * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_ship_entry_wire_hardpoints__retain( TableWriter * w, const ShipEntry * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    table_writer_leb( w, (uint64_t) value->hardpoints_count );
    for ( i = 0; i < value->hardpoints_count; i++ )
    {
        table_writer_put32( w, (uint32_t) ( value->hardpoints[i] ) );
    }
...
static SCHEMA_UNUSED int ship_entry_save_body_retain( TableWriter * w, const ShipEntry * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,0,0);
        ...
        if ( value->display_name_length != 0 )
        {
            ...
            table_retain_writer_id( w, 0x2d21d7cd66bd5a5dull , retention);
            table_writer_put8( w, 12 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_ship_entry_wire_display_name__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_ship_entry_wire_display_name__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_ship_entry_wire_display_name__retain( w, value , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,3,0);
        ...
        if ( value->hardpoints_count > 0 )
        {
            ...
            table_retain_writer_id( w, 0x95d0cce09ca82b73ull , retention);
            table_writer_put8( w, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_ship_entry_wire_hardpoints__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_ship_entry_wire_hardpoints__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_ship_entry_wire_hardpoints__retain( w, value , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,4,0);
        if ( value->gunner_present )
        {
            ...
            {
                int64_t frame_begin = w->offset;
                if ( !gunner_settings_save_body_retain( w, &value->gunner , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !gunner_settings_save_body_retain( &probe, &value->gunner , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !gunner_settings_save_body_retain( w, &value->gunner , retention) ) { return 0;
...
static SCHEMA_UNUSED int ship_entry_load_body_retain( TableReader * r, ShipEntry * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
            case 0x2d21d7cd66bd5a5dull: /* display_name */
            {
                ...
                memcpy( value->display_name, sub.buffer, (size_t) keep );
            ...
            case 0x95d0cce09ca82b73ull: /* hardpoints */
            {
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    else
                    {
                        if ( elem_kind != 4 )
                        {
                            if ( !(table_kind_widens(elem_kind,4)) ) { r->report->kind_mismatch++;
                            break;
                            }
                            r->report->widened++;
                        }
                        ...
                        for ( i = 0; i < kept; i++ )
                        {
                            switch ( elem_kind )
                            {
                                case 2:
                                {
                                    ...
                                    if ( decoded_wide > 8ll ) { decoded_wide = 8ll;
                                    r->report->clamped++;
                                    }
                                    value->hardpoints[i] = decoded_wide;
                                    break;
                                ...
                                case 4:
                                {
                                    ...
                                    }
                                    {
                                        ...
                                        else if ( decoded_v > 8 ) { decoded_v = 8;
                                        r->report->clamped++;
                                        }
                                        value->hardpoints[i] = decoded_v;
                                    }
                        ...
                        end_hardpoints: ;
                        { uint32_t tail;
                        for (tail=(uint32_t)value->hardpoints_count;tail<(uint32_t)previous_count && tail<4;tail++) {
                         memset(&value->hardpoints[tail],0,sizeof(value->hardpoints[tail]));
                        } }
                    }
                }
            ...
            case 0x40dbb648c0cd44aaull: /* gunner */
            {
                ...
                gunner_settings_load_body_retain( &sub, &value->gunner , retention);
...
static SCHEMA_UNUSED int ship_entry_load_message_body_retain(TableMessageReader * r,ShipEntry * value, TableRetainWalk retention)
{
    (void)retention;
 ...
 retention=table_retain_step(body_keep,4,0);
 table_retain_discard(body_keep,1,4);
 if(!gunner_settings_load_message_body_retain(r,&value->gunner, retention))return 0;
 value->gunner_present=1;
 break;
 }
 default:r->report->unknown += 1;
...
static SCHEMA_UNUSED int schema_tabledemo_global_settings_wire_build_note__retain( TableWriter * w, const GlobalSettings * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_global_settings_wire_spawn_delays__retain( TableWriter * w, const GlobalSettings * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int global_settings_save_body_retain( TableWriter * w, const GlobalSettings * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,0,0);
        if ( !( value->tick_rate == 60 ) )
        {
            ...
            table_retain_writer_id( w, 0xa65f859b617deaf3ull , retention);
    ...
    retention=table_retain_step(body_keep,1,0);
        if ( !( value->difficulty == DIFFICULTY_NORMAL ) )
        {
            ...
            table_retain_writer_id( w, 0x467f35a74c6e4a70ull , retention);
            table_writer_put8( w, 30 );
            switch ( value->difficulty )
            {
                case DIFFICULTY_NONE: table_writer_leb( w, 0 );
                break;
                case DIFFICULTY_EASY: table_retain_writer_id( w, 0x483d9e6c1ccd1f9bull , retention);
                break;
                case DIFFICULTY_NORMAL: table_retain_writer_id( w, 0x9ff3121d30f88d52ull , retention);
                break;
                case DIFFICULTY_HARD: table_retain_writer_id( w, 0x58c7b5d87587287cull , retention);
                break;
                default: return 0;
    ...
    retention=table_retain_step(body_keep,2,0);
        ...
        if ( value->build_note_length != 0 )
        {
            ...
            table_retain_writer_id( w, 0x14ec921cc2549d60ull , retention);
            table_writer_put8( w, 12 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_global_settings_wire_build_note__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_global_settings_wire_build_note__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_global_settings_wire_build_note__retain( w, value , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,3,0);
        ...
        if ( rides )
        {
            ...
            table_retain_writer_id( w, 0x09ae5613b0051271ull , retention);
            table_writer_put8( w, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_global_settings_wire_spawn_delays__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_global_settings_wire_spawn_delays__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_global_settings_wire_spawn_delays__retain( w, value , retention) ) { return 0;
...
static SCHEMA_UNUSED int global_settings_load_body_retain( TableReader * r, GlobalSettings * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
                    ...
                    if ( table_kind_widens( kind, 8 ) )
                    {
                        switch ( kind )
                        {
                            case 6:
                            {
                                ...
                                if ( decoded_wide > 240ull ) { decoded_wide = 240ull;
                                r->report->clamped++;
                                }
                                value->tick_rate = decoded_wide;
                                break;
                            ...
                            case 8:
                            {
                                ...
                                {
                                    uint32_t decoded_v = (uint32_t) table_reader_get32( &(*r) );
                                    if ( decoded_v < 1 ) { decoded_v = 1;
                                    r->report->clamped++;
                                    }
                                    else if ( decoded_v > 240 ) { decoded_v = 240;
                                    r->report->clamped++;
                                    }
                                    value->tick_rate = decoded_v;
                                }
            ...
            case 0x467f35a74c6e4a70ull: /* difficulty */
            {
                ...
                retention=table_retain_step(body_keep,1,0);
                {
                    ...
                    else
                    {
                        switch ( table_reader_id_at( &(*r), variant_ref ) )
                        {
                            case 0x483d9e6c1ccd1f9bull: value->difficulty = DIFFICULTY_EASY;
                            break;
                            case 0x9ff3121d30f88d52ull: value->difficulty = DIFFICULTY_NORMAL;
                            break;
                            case 0x58c7b5d87587287cull: value->difficulty = DIFFICULTY_HARD;
                            break;
                            default: value->difficulty = DIFFICULTY_NONE;
                            r->report->unknown++;
                            r->report->retain_lost += retention.retain != NULL;
            ...
            case 0x14ec921cc2549d60ull: /* build_note */
            {
                ...
                {
                    r->report->malformed = 1;
                    value->build_note[0] = 0;
                    value->build_note_length = 0;
                    break;
                }
                keep = (uint64_t) sub.size;
                if ( keep > 48 ) { keep = table_wire_utf8_clamp( sub.buffer, keep, 48 );
                r->report->clamped++;
                }
                memcpy( value->build_note, sub.buffer, (size_t) keep );
...
static SCHEMA_UNUSED int global_settings_load_message_body_retain(TableMessageReader * r,GlobalSettings * value, TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_pack_config_wire_ships__retain( TableWriter * w, const PackConfig * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( i = 0; i < SHIP_TYPE_MAX; i++ )
    {
        ...
        if ( !ship_entry_save_body_retain( &slot_probe, &value->ships[i] , retention) ) { return 0;
        }
    ...
    for ( i = 0; i < SHIP_TYPE_MAX; i++ )
    {
        ...
        switch ( i + 1 )
        {
            case SHIP_TYPE_NONE: table_writer_leb( w, 0 );
            break;
            case SHIP_TYPE_FIGHTER: table_retain_writer_id( w, 0xd011f7c3c15285c2ull , retention);
            break;
            case SHIP_TYPE_BOMBER: table_retain_writer_id( w, 0xa8216aa1c554cb8aull , retention);
            break;
            case SHIP_TYPE_SCOUT: table_retain_writer_id( w, 0x7d573c625719c1a5ull , retention);
            break;
            default: return 0;
            /* no declared identity */
        }
        ...
        {
            int64_t frame_begin = w->offset;
            if ( !ship_entry_save_body_retain( w, &value->ships[i] , retention) ) { return 0;
            }
            table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
        }
        else
        {
            TableWriter probe = table_retain_probe( w , retention);
            if ( !ship_entry_save_body_retain( &probe, &value->ships[i] , retention) ) { return 0;
            }
            table_retain_rewind(&probe, retention);
            table_writer_leb( w, (uint64_t) probe.offset );
            if ( !ship_entry_save_body_retain( w, &value->ships[i] , retention) ) { return 0;
...
static SCHEMA_UNUSED int schema_tabledemo_pack_config_wire_thresholds__retain( TableWriter * w, const PackConfig * value , TableRetainWalk retention)
{
    (void)retention;
...
static SCHEMA_UNUSED int schema_tabledemo_pack_config_wire_reserves__retain( TableWriter * w, const PackConfig * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    int32_t i;
    table_writer_put8( w, 13 );
    table_writer_leb( w, (uint64_t) value->reserves_count );
    for ( i = 0; i < value->reserves_count; i++ )
    {
        retention=table_retain_index(retention,(uint32_t)(i));
        if ( w->buffer == NULL )
        {
            int64_t frame_begin = w->offset;
            if ( !ship_entry_save_body_retain( w, &value->reserves[i] , retention) ) { return 0;
            }
            table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
        }
        else
        {
            TableWriter probe = table_retain_probe( w , retention);
            if ( !ship_entry_save_body_retain( &probe, &value->reserves[i] , retention) ) { return 0;
            }
            table_retain_rewind(&probe, retention);
            table_writer_leb( w, (uint64_t) probe.offset );
            if ( !ship_entry_save_body_retain( w, &value->reserves[i] , retention) ) { return 0;
...
static SCHEMA_UNUSED int pack_config_save_body_retain( TableWriter * w, const PackConfig * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    retention=table_retain_step(body_keep,1,0);
        ...
        if ( !global_settings_save_body_retain( &default_probe, &value->global , retention) ) { return 0;
        }
        table_retain_rewind(&default_probe, retention);
        if ( default_probe.offset > 1 )
        {
            table_retain_writer_id( w, 0x7fb43557b54149ceull , retention);
            table_writer_put8( w, 13 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !global_settings_save_body_retain( w, &value->global , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !global_settings_save_body_retain( &probe, &value->global , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !global_settings_save_body_retain( w, &value->global , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,2,0);
        ...
        if ( rides )
        {
            table_retain_writer_id( w, 0x294a5c4913e1ad44ull , retention);
            table_writer_put8( w, 16 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_pack_config_wire_ships__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_pack_config_wire_ships__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_pack_config_wire_ships__retain( w, value , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,3,0);
        ...
        if ( rides )
        {
            table_retain_writer_id( w, 0x9cda940a344e1571ull , retention);
            table_writer_put8( w, 16 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_pack_config_wire_thresholds__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_pack_config_wire_thresholds__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_pack_config_wire_thresholds__retain( w, value , retention) ) { return 0;
    ...
    retention=table_retain_step(body_keep,4,0);
        ...
        if ( value->reserves_count > 0 )
        {
            table_retain_writer_id( w, 0x77707fccd201c228ull , retention);
            table_writer_put8( w, 14 );
            if ( w->buffer == NULL )
            {
                int64_t frame_begin = w->offset;
                if ( !schema_tabledemo_pack_config_wire_reserves__retain( w, value , retention) ) { return 0;
                }
                table_writer_leb( w, (uint64_t)(w->offset - frame_begin) );
            }
            else
            {
                TableWriter probe = table_retain_probe( w , retention);
                if ( !schema_tabledemo_pack_config_wire_reserves__retain( &probe, value , retention) ) { return 0;
                }
                table_retain_rewind(&probe, retention);
                table_writer_leb( w, (uint64_t) probe.offset );
                if ( !schema_tabledemo_pack_config_wire_reserves__retain( w, value , retention) ) { return 0;
...
static SCHEMA_UNUSED int pack_config_load_body_retain( TableReader * r, PackConfig * value , TableRetainWalk retention)
{
    (void)retention;
    ...
    for ( ;; )
    {
        ...
        switch ( id )
        {
            ...
            case 0x7fb43557b54149ceull: /* global */
            {
                ...
                global_settings_load_body_retain( &sub, &value->global , retention);
                if ( sub.offset != sub.size ) { r->report->malformed = 1;
                global_settings_reset( &value->global );
                }
                break;
            ...
            case 0x294a5c4913e1ad44ull: /* ships */
            {
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    for ( i = 0; i < count; i++ )
                    {
                        ...
                        switch ( key )
                        {
                            case 0xd011f7c3c15285c2ull: slot = 0;
                            break;
                            case 0xa8216aa1c554cb8aull: slot = 1;
                            break;
                            case 0x7d573c625719c1a5ull: slot = 2;
                            break;
                            default: r->report->unknown++;
                            r->report->retain_lost += retention.retain != NULL;
                            break;
                        ...
                        ship_entry_load_body_retain( &elem, &value->ships[slot] , retention);
                        if(elem.offset!=elem.size) { r->report->malformed=1;
                        ship_entry_reset(&value->ships[slot]);
                        }
                    }
                }
                break;
            ...
            case 0x9cda940a344e1571ull: /* thresholds */
            {
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    for ( i = 0; i < count; i++ )
                    {
                        ...
                        switch ( key )
                        {
                            case 0x483d9e6c1ccd1f9bull: slot = 0;
                            break;
                            case 0x9ff3121d30f88d52ull: slot = 1;
                            break;
                            case 0x58c7b5d87587287cull: slot = 2;
                            break;
                            default: r->report->unknown++;
                            r->report->retain_lost += retention.retain != NULL;
                            break;
                ...
                if ( sub.size >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        for ( i = 0; i < kept; i++ )
                        {
                            ...
                            ship_entry_load_body_retain( &elem, &value->reserves[i] , retention);
                            if(elem.offset!=elem.size) { r->report->malformed=1;
                            ship_entry_reset(&value->reserves[i]);
                            }
                            value->reserves_count = (int32_t) i + 1;
                        }
                        end_reserves: ;
                        { uint32_t tail;
                        for (tail=(uint32_t)value->reserves_count;tail<(uint32_t)previous_count && tail<3;tail++) {
                         ship_entry_reset(&value->reserves[tail]);
                        } }
                    }
                }
...
static SCHEMA_UNUSED int pack_config_load_message_body_retain(TableMessageReader * r,PackConfig * value, TableRetainWalk retention)
{
    (void)retention;
 ...
 retention=table_retain_step(body_keep,1,0);
 table_retain_discard(body_keep,1,1);
 if(!global_settings_load_message_body_retain(r,&value->global, retention))return 0;
 break;
 }
 case UINT64_C(0x294a5c4913e1ad44): {
 if(!(entry->kind==16 && entry->elem_kind==13)){if(0){r->report->widened++;
 ...
 (void)element_entry;
  ...
  if(!ship_entry_load_message_body_retain(r,&scratch, retention))return 0;
  retention=named_retention;
  }continue;
  }
  retention=table_retain_index(retention,(uint32_t)(slot));
  if(!ship_entry_load_message_body_retain(r,&value->ships[slot], retention))return 0;
 } }
 break;
 }
 case UINT64_C(0x9cda940a344e1571): {
 ...
 (void)element_entry;
  ...
  ShipEntry * item=i<kept ? &value->reserves[i] : &scratch;
  retention=table_retain_index(retention,(uint32_t)(i));
  if(!ship_entry_load_message_body_retain(r,&(*item), retention))return 0;
  }if(walk<n && !table_message_skip_run(r,n-walk,element_entry->value_bits))goto malformed;
  value->reserves_count=(int32_t)kept;
 }
 break;
