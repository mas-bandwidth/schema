...
static SCHEMA_UNUSED SCHEMA_TABLEDEMO_TABLE_INLINE void schema_tabledemo_root_config_fixed_write_body_( uint8_t * b, const RootConfig * value )
{
    ...
    memcpy( b + 4, value->version_note, 16 );
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != weapon_config_fixed_hash )
    {
        ...
        made = table_fixed_compile( &parsed, weapon_config_fixed_layout, (int32_t) sizeof( weapon_config_fixed_layout ), weapon_config_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != loadout_config_fixed_hash )
    {
        ...
        int32_t made;
        if ( !table_fixed_parse_layout( layout, (int64_t) layout_bytes, &parsed, &why ) ) { report->refused = 1; report->reason = why; return -1; }
        made = table_fixed_compile( &parsed, loadout_config_fixed_layout, (int32_t) sizeof( loadout_config_fixed_layout ), loadout_config_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
        if ( made < 0 ) { report->refused = 1; report->reason = ( made == -2 ) ? SCHEMA_TABLE_LAYOUT_MALFORMED : SCHEMA_TABLE_PLAN_TOO_LARGE; return -1; }
        entries = plan;
        entry_count = made;
        entry_guarded = compiled_guarded;
...
static SCHEMA_UNUSED const TableFixedEntry profile_config_fixed_plan[] = {
    { 0u, 36u, 32u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* name */
    { 36u, 56u, 16u, 40u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 3, 0, 0 }, /* icon */
    { 56u, 60u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* experience */
    { 61u, 66u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* heading */
    { 63u, 72u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* timestamp */
    { 72u, 82u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* port */
    { 74u, 88u, 33u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* epoch */
    { 107u, 128u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grade */
    { 108u, 136u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* grades count */
    { 112u, 129u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grades, whole */
    { 116u, 140u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* podium, whole */
    { 119u, 144u, 25u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* perks */
    { 144u, 172u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 149u, 180u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 166u, 200u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 171u, 208u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 188u, 228u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 193u, 300u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* attachments count */
    { 197u, 236u, 64u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* attachments, whole */
    { 145u, 176u, 4u, 0u, 144u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 145u, 176u, 4u, 0u, 144u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 167u, 204u, 4u, 0u, 166u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 167u, 204u, 4u, 0u, 166u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 189u, 232u, 4u, 0u, 188u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 189u, 232u, 4u, 0u, 188u, kTableFixedCopy, 2, 0, 0 }, /* amount */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != profile_config_fixed_hash )
    {
        ...
        int32_t made;
        if ( !table_fixed_parse_layout( layout, (int64_t) layout_bytes, &parsed, &why ) ) { report->refused = 1; report->reason = why; return -1; }
        made = table_fixed_compile( &parsed, profile_config_fixed_layout, (int32_t) sizeof( profile_config_fixed_layout ), profile_config_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
        if ( made < 0 ) { report->refused = 1; report->reason = ( made == -2 ) ? SCHEMA_TABLE_LAYOUT_MALFORMED : SCHEMA_TABLE_PLAN_TOO_LARGE; return -1; }
        entries = plan;
        entry_count = made;
        entry_guarded = compiled_guarded;
    ...
    for ( k = 0; k < count; ++k )
    {
        profile_config_reset( values + k ); /* the declared defaults, one prefill */
        if ( table_fixed_get64( at ) != hash ) { report->refused = 1; report->reason = SCHEMA_TABLE_NO_LAYOUT; return -1; }
        table_fixed_run( entries, entry_count, entry_guarded, at + 8, (uint8_t *) ( values + k ), report );
        at += record_bytes;
    }
...
static SCHEMA_UNUSED const TableFixedEntry root_config_fixed_plan[] = {
    { 0u, 20u, 16u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* version_note */
    { 20u, 248u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* weapons count */
    { 24u, 24u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 41u, 44u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 46u, 52u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 63u, 72u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 68u, 80u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 85u, 100u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 90u, 108u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 107u, 128u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 112u, 136u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 129u, 156u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 134u, 164u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 151u, 184u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 156u, 192u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 173u, 212u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 178u, 220u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 195u, 240u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 200u, 1472u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* profiles count */
    { 204u, 292u, 32u, 256u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* name */
    { 240u, 312u, 16u, 296u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 3, 0, 0 }, /* icon */
    { 260u, 316u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* experience */
    { 265u, 322u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* heading */
    { 267u, 328u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* timestamp */
    { 276u, 338u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* port */
    { 278u, 344u, 33u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* epoch */
    { 311u, 384u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grade */
    { 312u, 392u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* grades count */
    { 316u, 385u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grades, whole */
    { 320u, 396u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* podium, whole */
    { 323u, 400u, 25u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* perks */
    { 348u, 428u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 353u, 436u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 370u, 456u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 375u, 464u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 392u, 484u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 397u, 556u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* attachments count */
    { 401u, 492u, 64u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* attachments, whole */
    { 465u, 596u, 32u, 560u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* name */
    { 501u, 616u, 16u, 600u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 3, 0, 0 }, /* icon */
    { 521u, 620u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* experience */
    { 526u, 626u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* heading */
    { 528u, 632u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* timestamp */
    { 537u, 642u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* port */
    { 539u, 648u, 33u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* epoch */
    { 572u, 688u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grade */
    { 573u, 696u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* grades count */
    { 577u, 689u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grades, whole */
    { 581u, 700u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* podium, whole */
    { 584u, 704u, 25u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* perks */
    { 609u, 732u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 614u, 740u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 631u, 760u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 636u, 768u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 653u, 788u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 658u, 860u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* attachments count */
    { 662u, 796u, 64u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* attachments, whole */
    { 726u, 900u, 32u, 864u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* name */
    { 762u, 920u, 16u, 904u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 3, 0, 0 }, /* icon */
    { 782u, 924u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* experience */
    { 787u, 930u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* heading */
    { 789u, 936u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* timestamp */
    { 798u, 946u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* port */
    { 800u, 952u, 33u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* epoch */
    { 833u, 992u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grade */
    { 834u, 1000u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* grades count */
    { 838u, 993u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grades, whole */
    { 842u, 1004u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* podium, whole */
    { 845u, 1008u, 25u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* perks */
    { 870u, 1036u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 875u, 1044u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 892u, 1064u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 897u, 1072u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 914u, 1092u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 919u, 1164u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* attachments count */
    { 923u, 1100u, 64u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* attachments, whole */
    { 987u, 1204u, 32u, 1168u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 1, 0, 0 }, /* name */
    { 1023u, 1224u, 16u, 1208u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedText, 3, 0, 0 }, /* icon */
    { 1043u, 1228u, 5u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* experience */
    { 1048u, 1234u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* heading */
    { 1050u, 1240u, 9u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* timestamp */
    { 1059u, 1250u, 2u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* port */
    { 1061u, 1256u, 33u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* epoch */
    { 1094u, 1296u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grade */
    { 1095u, 1304u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* grades count */
    { 1099u, 1297u, 4u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* grades, whole */
    { 1103u, 1308u, 3u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* podium, whole */
    { 1106u, 1312u, 25u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* perks */
    { 1131u, 1340u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 1136u, 1348u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 1153u, 1368u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 1158u, 1376u, 17u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 1175u, 1396u, 1u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* effect tag */
    { 1180u, 1468u, 8u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCount, 0, 0, 0 }, /* attachments count */
    { 1184u, 1404u, 64u, 0u, SCHEMA_TABLE_FIXED_NO_GUARD, kTableFixedCopy, 0, 0, 0 }, /* attachments, whole */
    { 42u, 48u, 4u, 0u, 41u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 42u, 48u, 4u, 0u, 41u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 64u, 76u, 4u, 0u, 63u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 64u, 76u, 4u, 0u, 63u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 86u, 104u, 4u, 0u, 85u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 86u, 104u, 4u, 0u, 85u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 108u, 132u, 4u, 0u, 107u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 108u, 132u, 4u, 0u, 107u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 130u, 160u, 4u, 0u, 129u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 130u, 160u, 4u, 0u, 129u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 152u, 188u, 4u, 0u, 151u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 152u, 188u, 4u, 0u, 151u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 174u, 216u, 4u, 0u, 173u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 174u, 216u, 4u, 0u, 173u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 196u, 244u, 4u, 0u, 195u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 196u, 244u, 4u, 0u, 195u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 349u, 432u, 4u, 0u, 348u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 349u, 432u, 4u, 0u, 348u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 371u, 460u, 4u, 0u, 370u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 371u, 460u, 4u, 0u, 370u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 393u, 488u, 4u, 0u, 392u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 393u, 488u, 4u, 0u, 392u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 610u, 736u, 4u, 0u, 609u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 610u, 736u, 4u, 0u, 609u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 632u, 764u, 4u, 0u, 631u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 632u, 764u, 4u, 0u, 631u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 654u, 792u, 4u, 0u, 653u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 654u, 792u, 4u, 0u, 653u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 871u, 1040u, 4u, 0u, 870u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 871u, 1040u, 4u, 0u, 870u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 893u, 1068u, 4u, 0u, 892u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 893u, 1068u, 4u, 0u, 892u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 915u, 1096u, 4u, 0u, 914u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 915u, 1096u, 4u, 0u, 914u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 1132u, 1344u, 4u, 0u, 1131u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 1132u, 1344u, 4u, 0u, 1131u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 1154u, 1372u, 4u, 0u, 1153u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 1154u, 1372u, 4u, 0u, 1153u, kTableFixedCopy, 2, 0, 0 }, /* amount */
    { 1176u, 1400u, 4u, 0u, 1175u, kTableFixedCopy, 1, 0, 0 }, /* multiplier */
    { 1176u, 1400u, 4u, 0u, 1175u, kTableFixedCopy, 2, 0, 0 }, /* amount */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != root_config_fixed_hash )
    {
        ...
        int32_t made;
        if ( !table_fixed_parse_layout( layout, (int64_t) layout_bytes, &parsed, &why ) ) { report->refused = 1; report->reason = why; return -1; }
        made = table_fixed_compile( &parsed, root_config_fixed_layout, (int32_t) sizeof( root_config_fixed_layout ), root_config_fixed_dst, plan, plan_capacity, &compiled_guarded, report );
        if ( made < 0 ) { report->refused = 1; report->reason = ( made == -2 ) ? SCHEMA_TABLE_LAYOUT_MALFORMED : SCHEMA_TABLE_PLAN_TOO_LARGE; return -1; }
        entries = plan;
        entry_count = made;
        entry_guarded = compiled_guarded;
    ...
    for ( k = 0; k < count; ++k )
    {
        root_config_reset( values + k ); /* the declared defaults, one prefill */
        if ( table_fixed_get64( at ) != hash ) { report->refused = 1; report->reason = SCHEMA_TABLE_NO_LAYOUT; return -1; }
        table_fixed_run( entries, entry_count, entry_guarded, at + 8, (uint8_t *) ( values + k ), report );
        at += record_bytes;
    }
