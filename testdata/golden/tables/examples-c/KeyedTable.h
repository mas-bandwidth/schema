...
static SCHEMA_UNUSED const TableFixedGuard team_config_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t team_config_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry team_config_fixed_plan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* spawn_count */
    { 4u, 24u, 16u, 4u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* banner */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) team_config_fixed_guards;
...
/* THE GUARD POOL: every chain the plan's entries name, laid once and
   ...
   union first, and it is as long as the nesting is deep: there is no bound
   on how many unions may nest (§5.9). */
static SCHEMA_UNUSED const TableFixedGuard gunner_config_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t gunner_config_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry gunner_config_fixed_plan[] = {
    { 0u, 0u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) gunner_config_fixed_guards;
...
/* THE GUARD POOL: every chain the plan's entries name, laid once and
   ...
   union first, and it is as long as the nesting is deep: there is no bound
   on how many unions may nest (§5.9). */
static SCHEMA_UNUSED const TableFixedGuard turret_config_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t turret_config_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry turret_config_fixed_plan[] = {
    { 0u, 0u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 8u, 16u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 9u, 8u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) turret_config_fixed_guards;
...
/* THE GUARD POOL: every chain the plan's entries name, laid once and
   ...
   union first, and it is as long as the nesting is deep: there is no bound
   on how many unions may nest (§5.9). */
static SCHEMA_UNUSED const TableFixedGuard hull_config_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t hull_config_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry hull_config_fixed_plan[] = {
    { 0u, 0u, 16u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* health */
    { 16u, 24u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 17u, 16u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 22u, 28u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 30u, 44u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 31u, 36u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 36u, 48u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 44u, 64u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 45u, 56u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) hull_config_fixed_guards;
...
/* THE GUARD POOL: every chain the plan's entries name, laid once and
   ...
   union first, and it is as long as the nesting is deep: there is no bound
   on how many unions may nest (§5.9). */
static SCHEMA_UNUSED const TableFixedGuard keyed_config_fixed_guards[] = {
    { 0u, 0u, 0u, 1u } /* no union in this type: the pool names no condition */
};
static SCHEMA_UNUSED const int32_t keyed_config_fixed_guard_count = 0;
...
static SCHEMA_UNUSED const TableFixedEntry keyed_config_fixed_plan[] = {
    { 0u, 0u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* spawn_count */
    { 4u, 24u, 16u, 4u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* banner */
    { 24u, 28u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* spawn_count */
    { 28u, 52u, 16u, 32u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* banner */
    { 48u, 56u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* spawn_count */
    { 52u, 80u, 16u, 60u, 0u, 0, kTableFixedText, 1, 0, 0 }, /* banner */
    { 72u, 84u, 16u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* health */
    { 88u, 108u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 89u, 100u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 94u, 112u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 102u, 128u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 103u, 120u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 108u, 132u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 116u, 148u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 117u, 140u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 122u, 152u, 16u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* health */
    { 138u, 176u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 139u, 168u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 144u, 180u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 152u, 196u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 153u, 188u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 158u, 200u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 166u, 216u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 167u, 208u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 172u, 220u, 16u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* health */
    { 188u, 244u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 189u, 236u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 194u, 248u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 202u, 264u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 203u, 256u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 208u, 268u, 8u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* damage */
    { 216u, 284u, 1u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* gunner present */
    { 217u, 276u, 5u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* reaction */
    { 222u, 288u, 12u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, /* per_team, whole */
};
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) keyed_config_fixed_guards;
