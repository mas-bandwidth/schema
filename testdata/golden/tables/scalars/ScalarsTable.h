...
{
    return 1 + 4 + SimStateFixedLayoutBytes + count * SimStateFixedRecordBytes;
}
...
inline int64_t SimStateFixedSave( const SimState * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) SimStateFixedLayoutBytes );
    memcpy( buffer + 5, SimStateFixedLayout, (size_t) SimStateFixedLayoutBytes );
    uint8_t * at = buffer + 5 + SimStateFixedLayoutBytes;
