...
constexpr uint64_t SimStateFixedHash = 0x1b3ae43f63f8eaddull; // fnv1a64 over the block's bytes
...
constexpr uint8_t SimStateFixedVocab[] = {
...
constexpr int64_t SimStateFixedVocabBytes = (int64_t) sizeof( SimStateFixedVocab );
...
{
    return 1 + 4 + SimStateFixedVocabBytes + count * SimStateFixedRecordBytes;
}
...
inline int64_t SimStateFixedSave( const SimState * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) SimStateFixedVocabBytes );
    memcpy( buffer + 5, SimStateFixedVocab, (size_t) SimStateFixedVocabBytes );
    uint8_t * at = buffer + 5 + SimStateFixedVocabBytes;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != SimStateFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, SimStateFixedVocab, (int32_t) SimStateFixedVocabBytes, SimStateFixedDst, plan, plan_capacity, &compiled_guarded, report );
