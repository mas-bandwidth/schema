    ...
    for ( ;; )
    {
        ...
        switch ( entry.id )
        {
            case 0x1e5088ef2e9bafc6ull: // tilt
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 20, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
            ...
            case 0x401ab8cd06158638ull: // angle
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 22, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
                    if ( width < 0 || !r.get( raw, width ) ) { report->malformed = true; return false; }
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
            ...
            case 0x4cbf3a26fca1d74aull: // position
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 23, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
                    if ( width < 0 || !r.get( raw, width ) ) { report->malformed = true; return false; }
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
            ...
            case 0x891da1f305deb858ull: // reach
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 24, entry.packing, entry.value_bits );
            ...
            case 0xfbc924118177ade4ull: // ratio
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 25, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
                    if ( width < 0 || !r.get( raw, width ) ) { report->malformed = true; return false; }
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
            ...
            case 0x2281498aa0200e40ull: // speed
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 27, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
                    if ( width < 0 || !r.get( raw, width ) ) { report->malformed = true; return false; }
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
            ...
            case 0x8b7dc019093cd0e1ull: // span
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 28, entry.packing, entry.value_bits );
                    uint64_t raw = 0;
                    if ( width < 0 || !r.get( raw, width ) ) { report->malformed = true; return false; }
                    int64_t decoded_wide = (int64_t) raw;
                    if ( entry.packing == 1 ) { decoded_wide = (int64_t) ( raw + (uint64_t) entry.base_lo ); }
            ...
            case 0x1f3757a2ce7b0ab1ull: // mass
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 29, entry.packing, entry.value_bits );
                    uint64_t lo_v = 0, hi_v = 0;
                    if ( width < 0 || !r.get( lo_v, width < 64 ? width : 64 ) || ( width > 64 && !r.get( hi_v, width - 64 ) ) ) { report->malformed = true; return false; }
                    serialize::uint128_t raw_v = ( serialize::uint128_t( hi_v ) << 64 ) | serialize::uint128_t( lo_v );
                    if ( entry.packing == 1 ) { raw_v = raw_v + ( ( serialize::uint128_t( (uint64_t) entry.base_hi ) << 64 ) | serialize::uint128_t( (uint64_t) entry.base_lo ) ); }
            ...
            case 0xd61bdd7908af2642ull: // flux
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 18, entry.packing, entry.value_bits );
                    uint64_t lo_v = 0, hi_v = 0;
                    if ( width < 0 || !r.get( lo_v, width < 64 ? width : 64 ) || ( width > 64 && !r.get( hi_v, width - 64 ) ) ) { report->malformed = true; return false; }
                    serialize::uint128_t raw_v = ( serialize::uint128_t( hi_v ) << 64 ) | serialize::uint128_t( lo_v );
                    if ( entry.packing == 1 ) { raw_v = raw_v + ( ( serialize::uint128_t( (uint64_t) entry.base_hi ) << 64 ) | serialize::uint128_t( (uint64_t) entry.base_lo ) ); }
            ...
            case 0x23fcfd6678e36712ull: // entity_id
            {
                ...
                {
                    const int64_t width = TableMessageValueBits( 19, entry.packing, entry.value_bits );
                    uint64_t lo_v = 0, hi_v = 0;
                    if ( width < 0 || !r.get( lo_v, width < 64 ? width : 64 ) || ( width > 64 && !r.get( hi_v, width - 64 ) ) ) { report->malformed = true; return false; }
                    serialize::uint128_t raw_v = ( serialize::uint128_t( hi_v ) << 64 ) | serialize::uint128_t( lo_v );
                    if ( entry.packing == 1 ) { raw_v = raw_v + ( ( serialize::uint128_t( (uint64_t) entry.base_hi ) << 64 ) | serialize::uint128_t( (uint64_t) entry.base_lo ) ); }
            ...
            case 0xe3b1ca6a3b48dddcull: // samples
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        int32_t scratch = 0;
                        {
                            const int64_t width_2 = TableMessageValueBits( 22, entry.elem_packing, entry.elem_value_bits );
                            uint64_t raw_2 = 0;
            ...
            case 0xb1494b6ef08a411eull: // weights
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        uint16_t scratch = 0;
                        {
                            const int64_t width_2 = TableMessageValueBits( 26, entry.elem_packing, entry.elem_value_bits );
                            uint64_t raw_2 = 0;
                            if ( width_2 < 0 || !r.get( raw_2, width_2 ) ) { report->malformed = true; return false; }
                            int64_t decoded_wide_2 = (int64_t) raw_2;
                            if ( entry.elem_packing == 1 ) { decoded_wide_2 = (int64_t) ( raw_2 + (uint64_t) entry.elem_base_lo ); }
            ...
            case 0x32969e840d9c67b8ull: // axes
            {
                ...
                }
                {
                    ...
                    for ( uint64_t p = 0; p < n; p++ )
                    {
                        ...
                        int64_t scratch = 0;
                        {
                            const int64_t width_2 = TableMessageValueBits( 23, entry.elem_packing, entry.elem_value_bits );
                            uint64_t raw_2 = 0;
                            if ( width_2 < 0 || !r.get( raw_2, width_2 ) ) { report->malformed = true; return false; }
                            int64_t decoded_wide_2 = (int64_t) raw_2;
                            if ( entry.elem_packing == 1 ) { decoded_wide_2 = (int64_t) ( raw_2 + (uint64_t) entry.elem_base_lo ); }
            ...
            case 0x5af1ac301b4ae16dull: // seeds
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        {
                            const int64_t width_2 = TableMessageValueBits( 19, entry.elem_packing, entry.elem_value_bits );
