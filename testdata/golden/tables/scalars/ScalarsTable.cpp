...
// package scalardemo — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several scalardemo Table.cpp files may be
...
#ifndef SCALARDEMO_SCHEMA_TABLE_JSON
#define SCALARDEMO_SCHEMA_TABLE_JSON
