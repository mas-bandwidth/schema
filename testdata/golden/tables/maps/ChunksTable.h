...
// table ChunksBlobsEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct ChunksBlobsEntry {
    int32_t key = 0;
    TableRef value; // *bytes — a byte buffer at its used size, null until assigned
};

// table Chunks — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Chunks {
    TableMap<ChunksBlobsEntry> blobs; // map[int32]*bytes — the sorted entry array, empty until an insert
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void ChunksBlobsEntryReset( ChunksBlobsEntry & value );
inline void ChunksReset( Chunks & value );

inline void ChunksBlobsEntryReset( ChunksBlobsEntry & value )
{
    value.key = 0;
    value.value.value = 0; // *bytes — null
}
...
template <typename Ctx> inline int64_t ChunksBlobsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ChunksBlobsEntry & value );
template <typename Ctx> inline bool ChunksBlobsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ChunksBlobsEntry & value );
inline bool ChunksBlobsEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, ChunksBlobsEntry & value );
template <typename Ctx> inline int64_t ChunksMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Chunks & value );
template <typename Ctx> inline bool ChunksSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Chunks & value );
inline bool ChunksLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Chunks & value );
inline bool ChunksMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// ChunksBlobsEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct ChunksBlobsEntryMessageKeyRead
{
    int32_t key;
...
inline ChunksBlobsEntryMessageKeyRead ChunksBlobsEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    ChunksBlobsEntryMessageKeyRead out = { 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( ChunksBlobsEntry & value ) { ChunksBlobsEntryReset( value ); }
inline void TableReset( Chunks & value ) { ChunksReset( value ); }
...
template <typename Ctx> inline int64_t ChunksBlobsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ChunksBlobsEntry & value );
template <typename Ctx> inline bool ChunksBlobsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ChunksBlobsEntry & value );
template <typename Ctx> inline bool ChunksBlobsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ChunksBlobsEntry & value );
inline bool ChunksBlobsEntryLoadBody( TableReader & r, const TableNodeMap & nodes, ChunksBlobsEntry & value );
template <typename Ctx> inline int64_t ChunksMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Chunks & value );
template <typename Ctx> inline bool ChunksSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Chunks & value );
template <typename Ctx> inline bool ChunksSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Chunks & value );
...
template <typename Ctx> inline bool ChunksBlobsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const ChunksBlobsEntry & value );
template <typename Ctx> inline int64_t ChunksBlobsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const ChunksBlobsEntry & value );
template <typename Ctx> inline bool ChunksBlobsEntryPack( const Ctx & ctx, TablePackMap & seen, const ChunksBlobsEntry & src, ChunksBlobsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool ChunksNumber( const Ctx & ctx, TableNumbering & numbering, const Chunks & value );
template <typename Ctx> inline int64_t ChunksPackMeasure( const Ctx & ctx, TablePackMap & seen, const Chunks & value );
template <typename Ctx> inline bool ChunksPack( const Ctx & ctx, TablePackMap & seen, const Chunks & src, Chunks & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ChunksBlobsEntry & value ) { return ChunksBlobsEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ChunksBlobsEntry & value ) { return ChunksBlobsEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ChunksBlobsEntry & value ) { return ChunksBlobsEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ChunksBlobsEntry & value ) { return ChunksBlobsEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Chunks & value ) { return ChunksMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Chunks & value ) { return ChunksSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Chunks & value ) { return ChunksMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Chunks & value ) { return ChunksSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- ChunksBlobsEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( ChunksBlobsEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );

inline int TableEntryOrder( const ChunksBlobsEntry & a, const ChunksBlobsEntry & b )
{
    return TableKeyOrder( (int64_t) a.key, (int64_t) b.key ); // integers compare by VALUE, signed here
}
inline int TableEntryOrder( const ChunksBlobsEntry & entry, int32_t key )
{
    return TableKeyOrder( (int64_t) entry.key, (int64_t) key );
}
inline int32_t TableEntryKey( const ChunksBlobsEntry & entry ) { return entry.key; }
inline void TableEntrySetKey( ChunksBlobsEntry & entry, int32_t key ) { entry.key = key; }
...
inline const TableBlob * TableEntryFound( const ChunksBlobsEntry * entry ) { return entry != NULL ? TableBlobAt( entry->value ) : NULL; }
inline TableRef * TableEntryValue( ChunksBlobsEntry * entry ) { return &entry->value; } // the builder hands back the SLOT
struct ChunksBlobsEntryEach { int32_t key; decltype( TableEntryValue( (ChunksBlobsEntry *) NULL ) ) value; };
inline ChunksBlobsEntryEach TableEntryEach( ChunksBlobsEntry * entry ) { return ChunksBlobsEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( ChunksBlobsEntry & value )
{
    value.value.value = 0; // *bytes — null
}

// ChunksBlobsEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
struct ChunksBlobsEntryKeyRead
{
    int32_t key;
    bool found;         // the body carried the key's id
    bool kind_bad;      // it carried it under another kind: the MAP's event
...
inline ChunksBlobsEntryKeyRead ChunksBlobsEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    ChunksBlobsEntryKeyRead out = { 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t ChunksBlobsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ChunksBlobsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ChunksBlobsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool ChunksBlobsEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t ChunksMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ChunksSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ChunksSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool ChunksLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Chunks & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t ChunksBlobsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const ChunksBlobsEntry & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref( 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
        const TableBlob * blob_value = TableBlobAt( ctx, value.value ); // *bytes
...
template <typename Ctx>
inline bool ChunksBlobsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ChunksBlobsEntry & value )
{
    if ( value.key != 0 )
    {
...
template <typename Ctx>
inline bool ChunksBlobsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const ChunksBlobsEntry & value )
{
    if ( !ChunksBlobsEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
        ...
        switch ( field_id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    ...
                    TableNodeResolve( nodes, value.value, node_index, kTableBytesTypeId, r.report ); // *bytes
                }
                break;
            }
...
template <typename Ctx>
inline int64_t ChunksBlobsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const ChunksBlobsEntry & value )
{
    ...
    {
        const TableBlob * pointee_value = TableBlobAt( ctx, value.value ); // *bytes: a byte buffer
...
template <typename Ctx>
inline bool ChunksBlobsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const ChunksBlobsEntry & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.key != 0 )
    {
        ...
        switch ( entry.id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                }
                {
                    ...
                    TableNodeResolve( nodes, value.value, node_index, kTableBytesTypeId, report ); // *bytes
                }
                break;
            }
            default:
...
template <typename Ctx>
inline int64_t ChunksMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Chunks & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // blobs: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<ChunksBlobsEntry> order_blobs = TableMapOrder( ctx, value.blobs );
        ...
        if ( order_blobs.count > 0 )
        {
            ...
            {
                const int64_t elem_blobs = ChunksBlobsEntryMeasureBody( ctx, numbering, ids, *order_blobs[i] );
...
template <typename Ctx>
inline bool ChunksSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Chunks & value )
{
    {
        TableMapCursor<ChunksBlobsEntry> order_blobs = TableMapOrder( ctx, value.blobs ); // blobs
        ...
        if ( order_blobs.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_blobs.count; i++ )
            {
                const int64_t elem_len_blobs = ChunksBlobsEntryMeasureBody( ctx, numbering, ids, *order_blobs[i] );
                if ( elem_len_blobs < 0 ) { TableMapRelease( order_blobs ); return false; }
                w.putleb( (uint64_t) elem_len_blobs );
                if ( !ChunksBlobsEntrySaveBody( ctx, numbering, w, ids, *order_blobs[i] ) ) { TableMapRelease( order_blobs ); return false; }
            }
        }
        TableMapRelease( order_blobs );
    }
...
template <typename Ctx>
inline bool ChunksSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Chunks & value )
{
    if ( !ChunksSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x14e2eaab9cde925bull: // blobs
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        ChunksBlobsEntryKeyRead read = ChunksBlobsEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t ChunksMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Chunks & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_blobs.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_blobs.count; i++ )
            {
                const int64_t elem_blobs = ChunksBlobsEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_blobs[i] );
                if ( elem_blobs < 0 ) { TableMapRelease( order_blobs ); return -1; }
...
// body is self-delimiting: it is written where the file form put an L.
template <typename Ctx>
inline bool ChunksSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Chunks & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableMapCursor<ChunksBlobsEntry> order_blobs = TableMapOrder( ctx, value.blobs ); // blobs
        ...
        if ( order_blobs.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_blobs.count; i++ )
            {
                if ( !ChunksBlobsEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_blobs[i] ) ) { TableMapRelease( order_blobs ); return false; }
            }
        }
        TableMapRelease( order_blobs );
    }
...
// ChunksMessageExtent: the extent Chunks's maps command on the message wire, from
...
inline bool ChunksMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x14e2eaab9cde925bull && entry.kind == 14 && entry.elem_kind == 13 ) // blobs
        {
            ...
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( ChunksBlobsEntry )
            at += (int64_t) n * (int64_t) sizeof( ChunksBlobsEntry ); // the whole array FIRST
        ...
        switch ( entry.id )
        {
            case 0x14e2eaab9cde925bull: // blobs
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const ChunksBlobsEntryMessageKeyRead read = ChunksBlobsEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !ChunksBlobsEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// ChunksBlobsEntryWireExtent: the extent ChunksBlobsEntry's lists and maps command, from the FRAMING alone.
...
inline bool ChunksBlobsEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// ChunksBlobsEntryExtentAt: the node extent ChunksBlobsEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as ChunksBlobsEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool ChunksBlobsEntryExtentAt( const Ctx & ctx, const ChunksBlobsEntry & value, int64_t & at )
{
...
template <typename Ctx>
inline int64_t ChunksBlobsEntryExtent( const Ctx & ctx, const ChunksBlobsEntry & value )
{
    (void) ctx; (void) value; // no list or map below this record
    return 0;
}

// ChunksBlobsEntryExtentPack: carve ChunksBlobsEntry's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset ChunksBlobsEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool ChunksBlobsEntryExtentPack( const Ctx & ctx, const ChunksBlobsEntry & src, ChunksBlobsEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// ChunksWireExtent: the extent Chunks's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool ChunksWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0x14e2eaab9cde925bull && field_kind == 14 ) // blobs
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( ChunksBlobsEntry ), (int64_t) alignof( ChunksBlobsEntry ), NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// ChunksExtentAt: the node extent Chunks's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as ChunksExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool ChunksExtentAt( const Ctx & ctx, const Chunks & value, int64_t & at )
{
    {
        TableMapCursor<ChunksBlobsEntry> cursor = TableMapOrder( ctx, value.blobs );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( ChunksBlobsEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( ChunksBlobsEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !ChunksBlobsEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
template <typename Ctx>
inline int64_t ChunksExtent( const Ctx & ctx, const Chunks & value )
{
    int64_t at = 0;
    if ( !ChunksExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// ChunksExtentPack: carve Chunks's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset ChunksExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool ChunksExtentPack( const Ctx & ctx, const Chunks & src, Chunks & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<ChunksBlobsEntry> cursor = TableMapOrder( ctx, src.blobs );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( ChunksBlobsEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        ChunksBlobsEntry * placed = (ChunksBlobsEntry *) ( extent + at );
        at += bytes;
        ...
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( ChunksBlobsEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !ChunksBlobsEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Chunks.blobs: the builder's five and the side index (§2.8) ----
...
inline TableRef * ChunksBlobsInsert( TableWorker & worker, TableMap<ChunksBlobsEntry> & map, int32_t key )
{
    ChunksBlobsEntry * entry = TableMapPlace( worker, map, key );
...
inline TableRef * ChunksBlobsFind( TableArena & arena, TableMap<ChunksBlobsEntry> & map, int32_t key )
{
    ChunksBlobsEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool ChunksBlobsErase( TableArena & arena, TableMap<ChunksBlobsEntry> & map, int32_t key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<ChunksBlobsEntry> ChunksBlobsEach( const TableArena & arena, const TableMap<ChunksBlobsEntry> & map )
{
...
inline int64_t ChunksBlobsIndexMeasure( const TableMap<ChunksBlobsEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex ChunksBlobsIndex( const TableMap<ChunksBlobsEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const ChunksBlobsEntry * entries = map.Entries();
...
inline const TableBlob * ChunksBlobsIndexFind( const TableMapIndex & index, const TableMap<ChunksBlobsEntry> & map, int32_t key )
{
...
// ChunksBlobsEntryNumber: number everything ChunksBlobsEntry POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool ChunksBlobsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const ChunksBlobsEntry & value )
{
    {
...
// ChunksBlobsEntryPackMeasure: the packed region bytes of everything ChunksBlobsEntry POINTS AT.
...
template <typename Ctx>
inline int64_t ChunksBlobsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const ChunksBlobsEntry & value )
{
    int64_t bytes = 0;
    {
...
// ChunksBlobsEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool ChunksBlobsEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const ChunksBlobsEntry & src, ChunksBlobsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool ChunksBlobsEntryPack( const Ctx & ctx, TablePackMap & seen, const ChunksBlobsEntry & src, ChunksBlobsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( ChunksBlobsEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( ChunksBlobsEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !ChunksBlobsEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return ChunksBlobsEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
// ChunksNumber: number everything Chunks POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool ChunksNumber( const Ctx & ctx, TableNumbering & numbering, const Chunks & value )
{
    { // blobs: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<ChunksBlobsEntry> cursor_blobs = TableMapOrder( ctx, value.blobs );
        if ( !cursor_blobs.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_blobs.count; i++ )
        {
            if ( !ChunksBlobsEntryNumber( ctx, numbering, *cursor_blobs[i] ) ) { TableMapRelease( cursor_blobs ); return false; }
        }
        TableMapRelease( cursor_blobs );
    }
    return true;
}

// ChunksPackMeasure: the packed region bytes of everything Chunks POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t ChunksPackMeasure( const Ctx & ctx, TablePackMap & seen, const Chunks & value )
{
    int64_t bytes = 0;
    { // blobs: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<ChunksBlobsEntry> cursor_blobs = TableMapOrder( ctx, value.blobs );
        if ( !cursor_blobs.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_blobs.count; i++ )
        {
            int64_t inner = ChunksBlobsEntryPackMeasure( ctx, seen, *cursor_blobs[i] );
            if ( inner < 0 ) { TableMapRelease( cursor_blobs ); return -1; }
            bytes += inner;
        }
        TableMapRelease( cursor_blobs );
    }
...
// ChunksPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool ChunksPackEdges( const Ctx & ctx, TablePackMap & seen, const Chunks & src, Chunks & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool ChunksPack( const Ctx & ctx, TablePackMap & seen, const Chunks & src, Chunks & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Chunks ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Chunks ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !ChunksExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return ChunksPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // blobs: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<ChunksBlobsEntry> cursor_blobs = TableMapOrder( ctx, src.blobs );
        if ( !cursor_blobs.ok ) { return false; }
        ChunksBlobsEntry * placed_blobs = (ChunksBlobsEntry *) ( dst.blobs.entries.value != 0 ? ( (uint8_t *) &dst.blobs.entries + dst.blobs.entries.value ) : NULL );
        for ( int32_t i = 0; i < cursor_blobs.count; i++ )
        {
            if ( !ChunksBlobsEntryPackEdges( ctx, seen, *cursor_blobs[i], placed_blobs[i], base, capacity, used ) ) { TableMapRelease( cursor_blobs ); return false; }
        }
        TableMapRelease( cursor_blobs );
    }
    return true;
...
// ---- Chunks: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: ChunksBuilder — allocate nodes, wire them together, then Lock.
...
// Chunks is never held by value — a file-format-scale structure is a region
...
struct ChunksBuilder
{
    ...
    ChunksBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Chunks * GetRoot() { return arena.locked ? NULL : (Chunks *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Chunks * AsConst() const { return (const Chunks *) region; }
...
inline bool ChunksBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Chunks & root = *(const Chunks *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Chunks on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// ChunksNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t ChunksNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    switch ( type_id )
    {
...
// ChunksNodePlace: start one record's node's lifetime in the storage pass one
...
inline void ChunksNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    switch ( type_id )
    {
...
// ChunksNodeRecordBytes: one record's OWN storage, before the extent its maps
...
// ChunksNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t ChunksNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    switch ( type_id )
    {
...
// ChunksNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void ChunksNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = ChunksNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? ChunksNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// ChunksNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t ChunksNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) extent;
    switch ( type_id )
    {
...
// ChunksNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool ChunksNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// ChunksNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool ChunksNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + ChunksNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !ChunksNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool ChunksNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Chunks & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return ChunksNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t ChunksMeasureWire( const Ctx & ctx, const Chunks & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( ChunksNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = ChunksMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t ChunksSaveWire( const Ctx & ctx, const Chunks & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !ChunksNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = ChunksSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == ChunksMeasure( root )
}

inline int64_t ChunksMeasure( const Chunks * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ChunksMeasureWire( ctx, *root, allocator );
}

inline int64_t ChunksSave( const Chunks * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ChunksSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t ChunksMeasure( const ChunksBuilder & builder )
{
    if ( builder.region != NULL ) { return ChunksMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ChunksMeasureWire( ctx, *(const Chunks *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t ChunksSave( const ChunksBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return ChunksSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ChunksSaveWire( ctx, *(const Chunks *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Chunks on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// ChunksMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t ChunksMessageBodyBits( const Ctx & ctx, const Chunks & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( ChunksNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = ChunksMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool ChunksMessageBodySave( const Ctx & ctx, const Chunks & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && ChunksSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t ChunksMeasureMessages( const Chunks * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = ChunksMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t ChunksSaveMessages( const Chunks * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !ChunksMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == ChunksMeasureMessages( roots, count, report, allocator )
}

// ChunksMessageRecordScan: one node record's type id and the extent its maps
...
inline bool ChunksMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return ChunksNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// ChunksMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool ChunksMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ChunksMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = ChunksNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !ChunksMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Chunks ) ) + root_extent );
    return true;
}

// ChunksLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t ChunksLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !ChunksMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// ChunksLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool ChunksLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Chunks * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !ChunksMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = ChunksNodeMessageStorage( type_id, extent, length );
        ...
        ChunksNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !ChunksMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Chunks ) ) + root_extent );
    ...
    Chunks * root = new ( region + used ) Chunks; // lifetime only: LoadMessageBody's first act is ChunksReset
    ChunksReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Chunks ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ChunksNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return ChunksLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// ChunksLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool ChunksLoadMessages( const Chunks ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !ChunksLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// ChunksLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t ChunksLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !ChunksWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Chunks ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = ChunksNodeStorage( type_id, length, reason );
...
// ChunksLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Chunks * ChunksLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Chunks ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !ChunksWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Chunks ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x816c207ba6213983ull;
    Chunks * root = new ( region ) Chunks; // lifetime only: LoadBody's first act is ChunksReset
    ChunksReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                ChunksNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Chunks ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    ChunksLoadBody( r, nodes, *root );
    return root;
}

// ChunksLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool ChunksLoadBuilder( ChunksBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = ChunksNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = ChunksLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t ChunksBlobsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref( 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
...
template <typename Ctx>
inline bool ChunksBlobsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key != 0 )
    {
        w.putleb( ids.ref( 0x3dc94a19365b10ecull ) ); w.put8( 4 ); // key
...
template <typename Ctx>
inline bool ChunksBlobsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const ChunksBlobsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !ChunksBlobsEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t ChunksMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // blobs: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_blobs.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_blobs.count; i++ )
            {
                const int64_t elem_blobs = ChunksBlobsEntryMeasureBodyRetain( ctx, numbering, ids, *order_blobs[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_blobs < 0 ) { TableMapRelease( order_blobs ); return -1; }
                body_blobs += TableLebBytes( (uint64_t) ( elem_blobs ) ) + ( elem_blobs ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_blobs ) + 1 + TableLebBytes( (uint64_t) ( body_blobs ) ) + ( body_blobs );
...
template <typename Ctx>
inline bool ChunksSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<ChunksBlobsEntry> order_blobs = TableMapOrder( ctx, value.blobs ); // blobs
        if ( !order_blobs.ok ) { return false; }
        if ( order_blobs.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_blobs.count; i++ )
            {
                const int64_t elem_len_blobs = ChunksBlobsEntryMeasureBodyRetain( ctx, numbering, ids, *order_blobs[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_blobs < 0 ) { TableMapRelease( order_blobs ); return false; }
                w.putleb( (uint64_t) elem_len_blobs );
                if ( !ChunksBlobsEntrySaveBodyRetain( ctx, numbering, w, ids, *order_blobs[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_blobs ); return false; }
            }
        }
        TableMapRelease( order_blobs );
    }
...
template <typename Ctx>
inline bool ChunksSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Chunks & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !ChunksSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x14e2eaab9cde925bull: // blobs
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !ChunksBlobsEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// ChunksNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void ChunksNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// ChunksLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Chunks * ChunksLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                ChunksNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    ChunksLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// ChunksNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool ChunksNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + ChunksNodeRecordBytes( type_id );
    carve.left = 0;
...
inline bool ChunksLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Chunks * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ChunksNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return ChunksLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// ChunksLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool ChunksLoadRetainMessages( const Chunks ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !ChunksLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// ChunksMeasureRetain and ChunksSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t ChunksMeasureWireRetain( const Ctx & ctx, const Chunks & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( ChunksNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = ChunksMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t ChunksSaveWireRetain( const Ctx & ctx, const Chunks & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = ChunksSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t ChunksMeasureRetain( const Chunks * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ChunksMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t ChunksSaveRetain( const Chunks * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ChunksSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// ChunksSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH ChunksAt: the slot holds
...
// parameter on a load.
inline const Chunks * ChunksOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Chunks *) TableCookOpen( bytes, length, (uint64_t) sizeof( Chunks ), (uint64_t) alignof( Chunks ), reason );
}
...
template <typename Ctx> inline bool ChunksBlobsEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const ChunksBlobsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool ChunksCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Chunks & value, TableByteOrder order );

template <typename Ctx> inline bool ChunksBlobsEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const ChunksBlobsEntry & value, TableByteOrder order )
{
    table_cook_put( at + 0, (uint64_t) value.key, 4, order );
    if ( !table_cook_ref( region, at + 8, (const void *) TableBlobAt( ctx, value.value ), order ) ) { return false; } // value
    return true;
}
...
template <typename Ctx> inline bool ChunksCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Chunks & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 0, 0, 8, order ); // blobs: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool ChunksBlobsEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const ChunksBlobsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool ChunksCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Chunks & value, TableByteOrder order );

// ChunksBlobsEntryCookExtent: ChunksBlobsEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
// ChunksCookExtent: Chunks's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool ChunksCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Chunks & value, TableByteOrder order )
{
    ...
    { // blobs
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !ChunksBlobsEntryCookBody( ctx, region, array + i * 16, *cursor[i], order ) ) { return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ChunksBlobsEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool ChunksBlobsEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const ChunksBlobsEntry & value, TableByteOrder order )
{
    if ( !ChunksBlobsEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    return ChunksBlobsEntryCookExtent( ctx, region, at + 16, extent_at, at, value, order );
}

// ChunksCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool ChunksCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Chunks & value, TableByteOrder order )
{
    if ( !ChunksCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !ChunksCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == ChunksExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// ChunksCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool ChunksCookLayout( const Ctx & ctx, const Chunks & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = ChunksExtent( ctx, root );
...
// ChunksCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t ChunksCookMeasureFrom( const Ctx & ctx, const Chunks & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( ChunksNumberFrom( ctx, numbering, root ) && ChunksCookLayout( ctx, root, numbering, region ) )
    {
...
// ChunksCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool ChunksCookFrom( const Ctx & ctx, const Chunks & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = ChunksCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x816c207ba6213983ull, 8, order ); // the root: fnv1a64( "Chunks" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// ChunksCookMeasure / ChunksCook over a REGION root — a locked builder's AsConst, a
// region ChunksLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t ChunksCookMeasure( const Chunks * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ChunksCookMeasureFrom( ctx, *root, allocator );
}

inline bool ChunksCook( const Chunks * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return ChunksCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t ChunksCookMeasure( const ChunksBuilder & builder )
{
    if ( builder.region != NULL ) { return ChunksCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ChunksCookMeasureFrom( ctx, *(const Chunks *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool ChunksCook( const ChunksBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return ChunksCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ChunksCookFrom( ctx, *(const Chunks *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( ChunksBlobsEntry ), "ChunksBlobsEntry must stay relocatable" );
static_assert( __is_standard_layout( ChunksBlobsEntry ), "ChunksBlobsEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Chunks ), "Chunks must stay relocatable" );
static_assert( __is_standard_layout( Chunks ), "Chunks must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( ChunksBlobsEntry ) == 16, "ChunksBlobsEntry's sizeof moved: the build version was taken over 16, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( ChunksBlobsEntry ) == 8, "ChunksBlobsEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( ChunksBlobsEntry, key ) == 0, "ChunksBlobsEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( ChunksBlobsEntry, value ) == 8, "ChunksBlobsEntry's field value moved: the build version was taken over offset 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Chunks ) == 24, "Chunks's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Chunks ) == 8, "Chunks's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Chunks, blobs ) == 0, "Chunks's field blobs moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Chunks, after ) == 16, "Chunks's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );


// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * ChunksBlobsEntryTableType();
inline const TableTypeInfo * ChunksTableType();
...
extern const TableTypeInfo ChunksBlobsEntryTableInfo;
extern const TableTypeInfo ChunksTableInfo;

inline const TableFieldInfo ChunksBlobsEntryTableFields[] = {
    { "key", "key", "int32", 0x3dc94a19365b10ecull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( ChunksBlobsEntry, key ), (uint32_t) sizeof( ChunksBlobsEntry::key ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "bytes", 0x7ce4fd9430e80ceaull, 17, false, true, []( const void * slot ) -> const void * { return (const void *) TableBlobAt( *(const TableRef *) slot ); }, NULL, false, false, 0, (uint32_t) offsetof( ChunksBlobsEntry, value ), (uint32_t) sizeof( TableRef ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo ChunksBlobsEntryTableInfo = { "ChunksBlobsEntry", (uint32_t) sizeof( ChunksBlobsEntry ), 2, ChunksBlobsEntryTableFields, +[]( void * p ) { ChunksBlobsEntryReset( *(ChunksBlobsEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * ChunksBlobsEntryTableType() { return &ChunksBlobsEntryTableInfo; }

inline const TableFieldInfo ChunksTableFields[] = {
    { "blobs", "blobs", "map[int32]*bytes", 0x14e2eaab9cde925bull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Chunks, blobs ), (uint32_t) sizeof( ChunksBlobsEntry ), (uint32_t) offsetof( Chunks, blobs.count ), 0xffffffffu, &ChunksBlobsEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<ChunksBlobsEntry> *) slot, (int32_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Chunks, after ), (uint32_t) sizeof( Chunks::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo ChunksTableInfo = { "Chunks", (uint32_t) sizeof( Chunks ), 2, ChunksTableFields, +[]( void * p ) { ChunksReset( *(Chunks *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * ChunksTableType() { return &ChunksTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Chunks in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in ChunksTable.cpp; link it to use them.
bool ChunksFromJson( ChunksBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t ChunksToJsonMeasure( const Chunks * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t ChunksToJson( const Chunks * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
