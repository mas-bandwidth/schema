...
// Item is a pointer target.
inline const Item * ItemAt( const TableRef & ref ) // the const form's hot path: one add, no base
{
    return ref.value != 0 ? (const Item *) ( (const uint8_t *) &ref + ref.value ) : NULL;
}
inline Item * ItemAt( TableRef & ref )
{
    return ref.value != 0 ? (Item *) ( (uint8_t *) &ref + ref.value ) : NULL;
}
inline const Item * ItemAt( const TableRegionCtx &, const TableRef & ref ) { return ItemAt( ref ); }
inline const Item * ItemAt( const TableArenaCtx & ctx, const TableRef & ref )
{
    return ref.value != 0 ? (const Item *) TableArenaAt( *ctx.arena, (uint32_t) ref.value ) : NULL;
}
// while the builder is mutable, resolve against the arena itself
inline Item * ItemAt( TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (Item *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
inline const Item * ItemAt( const TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (const Item *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
// allocate one Item in the arena; the slot holds the arena offset
inline Item * ItemEmplace( TableWorker & worker, TableRef & slot )
{
    TableSlot<Item> allocated = worker.Alloc<Item>();
    slot = allocated.ref;
    return allocated.ptr;
}
...
template <typename Ctx> inline bool ItemNumber( const Ctx & ctx, TableNumbering & numbering, const Item & value );
template <typename Ctx> inline int64_t ItemPackMeasure( const Ctx & ctx, TablePackMap & seen, const Item & value );
template <typename Ctx> inline bool ItemPack( const Ctx & ctx, TablePackMap & seen, const Item & src, Item & dst, uint8_t * base, int64_t capacity, int64_t & used );
...
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx &, const TableNumbering &, TableIds & ids, const Item & value ) { return ItemMeasureBody( ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx &, const TableNumbering &, TableWriter & w, TableIds & ids, const Item & value ) { return ItemSaveBody( w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx &, const TableNumbering &, int64_t, int64_t at, const Item & value ) { return ItemMeasureMessageBody( at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx &, const TableNumbering &, int64_t, TableBitWriter & w, const Item & value ) { return ItemSaveMessageBody( w, value ); }
...
MAPDEMO_TABLE_INLINE bool ShipConfigLoadBodyRetain( TableReader & r, ShipConfig & value, TableRetain * retain, const TableRetainPath & path );
inline bool ShipConfigLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, ShipConfig & value, TableRetain * retain, const TableRetainPath & path );
...
MAPDEMO_TABLE_INLINE bool ItemLoadBodyRetain( TableReader & r, Item & value, TableRetain * retain, const TableRetainPath & path );
inline bool ItemLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Item & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t FleetShipsEntryMeasureBodyRetain( TableRetainIds & ids, const FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetShipsEntrySaveBodyRetain( TableWriter & w, TableRetainIds & ids, const FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetShipsEntryLoadBodyRetain( TableReader & r, FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path );
inline bool FleetShipsEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t FleetByIdEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetByIdEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetByIdEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool FleetByIdEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t FleetLoadoutsEntryValueEntryMeasureBodyRetain( TableRetainIds & ids, const FleetLoadoutsEntryValueEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetLoadoutsEntryValueEntrySaveBodyRetain( TableWriter & w, TableRetainIds & ids, const FleetLoadoutsEntryValueEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetLoadoutsEntryValueEntryLoadBodyRetain( TableReader & r, FleetLoadoutsEntryValueEntry & value, TableRetain * retain, const TableRetainPath & path );
inline bool FleetLoadoutsEntryValueEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, FleetLoadoutsEntryValueEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t FleetLoadoutsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetLoadoutsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetLoadoutsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool FleetLoadoutsEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path );
inline int64_t FleetTiersEntryMeasureBodyRetain( TableRetainIds & ids, const FleetTiersEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetTiersEntrySaveBodyRetain( TableWriter & w, TableRetainIds & ids, const FleetTiersEntry & value, TableRetain * retain, const TableRetainPath & path );
MAPDEMO_TABLE_INLINE bool FleetTiersEntryLoadBodyRetain( TableReader & r, FleetTiersEntry & value, TableRetain * retain, const TableRetainPath & path );
inline bool FleetTiersEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, FleetTiersEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t FleetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool FleetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool FleetLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Fleet & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool FleetLoadoutsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const FleetLoadoutsEntry & value )
{
    ...
    }
    {
        ...
        if ( order_value.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            w.header( ref_value, 14 ); w.putleb( (uint64_t) body_value );
...
MAPDEMO_TABLE_INLINE bool FleetTiersEntrySaveBody( TableWriter & w, TableIds & ids, const FleetTiersEntry & value )
{
    if ( value.key != 0 )
    {
        w.header( ids.ref_at( 21, 0x3dc94a19365b10ecull ), 3 ); // key
...
inline int64_t FleetMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Fleet & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        ...
        {
            const uint64_t ref_ships = ids.ref_at( 15, 0x294a5c4913e1ad44ull );
    ...
    }
    {
        ...
        {
            const uint64_t ref_by_id = ids.ref_at( 35, 0x7b024c46e98d3404ull );
    ...
    }
    {
        ...
        if ( pointee_flagship != NULL )
        {
            ...
            bytes += TableLebBytes( ids.ref_at( 28, 0x63dfa0c4a4b3815dull ) ) + 1 + TableLebBytes( index_flagship );
        }
    }
    {
        ...
        {
            const uint64_t ref_loadouts = ids.ref_at( 16, 0x294fa1b3f0f5f070ull );
    ...
    }
    {
        ...
        {
            const uint64_t ref_tiers = ids.ref_at( 29, 0x6dd8dc6c5fdae3ceull );
...
{
    {
        ...
        if ( order_ships.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            w.header( ref_ships, 14 ); w.putleb( (uint64_t) body_ships );
    ...
    }
    {
        ...
        if ( order_by_id.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            w.header( ref_by_id, 14 ); w.putleb( (uint64_t) body_by_id );
    ...
    }
    {
        ...
        if ( pointee_flagship != NULL )
        {
            ...
            w.header( ids.ref_at( 28, 0x63dfa0c4a4b3815dull ), 17 ); // flagship — a NODE INDEX into the flat node table
    ...
    }
    {
        ...
        if ( order_loadouts.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            w.header( ref_loadouts, 14 ); w.putleb( (uint64_t) body_loadouts );
    ...
    }
    {
        ...
        if ( order_tiers.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            w.header( ref_tiers, 14 ); w.putleb( (uint64_t) body_tiers );
...
static_assert( sizeof( ShipConfig ) == 76, "ShipConfig: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( ShipConfig, name ) == 0, "ShipConfig.name: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( ShipConfig, name_length ) == 68, "ShipConfig.name_length: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( ShipConfig, health ) == 72, "ShipConfig.health: the fixed form's plan lands here" );
static_assert( sizeof( Item ) == 4, "Item: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( Item, count ) == 0, "Item.count: the fixed form's plan lands here" );

// ShipConfig's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void ShipConfigFixedWriteBody( uint8_t * b, const ShipConfig & value )
{
    (void) b; (void) value;
    schema_assert( value.name_length >= 0 && value.name_length <= 64 ); // the declared length is the bound (§3.4)
    TableFixedPut32( b + 0, (uint32_t) value.name_length );
    memcpy( b + 4, value.name, (size_t) ( value.name_length ) );
    TableFixedPut32( b + 68, (uint32_t) value.health );
}

// Item's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void ItemFixedWriteBody( uint8_t * b, const Item & value )
{
    (void) b; (void) value;
...
constexpr int64_t ShipConfigFixedBodyBytes = 72;
constexpr int64_t ShipConfigFixedRecordBytes = 8 + ShipConfigFixedBodyBytes; // the hash and the body
constexpr uint64_t ShipConfigFixedHash = 0x9579bc245248ed0full; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t ShipConfigFixedLayout[] = {
    0x03, 0x00, 0x00, 0x00, 0x0d, 0x4f, 0xb1, 0xd1, 0xd2, 0x52, 0x82, 0x75, 0x0d, 0x48, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x86, 0x1b, 0x63, 0x8e, 0xba, 0xad, 0xbc, 0xc4, 0x0c, 0x44, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xcf, 0xa9, 0x8b, 0x28, 0xb5, 0xd4, 0x69, 0x7f, 0x04, 0x04,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t ShipConfigFixedLayoutBytes = (int64_t) sizeof( ShipConfigFixedLayout );
...
constexpr TableFixedDst ShipConfigFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // ShipConfig
    { (uint32_t) __builtin_offsetof( ShipConfig, name_length ), 0, (uint32_t) __builtin_offsetof( ShipConfig, name ), 0, 1 }, // name
    { (uint32_t) __builtin_offsetof( ShipConfig, health ), 0, 0, 0, 0 }, // health
};
...
// guard at all.
constexpr TableFixedEntry ShipConfigFixedPlan[] = {
    { 0u, 68u, 64u, 0u, kTableFixedNoGuard, kTableFixedText, 0, 1, 0, 0, 1 }, // name
    { 68u, 72u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // health
};
constexpr int32_t ShipConfigFixedPlanCount = 2;
constexpr int32_t ShipConfigFixedPlanGuarded = 2;
...
constexpr TableFixedFill ShipConfigFixedCover[] = {
    { 0u, 65u },
    { 68u, 8u },
};
constexpr int32_t ShipConfigFixedCoverCount = 2;
...
constexpr uint64_t ShipConfigFixedLineage[] = {
    0x9579bc245248ed0full, // identity
};
constexpr int32_t ShipConfigFixedLineageCount = 1;
constexpr int32_t ShipConfigFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t ShipConfigFixedFloorLive = ShipConfigFixedFloor;
inline void ShipConfigFixedSetFloorForTest( int32_t index ) { ShipConfigFixedFloorLive = index; }
#endif

constexpr uint8_t ShipConfigFixedKnown0Layout[] = {
    0x03, 0x00, 0x00, 0x00, 0x0d, 0x4f, 0xb1, 0xd1, 0xd2, 0x52, 0x82, 0x75, 0x0d, 0x48, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x86, 0x1b, 0x63, 0x8e, 0xba, 0xad, 0xbc, 0xc4, 0x0c, 0x44, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xcf, 0xa9, 0x8b, 0x28, 0xb5, 0xd4, 0x69, 0x7f, 0x04, 0x04,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr TableFixedKnownLayout ShipConfigFixedKnown[] = {
    { 0x9579bc245248ed0full, ShipConfigFixedKnown0Layout, 55, 80 }, // identity
};
...
constexpr int64_t ShipConfigFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + ShipConfigFixedLayoutBytes + count * ShipConfigFixedRecordBytes;
}

inline int64_t ShipConfigFixedSave( const ShipConfig * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = ShipConfigFixedMeasure( count );
    ...
    TableFixedPut64( buffer + kTableFixedHashAt, ShipConfigFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) ShipConfigFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, ShipConfigFixedLayout, (size_t) ShipConfigFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + ShipConfigFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, ShipConfigFixedHash );
        memset( at + 8, 0, (size_t) ShipConfigFixedBodyBytes ); // the prefill's zeros
        ShipConfigFixedWriteBody( at + 8, values[k] );
        at += ShipConfigFixedRecordBytes;
    }
    return need;
}
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    for ( int32_t i = 0; i < ShipConfigFixedLineageCount; ++i )
    {
        if ( ShipConfigFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = ShipConfigFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = ShipConfigFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = ShipConfigFixedKnown[lineage_at];
    ...
    const TableFixedEntry * entries = ShipConfigFixedPlan;
    int32_t entry_count = ShipConfigFixedPlanCount;
    int32_t entry_guarded = ShipConfigFixedPlanGuarded;
    ...
    if ( hash != ShipConfigFixedHash )
    {
        ...
        else
        {
            ...
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, ShipConfigFixedLayout, (int32_t) ShipConfigFixedLayoutBytes, ShipConfigFixedDst,
                                                   ShipConfigFixedCover, ShipConfigFixedCoverCount,
...
// MeasureBody IS A CONSTEXPR on this form: the body is the same size for
// every value the type can hold (docs/SPEC-TABLES.md §3.4).
constexpr int64_t ItemFixedBodyBytes = 4;
constexpr int64_t ItemFixedRecordBytes = 8 + ItemFixedBodyBytes; // the hash and the body
constexpr uint64_t ItemFixedHash = 0xd285587ad8f0ebdcull; // fnv1a64 over the layout and the definitions digest (bill §13)

// THE LAYOUT (form 1 calls this the vocabulary block): 2 entries, a
// PRE-ORDER walk of the closure in the writer's declared order.
// Every byte is settled by the compiler.
constexpr uint8_t ItemFixedLayout[] = {
    0x02, 0x00, 0x00, 0x00, 0x06, 0x68, 0x47, 0x98, 0xd1, 0xa1, 0xcf, 0x52, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x74, 0xa2, 0x79, 0x44, 0x8e, 0xe2, 0xe5, 0xb1, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t ItemFixedLayoutBytes = (int64_t) sizeof( ItemFixedLayout );

// MY SIDE of the layout, one row per entry: the storage facts a layout
// entry cannot carry, which is what a plan compiled from another writer's
// layout lands values through.
constexpr TableFixedDst ItemFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // Item
...
// twice; a plan compiled from a stranger's layout subtracts itself from it
// once, when the plan is compiled, and prefills exactly the rest.
constexpr TableFixedFill ItemFixedCover[] = {
    { 0u, 4u },
};
constexpr int32_t ItemFixedCoverCount = 1;

// THE LINEAGE, oldest first, the reader's own last (bill §6b). LOAD looks
// the file's header hash up here and never parses a stranger's layout.
constexpr uint64_t ItemFixedLineage[] = {
    0xd285587ad8f0ebdcull, // identity
};
constexpr int32_t ItemFixedLineageCount = 1;
constexpr int32_t ItemFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t ItemFixedFloorLive = ItemFixedFloor;
inline void ItemFixedSetFloorForTest( int32_t index ) { ItemFixedFloorLive = index; }
#endif

constexpr uint8_t ItemFixedKnown0Layout[] = {
    0x02, 0x00, 0x00, 0x00, 0x06, 0x68, 0x47, 0x98, 0xd1, 0xa1, 0xcf, 0x52, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x74, 0xa2, 0x79, 0x44, 0x8e, 0xe2, 0xe5, 0xb1, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr TableFixedKnownLayout ItemFixedKnown[] = {
    { 0xd285587ad8f0ebdcull, ItemFixedKnown0Layout, 38, 12 }, // identity
};

// A FILE: THE HEADER (docs/SPEC-TABLES.md §3, one rule for all five forms)
// — form byte, seven reserved zero bytes, the LAYOUT HASH at 8, body at 16 —
// then the layout behind its u32 length, then the records to the end of it.
constexpr int64_t ItemFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + ItemFixedLayoutBytes + count * ItemFixedRecordBytes;
}

inline int64_t ItemFixedSave( const Item * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = ItemFixedMeasure( count );
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); // the seven reserved bytes, and the rest of the header
    buffer[0] = kTableFixedForm;
    TableFixedPut64( buffer + kTableFixedHashAt, ItemFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) ItemFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, ItemFixedLayout, (size_t) ItemFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + ItemFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, ItemFixedHash );
        memset( at + 8, 0, (size_t) ItemFixedBodyBytes ); // the prefill's zeros
        ItemFixedWriteBody( at + 8, values[k] );
        at += ItemFixedRecordBytes;
    }
    return need;
}
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const int64_t rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    int32_t lineage_at = -1;
    for ( int32_t i = 0; i < ItemFixedLineageCount; ++i )
    {
        if ( ItemFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = ItemFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = ItemFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = ItemFixedKnown[lineage_at];
    if ( (int64_t) layout_bytes != known.layout_bytes || memcmp( layout, known.layout, (size_t) layout_bytes ) != 0 )
    {
        report->refused = true; report->reason = layout_malformed; return -1;
    }
    ...
    if ( hash != ItemFixedHash )
    {
        ...
        else
        {
            ...
            int32_t compiled_guarded = 0;
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, ItemFixedLayout, (int32_t) ItemFixedLayoutBytes, ItemFixedDst,
                                                   ItemFixedCover, ItemFixedCoverCount,
                                                   dest, dest_capacity, &compiled_guarded, &fill_at, &fill_count, report );
            if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_malformed : plan_too_large; return -1; }
            record_bytes = known.record_bytes;
            fill = ( fill_count > 0 ) ? (const TableFixedFill *) (const void *) ( (const uint8_t *) dest + fill_at ) : NULL;
...
// ItemWireExtent: the extent Item's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool ItemWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// ItemExtentAt: the node extent Item's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as ItemExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool ItemExtentAt( const Ctx & ctx, const Item & value, int64_t & at )
{
    (void) ctx; (void) value; (void) at; // no list or map below this record
    return true;
}
...
template <typename Ctx>
inline int64_t ItemExtent( const Ctx & ctx, const Item & value )
{
    (void) ctx; (void) value; // no list or map below this record
    return 0;
}
...
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset ItemExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool ItemExtentPack( const Ctx & ctx, const Item & src, Item & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}
...
// ItemNumber: number everything Item POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool ItemNumber( const Ctx & ctx, TableNumbering & numbering, const Item & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// ItemPackMeasure: the packed region bytes of everything Item POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t ItemPackMeasure( const Ctx & ctx, TablePackMap & seen, const Item & value )
{
    int64_t bytes = 0;
    (void) ctx; (void) seen; (void) value; // no pointers below this node
    return bytes;
...
// ItemPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool ItemPackEdges( const Ctx & ctx, TablePackMap & seen, const Item & src, Item & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool ItemPack( const Ctx & ctx, TablePackMap & seen, const Item & src, Item & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Item ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Item ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !ItemExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return ItemPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    {
        ...
        if ( pointee != NULL )
        {
            ...
            else
            {
                ...
                node.type_slot = 69; // its slot in the unit's vocabulary (§3.3)
...
inline int64_t FleetShipsEntryMeasureBodyRetain( TableRetainIds & ids, const FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    if ( value.key_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + TableLebBytes( (uint64_t) ( value.key_length ) ) + ( value.key_length ); } // key
    {
        const int32_t mark_value = ids.count;
        const uint64_t ref_value = ids.ref_at( 36, 0x7ce4fd9430e80ceaull );
        const int64_t body_value = ShipConfigMeasureBodyRetain( ids, value.value, retain, TableRetainStepInto( path, 1, (uint32_t) ( 0 ) ) );
        if ( body_value < 0 ) { return -1; }
        if ( body_value > 1 ) { bytes += TableLebBytes( ref_value ) + 1 + TableLebBytes( (uint64_t) ( body_value ) ) + ( body_value ); } // value
        else { ids.truncate( mark_value ); } // an all-default nested table elides, and costs no entry
    }
...
MAPDEMO_TABLE_INLINE bool FleetShipsEntrySaveBodyRetain( TableWriter & w, TableRetainIds & ids, const FleetShipsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    }
    {
        ...
        {
            w.header( ref_value, 13 ); w.putleb( (uint64_t) body_value ); // value
            if ( !ShipConfigSaveBodyRetain( w, ids, value.value, retain, TableRetainStepInto( path, 1, (uint32_t) ( 0 ) ) ) ) return false;
        }
        else { ids.truncate( mark_value ); }
    }
    if ( !TableRetainTailSave( retain, ids, w, path ) ) { return false; }
    ...
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                {
                    TableReader sub( r.buffer + r.offset, (int64_t) body_len, r.report, r.ids );
                    ShipConfigLoadBodyRetain( sub, value.value, retain, TableRetainStepInto( path, 1, (uint32_t) ( 0 ) ) );
                    if ( sub.offset != sub.size )
                    {
                        r.report->malformed = true;
                        ShipConfigReset( value.value );
    ...
    for ( ;; )
    {
        ...
        switch ( entry.id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                TableRetainDiscardField( retain, path, 1 );
                if ( !ShipConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, value.value, retain, TableRetainStepInto( path, 1, (uint32_t) ( 0 ) ) ) ) { return false; }
                break;
            }
            default:
                report->unknown++;
...
template <typename Ctx>
inline int64_t FleetByIdEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
...
template <typename Ctx>
inline bool FleetByIdEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key != 0 )
    {
        w.header( ids.ref_at( 21, 0x3dc94a19365b10ecull ), 8 ); // key
...
template <typename Ctx>
inline bool FleetByIdEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetByIdEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !FleetByIdEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t FleetLoadoutsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key_length < 0 || value.key_length > 16 ) { return -1; } // storage invariant
    if ( value.key_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + TableLebBytes( (uint64_t) ( value.key_length ) ) + ( value.key_length ); } // key
    {
        ...
        if ( order_value.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_value.count; i++ )
            {
                const int64_t elem_value = FleetLoadoutsEntryValueEntryMeasureBodyRetain( ids, *order_value[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) );
                if ( elem_value < 0 ) { TableMapRelease( order_value ); return -1; }
                body_value += TableLebBytes( (uint64_t) ( elem_value ) ) + ( elem_value ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_value ) + 1 + TableLebBytes( (uint64_t) ( body_value ) ) + ( body_value );
...
template <typename Ctx>
inline bool FleetLoadoutsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    if ( value.key_length < 0 || value.key_length > 16 ) { return false; } // storage invariant
    if ( value.key_length > 0 )
    ...
    }
    {
        ...
        if ( order_value.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_value.count; i++ )
            {
                const int64_t elem_len_value = FleetLoadoutsEntryValueEntryMeasureBodyRetain( ids, *order_value[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) );
                if ( elem_len_value < 0 ) { TableMapRelease( order_value ); return false; }
                w.putleb( (uint64_t) elem_len_value );
                if ( !FleetLoadoutsEntryValueEntrySaveBodyRetain( w, ids, *order_value[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_value ); return false; }
            }
        }
        TableMapRelease( order_value );
    }
...
template <typename Ctx>
inline bool FleetLoadoutsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const FleetLoadoutsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !FleetLoadoutsEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        {
                            TableReader elem( elem_body, (int64_t) elem_len, r.report, r.ids );
                            FleetLoadoutsEntryValueEntryLoadBodyRetain( elem, *slot, retain, TableRetainStepInto( path, 1, (uint32_t) ( fill.map->count - 1 ) ) );
                        }
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !FleetLoadoutsEntryValueEntryLoadMessageBodyRetain( r, vocabulary, report, index_bits, *slot, retain, TableRetainStepInto( path, 1, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
template <typename Ctx>
inline int64_t FleetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // ships: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_ships.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_ships.count; i++ )
            {
                const int64_t elem_ships = FleetShipsEntryMeasureBodyRetain( ids, *order_ships[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_ships < 0 ) { TableMapRelease( order_ships ); return -1; }
                body_ships += TableLebBytes( (uint64_t) ( elem_ships ) ) + ( elem_ships ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_ships ) + 1 + TableLebBytes( (uint64_t) ( body_ships ) ) + ( body_ships );
    ...
    }
    {
        ...
        if ( order_by_id.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_by_id.count; i++ )
            {
                const int64_t elem_by_id = FleetByIdEntryMeasureBodyRetain( ctx, numbering, ids, *order_by_id[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) );
                if ( elem_by_id < 0 ) { TableMapRelease( order_by_id ); return -1; }
                body_by_id += TableLebBytes( (uint64_t) ( elem_by_id ) ) + ( elem_by_id ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_by_id ) + 1 + TableLebBytes( (uint64_t) ( body_by_id ) ) + ( body_by_id );
    ...
    }
    {
        ...
        if ( order_loadouts.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_loadouts.count; i++ )
            {
                const int64_t elem_loadouts = FleetLoadoutsEntryMeasureBodyRetain( ctx, numbering, ids, *order_loadouts[i], retain, TableRetainStepInto( path, 3, (uint32_t) ( i ) ) );
                if ( elem_loadouts < 0 ) { TableMapRelease( order_loadouts ); return -1; }
                body_loadouts += TableLebBytes( (uint64_t) ( elem_loadouts ) ) + ( elem_loadouts ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_loadouts ) + 1 + TableLebBytes( (uint64_t) ( body_loadouts ) ) + ( body_loadouts );
    ...
    }
    {
        ...
        if ( order_tiers.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_tiers.count; i++ )
            {
                const int64_t elem_tiers = FleetTiersEntryMeasureBodyRetain( ids, *order_tiers[i], retain, TableRetainStepInto( path, 4, (uint32_t) ( i ) ) );
                if ( elem_tiers < 0 ) { TableMapRelease( order_tiers ); return -1; }
                body_tiers += TableLebBytes( (uint64_t) ( elem_tiers ) ) + ( elem_tiers ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_tiers ) + 1 + TableLebBytes( (uint64_t) ( body_tiers ) ) + ( body_tiers );
...
template <typename Ctx>
inline bool FleetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<FleetShipsEntry> order_ships = TableMapOrder( ctx, value.ships ); // ships
        if ( !order_ships.ok ) { return false; }
        if ( order_ships.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_ships.count; i++ )
            {
                const int64_t elem_len_ships = FleetShipsEntryMeasureBodyRetain( ids, *order_ships[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_ships < 0 ) { TableMapRelease( order_ships ); return false; }
                w.putleb( (uint64_t) elem_len_ships );
                if ( !FleetShipsEntrySaveBodyRetain( w, ids, *order_ships[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_ships ); return false; }
            }
        }
        TableMapRelease( order_ships );
    }
    {
        ...
        if ( order_by_id.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_by_id.count; i++ )
            {
                const int64_t elem_len_by_id = FleetByIdEntryMeasureBodyRetain( ctx, numbering, ids, *order_by_id[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) );
                if ( elem_len_by_id < 0 ) { TableMapRelease( order_by_id ); return false; }
                w.putleb( (uint64_t) elem_len_by_id );
                if ( !FleetByIdEntrySaveBodyRetain( ctx, numbering, w, ids, *order_by_id[i], retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_by_id ); return false; }
            }
        }
        TableMapRelease( order_by_id );
    }
    ...
    }
    {
        ...
        if ( order_loadouts.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_loadouts.count; i++ )
            {
                const int64_t elem_len_loadouts = FleetLoadoutsEntryMeasureBodyRetain( ctx, numbering, ids, *order_loadouts[i], retain, TableRetainStepInto( path, 3, (uint32_t) ( i ) ) );
                if ( elem_len_loadouts < 0 ) { TableMapRelease( order_loadouts ); return false; }
                w.putleb( (uint64_t) elem_len_loadouts );
                if ( !FleetLoadoutsEntrySaveBodyRetain( ctx, numbering, w, ids, *order_loadouts[i], retain, TableRetainStepInto( path, 3, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_loadouts ); return false; }
            }
        }
        TableMapRelease( order_loadouts );
    }
    {
        ...
        if ( order_tiers.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_tiers.count; i++ )
            {
                const int64_t elem_len_tiers = FleetTiersEntryMeasureBodyRetain( ids, *order_tiers[i], retain, TableRetainStepInto( path, 4, (uint32_t) ( i ) ) );
                if ( elem_len_tiers < 0 ) { TableMapRelease( order_tiers ); return false; }
                w.putleb( (uint64_t) elem_len_tiers );
                if ( !FleetTiersEntrySaveBodyRetain( w, ids, *order_tiers[i], retain, TableRetainStepInto( path, 4, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_tiers ); return false; }
            }
        }
        TableMapRelease( order_tiers );
    }
...
template <typename Ctx>
inline bool FleetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Fleet & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !FleetSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x294a5c4913e1ad44ull: // ships
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        {
                            TableReader elem( elem_body, (int64_t) elem_len, r.report, r.ids );
                            FleetShipsEntryLoadBodyRetain( elem, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) );
                        }
                        last_key = read.key; last_length = read.length; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x6dd8dc6c5fdae3ceull: // tiers
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        {
                            TableReader elem( elem_body, (int64_t) elem_len, r.report, r.ids );
                            FleetTiersEntryLoadBodyRetain( elem, *slot, retain, TableRetainStepInto( path, 4, (uint32_t) ( fill.map->count - 1 ) ) );
                        }
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x294a5c4913e1ad44ull: // ships
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !FleetShipsEntryLoadMessageBodyRetain( r, vocabulary, report, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; last_length = read.length; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x7b024c46e98d3404ull: // by_id
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !FleetByIdEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 1, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x294fa1b3f0f5f070ull: // loadouts
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !FleetLoadoutsEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 3, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; last_length = read.length; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
            ...
            case 0x6dd8dc6c5fdae3ceull: // tiers
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !FleetTiersEntryLoadMessageBodyRetain( r, vocabulary, report, index_bits, *slot, retain, TableRetainStepInto( path, 4, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
inline void FleetNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    switch ( type_id )
    {
        case 0x758252d2d1b14f0dull: ShipConfigLoadBodyRetain( r, *(ShipConfig *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // ShipConfig
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// FleetLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Fleet * FleetLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                FleetNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    FleetLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// FleetNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool FleetNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + FleetNodeRecordBytes( type_id );
    carve.left = 0;
    ...
    switch ( type_id )
    {
        case 0x758252d2d1b14f0dull: ok = ShipConfigLoadMessageBodyRetain( r, vocabulary, report, index_bits, *(ShipConfig *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // ShipConfig
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    nodes.carve = outer;
...
// FleetLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool FleetLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Fleet * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !FleetNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return FleetLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// FleetLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool FleetLoadRetainMessages( const Fleet ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !FleetLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// FleetMeasureRetain and FleetSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t FleetMeasureWireRetain( const Ctx & ctx, const Fleet & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0x758252d2d1b14f0dull: return ShipConfigMeasureBodyRetain( ii, *(const ShipConfig *) node, rt, at ); // ShipConfig
            default: break;
        }
        return -1;
    };
    if ( FleetNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = FleetMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t FleetSaveWireRetain( const Ctx & ctx, const Fleet & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0x758252d2d1b14f0dull: return ShipConfigSaveBodyRetain( ww, ii, *(const ShipConfig *) node, rt, at ); // ShipConfig
            default: break;
        }
        return false;
    };
    ...
    bool ok = FleetSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t FleetMeasureRetain( const Fleet * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return FleetMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t FleetSaveRetain( const Fleet * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return FleetSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// FleetSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
template <typename... Args>
inline void ShipConfigSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "ShipConfig is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ShipConfigLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "ShipConfig is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ShipConfigSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "ShipConfig is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ItemLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Item is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ItemSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Item is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
