// Code generated by the schema compiler from Spans.schema. DO NOT EDIT.
...
// table SpansTracksEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct SpansTracksEntry {
    uint8_t key = 0;
    TableList<Item> value; // Item: the element array, empty until an Add
};

// table Spans — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Spans {
    TableMap<SpansTracksEntry> tracks; // map[uint8]Item — the sorted entry array, empty until an insert
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void SpansTracksEntryReset( SpansTracksEntry & value );
inline void SpansReset( Spans & value );

inline void SpansTracksEntryReset( SpansTracksEntry & value )
{
    value.key = 0;
    value.value.elements.value = 0; // Item: empty
    value.value.count = 0;
...
inline void SpansReset( Spans & value )
{
    value.tracks.entries.value = 0; // map[uint8]Item: empty
    value.tracks.count = 0;
    value.tracks.padding = 0;
    value.after = 0;
}

template <typename Ctx> inline int64_t SpansTracksEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const SpansTracksEntry & value );
template <typename Ctx> inline bool SpansTracksEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const SpansTracksEntry & value );
inline bool SpansTracksEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, SpansTracksEntry & value );
inline bool SpansTracksEntryMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
template <typename Ctx> inline int64_t SpansMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Spans & value );
template <typename Ctx> inline bool SpansSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Spans & value );
inline bool SpansLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Spans & value );
inline bool SpansMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// SpansTracksEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct SpansTracksEntryMessageKeyRead
{
    uint8_t key;
...
inline SpansTracksEntryMessageKeyRead SpansTracksEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    SpansTracksEntryMessageKeyRead out = { 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( SpansTracksEntry & value ) { SpansTracksEntryReset( value ); }
inline void TableReset( Spans & value ) { SpansReset( value ); }
...
template <typename Ctx> inline int64_t SpansTracksEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const SpansTracksEntry & value );
template <typename Ctx> inline bool SpansTracksEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const SpansTracksEntry & value );
template <typename Ctx> inline bool SpansTracksEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const SpansTracksEntry & value );
inline bool SpansTracksEntryLoadBody( TableReader & r, const TableNodeMap & nodes, SpansTracksEntry & value );
template <typename Ctx> inline int64_t SpansMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Spans & value );
template <typename Ctx> inline bool SpansSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Spans & value );
template <typename Ctx> inline bool SpansSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Spans & value );
...
template <typename Ctx> inline bool SpansTracksEntryNumber( const Ctx & ctx, TableNumbering & numbering, const SpansTracksEntry & value );
template <typename Ctx> inline int64_t SpansTracksEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const SpansTracksEntry & value );
template <typename Ctx> inline bool SpansTracksEntryPack( const Ctx & ctx, TablePackMap & seen, const SpansTracksEntry & src, SpansTracksEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool SpansNumber( const Ctx & ctx, TableNumbering & numbering, const Spans & value );
template <typename Ctx> inline int64_t SpansPackMeasure( const Ctx & ctx, TablePackMap & seen, const Spans & value );
template <typename Ctx> inline bool SpansPack( const Ctx & ctx, TablePackMap & seen, const Spans & src, Spans & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const SpansTracksEntry & value ) { return SpansTracksEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const SpansTracksEntry & value ) { return SpansTracksEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const SpansTracksEntry & value ) { return SpansTracksEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const SpansTracksEntry & value ) { return SpansTracksEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Spans & value ) { return SpansMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Spans & value ) { return SpansSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Spans & value ) { return SpansMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Spans & value ) { return SpansSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- SpansTracksEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( SpansTracksEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );

inline int TableEntryOrder( const SpansTracksEntry & a, const SpansTracksEntry & b )
{
    return TableKeyOrder( (uint64_t) a.key, (uint64_t) b.key ); // integers compare by VALUE, unsigned here
}
inline int TableEntryOrder( const SpansTracksEntry & entry, uint8_t key )
{
    return TableKeyOrder( (uint64_t) entry.key, (uint64_t) key );
}
inline uint8_t TableEntryKey( const SpansTracksEntry & entry ) { return entry.key; }
inline void TableEntrySetKey( SpansTracksEntry & entry, uint8_t key ) { entry.key = key; }
inline const TableList<Item> * TableEntryFound( const SpansTracksEntry * entry ) { return entry != NULL ? &entry->value : NULL; }
inline TableList<Item> * TableEntryValue( SpansTracksEntry * entry ) { return &entry->value; }
struct SpansTracksEntryEach { uint8_t key; decltype( TableEntryValue( (SpansTracksEntry *) NULL ) ) value; };
inline SpansTracksEntryEach TableEntryEach( SpansTracksEntry * entry ) { return SpansTracksEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( SpansTracksEntry & value )
{
    value.value.elements.value = 0; // Item: empty
    value.value.count = 0;
    value.value.padding = 0;
...
// SpansTracksEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
struct SpansTracksEntryKeyRead
{
    uint8_t key;
    bool found;         // the body carried the key's id
    bool kind_bad;      // it carried it under another kind: the MAP's event
...
inline SpansTracksEntryKeyRead SpansTracksEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    SpansTracksEntryKeyRead out = { 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t SpansTracksEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SpansTracksEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SpansTracksEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool SpansTracksEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t SpansMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SpansSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SpansSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool SpansLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Spans & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t SpansTracksEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const SpansTracksEntry & value )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 1; } // key
    {
        // value: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        TableListCursor<Item> cursor_value = TableListElements( ctx, value.value );
        if ( !cursor_value.ok ) { return -1; } // the slot and the head disagree
        if ( cursor_value.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_value = 0; elem_i_value < cursor_value.count; elem_i_value++ )
            {
                ...
                if ( elem_bytes_value < 0 ) { return -1; }
...
template <typename Ctx>
inline bool SpansTracksEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const SpansTracksEntry & value )
{
    (void) ctx; (void) numbering;
    if ( value.key != 0 )
    {
    ...
    {
        TableListCursor<Item> cursor_value = TableListElements( ctx, value.value ); // value
        if ( !cursor_value.ok ) { return false; }
        if ( cursor_value.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            const uint64_t ref_value = ids.ref_at( 36, 0x7ce4fd9430e80ceaull );
            int64_t body_value = 0;
            ...
            w.header( ref_value, 14 ); w.putleb( (uint64_t) body_value ); // value
            w.put8( 13 ); w.putleb( (uint64_t) ( cursor_value.count ) );
            for ( int32_t elem_i_value = 0; elem_i_value < cursor_value.count; elem_i_value++ )
            {
                {
...
template <typename Ctx>
inline bool SpansTracksEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const SpansTracksEntry & value )
{
    if ( !SpansTracksEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        TableListFill<Item> fill = TableListFillBegin( nodes, value.value, count );
                        ...
                        {
                            Item * slot = TableListFillNext( fill );
                            if ( slot == NULL ) { r.report->malformed = true; break; } // the arena could not carve
                            bool landed = false;
                            do
                            {
                                uint64_t elem_len_value = 0;
                                if ( !sub.getleb( elem_len_value ) || !sub.room( elem_len_value ) ) { r.report->malformed = true; break; }
                                {
...
template <typename Ctx>
inline int64_t SpansTracksEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const SpansTracksEntry & value )
{
    ...
    }
    {
        TableListCursor<Item> cursor_value = TableListElements( ctx, value.value ); // value
        if ( !cursor_value.ok ) { return -1; } // the slot and the head disagree
        if ( cursor_value.count > 0 )
        {
            bits += kTableMessageRefBitsHere;
            bits += 32;
            for ( int32_t i = 0; i < cursor_value.count; i++ )
            {
                const int64_t elem = ItemMeasureMessageBody( at + bits, cursor_value[i] );
                if ( elem < 0 ) { return -1; }
                bits += elem;
            }
        }
...
template <typename Ctx>
inline bool SpansTracksEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const SpansTracksEntry & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.key != 0 )
    {
    ...
    {
        TableListCursor<Item> cursor_value = TableListElements( ctx, value.value ); // value
        if ( !cursor_value.ok ) { return false; } // the slot and the head disagree
        if ( cursor_value.count > 0 )
        {
            w.put( 2, kTableMessageRefBitsHere );
            w.put( (uint64_t) ( cursor_value.count ) - 0, 32 );
            for ( int32_t i = 0; i < cursor_value.count; i++ )
            {
                if ( !ItemSaveMessageBody( w, cursor_value[i] ) ) { return false; }
            }
        }
    }
...
// SpansTracksEntryMessageExtent: the extent SpansTracksEntry's maps command on the message wire, from
...
inline bool SpansTracksEntryMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x7ce4fd9430e80ceaull && entry.kind == 14 && entry.elem_kind == 13 ) // value: an unbounded array
        {
            uint64_t n = 0;
            ...
            at = ( at + 3 ) & ~(int64_t) 3; // at alignof( Item )
            at += (int64_t) n * (int64_t) sizeof( Item ); // the whole array FIRST
            const int64_t run = TableMessageElementRunBits( vocabulary, entry );
        ...
        switch ( entry.id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                }
                {
                    ...
                    n += (uint64_t) entry.min;
                    TableListFill<Item> fill = TableListFillBegin( nodes, value.value, n );
                    if ( fill.refused ) { nodes.refused = true; return false; }
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        if ( !ItemLoadMessageBody( r, vocabulary, report, index_bits, ( *slot ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
template <typename Ctx>
inline int64_t SpansMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Spans & value )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // tracks: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<SpansTracksEntry> order_tracks = TableMapOrder( ctx, value.tracks );
        if ( !order_tracks.ok ) { return -1; } // the sort could not run
        if ( order_tracks.count > 0 )
        {
            const uint64_t ref_tracks = ids.ref_at( 32, 0x755332609c470fbdull );
            int64_t body_tracks = 1 + TableLebBytes( (uint64_t) order_tracks.count ); // the element kind byte and the count
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_tracks = SpansTracksEntryMeasureBody( ctx, numbering, ids, *order_tracks[i] );
                if ( elem_tracks < 0 ) { TableMapRelease( order_tracks ); return -1; }
                body_tracks += TableLebBytes( (uint64_t) ( elem_tracks ) ) + ( elem_tracks ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_tracks ) + 1 + TableLebBytes( (uint64_t) ( body_tracks ) ) + ( body_tracks );
        }
        TableMapRelease( order_tracks );
    }
...
template <typename Ctx>
inline bool SpansSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Spans & value )
{
    (void) ctx; (void) numbering;
    {
        TableMapCursor<SpansTracksEntry> order_tracks = TableMapOrder( ctx, value.tracks ); // tracks
        if ( !order_tracks.ok ) { return false; }
        if ( order_tracks.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            const uint64_t ref_tracks = ids.ref_at( 32, 0x755332609c470fbdull );
            int64_t body_tracks = 1 + TableLebBytes( (uint64_t) order_tracks.count );
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_tracks = SpansTracksEntryMeasureBody( ctx, numbering, ids, *order_tracks[i] );
                if ( elem_tracks < 0 ) { TableMapRelease( order_tracks ); return false; }
                body_tracks += TableLebBytes( (uint64_t) ( elem_tracks ) ) + ( elem_tracks );
            }
            w.header( ref_tracks, 14 ); w.putleb( (uint64_t) body_tracks );
            w.put8( 13 ); w.putleb( (uint64_t) order_tracks.count );
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_len_tracks = SpansTracksEntryMeasureBody( ctx, numbering, ids, *order_tracks[i] );
                if ( elem_len_tracks < 0 ) { TableMapRelease( order_tracks ); return false; }
                w.putleb( (uint64_t) elem_len_tracks );
                if ( !SpansTracksEntrySaveBody( ctx, numbering, w, ids, *order_tracks[i] ) ) { TableMapRelease( order_tracks ); return false; }
            }
        }
        TableMapRelease( order_tracks );
    }
...
template <typename Ctx>
inline bool SpansSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Spans & value )
{
    if ( !SpansSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x755332609c470fbdull: // tracks
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        SpansTracksEntryKeyRead read = SpansTracksEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t SpansMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Spans & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_tracks.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_tracks = SpansTracksEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_tracks[i] );
                if ( elem_tracks < 0 ) { TableMapRelease( order_tracks ); return -1; }
                bits += elem_tracks; // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
        }
        TableMapRelease( order_tracks );
    }
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool SpansSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Spans & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableMapCursor<SpansTracksEntry> order_tracks = TableMapOrder( ctx, value.tracks ); // tracks
        if ( !order_tracks.ok ) { return false; } // the sort could not run
        if ( order_tracks.count > 0 )
        {
            w.put( 45, kTableMessageRefBitsHere );
            w.put( (uint64_t) order_tracks.count, 32 ); // the count the data decides
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                if ( !SpansTracksEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_tracks[i] ) ) { TableMapRelease( order_tracks ); return false; }
            }
        }
        TableMapRelease( order_tracks );
    }
...
// SpansMessageExtent: the extent Spans's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool SpansMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        const TableMessageEntry & entry = TableVocabularyEntryAt( vocabulary, ref );
        if ( TableMessageReserved( entry.id ) ) { return false; }
        if ( entry.id == 0x755332609c470fbdull && entry.kind == 14 && entry.elem_kind == 13 ) // tracks
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( SpansTracksEntry )
            at += (int64_t) n * (int64_t) sizeof( SpansTracksEntry ); // the whole array FIRST
            for ( uint64_t i = 0; i < n; i++ ) // then, entry by entry in key order
            {
                if ( !SpansTracksEntryMessageExtent( r, vocabulary, index_bits, at ) ) { return false; }
            }
            continue;
        }
        if ( !TableMessageSkip( r, vocabulary, index_bits, entry ) ) { return false; }
        ...
        switch ( entry.id )
        {
            case 0x755332609c470fbdull: // tracks
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const SpansTracksEntryMessageKeyRead read = SpansTracksEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !SpansTracksEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// SpansTracksEntryWireExtent: the extent SpansTracksEntry's lists and maps command, from the FRAMING alone.
...
inline bool SpansTracksEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0x7ce4fd9430e80ceaull && field_kind == 14 ) // value: an unbounded array
        {
            ...
            if ( !TableListWireExtent( list_body, (int64_t) list_len, at, (int64_t) sizeof( Item ), (int64_t) alignof( Item ), 13, 2, NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// SpansTracksEntryExtentAt: the node extent SpansTracksEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as SpansTracksEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool SpansTracksEntryExtentAt( const Ctx & ctx, const SpansTracksEntry & value, int64_t & at )
{
    {
        TableListCursor<Item> cursor = TableListElements( ctx, value.value );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Item ) - 1 ) & ~( (int64_t) alignof( Item ) - 1 );
        at += (int64_t) cursor.count * (int64_t) sizeof( Item ); // the whole array FIRST
    }
    return true;
}
...
template <typename Ctx>
inline int64_t SpansTracksEntryExtent( const Ctx & ctx, const SpansTracksEntry & value )
{
    int64_t at = 0;
    if ( !SpansTracksEntryExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// SpansTracksEntryExtentPack: carve SpansTracksEntry's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset SpansTracksEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool SpansTracksEntryExtentPack( const Ctx & ctx, const SpansTracksEntry & src, SpansTracksEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableListCursor<Item> cursor = TableListElements( ctx, src.value );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Item ) - 1 ) & ~( (int64_t) alignof( Item ) - 1 );
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( Item );
        if ( at + bytes > capacity ) { return false; }
        Item * placed = (Item *) ( extent + at );
        at += bytes;
        dst.value.count = cursor.count;
        dst.value.padding = 0;
        dst.value.elements.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.value.elements ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            memcpy( (void *) ( placed + i ), (const void *) &cursor[i], sizeof( Item ) ); // trivially copyable, by construction
        }
    }
    return true;
}

// SpansWireExtent: the extent Spans's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool SpansWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
    {
        ...
        if ( field_id == 0x755332609c470fbdull && field_kind == 14 ) // tracks
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( SpansTracksEntry ), (int64_t) alignof( SpansTracksEntry ), &SpansTracksEntryWireExtent, ids, reason ) ) { return false; }
            continue;
        }
        if ( !r.skip( field_kind ) ) { return true; }
    }
...
// SpansExtentAt: the node extent Spans's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as SpansExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool SpansExtentAt( const Ctx & ctx, const Spans & value, int64_t & at )
{
    {
        TableMapCursor<SpansTracksEntry> cursor = TableMapOrder( ctx, value.tracks );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( SpansTracksEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( SpansTracksEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !SpansTracksEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t SpansExtent( const Ctx & ctx, const Spans & value )
{
    int64_t at = 0;
    if ( !SpansExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// SpansExtentPack: carve Spans's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset SpansExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool SpansExtentPack( const Ctx & ctx, const Spans & src, Spans & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<SpansTracksEntry> cursor = TableMapOrder( ctx, src.tracks );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( SpansTracksEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        SpansTracksEntry * placed = (SpansTracksEntry *) ( extent + at );
        at += bytes;
        dst.tracks.count = cursor.count;
        dst.tracks.padding = 0;
        dst.tracks.entries.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.tracks.entries ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( SpansTracksEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !SpansTracksEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Spans.tracks: the builder's five and the side index (§2.8) ----
...
inline TableList<Item> * SpansTracksInsert( TableWorker & worker, TableMap<SpansTracksEntry> & map, uint8_t key )
{
    SpansTracksEntry * entry = TableMapPlace( worker, map, key );
...
inline TableList<Item> * SpansTracksFind( TableArena & arena, TableMap<SpansTracksEntry> & map, uint8_t key )
{
    SpansTracksEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool SpansTracksErase( TableArena & arena, TableMap<SpansTracksEntry> & map, uint8_t key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<SpansTracksEntry> SpansTracksEach( const TableArena & arena, const TableMap<SpansTracksEntry> & map )
{
...
inline int64_t SpansTracksIndexMeasure( const TableMap<SpansTracksEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex SpansTracksIndex( const TableMap<SpansTracksEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const SpansTracksEntry * entries = map.Entries();
...
inline const TableList<Item> * SpansTracksIndexFind( const TableMapIndex & index, const TableMap<SpansTracksEntry> & map, uint8_t key )
{
...
// ---- SpansTracksEntry.value: the builder's three (§2.9) ----
...
inline Item * SpansTracksEntryValueAdd( TableWorker & worker, TableList<Item> & list )
{
...
inline bool SpansTracksEntryValueErase( TableArena & arena, TableList<Item> & list, const Item * element )
{
...
inline TableListEach<Item> SpansTracksEntryValueEach( const TableArena & arena, const TableList<Item> & list )
{
    return TableListEachOf( arena, list );
}

// SpansTracksEntryNumber: number everything SpansTracksEntry POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool SpansTracksEntryNumber( const Ctx & ctx, TableNumbering & numbering, const SpansTracksEntry & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// SpansTracksEntryPackMeasure: the packed region bytes of everything SpansTracksEntry POINTS AT.
...
template <typename Ctx>
inline int64_t SpansTracksEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const SpansTracksEntry & value )
{
    int64_t bytes = 0;
...
// SpansTracksEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool SpansTracksEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const SpansTracksEntry & src, SpansTracksEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool SpansTracksEntryPack( const Ctx & ctx, TablePackMap & seen, const SpansTracksEntry & src, SpansTracksEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( SpansTracksEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( SpansTracksEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !SpansTracksEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return SpansTracksEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
// SpansNumber: number everything Spans POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool SpansNumber( const Ctx & ctx, TableNumbering & numbering, const Spans & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// SpansPackMeasure: the packed region bytes of everything Spans POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t SpansPackMeasure( const Ctx & ctx, TablePackMap & seen, const Spans & value )
{
    int64_t bytes = 0;
    (void) ctx; (void) seen; (void) value; // no pointers below this node
    return bytes;
...
// SpansPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool SpansPackEdges( const Ctx & ctx, TablePackMap & seen, const Spans & src, Spans & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool SpansPack( const Ctx & ctx, TablePackMap & seen, const Spans & src, Spans & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Spans ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Spans ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !SpansExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return SpansPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
// ---- Spans: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: SpansBuilder — allocate nodes, wire them together, then Lock.
...
// Spans is never held by value — a file-format-scale structure is a region
...
struct SpansBuilder
{
    ...
    SpansBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Spans * GetRoot() { return arena.locked ? NULL : (Spans *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Spans * AsConst() const { return (const Spans *) region; }
...
inline bool SpansBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Spans & root = *(const Spans *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Spans on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// SpansNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t SpansNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
...
// SpansNodePlace: start one record's node's lifetime in the storage pass one
...
inline void SpansNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) at;
...
// SpansNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t SpansNodeRecordBytes( uint64_t type_id )
{
    (void) type_id;
    return 0;
}

// SpansNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t SpansNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    (void) type_id;
    (void) worker;
...
// SpansNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void SpansNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = SpansNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? SpansNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// SpansNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t SpansNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    (void) type_id;
...
// SpansNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool SpansNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// SpansNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool SpansNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + SpansNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !SpansNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool SpansNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Spans & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return SpansNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t SpansMeasureWire( const Ctx & ctx, const Spans & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( SpansNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = SpansMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t SpansSaveWire( const Ctx & ctx, const Spans & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !SpansNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = SpansSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == SpansMeasure( root )
}

inline int64_t SpansMeasure( const Spans * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SpansMeasureWire( ctx, *root, allocator );
}

inline int64_t SpansSave( const Spans * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SpansSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t SpansMeasure( const SpansBuilder & builder )
{
    if ( builder.region != NULL ) { return SpansMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SpansMeasureWire( ctx, *(const Spans *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t SpansSave( const SpansBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return SpansSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SpansSaveWire( ctx, *(const Spans *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Spans on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// SpansMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t SpansMessageBodyBits( const Ctx & ctx, const Spans & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( SpansNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = SpansMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool SpansMessageBodySave( const Ctx & ctx, const Spans & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && SpansSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t SpansMeasureMessages( const Spans * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = SpansMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t SpansSaveMessages( const Spans * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !SpansMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == SpansMeasureMessages( roots, count, report, allocator )
}

// SpansMessageRecordScan: one node record's type id and the extent its maps
...
inline bool SpansMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return SpansNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// SpansMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool SpansMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !SpansMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = SpansNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !SpansMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Spans ) ) + root_extent );
    return true;
}

// SpansLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t SpansLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !SpansMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// SpansLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool SpansLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Spans * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !SpansMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = SpansNodeMessageStorage( type_id, extent, length );
        ...
        SpansNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !SpansMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Spans ) ) + root_extent );
    ...
    Spans * root = new ( region + used ) Spans; // lifetime only: LoadMessageBody's first act is SpansReset
    SpansReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Spans ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !SpansNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return SpansLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// SpansLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool SpansLoadMessages( const Spans ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !SpansLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// SpansLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t SpansLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !SpansWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Spans ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = SpansNodeStorage( type_id, length, reason );
...
// SpansLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Spans * SpansLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Spans ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !SpansWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Spans ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x033de3f1246bba76ull;
    Spans * root = new ( region ) Spans; // lifetime only: LoadBody's first act is SpansReset
    SpansReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                SpansNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Spans ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    SpansLoadBody( r, nodes, *root );
    return root;
}

// SpansLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool SpansLoadBuilder( SpansBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = SpansNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = SpansLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t SpansTracksEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 1; } // key
    {
        ...
        if ( cursor_value.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_value = 0; elem_i_value < cursor_value.count; elem_i_value++ )
            {
                const int64_t elem_bytes_value = ItemMeasureBodyRetain( ids, cursor_value[elem_i_value], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i_value ) ) );
                if ( elem_bytes_value < 0 ) { return -1; }
                body_value += TableLebBytes( (uint64_t) ( elem_bytes_value ) ) + ( elem_bytes_value );
            }
            bytes += TableLebBytes( ref_value ) + 1 + TableLebBytes( (uint64_t) ( body_value ) ) + ( body_value );
...
template <typename Ctx>
inline bool SpansTracksEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    if ( value.key != 0 )
    {
    ...
    }
    {
        ...
        if ( cursor_value.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const int64_t elem_len_value = ItemMeasureBodyRetain( ids, cursor_value[elem_i_value], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i_value ) ) );
                    if ( elem_len_value < 0 ) return false;
                    w.putleb( (uint64_t) elem_len_value );
                    if ( !ItemSaveBodyRetain( w, ids, cursor_value[elem_i_value], retain, TableRetainStepInto( path, 1, (uint32_t) ( elem_i_value ) ) ) ) return false;
                }
            }
        }
    }
...
template <typename Ctx>
inline bool SpansTracksEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const SpansTracksEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !SpansTracksEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        Item * slot = TableListFillNext( fill );
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        if ( !ItemLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( *slot ), retain, TableRetainStepInto( path, 1, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
template <typename Ctx>
inline int64_t SpansMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        ...
        if ( order_tracks.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_tracks = SpansTracksEntryMeasureBodyRetain( ctx, numbering, ids, *order_tracks[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_tracks < 0 ) { TableMapRelease( order_tracks ); return -1; }
                body_tracks += TableLebBytes( (uint64_t) ( elem_tracks ) ) + ( elem_tracks ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_tracks ) + 1 + TableLebBytes( (uint64_t) ( body_tracks ) ) + ( body_tracks );
...
template <typename Ctx>
inline bool SpansSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    {
        TableMapCursor<SpansTracksEntry> order_tracks = TableMapOrder( ctx, value.tracks ); // tracks
        ...
        if ( order_tracks.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_tracks.count; i++ )
            {
                const int64_t elem_len_tracks = SpansTracksEntryMeasureBodyRetain( ctx, numbering, ids, *order_tracks[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_tracks < 0 ) { TableMapRelease( order_tracks ); return false; }
                w.putleb( (uint64_t) elem_len_tracks );
                if ( !SpansTracksEntrySaveBodyRetain( ctx, numbering, w, ids, *order_tracks[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_tracks ); return false; }
            }
        }
        TableMapRelease( order_tracks );
    }
...
template <typename Ctx>
inline bool SpansSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Spans & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !SpansSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x755332609c470fbdull: // tracks
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !SpansTracksEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// SpansNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void SpansNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// SpansLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Spans * SpansLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                SpansNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    SpansLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// SpansNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool SpansNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + SpansNodeRecordBytes( type_id );
    carve.left = 0;
...
// SpansLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool SpansLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Spans * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !SpansNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return SpansLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// SpansLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool SpansLoadRetainMessages( const Spans ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !SpansLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// SpansMeasureRetain and SpansSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t SpansMeasureWireRetain( const Ctx & ctx, const Spans & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( SpansNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = SpansMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t SpansSaveWireRetain( const Ctx & ctx, const Spans & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = SpansSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t SpansMeasureRetain( const Spans * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SpansMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t SpansSaveRetain( const Spans * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SpansSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// SpansSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH SpansAt: the slot holds
...
// parameter on a load.
inline const Spans * SpansOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Spans *) TableCookOpen( bytes, length, (uint64_t) sizeof( Spans ), (uint64_t) alignof( Spans ), reason );
}
...
template <typename Ctx> inline bool SpansTracksEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const SpansTracksEntry & value, TableByteOrder order );
template <typename Ctx> inline bool SpansCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Spans & value, TableByteOrder order );
...
template <typename Ctx> inline bool SpansTracksEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const SpansTracksEntry & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 8, 0, 8, order ); // value: the array's delta, filled by the extent writer
    table_cook_put( at + 16, 0, 4, order ); // and its count
    return true;
}
...
{
    (void) ctx; (void) region; // no reference resolves in this body: a list's and a map's slots are the extent writer's, and the class was decided elsewhere in the closure
    table_cook_put( at + 0, 0, 8, order ); // tracks: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool SpansTracksEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const SpansTracksEntry & value, TableByteOrder order );
template <typename Ctx> inline bool SpansCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Spans & value, TableByteOrder order );

// SpansTracksEntryCookExtent: SpansTracksEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
template <typename Ctx> inline bool SpansTracksEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const SpansTracksEntry & value, TableByteOrder order )
{
    ...
    { // value: an unbounded array
        ...
        table_cook_put( record + 8, cursor.count > 0 ? (uint64_t) (int64_t) ( array - ( record + 8 ) ) : 0, 8, order );
        table_cook_put( record + 16, (uint64_t) (uint32_t) cursor.count, 4, order );
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            ItemCookBody( array + i * 4, cursor[i], order );
        }
    }
    return true;
}

// SpansCookExtent: Spans's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool SpansCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Spans & value, TableByteOrder order )
{
    ...
    { // tracks
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !SpansTracksEntryCookBody( ctx, region, array + i * 24, *cursor[i], order ) ) { return false; }
        }
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !SpansTracksEntryCookExtent( ctx, region, extent, at, array + i * 24, *cursor[i], order ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// SpansTracksEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool SpansTracksEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const SpansTracksEntry & value, TableByteOrder order )
{
    if ( !SpansTracksEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !SpansTracksEntryCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == SpansTracksEntryExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// SpansCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool SpansCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Spans & value, TableByteOrder order )
{
    if ( !SpansCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !SpansCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == SpansExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// SpansCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool SpansCookLayout( const Ctx & ctx, const Spans & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = SpansExtent( ctx, root );
...
// SpansCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t SpansCookMeasureFrom( const Ctx & ctx, const Spans & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( SpansNumberFrom( ctx, numbering, root ) && SpansCookLayout( ctx, root, numbering, region ) )
    {
...
// SpansCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool SpansCookFrom( const Ctx & ctx, const Spans & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = SpansCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x033de3f1246bba76ull, 8, order ); // the root: fnv1a64( "Spans" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// SpansCookMeasure / SpansCook over a REGION root — a locked builder's AsConst, a
// region SpansLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t SpansCookMeasure( const Spans * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SpansCookMeasureFrom( ctx, *root, allocator );
}

inline bool SpansCook( const Spans * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return SpansCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t SpansCookMeasure( const SpansBuilder & builder )
{
    if ( builder.region != NULL ) { return SpansCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SpansCookMeasureFrom( ctx, *(const Spans *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool SpansCook( const SpansBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return SpansCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SpansCookFrom( ctx, *(const Spans *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( SpansTracksEntry ), "SpansTracksEntry must stay relocatable" );
static_assert( __is_standard_layout( SpansTracksEntry ), "SpansTracksEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Spans ), "Spans must stay relocatable" );
static_assert( __is_standard_layout( Spans ), "Spans must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( SpansTracksEntry ) == 24, "SpansTracksEntry's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( SpansTracksEntry ) == 8, "SpansTracksEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( SpansTracksEntry, key ) == 0, "SpansTracksEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( SpansTracksEntry, value ) == 8, "SpansTracksEntry's field value moved: the build version was taken over offset 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Spans ) == 24, "Spans's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Spans ) == 8, "Spans's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Spans, tracks ) == 0, "Spans's field tracks moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Spans, after ) == 16, "Spans's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );

static_assert( alignof( Item ) <= kTableAlign, "SpansTracksEntry.value: an unbounded array's element alignment must fit the arena's" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * SpansTracksEntryTableType();
inline const TableTypeInfo * SpansTableType();
...
extern const TableTypeInfo SpansTracksEntryTableInfo;
extern const TableTypeInfo SpansTableInfo;

inline const TableFieldInfo SpansTracksEntryTableFields[] = {
    { "key", "key", "uint8", 0x3dc94a19365b10ecull, 6, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( SpansTracksEntry, key ), (uint32_t) sizeof( SpansTracksEntry::key ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "Item", 0x7ce4fd9430e80ceaull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( SpansTracksEntry, value ), (uint32_t) sizeof( Item ), (uint32_t) offsetof( SpansTracksEntry, value.count ), 0xffffffffu, &ItemTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Item> *) slot ); }, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo SpansTracksEntryTableInfo = { "SpansTracksEntry", (uint32_t) sizeof( SpansTracksEntry ), 2, SpansTracksEntryTableFields, +[]( void * p ) { SpansTracksEntryReset( *(SpansTracksEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * SpansTracksEntryTableType() { return &SpansTracksEntryTableInfo; }

inline const TableFieldInfo SpansTableFields[] = {
    { "tracks", "tracks", "map[uint8]Item", 0x755332609c470fbdull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Spans, tracks ), (uint32_t) sizeof( SpansTracksEntry ), (uint32_t) offsetof( Spans, tracks.count ), 0xffffffffu, &SpansTracksEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<SpansTracksEntry> *) slot, (uint8_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Spans, after ), (uint32_t) sizeof( Spans::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo SpansTableInfo = { "Spans", (uint32_t) sizeof( Spans ), 2, SpansTableFields, +[]( void * p ) { SpansReset( *(Spans *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * SpansTableType() { return &SpansTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Spans in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in SpansTable.cpp; link it to use them.
bool SpansFromJson( SpansBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t SpansToJsonMeasure( const Spans * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t SpansToJson( const Spans * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
