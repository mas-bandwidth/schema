...
// table CrewsMembersEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct CrewsMembersEntry {
    uint32_t key = 0;
    TableRef value[2]; // [..2]*Item — used count beside it; every slot null until assigned
    int32_t value_count = 0;
};

// table Crews — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Crews {
    TableMap<CrewsMembersEntry> members; // map[uint32]*Item — the sorted entry array, empty until an insert
    int32_t after = 0;
};
...
inline void CrewsReset( Crews & value )
{
    value.members.entries.value = 0; // map[uint32]*Item: empty
    value.members.count = 0;
    value.members.padding = 0;
    value.after = 0;
}

template <typename Ctx> inline int64_t CrewsMembersEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const CrewsMembersEntry & value );
template <typename Ctx> inline bool CrewsMembersEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const CrewsMembersEntry & value );
inline bool CrewsMembersEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, CrewsMembersEntry & value );
template <typename Ctx> inline int64_t CrewsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Crews & value );
template <typename Ctx> inline bool CrewsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Crews & value );
inline bool CrewsLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Crews & value );
inline bool CrewsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// CrewsMembersEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct CrewsMembersEntryMessageKeyRead
{
    uint32_t key;
...
inline CrewsMembersEntryMessageKeyRead CrewsMembersEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    CrewsMembersEntryMessageKeyRead out = { 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( CrewsMembersEntry & value ) { CrewsMembersEntryReset( value ); }
inline void TableReset( Crews & value ) { CrewsReset( value ); }
...
template <typename Ctx> inline int64_t CrewsMembersEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const CrewsMembersEntry & value );
template <typename Ctx> inline bool CrewsMembersEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const CrewsMembersEntry & value );
template <typename Ctx> inline bool CrewsMembersEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const CrewsMembersEntry & value );
inline bool CrewsMembersEntryLoadBody( TableReader & r, const TableNodeMap & nodes, CrewsMembersEntry & value );
template <typename Ctx> inline int64_t CrewsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Crews & value );
template <typename Ctx> inline bool CrewsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Crews & value );
template <typename Ctx> inline bool CrewsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Crews & value );
...
template <typename Ctx> inline bool CrewsMembersEntryNumber( const Ctx & ctx, TableNumbering & numbering, const CrewsMembersEntry & value );
template <typename Ctx> inline int64_t CrewsMembersEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & value );
template <typename Ctx> inline bool CrewsMembersEntryPack( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & src, CrewsMembersEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool CrewsNumber( const Ctx & ctx, TableNumbering & numbering, const Crews & value );
template <typename Ctx> inline int64_t CrewsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Crews & value );
template <typename Ctx> inline bool CrewsPack( const Ctx & ctx, TablePackMap & seen, const Crews & src, Crews & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const CrewsMembersEntry & value ) { return CrewsMembersEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const CrewsMembersEntry & value ) { return CrewsMembersEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const CrewsMembersEntry & value ) { return CrewsMembersEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const CrewsMembersEntry & value ) { return CrewsMembersEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Crews & value ) { return CrewsMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Crews & value ) { return CrewsSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Crews & value ) { return CrewsMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Crews & value ) { return CrewsSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- CrewsMembersEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( CrewsMembersEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );

inline int TableEntryOrder( const CrewsMembersEntry & a, const CrewsMembersEntry & b )
{
    return TableKeyOrder( (uint64_t) a.key, (uint64_t) b.key ); // integers compare by VALUE, unsigned here
}
inline int TableEntryOrder( const CrewsMembersEntry & entry, uint32_t key )
{
    return TableKeyOrder( (uint64_t) entry.key, (uint64_t) key );
}
inline uint32_t TableEntryKey( const CrewsMembersEntry & entry ) { return entry.key; }
inline void TableEntrySetKey( CrewsMembersEntry & entry, uint32_t key ) { entry.key = key; }
...
inline const CrewsMembersEntry * TableEntryFound( const CrewsMembersEntry * entry ) { return entry; }
inline CrewsMembersEntry * TableEntryValue( CrewsMembersEntry * entry ) { return entry; }
struct CrewsMembersEntryEach { uint32_t key; decltype( TableEntryValue( (CrewsMembersEntry *) NULL ) ) value; };
inline CrewsMembersEntryEach TableEntryEach( CrewsMembersEntry * entry ) { return CrewsMembersEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( CrewsMembersEntry & value )
{
    for ( int32_t i = 0; i < 2; i++ ) { value.value[i].value = 0; } // [2]*Item — every slot null
    value.value_count = 0;
}

// CrewsMembersEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
struct CrewsMembersEntryKeyRead
{
    uint32_t key;
    bool found;         // the body carried the key's id
    bool kind_bad;      // it carried it under another kind: the MAP's event
...
inline CrewsMembersEntryKeyRead CrewsMembersEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    CrewsMembersEntryKeyRead out = { 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t CrewsMembersEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CrewsMembersEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CrewsMembersEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool CrewsMembersEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t CrewsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CrewsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool CrewsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool CrewsLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Crews & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t CrewsMembersEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const CrewsMembersEntry & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    if ( value.value_count < 0 || value.value_count > 2 ) { return -1; } // storage invariant
...
template <typename Ctx>
inline bool CrewsMembersEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const CrewsMembersEntry & value )
{
    if ( value.key != 0 )
    {
    ...
    if ( value.value_count < 0 || value.value_count > 2 ) { return false; } // storage invariant
    if ( value.value_count > 0 )
    {
        const uint64_t ref_value = ids.ref_at( 36, 0x7ce4fd9430e80ceaull );
        int64_t body_value = 0;
        ...
        w.put8( 17 ); w.putleb( (uint64_t) ( value.value_count ) );
        for ( int32_t elem_i = 0; elem_i < value.value_count; elem_i++ )
        {
            {
                const Item * slot_pointee = ItemAt( ctx, value.value[elem_i] );
...
template <typename Ctx>
inline bool CrewsMembersEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const CrewsMembersEntry & value )
{
    if ( !CrewsMembersEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
...
template <typename Ctx>
inline int64_t CrewsMembersEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const CrewsMembersEntry & value )
{
    ...
    if ( value.value_count > 0 )
    {
        bits += kTableMessageRefBitsHere;
        bits += 2;
        bits += (int64_t) ( value.value_count ) * index_bits;
    }
...
inline bool CrewsMembersEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const CrewsMembersEntry & value )
{
    ...
    if ( value.value_count > 0 )
    {
        ...
        w.put( (uint64_t) ( value.value_count ) - 0, 2 );
...
template <typename Ctx>
inline int64_t CrewsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Crews & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // members: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<CrewsMembersEntry> order_members = TableMapOrder( ctx, value.members );
        if ( !order_members.ok ) { return -1; } // the sort could not run
        if ( order_members.count > 0 )
        {
            const uint64_t ref_members = ids.ref_at( 34, 0x79d594675e391090ull );
            int64_t body_members = 1 + TableLebBytes( (uint64_t) order_members.count ); // the element kind byte and the count
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_members = CrewsMembersEntryMeasureBody( ctx, numbering, ids, *order_members[i] );
                if ( elem_members < 0 ) { TableMapRelease( order_members ); return -1; }
                body_members += TableLebBytes( (uint64_t) ( elem_members ) ) + ( elem_members ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_members ) + 1 + TableLebBytes( (uint64_t) ( body_members ) ) + ( body_members );
        }
        TableMapRelease( order_members );
    }
...
template <typename Ctx>
inline bool CrewsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Crews & value )
{
    {
        TableMapCursor<CrewsMembersEntry> order_members = TableMapOrder( ctx, value.members ); // members
        if ( !order_members.ok ) { return false; }
        if ( order_members.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            const uint64_t ref_members = ids.ref_at( 34, 0x79d594675e391090ull );
            int64_t body_members = 1 + TableLebBytes( (uint64_t) order_members.count );
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_members = CrewsMembersEntryMeasureBody( ctx, numbering, ids, *order_members[i] );
                if ( elem_members < 0 ) { TableMapRelease( order_members ); return false; }
                body_members += TableLebBytes( (uint64_t) ( elem_members ) ) + ( elem_members );
            }
            w.putleb( ref_members ); w.put8( 14 ); w.putleb( (uint64_t) body_members );
            w.put8( 13 ); w.putleb( (uint64_t) order_members.count );
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_len_members = CrewsMembersEntryMeasureBody( ctx, numbering, ids, *order_members[i] );
                if ( elem_len_members < 0 ) { TableMapRelease( order_members ); return false; }
                w.putleb( (uint64_t) elem_len_members );
                if ( !CrewsMembersEntrySaveBody( ctx, numbering, w, ids, *order_members[i] ) ) { TableMapRelease( order_members ); return false; }
            }
        }
        TableMapRelease( order_members );
    }
...
template <typename Ctx>
inline bool CrewsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Crews & value )
{
    if ( !CrewsSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x79d594675e391090ull: // members
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        CrewsMembersEntryKeyRead read = CrewsMembersEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t CrewsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Crews & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_members.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_members = CrewsMembersEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_members[i] );
                if ( elem_members < 0 ) { TableMapRelease( order_members ); return -1; }
                bits += elem_members; // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
        }
        TableMapRelease( order_members );
    }
...
inline bool CrewsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Crews & value )
{
    ...
    {
        TableMapCursor<CrewsMembersEntry> order_members = TableMapOrder( ctx, value.members ); // members
        if ( !order_members.ok ) { return false; } // the sort could not run
        if ( order_members.count > 0 )
        {
            w.put( 20, kTableMessageRefBitsHere );
            w.put( (uint64_t) order_members.count, 32 ); // the count the data decides
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                if ( !CrewsMembersEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_members[i] ) ) { TableMapRelease( order_members ); return false; }
            }
        }
        TableMapRelease( order_members );
    }
...
// CrewsMessageExtent: the extent Crews's maps command on the message wire, from
...
inline bool CrewsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x79d594675e391090ull && entry.kind == 14 && entry.elem_kind == 13 ) // members
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( CrewsMembersEntry )
            at += (int64_t) n * (int64_t) sizeof( CrewsMembersEntry ); // the whole array FIRST
        ...
        switch ( entry.id )
        {
            case 0x79d594675e391090ull: // members
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const CrewsMembersEntryMessageKeyRead read = CrewsMembersEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !CrewsMembersEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// CrewsMembersEntryWireExtent: the extent CrewsMembersEntry's lists and maps command, from the FRAMING alone.
...
inline bool CrewsMembersEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// CrewsMembersEntryExtentAt: the node extent CrewsMembersEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as CrewsMembersEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool CrewsMembersEntryExtentAt( const Ctx & ctx, const CrewsMembersEntry & value, int64_t & at )
{
...
template <typename Ctx>
inline int64_t CrewsMembersEntryExtent( const Ctx & ctx, const CrewsMembersEntry & value )
{
...
// advancing the same running offset CrewsMembersEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool CrewsMembersEntryExtentPack( const Ctx & ctx, const CrewsMembersEntry & src, CrewsMembersEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// CrewsWireExtent: the extent Crews's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool CrewsWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0x79d594675e391090ull && field_kind == 14 ) // members
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( CrewsMembersEntry ), (int64_t) alignof( CrewsMembersEntry ), NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// CrewsExtentAt: the node extent Crews's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as CrewsExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool CrewsExtentAt( const Ctx & ctx, const Crews & value, int64_t & at )
{
    {
        TableMapCursor<CrewsMembersEntry> cursor = TableMapOrder( ctx, value.members );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( CrewsMembersEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( CrewsMembersEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !CrewsMembersEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
template <typename Ctx>
inline int64_t CrewsExtent( const Ctx & ctx, const Crews & value )
{
    int64_t at = 0;
    if ( !CrewsExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// CrewsExtentPack: carve Crews's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset CrewsExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool CrewsExtentPack( const Ctx & ctx, const Crews & src, Crews & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<CrewsMembersEntry> cursor = TableMapOrder( ctx, src.members );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( CrewsMembersEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        CrewsMembersEntry * placed = (CrewsMembersEntry *) ( extent + at );
        at += bytes;
        dst.members.count = cursor.count;
        dst.members.padding = 0;
        dst.members.entries.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.members.entries ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( CrewsMembersEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !CrewsMembersEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Crews.members: the builder's five and the side index (§2.8) ----
...
inline CrewsMembersEntry * CrewsMembersInsert( TableWorker & worker, TableMap<CrewsMembersEntry> & map, uint32_t key )
{
    CrewsMembersEntry * entry = TableMapPlace( worker, map, key );
...
inline CrewsMembersEntry * CrewsMembersFind( TableArena & arena, TableMap<CrewsMembersEntry> & map, uint32_t key )
{
    CrewsMembersEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool CrewsMembersErase( TableArena & arena, TableMap<CrewsMembersEntry> & map, uint32_t key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<CrewsMembersEntry> CrewsMembersEach( const TableArena & arena, const TableMap<CrewsMembersEntry> & map )
{
...
inline int64_t CrewsMembersIndexMeasure( const TableMap<CrewsMembersEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex CrewsMembersIndex( const TableMap<CrewsMembersEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const CrewsMembersEntry * entries = map.Entries();
...
inline const CrewsMembersEntry * CrewsMembersIndexFind( const TableMapIndex & index, const TableMap<CrewsMembersEntry> & map, uint32_t key )
{
...
// CrewsMembersEntryNumber: number everything CrewsMembersEntry POINTS AT, in first-visit order —
...
{
    for ( int32_t k = 0; k < value.value_count && k < 2; k++ ) // value: [..2]*Item
    {
    {
...
// CrewsMembersEntryPackMeasure: the packed region bytes of everything CrewsMembersEntry POINTS AT.
...
template <typename Ctx>
inline int64_t CrewsMembersEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & value )
{
    int64_t bytes = 0;
    for ( int32_t k = 0; k < value.value_count && k < 2; k++ ) // value: [..2]*Item
    {
...
// CrewsMembersEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool CrewsMembersEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & src, CrewsMembersEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool CrewsMembersEntryPack( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & src, CrewsMembersEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( CrewsMembersEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( CrewsMembersEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !CrewsMembersEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return CrewsMembersEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}

template <typename Ctx>
inline bool CrewsMembersEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const CrewsMembersEntry & src, CrewsMembersEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    for ( int32_t k = 0; k < src.value_count && k < 2; k++ ) // value: [..2]*Item
    {
    {
...
// CrewsNumber: number everything Crews POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool CrewsNumber( const Ctx & ctx, TableNumbering & numbering, const Crews & value )
{
    { // members: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<CrewsMembersEntry> cursor_members = TableMapOrder( ctx, value.members );
        if ( !cursor_members.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_members.count; i++ )
        {
            if ( !CrewsMembersEntryNumber( ctx, numbering, *cursor_members[i] ) ) { TableMapRelease( cursor_members ); return false; }
        }
        TableMapRelease( cursor_members );
    }
    return true;
}

// CrewsPackMeasure: the packed region bytes of everything Crews POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t CrewsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Crews & value )
{
    int64_t bytes = 0;
    { // members: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<CrewsMembersEntry> cursor_members = TableMapOrder( ctx, value.members );
        if ( !cursor_members.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_members.count; i++ )
        {
            int64_t inner = CrewsMembersEntryPackMeasure( ctx, seen, *cursor_members[i] );
            if ( inner < 0 ) { TableMapRelease( cursor_members ); return -1; }
            bytes += inner;
        }
        TableMapRelease( cursor_members );
    }
...
// CrewsPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool CrewsPackEdges( const Ctx & ctx, TablePackMap & seen, const Crews & src, Crews & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool CrewsPack( const Ctx & ctx, TablePackMap & seen, const Crews & src, Crews & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Crews ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Crews ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !CrewsExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return CrewsPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // members: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<CrewsMembersEntry> cursor_members = TableMapOrder( ctx, src.members );
        if ( !cursor_members.ok ) { return false; }
        CrewsMembersEntry * placed_members = (CrewsMembersEntry *) ( dst.members.entries.value != 0 ? ( (uint8_t *) &dst.members.entries + dst.members.entries.value ) : NULL );
        for ( int32_t i = 0; i < cursor_members.count; i++ )
        {
            if ( !CrewsMembersEntryPackEdges( ctx, seen, *cursor_members[i], placed_members[i], base, capacity, used ) ) { TableMapRelease( cursor_members ); return false; }
        }
        TableMapRelease( cursor_members );
    }
    return true;
...
// ---- Crews: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: CrewsBuilder — allocate nodes, wire them together, then Lock.
...
// Crews is never held by value — a file-format-scale structure is a region
...
struct CrewsBuilder
{
    ...
    CrewsBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Crews * GetRoot() { return arena.locked ? NULL : (Crews *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Crews * AsConst() const { return (const Crews *) region; }
...
inline bool CrewsBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Crews & root = *(const Crews *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Crews on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// CrewsNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t CrewsNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
...
// CrewsNodePlace: start one record's node's lifetime in the storage pass one
...
inline void CrewsNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// CrewsNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t CrewsNodeRecordBytes( uint64_t type_id )
{
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return TableAlignUp64( (int64_t) sizeof( Item ) ); // Item
...
// CrewsNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t CrewsNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// CrewsNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void CrewsNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = CrewsNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? CrewsNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// CrewsNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t CrewsNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// CrewsNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool CrewsNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// CrewsNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool CrewsNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + CrewsNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !CrewsNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool CrewsNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Crews & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return CrewsNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t CrewsMeasureWire( const Ctx & ctx, const Crews & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( CrewsNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = CrewsMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t CrewsSaveWire( const Ctx & ctx, const Crews & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !CrewsNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = CrewsSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == CrewsMeasure( root )
}

inline int64_t CrewsMeasure( const Crews * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CrewsMeasureWire( ctx, *root, allocator );
}

inline int64_t CrewsSave( const Crews * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CrewsSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t CrewsMeasure( const CrewsBuilder & builder )
{
    if ( builder.region != NULL ) { return CrewsMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CrewsMeasureWire( ctx, *(const Crews *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t CrewsSave( const CrewsBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return CrewsSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CrewsSaveWire( ctx, *(const Crews *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Crews on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// CrewsMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t CrewsMessageBodyBits( const Ctx & ctx, const Crews & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( CrewsNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = CrewsMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool CrewsMessageBodySave( const Ctx & ctx, const Crews & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && CrewsSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t CrewsMeasureMessages( const Crews * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = CrewsMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t CrewsSaveMessages( const Crews * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !CrewsMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == CrewsMeasureMessages( roots, count, report, allocator )
}

// CrewsMessageRecordScan: one node record's type id and the extent its maps
...
inline bool CrewsMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return CrewsNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// CrewsMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool CrewsMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !CrewsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = CrewsNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !CrewsMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Crews ) ) + root_extent );
    return true;
}

// CrewsLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t CrewsLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !CrewsMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// CrewsLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool CrewsLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Crews * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !CrewsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = CrewsNodeMessageStorage( type_id, extent, length );
        ...
        CrewsNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !CrewsMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Crews ) ) + root_extent );
    ...
    Crews * root = new ( region + used ) Crews; // lifetime only: LoadMessageBody's first act is CrewsReset
    CrewsReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Crews ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !CrewsNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return CrewsLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// CrewsLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool CrewsLoadMessages( const Crews ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !CrewsLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// CrewsLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t CrewsLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !CrewsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Crews ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = CrewsNodeStorage( type_id, length, reason );
...
// CrewsLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Crews * CrewsLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Crews ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !CrewsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Crews ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0xc85b940060088651ull;
    Crews * root = new ( region ) Crews; // lifetime only: LoadBody's first act is CrewsReset
    CrewsReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                CrewsNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Crews ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    CrewsLoadBody( r, nodes, *root );
    return root;
}

// CrewsLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool CrewsLoadBuilder( CrewsBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = CrewsNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = CrewsLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t CrewsMembersEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    if ( value.value_count < 0 || value.value_count > 2 ) { return -1; } // storage invariant
...
template <typename Ctx>
inline bool CrewsMembersEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key != 0 )
    {
        w.putleb( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ); w.put8( 8 ); // key
...
template <typename Ctx>
inline bool CrewsMembersEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const CrewsMembersEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !CrewsMembersEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t CrewsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // members: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_members.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_members = CrewsMembersEntryMeasureBodyRetain( ctx, numbering, ids, *order_members[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_members < 0 ) { TableMapRelease( order_members ); return -1; }
                body_members += TableLebBytes( (uint64_t) ( elem_members ) ) + ( elem_members ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_members ) + 1 + TableLebBytes( (uint64_t) ( body_members ) ) + ( body_members );
...
template <typename Ctx>
inline bool CrewsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<CrewsMembersEntry> order_members = TableMapOrder( ctx, value.members ); // members
        if ( !order_members.ok ) { return false; }
        if ( order_members.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_members.count; i++ )
            {
                const int64_t elem_len_members = CrewsMembersEntryMeasureBodyRetain( ctx, numbering, ids, *order_members[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_members < 0 ) { TableMapRelease( order_members ); return false; }
                w.putleb( (uint64_t) elem_len_members );
                if ( !CrewsMembersEntrySaveBodyRetain( ctx, numbering, w, ids, *order_members[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_members ); return false; }
            }
        }
        TableMapRelease( order_members );
    }
...
template <typename Ctx>
inline bool CrewsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Crews & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !CrewsSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x79d594675e391090ull: // members
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !CrewsMembersEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// CrewsNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void CrewsNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// CrewsLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Crews * CrewsLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                CrewsNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    CrewsLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// CrewsNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool CrewsNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + CrewsNodeRecordBytes( type_id );
    carve.left = 0;
...
// CrewsLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool CrewsLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Crews * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !CrewsNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return CrewsLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// CrewsLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool CrewsLoadRetainMessages( const Crews ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !CrewsLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// CrewsMeasureRetain and CrewsSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t CrewsMeasureWireRetain( const Ctx & ctx, const Crews & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( CrewsNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = CrewsMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t CrewsSaveWireRetain( const Ctx & ctx, const Crews & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = CrewsSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t CrewsMeasureRetain( const Crews * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CrewsMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t CrewsSaveRetain( const Crews * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CrewsSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}
...
// CrewsOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH CrewsAt: the slot holds
...
// parameter on a load.
inline const Crews * CrewsOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Crews *) TableCookOpen( bytes, length, (uint64_t) sizeof( Crews ), (uint64_t) alignof( Crews ), reason );
}
...
template <typename Ctx> inline bool CrewsMembersEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const CrewsMembersEntry & value, TableByteOrder order );
template <typename Ctx> inline bool CrewsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Crews & value, TableByteOrder order );
...
template <typename Ctx> inline bool CrewsMembersEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const CrewsMembersEntry & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 24, (uint64_t) (uint32_t) value.value_count, 4, order );
    return true;
}
...
template <typename Ctx> inline bool CrewsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Crews & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 0, 0, 8, order ); // members: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool CrewsMembersEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const CrewsMembersEntry & value, TableByteOrder order );
template <typename Ctx> inline bool CrewsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Crews & value, TableByteOrder order );

// CrewsMembersEntryCookExtent: CrewsMembersEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
// CrewsCookExtent: Crews's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool CrewsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Crews & value, TableByteOrder order )
{
    ...
    { // members
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !CrewsMembersEntryCookBody( ctx, region, array + i * 32, *cursor[i], order ) ) { return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// CrewsMembersEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool CrewsMembersEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const CrewsMembersEntry & value, TableByteOrder order )
{
    if ( !CrewsMembersEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    return CrewsMembersEntryCookExtent( ctx, region, at + 32, extent_at, at, value, order );
}

// CrewsCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool CrewsCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Crews & value, TableByteOrder order )
{
    if ( !CrewsCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !CrewsCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == CrewsExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// CrewsCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool CrewsCookLayout( const Ctx & ctx, const Crews & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = CrewsExtent( ctx, root );
...
// CrewsCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t CrewsCookMeasureFrom( const Ctx & ctx, const Crews & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( CrewsNumberFrom( ctx, numbering, root ) && CrewsCookLayout( ctx, root, numbering, region ) )
    {
...
// CrewsCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool CrewsCookFrom( const Ctx & ctx, const Crews & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = CrewsCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0xc85b940060088651ull, 8, order ); // the root: fnv1a64( "Crews" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// CrewsCookMeasure / CrewsCook over a REGION root — a locked builder's AsConst, a
// region CrewsLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t CrewsCookMeasure( const Crews * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return CrewsCookMeasureFrom( ctx, *root, allocator );
}

inline bool CrewsCook( const Crews * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return CrewsCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t CrewsCookMeasure( const CrewsBuilder & builder )
{
    if ( builder.region != NULL ) { return CrewsCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CrewsCookMeasureFrom( ctx, *(const Crews *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool CrewsCook( const CrewsBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return CrewsCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return CrewsCookFrom( ctx, *(const Crews *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( CrewsMembersEntry ), "CrewsMembersEntry must stay relocatable" );
static_assert( __is_standard_layout( CrewsMembersEntry ), "CrewsMembersEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Crews ), "Crews must stay relocatable" );
static_assert( __is_standard_layout( Crews ), "Crews must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( CrewsMembersEntry ) == 32, "CrewsMembersEntry's sizeof moved: the build version was taken over 32, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( CrewsMembersEntry ) == 8, "CrewsMembersEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( CrewsMembersEntry, key ) == 0, "CrewsMembersEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( CrewsMembersEntry, value ) == 8, "CrewsMembersEntry's field value moved: the build version was taken over offset 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Crews ) == 24, "Crews's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Crews ) == 8, "Crews's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Crews, members ) == 0, "Crews's field members moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Crews, after ) == 16, "Crews's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );


// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * CrewsMembersEntryTableType();
inline const TableTypeInfo * CrewsTableType();
...
extern const TableTypeInfo CrewsMembersEntryTableInfo;
extern const TableTypeInfo CrewsTableInfo;

inline const TableFieldInfo CrewsMembersEntryTableFields[] = {
    { "key", "key", "uint32", 0x3dc94a19365b10ecull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( CrewsMembersEntry, key ), (uint32_t) sizeof( CrewsMembersEntry::key ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "Item", 0x7ce4fd9430e80ceaull, 17, true, true, []( const void * slot ) -> const void * { return (const void *) ItemAt( *(const TableRef *) slot ); }, []( TableWorker & worker, void * slot ) -> void * { return (void *) ItemEmplace( worker, *(TableRef *) slot ); }, true, false, 2, (uint32_t) offsetof( CrewsMembersEntry, value ), (uint32_t) sizeof( CrewsMembersEntry::value[0] ), (uint32_t) offsetof( CrewsMembersEntry, value_count ), 0xffffffffu, &ItemTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo CrewsMembersEntryTableInfo = { "CrewsMembersEntry", (uint32_t) sizeof( CrewsMembersEntry ), 2, CrewsMembersEntryTableFields, +[]( void * p ) { CrewsMembersEntryReset( *(CrewsMembersEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * CrewsMembersEntryTableType() { return &CrewsMembersEntryTableInfo; }

inline const TableFieldInfo CrewsTableFields[] = {
    { "members", "members", "map[uint32]*Item", 0x79d594675e391090ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Crews, members ), (uint32_t) sizeof( CrewsMembersEntry ), (uint32_t) offsetof( Crews, members.count ), 0xffffffffu, &CrewsMembersEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<CrewsMembersEntry> *) slot, (uint32_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Crews, after ), (uint32_t) sizeof( Crews::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo CrewsTableInfo = { "Crews", (uint32_t) sizeof( Crews ), 2, CrewsTableFields, +[]( void * p ) { CrewsReset( *(Crews *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * CrewsTableType() { return &CrewsTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Crews in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in CrewsTable.cpp; link it to use them.
bool CrewsFromJson( CrewsBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t CrewsToJsonMeasure( const Crews * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t CrewsToJson( const Crews * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
