// Code generated by the schema compiler from Docs.schema. DO NOT EDIT.
...
// table DocsPagesEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct DocsPagesEntry {
    char key[8 + 1] = {}; // string(8): max length, used length beside it
    int32_t key_length = 0;
    TableRef value; // *string — a byte buffer at its used size, null until assigned
};

// table Docs — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Docs {
    TableMap<DocsPagesEntry> pages; // map[string(8)]*string — the sorted entry array, empty until an insert
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void DocsPagesEntryReset( DocsPagesEntry & value );
inline void DocsReset( Docs & value );

inline void DocsPagesEntryReset( DocsPagesEntry & value )
{
    memset( value.key, 0, sizeof( value.key ) );
    value.key_length = 0;
    value.value.value = 0; // *string — null
}

inline void DocsReset( Docs & value )
{
    value.pages.entries.value = 0; // map[string(8)]*string: empty
    value.pages.count = 0;
    value.pages.padding = 0;
    value.after = 0;
}

template <typename Ctx> inline int64_t DocsPagesEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const DocsPagesEntry & value );
template <typename Ctx> inline bool DocsPagesEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const DocsPagesEntry & value );
inline bool DocsPagesEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, DocsPagesEntry & value );
template <typename Ctx> inline int64_t DocsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Docs & value );
template <typename Ctx> inline bool DocsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Docs & value );
inline bool DocsLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Docs & value );
inline bool DocsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// DocsPagesEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct DocsPagesEntryMessageKeyRead
{
...
inline DocsPagesEntryMessageKeyRead DocsPagesEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    DocsPagesEntryMessageKeyRead out = { NULL, 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( DocsPagesEntry & value ) { DocsPagesEntryReset( value ); }
inline void TableReset( Docs & value ) { DocsReset( value ); }
...
template <typename Ctx> inline int64_t DocsPagesEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const DocsPagesEntry & value );
template <typename Ctx> inline bool DocsPagesEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const DocsPagesEntry & value );
template <typename Ctx> inline bool DocsPagesEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const DocsPagesEntry & value );
inline bool DocsPagesEntryLoadBody( TableReader & r, const TableNodeMap & nodes, DocsPagesEntry & value );
template <typename Ctx> inline int64_t DocsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Docs & value );
template <typename Ctx> inline bool DocsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Docs & value );
template <typename Ctx> inline bool DocsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Docs & value );
...
template <typename Ctx> inline bool DocsPagesEntryNumber( const Ctx & ctx, TableNumbering & numbering, const DocsPagesEntry & value );
template <typename Ctx> inline int64_t DocsPagesEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const DocsPagesEntry & value );
template <typename Ctx> inline bool DocsPagesEntryPack( const Ctx & ctx, TablePackMap & seen, const DocsPagesEntry & src, DocsPagesEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool DocsNumber( const Ctx & ctx, TableNumbering & numbering, const Docs & value );
template <typename Ctx> inline int64_t DocsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Docs & value );
template <typename Ctx> inline bool DocsPack( const Ctx & ctx, TablePackMap & seen, const Docs & src, Docs & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const DocsPagesEntry & value ) { return DocsPagesEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const DocsPagesEntry & value ) { return DocsPagesEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const DocsPagesEntry & value ) { return DocsPagesEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const DocsPagesEntry & value ) { return DocsPagesEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Docs & value ) { return DocsMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Docs & value ) { return DocsSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Docs & value ) { return DocsMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Docs & value ) { return DocsSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- DocsPagesEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( DocsPagesEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );
static const int32_t kDocsPagesEntryKeyBound = 8; // string(8): the key's storage, and the length an insert refuses past

inline int TableEntryOrder( const DocsPagesEntry & a, const DocsPagesEntry & b )
{
...
inline int TableEntryOrder( const DocsPagesEntry & entry, TableMapKeyRef key )
{
    return TableKeyOrder( entry.key, entry.key_length, key.data, key.length );
}
inline int TableEntryOrder( const DocsPagesEntry & entry, const char * key )
{
    return TableEntryOrder( entry, TableMapKeyRef{ key, TableKeyLength( key, kDocsPagesEntryKeyBound ) } );
}
inline const char * TableEntryKey( const DocsPagesEntry & entry ) { return entry.key; } // NUL-terminated, the storage's own bytes
inline void TableEntrySetKey( DocsPagesEntry & entry, TableMapKeyRef key )
{
...
// a map[K]*string or map[K]*bytes: the value is a slot naming a BLOB
// NODE (§2.5), so the const Find answers the RESOLVED blob, one add on
// the self-relative delta, exactly as TableBlobAt answers it (§6.2, §6.3)
inline const TableBlob * TableEntryFound( const DocsPagesEntry * entry ) { return entry != NULL ? TableBlobAt( entry->value ) : NULL; }
inline TableRef * TableEntryValue( DocsPagesEntry * entry ) { return &entry->value; } // the builder hands back the SLOT
struct DocsPagesEntryEach { const char * key; decltype( TableEntryValue( (DocsPagesEntry *) NULL ) ) value; };
inline DocsPagesEntryEach TableEntryEach( DocsPagesEntry * entry ) { return DocsPagesEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( DocsPagesEntry & value )
{
    value.value.value = 0; // *string — null
}

// DocsPagesEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
inline DocsPagesEntryKeyRead DocsPagesEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    DocsPagesEntryKeyRead out = { NULL, 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t DocsPagesEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DocsPagesEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DocsPagesEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool DocsPagesEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t DocsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DocsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DocsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool DocsLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Docs & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t DocsPagesEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const DocsPagesEntry & value )
{
    ...
    {
        const TableBlob * blob_value = TableBlobAt( ctx, value.value ); // *string
        ...
        if ( blob_value != NULL )
        {
            ...
            if ( !TableNumberingIndex( numbering, (const void *) blob_value, index_value ) ) { return -1; }
            bytes += TableLebBytes( ids.ref_at( 36, 0x7ce4fd9430e80ceaull ) ) + 1 + TableLebBytes( index_value );
        }
    }
    return bytes;
}
...
template <typename Ctx>
inline bool DocsPagesEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const DocsPagesEntry & value )
{
    ...
    }
    {
        ...
        {
            uint64_t index_value = 0;
            if ( !TableNumberingIndex( numbering, (const void *) blob_value, index_value ) ) { return false; }
            w.header( ids.ref_at( 36, 0x7ce4fd9430e80ceaull ), 17 ); // value — a NODE INDEX into the flat node table
...
template <typename Ctx>
inline bool DocsPagesEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const DocsPagesEntry & value )
{
    if ( !DocsPagesEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
        ...
        switch ( field_id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    ...
                    TableNodeResolve( nodes, value.value, node_index, kTableStringTypeId, r.report ); // *string
                }
                break;
            }
...
template <typename Ctx>
inline int64_t DocsPagesEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const DocsPagesEntry & value )
{
    ...
    {
        const TableBlob * pointee_value = TableBlobAt( ctx, value.value ); // *string: a byte buffer
...
template <typename Ctx>
inline bool DocsPagesEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const DocsPagesEntry & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.key_length < 0 || value.key_length > 8 ) { return false; } // storage invariant
    if ( value.key_length > 0 )
        ...
        switch ( entry.id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                }
                {
                    ...
                    TableNodeResolve( nodes, value.value, node_index, kTableStringTypeId, report ); // *string
                }
                break;
            }
            default:
...
template <typename Ctx>
inline int64_t DocsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Docs & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // pages: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<DocsPagesEntry> order_pages = TableMapOrder( ctx, value.pages );
        if ( !order_pages.ok ) { return -1; } // the sort could not run
        if ( order_pages.count > 0 )
        {
            const uint64_t ref_pages = ids.ref_at( 49, 0xab01daa76a48769full );
            int64_t body_pages = 1 + TableLebBytes( (uint64_t) order_pages.count ); // the element kind byte and the count
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_pages = DocsPagesEntryMeasureBody( ctx, numbering, ids, *order_pages[i] );
                if ( elem_pages < 0 ) { TableMapRelease( order_pages ); return -1; }
                body_pages += TableLebBytes( (uint64_t) ( elem_pages ) ) + ( elem_pages ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_pages ) + 1 + TableLebBytes( (uint64_t) ( body_pages ) ) + ( body_pages );
        }
        TableMapRelease( order_pages );
    }
...
template <typename Ctx>
inline bool DocsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Docs & value )
{
    {
        TableMapCursor<DocsPagesEntry> order_pages = TableMapOrder( ctx, value.pages ); // pages
        if ( !order_pages.ok ) { return false; }
        if ( order_pages.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            const uint64_t ref_pages = ids.ref_at( 49, 0xab01daa76a48769full );
            int64_t body_pages = 1 + TableLebBytes( (uint64_t) order_pages.count );
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_pages = DocsPagesEntryMeasureBody( ctx, numbering, ids, *order_pages[i] );
                if ( elem_pages < 0 ) { TableMapRelease( order_pages ); return false; }
                body_pages += TableLebBytes( (uint64_t) ( elem_pages ) ) + ( elem_pages );
            }
            w.header( ref_pages, 14 ); w.putleb( (uint64_t) body_pages );
            w.put8( 13 ); w.putleb( (uint64_t) order_pages.count );
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_len_pages = DocsPagesEntryMeasureBody( ctx, numbering, ids, *order_pages[i] );
                if ( elem_len_pages < 0 ) { TableMapRelease( order_pages ); return false; }
                w.putleb( (uint64_t) elem_len_pages );
                if ( !DocsPagesEntrySaveBody( ctx, numbering, w, ids, *order_pages[i] ) ) { TableMapRelease( order_pages ); return false; }
            }
        }
        TableMapRelease( order_pages );
    }
...
template <typename Ctx>
inline bool DocsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Docs & value )
{
    if ( !DocsSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0xab01daa76a48769full: // pages
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        DocsPagesEntryKeyRead read = DocsPagesEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t DocsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Docs & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_pages.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_pages = DocsPagesEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_pages[i] );
                if ( elem_pages < 0 ) { TableMapRelease( order_pages ); return -1; }
                bits += elem_pages; // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
        }
        TableMapRelease( order_pages );
    }
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool DocsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Docs & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableMapCursor<DocsPagesEntry> order_pages = TableMapOrder( ctx, value.pages ); // pages
        if ( !order_pages.ok ) { return false; } // the sort could not run
        if ( order_pages.count > 0 )
        {
            w.put( 26, kTableMessageRefBitsHere );
            w.put( (uint64_t) order_pages.count, 32 ); // the count the data decides
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                if ( !DocsPagesEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_pages[i] ) ) { TableMapRelease( order_pages ); return false; }
            }
        }
        TableMapRelease( order_pages );
    }
...
// DocsMessageExtent: the extent Docs's maps command on the message wire, from
...
inline bool DocsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0xab01daa76a48769full && entry.kind == 14 && entry.elem_kind == 13 ) // pages
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( DocsPagesEntry )
            at += (int64_t) n * (int64_t) sizeof( DocsPagesEntry ); // the whole array FIRST
        ...
        switch ( entry.id )
        {
            case 0xab01daa76a48769full: // pages
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const DocsPagesEntryMessageKeyRead read = DocsPagesEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !DocsPagesEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// DocsPagesEntryWireExtent: the extent DocsPagesEntry's lists and maps command, from the FRAMING alone.
...
inline bool DocsPagesEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// DocsPagesEntryExtentAt: the node extent DocsPagesEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as DocsPagesEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool DocsPagesEntryExtentAt( const Ctx & ctx, const DocsPagesEntry & value, int64_t & at )
{
...
template <typename Ctx>
inline int64_t DocsPagesEntryExtent( const Ctx & ctx, const DocsPagesEntry & value )
{
    (void) ctx; (void) value; // no list or map below this record
    return 0;
}

// DocsPagesEntryExtentPack: carve DocsPagesEntry's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset DocsPagesEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool DocsPagesEntryExtentPack( const Ctx & ctx, const DocsPagesEntry & src, DocsPagesEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// DocsWireExtent: the extent Docs's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool DocsWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0xab01daa76a48769full && field_kind == 14 ) // pages
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( DocsPagesEntry ), (int64_t) alignof( DocsPagesEntry ), NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// DocsExtentAt: the node extent Docs's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as DocsExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool DocsExtentAt( const Ctx & ctx, const Docs & value, int64_t & at )
{
    {
        TableMapCursor<DocsPagesEntry> cursor = TableMapOrder( ctx, value.pages );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( DocsPagesEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( DocsPagesEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !DocsPagesEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
template <typename Ctx>
inline int64_t DocsExtent( const Ctx & ctx, const Docs & value )
{
    int64_t at = 0;
    if ( !DocsExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// DocsExtentPack: carve Docs's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset DocsExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool DocsExtentPack( const Ctx & ctx, const Docs & src, Docs & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<DocsPagesEntry> cursor = TableMapOrder( ctx, src.pages );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( DocsPagesEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        DocsPagesEntry * placed = (DocsPagesEntry *) ( extent + at );
        at += bytes;
        dst.pages.count = cursor.count;
        dst.pages.padding = 0;
        dst.pages.entries.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.pages.entries ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( DocsPagesEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !DocsPagesEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Docs.pages: the builder's five and the side index (§2.8) ----
...
inline TableRef * DocsPagesInsert( TableWorker & worker, TableMap<DocsPagesEntry> & map, const char * key )
{
    if ( key == NULL ) { return NULL; }
    const TableMapKeyRef bytes = { key, TableKeyLength( key, kDocsPagesEntryKeyBound ) };
    if ( bytes.length > kDocsPagesEntryKeyBound ) { return NULL; } // KEYS NEVER CLAMP
    DocsPagesEntry * entry = TableMapPlace( worker, map, bytes );
...
inline TableRef * DocsPagesFind( TableArena & arena, TableMap<DocsPagesEntry> & map, const char * key )
{
    DocsPagesEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool DocsPagesErase( TableArena & arena, TableMap<DocsPagesEntry> & map, const char * key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<DocsPagesEntry> DocsPagesEach( const TableArena & arena, const TableMap<DocsPagesEntry> & map )
{
...
inline int64_t DocsPagesIndexMeasure( const TableMap<DocsPagesEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex DocsPagesIndex( const TableMap<DocsPagesEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const DocsPagesEntry * entries = map.Entries();
...
inline const TableBlob * DocsPagesIndexFind( const TableMapIndex & index, const TableMap<DocsPagesEntry> & map, const char * key )
{
    if ( !index.good ) { return map.Find( key ); } // an index that did not build is not a wrong answer
    const DocsPagesEntry * entries = map.Entries();
    int32_t at = (int32_t) ( TableMapHash( (const void *) key, TableKeyLength( key, kDocsPagesEntryKeyBound ) ) & (uint64_t) ( index.capacity - 1 ) );
...
// DocsPagesEntryNumber: number everything DocsPagesEntry POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool DocsPagesEntryNumber( const Ctx & ctx, TableNumbering & numbering, const DocsPagesEntry & value )
{
    {
        const TableBlob * blob = TableBlobAt( ctx, value.value ); // value: a byte buffer
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            if ( taken )
            {
                ...
                node.type_slot = 56; // its slot in the unit's vocabulary (§3.3)
...
// DocsPagesEntryPackMeasure: the packed region bytes of everything DocsPagesEntry POINTS AT.
...
template <typename Ctx>
inline int64_t DocsPagesEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const DocsPagesEntry & value )
{
    int64_t bytes = 0;
    {
        const TableBlob * blob = TableBlobAt( ctx, value.value ); // value: a byte buffer, packed at its used size
        if ( blob != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
...
// DocsPagesEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool DocsPagesEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const DocsPagesEntry & src, DocsPagesEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool DocsPagesEntryPack( const Ctx & ctx, TablePackMap & seen, const DocsPagesEntry & src, DocsPagesEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( DocsPagesEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( DocsPagesEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !DocsPagesEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return DocsPagesEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    {
        dst.value.value = 0; // value: a byte buffer
        const TableBlob * blob = TableBlobAt( ctx, src.value );
        if ( blob != NULL )
        {
...
// DocsNumber: number everything Docs POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool DocsNumber( const Ctx & ctx, TableNumbering & numbering, const Docs & value )
{
    { // pages: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<DocsPagesEntry> cursor_pages = TableMapOrder( ctx, value.pages );
        if ( !cursor_pages.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_pages.count; i++ )
        {
            if ( !DocsPagesEntryNumber( ctx, numbering, *cursor_pages[i] ) ) { TableMapRelease( cursor_pages ); return false; }
        }
        TableMapRelease( cursor_pages );
    }
    return true;
}

// DocsPackMeasure: the packed region bytes of everything Docs POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t DocsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Docs & value )
{
    int64_t bytes = 0;
    { // pages: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<DocsPagesEntry> cursor_pages = TableMapOrder( ctx, value.pages );
        if ( !cursor_pages.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_pages.count; i++ )
        {
            int64_t inner = DocsPagesEntryPackMeasure( ctx, seen, *cursor_pages[i] );
            if ( inner < 0 ) { TableMapRelease( cursor_pages ); return -1; }
            bytes += inner;
        }
        TableMapRelease( cursor_pages );
    }
...
// DocsPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool DocsPackEdges( const Ctx & ctx, TablePackMap & seen, const Docs & src, Docs & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool DocsPack( const Ctx & ctx, TablePackMap & seen, const Docs & src, Docs & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Docs ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Docs ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !DocsExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return DocsPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // pages: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<DocsPagesEntry> cursor_pages = TableMapOrder( ctx, src.pages );
        if ( !cursor_pages.ok ) { return false; }
        DocsPagesEntry * placed_pages = (DocsPagesEntry *) ( dst.pages.entries.value != 0 ? ( (uint8_t *) &dst.pages.entries + dst.pages.entries.value ) : NULL );
        for ( int32_t i = 0; i < cursor_pages.count; i++ )
        {
            if ( !DocsPagesEntryPackEdges( ctx, seen, *cursor_pages[i], placed_pages[i], base, capacity, used ) ) { TableMapRelease( cursor_pages ); return false; }
        }
        TableMapRelease( cursor_pages );
    }
    return true;
...
// ---- Docs: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: DocsBuilder — allocate nodes, wire them together, then Lock.
...
// Docs is never held by value — a file-format-scale structure is a region
...
struct DocsBuilder
{
    ...
    DocsBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Docs * GetRoot() { return arena.locked ? NULL : (Docs *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Docs * AsConst() const { return (const Docs *) region; }
...
inline bool DocsBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Docs & root = *(const Docs *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Docs on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// DocsNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t DocsNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    switch ( type_id )
    {
...
// DocsNodePlace: start one record's node's lifetime in the storage pass one
...
inline void DocsNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    switch ( type_id )
    {
...
// DocsNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t DocsNodeRecordBytes( uint64_t type_id )
{
    (void) type_id;
    return 0;
}

// DocsNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t DocsNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    switch ( type_id )
    {
...
// DocsNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void DocsNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = DocsNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? DocsNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// DocsNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t DocsNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) extent;
    switch ( type_id )
    {
...
// DocsNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool DocsNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// DocsNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool DocsNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + DocsNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !DocsNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool DocsNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Docs & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return DocsNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t DocsMeasureWire( const Ctx & ctx, const Docs & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( DocsNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = DocsMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t DocsSaveWire( const Ctx & ctx, const Docs & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !DocsNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = DocsSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == DocsMeasure( root )
}

inline int64_t DocsMeasure( const Docs * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DocsMeasureWire( ctx, *root, allocator );
}

inline int64_t DocsSave( const Docs * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DocsSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t DocsMeasure( const DocsBuilder & builder )
{
    if ( builder.region != NULL ) { return DocsMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DocsMeasureWire( ctx, *(const Docs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t DocsSave( const DocsBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return DocsSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DocsSaveWire( ctx, *(const Docs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Docs on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// DocsMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t DocsMessageBodyBits( const Ctx & ctx, const Docs & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( DocsNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = DocsMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool DocsMessageBodySave( const Ctx & ctx, const Docs & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && DocsSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t DocsMeasureMessages( const Docs * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = DocsMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t DocsSaveMessages( const Docs * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !DocsMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == DocsMeasureMessages( roots, count, report, allocator )
}

// DocsMessageRecordScan: one node record's type id and the extent its maps
...
inline bool DocsMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return DocsNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// DocsMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool DocsMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !DocsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = DocsNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !DocsMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Docs ) ) + root_extent );
    return true;
}

// DocsLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t DocsLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !DocsMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// DocsLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool DocsLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Docs * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !DocsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = DocsNodeMessageStorage( type_id, extent, length );
        ...
        DocsNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !DocsMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Docs ) ) + root_extent );
    ...
    Docs * root = new ( region + used ) Docs; // lifetime only: LoadMessageBody's first act is DocsReset
    DocsReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Docs ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !DocsNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return DocsLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// DocsLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool DocsLoadMessages( const Docs ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !DocsLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// DocsLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t DocsLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !DocsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Docs ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = DocsNodeStorage( type_id, length, reason );
...
// DocsLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Docs * DocsLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Docs ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !DocsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Docs ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x036ffe7360826852ull;
    Docs * root = new ( region ) Docs; // lifetime only: LoadBody's first act is DocsReset
    DocsReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                DocsNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Docs ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    DocsLoadBody( r, nodes, *root );
    return root;
}

// DocsLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool DocsLoadBuilder( DocsBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = DocsNodeAlloc( type_id, builder.main, length );
            if ( type_id == kTableStringTypeId && !TableUtf8Valid( body, length ) )
            {
                out->malformed = true;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = DocsLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t DocsPagesEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key_length < 0 || value.key_length > 8 ) { return -1; } // storage invariant
    if ( value.key_length > 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + TableLebBytes( (uint64_t) ( value.key_length ) ) + ( value.key_length ); } // key
...
template <typename Ctx>
inline bool DocsPagesEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key_length < 0 || value.key_length > 8 ) { return false; } // storage invariant
    if ( value.key_length > 0 )
    {
...
template <typename Ctx>
inline bool DocsPagesEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const DocsPagesEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !DocsPagesEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t DocsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // pages: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_pages.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_pages = DocsPagesEntryMeasureBodyRetain( ctx, numbering, ids, *order_pages[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_pages < 0 ) { TableMapRelease( order_pages ); return -1; }
                body_pages += TableLebBytes( (uint64_t) ( elem_pages ) ) + ( elem_pages ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_pages ) + 1 + TableLebBytes( (uint64_t) ( body_pages ) ) + ( body_pages );
...
template <typename Ctx>
inline bool DocsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<DocsPagesEntry> order_pages = TableMapOrder( ctx, value.pages ); // pages
        if ( !order_pages.ok ) { return false; }
        if ( order_pages.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_pages.count; i++ )
            {
                const int64_t elem_len_pages = DocsPagesEntryMeasureBodyRetain( ctx, numbering, ids, *order_pages[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_pages < 0 ) { TableMapRelease( order_pages ); return false; }
                w.putleb( (uint64_t) elem_len_pages );
                if ( !DocsPagesEntrySaveBodyRetain( ctx, numbering, w, ids, *order_pages[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_pages ); return false; }
            }
        }
        TableMapRelease( order_pages );
    }
...
template <typename Ctx>
inline bool DocsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Docs & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !DocsSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0xab01daa76a48769full: // pages
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !DocsPagesEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; last_length = read.length; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// DocsNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void DocsNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// DocsLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Docs * DocsLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                DocsNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    DocsLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// DocsNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool DocsNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + DocsNodeRecordBytes( type_id );
    carve.left = 0;
...
// DocsLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool DocsLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Docs * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !DocsNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return DocsLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// DocsLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool DocsLoadRetainMessages( const Docs ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !DocsLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// DocsMeasureRetain and DocsSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t DocsMeasureWireRetain( const Ctx & ctx, const Docs & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( DocsNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = DocsMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t DocsSaveWireRetain( const Ctx & ctx, const Docs & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = DocsSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t DocsMeasureRetain( const Docs * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DocsMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t DocsSaveRetain( const Docs * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DocsSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// DocsSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH DocsAt: the slot holds
...
// parameter on a load.
inline const Docs * DocsOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Docs *) TableCookOpen( bytes, length, (uint64_t) sizeof( Docs ), (uint64_t) alignof( Docs ), reason );
}
...
template <typename Ctx> inline bool DocsPagesEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const DocsPagesEntry & value, TableByteOrder order );
template <typename Ctx> inline bool DocsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Docs & value, TableByteOrder order );

template <typename Ctx> inline bool DocsPagesEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const DocsPagesEntry & value, TableByteOrder order )
{
    table_cook_bytes( at + 0, value.key, value.key_length, 9 );
    table_cook_put( at + 12, (uint64_t) (uint32_t) value.key_length, 4, order );
    if ( !table_cook_ref( region, at + 16, (const void *) TableBlobAt( ctx, value.value ), order ) ) { return false; } // value
    return true;
}
...
template <typename Ctx> inline bool DocsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Docs & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 0, 0, 8, order ); // pages: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool DocsPagesEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const DocsPagesEntry & value, TableByteOrder order );
template <typename Ctx> inline bool DocsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Docs & value, TableByteOrder order );

// DocsPagesEntryCookExtent: DocsPagesEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
// DocsCookExtent: Docs's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool DocsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Docs & value, TableByteOrder order )
{
    ...
    { // pages
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !DocsPagesEntryCookBody( ctx, region, array + i * 24, *cursor[i], order ) ) { return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// DocsPagesEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool DocsPagesEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const DocsPagesEntry & value, TableByteOrder order )
{
    if ( !DocsPagesEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    return DocsPagesEntryCookExtent( ctx, region, at + 24, extent_at, at, value, order );
}

// DocsCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool DocsCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Docs & value, TableByteOrder order )
{
    if ( !DocsCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !DocsCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == DocsExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// DocsCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool DocsCookLayout( const Ctx & ctx, const Docs & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = DocsExtent( ctx, root );
...
// DocsCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t DocsCookMeasureFrom( const Ctx & ctx, const Docs & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( DocsNumberFrom( ctx, numbering, root ) && DocsCookLayout( ctx, root, numbering, region ) )
    {
...
// DocsCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool DocsCookFrom( const Ctx & ctx, const Docs & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = DocsCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x036ffe7360826852ull, 8, order ); // the root: fnv1a64( "Docs" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// DocsCookMeasure / DocsCook over a REGION root — a locked builder's AsConst, a
// region DocsLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t DocsCookMeasure( const Docs * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DocsCookMeasureFrom( ctx, *root, allocator );
}

inline bool DocsCook( const Docs * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return DocsCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t DocsCookMeasure( const DocsBuilder & builder )
{
    if ( builder.region != NULL ) { return DocsCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DocsCookMeasureFrom( ctx, *(const Docs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool DocsCook( const DocsBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return DocsCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DocsCookFrom( ctx, *(const Docs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( DocsPagesEntry ), "DocsPagesEntry must stay relocatable" );
static_assert( __is_standard_layout( DocsPagesEntry ), "DocsPagesEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Docs ), "Docs must stay relocatable" );
static_assert( __is_standard_layout( Docs ), "Docs must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( DocsPagesEntry ) == 24, "DocsPagesEntry's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( DocsPagesEntry ) == 8, "DocsPagesEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( DocsPagesEntry, key ) == 0, "DocsPagesEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( DocsPagesEntry, value ) == 16, "DocsPagesEntry's field value moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Docs ) == 24, "Docs's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Docs ) == 8, "Docs's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Docs, pages ) == 0, "Docs's field pages moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Docs, after ) == 16, "Docs's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );


// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * DocsPagesEntryTableType();
inline const TableTypeInfo * DocsTableType();
...
extern const TableTypeInfo DocsPagesEntryTableInfo;
extern const TableTypeInfo DocsTableInfo;

inline const TableFieldInfo DocsPagesEntryTableFields[] = {
    { "key", "key", "string", 0x3dc94a19365b10ecull, 12, false, false, NULL, NULL, true, false, 8, (uint32_t) offsetof( DocsPagesEntry, key ), (uint32_t) sizeof( DocsPagesEntry::key ), (uint32_t) offsetof( DocsPagesEntry, key_length ), 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "string", 0x7ce4fd9430e80ceaull, 17, false, true, []( const void * slot ) -> const void * { return (const void *) TableBlobAt( *(const TableRef *) slot ); }, NULL, false, false, 0, (uint32_t) offsetof( DocsPagesEntry, value ), (uint32_t) sizeof( TableRef ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo DocsPagesEntryTableInfo = { "DocsPagesEntry", (uint32_t) sizeof( DocsPagesEntry ), 2, DocsPagesEntryTableFields, +[]( void * p ) { DocsPagesEntryReset( *(DocsPagesEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * DocsPagesEntryTableType() { return &DocsPagesEntryTableInfo; }

inline const TableFieldInfo DocsTableFields[] = {
    { "pages", "pages", "map[string(8)]*string", 0xab01daa76a48769full, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Docs, pages ), (uint32_t) sizeof( DocsPagesEntry ), (uint32_t) offsetof( Docs, pages.count ), 0xffffffffu, &DocsPagesEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char * key, int32_t key_length, int64_t ) -> void * { if ( key == NULL ) { return NULL; } return (void *) TableMapPlace( worker, *(TableMap<DocsPagesEntry> *) slot, TableMapKeyRef{ key, key_length } ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Docs, after ), (uint32_t) sizeof( Docs::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo DocsTableInfo = { "Docs", (uint32_t) sizeof( Docs ), 2, DocsTableFields, +[]( void * p ) { DocsReset( *(Docs *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * DocsTableType() { return &DocsTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Docs in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in DocsTable.cpp; link it to use them.
bool DocsFromJson( DocsBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t DocsToJsonMeasure( const Docs * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t DocsToJson( const Docs * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
