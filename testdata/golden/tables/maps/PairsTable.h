// Code generated by the schema compiler from Pairs.schema. DO NOT EDIT.
...
// table PairsSlotsEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct PairsSlotsEntry {
    uint32_t key = 0;
    TableRef value[2]; // [2]*Item — every slot null until assigned
};

// table Pairs — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Pairs {
    TableMap<PairsSlotsEntry> slots; // map[uint32]*Item — the sorted entry array, empty until an insert
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void PairsSlotsEntryReset( PairsSlotsEntry & value );
inline void PairsReset( Pairs & value );

inline void PairsSlotsEntryReset( PairsSlotsEntry & value )
{
    value.key = 0;
    for ( int32_t i = 0; i < 2; i++ ) { value.value[i].value = 0; } // [2]*Item — every slot null
}

inline void PairsReset( Pairs & value )
{
    value.slots.entries.value = 0; // map[uint32]*Item: empty
    value.slots.count = 0;
    value.slots.padding = 0;
    value.after = 0;
}

template <typename Ctx> inline int64_t PairsSlotsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const PairsSlotsEntry & value );
template <typename Ctx> inline bool PairsSlotsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const PairsSlotsEntry & value );
inline bool PairsSlotsEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, PairsSlotsEntry & value );
template <typename Ctx> inline int64_t PairsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Pairs & value );
template <typename Ctx> inline bool PairsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Pairs & value );
inline bool PairsLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Pairs & value );
inline bool PairsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// PairsSlotsEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct PairsSlotsEntryMessageKeyRead
{
    uint32_t key;
...
inline PairsSlotsEntryMessageKeyRead PairsSlotsEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    PairsSlotsEntryMessageKeyRead out = { 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( PairsSlotsEntry & value ) { PairsSlotsEntryReset( value ); }
inline void TableReset( Pairs & value ) { PairsReset( value ); }
...
template <typename Ctx> inline int64_t PairsSlotsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const PairsSlotsEntry & value );
template <typename Ctx> inline bool PairsSlotsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const PairsSlotsEntry & value );
template <typename Ctx> inline bool PairsSlotsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const PairsSlotsEntry & value );
inline bool PairsSlotsEntryLoadBody( TableReader & r, const TableNodeMap & nodes, PairsSlotsEntry & value );
template <typename Ctx> inline int64_t PairsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Pairs & value );
template <typename Ctx> inline bool PairsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Pairs & value );
template <typename Ctx> inline bool PairsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Pairs & value );
...
template <typename Ctx> inline bool PairsSlotsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const PairsSlotsEntry & value );
template <typename Ctx> inline int64_t PairsSlotsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & value );
template <typename Ctx> inline bool PairsSlotsEntryPack( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & src, PairsSlotsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool PairsNumber( const Ctx & ctx, TableNumbering & numbering, const Pairs & value );
template <typename Ctx> inline int64_t PairsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Pairs & value );
template <typename Ctx> inline bool PairsPack( const Ctx & ctx, TablePackMap & seen, const Pairs & src, Pairs & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const PairsSlotsEntry & value ) { return PairsSlotsEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const PairsSlotsEntry & value ) { return PairsSlotsEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const PairsSlotsEntry & value ) { return PairsSlotsEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const PairsSlotsEntry & value ) { return PairsSlotsEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Pairs & value ) { return PairsMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Pairs & value ) { return PairsSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Pairs & value ) { return PairsMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Pairs & value ) { return PairsSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- PairsSlotsEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( PairsSlotsEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );

inline int TableEntryOrder( const PairsSlotsEntry & a, const PairsSlotsEntry & b )
{
    return TableKeyOrder( (uint64_t) a.key, (uint64_t) b.key ); // integers compare by VALUE, unsigned here
}
inline int TableEntryOrder( const PairsSlotsEntry & entry, uint32_t key )
{
    return TableKeyOrder( (uint64_t) entry.key, (uint64_t) key );
}
inline uint32_t TableEntryKey( const PairsSlotsEntry & entry ) { return entry.key; }
inline void TableEntrySetKey( PairsSlotsEntry & entry, uint32_t key ) { entry.key = key; }
// A FIXED ARRAY VALUE IS ONE MEMBER (§2.8, §4.2): the handle points at the
// ARRAY and not at its first element, so the extent survives the handoff.
typedef TableRef PairsSlotsEntryValue[2];
inline const PairsSlotsEntryValue * TableEntryFound( const PairsSlotsEntry * entry ) { return entry != NULL ? &entry->value : NULL; }
inline PairsSlotsEntryValue * TableEntryValue( PairsSlotsEntry * entry ) { return &entry->value; }
struct PairsSlotsEntryEach { uint32_t key; decltype( TableEntryValue( (PairsSlotsEntry *) NULL ) ) value; };
inline PairsSlotsEntryEach TableEntryEach( PairsSlotsEntry * entry ) { return PairsSlotsEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( PairsSlotsEntry & value )
{
    for ( int32_t i = 0; i < 2; i++ ) { value.value[i].value = 0; } // [2]*Item — every slot null
}

// PairsSlotsEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
inline PairsSlotsEntryKeyRead PairsSlotsEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    PairsSlotsEntryKeyRead out = { 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t PairsSlotsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool PairsSlotsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool PairsSlotsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool PairsSlotsEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t PairsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool PairsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool PairsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool PairsLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Pairs & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t PairsSlotsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const PairsSlotsEntry & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
        bool any_value = false;
        for ( int32_t i = 0; i < 2; i++ ) { if ( ItemAt( ctx, value.value[i] ) != NULL ) { any_value = true; break; } }
        if ( any_value )
        {
            const uint64_t ref_value = ids.ref_at( 36, 0x7ce4fd9430e80ceaull );
            int64_t body_value = 0;
            body_value += 1 + TableLebBytes( (uint64_t) ( 2 ) ); // the element kind byte and the count
            for ( int32_t elem_i = 0; elem_i < 2; elem_i++ )
            {
                {
                    const Item * slot_pointee = ItemAt( ctx, value.value[elem_i] );
                    uint64_t slot_index = 0;
                    if ( slot_pointee != NULL && !TableNumberingIndex( numbering, (const void *) slot_pointee, slot_index ) ) { return -1; }
                    body_value += TableLebBytes( slot_index );
                }
            }
            bytes += TableLebBytes( ref_value ) + 1 + TableLebBytes( (uint64_t) ( body_value ) ) + ( body_value ); // value: [2]*Item
        }
    }
    return bytes;
}
...
template <typename Ctx>
inline bool PairsSlotsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const PairsSlotsEntry & value )
{
    if ( value.key != 0 )
    {
...
template <typename Ctx>
inline bool PairsSlotsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const PairsSlotsEntry & value )
{
    if ( !PairsSlotsEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
                    ...
                    {
                        {
                            ...
                            TableNodeResolve( nodes, value.value[(int32_t) i], node_index, 0x52cfa1d198476806ull, r.report ); // *Item
                        }
                    }
                    }
                }
...
template <typename Ctx>
inline int64_t PairsSlotsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const PairsSlotsEntry & value )
{
    ...
    {
        bool rides_value = false;
        for ( int32_t i = 0; i < 2; i++ ) { if ( ItemAt( ctx, value.value[i] ) != NULL ) { rides_value = true; break; } }
        if ( rides_value )
        {
            bits += kTableMessageRefBitsHere;
...
template <typename Ctx>
inline bool PairsSlotsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const PairsSlotsEntry & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.key != 0 )
    {
    ...
    }
    {
        ...
        if ( rides_value )
        {
            ...
            {
                const Item * pointee_value = ItemAt( ctx, value.value[i] ); // *Item
                uint64_t index_value = 0;
                if ( pointee_value != NULL && !TableNumberingIndex( numbering, (const void *) pointee_value, index_value ) ) { return false; }
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        TableRef scratch;
                        {
                            ...
                            TableNodeResolve( nodes, ( in_bounds ? value.value[i] : scratch ), node_index_2, 0x52cfa1d198476806ull, report ); // *Item
                        }
                    }
                }
                break;
...
template <typename Ctx>
inline int64_t PairsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Pairs & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // slots: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<PairsSlotsEntry> order_slots = TableMapOrder( ctx, value.slots );
        if ( !order_slots.ok ) { return -1; } // the sort could not run
        if ( order_slots.count > 0 )
        {
            const uint64_t ref_slots = ids.ref_at( 65, 0xe68c2e6bb1ee5646ull );
            int64_t body_slots = 1 + TableLebBytes( (uint64_t) order_slots.count ); // the element kind byte and the count
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_slots = PairsSlotsEntryMeasureBody( ctx, numbering, ids, *order_slots[i] );
                if ( elem_slots < 0 ) { TableMapRelease( order_slots ); return -1; }
                body_slots += TableLebBytes( (uint64_t) ( elem_slots ) ) + ( elem_slots ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_slots ) + 1 + TableLebBytes( (uint64_t) ( body_slots ) ) + ( body_slots );
        }
        TableMapRelease( order_slots );
    }
...
template <typename Ctx>
inline bool PairsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Pairs & value )
{
    {
        TableMapCursor<PairsSlotsEntry> order_slots = TableMapOrder( ctx, value.slots ); // slots
        if ( !order_slots.ok ) { return false; }
        if ( order_slots.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            const uint64_t ref_slots = ids.ref_at( 65, 0xe68c2e6bb1ee5646ull );
            int64_t body_slots = 1 + TableLebBytes( (uint64_t) order_slots.count );
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_slots = PairsSlotsEntryMeasureBody( ctx, numbering, ids, *order_slots[i] );
                if ( elem_slots < 0 ) { TableMapRelease( order_slots ); return false; }
                body_slots += TableLebBytes( (uint64_t) ( elem_slots ) ) + ( elem_slots );
            }
            w.header( ref_slots, 14 ); w.putleb( (uint64_t) body_slots );
            w.put8( 13 ); w.putleb( (uint64_t) order_slots.count );
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_len_slots = PairsSlotsEntryMeasureBody( ctx, numbering, ids, *order_slots[i] );
                if ( elem_len_slots < 0 ) { TableMapRelease( order_slots ); return false; }
                w.putleb( (uint64_t) elem_len_slots );
                if ( !PairsSlotsEntrySaveBody( ctx, numbering, w, ids, *order_slots[i] ) ) { TableMapRelease( order_slots ); return false; }
            }
        }
        TableMapRelease( order_slots );
    }
...
template <typename Ctx>
inline bool PairsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Pairs & value )
{
    if ( !PairsSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
        ...
        switch ( field_id )
        {
            case 0xe68c2e6bb1ee5646ull: // slots
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    TableMapFill<PairsSlotsEntry> fill = TableMapFillBegin( nodes, value.slots, count );
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        PairsSlotsEntryKeyRead read = PairsSlotsEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t PairsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Pairs & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_slots.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_slots = PairsSlotsEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_slots[i] );
                if ( elem_slots < 0 ) { TableMapRelease( order_slots ); return -1; }
                bits += elem_slots; // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
        }
        TableMapRelease( order_slots );
    }
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool PairsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Pairs & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableMapCursor<PairsSlotsEntry> order_slots = TableMapOrder( ctx, value.slots ); // slots
        if ( !order_slots.ok ) { return false; } // the sort could not run
        if ( order_slots.count > 0 )
        {
            w.put( 37, kTableMessageRefBitsHere );
            w.put( (uint64_t) order_slots.count, 32 ); // the count the data decides
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                if ( !PairsSlotsEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_slots[i] ) ) { TableMapRelease( order_slots ); return false; }
            }
        }
        TableMapRelease( order_slots );
    }
...
// PairsMessageExtent: the extent Pairs's maps command on the message wire, from
...
inline bool PairsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0xe68c2e6bb1ee5646ull && entry.kind == 14 && entry.elem_kind == 13 ) // slots
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( PairsSlotsEntry )
            at += (int64_t) n * (int64_t) sizeof( PairsSlotsEntry ); // the whole array FIRST
        ...
        switch ( entry.id )
        {
            case 0xe68c2e6bb1ee5646ull: // slots
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const PairsSlotsEntryMessageKeyRead read = PairsSlotsEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !PairsSlotsEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// PairsSlotsEntryWireExtent: the extent PairsSlotsEntry's lists and maps command, from the FRAMING alone.
...
inline bool PairsSlotsEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) body; (void) length; (void) at; (void) ids; (void) reason; // no list or map below this record
    return true;
}

// PairsSlotsEntryExtentAt: the node extent PairsSlotsEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as PairsSlotsEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool PairsSlotsEntryExtentAt( const Ctx & ctx, const PairsSlotsEntry & value, int64_t & at )
{
...
template <typename Ctx>
inline int64_t PairsSlotsEntryExtent( const Ctx & ctx, const PairsSlotsEntry & value )
{
...
// advancing the same running offset PairsSlotsEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool PairsSlotsEntryExtentPack( const Ctx & ctx, const PairsSlotsEntry & src, PairsSlotsEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    (void) ctx; (void) src; (void) dst; (void) extent; (void) at; (void) capacity; // no list or map below this record
    return true;
}

// PairsWireExtent: the extent Pairs's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool PairsWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0xe68c2e6bb1ee5646ull && field_kind == 14 ) // slots
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( PairsSlotsEntry ), (int64_t) alignof( PairsSlotsEntry ), NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// PairsExtentAt: the node extent Pairs's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as PairsExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool PairsExtentAt( const Ctx & ctx, const Pairs & value, int64_t & at )
{
    {
        TableMapCursor<PairsSlotsEntry> cursor = TableMapOrder( ctx, value.slots );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( PairsSlotsEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( PairsSlotsEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !PairsSlotsEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
template <typename Ctx>
inline int64_t PairsExtent( const Ctx & ctx, const Pairs & value )
{
    int64_t at = 0;
    if ( !PairsExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// PairsExtentPack: carve Pairs's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset PairsExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool PairsExtentPack( const Ctx & ctx, const Pairs & src, Pairs & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<PairsSlotsEntry> cursor = TableMapOrder( ctx, src.slots );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( PairsSlotsEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        PairsSlotsEntry * placed = (PairsSlotsEntry *) ( extent + at );
        at += bytes;
        dst.slots.count = cursor.count;
        dst.slots.padding = 0;
        dst.slots.entries.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.slots.entries ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( PairsSlotsEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !PairsSlotsEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Pairs.slots: the builder's five and the side index (§2.8) ----
...
inline PairsSlotsEntryValue * PairsSlotsInsert( TableWorker & worker, TableMap<PairsSlotsEntry> & map, uint32_t key )
{
    PairsSlotsEntry * entry = TableMapPlace( worker, map, key );
...
inline PairsSlotsEntryValue * PairsSlotsFind( TableArena & arena, TableMap<PairsSlotsEntry> & map, uint32_t key )
{
    PairsSlotsEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool PairsSlotsErase( TableArena & arena, TableMap<PairsSlotsEntry> & map, uint32_t key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<PairsSlotsEntry> PairsSlotsEach( const TableArena & arena, const TableMap<PairsSlotsEntry> & map )
{
...
inline int64_t PairsSlotsIndexMeasure( const TableMap<PairsSlotsEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex PairsSlotsIndex( const TableMap<PairsSlotsEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const PairsSlotsEntry * entries = map.Entries();
...
inline const PairsSlotsEntryValue * PairsSlotsIndexFind( const TableMapIndex & index, const TableMap<PairsSlotsEntry> & map, uint32_t key )
{
...
// PairsSlotsEntryNumber: number everything PairsSlotsEntry POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool PairsSlotsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const PairsSlotsEntry & value )
{
    for ( int32_t k = 0; k < 2; k++ ) // value: [2]*Item
    {
    {
        const Item * pointee = ItemAt( ctx, value.value[k] ); // value
        if ( pointee != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            else
            {
                ...
                node.type_id = 0x52cfa1d198476806ull; // fnv1a64( "Item" )
                node.type_slot = 65; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableNodeMeasureThunk<Ctx, Item>;
                node.save = &TableNodeSaveThunk<Ctx, Item>;
                node.message_measure = &TableNodeMessageMeasureThunk<Ctx, Item>;
                node.message_save = &TableNodeMessageSaveThunk<Ctx, Item>;
                if ( !TableNumberingAppend( numbering, node ) ) { return false; }
                if ( !ItemNumber( ctx, numbering, *pointee ) ) { return false; }
...
// PairsSlotsEntryPackMeasure: the packed region bytes of everything PairsSlotsEntry POINTS AT.
...
template <typename Ctx>
inline int64_t PairsSlotsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & value )
{
    int64_t bytes = 0;
    for ( int32_t k = 0; k < 2; k++ ) // value: [2]*Item
    {
    {
        ...
        if ( pointee != NULL )
        {
            ...
            {
                int64_t inner = ItemPackMeasure( ctx, seen, *pointee );
                if ( inner < 0 ) { return -1; }
                TablePackMapClose( seen, (const void *) pointee, slot );
                bytes += TableAlignUp64( (int64_t) sizeof( Item ) ) + inner;
            }
        }
    }
    }
...
// PairsSlotsEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool PairsSlotsEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & src, PairsSlotsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool PairsSlotsEntryPack( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & src, PairsSlotsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( PairsSlotsEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( PairsSlotsEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !PairsSlotsEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return PairsSlotsEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
inline bool PairsSlotsEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const PairsSlotsEntry & src, PairsSlotsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    ...
    {
    {
        dst.value[k].value = 0; // value
        const Item * pointee = ItemAt( ctx, src.value[k] );
        if ( pointee != NULL )
        {
            ...
            {
                if ( entry->open != 0 ) { return false; } // a data cycle
                dst.value[k].value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.value[k] ); // the one body it already has
            }
            else
            {
                if ( at + (int64_t) sizeof( Item ) > capacity ) { return false; }
                used = at + TableAlignUp64( (int64_t) sizeof( Item ) );
                Item * child = new ( base + at ) Item; // lifetime only: the Pack below memcpy's the whole node over it
                dst.value[k].value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.value[k] );
                if ( !ItemPack( ctx, seen, *pointee, *child, base, capacity, used ) ) { return false; }
                TablePackMapClose( seen, (const void *) pointee, slot );
            }
        }
    }
...
// PairsNumber: number everything Pairs POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool PairsNumber( const Ctx & ctx, TableNumbering & numbering, const Pairs & value )
{
    { // slots: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<PairsSlotsEntry> cursor_slots = TableMapOrder( ctx, value.slots );
        if ( !cursor_slots.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_slots.count; i++ )
        {
            if ( !PairsSlotsEntryNumber( ctx, numbering, *cursor_slots[i] ) ) { TableMapRelease( cursor_slots ); return false; }
        }
        TableMapRelease( cursor_slots );
    }
    return true;
}

// PairsPackMeasure: the packed region bytes of everything Pairs POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t PairsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Pairs & value )
{
    int64_t bytes = 0;
    { // slots: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<PairsSlotsEntry> cursor_slots = TableMapOrder( ctx, value.slots );
        if ( !cursor_slots.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_slots.count; i++ )
        {
            int64_t inner = PairsSlotsEntryPackMeasure( ctx, seen, *cursor_slots[i] );
            if ( inner < 0 ) { TableMapRelease( cursor_slots ); return -1; }
            bytes += inner;
        }
        TableMapRelease( cursor_slots );
    }
...
// PairsPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool PairsPackEdges( const Ctx & ctx, TablePackMap & seen, const Pairs & src, Pairs & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool PairsPack( const Ctx & ctx, TablePackMap & seen, const Pairs & src, Pairs & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Pairs ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Pairs ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !PairsExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return PairsPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // slots: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<PairsSlotsEntry> cursor_slots = TableMapOrder( ctx, src.slots );
        if ( !cursor_slots.ok ) { return false; }
        PairsSlotsEntry * placed_slots = (PairsSlotsEntry *) ( dst.slots.entries.value != 0 ? ( (uint8_t *) &dst.slots.entries + dst.slots.entries.value ) : NULL );
        for ( int32_t i = 0; i < cursor_slots.count; i++ )
        {
            if ( !PairsSlotsEntryPackEdges( ctx, seen, *cursor_slots[i], placed_slots[i], base, capacity, used ) ) { TableMapRelease( cursor_slots ); return false; }
        }
        TableMapRelease( cursor_slots );
    }
    return true;
...
// ---- Pairs: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: PairsBuilder — allocate nodes, wire them together, then Lock.
...
// Pairs is never held by value — a file-format-scale structure is a region
...
struct PairsBuilder
{
    ...
    PairsBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Pairs * GetRoot() { return arena.locked ? NULL : (Pairs *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Pairs * AsConst() const { return (const Pairs *) region; }
...
inline bool PairsBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Pairs & root = *(const Pairs *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Pairs on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// PairsNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t PairsNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
    (void) length; // no byte buffer below this root: every node's storage is its type's
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return TableAlignUp64( (int64_t) sizeof( Item ) ); // Item
        default: break;
    }
...
// PairsNodePlace: start one record's node's lifetime in the storage pass one
...
inline void PairsNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: { Item * node = new ( at ) Item; ItemReset( *node ); break; } // Item
        default: break;
    }
}

// PairsNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t PairsNodeRecordBytes( uint64_t type_id )
{
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return TableAlignUp64( (int64_t) sizeof( Item ) ); // Item
...
// PairsNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t PairsNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return (uint32_t) worker.Alloc<Item>().ref.value; // Item
        default: break;
    }
    return 0;
}

// PairsNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void PairsNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = PairsNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? PairsNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
    ...
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: ItemLoadBody( r, *(Item *) at ); break; // Item
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// PairsNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t PairsNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Item ) ) + extent ); // Item
        default: break;
    }
    return -1;
}

// PairsNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool PairsNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// PairsNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool PairsNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + PairsNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !PairsNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    ...
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: ok = ItemLoadMessageBody( r, vocabulary, report, index_bits, *(Item *) at ); break; // Item
...
template <typename Ctx>
inline bool PairsNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Pairs & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return PairsNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t PairsMeasureWire( const Ctx & ctx, const Pairs & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( PairsNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = PairsMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t PairsSaveWire( const Ctx & ctx, const Pairs & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !PairsNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = PairsSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == PairsMeasure( root )
}

inline int64_t PairsMeasure( const Pairs * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return PairsMeasureWire( ctx, *root, allocator );
}

inline int64_t PairsSave( const Pairs * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return PairsSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t PairsMeasure( const PairsBuilder & builder )
{
    if ( builder.region != NULL ) { return PairsMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return PairsMeasureWire( ctx, *(const Pairs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t PairsSave( const PairsBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return PairsSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return PairsSaveWire( ctx, *(const Pairs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Pairs on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// PairsMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t PairsMessageBodyBits( const Ctx & ctx, const Pairs & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( PairsNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = PairsMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool PairsMessageBodySave( const Ctx & ctx, const Pairs & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && PairsSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t PairsMeasureMessages( const Pairs * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = PairsMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t PairsSaveMessages( const Pairs * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !PairsMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == PairsMeasureMessages( roots, count, report, allocator )
}

// PairsMessageRecordScan: one node record's type id and the extent its maps
...
inline bool PairsMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return PairsNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// PairsMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool PairsMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !PairsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = PairsNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !PairsMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Pairs ) ) + root_extent );
    return true;
}

// PairsLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t PairsLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !PairsMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// PairsLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool PairsLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Pairs * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !PairsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = PairsNodeMessageStorage( type_id, extent, length );
        ...
        PairsNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !PairsMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Pairs ) ) + root_extent );
    ...
    Pairs * root = new ( region + used ) Pairs; // lifetime only: LoadMessageBody's first act is PairsReset
    PairsReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Pairs ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !PairsNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return PairsLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// PairsLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool PairsLoadMessages( const Pairs ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !PairsLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// PairsLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t PairsLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !PairsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Pairs ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = PairsNodeStorage( type_id, length, reason );
...
// PairsLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Pairs * PairsLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Pairs ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !PairsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Pairs ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x1404200dab337086ull;
    Pairs * root = new ( region ) Pairs; // lifetime only: LoadBody's first act is PairsReset
    PairsReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                PairsNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Pairs ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    PairsLoadBody( r, nodes, *root );
    return root;
}

// PairsLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool PairsLoadBuilder( PairsBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = PairsNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = PairsLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t PairsSlotsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
...
template <typename Ctx>
inline bool PairsSlotsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key != 0 )
    {
        w.header( ids.ref_at( 21, 0x3dc94a19365b10ecull ), 8 ); // key
...
template <typename Ctx>
inline bool PairsSlotsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const PairsSlotsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !PairsSlotsEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t PairsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // slots: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_slots.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_slots = PairsSlotsEntryMeasureBodyRetain( ctx, numbering, ids, *order_slots[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_slots < 0 ) { TableMapRelease( order_slots ); return -1; }
                body_slots += TableLebBytes( (uint64_t) ( elem_slots ) ) + ( elem_slots ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_slots ) + 1 + TableLebBytes( (uint64_t) ( body_slots ) ) + ( body_slots );
...
template <typename Ctx>
inline bool PairsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<PairsSlotsEntry> order_slots = TableMapOrder( ctx, value.slots ); // slots
        if ( !order_slots.ok ) { return false; }
        if ( order_slots.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_slots.count; i++ )
            {
                const int64_t elem_len_slots = PairsSlotsEntryMeasureBodyRetain( ctx, numbering, ids, *order_slots[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_slots < 0 ) { TableMapRelease( order_slots ); return false; }
                w.putleb( (uint64_t) elem_len_slots );
                if ( !PairsSlotsEntrySaveBodyRetain( ctx, numbering, w, ids, *order_slots[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_slots ); return false; }
            }
        }
        TableMapRelease( order_slots );
    }
...
template <typename Ctx>
inline bool PairsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Pairs & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !PairsSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0xe68c2e6bb1ee5646ull: // slots
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !PairsSlotsEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// PairsNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void PairsNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: ItemLoadBodyRetain( r, *(Item *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Item
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// PairsLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Pairs * PairsLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                PairsNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    PairsLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// PairsNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool PairsNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + PairsNodeRecordBytes( type_id );
    carve.left = 0;
    ...
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: ok = ItemLoadMessageBodyRetain( r, vocabulary, report, index_bits, *(Item *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Item
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    nodes.carve = outer;
...
// PairsLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool PairsLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Pairs * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !PairsNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return PairsLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// PairsLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool PairsLoadRetainMessages( const Pairs ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !PairsLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// PairsMeasureRetain and PairsSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t PairsMeasureWireRetain( const Ctx & ctx, const Pairs & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0x52cfa1d198476806ull: return ItemMeasureBodyRetain( ii, *(const Item *) node, rt, at ); // Item
            default: break;
        }
        return -1;
    };
    if ( PairsNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = PairsMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t PairsSaveWireRetain( const Ctx & ctx, const Pairs & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0x52cfa1d198476806ull: return ItemSaveBodyRetain( ww, ii, *(const Item *) node, rt, at ); // Item
            default: break;
        }
        return false;
    };
    ...
    bool ok = PairsSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t PairsMeasureRetain( const Pairs * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return PairsMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t PairsSaveRetain( const Pairs * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return PairsSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// PairsSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH PairsAt: the slot holds
...
// parameter on a load.
inline const Pairs * PairsOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Pairs *) TableCookOpen( bytes, length, (uint64_t) sizeof( Pairs ), (uint64_t) alignof( Pairs ), reason );
}
...
template <typename Ctx> inline bool PairsSlotsEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const PairsSlotsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool PairsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Pairs & value, TableByteOrder order );

template <typename Ctx> inline bool PairsSlotsEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const PairsSlotsEntry & value, TableByteOrder order )
{
    table_cook_put( at + 0, (uint64_t) value.key, 4, order );
    for ( int32_t i = 0; i < 2; i++ ) // value: an array of pointers, every slot
    {
        if ( !table_cook_ref( region, at + 8 + i * 8, (const void *) ItemAt( ctx, value.value[ i ] ), order ) ) { return false; }
    }
    return true;
}
...
template <typename Ctx> inline bool PairsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Pairs & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 0, 0, 8, order ); // slots: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool PairsSlotsEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const PairsSlotsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool PairsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Pairs & value, TableByteOrder order );

// PairsSlotsEntryCookExtent: PairsSlotsEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
// PairsCookExtent: Pairs's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool PairsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Pairs & value, TableByteOrder order )
{
    ...
    { // slots
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !PairsSlotsEntryCookBody( ctx, region, array + i * 24, *cursor[i], order ) ) { return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// PairsSlotsEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool PairsSlotsEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const PairsSlotsEntry & value, TableByteOrder order )
{
    if ( !PairsSlotsEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    return PairsSlotsEntryCookExtent( ctx, region, at + 24, extent_at, at, value, order );
}

// PairsCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool PairsCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Pairs & value, TableByteOrder order )
{
    if ( !PairsCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !PairsCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == PairsExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// PairsCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool PairsCookLayout( const Ctx & ctx, const Pairs & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = PairsExtent( ctx, root );
    ...
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
        ...
        {
            case 0x52cfa1d198476806ull: size = 4; node_align = 4; break; // Item
            default: return false;
        }
...
// PairsCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t PairsCookMeasureFrom( const Ctx & ctx, const Pairs & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( PairsNumberFrom( ctx, numbering, root ) && PairsCookLayout( ctx, root, numbering, region ) )
    {
...
// PairsCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool PairsCookFrom( const Ctx & ctx, const Pairs & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = PairsCookNode( ctx, region, region.base, root, order );
            for ( int64_t k = 0; ok && k < numbering.count; k++ )
            {
                ...
                switch ( numbering.entries[k].type_id )
                {
                    case 0x52cfa1d198476806ull: ok = ItemCookNode( ctx, region, at, *(const Item *) node, order ); break; // Item
            ...
            table_cook_put( entry + 8, 0x1404200dab337086ull, 8, order ); // the root: fnv1a64( "Pairs" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// PairsCookMeasure / PairsCook over a REGION root — a locked builder's AsConst, a
// region PairsLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t PairsCookMeasure( const Pairs * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return PairsCookMeasureFrom( ctx, *root, allocator );
}

inline bool PairsCook( const Pairs * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return PairsCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t PairsCookMeasure( const PairsBuilder & builder )
{
    if ( builder.region != NULL ) { return PairsCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return PairsCookMeasureFrom( ctx, *(const Pairs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool PairsCook( const PairsBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return PairsCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return PairsCookFrom( ctx, *(const Pairs *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( PairsSlotsEntry ), "PairsSlotsEntry must stay relocatable" );
static_assert( __is_standard_layout( PairsSlotsEntry ), "PairsSlotsEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Pairs ), "Pairs must stay relocatable" );
static_assert( __is_standard_layout( Pairs ), "Pairs must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( PairsSlotsEntry ) == 24, "PairsSlotsEntry's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( PairsSlotsEntry ) == 8, "PairsSlotsEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( PairsSlotsEntry, key ) == 0, "PairsSlotsEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( PairsSlotsEntry, value ) == 8, "PairsSlotsEntry's field value moved: the build version was taken over offset 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Pairs ) == 24, "Pairs's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Pairs ) == 8, "Pairs's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Pairs, slots ) == 0, "Pairs's field slots moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Pairs, after ) == 16, "Pairs's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );


// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * PairsSlotsEntryTableType();
inline const TableTypeInfo * PairsTableType();
...
extern const TableTypeInfo PairsSlotsEntryTableInfo;
extern const TableTypeInfo PairsTableInfo;

inline const TableFieldInfo PairsSlotsEntryTableFields[] = {
    { "key", "key", "uint32", 0x3dc94a19365b10ecull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( PairsSlotsEntry, key ), (uint32_t) sizeof( PairsSlotsEntry::key ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "Item", 0x7ce4fd9430e80ceaull, 17, true, true, []( const void * slot ) -> const void * { return (const void *) ItemAt( *(const TableRef *) slot ); }, []( TableWorker & worker, void * slot ) -> void * { return (void *) ItemEmplace( worker, *(TableRef *) slot ); }, false, false, 2, (uint32_t) offsetof( PairsSlotsEntry, value ), (uint32_t) sizeof( PairsSlotsEntry::value[0] ), 0xffffffffu, 0xffffffffu, &ItemTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo PairsSlotsEntryTableInfo = { "PairsSlotsEntry", (uint32_t) sizeof( PairsSlotsEntry ), 2, PairsSlotsEntryTableFields, +[]( void * p ) { PairsSlotsEntryReset( *(PairsSlotsEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * PairsSlotsEntryTableType() { return &PairsSlotsEntryTableInfo; }

inline const TableFieldInfo PairsTableFields[] = {
    { "slots", "slots", "map[uint32]*Item", 0xe68c2e6bb1ee5646ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Pairs, slots ), (uint32_t) sizeof( PairsSlotsEntry ), (uint32_t) offsetof( Pairs, slots.count ), 0xffffffffu, &PairsSlotsEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<PairsSlotsEntry> *) slot, (uint32_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Pairs, after ), (uint32_t) sizeof( Pairs::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo PairsTableInfo = { "Pairs", (uint32_t) sizeof( Pairs ), 2, PairsTableFields, +[]( void * p ) { PairsReset( *(Pairs *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * PairsTableType() { return &PairsTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Pairs in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in PairsTable.cpp; link it to use them.
bool PairsFromJson( PairsBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t PairsToJsonMeasure( const Pairs * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t PairsToJson( const Pairs * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
