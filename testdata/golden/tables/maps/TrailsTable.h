...
// table TrailsStepsEntry — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct TrailsStepsEntry {
    uint32_t key = 0;
    TableList<Item *> value; // Item: the element array, empty until an Add
};

// table Trails — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Trails {
    TableMap<TrailsStepsEntry> steps; // map[uint32]*Item — the sorted entry array, empty until an insert
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void TrailsStepsEntryReset( TrailsStepsEntry & value );
inline void TrailsReset( Trails & value );
...
inline void TrailsReset( Trails & value )
{
    value.steps.entries.value = 0; // map[uint32]*Item: empty
    value.steps.count = 0;
    value.steps.padding = 0;
    value.after = 0;
}

template <typename Ctx> inline int64_t TrailsStepsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const TrailsStepsEntry & value );
template <typename Ctx> inline bool TrailsStepsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const TrailsStepsEntry & value );
inline bool TrailsStepsEntryLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, TrailsStepsEntry & value );
inline bool TrailsStepsEntryMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
template <typename Ctx> inline int64_t TrailsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Trails & value );
template <typename Ctx> inline bool TrailsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Trails & value );
...
inline bool TrailsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );

// TrailsStepsEntryMessageKeyRead: the key of one entry on the message wire, before the
...
struct TrailsStepsEntryMessageKeyRead
{
    uint32_t key;
...
inline TrailsStepsEntryMessageKeyRead TrailsStepsEntryMessageReadKey( TableBitReader r, const TableVocabulary & vocabulary, int64_t index_bits )
{
    TrailsStepsEntryMessageKeyRead out = { 0, 0, false, false, false, false, false };
    for ( ;; )
    {
        uint64_t ref = 0;
...
inline void TableReset( TrailsStepsEntry & value ) { TrailsStepsEntryReset( value ); }
inline void TableReset( Trails & value ) { TrailsReset( value ); }
...
template <typename Ctx> inline int64_t TrailsStepsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const TrailsStepsEntry & value );
template <typename Ctx> inline bool TrailsStepsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const TrailsStepsEntry & value );
template <typename Ctx> inline bool TrailsStepsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const TrailsStepsEntry & value );
inline bool TrailsStepsEntryLoadBody( TableReader & r, const TableNodeMap & nodes, TrailsStepsEntry & value );
template <typename Ctx> inline int64_t TrailsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Trails & value );
template <typename Ctx> inline bool TrailsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Trails & value );
template <typename Ctx> inline bool TrailsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Trails & value );
...
template <typename Ctx> inline bool TrailsStepsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const TrailsStepsEntry & value );
template <typename Ctx> inline int64_t TrailsStepsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const TrailsStepsEntry & value );
template <typename Ctx> inline bool TrailsStepsEntryPack( const Ctx & ctx, TablePackMap & seen, const TrailsStepsEntry & src, TrailsStepsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool TrailsNumber( const Ctx & ctx, TableNumbering & numbering, const Trails & value );
template <typename Ctx> inline int64_t TrailsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Trails & value );
template <typename Ctx> inline bool TrailsPack( const Ctx & ctx, TablePackMap & seen, const Trails & src, Trails & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const TrailsStepsEntry & value ) { return TrailsStepsEntryMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const TrailsStepsEntry & value ) { return TrailsStepsEntrySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const TrailsStepsEntry & value ) { return TrailsStepsEntryMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const TrailsStepsEntry & value ) { return TrailsStepsEntrySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Trails & value ) { return TrailsMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Trails & value ) { return TrailsSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Trails & value ) { return TrailsMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Trails & value ) { return TrailsSaveMessageBody( ctx, numbering, index_bits, w, value ); }

// ---- TrailsStepsEntry: the order, the key and the value (docs/SPEC-TABLES.md §2.8) ----
//
// The four overloads the map runtime's templates reach by argument-dependent
// lookup. Nothing outside this file names them.
static_assert( alignof( TrailsStepsEntry ) <= kTableAlign, "a map entry's alignment must fit the arena's" );

inline int TableEntryOrder( const TrailsStepsEntry & a, const TrailsStepsEntry & b )
{
    return TableKeyOrder( (uint64_t) a.key, (uint64_t) b.key ); // integers compare by VALUE, unsigned here
}
inline int TableEntryOrder( const TrailsStepsEntry & entry, uint32_t key )
{
    return TableKeyOrder( (uint64_t) entry.key, (uint64_t) key );
}
inline uint32_t TableEntryKey( const TrailsStepsEntry & entry ) { return entry.key; }
inline void TableEntrySetKey( TrailsStepsEntry & entry, uint32_t key ) { entry.key = key; }
inline const TableList<Item *> * TableEntryFound( const TrailsStepsEntry * entry ) { return entry != NULL ? &entry->value : NULL; }
inline TableList<Item *> * TableEntryValue( TrailsStepsEntry * entry ) { return &entry->value; }
struct TrailsStepsEntryEach { uint32_t key; decltype( TableEntryValue( (TrailsStepsEntry *) NULL ) ) value; };
inline TrailsStepsEntryEach TableEntryEach( TrailsStepsEntry * entry ) { return TrailsStepsEntryEach{ TableEntryKey( *entry ), TableEntryValue( entry ) }; }
inline void TableResetMapValue( TrailsStepsEntry & value )
{
    value.value.elements.value = 0; // Item: empty
    value.value.count = 0;
    value.value.padding = 0;
...
// TrailsStepsEntryReadKey: the key, before the slot is chosen (docs/SPEC-TABLES.md §2.8).
...
struct TrailsStepsEntryKeyRead
{
    uint32_t key;
    bool found;         // the body carried the key's id
    bool kind_bad;      // it carried it under another kind: the MAP's event
...
inline TrailsStepsEntryKeyRead TrailsStepsEntryReadKey( const uint8_t * body, int64_t length, const TableIdTable * ids )
{
    TrailsStepsEntryKeyRead out = { 0, false, false, false, false, false };
...
template <typename Ctx> inline int64_t TrailsStepsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TrailsStepsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TrailsStepsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool TrailsStepsEntryLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t TrailsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TrailsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool TrailsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool TrailsLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Trails & value, TableRetain * retain, const TableRetainPath & path );

template <typename Ctx>
inline int64_t TrailsStepsEntryMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const TrailsStepsEntry & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
        // value: a kind 14 array of kind 17 elements, INDEX order (§2.9)
        TableListCursor<TableRef> cursor_value = TableListElements( ctx, value.value );
        ...
        if ( cursor_value.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const Item * slot_pointee_value = ItemAt( ctx, cursor_value[elem_i_value] );
                    uint64_t slot_index_value = 0;
                    if ( slot_pointee_value != NULL && !TableNumberingIndex( numbering, (const void *) slot_pointee_value, slot_index_value ) ) { return -1; }
                    body_value += TableLebBytes( slot_index_value );
                }
            }
...
template <typename Ctx>
inline bool TrailsStepsEntrySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const TrailsStepsEntry & value )
{
    if ( value.key != 0 )
    {
    ...
    {
        TableListCursor<TableRef> cursor_value = TableListElements( ctx, value.value ); // value
            ...
            {
                {
                    const Item * slot_pointee_value = ItemAt( ctx, cursor_value[elem_i_value] );
                    uint64_t slot_index_value = 0;
                    if ( slot_pointee_value != NULL && !TableNumberingIndex( numbering, (const void *) slot_pointee_value, slot_index_value ) ) { return false; }
                    body_value += TableLebBytes( slot_index_value );
                }
            }
            w.putleb( ref_value ); w.put8( 14 ); w.putleb( (uint64_t) body_value ); // value
            w.put8( 17 ); w.putleb( (uint64_t) ( cursor_value.count ) );
            for ( int32_t elem_i_value = 0; elem_i_value < cursor_value.count; elem_i_value++ )
            {
                {
                    const Item * slot_pointee_value = ItemAt( ctx, cursor_value[elem_i_value] );
...
template <typename Ctx>
inline bool TrailsStepsEntrySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const TrailsStepsEntry & value )
{
    if ( !TrailsStepsEntrySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        for ( uint64_t i = 0; i < count; i++ )
                        {
                            ...
                            {
                                {
                                    uint64_t node_index_value = 0;
                                    if ( !sub.getleb( node_index_value ) ) { r.report->malformed = true; break; }
                                    TableNodeResolve( nodes, ( *slot ), node_index_value, 0x52cfa1d198476806ull, r.report ); // *Item
                                }
                                landed = true;
                            } while ( 0 );
...
template <typename Ctx>
inline int64_t TrailsStepsEntryMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const TrailsStepsEntry & value )
{
    ...
    }
    {
        ...
        if ( cursor_value.count > 0 )
        {
            bits += kTableMessageRefBitsHere;
            bits += 32;
            bits += (int64_t) ( cursor_value.count ) * index_bits;
        }
    }
...
template <typename Ctx>
inline bool TrailsStepsEntrySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const TrailsStepsEntry & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    if ( value.key != 0 )
    {
    ...
    }
    {
        ...
        if ( cursor_value.count > 0 )
        {
            ...
            {
                const Item * pointee_value = ItemAt( ctx, cursor_value[i] ); // *Item
...
// TrailsStepsEntryMessageExtent: the extent TrailsStepsEntry's maps command on the message wire, from
...
inline bool TrailsStepsEntryMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x7ce4fd9430e80ceaull && entry.kind == 14 && entry.elem_kind == 17 ) // value: an unbounded array
        {
            uint64_t n = 0;
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        {
                            ...
                            TableNodeResolve( nodes, ( *slot ), node_index_2, 0x52cfa1d198476806ull, report ); // *Item
                        }
                    }
                    TableListFillEnd( fill );
                }
...
template <typename Ctx>
inline int64_t TrailsMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Trails & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // steps: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        TableMapCursor<TrailsStepsEntry> order_steps = TableMapOrder( ctx, value.steps );
        if ( !order_steps.ok ) { return -1; } // the sort could not run
        if ( order_steps.count > 0 )
        {
            const uint64_t ref_steps = ids.ref_at( 6, 0x124250ad5a5b6d14ull );
            int64_t body_steps = 1 + TableLebBytes( (uint64_t) order_steps.count ); // the element kind byte and the count
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_steps = TrailsStepsEntryMeasureBody( ctx, numbering, ids, *order_steps[i] );
                if ( elem_steps < 0 ) { TableMapRelease( order_steps ); return -1; }
                body_steps += TableLebBytes( (uint64_t) ( elem_steps ) ) + ( elem_steps ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_steps ) + 1 + TableLebBytes( (uint64_t) ( body_steps ) ) + ( body_steps );
        }
        TableMapRelease( order_steps );
    }
...
template <typename Ctx>
inline bool TrailsSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Trails & value )
{
    {
        TableMapCursor<TrailsStepsEntry> order_steps = TableMapOrder( ctx, value.steps ); // steps
        if ( !order_steps.ok ) { return false; }
        if ( order_steps.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            const uint64_t ref_steps = ids.ref_at( 6, 0x124250ad5a5b6d14ull );
            int64_t body_steps = 1 + TableLebBytes( (uint64_t) order_steps.count );
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_steps = TrailsStepsEntryMeasureBody( ctx, numbering, ids, *order_steps[i] );
                if ( elem_steps < 0 ) { TableMapRelease( order_steps ); return false; }
                body_steps += TableLebBytes( (uint64_t) ( elem_steps ) ) + ( elem_steps );
            }
            w.putleb( ref_steps ); w.put8( 14 ); w.putleb( (uint64_t) body_steps );
            w.put8( 13 ); w.putleb( (uint64_t) order_steps.count );
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_len_steps = TrailsStepsEntryMeasureBody( ctx, numbering, ids, *order_steps[i] );
                if ( elem_len_steps < 0 ) { TableMapRelease( order_steps ); return false; }
                w.putleb( (uint64_t) elem_len_steps );
                if ( !TrailsStepsEntrySaveBody( ctx, numbering, w, ids, *order_steps[i] ) ) { TableMapRelease( order_steps ); return false; }
            }
        }
        TableMapRelease( order_steps );
    }
...
template <typename Ctx>
inline bool TrailsSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Trails & value )
{
    if ( !TrailsSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x124250ad5a5b6d14ull: // steps
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        TrailsStepsEntryKeyRead read = TrailsStepsEntryReadKey( elem_body, (int64_t) elem_len, r.ids );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t TrailsMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Trails & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        ...
        if ( order_steps.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_steps = TrailsStepsEntryMeasureMessageBody( ctx, numbering, index_bits, at + bits, *order_steps[i] );
                if ( elem_steps < 0 ) { TableMapRelease( order_steps ); return -1; }
                bits += elem_steps; // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
        }
        TableMapRelease( order_steps );
    }
...
// body is self-delimiting: it is written where the file form put an L.
template <typename Ctx>
inline bool TrailsSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Trails & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableMapCursor<TrailsStepsEntry> order_steps = TableMapOrder( ctx, value.steps ); // steps
        if ( !order_steps.ok ) { return false; } // the sort could not run
        if ( order_steps.count > 0 )
        {
            w.put( 48, kTableMessageRefBitsHere );
            w.put( (uint64_t) order_steps.count, 32 ); // the count the data decides
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                if ( !TrailsStepsEntrySaveMessageBody( ctx, numbering, index_bits, w, *order_steps[i] ) ) { TableMapRelease( order_steps ); return false; }
            }
        }
        TableMapRelease( order_steps );
    }
...
// TrailsMessageExtent: the extent Trails's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool TrailsMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        const TableMessageEntry & entry = TableVocabularyEntryAt( vocabulary, ref );
        if ( TableMessageReserved( entry.id ) ) { return false; }
        if ( entry.id == 0x124250ad5a5b6d14ull && entry.kind == 14 && entry.elem_kind == 13 ) // steps
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( TrailsStepsEntry )
            at += (int64_t) n * (int64_t) sizeof( TrailsStepsEntry ); // the whole array FIRST
            for ( uint64_t i = 0; i < n; i++ ) // then, entry by entry in key order
            {
                if ( !TrailsStepsEntryMessageExtent( r, vocabulary, index_bits, at ) ) { return false; }
            }
            continue;
        }
        if ( !TableMessageSkip( r, vocabulary, index_bits, entry ) ) { return false; }
        ...
        switch ( entry.id )
        {
            case 0x124250ad5a5b6d14ull: // steps
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        const TrailsStepsEntryMessageKeyRead read = TrailsStepsEntryMessageReadKey( r, vocabulary, index_bits );
                        ...
                        if ( !TrailsStepsEntryLoadMessageBody( r, vocabulary, report, nodes, index_bits, *slot ) ) { return false; }
...
// TrailsStepsEntryWireExtent: the extent TrailsStepsEntry's lists and maps command, from the FRAMING alone.
...
inline bool TrailsStepsEntryWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
...
// TrailsStepsEntryExtentAt: the node extent TrailsStepsEntry's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as TrailsStepsEntryExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool TrailsStepsEntryExtentAt( const Ctx & ctx, const TrailsStepsEntry & value, int64_t & at )
{
    {
        TableListCursor<TableRef> cursor = TableListElements( ctx, value.value );
...
template <typename Ctx>
inline int64_t TrailsStepsEntryExtent( const Ctx & ctx, const TrailsStepsEntry & value )
{
    int64_t at = 0;
    if ( !TrailsStepsEntryExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// TrailsStepsEntryExtentPack: carve TrailsStepsEntry's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset TrailsStepsEntryExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool TrailsStepsEntryExtentPack( const Ctx & ctx, const TrailsStepsEntry & src, TrailsStepsEntry & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableListCursor<TableRef> cursor = TableListElements( ctx, src.value );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( TableRef ) - 1 ) & ~( (int64_t) alignof( TableRef ) - 1 );
...
// TrailsWireExtent: the extent Trails's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool TrailsWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
    {
        ...
        if ( field_id == 0x124250ad5a5b6d14ull && field_kind == 14 ) // steps
        {
            ...
            if ( !TableMapWireExtent( map_body, (int64_t) map_len, at, (int64_t) sizeof( TrailsStepsEntry ), (int64_t) alignof( TrailsStepsEntry ), &TrailsStepsEntryWireExtent, ids, reason ) ) { return false; }
            continue;
        }
        if ( !r.skip( field_kind ) ) { return true; }
    }
...
// TrailsExtentAt: the node extent Trails's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as TrailsExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool TrailsExtentAt( const Ctx & ctx, const Trails & value, int64_t & at )
{
    {
        TableMapCursor<TrailsStepsEntry> cursor = TableMapOrder( ctx, value.steps );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( TrailsStepsEntry )
        at += (int64_t) cursor.count * (int64_t) sizeof( TrailsStepsEntry ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !TrailsStepsEntryExtentAt( ctx, *cursor[i], at ) ) { TableMapRelease( cursor ); return false; }
        }
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t TrailsExtent( const Ctx & ctx, const Trails & value )
{
    int64_t at = 0;
    if ( !TrailsExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// TrailsExtentPack: carve Trails's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset TrailsExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool TrailsExtentPack( const Ctx & ctx, const Trails & src, Trails & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableMapCursor<TrailsStepsEntry> cursor = TableMapOrder( ctx, src.steps );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7;
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( TrailsStepsEntry );
        if ( at + bytes > capacity ) { TableMapRelease( cursor ); return false; }
        TrailsStepsEntry * placed = (TrailsStepsEntry *) ( extent + at );
        at += bytes;
        dst.steps.count = cursor.count;
        dst.steps.padding = 0;
        dst.steps.entries.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.steps.entries ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            memcpy( (void *) ( placed + i ), (const void *) cursor[i], sizeof( TrailsStepsEntry ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !TrailsStepsEntryExtentPack( ctx, *cursor[i], placed[i], extent, at, capacity ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// ---- Trails.steps: the builder's five and the side index (§2.8) ----
...
inline TableList<Item *> * TrailsStepsInsert( TableWorker & worker, TableMap<TrailsStepsEntry> & map, uint32_t key )
{
    TrailsStepsEntry * entry = TableMapPlace( worker, map, key );
...
inline TableList<Item *> * TrailsStepsFind( TableArena & arena, TableMap<TrailsStepsEntry> & map, uint32_t key )
{
    TrailsStepsEntry * found = TableMapScan( arena, map, key );
...
// entry's address is stable" false for exactly one case.
inline bool TrailsStepsErase( TableArena & arena, TableMap<TrailsStepsEntry> & map, uint32_t key )
{
    return TableMapErase( arena, map, key );
}

// EACH on the builder: INSERTION order, live entries only.
inline TableMapEach<TrailsStepsEntry> TrailsStepsEach( const TableArena & arena, const TableMap<TrailsStepsEntry> & map )
{
...
inline int64_t TrailsStepsIndexMeasure( const TableMap<TrailsStepsEntry> & map )
{
    return (int64_t) TableMapIndexSlots( map.count ) * (int64_t) sizeof( int32_t );
}

inline TableMapIndex TrailsStepsIndex( const TableMap<TrailsStepsEntry> & map, void * storage, int64_t bytes )
{
    TableMapIndex index;
    ...
    const TrailsStepsEntry * entries = map.Entries();
...
inline const TableList<Item *> * TrailsStepsIndexFind( const TableMapIndex & index, const TableMap<TrailsStepsEntry> & map, uint32_t key )
{
...
// ---- TrailsStepsEntry.value: the builder's three (§2.9) ----

// ADD: the element is appended and handed back to fill. On a []*T that is
// the SLOT at null, which ItemEmplace fills as it fills any pointer slot,
...
inline TableRef * TrailsStepsEntryValueAdd( TableWorker & worker, TableList<Item *> & list )
{
...
inline bool TrailsStepsEntryValueErase( TableArena & arena, TableList<Item *> & list, const TableRef * element )
{
...
inline TableListEach<Item *> TrailsStepsEntryValueEach( const TableArena & arena, const TableList<Item *> & list )
{
    return TableListEachOf( arena, list );
}

// TrailsStepsEntryNumber: number everything TrailsStepsEntry POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool TrailsStepsEntryNumber( const Ctx & ctx, TableNumbering & numbering, const TrailsStepsEntry & value )
{
    { // value: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<TableRef> cursor_value = TableListElements( ctx, value.value );
        if ( !cursor_value.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_value.count; i++ )
        {
            {
                const Item * pointee = ItemAt( ctx, cursor_value[i] ); // value
                if ( pointee != NULL )
                {
                    bool taken = false;
                    int64_t slot = 0;
...
// TrailsStepsEntryPackMeasure: the packed region bytes of everything TrailsStepsEntry POINTS AT.
...
template <typename Ctx>
inline int64_t TrailsStepsEntryPackMeasure( const Ctx & ctx, TablePackMap & seen, const TrailsStepsEntry & value )
{
    int64_t bytes = 0;
    { // value: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<TableRef> cursor_value = TableListElements( ctx, value.value );
        if ( !cursor_value.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_value.count; i++ )
        {
            {
                const Item * pointee = ItemAt( ctx, cursor_value[i] ); // value
...
// TrailsStepsEntryPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool TrailsStepsEntryPackEdges( const Ctx & ctx, TablePackMap & seen, const TrailsStepsEntry & src, TrailsStepsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool TrailsStepsEntryPack( const Ctx & ctx, TablePackMap & seen, const TrailsStepsEntry & src, TrailsStepsEntry & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( TrailsStepsEntry ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( TrailsStepsEntry ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !TrailsStepsEntryExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return TrailsStepsEntryPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // value: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<TableRef> cursor_value = TableListElements( ctx, src.value );
        if ( !cursor_value.ok ) { return false; }
        TableRef * placed_value = (TableRef *) ( dst.value.elements.value != 0 ? ( (uint8_t *) &dst.value.elements + dst.value.elements.value ) : NULL );
        for ( int32_t i = 0; i < cursor_value.count; i++ )
        {
            {
                placed_value[i].value = 0; // value
                const Item * pointee = ItemAt( ctx, cursor_value[i] );
                if ( pointee != NULL )
                {
                    ...
                    {
                        if ( entry->open != 0 ) { return false; } // a data cycle
                        placed_value[i].value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &placed_value[i] ); // the one body it already has
                    }
                    else
                    {
                        ...
                        placed_value[i].value = (int64_t) ( ( base + at ) - (const uint8_t *) &placed_value[i] );
...
// TrailsNumber: number everything Trails POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool TrailsNumber( const Ctx & ctx, TableNumbering & numbering, const Trails & value )
{
    { // steps: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<TrailsStepsEntry> cursor_steps = TableMapOrder( ctx, value.steps );
        if ( !cursor_steps.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_steps.count; i++ )
        {
            if ( !TrailsStepsEntryNumber( ctx, numbering, *cursor_steps[i] ) ) { TableMapRelease( cursor_steps ); return false; }
        }
        TableMapRelease( cursor_steps );
    }
    return true;
}

// TrailsPackMeasure: the packed region bytes of everything Trails POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t TrailsPackMeasure( const Ctx & ctx, TablePackMap & seen, const Trails & value )
{
    int64_t bytes = 0;
    { // steps: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<TrailsStepsEntry> cursor_steps = TableMapOrder( ctx, value.steps );
        if ( !cursor_steps.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_steps.count; i++ )
        {
            int64_t inner = TrailsStepsEntryPackMeasure( ctx, seen, *cursor_steps[i] );
            if ( inner < 0 ) { TableMapRelease( cursor_steps ); return -1; }
            bytes += inner;
        }
        TableMapRelease( cursor_steps );
    }
...
// TrailsPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool TrailsPackEdges( const Ctx & ctx, TablePackMap & seen, const Trails & src, Trails & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool TrailsPack( const Ctx & ctx, TablePackMap & seen, const Trails & src, Trails & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Trails ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Trails ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !TrailsExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return TrailsPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // steps: a by-value edge, entries in ASCENDING key order (§2.8, §3.1)
        TableMapCursor<TrailsStepsEntry> cursor_steps = TableMapOrder( ctx, src.steps );
        if ( !cursor_steps.ok ) { return false; }
        TrailsStepsEntry * placed_steps = (TrailsStepsEntry *) ( dst.steps.entries.value != 0 ? ( (uint8_t *) &dst.steps.entries + dst.steps.entries.value ) : NULL );
        for ( int32_t i = 0; i < cursor_steps.count; i++ )
        {
            if ( !TrailsStepsEntryPackEdges( ctx, seen, *cursor_steps[i], placed_steps[i], base, capacity, used ) ) { TableMapRelease( cursor_steps ); return false; }
        }
        TableMapRelease( cursor_steps );
    }
    return true;
...
// ---- Trails: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: TrailsBuilder — allocate nodes, wire them together, then Lock.
...
// Trails is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.

struct TrailsBuilder
{
    TableArena arena;
    ...
    TrailsBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Trails * GetRoot() { return arena.locked ? NULL : (Trails *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Trails * AsConst() const { return (const Trails *) region; }
...
inline bool TrailsBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Trails & root = *(const Trails *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Trails on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// TrailsNodeStorage: the region bytes one record commands, or -1 for a type id
...
inline int64_t TrailsNodeStorage( uint64_t type_id, int64_t length, TableRefuseReason & reason )
{
...
// TrailsNodePlace: start one record's node's lifetime in the storage pass one
...
inline void TrailsNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// TrailsNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t TrailsNodeRecordBytes( uint64_t type_id )
{
    switch ( type_id )
    {
        case 0x52cfa1d198476806ull: return TableAlignUp64( (int64_t) sizeof( Item ) ); // Item
...
// TrailsNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t TrailsNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// TrailsNodeBody: PASS TWO's half — decode one record's body into the storage it
// already owns.
inline void TrailsNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = TrailsNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? TrailsNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// TrailsNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t TrailsNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
...
// TrailsNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool TrailsNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// TrailsNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool TrailsNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + TrailsNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !TrailsNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool TrailsNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Trails & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return TrailsNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t TrailsMeasureWire( const Ctx & ctx, const Trails & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( TrailsNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = TrailsMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t TrailsSaveWire( const Ctx & ctx, const Trails & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !TrailsNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    ...
    bool ok = TrailsSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == TrailsMeasure( root )
}

inline int64_t TrailsMeasure( const Trails * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrailsMeasureWire( ctx, *root, allocator );
}

inline int64_t TrailsSave( const Trails * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrailsSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t TrailsMeasure( const TrailsBuilder & builder )
{
    if ( builder.region != NULL ) { return TrailsMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TrailsMeasureWire( ctx, *(const Trails *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t TrailsSave( const TrailsBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return TrailsSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TrailsSaveWire( ctx, *(const Trails *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Trails on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// TrailsMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t TrailsMessageBodyBits( const Ctx & ctx, const Trails & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( TrailsNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = TrailsMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool TrailsMessageBodySave( const Ctx & ctx, const Trails & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && TrailsSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t TrailsMeasureMessages( const Trails * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = TrailsMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t TrailsSaveMessages( const Trails * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !TrailsMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == TrailsMeasureMessages( roots, count, report, allocator )
}

// TrailsMessageRecordScan: one node record's type id and the extent its maps
...
inline bool TrailsMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return TrailsNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// TrailsMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool TrailsMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TrailsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = TrailsNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !TrailsMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Trails ) ) + root_extent );
    return true;
}

// TrailsLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t TrailsLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !TrailsMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// TrailsLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool TrailsLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Trails * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !TrailsMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = TrailsNodeMessageStorage( type_id, extent, length );
        ...
        TrailsNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !TrailsMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Trails ) ) + root_extent );
    ...
    Trails * root = new ( region + used ) Trails; // lifetime only: LoadMessageBody's first act is TrailsReset
    TrailsReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Trails ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TrailsNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return TrailsLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// TrailsLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool TrailsLoadMessages( const Trails ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !TrailsLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
...
// TrailsLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t TrailsLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !TrailsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Trails ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = TrailsNodeStorage( type_id, length, reason );
...
// TrailsLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Trails * TrailsLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Trails ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !TrailsWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Trails ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0xb4578774a78fb150ull;
    Trails * root = new ( region ) Trails; // lifetime only: LoadBody's first act is TrailsReset
    TrailsReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                TrailsNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Trails ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    TrailsLoadBody( r, nodes, *root );
    return root;
}

// TrailsLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool TrailsLoadBuilder( TrailsBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = TrailsNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = TrailsLoadBody( r, nodes, *root );
...
template <typename Ctx>
inline int64_t TrailsStepsEntryMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.key != 0 ) { bytes += TableLebBytes( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ) + 1 + 4; } // key
    {
...
template <typename Ctx>
inline bool TrailsStepsEntrySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.key != 0 )
    {
        w.putleb( ids.ref_at( 21, 0x3dc94a19365b10ecull ) ); w.put8( 8 ); // key
...
template <typename Ctx>
inline bool TrailsStepsEntrySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const TrailsStepsEntry & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !TrailsStepsEntrySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t TrailsMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // steps: a kind 14 array of kind 13 elements, ASCENDING (§2.8)
        ...
        if ( order_steps.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_steps = TrailsStepsEntryMeasureBodyRetain( ctx, numbering, ids, *order_steps[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_steps < 0 ) { TableMapRelease( order_steps ); return -1; }
                body_steps += TableLebBytes( (uint64_t) ( elem_steps ) ) + ( elem_steps ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_steps ) + 1 + TableLebBytes( (uint64_t) ( body_steps ) ) + ( body_steps );
...
template <typename Ctx>
inline bool TrailsSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableMapCursor<TrailsStepsEntry> order_steps = TableMapOrder( ctx, value.steps ); // steps
        if ( !order_steps.ok ) { return false; }
        if ( order_steps.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_steps.count; i++ )
            {
                const int64_t elem_len_steps = TrailsStepsEntryMeasureBodyRetain( ctx, numbering, ids, *order_steps[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_steps < 0 ) { TableMapRelease( order_steps ); return false; }
                w.putleb( (uint64_t) elem_len_steps );
                if ( !TrailsStepsEntrySaveBodyRetain( ctx, numbering, w, ids, *order_steps[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_steps ); return false; }
            }
        }
        TableMapRelease( order_steps );
    }
...
template <typename Ctx>
inline bool TrailsSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Trails & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !TrailsSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x124250ad5a5b6d14ull: // steps
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        if ( slot == NULL ) { report->malformed = true; return false; }
                        if ( !TrailsStepsEntryLoadMessageBodyRetain( r, vocabulary, report, nodes, index_bits, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) ) ) { return false; }
                        if ( r.offset != read.end ) { report->malformed = true; return false; } // the scan and the decode disagree about where the entry ends
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
// TrailsNodeBodyRetain: PASS TWO's half — decode one record's body into the storage it
// already owns.
...
inline void TrailsNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// TrailsLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Trails * TrailsLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                TrailsNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    TrailsLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// TrailsNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool TrailsNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + TrailsNodeRecordBytes( type_id );
    carve.left = 0;
...
// TrailsLoadMessageBodyIntoRetain: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
...
inline bool TrailsLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Trails * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !TrailsNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return TrailsLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// TrailsLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool TrailsLoadRetainMessages( const Trails ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !TrailsLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// TrailsMeasureRetain and TrailsSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t TrailsMeasureWireRetain( const Ctx & ctx, const Trails & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( TrailsNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = TrailsMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t TrailsSaveWireRetain( const Ctx & ctx, const Trails & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = TrailsSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t TrailsMeasureRetain( const Trails * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrailsMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t TrailsSaveRetain( const Trails * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrailsSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// TrailsSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH TrailsAt: the slot holds
...
// parameter on a load.
inline const Trails * TrailsOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Trails *) TableCookOpen( bytes, length, (uint64_t) sizeof( Trails ), (uint64_t) alignof( Trails ), reason );
}
...
template <typename Ctx> inline bool TrailsStepsEntryCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const TrailsStepsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool TrailsCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Trails & value, TableByteOrder order );
...
{
    (void) ctx; (void) region; // no reference resolves in this body: a list's and a map's slots are the extent writer's, and the class was decided elsewhere in the closure
    table_cook_put( at + 0, 0, 8, order ); // steps: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool TrailsStepsEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const TrailsStepsEntry & value, TableByteOrder order );
template <typename Ctx> inline bool TrailsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Trails & value, TableByteOrder order );

// TrailsStepsEntryCookExtent: TrailsStepsEntry's arrays into the node's extent, PRE-ORDER, a map's entries
...
template <typename Ctx> inline bool TrailsStepsEntryCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const TrailsStepsEntry & value, TableByteOrder order )
{
    { // value: an unbounded array
        ...
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            if ( !table_cook_ref( region, array + i * 8, (const void *) ItemAt( ctx, cursor[i] ), order ) ) { return false; }
        }
    }
    return true;
}

// TrailsCookExtent: Trails's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool TrailsCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Trails & value, TableByteOrder order )
{
    ...
    { // steps
        ...
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !TrailsStepsEntryCookBody( ctx, region, array + i * 24, *cursor[i], order ) ) { return false; }
        }
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, entry by entry in key order
        {
            if ( !TrailsStepsEntryCookExtent( ctx, region, extent, at, array + i * 24, *cursor[i], order ) ) { TableMapRelease( cursor ); return false; }
        }
        TableMapRelease( cursor );
    }
    return true;
...
// TrailsStepsEntryCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool TrailsStepsEntryCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const TrailsStepsEntry & value, TableByteOrder order )
{
    if ( !TrailsStepsEntryCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !TrailsStepsEntryCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == TrailsStepsEntryExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// TrailsCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool TrailsCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Trails & value, TableByteOrder order )
{
    if ( !TrailsCookBody( ctx, region, at, value, order ) ) { return false; }
    int64_t extent_at = 0;
    if ( !TrailsCookExtent( ctx, region, at + 24, extent_at, at, value, order ) ) { return false; }
    return extent_at == TrailsExtent( ctx, value ); // the extent written is the extent measured, or no header is written
}

// TrailsCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool TrailsCookLayout( const Ctx & ctx, const Trails & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = TrailsExtent( ctx, root );
...
// TrailsCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t TrailsCookMeasureFrom( const Ctx & ctx, const Trails & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( TrailsNumberFrom( ctx, numbering, root ) && TrailsCookLayout( ctx, root, numbering, region ) )
    {
...
// TrailsCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool TrailsCookFrom( const Ctx & ctx, const Trails & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = TrailsCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0xb4578774a78fb150ull, 8, order ); // the root: fnv1a64( "Trails" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// TrailsCookMeasure / TrailsCook over a REGION root — a locked builder's AsConst, a
// region TrailsLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t TrailsCookMeasure( const Trails * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return TrailsCookMeasureFrom( ctx, *root, allocator );
}

inline bool TrailsCook( const Trails * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return TrailsCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t TrailsCookMeasure( const TrailsBuilder & builder )
{
    if ( builder.region != NULL ) { return TrailsCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TrailsCookMeasureFrom( ctx, *(const Trails *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool TrailsCook( const TrailsBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return TrailsCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return TrailsCookFrom( ctx, *(const Trails *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( TrailsStepsEntry ), "TrailsStepsEntry must stay relocatable" );
static_assert( __is_standard_layout( TrailsStepsEntry ), "TrailsStepsEntry must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Trails ), "Trails must stay relocatable" );
static_assert( __is_standard_layout( Trails ), "Trails must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( TrailsStepsEntry ) == 24, "TrailsStepsEntry's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( TrailsStepsEntry ) == 8, "TrailsStepsEntry's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( TrailsStepsEntry, key ) == 0, "TrailsStepsEntry's field key moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( TrailsStepsEntry, value ) == 8, "TrailsStepsEntry's field value moved: the build version was taken over offset 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Trails ) == 24, "Trails's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Trails ) == 8, "Trails's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Trails, steps ) == 0, "Trails's field steps moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Trails, after ) == 16, "Trails's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );

static_assert( alignof( TableRef ) <= kTableAlign, "TrailsStepsEntry.value: an unbounded array's element alignment must fit the arena's" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * TrailsStepsEntryTableType();
inline const TableTypeInfo * TrailsTableType();
...
extern const TableTypeInfo TrailsStepsEntryTableInfo;
extern const TableTypeInfo TrailsTableInfo;

inline const TableFieldInfo TrailsStepsEntryTableFields[] = {
    { "key", "key", "uint32", 0x3dc94a19365b10ecull, 8, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( TrailsStepsEntry, key ), (uint32_t) sizeof( TrailsStepsEntry::key ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "value", "value", "Item", 0x7ce4fd9430e80ceaull, 17, true, true, []( const void * slot ) -> const void * { return (const void *) ItemAt( *(const TableRef *) slot ); }, []( TableWorker & worker, void * slot ) -> void * { return (void *) ItemEmplace( worker, *(TableRef *) slot ); }, true, false, 0, (uint32_t) offsetof( TrailsStepsEntry, value ), (uint32_t) sizeof( TableRef ), (uint32_t) offsetof( TrailsStepsEntry, value.count ), 0xffffffffu, &ItemTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Item *> *) slot ); }, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo TrailsStepsEntryTableInfo = { "TrailsStepsEntry", (uint32_t) sizeof( TrailsStepsEntry ), 2, TrailsStepsEntryTableFields, +[]( void * p ) { TrailsStepsEntryReset( *(TrailsStepsEntry *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * TrailsStepsEntryTableType() { return &TrailsStepsEntryTableInfo; }

inline const TableFieldInfo TrailsTableFields[] = {
    { "steps", "steps", "map[uint32]*Item", 0x124250ad5a5b6d14ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Trails, steps ), (uint32_t) sizeof( TrailsStepsEntry ), (uint32_t) offsetof( Trails, steps.count ), 0xffffffffu, &TrailsStepsEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<TrailsStepsEntry> *) slot, (uint32_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Trails, after ), (uint32_t) sizeof( Trails::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo TrailsTableInfo = { "Trails", (uint32_t) sizeof( Trails ), 2, TrailsTableFields, +[]( void * p ) { TrailsReset( *(Trails *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * TrailsTableType() { return &TrailsTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Trails in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in TrailsTable.cpp; link it to use them.
bool TrailsFromJson( TrailsBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t TrailsToJsonMeasure( const Trails * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t TrailsToJson( const Trails * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
