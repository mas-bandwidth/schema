...
// BytesNodeMessageBody: PASS TWO's half — decode one record's body into the
...
// IntsNodeMessageBody: PASS TWO's half — decode one record's body into the
// storage it already owns, its map entries carved from its own extent.
...
// FloatsNodeMessageBody: PASS TWO's half — decode one record's body into the
// storage it already owns, its map entries carved from its own extent.
