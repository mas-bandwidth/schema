...
constexpr TableFixedDst PhotoFixedDst[] = {
    { 0, 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // Photo
    { (uint32_t) __builtin_offsetof( Photo, width ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // width
    { (uint32_t) __builtin_offsetof( Photo, height ), 0, 0, 0, 0, 0ull, 0ull, 0, 0 }, // height
};
