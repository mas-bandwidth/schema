...
constexpr TableFixedEntry PhotoFixedPlan[] = {
    { 0u, 0u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // width
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != PhotoFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, PhotoFixedLayout, (int32_t) PhotoFixedLayoutBytes, PhotoFixedDst, plan, plan_capacity, &compiled_guarded, report );
    ...
    {
        PhotoReset( values[k] ); // the declared defaults, one prefill
