// Code generated by the schema compiler from Holders.schema. DO NOT EDIT.
// SPDX-License-Identifier: NONE — this generated output is yours, under terms of
// your choice. See the LICENSE exception in the schema compiler; the compiler is
// AGPL-3.0, its output is not.
// package listdemo — protocol id 0x6f357df726f08bc5 (packets only: tables version by field id, not by protocol id)
...
static const uint8_t kTableAnnounce[ kTableAnnounceBytes ] = {
    0x01, 0x01, 0x09, 0x9e, 0x15, 0xed, 0x01, 0x9b, 0x02, 0x01, 0xab, 0x02,
...
static const uint64_t BuildVersion = 0xab01029b01ed159eull;
...
// table Sample — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Sample {
    int32_t v = 0;
};

// table Row — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Row {
    TableList<Sample> items; // Sample: the element array, empty until an Add
    int32_t label = 0;
};

// table Sheet — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Sheet {
    TableList<Row> rows; // Row: the element array, empty until an Add
    TableRef pinned; // *Row — null until assigned
};
...
// table Army — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Army {
    TableList<Squad> squads; // Squad: the element array, empty until an Add
    int32_t after = 0;
};

// table Deck — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Deck {
    Row hands[3]; // used count beside it; count in [0, 3]
    int32_t hands_count = 0;
    int32_t after = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void SampleReset( Sample & value );
inline void RowReset( Row & value );
inline void SheetReset( Sheet & value );
...
inline void ArmyReset( Army & value );
inline void DeckReset( Deck & value );
...
inline void RowReset( Row & value )
{
    value.items.elements.value = 0; // Sample: empty
    value.items.count = 0;
...
inline void SheetReset( Sheet & value )
{
    value.rows.elements.value = 0; // Row: empty
    value.rows.count = 0;
    value.rows.padding = 0;
    value.pinned.value = 0; // *Row — null
}
...
inline void ArmyReset( Army & value )
{
    value.squads.elements.value = 0; // Squad: empty
    value.squads.count = 0;
    value.squads.padding = 0;
    value.after = 0;
}

inline void DeckReset( Deck & value )
{
    RowReset( value.hands[0] );
    for ( int32_t i = 1; i < 3; i++ ) { value.hands[i] = value.hands[0]; }
    value.hands_count = 0;
    value.after = 0;
}

inline int64_t SampleMeasureMessageBody( int64_t at, const Sample & value );
inline bool SampleSaveMessageBody( TableBitWriter & w, const Sample & value );
inline bool SampleLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Sample & value );
template <typename Ctx> inline int64_t RowMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Row & value );
template <typename Ctx> inline bool RowSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Row & value );
inline bool RowLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Row & value );
inline bool RowMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
template <typename Ctx> inline int64_t SheetMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Sheet & value );
template <typename Ctx> inline bool SheetSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Sheet & value );
inline bool SheetLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Sheet & value );
inline bool SheetMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
...
template <typename Ctx> inline int64_t ArmyMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Army & value );
template <typename Ctx> inline bool ArmySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Army & value );
inline bool ArmyLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Army & value );
inline bool ArmyMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
template <typename Ctx> inline int64_t DeckMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Deck & value );
template <typename Ctx> inline bool DeckSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Deck & value );
inline bool DeckLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Deck & value );
inline bool DeckMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
...
inline void TableReset( Sample & value ) { SampleReset( value ); }
inline void TableReset( Row & value ) { RowReset( value ); }
inline void TableReset( Sheet & value ) { SheetReset( value ); }
...
inline void TableReset( Army & value ) { ArmyReset( value ); }
inline void TableReset( Deck & value ) { DeckReset( value ); }
...
// Row is a pointer target.
inline const Row * RowAt( const TableRef & ref ) // the const form's hot path: one add, no base
{
    return ref.value != 0 ? (const Row *) ( (const uint8_t *) &ref + ref.value ) : NULL;
}
inline Row * RowAt( TableRef & ref )
{
    return ref.value != 0 ? (Row *) ( (uint8_t *) &ref + ref.value ) : NULL;
}
inline const Row * RowAt( const TableRegionCtx &, const TableRef & ref ) { return RowAt( ref ); }
inline const Row * RowAt( const TableArenaCtx & ctx, const TableRef & ref )
{
    return ref.value != 0 ? (const Row *) TableArenaAt( *ctx.arena, (uint32_t) ref.value ) : NULL;
}
// while the builder is mutable, resolve against the arena itself
inline Row * RowAt( TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (Row *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
inline const Row * RowAt( const TableArena & arena, const TableRef & ref )
{
    return ref.value != 0 ? (const Row *) TableArenaAt( arena, (uint32_t) ref.value ) : NULL;
}
// allocate one Row in the arena; the slot holds the arena offset
inline Row * RowEmplace( TableWorker & worker, TableRef & slot )
{
    TableSlot<Row> allocated = worker.Alloc<Row>();
    slot = allocated.ref;
...
LISTDEMO_TABLE_INLINE bool SampleLoadBody( TableReader & r, Sample & value );
template <typename Ctx> inline int64_t RowMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Row & value );
template <typename Ctx> inline bool RowSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Row & value );
template <typename Ctx> inline bool RowSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Row & value );
inline bool RowLoadBody( TableReader & r, const TableNodeMap & nodes, Row & value );
template <typename Ctx> inline int64_t SheetMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Sheet & value );
template <typename Ctx> inline bool SheetSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Sheet & value );
template <typename Ctx> inline bool SheetSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Sheet & value );
...
LISTDEMO_TABLE_INLINE bool ItemLoadBody( TableReader & r, Item & value );
inline int64_t SquadRosterEntryMeasureBody( TableIds & ids, const SquadRosterEntry & value );
LISTDEMO_TABLE_INLINE bool SquadRosterEntrySaveBody( TableWriter & w, TableIds & ids, const SquadRosterEntry & value );
LISTDEMO_TABLE_INLINE bool SquadRosterEntryLoadBody( TableReader & r, SquadRosterEntry & value );
...
template <typename Ctx> inline int64_t ArmyMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Army & value );
template <typename Ctx> inline bool ArmySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Army & value );
template <typename Ctx> inline bool ArmySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Army & value );
inline bool ArmyLoadBody( TableReader & r, const TableNodeMap & nodes, Army & value );
template <typename Ctx> inline int64_t DeckMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Deck & value );
template <typename Ctx> inline bool DeckSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Deck & value );
template <typename Ctx> inline bool DeckSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Deck & value );
...
template <typename Ctx> inline bool RowNumber( const Ctx & ctx, TableNumbering & numbering, const Row & value );
template <typename Ctx> inline int64_t RowPackMeasure( const Ctx & ctx, TablePackMap & seen, const Row & value );
template <typename Ctx> inline bool RowPack( const Ctx & ctx, TablePackMap & seen, const Row & src, Row & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool SheetNumber( const Ctx & ctx, TableNumbering & numbering, const Sheet & value );
template <typename Ctx> inline int64_t SheetPackMeasure( const Ctx & ctx, TablePackMap & seen, const Sheet & value );
template <typename Ctx> inline bool SheetPack( const Ctx & ctx, TablePackMap & seen, const Sheet & src, Sheet & dst, uint8_t * base, int64_t capacity, int64_t & used );
...
template <typename Ctx> inline bool ArmyNumber( const Ctx & ctx, TableNumbering & numbering, const Army & value );
template <typename Ctx> inline int64_t ArmyPackMeasure( const Ctx & ctx, TablePackMap & seen, const Army & value );
template <typename Ctx> inline bool ArmyPack( const Ctx & ctx, TablePackMap & seen, const Army & src, Army & dst, uint8_t * base, int64_t capacity, int64_t & used );
template <typename Ctx> inline bool DeckNumber( const Ctx & ctx, TableNumbering & numbering, const Deck & value );
template <typename Ctx> inline int64_t DeckPackMeasure( const Ctx & ctx, TablePackMap & seen, const Deck & value );
template <typename Ctx> inline bool DeckPack( const Ctx & ctx, TablePackMap & seen, const Deck & src, Deck & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Row & value ) { return RowMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Row & value ) { return RowSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Row & value ) { return RowMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Row & value ) { return RowSaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Sheet & value ) { return SheetMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Sheet & value ) { return SheetSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Sheet & value ) { return SheetMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Sheet & value ) { return SheetSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Army & value ) { return ArmyMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Army & value ) { return ArmySaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Army & value ) { return ArmyMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Army & value ) { return ArmySaveMessageBody( ctx, numbering, index_bits, w, value ); }
template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Deck & value ) { return DeckMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Deck & value ) { return DeckSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Deck & value ) { return DeckMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Deck & value ) { return DeckSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
LISTDEMO_TABLE_INLINE bool SampleLoadBodyRetain( TableReader & r, Sample & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t RowMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RowSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool RowSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path );
...
template <typename Ctx> inline int64_t SheetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SheetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SheetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path );
...
LISTDEMO_TABLE_INLINE bool ItemLoadBodyRetain( TableReader & r, Item & value, TableRetain * retain, const TableRetainPath & path );
...
LISTDEMO_TABLE_INLINE bool SquadRosterEntrySaveBodyRetain( TableWriter & w, TableRetainIds & ids, const SquadRosterEntry & value, TableRetain * retain, const TableRetainPath & path );
LISTDEMO_TABLE_INLINE bool SquadRosterEntryLoadBodyRetain( TableReader & r, SquadRosterEntry & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t SquadMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SquadSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool SquadSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path );
...
template <typename Ctx> inline int64_t ArmyMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ArmySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool ArmySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path );
...
template <typename Ctx> inline int64_t DeckMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DeckSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool DeckSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path );
...
inline int64_t SampleMeasure( const Sample & value )
{
    TableIds ids;
    const int64_t body = SampleMeasureBody( ids, value );
...
inline int64_t SampleSave( const Sample & value, uint8_t * buffer, int64_t capacity )
{
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    if ( !SampleSaveBody( w, ids, value ) || ids.overflow ) { return -1; }
    TableIdsWrite( w, ids ); // the ID TABLE is the last thing in the file
    if ( w.overflow ) { return -1; }
    return w.offset; // == SampleMeasure( value )
}

LISTDEMO_TABLE_INLINE bool SampleLoadBody( TableReader & r, Sample & value )
{
    SampleReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
        uint64_t field_ref = 0;
...
inline TableOpenVerdict SampleLoadVerdict( Sample & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    TableIdTable table;
    ...
    if ( !SampleLoadBody( r, value ) ) { return TableOpenBodyStopped; }
    return TableOpenOk;
}
...
inline bool SampleLoad( Sample & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    return SampleLoadVerdict( value, buffer, bytes, report ) == TableOpenOk;
}
...
inline int64_t SampleMeasureMessages( const Sample * values, int64_t count, TableReport * report )
{
    ...
    {
        const int64_t body = SampleMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
...
inline int64_t SampleSaveMessages( const Sample * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !SampleSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == SampleMeasureMessages( values, count, report )
}
...
inline bool SampleLoadMessages( Sample * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    ...
    *count = 0;
    ...
    {
        if ( !SampleLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
...
template <typename Ctx>
inline int64_t RowMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Row & value )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // items: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        TableListCursor<Sample> cursor_items = TableListElements( ctx, value.items );
        ...
        if ( cursor_items.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_items = 0; elem_i_items < cursor_items.count; elem_i_items++ )
            {
                ...
                if ( elem_bytes_items < 0 ) { return -1; }
...
template <typename Ctx>
inline bool RowSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Row & value )
{
    (void) ctx; (void) numbering;
    {
        TableListCursor<Sample> cursor_items = TableListElements( ctx, value.items ); // items
...
template <typename Ctx>
inline bool RowSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Row & value )
{
    if ( !RowSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        TableListFill<Sample> fill = TableListFillBegin( nodes, value.items, count );
                        ...
                        {
                            Sample * slot = TableListFillNext( fill );
                            if ( slot == NULL ) { r.report->malformed = true; break; } // the arena could not carve
                            bool landed = false;
                            do
                            {
                                uint64_t elem_len_items = 0;
                                if ( !sub.getleb( elem_len_items ) || !sub.room( elem_len_items ) ) { r.report->malformed = true; break; }
                                {
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t RowMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Row & value )
{
    ...
    int64_t bits = 0;
    {
        ...
        if ( cursor_items.count > 0 )
        {
            ...
            {
                const int64_t elem = SampleMeasureMessageBody( at + bits, cursor_items[i] );
                if ( elem < 0 ) { return -1; }
                bits += elem;
            }
        }
...
inline bool RowSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Row & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        ...
        if ( cursor_items.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < cursor_items.count; i++ )
            {
                if ( !SampleSaveMessageBody( w, cursor_items[i] ) ) { return false; }
            }
        }
    }
    if ( value.label != 0 )
    {
        ...
        w.put( (uint64_t) ( value.label ), 32 );
    }
    w.put( 0, kTableMessageRefBitsHere ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}

// RowMessageExtent: the extent Row's maps command on the message wire, from
...
inline bool RowMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x3e7884bf4f412c6full && entry.kind == 14 && entry.elem_kind == 13 ) // items: an unbounded array
        {
            uint64_t n = 0;
        ...
        switch ( entry.id )
        {
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                }
                {
                    ...
                    n += (uint64_t) entry.min;
                    TableListFill<Sample> fill = TableListFillBegin( nodes, value.items, n );
                    if ( fill.refused ) { nodes.refused = true; return false; }
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        if ( !SampleLoadMessageBody( r, vocabulary, report, index_bits, ( *slot ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
template <typename Ctx>
inline int64_t SheetMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Sheet & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // rows: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows );
        ...
        if ( cursor_rows.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_rows = 0; elem_i_rows < cursor_rows.count; elem_i_rows++ )
            {
                ...
                if ( elem_bytes_rows < 0 ) { return -1; }
                body_rows += TableLebBytes( (uint64_t) ( elem_bytes_rows ) ) + ( elem_bytes_rows );
            }
            bytes += TableLebBytes( ref_rows ) + 1 + TableLebBytes( (uint64_t) ( body_rows ) ) + ( body_rows );
        }
    }
    {
        const Row * pointee_pinned = RowAt( ctx, value.pinned ); // *Row
...
template <typename Ctx>
inline bool SheetSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Sheet & value )
{
    {
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows ); // rows
...
template <typename Ctx>
inline bool SheetSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Sheet & value )
{
    if ( !SheetSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
        ...
        switch ( field_id )
        {
            case 0xa3a7061ff10a8138ull: // rows
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        // cannot fire on it. A count above the int32 storage cap is the
                        // fill's refusal, and it moves no counter.
                        TableListFill<Row> fill = TableListFillBegin( nodes, value.rows, count );
                        if ( fill.refused ) { nodes.refused = true; return false; }
                        if ( !fill.ok ) { r.report->malformed = true; r.offset = body_end; break; }
                        // elements are BOUNDED by the field body: a count the length cannot
                        // cover keeps the decoded prefix, flags malformed, and the parent
                        ...
                        for ( uint64_t i = 0; i < count; i++ )
                        {
                            Row * slot = TableListFillNext( fill );
                            if ( slot == NULL ) { r.report->malformed = true; break; } // the arena could not carve
                            bool landed = false;
                            do
                            {
                                uint64_t elem_len_rows = 0;
                                if ( !sub.getleb( elem_len_rows ) || !sub.room( elem_len_rows ) ) { r.report->malformed = true; break; }
                                {
            ...
            case 0x5f82477707ad620full: // pinned
            {
                ...
                // there is no traversal here and therefore no traversal bound.
                {
                    ...
                    TableNodeResolve( nodes, value.pinned, node_index, 0xa013e119fec906fbull, r.report ); // *Row
                }
                break;
            }
            case 0xffffffffffffffffull:
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t SheetMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Sheet & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows ); // rows
        if ( !cursor_rows.ok ) { return -1; } // the slot and the head disagree
        if ( cursor_rows.count > 0 )
        {
            bits += kTableMessageRefBitsHere;
            bits += 32;
            for ( int32_t i = 0; i < cursor_rows.count; i++ )
            {
                const int64_t elem = RowMeasureMessageBody( ctx, numbering, index_bits, at + bits, cursor_rows[i] );
                if ( elem < 0 ) { return -1; }
                bits += elem;
            }
        }
...
inline bool SheetSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Sheet & value )
{
    ...
    {
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows ); // rows
        if ( !cursor_rows.ok ) { return false; } // the slot and the head disagree
        if ( cursor_rows.count > 0 )
        {
            w.put( 30, kTableMessageRefBitsHere );
            w.put( (uint64_t) ( cursor_rows.count ) - 0, 32 );
            for ( int32_t i = 0; i < cursor_rows.count; i++ )
            {
                if ( !RowSaveMessageBody( ctx, numbering, index_bits, w, cursor_rows[i] ) ) { return false; }
            }
        }
    }
    {
...
// SheetMessageExtent: the extent Sheet's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool SheetMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        const TableMessageEntry & entry = TableVocabularyEntryAt( vocabulary, ref );
        if ( TableMessageReserved( entry.id ) ) { return false; }
        if ( entry.id == 0xa3a7061ff10a8138ull && entry.kind == 14 && entry.elem_kind == 13 ) // rows: an unbounded array
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            if ( n > (uint64_t) INT32_MAX ) { return false; } // above the int32 storage cap (§2.9)
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( Row )
            at += (int64_t) n * (int64_t) sizeof( Row ); // the whole array FIRST
            for ( uint64_t i = 0; i < n; i++ ) // then, element by element in index order
            {
                if ( !RowMessageExtent( r, vocabulary, index_bits, at ) ) { return false; }
            }
            continue;
        }
        if ( !TableMessageSkip( r, vocabulary, index_bits, entry ) ) { return false; }
        ...
        switch ( entry.id )
        {
            case 0xa3a7061ff10a8138ull: // rows
            {
                ...
                }
                {
                    ...
                    if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { report->malformed = true; return false; }
                    n += (uint64_t) entry.min;
                    TableListFill<Row> fill = TableListFillBegin( nodes, value.rows, n );
                    if ( fill.refused ) { nodes.refused = true; return false; }
                    if ( !fill.ok ) { report->malformed = true; return false; } // the measure and the load disagree
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        Row * slot = TableListFillNext( fill );
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        if ( !RowLoadMessageBody( r, vocabulary, report, nodes, index_bits, ( *slot ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
            ...
            case 0x5f82477707ad620full: // pinned
            {
                ...
                }
                {
                    ...
                    TableNodeResolve( nodes, value.pinned, node_index, 0xa013e119fec906fbull, report ); // *Row
                }
                break;
            }
            default:
...
template <typename Ctx>
inline int64_t ArmyMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Army & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // squads: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads );
        ...
        if ( cursor_squads.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_squads = 0; elem_i_squads < cursor_squads.count; elem_i_squads++ )
            {
                ...
                if ( elem_bytes_squads < 0 ) { return -1; }
...
template <typename Ctx>
inline bool ArmySaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Army & value )
{
    {
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads ); // squads
...
template <typename Ctx>
inline bool ArmySaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Army & value )
{
    if ( !ArmySaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x7848019b0c02a926ull: // squads
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        // cannot fire on it. A count above the int32 storage cap is the
                        // fill's refusal, and it moves no counter.
                        TableListFill<Squad> fill = TableListFillBegin( nodes, value.squads, count );
                        if ( fill.refused ) { nodes.refused = true; return false; }
                        if ( !fill.ok ) { r.report->malformed = true; r.offset = body_end; break; }
                        // elements are BOUNDED by the field body: a count the length cannot
                        // cover keeps the decoded prefix, flags malformed, and the parent
                        ...
                        for ( uint64_t i = 0; i < count; i++ )
                        {
                            Squad * slot = TableListFillNext( fill );
                            if ( slot == NULL ) { r.report->malformed = true; break; } // the arena could not carve
                            bool landed = false;
                            do
                            {
                                uint64_t elem_len_squads = 0;
                                if ( !sub.getleb( elem_len_squads ) || !sub.room( elem_len_squads ) ) { r.report->malformed = true; break; }
                                {
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t ArmyMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Army & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    {
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads ); // squads
        if ( !cursor_squads.ok ) { return -1; } // the slot and the head disagree
        if ( cursor_squads.count > 0 )
        {
            bits += kTableMessageRefBitsHere;
            bits += 32;
            for ( int32_t i = 0; i < cursor_squads.count; i++ )
            {
                const int64_t elem = SquadMeasureMessageBody( ctx, numbering, index_bits, at + bits, cursor_squads[i] );
                if ( elem < 0 ) { return -1; }
                bits += elem;
            }
        }
...
inline bool ArmySaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Army & value )
{
    ...
    {
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads ); // squads
        if ( !cursor_squads.ok ) { return false; } // the slot and the head disagree
        if ( cursor_squads.count > 0 )
        {
            w.put( 3, kTableMessageRefBitsHere );
            w.put( (uint64_t) ( cursor_squads.count ) - 0, 32 );
            for ( int32_t i = 0; i < cursor_squads.count; i++ )
            {
                if ( !SquadSaveMessageBody( ctx, numbering, index_bits, w, cursor_squads[i] ) ) { return false; }
            }
        }
    }
    if ( value.after != 0 )
...
// ArmyMessageExtent: the extent Army's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool ArmyMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        const TableMessageEntry & entry = TableVocabularyEntryAt( vocabulary, ref );
        if ( TableMessageReserved( entry.id ) ) { return false; }
        if ( entry.id == 0x7848019b0c02a926ull && entry.kind == 14 && entry.elem_kind == 13 ) // squads: an unbounded array
        {
            uint64_t n = 0;
            if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { return false; }
            n += (uint64_t) entry.min;
            if ( n > (uint64_t) INT32_MAX ) { return false; } // above the int32 storage cap (§2.9)
            at = ( at + 7 ) & ~(int64_t) 7; // at alignof( Squad )
            at += (int64_t) n * (int64_t) sizeof( Squad ); // the whole array FIRST
            for ( uint64_t i = 0; i < n; i++ ) // then, element by element in index order
            {
        ...
        switch ( entry.id )
        {
            case 0x7848019b0c02a926ull: // squads
            {
                ...
                }
                {
                    ...
                    if ( !r.get( n, TableBitsRequired( entry.min, entry.max ) ) ) { report->malformed = true; return false; }
                    n += (uint64_t) entry.min;
                    TableListFill<Squad> fill = TableListFillBegin( nodes, value.squads, n );
                    if ( fill.refused ) { nodes.refused = true; return false; }
                    if ( !fill.ok ) { report->malformed = true; return false; } // the measure and the load disagree
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        Squad * slot = TableListFillNext( fill );
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        if ( !SquadLoadMessageBody( r, vocabulary, report, nodes, index_bits, ( *slot ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
template <typename Ctx>
inline int64_t DeckMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Deck & value )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
...
template <typename Ctx>
inline bool DeckSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Deck & value )
{
...
template <typename Ctx>
inline bool DeckSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Deck & value )
{
    if ( !DeckSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t DeckMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Deck & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    int64_t bits = 0;
    if ( value.hands_count < 0 || value.hands_count > 3 ) { return -1; } // storage invariant
    if ( value.hands_count > 0 )
    {
        bits += kTableMessageRefBitsHere;
        bits += 2;
        for ( int32_t i = 0; i < value.hands_count; i++ )
        {
            const int64_t elem = RowMeasureMessageBody( ctx, numbering, index_bits, at + bits, value.hands[i] );
            if ( elem < 0 ) { return -1; }
            bits += elem;
        }
    }
...
inline bool DeckSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Deck & value )
{
    ...
    if ( value.hands_count > 0 )
    {
        ...
        w.put( (uint64_t) ( value.hands_count ) - 0, 2 );
        for ( int32_t i = 0; i < value.hands_count; i++ )
        {
            if ( !RowSaveMessageBody( ctx, numbering, index_bits, w, value.hands[i] ) ) { return false; }
        }
    }
    if ( value.after != 0 )
    {
...
// DeckMessageExtent: the extent Deck's maps command on the message wire, from
// the FRAMING alone (docs/SPEC-TABLES.md §2.8, §3.3, §6.5).
inline bool DeckMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        const TableMessageEntry & entry = TableVocabularyEntryAt( vocabulary, ref );
        if ( TableMessageReserved( entry.id ) ) { return false; }
        if ( entry.id == 0x81b46a69304ee2c9ull && entry.kind == 14 && entry.elem_kind == 13 ) // hands: a nesting that holds a map
        {
            uint64_t n = (uint64_t) entry.min;
            ...
            case 0x81b46a69304ee2c9ull: // hands
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        Row scratch;
                        RowReset( scratch );
                        if ( !RowLoadMessageBody( r, vocabulary, report, nodes, index_bits, ( in_bounds ? value.hands[i] : scratch ) ) ) { return false; }
                    }
                    value.hands_count = kept;
                }
                break;
            }
            case 0xbf82010f6f71eae9ull: // after
...
inline bool RowWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0x3e7884bf4f412c6full && field_kind == 14 ) // items: an unbounded array
        {
            ...
            if ( !TableListWireExtent( list_body, (int64_t) list_len, at, (int64_t) sizeof( Sample ), (int64_t) alignof( Sample ), 13, 2, NULL, ids, reason ) ) { return false; }
            continue;
        }
...
{
    {
        TableListCursor<Sample> cursor = TableListElements( ctx, value.items );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Sample ) - 1 ) & ~( (int64_t) alignof( Sample ) - 1 );
        at += (int64_t) cursor.count * (int64_t) sizeof( Sample ); // the whole array FIRST
    }
    return true;
}
...
{
    {
        TableListCursor<Sample> cursor = TableListElements( ctx, src.items );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Sample ) - 1 ) & ~( (int64_t) alignof( Sample ) - 1 );
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( Sample );
        if ( at + bytes > capacity ) { return false; }
        Sample * placed = (Sample *) ( extent + at );
        at += bytes;
        ...
        {
            memcpy( (void *) ( placed + i ), (const void *) &cursor[i], sizeof( Sample ) ); // trivially copyable, by construction
        }
    }
    return true;
}

// SheetWireExtent: the extent Sheet's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool SheetWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
    {
        ...
        if ( field_id == 0xa3a7061ff10a8138ull && field_kind == 14 ) // rows: an unbounded array
        {
            ...
            const uint8_t * list_body = r.buffer + r.offset;
            r.offset += (int64_t) list_len;
            if ( !TableListWireExtent( list_body, (int64_t) list_len, at, (int64_t) sizeof( Row ), (int64_t) alignof( Row ), 13, 2, &RowWireExtent, ids, reason ) ) { return false; }
            continue;
        }
        if ( !r.skip( field_kind ) ) { return true; }
    }
...
// SheetExtentAt: the node extent Sheet's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as SheetExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool SheetExtentAt( const Ctx & ctx, const Sheet & value, int64_t & at )
{
    {
        TableListCursor<Row> cursor = TableListElements( ctx, value.rows );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Row ) - 1 ) & ~( (int64_t) alignof( Row ) - 1 );
        at += (int64_t) cursor.count * (int64_t) sizeof( Row ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, element by element in index order
        {
            if ( !RowExtentAt( ctx, cursor[i], at ) ) { return false; }
        }
    }
    return true;
}
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t SheetExtent( const Ctx & ctx, const Sheet & value )
{
    int64_t at = 0;
    if ( !SheetExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// SheetExtentPack: carve Sheet's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset SheetExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool SheetExtentPack( const Ctx & ctx, const Sheet & src, Sheet & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableListCursor<Row> cursor = TableListElements( ctx, src.rows );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Row ) - 1 ) & ~( (int64_t) alignof( Row ) - 1 );
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( Row );
        if ( at + bytes > capacity ) { return false; }
        Row * placed = (Row *) ( extent + at );
        at += bytes;
        dst.rows.count = cursor.count;
        dst.rows.padding = 0;
        dst.rows.elements.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.rows.elements ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            memcpy( (void *) ( placed + i ), (const void *) &cursor[i], sizeof( Row ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !RowExtentPack( ctx, cursor[i], placed[i], extent, at, capacity ) ) { return false; }
        }
    }
    return true;
}
...
// ArmyWireExtent: the extent Army's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool ArmyWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
    {
        ...
        if ( field_id == 0x7848019b0c02a926ull && field_kind == 14 ) // squads: an unbounded array
        {
            ...
            const uint8_t * list_body = r.buffer + r.offset;
            r.offset += (int64_t) list_len;
            if ( !TableListWireExtent( list_body, (int64_t) list_len, at, (int64_t) sizeof( Squad ), (int64_t) alignof( Squad ), 13, 2, &SquadWireExtent, ids, reason ) ) { return false; }
            continue;
        }
        if ( !r.skip( field_kind ) ) { return true; }
    }
...
// ArmyExtentAt: the node extent Army's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as ArmyExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool ArmyExtentAt( const Ctx & ctx, const Army & value, int64_t & at )
{
    {
        TableListCursor<Squad> cursor = TableListElements( ctx, value.squads );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Squad ) - 1 ) & ~( (int64_t) alignof( Squad ) - 1 );
        at += (int64_t) cursor.count * (int64_t) sizeof( Squad ); // the whole array FIRST
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, element by element in index order
        {
            if ( !SquadExtentAt( ctx, cursor[i], at ) ) { return false; }
        }
    }
    return true;
}
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t ArmyExtent( const Ctx & ctx, const Army & value )
{
    int64_t at = 0;
    if ( !ArmyExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// ArmyExtentPack: carve Army's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset ArmyExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool ArmyExtentPack( const Ctx & ctx, const Army & src, Army & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableListCursor<Squad> cursor = TableListElements( ctx, src.squads );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Squad ) - 1 ) & ~( (int64_t) alignof( Squad ) - 1 );
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( Squad );
        if ( at + bytes > capacity ) { return false; }
        Squad * placed = (Squad *) ( extent + at );
        at += bytes;
        dst.squads.count = cursor.count;
        dst.squads.padding = 0;
        dst.squads.elements.value = cursor.count > 0 ? (int64_t) ( (uint8_t *) placed - (const uint8_t *) &dst.squads.elements ) : 0;
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            memcpy( (void *) ( placed + i ), (const void *) &cursor[i], sizeof( Squad ) ); // trivially copyable, by construction
        }
        for ( int32_t i = 0; i < cursor.count; i++ )
        {
            if ( !SquadExtentPack( ctx, cursor[i], placed[i], extent, at, capacity ) ) { return false; }
        }
    }
    return true;
}

// DeckWireExtent: the extent Deck's lists and maps command, from the FRAMING alone.
// It reads no field value, so a caller can refuse a number it did not
// expect before one byte is allocated (docs/SPEC-TABLES.md §6.5).
inline bool DeckWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    TableReport scratch; // the scan's framing damage is the LOAD's to report
    TableReader r( body, length, &scratch, ids );
    for ( ;; )
    {
        ...
        if ( field_id == 0x81b46a69304ee2c9ull && field_kind == 14 ) // hands: a nesting that holds a list or a map
        {
            ...
            if ( !TableWireExtentElements( nested_body, (int64_t) nested_len, at, &RowWireExtent, ids, reason ) ) { return false; }
            continue;
        }
        if ( !r.skip( field_kind ) ) { return true; }
    }
...
// DeckExtentAt: the node extent Deck's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as DeckExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool DeckExtentAt( const Ctx & ctx, const Deck & value, int64_t & at )
{
    for ( int32_t i = 0; i < value.hands_count && i < 3; i++ ) // hands
    {
        if ( !RowExtentAt( ctx, value.hands[i], at ) ) { return false; }
    }
...
// for it beside the record's own storage.
template <typename Ctx>
inline int64_t DeckExtent( const Ctx & ctx, const Deck & value )
{
    int64_t at = 0;
    if ( !DeckExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// DeckExtentPack: carve Deck's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset DeckExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool DeckExtentPack( const Ctx & ctx, const Deck & src, Deck & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    for ( int32_t i = 0; i < src.hands_count && i < 3; i++ ) // hands
    {
        if ( !RowExtentPack( ctx, src.hands[i], dst.hands[i], extent, at, capacity ) ) { return false; }
    }
    for ( int32_t i = src.hands_count; i < 3; i++ ) // hands: the slots the walk does not reach (§7.6)
    {
        if ( !TableExtentUnreachedEmpty( RowExtent( ctx, src.hands[i] ) ) ) { return false; }
    }
    return true;
}
...
{
    SquadRosterEntry * entry = TableMapPlace( worker, map, key );
...
// ---- Row.items: the builder's three (§2.9) ----
...
inline Sample * RowItemsAdd( TableWorker & worker, TableList<Sample> & list )
{
...
inline bool RowItemsErase( TableArena & arena, TableList<Sample> & list, const Sample * element )
{
...
inline TableListEach<Sample> RowItemsEach( const TableArena & arena, const TableList<Sample> & list )
{
    return TableListEachOf( arena, list );
}

// ---- Sheet.rows: the builder's three (§2.9) ----
...
// NULL means NOT ADDED: an arena that cannot carve another segment, or a
// count at the int32 cap. A caller that needs the reason checks size().
inline Row * SheetRowsAdd( TableWorker & worker, TableList<Row> & list )
{
    return TableListPlace( worker, list );
}
...
// not this list's. Storage is held until the builder resets. INDICES ARE
// NOT STABLE ACROSS AN ERASE: what was index 3 is index 2 in the next Save.
inline bool SheetRowsErase( TableArena & arena, TableList<Row> & list, const Row * element )
{
    return TableListErase( arena, list, element );
}
...
// EACH on the builder: INDEX order, live elements only, yielding the
// element Add handed back.
inline TableListEach<Row> SheetRowsEach( const TableArena & arena, const TableList<Row> & list )
{
    return TableListEachOf( arena, list );
}

// ---- Army.squads: the builder's three (§2.9) ----
...
// NULL means NOT ADDED: an arena that cannot carve another segment, or a
// count at the int32 cap. A caller that needs the reason checks size().
inline Squad * ArmySquadsAdd( TableWorker & worker, TableList<Squad> & list )
{
    return TableListPlace( worker, list );
}
...
// not this list's. Storage is held until the builder resets. INDICES ARE
// NOT STABLE ACROSS AN ERASE: what was index 3 is index 2 in the next Save.
inline bool ArmySquadsErase( TableArena & arena, TableList<Squad> & list, const Squad * element )
{
    return TableListErase( arena, list, element );
}
...
// EACH on the builder: INDEX order, live elements only, yielding the
// element Add handed back.
inline TableListEach<Squad> ArmySquadsEach( const TableArena & arena, const TableList<Squad> & list )
{
    return TableListEachOf( arena, list );
}
...
template <typename Ctx>
inline bool RowNumber( const Ctx & ctx, TableNumbering & numbering, const Row & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// RowPackMeasure: the packed region bytes of everything Row POINTS AT.
...
template <typename Ctx>
inline int64_t RowPackMeasure( const Ctx & ctx, TablePackMap & seen, const Row & value )
{
    int64_t bytes = 0;
...
// RowPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool RowPackEdges( const Ctx & ctx, TablePackMap & seen, const Row & src, Row & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool RowPack( const Ctx & ctx, TablePackMap & seen, const Row & src, Row & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Row ) ); // trivially copyable, by construction
    int64_t at = 0;
...
// SheetNumber: number everything Sheet POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool SheetNumber( const Ctx & ctx, TableNumbering & numbering, const Sheet & value )
{
    { // rows: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows );
        if ( !cursor_rows.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_rows.count; i++ )
        {
            if ( !RowNumber( ctx, numbering, cursor_rows[i] ) ) { return false; }
        }
    }
    {
        const Row * pointee = RowAt( ctx, value.pinned ); // pinned
        if ( pointee != NULL )
        {
            bool taken = false;
            int64_t slot = 0;
            ...
            else
            {
                ...
                node.type_id = 0xa013e119fec906fbull; // fnv1a64( "Row" )
                node.type_slot = 58; // its slot in the unit's vocabulary (§3.3)
                node.measure = &TableNodeMeasureThunk<Ctx, Row>;
                node.save = &TableNodeSaveThunk<Ctx, Row>;
                node.message_measure = &TableNodeMessageMeasureThunk<Ctx, Row>;
                node.message_save = &TableNodeMessageSaveThunk<Ctx, Row>;
                if ( !TableNumberingAppend( numbering, node ) ) { return false; }
                if ( !RowNumber( ctx, numbering, *pointee ) ) { return false; }
...
// SheetPackMeasure: the packed region bytes of everything Sheet POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t SheetPackMeasure( const Ctx & ctx, TablePackMap & seen, const Sheet & value )
{
    int64_t bytes = 0;
    { // rows: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows );
        if ( !cursor_rows.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_rows.count; i++ )
        {
            int64_t inner = RowPackMeasure( ctx, seen, cursor_rows[i] );
            if ( inner < 0 ) { return -1; }
            bytes += inner;
        }
    }
    {
        ...
        if ( pointee != NULL )
        {
            ...
            {
                int64_t inner = RowPackMeasure( ctx, seen, *pointee );
                if ( inner < 0 ) { return -1; }
                TablePackMapClose( seen, (const void *) pointee, slot );
                int64_t node_extent = RowExtent( ctx, *pointee );
                if ( node_extent < 0 ) { return -1; }
                bytes += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + node_extent ) + inner;
            }
        }
    }
    return bytes;
...
// SheetPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool SheetPackEdges( const Ctx & ctx, TablePackMap & seen, const Sheet & src, Sheet & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool SheetPack( const Ctx & ctx, TablePackMap & seen, const Sheet & src, Sheet & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Sheet ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Sheet ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !SheetExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return SheetPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // rows: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Row> cursor_rows = TableListElements( ctx, src.rows );
        if ( !cursor_rows.ok ) { return false; }
        Row * placed_rows = (Row *) ( dst.rows.elements.value != 0 ? ( (uint8_t *) &dst.rows.elements + dst.rows.elements.value ) : NULL );
        for ( int32_t i = 0; i < cursor_rows.count; i++ )
        {
            if ( !RowPackEdges( ctx, seen, cursor_rows[i], placed_rows[i], base, capacity, used ) ) { return false; }
        }
    }
    {
        dst.pinned.value = 0; // pinned
        const Row * pointee = RowAt( ctx, src.pinned );
        if ( pointee != NULL )
        {
            ...
            {
                if ( entry->open != 0 ) { return false; } // a data cycle
                dst.pinned.value = (int64_t) ( ( base + entry->offset ) - (const uint8_t *) &dst.pinned ); // the one body it already has
            }
            else
            {
                int64_t node_extent = RowExtent( ctx, *pointee );
                if ( node_extent < 0 ) { return false; }
                const int64_t node_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + node_extent );
                if ( at + node_bytes > capacity ) { return false; }
                used = at + node_bytes;
                Row * child = new ( base + at ) Row; // lifetime only: the Pack below memcpy's the whole node over it
                dst.pinned.value = (int64_t) ( ( base + at ) - (const uint8_t *) &dst.pinned );
                if ( !RowPack( ctx, seen, *pointee, *child, base, capacity, used ) ) { return false; }
                TablePackMapClose( seen, (const void *) pointee, slot );
            }
        }
    }
...
// ArmyNumber: number everything Army POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool ArmyNumber( const Ctx & ctx, TableNumbering & numbering, const Army & value )
{
    { // squads: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads );
        if ( !cursor_squads.ok ) { return false; }
        for ( int32_t i = 0; i < cursor_squads.count; i++ )
        {
            if ( !SquadNumber( ctx, numbering, cursor_squads[i] ) ) { return false; }
        }
    }
    return true;
}

// ArmyPackMeasure: the packed region bytes of everything Army POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t ArmyPackMeasure( const Ctx & ctx, TablePackMap & seen, const Army & value )
{
    int64_t bytes = 0;
    { // squads: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads );
        if ( !cursor_squads.ok ) { return -1; }
        for ( int32_t i = 0; i < cursor_squads.count; i++ )
        {
            int64_t inner = SquadPackMeasure( ctx, seen, cursor_squads[i] );
            if ( inner < 0 ) { return -1; }
            bytes += inner;
        }
    }
...
// ArmyPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool ArmyPackEdges( const Ctx & ctx, TablePackMap & seen, const Army & src, Army & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool ArmyPack( const Ctx & ctx, TablePackMap & seen, const Army & src, Army & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Army ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Army ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !ArmyExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return ArmyPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
{
    { // squads: a by-value edge, elements in INDEX order (§2.9, §3.1)
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, src.squads );
        if ( !cursor_squads.ok ) { return false; }
        Squad * placed_squads = (Squad *) ( dst.squads.elements.value != 0 ? ( (uint8_t *) &dst.squads.elements + dst.squads.elements.value ) : NULL );
        for ( int32_t i = 0; i < cursor_squads.count; i++ )
        {
            if ( !SquadPackEdges( ctx, seen, cursor_squads[i], placed_squads[i], base, capacity, used ) ) { return false; }
        }
    }
    return true;
}

// DeckNumber: number everything Deck POINTS AT, in first-visit order —
// the fields in declaration order, a by-value edge descended in place.
// A reference to an entry whose descent is still OPEN is a data cycle,
// named here rather than recursed away (docs/SPEC-TABLES.md §3.1).
template <typename Ctx>
inline bool DeckNumber( const Ctx & ctx, TableNumbering & numbering, const Deck & value )
{
    for ( int32_t i = 0; i < value.hands_count && i < 3; i++ ) // hands
    {
        if ( !RowNumber( ctx, numbering, value.hands[i] ) ) { return false; }
    }
    return true;
}

// DeckPackMeasure: the packed region bytes of everything Deck POINTS AT.
// ONE VISIT PER NODE: `seen` carries the first-visit numbering (§3.1), so a
// node two references name is measured ONCE and packed once, and a
// reference to a node whose descent is still open is a data cycle, refused.
template <typename Ctx>
inline int64_t DeckPackMeasure( const Ctx & ctx, TablePackMap & seen, const Deck & value )
{
    int64_t bytes = 0;
    for ( int32_t i = 0; i < value.hands_count && i < 3; i++ ) // hands
    {
        int64_t inner = RowPackMeasure( ctx, seen, value.hands[i] );
        if ( inner < 0 ) { return -1; }
        bytes += inner;
    }
    return bytes;
...
// DeckPack: copy src into dst (already placed), then lay every pointee out
// depth-first behind it, in FIELD ORDER, by bump allocation.
//
// ONE NODE, ONE BODY (§6.2): `seen` holds every node already placed and
// where it landed, so a node's FIRST reference lays it out and every later
...
// refuses it rather than packing one.
template <typename Ctx>
inline bool DeckPackEdges( const Ctx & ctx, TablePackMap & seen, const Deck & src, Deck & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool DeckPack( const Ctx & ctx, TablePackMap & seen, const Deck & src, Deck & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Deck ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Deck ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !DeckExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return DeckPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
inline bool DeckPackEdges( const Ctx & ctx, TablePackMap & seen, const Deck & src, Deck & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    for ( int32_t i = 0; i < src.hands_count && i < 3; i++ ) // hands
    {
        if ( !RowPackEdges( ctx, seen, src.hands[i], dst.hands[i], base, capacity, used ) ) { return false; }
    }
    return true;
}

// ---- Row: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: RowBuilder — allocate nodes, wire them together, then Lock.
...
// Row is never held by value — a file-format-scale structure is a region
...
struct RowBuilder
{
    ...
    RowBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Row * GetRoot() { return arena.locked ? NULL : (Row *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Row * AsConst() const { return (const Row *) region; }
...
inline bool RowBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Row & root = *(const Row *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Row on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// RowNodeStorage: the region bytes one record commands, or -1 for a type id
...
// RowNodePlace: start one record's node's lifetime in the storage pass one
...
// RowNodeAlloc: the TOOL's path — one record's node in the builder's arena.
...
inline void RowNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = RowNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? RowNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// RowNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t RowNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    switch ( type_id )
...
// RowNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool RowNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
{
    TableExtentCarve carve;
    carve.at = at + RowNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !RowNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool RowNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Row & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return RowNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t RowMeasureWire( const Ctx & ctx, const Row & root, TableAllocator allocator )
{
    ...
    {
        TableIds ids;
        bytes = RowMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t RowSaveWire( const Ctx & ctx, const Row & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    bool ok = RowSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == RowMeasure( root )
}

inline int64_t RowMeasure( const Row * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RowMeasureWire( ctx, *root, allocator );
}

inline int64_t RowSave( const Row * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RowSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t RowMeasure( const RowBuilder & builder )
{
    if ( builder.region != NULL ) { return RowMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RowMeasureWire( ctx, *(const Row *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t RowSave( const RowBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return RowSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RowSaveWire( ctx, *(const Row *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}
...
template <typename Ctx>
inline int64_t RowMessageBodyBits( const Ctx & ctx, const Row & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( RowNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = RowMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool RowMessageBodySave( const Ctx & ctx, const Row & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && RowSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t RowMeasureMessages( const Row * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = RowMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t RowSaveMessages( const Row * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !RowMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == RowMeasureMessages( roots, count, report, allocator )
}

// RowMessageRecordScan: one node record's type id and the extent its maps
...
inline bool RowMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return RowNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}
...
// and no further (§3.3).
inline bool RowMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RowMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = RowNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !RowMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + root_extent );
    return true;
}

// RowLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t RowLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !RowMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// RowLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool RowLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Row * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !RowMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = RowNodeMessageStorage( type_id, extent, length );
        ...
        RowNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !RowMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + root_extent );
    ...
    Row * root = new ( region + used ) Row; // lifetime only: LoadMessageBody's first act is RowReset
    RowReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Row ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !RowNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return RowLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// RowLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool RowLoadMessages( const Row ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !RowLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// RowLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t RowLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    ...
    {
        records++;
        int64_t storage = RowNodeStorage( type_id, length, reason );
...
// RowLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Row * RowLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Row ) ) { out->malformed = true; return NULL; }
    ...
    directory[0].type_id = 0xa013e119fec906fbull;
    Row * root = new ( region ) Row; // lifetime only: LoadBody's first act is RowReset
    RowReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                RowNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    RowLoadBody( r, nodes, *root );
    return root;
}

// RowLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool RowLoadBuilder( RowBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = RowNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
...
// ---- Sheet: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: SheetBuilder — allocate nodes, wire them together, then Lock.
// CONST:   one packed region, root at its base. Lock produces it and Load
//          produces it, so a locked structure and a loaded one are the
//          SAME representation with one view API. There is no unlock:
//          re-editing means loading the const form into a fresh builder.
// Sheet is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.
...
struct SheetBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    SheetBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    Sheet * GetRoot() { return arena.locked ? NULL : (Sheet *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Sheet * AsConst() const { return (const Sheet *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool SheetBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Sheet & root = *(const Sheet *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = SheetPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t root_extent = SheetExtent( ctx, root );
    if ( root_extent < 0 ) { TablePackMapShutdown( seen ); return false; } // the sort could not run
    int64_t total = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Sheet ) ) + root_extent ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) arena.allocator.alloc( arena.allocator.context, total );
...
// ---- Sheet on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// SheetNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
...
// depth, summed from the FRAMING: N is framing and not a value, and this
// reads no field. kTableNodeRefused is a wire whose N its L cannot carry.
inline int64_t SheetNodeStorage( uint64_t type_id, const uint8_t * body, int64_t length, const TableIdTable * ids, TableRefuseReason & reason )
{
    (void) length; // no byte buffer below this root: every node's storage is its type's
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: // Row
        {
            int64_t extent = 0;
            if ( !RowWireExtent( body, length, extent, ids, reason ) ) { return kTableNodeRefused; }
            return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + extent );
        }
        default: break;
    }
    return -1;
...
// SheetNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
inline void SheetNodePlace( uint64_t type_id, uint8_t * at, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: { Row * node = new ( at ) Row; RowReset( *node ); break; } // Row
        default: break;
    }
}

// SheetNodeRecordBytes: one record's OWN storage, before the extent its maps
// take (docs/SPEC-TABLES.md §2.8) — where a node's extent begins.
inline int64_t SheetNodeRecordBytes( uint64_t type_id )
{
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: return TableAlignUp64( (int64_t) sizeof( Row ) ); // Row
        default: break;
    }
    return 0;
}

// SheetNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
inline uint32_t SheetNodeAlloc( uint64_t type_id, TableWorker & worker, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: return (uint32_t) worker.Alloc<Row>().ref.value; // Row
        default: break;
    }
    return 0;
}

// SheetNodeBody: PASS TWO's half, decoding one record's body into the storage it
// already owns.
inline void SheetNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    {
        TableRefuseReason reason = count_over_length; // pass one already refused what this could refuse
        const int64_t storage = SheetNodeStorage( type_id, r.buffer, r.size, r.ids, reason );
        const int64_t record = storage > 0 ? SheetNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
        carve.left = storage > record ? storage - record : 0;
    }
    nodes.carve = &carve;
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: RowLoadBody( r, nodes, *(Row *) at ); break; // Row
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// SheetNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t SheetNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: return TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Row ) ) + extent ); // Row
        default: break;
    }
    return -1;
}

// SheetNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool SheetNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: return RowMessageExtent( r, vocabulary, index_bits, extent ); // Row
        default: break;
    }
    return TableMessageSkipBody( r, vocabulary, index_bits );
}
...
{
    TableExtentCarve carve;
    carve.at = at + SheetNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !SheetNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    TableExtentCarve * const outer = nodes.carve;
    nodes.carve = &carve;
    ...
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: ok = RowLoadMessageBody( r, vocabulary, report, nodes, index_bits, *(Row *) at ); break; // Row
        // a record this dispatch cannot name never reaches here: pass one left it absent
        default: report->malformed = true; break;
    }
    nodes.carve = outer;
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool SheetNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Sheet & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return SheetNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t SheetMeasureWire( const Ctx & ctx, const Sheet & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    if ( SheetNumberFrom( ctx, numbering, root ) )
    {
        TableIds ids;
        bytes = SheetMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t SheetSaveWire( const Ctx & ctx, const Sheet & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    if ( !SheetNumberFrom( ctx, numbering, root ) ) { TableNumberingShutdown( numbering ); return -1; }
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    // the root's own fields, then the node table's field, then the
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = SheetSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == SheetMeasure( root )
}

inline int64_t SheetMeasure( const Sheet * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SheetMeasureWire( ctx, *root, allocator );
}

inline int64_t SheetSave( const Sheet * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SheetSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t SheetMeasure( const SheetBuilder & builder )
{
    if ( builder.region != NULL ) { return SheetMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SheetMeasureWire( ctx, *(const Sheet *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t SheetSave( const SheetBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return SheetSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SheetSaveWire( ctx, *(const Sheet *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}
...
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t SheetMessageBodyBits( const Ctx & ctx, const Sheet & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( SheetNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = SheetMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool SheetMessageBodySave( const Ctx & ctx, const Sheet & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && SheetSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t SheetMeasureMessages( const Sheet * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = SheetMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t SheetSaveMessages( const Sheet * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !SheetMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == SheetMeasureMessages( roots, count, report, allocator )
}

// SheetMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool SheetMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return SheetNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool SheetMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !SheetMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = SheetNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !SheetMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Sheet ) ) + root_extent );
    return true;
}

// SheetLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t SheetLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !SheetMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// SheetLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool SheetLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Sheet * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !SheetMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = SheetNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        SheetNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    {
        TableBitReader walk = r;
        if ( !SheetMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Sheet ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x0cc9e0af9a85fbc8ull;
    Sheet * root = new ( region + used ) Sheet; // lifetime only: LoadMessageBody's first act is SheetReset
    SheetReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Sheet ) );
    root_carve.left = root_extent;
    used += root_bytes;
    nodes.good = true;
    out->unknown += unknown_records;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !SheetNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return SheetLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// SheetLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool SheetLoadMessages( const Sheet ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !SheetLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// SheetLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t SheetLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableRefuseReason reason = count_over_length;
    int64_t root_extent = 0;
    if ( !SheetWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Sheet ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = SheetNodeStorage( type_id, body, length, &ids_table, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// SheetLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const Sheet * SheetLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Sheet ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    TableRefuseReason reason = count_over_length; // LoadMeasure is where a caller reads it; a Load past a refusal is malformed
    int64_t root_extent = 0;
    if ( !SheetWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Sheet ) ) + root_extent );
    int64_t records = 0;
    {
        TableReport counting;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0x0cc9e0af9a85fbc8ull;
    Sheet * root = new ( region ) Sheet; // lifetime only: LoadBody's first act is SheetReset
    SheetReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                SheetNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    r.nested = false; // the ROOT body, the one that carries the node table
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Sheet ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    SheetLoadBody( r, nodes, *root );
    return root;
}

// SheetLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool SheetLoadBuilder( SheetBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = SheetNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    root_carve.worker = &builder.main;
    nodes.carve = &root_carve;
    bool ok = SheetLoadBody( r, nodes, *root );
    // A COUNT ABOVE THE int32 CAP is this path's refusal (docs/SPEC-TABLES.md
    // §2.9): the partial builder is the caller's to discard, and the report
    // holds what it held when the count was met
    ok = ok && !nodes.refused;
...
// ---- Army: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: ArmyBuilder — allocate nodes, wire them together, then Lock.
// CONST:   one packed region, root at its base. Lock produces it and Load
//          produces it, so a locked structure and a loaded one are the
//          SAME representation with one view API. There is no unlock:
//          re-editing means loading the const form into a fresh builder.
// Army is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.
...
struct ArmyBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    ArmyBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    Army * GetRoot() { return arena.locked ? NULL : (Army *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Army * AsConst() const { return (const Army *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool ArmyBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Army & root = *(const Army *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = ArmyPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t root_extent = ArmyExtent( ctx, root );
    if ( root_extent < 0 ) { TablePackMapShutdown( seen ); return false; } // the sort could not run
    int64_t total = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Army ) ) + root_extent ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) arena.allocator.alloc( arena.allocator.context, total );
...
// ---- Army on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// ArmyNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
...
// ArmyNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
...
// ArmyNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
...
// ArmyNodeBody: PASS TWO's half, decoding one record's body into the storage it
// already owns.
inline void ArmyNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    {
        TableRefuseReason reason = count_over_length; // pass one already refused what this could refuse
        const int64_t storage = ArmyNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? ArmyNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
        carve.left = storage > record ? storage - record : 0;
    }
    nodes.carve = &carve;
...
// ArmyNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t ArmyNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    switch ( type_id )
...
// ArmyNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool ArmyNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    (void) type_id; // no map below any node this root can name
    return TableMessageSkipBody( r, vocabulary, index_bits );
...
{
    TableExtentCarve carve;
    carve.at = at + ArmyNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !ArmyNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    TableExtentCarve * const outer = nodes.carve;
    nodes.carve = &carve;
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool ArmyNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Army & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return ArmyNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t ArmyMeasureWire( const Ctx & ctx, const Army & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    {
        TableIds ids;
        bytes = ArmyMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t ArmySaveWire( const Ctx & ctx, const Army & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = ArmySaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == ArmyMeasure( root )
}

inline int64_t ArmyMeasure( const Army * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ArmyMeasureWire( ctx, *root, allocator );
}

inline int64_t ArmySave( const Army * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ArmySaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t ArmyMeasure( const ArmyBuilder & builder )
{
    if ( builder.region != NULL ) { return ArmyMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ArmyMeasureWire( ctx, *(const Army *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t ArmySave( const ArmyBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return ArmySave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ArmySaveWire( ctx, *(const Army *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}
...
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t ArmyMessageBodyBits( const Ctx & ctx, const Army & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( ArmyNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = ArmyMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool ArmyMessageBodySave( const Ctx & ctx, const Army & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && ArmySaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t ArmyMeasureMessages( const Army * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = ArmyMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t ArmySaveMessages( const Army * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !ArmyMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == ArmyMeasureMessages( roots, count, report, allocator )
}

// ArmyMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool ArmyMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return ArmyNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool ArmyMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !ArmyMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = ArmyNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !ArmyMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Army ) ) + root_extent );
    return true;
}

// ArmyLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t ArmyLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !ArmyMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// ArmyLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool ArmyLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Army * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !ArmyMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = ArmyNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        ArmyNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    {
        TableBitReader walk = r;
        if ( !ArmyMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Army ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0x06e2378b553a9e84ull;
    Army * root = new ( region + used ) Army; // lifetime only: LoadMessageBody's first act is ArmyReset
    ArmyReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Army ) );
    root_carve.left = root_extent;
    used += root_bytes;
    nodes.good = true;
    out->unknown += unknown_records;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !ArmyNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return ArmyLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// ArmyLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool ArmyLoadMessages( const Army ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !ArmyLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// ArmyLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t ArmyLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableRefuseReason reason = count_over_length;
    int64_t root_extent = 0;
    if ( !ArmyWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Army ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = ArmyNodeStorage( type_id, length, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// ArmyLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const Army * ArmyLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Army ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    TableRefuseReason reason = count_over_length; // LoadMeasure is where a caller reads it; a Load past a refusal is malformed
    int64_t root_extent = 0;
    if ( !ArmyWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Army ) ) + root_extent );
    int64_t records = 0;
    {
        TableReport counting;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0x06e2378b553a9e84ull;
    Army * root = new ( region ) Army; // lifetime only: LoadBody's first act is ArmyReset
    ArmyReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                ArmyNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    r.nested = false; // the ROOT body, the one that carries the node table
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Army ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    ArmyLoadBody( r, nodes, *root );
    return root;
}

// ArmyLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool ArmyLoadBuilder( ArmyBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = ArmyNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    root_carve.worker = &builder.main;
    nodes.carve = &root_carve;
    bool ok = ArmyLoadBody( r, nodes, *root );
    // A COUNT ABOVE THE int32 CAP is this path's refusal (docs/SPEC-TABLES.md
    // §2.9): the partial builder is the caller's to discard, and the report
    // holds what it held when the count was met
    ok = ok && !nodes.refused;
...
// ---- Deck: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: DeckBuilder — allocate nodes, wire them together, then Lock.
// CONST:   one packed region, root at its base. Lock produces it and Load
//          produces it, so a locked structure and a loaded one are the
//          SAME representation with one view API. There is no unlock:
//          re-editing means loading the const form into a fresh builder.
// Deck is never held by value — a file-format-scale structure is a region
// and a root pointer, not a struct you copy.
...
struct DeckBuilder
{
    ...
    // the packed region, the wire walks' numbering, and the tool path's node
    // directory. Name your own and a profiler sees every byte under it.
    DeckBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
        TableArenaInit( arena, allocator );
        main.arena = &arena;
    ...
    // example. The checker refuses a table named after any member here,
    // so the remaining spellings cannot collide either.
    Deck * GetRoot() { return arena.locked ? NULL : (Deck *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Deck * AsConst() const { return (const Deck *) region; }
    const uint8_t * Region() const { return region; }
    int64_t RegionBytes() const { return region_bytes; }
...
inline bool DeckBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Deck & root = *(const Deck *) TableArenaAt( arena, (uint32_t) root_ref.value );
    // The ROOT takes the map's first entry: it is packed at offset 0, and its
    // descent is open for the whole walk (docs/SPEC-TABLES.md §3.1).
    TablePackMap seen;
    TablePackMapInit( seen, arena.allocator );
    ...
    if ( TablePackMapReach( seen, (const void *) &root, 0, root_taken, root_slot ) != NULL )
    {
        below = DeckPackMeasure( ctx, seen, root );
    }
    if ( below < 0 ) { TablePackMapShutdown( seen ); return false; } // a data cycle, named at the reference that closes it
    int64_t root_extent = DeckExtent( ctx, root );
    if ( root_extent < 0 ) { TablePackMapShutdown( seen ); return false; } // the sort could not run
    int64_t total = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Deck ) ) + root_extent ) + below;
    // the AUTHORING path may allocate (§6.5), and it does so through the
    // builder's own pair. The region comes back ZEROED, which is the
    // allocator's contract: a packed region carries node padding.
    uint8_t * packed = (uint8_t *) arena.allocator.alloc( arena.allocator.context, total );
...
// ---- Deck on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
// A pointered save writes every reachable node ONCE, into a node table under
// the reserved id 0xFFFF, and a pointer field rides as a u32 INDEX into it
// under kind 17. No pointer edge is a nesting level, so a chain's length is
...
// DeckNodeStorage: the region bytes one record commands, or -1 for a type id
// this build cannot name — which keeps its index and reads null. A BYTE
// BUFFER's record commands its header and its bytes (docs/SPEC-TABLES.md §2.5),
// which is the one answer the record's LENGTH decides, and a blob past the
// size cap answers kTableNodeRefused with its reason (§3.1, §6.5).
...
// DeckNodePlace: start one record's node's lifetime in the storage pass one
// reserved for it, holding exactly the declared defaults — a byte buffer's
// header holds its length, and its bytes come in pass two.
...
// DeckNodeAlloc: the TOOL's path — one record's node in the builder's arena.
// Zero is the arena's null, and it is also what a type id this build cannot
// name answers.
...
// DeckNodeBody: PASS TWO's half, decoding one record's body into the storage it
// already owns.
inline void DeckNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
    ...
    {
        TableRefuseReason reason = count_over_length; // pass one already refused what this could refuse
        const int64_t storage = DeckNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? DeckNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
        carve.left = storage > record ? storage - record : 0;
    }
    nodes.carve = &carve;
...
// DeckNodeMessageStorage: the region bytes one record commands on the message
// wire, or -1 for a type id this build cannot name. A table's is its own
// storage plus the extent its maps take; a byte buffer's is its header and
// its bytes, which is the one answer the record's LENGTH decides.
inline int64_t DeckNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    switch ( type_id )
...
// DeckNodeMessageExtent: step over one TABLE record's body, tallying the extent
// its maps take where its type has any (§2.8). A type this build cannot
// name is stepped over by its announced shapes and takes no extent.
inline bool DeckNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
    (void) type_id; // no map below any node this root can name
    return TableMessageSkipBody( r, vocabulary, index_bits );
...
{
    TableExtentCarve carve;
    carve.at = at + DeckNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !DeckNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
    TableExtentCarve * const outer = nodes.carve;
    nodes.carve = &carve;
...
// reference back at it is the cycle it is (§3.1).
template <typename Ctx>
inline bool DeckNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Deck & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return DeckNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t DeckMeasureWire( const Ctx & ctx, const Deck & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    {
        TableIds ids;
        bytes = DeckMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasure( ctx, ids, numbering );
            // the FORM BYTE, the ROOT BODY — its own fields, the node table
...
template <typename Ctx>
inline int64_t DeckSaveWire( const Ctx & ctx, const Deck & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    // terminator: a reader that gives up inside the table has already
    // decoded the ROOT'S OWN FIELDS (§3.1)
    bool ok = DeckSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
    TableIdsWrite( w, ids );
    if ( w.overflow ) { return -1; } // the caller's buffer was too small
    return w.offset; // == DeckMeasure( root )
}

inline int64_t DeckMeasure( const Deck * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DeckMeasureWire( ctx, *root, allocator );
}

inline int64_t DeckSave( const Deck * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DeckSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t DeckMeasure( const DeckBuilder & builder )
{
    if ( builder.region != NULL ) { return DeckMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DeckMeasureWire( ctx, *(const Deck *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t DeckSave( const DeckBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return DeckSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DeckSaveWire( ctx, *(const Deck *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}
...
// derives the same one, and nothing passes between them (§3.1).
template <typename Ctx>
inline int64_t DeckMessageBodyBits( const Ctx & ctx, const Deck & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( DeckNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = DeckMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
            bits = body < 0 ? -1 : table + body;
        }
    }
    TableNumberingShutdown( numbering );
...
template <typename Ctx>
inline bool DeckMessageBodySave( const Ctx & ctx, const Deck & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && DeckSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
    return ok && !w.overflow;
}
...
// root is a locked region's, `builder.AsConst()`, or a loaded one's. M above
// 256 is a refusal by name, batch_too_large, with nothing written.
inline int64_t DeckMeasureMessages( const Deck * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableRegionCtx ctx;
    ...
    {
        if ( roots[i] == NULL ) { return -1; }
        const int64_t body = DeckMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t DeckSaveMessages( const Deck * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !DeckMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == DeckMeasureMessages( roots, count, report, allocator )
}

// DeckMessageRecordScan: one node record's type id and the extent its maps
// take, or a blob's length, the reader left after the record. A type id
// reference of 0, one past E, or one naming anything but a kind-0 entry is
// damage, as §3.1 and §3.3 say.
inline bool DeckMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    if ( !r.get( type_ref, vocabulary.ref_bits ) ) { return false; }
    TableMessageEntry type_entry;
    ...
    return DeckNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}
...
// bodies before it were delivered, so the batch is sized through this body
// and no further (§3.3).
inline bool DeckMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !DeckMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = DeckNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !DeckMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Deck ) ) + root_extent );
    return true;
}

// DeckLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
// which is one measurement, one allocation and one bounds check for however
// many bodies ride (§3.3, §6.5). It is a scan by the announced shapes and
// reads no field value. The answer is the data bytes plus the attribution,
// one node directory a body, and -1 for a wire it cannot size: no vocabulary,
// another form, or framing that gives out.
inline int64_t DeckLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    const int64_t bodies = TableMessageBatchOpen( br, vocabulary, buffer, bytes, &ignored );
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        int64_t records = 0, body_data = 0;
        bool complete = true;
        if ( !DeckMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
        attribution += ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
        if ( !complete ) { break; } // damage inside this body: the load delivers the ones before it
    }
...
// DeckLoadMessageBodyInto: one body of a batch into the region at `used`. Its
// chunk is the node DIRECTORY, then the records in wire order, then the root
// and the extent its maps take, so every offset a pass needs is known when
// the pass reaches it. PASS ONE fills the numbering from the framing and
// places every node; PASS TWO decodes each record's body into the storage it
// owns; the ROOT's own body decodes last, so every index it carries resolves
// against a numbering already known whole.
inline bool DeckLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Deck * & root_out )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !DeckMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = DeckNodeMessageStorage( type_id, extent, length );
        directory[k + 1].type_id = type_id;
        if ( storage <= 0 )
        {
        ...
        if ( used + storage > region_bytes ) { out->malformed = true; return false; }
        directory[k + 1].offset = (uint64_t) used;
        DeckNodePlace( type_id, region + used, length );
        used += storage;
    }
    const int64_t fields_start = r.offset;
    int64_t root_extent = 0;
    {
        TableBitReader walk = r;
        if ( !DeckMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Deck ) ) + root_extent );
    if ( used + root_bytes > region_bytes ) { out->malformed = true; return false; }
    directory[0].offset = (uint64_t) used;
    directory[0].type_id = 0xd043187343bfcfe8ull;
    Deck * root = new ( region + used ) Deck; // lifetime only: LoadMessageBody's first act is DeckReset
    DeckReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Deck ) );
    root_carve.left = root_extent;
    used += root_bytes;
    nodes.good = true;
    out->unknown += unknown_records;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !DeckNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return DeckLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// DeckLoadMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
// no reference, so there is no depth cap and no visited set. NULL roots
// beyond count are not bodies.
inline bool DeckLoadMessages( const Deck ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !DeckLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// DeckLoadMeasure: the exact region bytes a wire buffer will need, and it is
// ONE SCAN — a record's type id gives its storage size, its length gives the
// next record — reading no field value at all, so the caller owns the
// allocation and can refuse a number it did not expect (§6.5).
//
...
// attribution is the wire's numbering made resident (§6.3) and a caller may
// release it once Load returns. The answer is their sum.
inline int64_t DeckLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    TableIdTable ids_table;
    int64_t body_bytes = 0;
    ...
    TableRefuseReason reason = count_over_length;
    int64_t root_extent = 0;
    if ( !DeckWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Deck ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    int64_t length = 0;
    ...
    {
        records++;
        int64_t storage = DeckNodeStorage( type_id, length, reason );
        if ( storage == kTableNodeRefused ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; } // an N the record's framing cannot carry, or a blob past the cap (§2.8, §2.9, §3.1)
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
    }
    int64_t attribution = ( records + 1 ) * (int64_t) sizeof( TableNodeDirEntry );
...
// DeckLoad: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
// was wrong.
inline const Deck * DeckLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Deck ) ) { out->malformed = true; return NULL; }
    if ( ( ( (uintptr_t) region ) & ( kTableAlign - 1 ) ) != 0 ) { out->malformed = true; return NULL; }
    memset( region, 0, (size_t) region_bytes );
    uint64_t type_id = 0;
    const uint8_t * body = NULL;
    ...
    TableRefuseReason reason = count_over_length; // LoadMeasure is where a caller reads it; a Load past a refusal is malformed
    int64_t root_extent = 0;
    if ( !DeckWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Deck ) ) + root_extent );
    int64_t records = 0;
    {
        TableReport counting;
    ...
    directory[0].offset = 0; // position 0 is the ROOT, at offset 0 (§6.3)
    directory[0].type_id = 0xd043187343bfcfe8ull;
    Deck * root = new ( region ) Deck; // lifetime only: LoadBody's first act is DeckReset
    DeckReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                DeckNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    r.nested = false; // the ROOT body, the one that carries the node table
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Deck ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    DeckLoadBody( r, nodes, *root );
    return root;
}

// DeckLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
// builder, so loaded data can be edited and locked again. The numbering is
// the same one; what differs is where a node lives and therefore what a
// resolved slot holds — an arena offset here, a self-relative delta there.
inline bool DeckLoadBuilder( DeckBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = DeckNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    root_carve.worker = &builder.main;
    nodes.carve = &root_carve;
    bool ok = DeckLoadBody( r, nodes, *root );
    // A COUNT ABOVE THE int32 CAP is this path's refusal (docs/SPEC-TABLES.md
    // §2.9): the partial builder is the caller's to discard, and the report
    // holds what it held when the count was met
    ok = ok && !nodes.refused;
...
template <typename Ctx>
inline int64_t RowMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        ...
        if ( cursor_items.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_items = 0; elem_i_items < cursor_items.count; elem_i_items++ )
            {
                const int64_t elem_bytes_items = SampleMeasureBodyRetain( ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) );
                if ( elem_bytes_items < 0 ) { return -1; }
                body_items += TableLebBytes( (uint64_t) ( elem_bytes_items ) ) + ( elem_bytes_items );
            }
            bytes += TableLebBytes( ref_items ) + 1 + TableLebBytes( (uint64_t) ( body_items ) ) + ( body_items );
...
template <typename Ctx>
inline bool RowSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    {
        TableListCursor<Sample> cursor_items = TableListElements( ctx, value.items ); // items
        ...
        if ( cursor_items.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const int64_t elem_len_items = SampleMeasureBodyRetain( ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) );
                    if ( elem_len_items < 0 ) return false;
                    w.putleb( (uint64_t) elem_len_items );
                    if ( !SampleSaveBodyRetain( w, ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) ) ) return false;
                }
            }
        }
    }
...
template <typename Ctx>
inline bool RowSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Row & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !RowSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t SheetMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // rows: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        ...
        if ( cursor_rows.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_rows = 0; elem_i_rows < cursor_rows.count; elem_i_rows++ )
            {
                const int64_t elem_bytes_rows = RowMeasureBodyRetain( ctx, numbering, ids, cursor_rows[elem_i_rows], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_rows ) ) );
                if ( elem_bytes_rows < 0 ) { return -1; }
                body_rows += TableLebBytes( (uint64_t) ( elem_bytes_rows ) ) + ( elem_bytes_rows );
            }
            bytes += TableLebBytes( ref_rows ) + 1 + TableLebBytes( (uint64_t) ( body_rows ) ) + ( body_rows );
...
template <typename Ctx>
inline bool SheetSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableListCursor<Row> cursor_rows = TableListElements( ctx, value.rows ); // rows
        if ( !cursor_rows.ok ) { return false; }
        if ( cursor_rows.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const int64_t elem_len_rows = RowMeasureBodyRetain( ctx, numbering, ids, cursor_rows[elem_i_rows], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_rows ) ) );
                    if ( elem_len_rows < 0 ) return false;
                    w.putleb( (uint64_t) elem_len_rows );
                    if ( !RowSaveBodyRetain( ctx, numbering, w, ids, cursor_rows[elem_i_rows], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_rows ) ) ) ) return false;
                }
            }
        }
    }
...
template <typename Ctx>
inline bool SheetSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Sheet & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !SheetSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
    ...
    for ( ;; )
    {
        ...
        switch ( field_id )
        {
            ...
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                {
                    TableReader sub( r.buffer + r.offset, (int64_t) body_len, r.report, r.ids );
                    ItemLoadBodyRetain( sub, value.value, retain, TableRetainStepInto( path, 1, (uint32_t) ( 0 ) ) );
                    if ( sub.offset != sub.size )
                    {
                        r.report->malformed = true;
                        ItemReset( value.value );
...
template <typename Ctx>
inline int64_t SquadMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        ...
        if ( order_roster.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < order_roster.count; i++ )
            {
                const int64_t elem_roster = SquadRosterEntryMeasureBodyRetain( ids, *order_roster[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_roster < 0 ) { TableMapRelease( order_roster ); return -1; }
                body_roster += TableLebBytes( (uint64_t) ( elem_roster ) ) + ( elem_roster ); // BUT THE ENTRY ALWAYS RIDES: identity here is the key
            }
            bytes += TableLebBytes( ref_roster ) + 1 + TableLebBytes( (uint64_t) ( body_roster ) ) + ( body_roster );
...
template <typename Ctx>
inline bool SquadSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    {
        TableMapCursor<SquadRosterEntry> order_roster = TableMapOrder( ctx, value.roster ); // roster
        ...
        if ( order_roster.count > 0 ) // an EMPTY map elides, the by-value rule (§3)
        {
            ...
            for ( int32_t i = 0; i < order_roster.count; i++ )
            {
                const int64_t elem_len_roster = SquadRosterEntryMeasureBodyRetain( ids, *order_roster[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) );
                if ( elem_len_roster < 0 ) { TableMapRelease( order_roster ); return false; }
                w.putleb( (uint64_t) elem_len_roster );
                if ( !SquadRosterEntrySaveBodyRetain( w, ids, *order_roster[i], retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { TableMapRelease( order_roster ); return false; }
            }
        }
        TableMapRelease( order_roster );
    }
...
template <typename Ctx>
inline bool SquadSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Squad & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !SquadSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x1c84390d304f4f42ull: // roster
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    for ( uint64_t i = 0; i < count; i++ )
                    {
                        ...
                        {
                            TableReader elem( elem_body, (int64_t) elem_len, r.report, r.ids );
                            SquadRosterEntryLoadBodyRetain( elem, *slot, retain, TableRetainStepInto( path, 0, (uint32_t) ( fill.map->count - 1 ) ) );
                        }
                        last_key = read.key; // the WIRE keys of the entries that LAND
                        landed = true;
                    }
...
template <typename Ctx>
inline int64_t ArmyMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // squads: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        ...
        if ( cursor_squads.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_squads = 0; elem_i_squads < cursor_squads.count; elem_i_squads++ )
            {
                const int64_t elem_bytes_squads = SquadMeasureBodyRetain( ctx, numbering, ids, cursor_squads[elem_i_squads], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_squads ) ) );
                if ( elem_bytes_squads < 0 ) { return -1; }
                body_squads += TableLebBytes( (uint64_t) ( elem_bytes_squads ) ) + ( elem_bytes_squads );
            }
            bytes += TableLebBytes( ref_squads ) + 1 + TableLebBytes( (uint64_t) ( body_squads ) ) + ( body_squads );
...
template <typename Ctx>
inline bool ArmySaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path )
{
    {
        TableListCursor<Squad> cursor_squads = TableListElements( ctx, value.squads ); // squads
        if ( !cursor_squads.ok ) { return false; }
        if ( cursor_squads.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const int64_t elem_len_squads = SquadMeasureBodyRetain( ctx, numbering, ids, cursor_squads[elem_i_squads], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_squads ) ) );
                    if ( elem_len_squads < 0 ) return false;
                    w.putleb( (uint64_t) elem_len_squads );
                    if ( !SquadSaveBodyRetain( ctx, numbering, w, ids, cursor_squads[elem_i_squads], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_squads ) ) ) ) return false;
                }
            }
        }
    }
...
template <typename Ctx>
inline bool ArmySaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Army & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !ArmySaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
template <typename Ctx>
inline int64_t DeckMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path )
{
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    if ( value.hands_count < 0 || value.hands_count > 3 ) { return -1; } // storage invariant
    if ( value.hands_count > 0 )
    {
        ...
        for ( int32_t elem_i = 0; elem_i < value.hands_count; elem_i++ )
        {
            const int64_t elem_bytes = RowMeasureBodyRetain( ctx, numbering, ids, value.hands[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_hands += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_hands ) + 1 + TableLebBytes( (uint64_t) ( body_hands ) ) + ( body_hands ); // hands
...
template <typename Ctx>
inline bool DeckSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( value.hands_count < 0 || value.hands_count > 3 ) { return false; } // storage invariant
    if ( value.hands_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = RowMeasureBodyRetain( ctx, numbering, ids, value.hands[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !RowSaveBodyRetain( ctx, numbering, w, ids, value.hands[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( value.after != 0 )
...
template <typename Ctx>
inline bool DeckSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Deck & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !DeckSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
...
inline void RowNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// RowLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Row * RowLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                RowNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    RowLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// RowMeasureRetain and RowSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t RowMeasureWireRetain( const Ctx & ctx, const Row & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( RowNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = RowMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t RowSaveWireRetain( const Ctx & ctx, const Row & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = RowSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t RowMeasureRetain( const Row * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RowMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t RowSaveRetain( const Row * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RowSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// RowSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
inline void SheetNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    ...
    switch ( type_id )
    {
        case 0xa013e119fec906fbull: RowLoadBodyRetain( r, nodes, *(Row *) at, retain, TableRetainPathRoot( (const void *) at, node ) ); break; // Row
        default: break;
    }
    nodes.carve = NULL; // the cursor is ONE node's, and this node's body is done
}

// SheetLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Sheet * SheetLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                SheetNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    SheetLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// SheetMeasureRetain and SheetSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t SheetMeasureWireRetain( const Ctx & ctx, const Sheet & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    {
        ...
        switch ( type_id )
        {
            case 0xa013e119fec906fbull: return RowMeasureBodyRetain( c, nn, ii, *(const Row *) node, rt, at ); // Row
            default: break;
        }
        return -1;
    };
    if ( SheetNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = SheetMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t SheetSaveWireRetain( const Ctx & ctx, const Sheet & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    auto retain_save = []( const Ctx & c, const TableNumbering & nn, TableWriter & ww, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> bool
    {
        ...
        switch ( type_id )
        {
            case 0xa013e119fec906fbull: return RowSaveBodyRetain( c, nn, ww, ii, *(const Row *) node, rt, at ); // Row
            default: break;
        }
        return false;
    };
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = SheetSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t SheetMeasureRetain( const Sheet * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SheetMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t SheetSaveRetain( const Sheet * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SheetSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// SheetSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the FILE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t SheetSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Sheet: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the FILE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}
...
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void SquadNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// SquadLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Squad * SquadLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                SquadNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    SquadLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// SquadMeasureRetain and SquadSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t SquadMeasureWireRetain( const Ctx & ctx, const Squad & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( SquadNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = SquadMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t SquadSaveWireRetain( const Ctx & ctx, const Squad & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = SquadSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t SquadMeasureRetain( const Squad * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SquadMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t SquadSaveRetain( const Squad * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SquadSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// SquadSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the FILE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t SquadSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Squad: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the FILE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}

// ArmyNodeBodyRetain: PASS TWO's half, decoding one record's body into the storage it
// already owns.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void ArmyNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// ArmyLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Army * ArmyLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                ArmyNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    ArmyLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// ArmyMeasureRetain and ArmySaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t ArmyMeasureWireRetain( const Ctx & ctx, const Army & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( ArmyNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = ArmyMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t ArmySaveWireRetain( const Ctx & ctx, const Army & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = ArmySaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t ArmyMeasureRetain( const Army * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ArmyMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t ArmySaveRetain( const Army * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ArmySaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// ArmySaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the FILE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t ArmySaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Army: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the FILE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}

// DeckNodeBodyRetain: PASS TWO's half, decoding one record's body into the storage it
// already owns.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
// index is the region directory's, which Load fills from the wire's framing
// and nothing afterwards renumbers.
inline void DeckNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// DeckLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
// (docs/SPEC-TABLES.md §6.6). It is Load's own path and nothing else: the
// reader's data is exactly what it would have been with retention off.
inline const Deck * DeckLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                DeckNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    DeckLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// DeckMeasureRetain and DeckSaveRetain: the pair, with the retained tail in
// every body it belongs to (docs/SPEC-TABLES.md §6.6). They drop the same
// records under the same walk, so Measure's answer is the size the save
// writes even where a record could not be placed.
template <typename Ctx>
inline int64_t DeckMeasureWireRetain( const Ctx & ctx, const Deck & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( DeckNumberFrom( ctx, numbering, root ) )
    {
        TableRetainIds ids( retain );
        if ( retain != NULL ) { retain->id_used = 0; } // one walk fills the list, and the save's own walk refills it
        bytes = DeckMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
            const int64_t table = TableNodeTableMeasureRetain( ctx, ids, numbering, retain, retain_measure );
            bytes = table < 0 || ids.overflow ? -1 : 1 + bytes + table + TableRetainIdsBytes( ids );
...
template <typename Ctx>
inline int64_t DeckSaveWireRetain( const Ctx & ctx, const Deck & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, TableDefaultAllocator() );
    auto retain_measure = []( const Ctx & c, const TableNumbering & nn, TableRetainIds & ii, uint64_t type_id, const void * node, TableRetain * rt ) -> int64_t
    ...
    // field: a retained field is one of the root's own values, and the tail
    // is pinned before the large and damage-prone part (§6.6, §3.1)
    bool ok = DeckSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
              TableNodeTableSaveRetain( ctx, w, ids, numbering, retain, retain_measure, retain_save );
    TableNumberingShutdown( numbering );
    if ( !ok || ids.overflow ) { return -1; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the root body
...
inline int64_t DeckMeasureRetain( const Deck * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DeckMeasureWireRetain( ctx, *root, retain, allocator );
}
...
// else. A surface that let a caller retain, save and never find out would
// be a promise it could not check.
inline int64_t DeckSaveRetain( const Deck * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DeckSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// DeckSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
// (docs/SPEC-TABLES.md §3.3). It is a MISUSE refusal on §6.6's own
// precedent and never a silent drop, and the two answers are named: a
// caller that must carry unknowns across a rewrite writes the FILE form,
// which carries its own table and takes §6.6 unchanged, and a RELAY
// forwards the sending peer's announcement and its batch bytes verbatim.
template <typename... Args>
inline int64_t DeckSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Deck: a form 2 writer names entries through slots of a vocabulary the compiler settled, and a retained id is one this build's closure does not contain, so it has neither a slot nor an announced shape. Retention writing the MESSAGE form is refused by name (docs/SPEC-TABLES.md §3.3). Write the FILE form, which carries its own table and takes §6.6 unchanged, or relay the sender's announcement and batch bytes verbatim." );
    return -1;
}
...
template <typename... Args>
inline void SampleSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Sample is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ItemLoadRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Item is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}

template <typename... Args>
inline void ItemMeasureRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Item is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void ItemSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Item is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
// SampleOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// Sample IS FIXED-SIZE, so its cook is ONE REGION OF ONE NODE and not a second
...
// parameter on a load.
inline const Sample * SampleOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Sample *) TableCookOpen( bytes, length, (uint64_t) sizeof( Sample ), (uint64_t) alignof( Sample ), reason );
}
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH RowAt: the slot holds
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Row * RowOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Row *) TableCookOpen( bytes, length, (uint64_t) sizeof( Row ), (uint64_t) alignof( Row ), reason );
}

// SheetOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH SheetAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Sheet * SheetOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Sheet *) TableCookOpen( bytes, length, (uint64_t) sizeof( Sheet ), (uint64_t) alignof( Sheet ), reason );
}
...
// ArmyOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH ArmyAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Army * ArmyOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Army *) TableCookOpen( bytes, length, (uint64_t) sizeof( Army ), (uint64_t) alignof( Army ), reason );
}

// DeckOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH DeckAt: the slot holds
// the signed self-relative byte delta of §6.3, so a deref is one add and
// needs no base pointer, a whole region relocates by plain memcpy, and a
// delta of zero is null.
//
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Deck * DeckOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Deck *) TableCookOpen( bytes, length, (uint64_t) sizeof( Deck ), (uint64_t) alignof( Deck ), reason );
}
...
inline void SampleCookBody( uint8_t * at, const Sample & value, TableByteOrder order );
...
template <typename Ctx> inline bool SheetCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Sheet & value, TableByteOrder order );
...
template <typename Ctx> inline bool ArmyCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Army & value, TableByteOrder order );
template <typename Ctx> inline bool DeckCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Deck & value, TableByteOrder order );
...
template <typename Ctx> inline bool RowCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Row & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 16, (uint64_t) value.label, 4, order );
    return true;
}

template <typename Ctx> inline bool SheetCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Sheet & value, TableByteOrder order )
{
    table_cook_put( at + 0, 0, 8, order ); // rows: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
    if ( !table_cook_ref( region, at + 16, (const void *) RowAt( ctx, value.pinned ), order ) ) { return false; } // pinned
    return true;
}
...
template <typename Ctx> inline bool SquadCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Squad & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 8, 0, 4, order ); // and its count
    table_cook_put( at + 16, (uint64_t) value.name, 4, order );
    return true;
}
...
{
    (void) ctx; (void) region; // no reference resolves in this body: a list's and a map's slots are the extent writer's, and the class was decided elsewhere in the closure
    table_cook_put( at + 0, 0, 8, order ); // squads: the array's delta, filled by the extent writer
    table_cook_put( at + 8, 0, 4, order ); // and its count
...
template <typename Ctx> inline bool DeckCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Deck & value, TableByteOrder order )
{
    ...
    {
        if ( !RowCookBody( ctx, region, at + 0 + i * 24, value.hands[ i ], order ) ) { return false; }
    }
    table_cook_put( at + 72, (uint64_t) (uint32_t) value.hands_count, 4, order );
    table_cook_put( at + 76, (uint64_t) value.after, 4, order );
    return true;
}

template <typename Ctx> inline bool SampleCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Sample & value, TableByteOrder order );
...
template <typename Ctx> inline bool SheetCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Sheet & value, TableByteOrder order );
...
template <typename Ctx> inline bool ArmyCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Army & value, TableByteOrder order );
...
// SampleCookExtent: Sample's arrays into the node's extent, PRE-ORDER, a map's entries
...
template <typename Ctx> inline bool RowCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Row & value, TableByteOrder order )
{
    ...
    { // items: an unbounded array
        ...
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            SampleCookBody( array + i * 4, cursor[i], order );
        }
    }
    return true;
}

// SheetCookExtent: Sheet's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool SheetCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Sheet & value, TableByteOrder order )
{
    (void) region; // a table element's and an entry's references resolve through their own bodies
    { // rows: an unbounded array
        TableListCursor<Row> cursor = TableListElements( ctx, value.rows );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( Row )
        uint8_t * array = extent + at;
        ...
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            if ( !RowCookBody( ctx, region, array + i * 24, cursor[i], order ) ) { return false; }
        }
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, element by element in index order
        {
            if ( !RowCookExtent( ctx, region, extent, at, array + i * 24, cursor[i], order ) ) { return false; }
        }
    }
    return true;
}
...
// ArmyCookExtent: Army's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool ArmyCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Army & value, TableByteOrder order )
{
    (void) region; // a table element's and an entry's references resolve through their own bodies
    { // squads: an unbounded array
        TableListCursor<Squad> cursor = TableListElements( ctx, value.squads );
        if ( !cursor.ok ) { return false; }
        at = ( at + 7 ) & ~(int64_t) 7; // at alignof( Squad )
        uint8_t * array = extent + at;
        ...
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            if ( !SquadCookBody( ctx, region, array + i * 24, cursor[i], order ) ) { return false; }
        }
        for ( int32_t i = 0; i < cursor.count; i++ ) // then, element by element in index order
        {
            if ( !SquadCookExtent( ctx, region, extent, at, array + i * 24, cursor[i], order ) ) { return false; }
        }
    }
    return true;
}

// DeckCookExtent: Deck's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool DeckCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Deck & value, TableByteOrder order )
{
...
// SampleCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool SampleCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Sample & value, TableByteOrder order )
{
    SampleCookBody( at, value, order );
    int64_t extent_at = 0;
    return SampleCookExtent( ctx, region, at + 8, extent_at, at, value, order );
}
...
template <typename Ctx> inline bool SheetCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Sheet & value, TableByteOrder order )
{
...
template <typename Ctx> inline bool ArmyCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Army & value, TableByteOrder order )
{
...
template <typename Ctx> inline bool DeckCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Deck & value, TableByteOrder order )
{
...
//
// Sample IS FIXED-SIZE, so the answer does not depend on the value: its cook is
...
inline int64_t SampleCookMeasure( const Sample & value )
{
    (void) value;
    return 88; // 64 header + 8 data + 16 attribution
}

// SampleCook: write one cooked file for the build this code is compiled into,
...
// the same contract SampleMeasure/SampleSave has on the wire (§6.1).
//
...
inline bool SampleCook( const Sample & value, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( out == NULL ) { return false; }
    const uint64_t need = (uint64_t) SampleCookMeasure( value );
    ...
    SampleCookBody( raw + 64, value, order );
    ...
    table_cook_put( raw + 80, 0xdc40d61254c70aa7ull, 8, order );
    return true;
}
...
// RowCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t RowCookMeasureFrom( const Ctx & ctx, const Row & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( RowNumberFrom( ctx, numbering, root ) && RowCookLayout( ctx, root, numbering, region ) )
    {
...
// RowCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool RowCookFrom( const Ctx & ctx, const Row & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = RowCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0xa013e119fec906fbull, 8, order ); // the root: fnv1a64( "Row" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// RowCookMeasure / RowCook over a REGION root — a locked builder's AsConst, a
// region RowLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t RowCookMeasure( const Row * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return RowCookMeasureFrom( ctx, *root, allocator );
}

inline bool RowCook( const Row * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return RowCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t RowCookMeasure( const RowBuilder & builder )
{
    if ( builder.region != NULL ) { return RowCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RowCookMeasureFrom( ctx, *(const Row *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool RowCook( const RowBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return RowCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return RowCookFrom( ctx, *(const Row *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}

// SheetCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
...
// the numbering walked and reads the same arrays that walk read.
template <typename Ctx>
inline bool SheetCookLayout( const Ctx & ctx, const Sheet & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = SheetExtent( ctx, root );
    if ( root_extent < 0 ) { return false; }
    int64_t offset = 24 + root_extent; // the root at zero, its extent behind it
    int64_t align = 8;
    if ( region.offsets != NULL ) { region.offsets[0] = 0; }
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
        ...
        switch ( numbering.entries[k].type_id )
        {
            case 0xa013e119fec906fbull: // Row
                {
                    const int64_t extent = RowExtent( ctx, *(const Row *) numbering.entries[k].node );
                    if ( extent < 0 ) { return false; }
                    size = 24 + extent; node_align = 8;
                }
                break;
            default: return false;
        }
...
// SheetCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t SheetCookMeasureFrom( const Ctx & ctx, const Sheet & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( SheetNumberFrom( ctx, numbering, root ) && SheetCookLayout( ctx, root, numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// SheetCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool SheetCookFrom( const Ctx & ctx, const Sheet & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = SheetCookNode( ctx, region, region.base, root, order );
            for ( int64_t k = 0; ok && k < numbering.count; k++ )
            {
                ...
                switch ( numbering.entries[k].type_id )
                {
                    case 0xa013e119fec906fbull: ok = RowCookNode( ctx, region, at, *(const Row *) node, order ); break; // Row
            ...
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0x0cc9e0af9a85fbc8ull, 8, order ); // the root: fnv1a64( "Sheet" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// SheetCookMeasure / SheetCook over a REGION root — a locked builder's AsConst, a
// region SheetLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t SheetCookMeasure( const Sheet * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return SheetCookMeasureFrom( ctx, *root, allocator );
}

inline bool SheetCook( const Sheet * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return SheetCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t SheetCookMeasure( const SheetBuilder & builder )
{
    if ( builder.region != NULL ) { return SheetCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SheetCookMeasureFrom( ctx, *(const Sheet *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool SheetCook( const SheetBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return SheetCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return SheetCookFrom( ctx, *(const Sheet *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
// ArmyCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
...
// the numbering walked and reads the same arrays that walk read.
template <typename Ctx>
inline bool ArmyCookLayout( const Ctx & ctx, const Army & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = ArmyExtent( ctx, root );
    if ( root_extent < 0 ) { return false; }
    int64_t offset = 24 + root_extent; // the root at zero, its extent behind it
    int64_t align = 8;
    if ( region.offsets != NULL ) { region.offsets[0] = 0; }
...
// ArmyCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t ArmyCookMeasureFrom( const Ctx & ctx, const Army & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( ArmyNumberFrom( ctx, numbering, root ) && ArmyCookLayout( ctx, root, numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// ArmyCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool ArmyCookFrom( const Ctx & ctx, const Army & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = ArmyCookNode( ctx, region, region.base, root, order );
            // the ATTRIBUTION part: the node directory (§6.3), one entry per node
            // in index order, for `schema cook-check`
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0x06e2378b553a9e84ull, 8, order ); // the root: fnv1a64( "Army" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// ArmyCookMeasure / ArmyCook over a REGION root — a locked builder's AsConst, a
// region ArmyLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t ArmyCookMeasure( const Army * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return ArmyCookMeasureFrom( ctx, *root, allocator );
}

inline bool ArmyCook( const Army * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return ArmyCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t ArmyCookMeasure( const ArmyBuilder & builder )
{
    if ( builder.region != NULL ) { return ArmyCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ArmyCookMeasureFrom( ctx, *(const Army *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool ArmyCook( const ArmyBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return ArmyCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return ArmyCookFrom( ctx, *(const Army *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}

// DeckCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
// numbering — the root at zero, then every node in index order at
// align_up( offset, alignof ) for its OWN type, no slack between them, the
// data length rounded to the greatest alignment among them and never below
// eight. The offsets go into the region's table when it has one, and are only
...
// the numbering walked and reads the same arrays that walk read.
template <typename Ctx>
inline bool DeckCookLayout( const Ctx & ctx, const Deck & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = DeckExtent( ctx, root );
    if ( root_extent < 0 ) { return false; }
    int64_t offset = 80 + root_extent; // the root at zero, its extent behind it
    int64_t align = 8;
    if ( region.offsets != NULL ) { region.offsets[0] = 0; }
    for ( int64_t k = 0; k < numbering.count; k++ )
    {
...
// DeckCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
// the data part and the attribution part (§7.1). IT DEPENDS ON THE VALUE,
// because the answer is the numbering: the depth-first walk of §3.1 is run
// here and run again by the write, and neither carries the other's (§7.6). A
// data cycle is refused by the walk and answers -1.
template <typename Ctx>
inline int64_t DeckCookMeasureFrom( const Ctx & ctx, const Deck & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( DeckNumberFrom( ctx, numbering, root ) && DeckCookLayout( ctx, root, numbering, region ) )
    {
        const int64_t data_offset = ( kTableCookHeaderBytes + region.align - 1 ) & ~( region.align - 1 );
        bytes = data_offset + region.bytes + region.count * (int64_t) sizeof( TableNodeDirEntry );
    }
...
// DeckCookFrom: write one cooked file of a pointered graph, in the byte order
// the caller names. The bytes are `schema cook`'s, byte for byte (§7.6).
//
// THE CALLER OWNS THE OUTPUT and nothing is allocated toward it. What is
// allocated is the numbering — the identity map, the entry array and one
...
// mistake them for a cook.
template <typename Ctx>
inline bool DeckCookFrom( const Ctx & ctx, const Deck & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            // the DATA part: the root at the region's base, then every numbered
            // node at the offset the layout gave it, each through its own writer
            ok = DeckCookNode( ctx, region, region.base, root, order );
            // the ATTRIBUTION part: the node directory (§6.3), one entry per node
            // in index order, for `schema cook-check`
            uint8_t * entry = raw + data_offset + region.bytes;
            table_cook_put( entry, 0, 8, order );
            table_cook_put( entry + 8, 0xd043187343bfcfe8ull, 8, order ); // the root: fnv1a64( "Deck" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
                entry += sizeof( TableNodeDirEntry );
                table_cook_put( entry, (uint64_t) region.offsets[k + 1], 8, order );
...
// DeckCookMeasure / DeckCook over a REGION root — a locked builder's AsConst, a
// region DeckLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t DeckCookMeasure( const Deck * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return DeckCookMeasureFrom( ctx, *root, allocator );
}

inline bool DeckCook( const Deck * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return DeckCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t DeckCookMeasure( const DeckBuilder & builder )
{
    if ( builder.region != NULL ) { return DeckCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DeckCookMeasureFrom( ctx, *(const Deck *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool DeckCook( const DeckBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return DeckCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return DeckCookFrom( ctx, *(const Deck *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( Sample ), "Sample must stay relocatable" );
static_assert( __is_standard_layout( Sample ), "Sample must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Row ), "Row must stay relocatable" );
static_assert( __is_standard_layout( Row ), "Row must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Sheet ), "Sheet must stay relocatable" );
static_assert( __is_standard_layout( Sheet ), "Sheet must stay standard-layout for offsetof" );
...
static_assert( __is_trivially_copyable( Army ), "Army must stay relocatable" );
static_assert( __is_standard_layout( Army ), "Army must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Deck ), "Deck must stay relocatable" );
static_assert( __is_standard_layout( Deck ), "Deck must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( Sample ) == 4, "Sample's sizeof moved: the build version was taken over 4, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Sample ) == 4, "Sample's alignof moved: the build version was taken over 4 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Sample, v ) == 0, "Sample's field v moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Row ) == 24, "Row's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Row ) == 8, "Row's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Row, items ) == 0, "Row's field items moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Row, label ) == 16, "Row's field label moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Sheet ) == 24, "Sheet's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Sheet ) == 8, "Sheet's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Sheet, rows ) == 0, "Sheet's field rows moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Sheet, pinned ) == 16, "Sheet's field pinned moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );
...
static_assert( sizeof( Squad ) == 24, "Squad's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
...
static_assert( offsetof( Squad, name ) == 16, "Squad's field name moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Army ) == 24, "Army's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Army ) == 8, "Army's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Army, squads ) == 0, "Army's field squads moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Army, after ) == 16, "Army's field after moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Deck ) == 80, "Deck's sizeof moved: the build version was taken over 80, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Deck ) == 8, "Deck's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Deck, hands ) == 0, "Deck's field hands moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Deck, after ) == 76, "Deck's field after moved: the build version was taken over offset 76 (docs/SPEC-TABLES.md §20.3)" );

static_assert( alignof( Sample ) <= kTableAlign, "Row.items: an unbounded array's element alignment must fit the arena's" );
static_assert( alignof( Row ) <= kTableAlign, "Sheet.rows: an unbounded array's element alignment must fit the arena's" );
static_assert( alignof( Squad ) <= kTableAlign, "Army.squads: an unbounded array's element alignment must fit the arena's" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * SampleTableType();
inline const TableTypeInfo * RowTableType();
inline const TableTypeInfo * SheetTableType();
...
inline const TableTypeInfo * ArmyTableType();
...
extern const TableTypeInfo SampleTableInfo;
extern const TableTypeInfo RowTableInfo;
extern const TableTypeInfo SheetTableInfo;
...
extern const TableTypeInfo ArmyTableInfo;
extern const TableTypeInfo DeckTableInfo;

inline const TableFieldInfo SampleTableFields[] = {
    { "v", "v", "int32", 0xaf63eb4c86020609ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Sample, v ), (uint32_t) sizeof( Sample::v ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo SampleTableInfo = { "Sample", (uint32_t) sizeof( Sample ), 1, SampleTableFields, +[]( void * p ) { SampleReset( *(Sample *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * SampleTableType() { return &SampleTableInfo; }

inline const TableFieldInfo RowTableFields[] = {
    { "items", "items", "Sample", 0x3e7884bf4f412c6full, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Row, items ), (uint32_t) sizeof( Sample ), (uint32_t) offsetof( Row, items.count ), 0xffffffffu, &SampleTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Sample> *) slot ); }, "", TableDocNone, 0, NULL },
    { "label", "label", "int32", 0x39f7fcec8fcb623dull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Row, label ), (uint32_t) sizeof( Row::label ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
...
inline const TableFieldInfo SheetTableFields[] = {
    { "rows", "rows", "Row", 0xa3a7061ff10a8138ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Sheet, rows ), (uint32_t) sizeof( Row ), (uint32_t) offsetof( Sheet, rows.count ), 0xffffffffu, &RowTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Row> *) slot ); }, "", TableDocNone, 0, NULL },
    { "pinned", "pinned", "Row", 0x5f82477707ad620full, 17, false, true, []( const void * slot ) -> const void * { return (const void *) RowAt( *(const TableRef *) slot ); }, []( TableWorker & worker, void * slot ) -> void * { return (void *) RowEmplace( worker, *(TableRef *) slot ); }, false, false, 0, (uint32_t) offsetof( Sheet, pinned ), (uint32_t) sizeof( TableRef ), 0xffffffffu, 0xffffffffu, &RowTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo SheetTableInfo = { "Sheet", (uint32_t) sizeof( Sheet ), 2, SheetTableFields, +[]( void * p ) { SheetReset( *(Sheet *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * SheetTableType() { return &SheetTableInfo; }
...
inline const TableFieldInfo SquadTableFields[] = {
    { "roster", "roster", "map[uint8]Item", 0x1c84390d304f4f42ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Squad, roster ), (uint32_t) sizeof( SquadRosterEntry ), (uint32_t) offsetof( Squad, roster.count ), 0xffffffffu, &SquadRosterEntryTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t key_value ) -> void * { return (void *) TableMapPlace( worker, *(TableMap<SquadRosterEntry> *) slot, (uint8_t) key_value ); }, "", TableDocNone, 0, NULL },
    { "name", "name", "int32", 0xc4bcadba8e631b86ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Squad, name ), (uint32_t) sizeof( Squad::name ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo SquadTableInfo = { "Squad", (uint32_t) sizeof( Squad ), 2, SquadTableFields, +[]( void * p ) { SquadReset( *(Squad *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * SquadTableType() { return &SquadTableInfo; }

inline const TableFieldInfo ArmyTableFields[] = {
    { "squads", "squads", "Squad", 0x7848019b0c02a926ull, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Army, squads ), (uint32_t) sizeof( Squad ), (uint32_t) offsetof( Army, squads.count ), 0xffffffffu, &SquadTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Squad> *) slot ); }, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Army, after ), (uint32_t) sizeof( Army::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo ArmyTableInfo = { "Army", (uint32_t) sizeof( Army ), 2, ArmyTableFields, +[]( void * p ) { ArmyReset( *(Army *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * ArmyTableType() { return &ArmyTableInfo; }

inline const TableFieldInfo DeckTableFields[] = {
    { "hands", "hands", "Row", 0x81b46a69304ee2c9ull, 13, true, false, NULL, NULL, true, false, 3, (uint32_t) offsetof( Deck, hands ), (uint32_t) sizeof( Deck::hands[0] ), (uint32_t) offsetof( Deck, hands_count ), 0xffffffffu, &RowTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "after", "after", "int32", 0xbf82010f6f71eae9ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Deck, after ), (uint32_t) sizeof( Deck::after ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo DeckTableInfo = { "Deck", (uint32_t) sizeof( Deck ), 2, DeckTableFields, +[]( void * p ) { DeckReset( *(Deck *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * DeckTableType() { return &DeckTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Sample in and out of a JSON text — one instance, one text, the generic
// walk over this type's descriptors (docs/SPEC-TABLES.md §16). Defined in
// HoldersTable.cpp; link it to use them.
bool SampleFromJson( Sample & value, const char * text, int64_t bytes, TableReport * report );
int64_t SampleToJsonMeasure( const Sample & value );
int64_t SampleToJson( const Sample & value, char * buffer, int64_t capacity );
...
// carries `&node` in the text. Defined in HoldersTable.cpp; link it to use them.
bool RowFromJson( RowBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t RowToJsonMeasure( const Row * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t RowToJson( const Row * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );

// Sheet in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in HoldersTable.cpp; link it to use them.
bool SheetFromJson( SheetBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t SheetToJsonMeasure( const Sheet * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t SheetToJson( const Sheet * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
...
// Army in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in HoldersTable.cpp; link it to use them.
bool ArmyFromJson( ArmyBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t ArmyToJsonMeasure( const Army * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t ArmyToJson( const Army * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );

// Deck in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in HoldersTable.cpp; link it to use them.
bool DeckFromJson( DeckBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t DeckToJsonMeasure( const Deck * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t DeckToJson( const Deck * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
