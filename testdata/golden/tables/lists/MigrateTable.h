// Code generated by the schema compiler from Migrate.schema. DO NOT EDIT.
...
// table Unit — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Unit {
    int32_t v = 0;
};

// table Bounded — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Bounded {
    Unit items[8]; // used count beside it; count in [0, 8]
    int32_t items_count = 0;
    int32_t tag = 0;
};

// table Unbounded — TABLE-wire storage: relocatable, bounded, defaults in the
// member initializers (docs/SPEC-TABLES.md)
struct Unbounded {
    TableList<Unit> items; // Unit: the element array, empty until an Add
    int32_t tag = 0;
};

// ---- prefill: the declared defaults, in place (docs/SPEC-TABLES.md) ----

inline void UnitReset( Unit & value );
inline void BoundedReset( Bounded & value );
inline void UnboundedReset( Unbounded & value );
...
inline void BoundedReset( Bounded & value )
{
    UnitReset( value.items[0] );
    for ( int32_t i = 1; i < 8; i++ ) { value.items[i] = value.items[0]; }
    value.items_count = 0;
    value.tag = 0;
}
...
inline void UnboundedReset( Unbounded & value )
{
    value.items.elements.value = 0; // Unit: empty
    value.items.count = 0;
    value.items.padding = 0;
    value.tag = 0;
}

inline int64_t UnitMeasureMessageBody( int64_t at, const Unit & value );
inline bool UnitSaveMessageBody( TableBitWriter & w, const Unit & value );
inline bool UnitLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Unit & value );
inline int64_t BoundedMeasureMessageBody( int64_t at, const Bounded & value );
inline bool BoundedSaveMessageBody( TableBitWriter & w, const Bounded & value );
inline bool BoundedLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Bounded & value );
template <typename Ctx> inline int64_t UnboundedMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Unbounded & value );
template <typename Ctx> inline bool UnboundedSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Unbounded & value );
inline bool UnboundedLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Unbounded & value );
inline bool UnboundedMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at );
...
inline void TableReset( Unit & value ) { UnitReset( value ); }
inline void TableReset( Bounded & value ) { BoundedReset( value ); }
inline void TableReset( Unbounded & value ) { UnboundedReset( value ); }
...
LISTDEMO_TABLE_INLINE bool UnitLoadBody( TableReader & r, Unit & value );
...
LISTDEMO_TABLE_INLINE bool BoundedLoadBody( TableReader & r, Bounded & value );
template <typename Ctx> inline int64_t UnboundedMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Unbounded & value );
template <typename Ctx> inline bool UnboundedSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Unbounded & value );
template <typename Ctx> inline bool UnboundedSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Unbounded & value );
...
template <typename Ctx> inline bool UnboundedNumber( const Ctx & ctx, TableNumbering & numbering, const Unbounded & value );
template <typename Ctx> inline int64_t UnboundedPackMeasure( const Ctx & ctx, TablePackMap & seen, const Unbounded & value );
template <typename Ctx> inline bool UnboundedPack( const Ctx & ctx, TablePackMap & seen, const Unbounded & src, Unbounded & dst, uint8_t * base, int64_t capacity, int64_t & used );

// ---- the numbering's bridge to each member's codec (docs/SPEC-TABLES.md §3.1) ----

template <typename Ctx> inline int64_t TableNodeMeasure( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Unbounded & value ) { return UnboundedMeasureBody( ctx, numbering, ids, value ); }
template <typename Ctx> inline bool TableNodeSave( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Unbounded & value ) { return UnboundedSaveBody( ctx, numbering, w, ids, value ); }
template <typename Ctx> inline int64_t TableNodeMessageMeasure( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Unbounded & value ) { return UnboundedMeasureMessageBody( ctx, numbering, index_bits, at, value ); }
template <typename Ctx> inline bool TableNodeMessageSave( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Unbounded & value ) { return UnboundedSaveMessageBody( ctx, numbering, index_bits, w, value ); }
...
LISTDEMO_TABLE_INLINE bool UnitLoadBodyRetain( TableReader & r, Unit & value, TableRetain * retain, const TableRetainPath & path );
inline bool UnitLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Unit & value, TableRetain * retain, const TableRetainPath & path );
...
LISTDEMO_TABLE_INLINE bool BoundedLoadBodyRetain( TableReader & r, Bounded & value, TableRetain * retain, const TableRetainPath & path );
inline bool BoundedLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, Bounded & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline int64_t UnboundedMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool UnboundedSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path );
template <typename Ctx> inline bool UnboundedSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path );
...
inline bool UnboundedLoadMessageBodyRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, Unbounded & value, TableRetain * retain, const TableRetainPath & path );
...
inline int64_t UnitMeasure( const Unit & value )
{
    TableIds ids;
    const int64_t body = UnitMeasureBody( ids, value );
...
inline int64_t UnitSave( const Unit & value, uint8_t * buffer, int64_t capacity )
{
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    if ( !UnitSaveBody( w, ids, value ) || ids.overflow ) { return -1; }
    TableIdsWrite( w, ids ); // the ID TABLE is the last thing in the file
    if ( w.overflow ) { return -1; }
    return w.offset; // == UnitMeasure( value )
}

LISTDEMO_TABLE_INLINE bool UnitLoadBody( TableReader & r, Unit & value )
{
    UnitReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
...
inline TableOpenVerdict UnitLoadVerdict( Unit & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    TableIdTable table;
    ...
    if ( !UnitLoadBody( r, value ) ) { return TableOpenBodyStopped; }
    return TableOpenOk;
}
...
inline bool UnitLoad( Unit & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    return UnitLoadVerdict( value, buffer, bytes, report ) == TableOpenOk;
}
...
inline int64_t UnitMeasureMessages( const Unit * values, int64_t count, TableReport * report )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = UnitMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
...
inline int64_t UnitSaveMessages( const Unit * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !UnitSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == UnitMeasureMessages( values, count, report )
}
...
inline bool UnitLoadMessages( Unit * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    ...
    *count = 0;
    ...
    {
        if ( !UnitLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
...
inline int64_t BoundedMeasure( const Bounded & value )
{
    TableIds ids;
    const int64_t body = BoundedMeasureBody( ids, value );
    if ( body < 0 || ids.overflow ) { return -1; }
    return 1 + body + TableIdsBytes( ids );
}
...
LISTDEMO_TABLE_INLINE bool BoundedSaveBody( TableWriter & w, TableIds & ids, const Bounded & value )
{
    ...
    if ( value.items_count > 0 )
    {
        ...
        w.put8( 13 ); w.putleb( (uint64_t) ( value.items_count ) );
        for ( int32_t elem_i = 0; elem_i < value.items_count; elem_i++ )
        {
            {
...
inline int64_t BoundedSave( const Bounded & value, uint8_t * buffer, int64_t capacity )
{
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    if ( !BoundedSaveBody( w, ids, value ) || ids.overflow ) { return -1; }
    TableIdsWrite( w, ids ); // the ID TABLE is the last thing in the file
    if ( w.overflow ) { return -1; }
    return w.offset; // == BoundedMeasure( value )
}

LISTDEMO_TABLE_INLINE bool BoundedLoadBody( TableReader & r, Bounded & value )
{
    BoundedReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
        uint64_t field_ref = 0;
        if ( !r.getleb( field_ref ) ) { r.report->malformed = true; return false; }
...
// A refusal moves none of the report's five counters, because nothing was
// decoded and there is nothing to count (docs/SPEC-TABLES.md §3).
inline TableOpenVerdict BoundedLoadVerdict( Bounded & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    TableIdTable table;
    ...
    TableReader r( buffer + 1, body_bytes, to, &table );
    r.nested = false; // the ROOT body, the one that may carry a node table
    if ( !BoundedLoadBody( r, value ) ) { return TableOpenBodyStopped; }
    return TableOpenOk;
}
...
// False is a wire nothing could be decoded from: a refusal, a table that
// cannot be read whole, or a root body the walk could not finish.
inline bool BoundedLoad( Bounded & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    return BoundedLoadVerdict( value, buffer, bytes, report ) == TableOpenOk;
}
...
inline int64_t BoundedMeasureMessageBody( int64_t at, const Bounded & value )
{
    ...
    if ( value.items_count > 0 )
    {
        ...
        {
            const int64_t elem = UnitMeasureMessageBody( at + bits, value.items[i] );
            if ( elem < 0 ) { return -1; }
            bits += elem;
        }
    }
...
inline bool BoundedSaveMessageBody( TableBitWriter & w, const Bounded & value )
{
    ...
    if ( value.items_count > 0 )
    {
        ...
        w.put( (uint64_t) ( value.items_count ) - 0, 4 );
        for ( int32_t i = 0; i < value.items_count; i++ )
        {
            if ( !UnitSaveMessageBody( w, value.items[i] ) ) { return false; }
        }
    }
    if ( value.tag != 0 )
    {
        w.put( 6, kTableMessageRefBitsHere );
        w.put( (uint64_t) ( value.tag ), 32 );
    }
    w.put( 0, kTableMessageRefBitsHere ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        Unit scratch;
                        UnitReset( scratch );
                        if ( !UnitLoadMessageBody( r, vocabulary, report, index_bits, ( in_bounds ? value.items[i] : scratch ) ) ) { return false; }
                    }
                    value.items_count = kept;
                }
                break;
            }
            case 0x56d7ab194448a4f3ull: // tag
...
// refusal is learned at MEASURE time, before a buffer is allocated, and a
// caller with more bodies calls again.
inline int64_t BoundedMeasureMessages( const Bounded * values, int64_t count, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    int64_t bits = 8; // the body count, a ranged integer over [1, 256]
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = BoundedMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8; // the form byte, then the stream padded to a byte
...
inline int64_t BoundedSaveMessages( const Bounded * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !BoundedSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == BoundedMeasureMessages( values, count, report )
}
...
// BODIES 1 TO k - 1: count says k - 1, one malformed counts, and the storage
// after it is not a body.
inline bool BoundedLoadMessages( Bounded * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    if ( values == NULL || count == NULL ) { to->malformed = true; return false; }
    ...
    *count = 0;
    ...
    for ( int64_t i = 0; i < bodies; i++ )
    {
        if ( !BoundedLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
template <typename Ctx>
inline int64_t UnboundedMeasureBody( const Ctx & ctx, const TableNumbering & numbering, TableIds & ids, const Unbounded & value )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        // items: a kind 14 array of kind 13 elements, INDEX order (§2.9)
        TableListCursor<Unit> cursor_items = TableListElements( ctx, value.items );
...
template <typename Ctx>
inline bool UnboundedSaveBodyFields( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Unbounded & value )
{
    (void) ctx; (void) numbering;
    {
        TableListCursor<Unit> cursor_items = TableListElements( ctx, value.items ); // items
...
template <typename Ctx>
inline bool UnboundedSaveBody( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableIds & ids, const Unbounded & value )
{
    if ( !UnboundedSaveBodyFields( ctx, numbering, w, ids, value ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                if ( body_len >= 2 )
                {
                    ...
                    else
                    {
                        ...
                        {
                            Unit * slot = TableListFillNext( fill );
...
// its bytes and an align costs what the position says it costs.
template <typename Ctx>
inline int64_t UnboundedMeasureMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, int64_t at, const Unbounded & value )
{
    ...
    int64_t bits = 0;
    {
        ...
        if ( cursor_items.count > 0 )
        {
            ...
            {
                const int64_t elem = UnitMeasureMessageBody( at + bits, cursor_items[i] );
                if ( elem < 0 ) { return -1; }
                bits += elem;
            }
        }
...
// body is self-delimiting: it is written where the VARIABLE form put an L.
template <typename Ctx>
inline bool UnboundedSaveMessageBody( const Ctx & ctx, const TableNumbering & numbering, int64_t index_bits, TableBitWriter & w, const Unbounded & value )
{
    (void) ctx; (void) numbering; (void) index_bits;
    {
        TableListCursor<Unit> cursor_items = TableListElements( ctx, value.items ); // items
        ...
        if ( cursor_items.count > 0 )
        {
            ...
            for ( int32_t i = 0; i < cursor_items.count; i++ )
            {
                if ( !UnitSaveMessageBody( w, cursor_items[i] ) ) { return false; }
            }
        }
    }
    if ( value.tag != 0 )
...
// UnboundedMessageExtent: the extent Unbounded's maps command on the message wire, from
...
inline bool UnboundedMessageExtent( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & at )
{
    for ( ;; )
    {
        ...
        if ( entry.id == 0x3e7884bf4f412c6full && entry.kind == 14 && entry.elem_kind == 13 ) // items: an unbounded array
        {
            ...
            at = ( at + 3 ) & ~(int64_t) 3; // at alignof( Unit )
            at += (int64_t) n * (int64_t) sizeof( Unit ); // the whole array FIRST
            const int64_t run = TableMessageElementRunBits( vocabulary, entry );
        ...
        switch ( entry.id )
        {
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                }
                {
                    ...
                    n += (uint64_t) entry.min;
                    TableListFill<Unit> fill = TableListFillBegin( nodes, value.items, n );
                    if ( fill.refused ) { nodes.refused = true; return false; }
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        ...
                        if ( !UnitLoadMessageBody( r, vocabulary, report, index_bits, ( *slot ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
static_assert( sizeof( Unit ) == 4, "Unit: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( Unit, v ) == 0, "Unit.v: the fixed form's plan lands here" );
static_assert( sizeof( Bounded ) == 40, "Bounded: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( Bounded, items ) == 0, "Bounded.items: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( Bounded, items_count ) == 32, "Bounded.items_count: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( Bounded, tag ) == 36, "Bounded.tag: the fixed form's plan lands here" );

// Unit's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void UnitFixedWriteBody( uint8_t * b, const Unit & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.v );
}

// Bounded's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void BoundedFixedWriteBody( uint8_t * b, const Bounded & value )
{
    (void) b; (void) value;
    schema_assert( value.items_count >= 0 && value.items_count <= 8 ); // the declared count is the bound (§3.4)
    TableFixedPut32( b + 0, (uint32_t) value.items_count );
    for ( int64_t i = 0; i < (int64_t) value.items_count; ++i )
    {
        UnitFixedWriteBody( b + 4 + i * 4 + 0, value.items[i] );
    }
    TableFixedPut32( b + 36, (uint32_t) value.tag );
}
...
constexpr int64_t UnitFixedBodyBytes = 4;
constexpr int64_t UnitFixedRecordBytes = 8 + UnitFixedBodyBytes; // the hash and the body
constexpr uint64_t UnitFixedHash = 0x9e3ff698790d29feull; // fnv1a64 over the layout and the definitions digest (bill §13)
...
constexpr uint8_t UnitFixedLayout[] = {
    0x02, 0x00, 0x00, 0x00, 0x87, 0x27, 0xcc, 0x86, 0xf0, 0xe0, 0x26, 0x8f, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t UnitFixedLayoutBytes = (int64_t) sizeof( UnitFixedLayout );
...
constexpr TableFixedDst UnitFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // Unit
    { (uint32_t) __builtin_offsetof( Unit, v ), 0, 0, 0, 0 }, // v
};
...
// test a guard at all.
constexpr TableFixedEntry UnitFixedPlan[] = {
    { 0u, 0u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1, kTableFixedNoGuard, 0, 1 }, // v
};
constexpr int32_t UnitFixedPlanCount = 1;
constexpr int32_t UnitFixedPlanGuarded = 1;
...
constexpr TableFixedFill UnitFixedCover[] = {
    { 0u, 4u },
};
constexpr int32_t UnitFixedCoverCount = 1;
...
constexpr uint64_t UnitFixedLineage[] = {
    0x9e3ff698790d29feull, // identity
};
constexpr int32_t UnitFixedLineageCount = 1;
constexpr int32_t UnitFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t UnitFixedFloorLive = UnitFixedFloor;
inline void UnitFixedSetFloorForTest( int32_t index ) { UnitFixedFloorLive = index; }
#endif

constexpr uint8_t UnitFixedKnown0Layout[] = {
    0x02, 0x00, 0x00, 0x00, 0x87, 0x27, 0xcc, 0x86, 0xf0, 0xe0, 0x26, 0x8f, 0x0d, 0x04, 0x00, 0x00,
    0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04, 0x04, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr TableFixedKnownLayout UnitFixedKnown[] = {
    { 0x9e3ff698790d29feull, UnitFixedKnown0Layout, 38, 12 }, // identity
};

constexpr const TableFixedKnownRange * UnitFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t UnitFixedKnownRangeCounts[] = { 0 };
...
constexpr int64_t UnitFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + UnitFixedLayoutBytes + count * UnitFixedRecordBytes;
}

inline int64_t UnitFixedSave( const Unit * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = UnitFixedMeasure( count );
    ...
    TableFixedPut64( buffer + kTableFixedHashAt, UnitFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) UnitFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, UnitFixedLayout, (size_t) UnitFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + UnitFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, UnitFixedHash );
        memset( at + 8, 0, (size_t) UnitFixedBodyBytes ); // the prefill's zeros
        UnitFixedWriteBody( at + 8, values[k] );
        at += UnitFixedRecordBytes;
    }
    return need;
}
...
inline int64_t UnitFixedLoad( Unit * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    for ( int32_t i = 0; i < UnitFixedLineageCount; ++i )
    {
        if ( UnitFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = UnitFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = UnitFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = UnitFixedKnown[lineage_at];
    ...
    const TableFixedEntry * entries = UnitFixedPlan;
    int32_t entry_count = UnitFixedPlanCount;
    int32_t entry_guarded = UnitFixedPlanGuarded;
    int64_t record_bytes = UnitFixedRecordBytes;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    if ( hash != UnitFixedHash )
    {
        ...
        else
        {
            ...
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, UnitFixedLayout, (int32_t) UnitFixedLayoutBytes, UnitFixedDst,
                                                   UnitFixedCover, UnitFixedCoverCount,
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        ...
        TableFixedClampKnownRanges( UnitFixedKnownRanges[lineage_at], UnitFixedKnownRangeCounts[lineage_at],
...
// ---- Bounded, the fixed form ----

// MeasureBody IS A CONSTEXPR on this form: the body is the same size for
// every value the type can hold (docs/SPEC-TABLES.md §3.4).
constexpr int64_t BoundedFixedBodyBytes = 40;
constexpr int64_t BoundedFixedRecordBytes = 8 + BoundedFixedBodyBytes; // the hash and the body
constexpr uint64_t BoundedFixedHash = 0x2b285a2d28d41c82ull; // fnv1a64 over the layout and the definitions digest (bill §13)

// THE LAYOUT (form 1 calls this the vocabulary block): 5 entries, a
// PRE-ORDER walk of the closure in the writer's declared order.
// Every byte is settled by the compiler.
constexpr uint8_t BoundedFixedLayout[] = {
    0x05, 0x00, 0x00, 0x00, 0x2a, 0x89, 0xf5, 0x12, 0x09, 0xc1, 0xca, 0x0a, 0x0d, 0x28, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x6f, 0x2c, 0x41, 0x4f, 0xbf, 0x84, 0x78, 0x3e, 0x0e, 0x24, 0x00,
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d, 0x04,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04,
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf3, 0xa4, 0x48, 0x44, 0x19, 0xab, 0xd7, 0x56,
    0x04, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
constexpr int64_t BoundedFixedLayoutBytes = (int64_t) sizeof( BoundedFixedLayout );

// MY SIDE of the layout, one row per entry: the storage facts a layout
// entry cannot carry, which is what a plan compiled from another writer's
// layout lands values through.
constexpr TableFixedDst BoundedFixedDst[] = {
    { 0, 0, 0, 0, 0 }, // Bounded
    { (uint32_t) __builtin_offsetof( Bounded, items ), (uint32_t) sizeof( Unit ), (uint32_t) __builtin_offsetof( Bounded, items_count ), 1, 0 }, // items
    { 0, 0, 0, 0, 0 }, // element
    { (uint32_t) __builtin_offsetof( Unit, v ), 0, 0, 0, 0 }, // v
    { (uint32_t) __builtin_offsetof( Bounded, tag ), 0, 0, 0, 0 }, // tag
};
...
// FIRST, then the arms: the entries that are nearly all of a plan never
// test a guard at all.
constexpr TableFixedEntry BoundedFixedPlan[] = {
    { 0u, 32u, 8u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0, 0, 1, kTableFixedNoGuard, 0, 1 }, // items count
    { 4u, 0u, 32u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1, kTableFixedNoGuard, 0, 1 }, // items, whole
    { 36u, 36u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1, kTableFixedNoGuard, 0, 1 }, // tag
};
constexpr int32_t BoundedFixedPlanCount = 3;
constexpr int32_t BoundedFixedPlanGuarded = 3;
...
// twice; a plan compiled from a stranger's layout subtracts itself from it
// once, when the plan is compiled, and prefills exactly the rest.
constexpr TableFixedFill BoundedFixedCover[] = {
    { 0u, 40u },
};
constexpr int32_t BoundedFixedCoverCount = 1;

// THE LINEAGE, oldest first, the reader's own last (bill §6b). LOAD looks
// the file's header hash up here and never parses a stranger's layout.
constexpr uint64_t BoundedFixedLineage[] = {
    0x2b285a2d28d41c82ull, // identity
};
constexpr int32_t BoundedFixedLineageCount = 1;
constexpr int32_t BoundedFixedFloor = 0;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
inline int32_t BoundedFixedFloorLive = BoundedFixedFloor;
inline void BoundedFixedSetFloorForTest( int32_t index ) { BoundedFixedFloorLive = index; }
#endif

constexpr uint8_t BoundedFixedKnown0Layout[] = {
    0x05, 0x00, 0x00, 0x00, 0x2a, 0x89, 0xf5, 0x12, 0x09, 0xc1, 0xca, 0x0a, 0x0d, 0x28, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x6f, 0x2c, 0x41, 0x4f, 0xbf, 0x84, 0x78, 0x3e, 0x0e, 0x24, 0x00,
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d, 0x04,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x06, 0x02, 0x86, 0x4c, 0xeb, 0x63, 0xaf, 0x04,
...
constexpr TableFixedKnownLayout BoundedFixedKnown[] = {
    { 0x2b285a2d28d41c82ull, BoundedFixedKnown0Layout, 89, 48 }, // identity
};

constexpr const TableFixedKnownRange * BoundedFixedKnownRanges[] = {
    NULL,
};
constexpr int32_t BoundedFixedKnownRangeCounts[] = { 0 };

// A FILE: THE HEADER (docs/SPEC-TABLES.md §3, one rule for all five forms)
// — form byte, seven reserved zero bytes, the LAYOUT HASH at 8, body at 16 —
// then the layout behind its u32 length, then the records to the end of it.
constexpr int64_t BoundedFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + BoundedFixedLayoutBytes + count * BoundedFixedRecordBytes;
}

inline int64_t BoundedFixedSave( const Bounded * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = BoundedFixedMeasure( count );
    if ( count < 0 || buffer == NULL || capacity < need ) { return -1; }
    memset( buffer, 0, (size_t) kTableFixedHeaderBytes ); // the seven reserved bytes, and the rest of the header
    buffer[0] = kTableFixedForm;
    TableFixedPut64( buffer + kTableFixedHashAt, BoundedFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) BoundedFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, BoundedFixedLayout, (size_t) BoundedFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + BoundedFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, BoundedFixedHash );
        memset( at + 8, 0, (size_t) BoundedFixedBodyBytes ); // the prefill's zeros
        BoundedFixedWriteBody( at + 8, values[k] );
        at += BoundedFixedRecordBytes;
    }
    return need;
}
...
// different bytes is layout_malformed, a hash below the floor is
// layout_unsupported. Identity is a PLAN walked by the same loop.
inline int64_t BoundedFixedLoad( Bounded * values, int64_t capacity, const uint8_t * data, int64_t bytes,
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    TableReport local;
    if ( report == NULL ) { report = &local; }
    ...
    const int64_t rest = bytes - kTableFixedHeaderBytes - 4 - (int64_t) layout_bytes;
    int32_t lineage_at = -1;
    for ( int32_t i = 0; i < BoundedFixedLineageCount; ++i )
    {
        if ( BoundedFixedLineage[i] == hash ) { lineage_at = i; break; }
    }
    if ( lineage_at < 0 )
    {
        report->refused = true; report->reason = layout_newer; report->layout_hash = hash; return -1;
    }
    int32_t floor_at = BoundedFixedFloor;
#ifdef SCHEMA_FIXED_FLOOR_TEST_HOOKS
    floor_at = BoundedFixedFloorLive;
#endif
    if ( lineage_at < floor_at )
    {
        report->refused = true; report->reason = layout_unsupported; report->layout_hash = hash; return -1;
    }
    const TableFixedKnownLayout & known = BoundedFixedKnown[lineage_at];
    if ( (int64_t) layout_bytes != known.layout_bytes || memcmp( layout, known.layout, (size_t) layout_bytes ) != 0 )
    {
        report->refused = true; report->reason = layout_malformed; return -1;
    }
    const TableFixedEntry * entries = BoundedFixedPlan;
    int32_t entry_count = BoundedFixedPlanCount;
    int32_t entry_guarded = BoundedFixedPlanGuarded;
    int64_t record_bytes = BoundedFixedRecordBytes;
    const TableFixedFill * fill = NULL;
    int32_t fill_count = 0;
    if ( hash != BoundedFixedHash )
    {
        // AN OLDER WRITER: compile the plan from the TRUSTED known layout,
        // never from the file's bytes (those were only compared). Cached by hash.
        const TableFixedPlanCacheSlot * hit = NULL;
        ...
        else
        {
            ...
            int32_t compiled_guarded = 0;
            uint32_t fill_at = 0;
            const int32_t made = TableFixedCompile( parsed, BoundedFixedLayout, (int32_t) BoundedFixedLayoutBytes, BoundedFixedDst,
                                                   BoundedFixedCover, BoundedFixedCoverCount,
                                                   dest, dest_capacity, &compiled_guarded, &fill_at, &fill_count, report );
            if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_record_too_large : plan_too_large; return -1; }
            record_bytes = known.record_bytes;
            fill = ( fill_count > 0 ) ? (const TableFixedFill *) (const void *) ( (const uint8_t *) dest + fill_at ) : NULL;
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        ...
        TableFixedClampKnownRanges( BoundedFixedKnownRanges[lineage_at], BoundedFixedKnownRangeCounts[lineage_at],
                                    (uint8_t *) &values[k], report );
        at += record_bytes;
    }
    return n;
...
// UnboundedWireExtent: the extent Unbounded's lists and maps command, from the FRAMING alone.
...
inline bool UnboundedWireExtent( const uint8_t * body, int64_t length, int64_t & at, const TableIdTable * ids, TableRefuseReason & reason )
{
    ...
    for ( ;; )
    {
        ...
        if ( field_id == 0x3e7884bf4f412c6full && field_kind == 14 ) // items: an unbounded array
        {
            ...
            if ( !TableListWireExtent( list_body, (int64_t) list_len, at, (int64_t) sizeof( Unit ), (int64_t) alignof( Unit ), 13, 2, NULL, ids, reason ) ) { return false; }
            continue;
        }
...
// UnboundedExtentAt: the node extent Unbounded's lists and maps take, PRE-ORDER, advancing
// the running offset exactly as UnboundedExtentPack advances it (§2.8, §2.9).
template <typename Ctx>
inline bool UnboundedExtentAt( const Ctx & ctx, const Unbounded & value, int64_t & at )
{
    {
        TableListCursor<Unit> cursor = TableListElements( ctx, value.items );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Unit ) - 1 ) & ~( (int64_t) alignof( Unit ) - 1 );
        at += (int64_t) cursor.count * (int64_t) sizeof( Unit ); // the whole array FIRST
    }
    return true;
}
...
template <typename Ctx>
inline int64_t UnboundedExtent( const Ctx & ctx, const Unbounded & value )
{
    int64_t at = 0;
    if ( !UnboundedExtentAt( ctx, value, at ) ) { return -1; }
    return at;
}

// UnboundedExtentPack: carve Unbounded's arrays out of the node's extent and copy the
// entries in ASCENDING key order and the elements in INDEX order, PRE-ORDER,
// advancing the same running offset UnboundedExtentAt advances (§2.8, §2.9).
template <typename Ctx>
inline bool UnboundedExtentPack( const Ctx & ctx, const Unbounded & src, Unbounded & dst, uint8_t * extent, int64_t & at, int64_t capacity )
{
    {
        TableListCursor<Unit> cursor = TableListElements( ctx, src.items );
        if ( !cursor.ok ) { return false; }
        at = ( at + (int64_t) alignof( Unit ) - 1 ) & ~( (int64_t) alignof( Unit ) - 1 );
        const int64_t bytes = (int64_t) cursor.count * (int64_t) sizeof( Unit );
        if ( at + bytes > capacity ) { return false; }
        Unit * placed = (Unit *) ( extent + at );
        at += bytes;
        ...
        {
            memcpy( (void *) ( placed + i ), (const void *) &cursor[i], sizeof( Unit ) ); // trivially copyable, by construction
        }
    }
    return true;
}

// ---- Unbounded.items: the builder's three (§2.9) ----
...
inline Unit * UnboundedItemsAdd( TableWorker & worker, TableList<Unit> & list )
{
...
inline bool UnboundedItemsErase( TableArena & arena, TableList<Unit> & list, const Unit * element )
{
...
inline TableListEach<Unit> UnboundedItemsEach( const TableArena & arena, const TableList<Unit> & list )
{
    return TableListEachOf( arena, list );
}

// UnboundedNumber: number everything Unbounded POINTS AT, in first-visit order —
...
template <typename Ctx>
inline bool UnboundedNumber( const Ctx & ctx, TableNumbering & numbering, const Unbounded & value )
{
    (void) ctx; (void) numbering; (void) value; // no pointers below this node
    return true;
}

// UnboundedPackMeasure: the packed region bytes of everything Unbounded POINTS AT.
...
template <typename Ctx>
inline int64_t UnboundedPackMeasure( const Ctx & ctx, TablePackMap & seen, const Unbounded & value )
{
    int64_t bytes = 0;
...
// UnboundedPack: copy src into dst (already placed), then lay every pointee out
...
template <typename Ctx>
inline bool UnboundedPackEdges( const Ctx & ctx, TablePackMap & seen, const Unbounded & src, Unbounded & dst, uint8_t * base, int64_t capacity, int64_t & used );

template <typename Ctx>
inline bool UnboundedPack( const Ctx & ctx, TablePackMap & seen, const Unbounded & src, Unbounded & dst, uint8_t * base, int64_t capacity, int64_t & used )
{
    memcpy( (void *) &dst, (const void *) &src, sizeof( Unbounded ) ); // trivially copyable, by construction
    int64_t at = 0;
    uint8_t * extent = (uint8_t *) &dst + TableAlignUp64( (int64_t) sizeof( Unbounded ) );
    const int64_t room = capacity - ( (int64_t) ( extent - base ) );
    if ( !UnboundedExtentPack( ctx, src, dst, extent, at, room ) ) { return false; }
    return UnboundedPackEdges( ctx, seen, src, dst, base, capacity, used );
}
...
// ---- Unbounded: the variable-length life (docs/SPEC-TABLES.md §2, §6, §9) ----
//
// MUTABLE: UnboundedBuilder — allocate nodes, wire them together, then Lock.
...
// Unbounded is never held by value — a file-format-scale structure is a region
...
struct UnboundedBuilder
{
    ...
    UnboundedBuilder( TableAllocator allocator = TableDefaultAllocator() )
    {
    ...
    Unbounded * GetRoot() { return arena.locked ? NULL : (Unbounded *) TableArenaAt( arena, (uint32_t) root_ref.value ); }
    bool Locked() const { return arena.locked; }
    const Unbounded * AsConst() const { return (const Unbounded *) region; }
...
inline bool UnboundedBuilder::Lock()
{
    if ( arena.locked ) { return region != NULL; }
    if ( root_ref.null() ) { return false; }
    TableArenaCtx ctx = { &arena };
    const Unbounded & root = *(const Unbounded *) TableArenaAt( arena, (uint32_t) root_ref.value );
...
// ---- Unbounded on the wire: the FLAT NODE TABLE (docs/SPEC-TABLES.md §3.1) ----
//
...
// UnboundedNodeStorage: the region bytes one record commands, or -1 for a type id
...
// UnboundedNodePlace: start one record's node's lifetime in the storage pass one
...
// UnboundedNodeAlloc: the TOOL's path — one record's node in the builder's arena.
...
inline void UnboundedNodeBody( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at )
{
    ...
    if ( carve.worker == NULL )
    {
        ...
        const int64_t storage = UnboundedNodeStorage( type_id, r.size, reason );
        const int64_t record = storage > 0 ? UnboundedNodeRecordBytes( type_id ) : 0;
        carve.at = at + record;
...
// UnboundedNodeMessageStorage: the region bytes one record commands on the message
...
inline int64_t UnboundedNodeMessageStorage( uint64_t type_id, int64_t extent, int64_t length )
{
    (void) length;
    (void) extent;
    (void) type_id;
...
// UnboundedNodeMessageExtent: step over one TABLE record's body, tallying the extent
...
inline bool UnboundedNodeMessageExtent( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, int64_t & extent )
{
    extent = 0;
...
// UnboundedNodeMessageBody: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
inline bool UnboundedNodeMessageBody( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at )
{
    TableExtentCarve carve;
    carve.at = at + UnboundedNodeRecordBytes( type_id );
    carve.left = 0;
    {
        // the extent this record was placed with, re-read from the framing
        TableBitReader walk = r;
        int64_t extent = 0;
        if ( !UnboundedNodeMessageExtent( type_id, walk, vocabulary, index_bits, extent ) ) { report->malformed = true; return false; }
        carve.left = extent;
    }
...
template <typename Ctx>
inline bool UnboundedNumberFrom( const Ctx & ctx, TableNumbering & numbering, const Unbounded & root )
{
    bool taken = false;
    int64_t slot = 0;
    if ( TablePackMapReach( numbering.seen, (const void *) &root, (int64_t) kTableNodeIndexRoot, taken, slot ) == NULL ) { return false; }
    return UnboundedNumber( ctx, numbering, root );
}

template <typename Ctx>
inline int64_t UnboundedMeasureWire( const Ctx & ctx, const Unbounded & root, TableAllocator allocator )
{
    ...
    {
        TableIds ids;
        bytes = UnboundedMeasureBody( ctx, numbering, ids, root );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t UnboundedSaveWire( const Ctx & ctx, const Unbounded & root, uint8_t * buffer, int64_t capacity, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    bool ok = UnboundedSaveBodyFields( ctx, numbering, w, ids, root ) && TableNodeTableSave( ctx, w, ids, numbering );
    TableNumberingShutdown( numbering );
    ...
    return w.offset; // == UnboundedMeasure( root )
}

inline int64_t UnboundedMeasure( const Unbounded * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return UnboundedMeasureWire( ctx, *root, allocator );
}

inline int64_t UnboundedSave( const Unbounded * root, uint8_t * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return UnboundedSaveWire( ctx, *root, buffer, capacity, allocator );
}

inline int64_t UnboundedMeasure( const UnboundedBuilder & builder )
{
    if ( builder.region != NULL ) { return UnboundedMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return UnboundedMeasureWire( ctx, *(const Unbounded *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline int64_t UnboundedSave( const UnboundedBuilder & builder, uint8_t * buffer, int64_t capacity )
{
    if ( builder.region != NULL ) { return UnboundedSave( builder.AsConst(), buffer, capacity, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return UnboundedSaveWire( ctx, *(const Unbounded *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), buffer, capacity, builder.arena.allocator );
}

// ---- Unbounded on the MESSAGE wire: the batch over a region (docs/SPEC-TABLES.md §3.3) ----

// UnboundedMessageBodyBits: one root body's bits at bit position `at` of the batch,
...
template <typename Ctx>
inline int64_t UnboundedMessageBodyBits( const Ctx & ctx, const Unbounded & root, int64_t at, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bits = -1;
    if ( UnboundedNumberFrom( ctx, numbering, root ) )
    {
        ...
        if ( table >= 0 )
        {
            const int64_t body = UnboundedMeasureMessageBody( ctx, numbering, index_bits, at + table, root );
...
template <typename Ctx>
inline bool UnboundedMessageBodySave( const Ctx & ctx, const Unbounded & root, TableBitWriter & w, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    bool ok = false;
    ...
    {
        const int64_t index_bits = TableBitsRequired( 0, numbering.count + 1 );
        ok = TableMessageNodeTableSave( ctx, numbering, index_bits, w ) && UnboundedSaveMessageBody( ctx, numbering, index_bits, w, root );
    }
    TableNumberingShutdown( numbering );
...
inline int64_t UnboundedMeasureMessages( const Unbounded * const * roots, int64_t count, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        ...
        const int64_t body = UnboundedMessageBodyBits( ctx, *roots[i], bits, allocator );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
    return 1 + ( bits + 7 ) / 8;
...
inline int64_t UnboundedSaveMessages( const Unbounded * const * roots, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( roots == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    TableMessageBatch batch;
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( roots[i] == NULL || !UnboundedMessageBodySave( ctx, *roots[i], batch.w, allocator ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == UnboundedMeasureMessages( roots, count, report, allocator )
}

// UnboundedMessageRecordScan: one node record's type id and the extent its maps
...
inline bool UnboundedMessageRecordScan( TableBitReader & r, const TableVocabulary & vocabulary, int64_t index_bits, uint64_t & type_id, int64_t & extent, int64_t & length )
{
    uint64_t type_ref = 0;
    ...
    return UnboundedNodeMessageExtent( type_id, r, vocabulary, index_bits, extent );
}

// UnboundedMessageBodyStorage: one body's node count and data bytes from the FRAMING
...
// and no further (§3.3).
inline bool UnboundedMessageBodyStorage( TableBitReader & r, const TableVocabulary & vocabulary, int64_t & records, int64_t & data, bool & complete )
{
    complete = true;
    records = 0;
    data = 0;
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !UnboundedMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { return false; }
        const int64_t storage = UnboundedNodeMessageStorage( type_id, extent, length );
        if ( storage > 0 ) { data += storage; } // a type id this build cannot name commands none
        records++;
    }
    int64_t root_extent = 0;
    if ( !UnboundedMessageExtent( r, vocabulary, index_bits, root_extent ) ) { complete = false; }
    data += TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Unbounded ) ) + root_extent );
    return true;
}

// UnboundedLoadMeasure's MESSAGE overload: the exact region bytes ONE BATCH needs,
...
inline int64_t UnboundedLoadMeasure( const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, int64_t * attribution_bytes = NULL )
{
    TableReport ignored;
    TableMessageBatchReader br;
    ...
    for ( int64_t b = 0; b < bodies; b++ )
    {
        ...
        bool complete = true;
        if ( !UnboundedMessageBodyStorage( br.r, vocabulary, records, body_data, complete ) ) { return -1; }
        data += body_data;
...
// UnboundedLoadMessageBodyInto: one body of a batch into the region at `used`. Its
...
inline bool UnboundedLoadMessageBodyInto( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Unbounded * & root_out )
{
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        uint64_t type_id = 0;
        int64_t extent = 0, length = 0;
        if ( !UnboundedMessageRecordScan( r, vocabulary, index_bits, type_id, extent, length ) ) { out->malformed = true; return false; }
        const int64_t storage = UnboundedNodeMessageStorage( type_id, extent, length );
        ...
        UnboundedNodePlace( type_id, region + used, length );
        used += storage;
    }
    ...
    {
        TableBitReader walk = r;
        if ( !UnboundedMessageExtent( walk, vocabulary, index_bits, root_extent ) ) { out->malformed = true; return false; }
    }
    const int64_t root_bytes = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Unbounded ) ) + root_extent );
    ...
    Unbounded * root = new ( region + used ) Unbounded; // lifetime only: LoadMessageBody's first act is UnboundedReset
    UnboundedReset( *root );
    root_out = root;
    TableExtentCarve root_carve;
    root_carve.at = region + used + TableAlignUp64( (int64_t) sizeof( Unbounded ) );
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !UnboundedNodeMessageBody( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset ) ) { return false; }
    }
    ...
    return UnboundedLoadMessageBody( r, vocabulary, out, nodes, index_bits, *root );
}

// UnboundedLoadMessages: decode a BATCH into the caller's exact-sized region and
...
inline bool UnboundedLoadMessages( const Unbounded ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !UnboundedLoadMessageBodyInto( br.r, vocabulary, out, region, region_bytes, used, roots[b] ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// UnboundedLoadMeasure: the exact region bytes a wire buffer will need, and it is
...
inline int64_t UnboundedLoadMeasure( const uint8_t * wire_file, int64_t wire_file_bytes, int64_t * attribution_bytes = NULL, TableRefuseReason * reason_out = NULL )
{
    TableReport ignored;
    ...
    int64_t root_extent = 0;
    if ( !UnboundedWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { if ( reason_out != NULL ) { *reason_out = reason; } return -1; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Unbounded ) ) + root_extent );
    int64_t records = 0;
    uint64_t type_id = 0;
    ...
    {
        records++;
        int64_t storage = UnboundedNodeStorage( type_id, length, reason );
...
// UnboundedLoad: decode the tolerant wire into the caller's exact-sized region and
...
// was wrong.
inline const Unbounded * UnboundedLoad( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    if ( region == NULL || region_bytes < (int64_t) sizeof( Unbounded ) ) { out->malformed = true; return NULL; }
    ...
    int64_t root_extent = 0;
    if ( !UnboundedWireExtent( wire, wire_bytes, root_extent, &ids_table, reason ) ) { out->malformed = true; return NULL; }
    int64_t data = TableAlignUp64( TableAlignUp64( (int64_t) sizeof( Unbounded ) ) + root_extent );
    int64_t records = 0;
    {
    ...
    directory[0].type_id = 0x2ec2f34386026d8bull;
    Unbounded * root = new ( region ) Unbounded; // lifetime only: LoadBody's first act is UnboundedReset
    UnboundedReset( *root );
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            if ( directory[k + 1].offset != kTableNodeAbsent )
            {
                ...
                UnboundedNodeBody( type_id, sub, nodes, region + directory[k + 1].offset );
            }
            k++;
        }
    }
    ...
    TableExtentCarve root_carve;
    root_carve.at = region + TableAlignUp64( (int64_t) sizeof( Unbounded ) );
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    UnboundedLoadBody( r, nodes, *root );
    return root;
}

// UnboundedLoadBuilder: the TOOL's path — the same tolerant decode into a fresh
...
inline bool UnboundedLoadBuilder( UnboundedBuilder & builder, const uint8_t * wire_file, int64_t wire_file_bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    TableIdTable ids_table;
    ...
    const uint8_t * const wire = wire_file + 1;
    const int64_t wire_bytes = body_bytes;
    Unbounded * root = builder.GetRoot();
    ...
    nodes.worker = &builder.main; // and a map's entries and a list's elements are the arena's, not a node extent's (§2.8, §2.9)
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            uint32_t at = UnboundedNodeAlloc( type_id, builder.main, length );
            if ( at == 0 )
            {
                unknown_records++;
                directory[k + 1].offset = kTableNodeAbsent;
    ...
    bool ok = UnboundedLoadBody( r, nodes, *root );
...
inline int64_t BoundedMeasureBodyRetain( TableRetainIds & ids, const Bounded & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    if ( value.items_count > 0 )
    {
        ...
        for ( int32_t elem_i = 0; elem_i < value.items_count; elem_i++ )
        {
            const int64_t elem_bytes = UnitMeasureBodyRetain( ids, value.items[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) );
            if ( elem_bytes < 0 ) { return -1; }
            body_items += TableLebBytes( (uint64_t) ( elem_bytes ) ) + ( elem_bytes );
        }
        bytes += TableLebBytes( ref_items ) + 1 + TableLebBytes( (uint64_t) ( body_items ) ) + ( body_items ); // items
...
LISTDEMO_TABLE_INLINE bool BoundedSaveBodyRetain( TableWriter & w, TableRetainIds & ids, const Bounded & value, TableRetain * retain, const TableRetainPath & path )
{
    ...
    if ( value.items_count > 0 )
    {
        ...
        {
            {
                const int64_t elem_len = UnitMeasureBodyRetain( ids, value.items[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) );
                if ( elem_len < 0 ) return false;
                w.putleb( (uint64_t) elem_len );
                if ( !UnitSaveBodyRetain( w, ids, value.items[elem_i], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i ) ) ) ) return false;
            }
        }
    }
    if ( value.tag != 0 )
            ...
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < walk; i++ )
                    {
                        ...
                        Unit scratch;
                        UnitReset( scratch );
                        if ( !UnitLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( in_bounds ? value.items[i] : scratch ), ( in_bounds ? retain : NULL ), TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    value.items_count = kept;
                }
                break;
...
template <typename Ctx>
inline int64_t UnboundedMeasureBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    int64_t bytes = 1; // the ZERO REFERENCE that ends the body
    {
        ...
        if ( cursor_items.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            for ( int32_t elem_i_items = 0; elem_i_items < cursor_items.count; elem_i_items++ )
            {
                const int64_t elem_bytes_items = UnitMeasureBodyRetain( ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) );
                if ( elem_bytes_items < 0 ) { return -1; }
                body_items += TableLebBytes( (uint64_t) ( elem_bytes_items ) ) + ( elem_bytes_items );
            }
            bytes += TableLebBytes( ref_items ) + 1 + TableLebBytes( (uint64_t) ( body_items ) ) + ( body_items );
...
template <typename Ctx>
inline bool UnboundedSaveBodyFieldsRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path )
{
    (void) ctx; (void) numbering;
    {
        TableListCursor<Unit> cursor_items = TableListElements( ctx, value.items ); // items
        ...
        if ( cursor_items.count > 0 ) // an EMPTY list elides, the by-value rule (§3)
        {
            ...
            {
                {
                    const int64_t elem_len_items = UnitMeasureBodyRetain( ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) );
                    if ( elem_len_items < 0 ) return false;
                    w.putleb( (uint64_t) elem_len_items );
                    if ( !UnitSaveBodyRetain( w, ids, cursor_items[elem_i_items], retain, TableRetainStepInto( path, 0, (uint32_t) ( elem_i_items ) ) ) ) return false;
                }
            }
        }
    }
...
template <typename Ctx>
inline bool UnboundedSaveBodyRetain( const Ctx & ctx, const TableNumbering & numbering, TableWriter & w, TableRetainIds & ids, const Unbounded & value, TableRetain * retain, const TableRetainPath & path )
{
    if ( !UnboundedSaveBodyFieldsRetain( ctx, numbering, w, ids, value, retain, path ) ) { return false; }
    w.put8( 0 ); // the ZERO REFERENCE that ends the body
    return !w.overflow;
}
            ...
            case 0x3e7884bf4f412c6full: // items
            {
                ...
                }
                {
                    ...
                    for ( uint64_t i = 0; i < n; i++ )
                    {
                        Unit * slot = TableListFillNext( fill );
                        if ( slot == NULL ) { report->malformed = true; return false; } // the arena could not carve
                        if ( !UnitLoadMessageBodyRetain( r, vocabulary, report, index_bits, ( *slot ), retain, TableRetainStepInto( path, 0, (uint32_t) ( i ) ) ) ) { return false; }
                    }
                    TableListFillEnd( fill );
                }
                break;
...
inline void UnboundedNodeBodyRetain( uint64_t type_id, TableReader & r, const TableNodeMap & nodes, uint8_t * at, TableRetain * retain, uint32_t node )
{
    // the node's own EXTENT, where its lists' and maps' arrays are carved
    // from, PRE-ORDER as the bodies decode (docs/SPEC-TABLES.md §2.8, §2.9).
    // The tool's path carries a worker instead: there the arrays are the
...
// UnboundedLoadRetain: decode the tolerant wire into the caller's exact-sized region and
// return the root. LOAD IS A SCAN, and that is the whole of its bound: it
// follows no reference, so there is no depth cap, no visited set and no
// ordering rule on the indices. Partial results are kept, as everywhere on
// this wire — the report says what happened. NULL means the CALLER's buffer
...
inline const Unbounded * UnboundedLoadRetain( uint8_t * region, int64_t region_bytes, const uint8_t * wire_file, int64_t wire_file_bytes, TableRetain * retain, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    // THE FORM BYTE IS READ FIRST, then the trailer, and only then a body:
    ...
    if ( nodes.good )
    {
        ...
        while ( TableNodeScanNext( scan, type_id, body, length ) )
        {
            ...
            {
                TableReader sub( body, length, out, &ids_table );
                UnboundedNodeBodyRetain( type_id, sub, nodes, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) );
            }
            k++;
        }
    }
    ...
    root_carve.left = root_extent;
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    UnboundedLoadBodyRetain( r, nodes, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
    return root;
}

// UnboundedNodeMessageBodyRetain: PASS TWO's half, which decodes one record's body into
// storage it already owns, its map entries carved from its own extent.
// EACH NODE BODY IS A PATH ROOT of its own (docs/SPEC-TABLES.md §6.6): the
...
inline bool UnboundedNodeMessageBodyRetain( uint64_t type_id, TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, const TableNodeMap & nodes, int64_t index_bits, uint8_t * at, TableRetain * retain, uint32_t node )
{
    TableExtentCarve carve;
    carve.at = at + UnboundedNodeRecordBytes( type_id );
    carve.left = 0;
...
inline bool UnboundedLoadMessageBodyIntoRetain( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * out, uint8_t * region, int64_t region_bytes, int64_t & used, const Unbounded * & root_out, TableRetain * retain )
{
    // the node table opens the body, or the body has none
    int64_t count = 0;
    if ( !TableMessageNodeTableOpen( r, vocabulary, count ) ) { out->malformed = true; return false; }
    ...
    for ( int64_t k = 0; k < count; k++ )
    {
        ...
        if ( !UnboundedNodeMessageBodyRetain( type_id, r, vocabulary, out, nodes, index_bits, region + directory[k + 1].offset, retain, (uint32_t) ( k + 2 ) ) ) { return false; }
    }
    if ( r.offset != fields_start ) { out->malformed = true; return false; } // the two passes disagree about the table's extent

    // and the ROOT's own body last
    nodes.carve = &root_carve; // the ROOT's extent is its own, like every node's
    return UnboundedLoadMessageBodyRetain( r, vocabulary, out, nodes, index_bits, *root, retain, TableRetainPathRoot( (const void *) root, 1 ) );
}

// UnboundedLoadRetainMessages: decode a BATCH into the caller's exact-sized region and
// write each body's root into `roots`. `count` is IN and OUT: the storage the
// caller has room for, then what it got. M above the capacity is a refusal
// by name with count holding the wire's M; damage inside body k delivers
// bodies 1 to k - 1 and count says k - 1 (§3.3). LOAD IS A SCAN: it follows
...
inline bool UnboundedLoadRetainMessages( const Unbounded ** roots, int64_t * count, uint8_t * region, int64_t region_bytes, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableRetain * retains, TableReport * report )
{
    TableReport ignored;
    TableReport * out = report != NULL ? report : &ignored;
    if ( roots == NULL || count == NULL ) { out->malformed = true; return false; }
    ...
    *count = 0;
    ...
    {
        roots[b] = NULL;
        if ( !UnboundedLoadMessageBodyIntoRetain( br.r, vocabulary, out, region, region_bytes, used, roots[b], retains != NULL ? &retains[b] : NULL ) ) { *count = b; return false; }
        br.remaining--;
    }
    *count = bodies;
    return TableMessageBatchClose( br );
...
// UnboundedMeasureRetain and UnboundedSaveRetain: the pair, with the retained tail in
...
template <typename Ctx>
inline int64_t UnboundedMeasureWireRetain( const Ctx & ctx, const Unbounded & root, TableRetain * retain, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    int64_t bytes = -1;
    ...
    if ( UnboundedNumberFrom( ctx, numbering, root ) )
    {
        ...
        bytes = UnboundedMeasureBodyRetain( ctx, numbering, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) );
        if ( bytes >= 0 )
        {
...
template <typename Ctx>
inline int64_t UnboundedSaveWireRetain( const Ctx & ctx, const Unbounded & root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    TableNumbering numbering;
    ...
    bool ok = UnboundedSaveBodyFieldsRetain( ctx, numbering, w, ids, root, retain, TableRetainPathRoot( (const void *) &root, 1 ) ) &&
...
inline int64_t UnboundedMeasureRetain( const Unbounded * root, TableRetain * retain, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return UnboundedMeasureWireRetain( ctx, *root, retain, allocator );
}
...
inline int64_t UnboundedSaveRetain( const Unbounded * root, TableRetain * retain, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( root == NULL || report == NULL ) { return -1; }
    TableRegionCtx ctx;
    return UnboundedSaveWireRetain( ctx, *root, retain, buffer, capacity, report );
}

// UnboundedSaveRetainMessages: RETENTION WRITING FORM 2 IS REFUSED BY NAME
...
template <typename... Args>
inline void UnitSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Unit is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void UnitLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Unit is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void UnitSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Unit is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void BoundedLoadRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Bounded is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}

template <typename... Args>
inline void BoundedMeasureRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Bounded is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void BoundedSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Bounded is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void BoundedLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Bounded is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void BoundedSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "Bounded is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
// UnitOpen: match the header and POINT. On a match the bytes ARE what this
...
//
// Unit IS FIXED-SIZE, so its cook is ONE REGION OF ONE NODE and not a second
...
// parameter on a load.
inline const Unit * UnitOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Unit *) TableCookOpen( bytes, length, (uint64_t) sizeof( Unit ), (uint64_t) alignof( Unit ), reason );
}

// BoundedOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// Bounded IS FIXED-SIZE, so its cook is ONE REGION OF ONE NODE and not a second
// shape (§7): one struct behind the header, at the region's base, which is
// what this returns. There is no graph below it and nothing to resolve.
//
// There is ONE entry point and no tolerant twin: a build either wrote this
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Bounded * BoundedOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Bounded *) TableCookOpen( bytes, length, (uint64_t) sizeof( Bounded ), (uint64_t) alignof( Bounded ), reason );
}

// UnboundedOpen: match the header and POINT. On a match the bytes ARE what this
// build wrote, in this build's layout and this build's byte order, so there
// is nothing to validate and nothing to fix up and the root comes back as it
// lies. On ANY refusal it returns NULL and NAMES the refusal in the caller's
// TableRefuseReason, the first failing clause in §7's order (a wrong build
...
// touching nothing at open rather than a separate mechanism.
//
// A REFERENCE INSIDE THE REGION IS DEREFERENCED THROUGH UnboundedAt: the slot holds
...
// over the ATTRIBUTION part beside the data — a person's decision, never a
// parameter on a load.
inline const Unbounded * UnboundedOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const Unbounded *) TableCookOpen( bytes, length, (uint64_t) sizeof( Unbounded ), (uint64_t) alignof( Unbounded ), reason );
}
...
inline void UnitCookBody( uint8_t * at, const Unit & value, TableByteOrder order );
inline void BoundedCookBody( uint8_t * at, const Bounded & value, TableByteOrder order );
template <typename Ctx> inline bool UnboundedCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Unbounded & value, TableByteOrder order );
...
inline void BoundedCookBody( uint8_t * at, const Bounded & value, TableByteOrder order )
{
    ...
    {
        UnitCookBody( at + 0 + i * 4, value.items[ i ], order );
    }
    table_cook_put( at + 32, (uint64_t) (uint32_t) value.items_count, 4, order );
    table_cook_put( at + 36, (uint64_t) value.tag, 4, order );
}
...
template <typename Ctx> inline bool UnboundedCookBody( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Unbounded & value, TableByteOrder order )
{
    ...
    table_cook_put( at + 16, (uint64_t) value.tag, 4, order );
    return true;
}

template <typename Ctx> inline bool UnitCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Unit & value, TableByteOrder order );
template <typename Ctx> inline bool BoundedCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Bounded & value, TableByteOrder order );
template <typename Ctx> inline bool UnboundedCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Unbounded & value, TableByteOrder order );

// UnitCookExtent: Unit's arrays into the node's extent, PRE-ORDER, a map's entries
...
// BoundedCookExtent: Bounded's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool BoundedCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Bounded & value, TableByteOrder order )
{
...
// UnboundedCookExtent: Unbounded's arrays into the node's extent, PRE-ORDER, a map's entries
// in ASCENDING key order and a list's elements in INDEX order, each through its
// own cook writer (§2.8, §2.9, §7.6).
template <typename Ctx> inline bool UnboundedCookExtent( const Ctx & ctx, const TableCookRegion & region, uint8_t * extent, int64_t & at, uint8_t * record, const Unbounded & value, TableByteOrder order )
{
    ...
    { // items: an unbounded array
        ...
        for ( int32_t i = 0; i < cursor.count; i++ ) // INDEX order, live elements only
        {
            UnitCookBody( array + i * 4, cursor[i], order );
        }
    }
    return true;
}

// UnitCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool UnitCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Unit & value, TableByteOrder order )
{
    UnitCookBody( at, value, order );
    int64_t extent_at = 0;
    return UnitCookExtent( ctx, region, at + 8, extent_at, at, value, order );
}

// BoundedCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool BoundedCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Bounded & value, TableByteOrder order )
{
    BoundedCookBody( at, value, order );
    int64_t extent_at = 0;
    return BoundedCookExtent( ctx, region, at + 40, extent_at, at, value, order );
}

// UnboundedCookNode: one node, the record, then the extent its lists and maps take (§2.8, §2.9).
template <typename Ctx> inline bool UnboundedCookNode( const Ctx & ctx, const TableCookRegion & region, uint8_t * at, const Unbounded & value, TableByteOrder order )
{
...
//
// Unit IS FIXED-SIZE, so the answer does not depend on the value: its cook is
...
inline int64_t UnitCookMeasure( const Unit & value )
{
    (void) value;
    return 88; // 64 header + 8 data + 16 attribution
}

// UnitCook: write one cooked file for the build this code is compiled into,
...
// the same contract UnitMeasure/UnitSave has on the wire (§6.1).
//
...
inline bool UnitCook( const Unit & value, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( out == NULL ) { return false; }
    const uint64_t need = (uint64_t) UnitCookMeasure( value );
    ...
    UnitCookBody( raw + 64, value, order );
    ...
    table_cook_put( raw + 80, 0x8f26e0f086cc2787ull, 8, order );
    return true;
}

// BoundedCookMeasure: the whole cooked file's bytes — the header, the data part
// and the attribution part (docs/SPEC-TABLES.md §7.1). It answers in int64_t
// because a cook's part lengths are 64 bits: the scale this form exists for is
// a catalog, and a 32-bit answer would reimpose the ceiling §3.1 removed.
//
// Bounded IS FIXED-SIZE, so the answer does not depend on the value: its cook is
// ONE REGION OF ONE NODE (§7) — the record at the region's base, its length
// rounded to the region's alignment, and one directory entry.
inline int64_t BoundedCookMeasure( const Bounded & value )
{
    (void) value;
    return 120; // 64 header + 40 data + 16 attribution
}

// BoundedCook: write one cooked file for the build this code is compiled into,
// in the byte order the caller names. The bytes are `schema cook`'s, byte for
// byte, and the tool is the reference (§7.6).
//
// THE CALLER OWNS THE BUFFER AND NOTHING IS ALLOCATED: measure, then write.
// A capacity short of the measure writes nothing and returns false, which is
// the same contract BoundedMeasure/BoundedSave has on the wire (§6.1).
//
// EVERY BYTE NO FIELD COVERS IS ZERO (§7.2) — interior padding, the record's
// trailing padding, a string's unused tail, the bytes of a union outside its
// set arm, and the slack the rounded data length leaves. It comes from the one
// memset below rather than from a rule per padding site, and it is what makes
// two cooks of one value ONE artifact (§7).
inline bool BoundedCook( const Bounded & value, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( out == NULL ) { return false; }
    const uint64_t need = (uint64_t) BoundedCookMeasure( value );
    if ( capacity < need ) { return false; }
    uint8_t * raw = (uint8_t *) out;
    memset( raw, 0, (size_t) need );
    // the HEADER (§7.1), every word a u64 in the order the file is produced in
    ...
    // the two RESERVED words are zero, and the memset already wrote them
    // the DATA part: the region, which for a fixed root is the record at its base
    BoundedCookBody( raw + 64, value, order );
    // the ATTRIBUTION part: the node directory (§6.3), written beside the data
    // for `schema cook-check` — one entry, the root at offset zero, and its type
    // id is the fnv1a64 of the table's name (§3.1)
    table_cook_put( raw + 104, 0, 8, order );
    table_cook_put( raw + 112, 0x0acac10912f5892aull, 8, order );
    return true;
}

// UnboundedCookLayout: the tool's own Layout (docs/SPEC-TABLES.md §7.2) over one
...
template <typename Ctx>
inline bool UnboundedCookLayout( const Ctx & ctx, const Unbounded & root, const TableNumbering & numbering, TableCookRegion & region )
{
    region.numbering = &numbering;
    region.count = numbering.count + 1;
    const int64_t root_extent = UnboundedExtent( ctx, root );
...
// UnboundedCookMeasureFrom: the whole cooked file's bytes for one graph — the header,
...
template <typename Ctx>
inline int64_t UnboundedCookMeasureFrom( const Ctx & ctx, const Unbounded & root, TableAllocator allocator )
{
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    TableCookRegion region;
    int64_t bytes = -1;
    if ( UnboundedNumberFrom( ctx, numbering, root ) && UnboundedCookLayout( ctx, root, numbering, region ) )
    {
...
// UnboundedCookFrom: write one cooked file of a pointered graph, in the byte order
...
template <typename Ctx>
inline bool UnboundedCookFrom( const Ctx & ctx, const Unbounded & root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator )
{
    if ( out == NULL ) { return false; }
    TableNumbering numbering;
    TableNumberingInit( numbering, allocator );
    ...
    if ( ok )
    {
        ...
        if ( ok )
        {
            ...
            ok = UnboundedCookNode( ctx, region, region.base, root, order );
            ...
            table_cook_put( entry + 8, 0x2ec2f34386026d8bull, 8, order ); // the root: fnv1a64( "Unbounded" )
            for ( int64_t k = 0; k < numbering.count; k++ )
            {
...
// UnboundedCookMeasure / UnboundedCook over a REGION root — a locked builder's AsConst, a
// region UnboundedLoad produced, or an opened cook — with the pair the numbering
// allocates through as an optional last argument, as the wire's own entries
// take it (§13.9).
inline int64_t UnboundedCookMeasure( const Unbounded * root, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return -1; }
    TableRegionCtx ctx;
    return UnboundedCookMeasureFrom( ctx, *root, allocator );
}

inline bool UnboundedCook( const Unbounded * root, void * out, uint64_t capacity, TableByteOrder order, TableAllocator allocator = TableDefaultAllocator() )
{
    if ( root == NULL ) { return false; }
    TableRegionCtx ctx;
    return UnboundedCookFrom( ctx, *root, out, capacity, order, allocator );
}

// and over a BUILDER, locked or not: the builder's own pair, and the arena
// encoding while it is still mutable (§6.3).
inline int64_t UnboundedCookMeasure( const UnboundedBuilder & builder )
{
    if ( builder.region != NULL ) { return UnboundedCookMeasure( builder.AsConst(), builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return -1; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return UnboundedCookMeasureFrom( ctx, *(const Unbounded *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), builder.arena.allocator );
}

inline bool UnboundedCook( const UnboundedBuilder & builder, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( builder.region != NULL ) { return UnboundedCook( builder.AsConst(), out, capacity, order, builder.arena.allocator ); }
    if ( builder.root_ref.null() ) { return false; } // the root allocation failed
    TableArenaCtx ctx = { &builder.arena };
    return UnboundedCookFrom( ctx, *(const Unbounded *) TableArenaAt( builder.arena, (uint32_t) builder.root_ref.value ), out, capacity, order, builder.arena.allocator );
}
...
static_assert( __is_trivially_copyable( Unit ), "Unit must stay relocatable" );
static_assert( __is_standard_layout( Unit ), "Unit must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Bounded ), "Bounded must stay relocatable" );
static_assert( __is_standard_layout( Bounded ), "Bounded must stay standard-layout for offsetof" );
static_assert( __is_trivially_copyable( Unbounded ), "Unbounded must stay relocatable" );
static_assert( __is_standard_layout( Unbounded ), "Unbounded must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( Unit ) == 4, "Unit's sizeof moved: the build version was taken over 4, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Unit ) == 4, "Unit's alignof moved: the build version was taken over 4 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Unit, v ) == 0, "Unit's field v moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Bounded ) == 40, "Bounded's sizeof moved: the build version was taken over 40, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Bounded ) == 4, "Bounded's alignof moved: the build version was taken over 4 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Bounded, items ) == 0, "Bounded's field items moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Bounded, tag ) == 36, "Bounded's field tag moved: the build version was taken over offset 36 (docs/SPEC-TABLES.md §20.3)" );
static_assert( sizeof( Unbounded ) == 24, "Unbounded's sizeof moved: the build version was taken over 24, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( Unbounded ) == 8, "Unbounded's alignof moved: the build version was taken over 8 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Unbounded, items ) == 0, "Unbounded's field items moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( Unbounded, tag ) == 16, "Unbounded's field tag moved: the build version was taken over offset 16 (docs/SPEC-TABLES.md §20.3)" );

static_assert( alignof( Unit ) <= kTableAlign, "Unbounded.items: an unbounded array's element alignment must fit the arena's" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * UnitTableType();
inline const TableTypeInfo * BoundedTableType();
inline const TableTypeInfo * UnboundedTableType();
...
extern const TableTypeInfo UnitTableInfo;
extern const TableTypeInfo BoundedTableInfo;
extern const TableTypeInfo UnboundedTableInfo;

inline const TableFieldInfo UnitTableFields[] = {
    { "v", "v", "int32", 0xaf63eb4c86020609ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Unit, v ), (uint32_t) sizeof( Unit::v ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo UnitTableInfo = { "Unit", (uint32_t) sizeof( Unit ), 1, UnitTableFields, +[]( void * p ) { UnitReset( *(Unit *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * UnitTableType() { return &UnitTableInfo; }

inline const TableFieldInfo BoundedTableFields[] = {
    { "items", "items", "Unit", 0x3e7884bf4f412c6full, 13, true, false, NULL, NULL, true, false, 8, (uint32_t) offsetof( Bounded, items ), (uint32_t) sizeof( Bounded::items[0] ), (uint32_t) offsetof( Bounded, items_count ), 0xffffffffu, &UnitTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    { "tag", "tag", "int32", 0x56d7ab194448a4f3ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Bounded, tag ), (uint32_t) sizeof( Bounded::tag ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo BoundedTableInfo = { "Bounded", (uint32_t) sizeof( Bounded ), 2, BoundedTableFields, +[]( void * p ) { BoundedReset( *(Bounded *) p ); }, false, TableDocNone, 0, NULL };
inline const TableTypeInfo * BoundedTableType() { return &BoundedTableInfo; }

inline const TableFieldInfo UnboundedTableFields[] = {
    { "items", "items", "Unit", 0x3e7884bf4f412c6full, 13, true, false, NULL, NULL, true, false, 0, (uint32_t) offsetof( Unbounded, items ), (uint32_t) sizeof( Unit ), (uint32_t) offsetof( Unbounded, items.count ), 0xffffffffu, &UnitTableInfo, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, []( TableWorker & worker, void * slot, const char *, int32_t, int64_t ) -> void * { return (void *) TableListPlace( worker, *(TableList<Unit> *) slot ); }, "", TableDocNone, 0, NULL },
    { "tag", "tag", "int32", 0x56d7ab194448a4f3ull, 4, false, false, NULL, NULL, false, false, 0, (uint32_t) offsetof( Unbounded, tag ), (uint32_t) sizeof( Unbounded::tag ), 0xffffffffu, 0xffffffffu, NULL, false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
};
inline const TableTypeInfo UnboundedTableInfo = { "Unbounded", (uint32_t) sizeof( Unbounded ), 2, UnboundedTableFields, +[]( void * p ) { UnboundedReset( *(Unbounded *) p ); }, true, TableDocNone, 0, NULL };
inline const TableTypeInfo * UnboundedTableType() { return &UnboundedTableInfo; }

// ---- the text form (docs/SPEC-TABLES.md §16) ----

// Unit in and out of a JSON text — one instance, one text, the generic
// walk over this type's descriptors (docs/SPEC-TABLES.md §16). Defined in
// MigrateTable.cpp; link it to use them.
bool UnitFromJson( Unit & value, const char * text, int64_t bytes, TableReport * report );
int64_t UnitToJsonMeasure( const Unit & value );
int64_t UnitToJson( const Unit & value, char * buffer, int64_t capacity );

// Bounded in and out of a JSON text — one instance, one text, the generic
// walk over this type's descriptors (docs/SPEC-TABLES.md §16). Defined in
// MigrateTable.cpp; link it to use them.
bool BoundedFromJson( Bounded & value, const char * text, int64_t bytes, TableReport * report );
int64_t BoundedToJsonMeasure( const Bounded & value );
int64_t BoundedToJson( const Bounded & value, char * buffer, int64_t capacity );

// Unbounded in and out of a JSON text (docs/SPEC-TABLES.md §16.7): read into a
// builder, written from a region's const root. A node named more than once
// carries `&node` in the text. Defined in MigrateTable.cpp; link it to use them.
bool UnboundedFromJson( UnboundedBuilder & builder, const char * text, int64_t bytes, TableReport * report );
int64_t UnboundedToJsonMeasure( const Unbounded * root, TableAllocator allocator = TableDefaultAllocator() );
int64_t UnboundedToJson( const Unbounded * root, char * buffer, int64_t capacity, TableAllocator allocator = TableDefaultAllocator() );
