...
constexpr TableFixedGuard UnitFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t UnitFixedGuardCount = 0;
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) UnitFixedGuards;
...
// union first, and it is as long as the nesting is deep: there is no bound
// on how many unions may nest (§5.9).
constexpr TableFixedGuard BoundedFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t BoundedFixedGuardCount = 0;
...
constexpr TableFixedEntry BoundedFixedPlan[] = {
    { 0u, 32u, 8u, 0u, 0u, 0, kTableFixedCount, 0, 0, 0 }, // items count
    { 4u, 0u, 32u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, // items, whole
    { 36u, 36u, 4u, 0u, 0u, 0, kTableFixedCopy, 0, 0, 0 }, // tag
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) BoundedFixedGuards;
