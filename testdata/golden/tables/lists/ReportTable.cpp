...
bool BytesFromJson( BytesBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    return TableJsonReadGraph( builder.main, root, BytesTableType(), text, bytes, report );
}

int64_t BytesToJsonMeasure( const Bytes * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, BytesTableType(), NULL, 0, allocator );
}

int64_t BytesToJson( const Bytes * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, BytesTableType(), buffer, capacity, allocator );
}
...
bool IntsFromJson( IntsBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, IntsTableType(), text, bytes, report );
}

int64_t IntsToJsonMeasure( const Ints * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, IntsTableType(), NULL, 0, allocator );
}

int64_t IntsToJson( const Ints * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, IntsTableType(), buffer, capacity, allocator );
}
...
bool FloatsFromJson( FloatsBuilder & builder, const char * text, int64_t bytes, TableReport * report )
{
    ...
    if ( root == NULL ) { if ( report != NULL ) { report->malformed = true; } return false; } // locked, or the root allocation failed
    return TableJsonReadGraph( builder.main, root, FloatsTableType(), text, bytes, report );
}

int64_t FloatsToJsonMeasure( const Floats * root, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, FloatsTableType(), NULL, 0, allocator );
}

int64_t FloatsToJson( const Floats * root, char * buffer, int64_t capacity, TableAllocator allocator )
{
    return TableJsonWriteGraph( root, FloatsTableType(), buffer, capacity, allocator );
}
