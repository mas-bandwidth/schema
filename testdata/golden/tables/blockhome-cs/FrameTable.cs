...
namespace Blockhome
{
    ...
    public static partial class Schema
    {
        ...
        public static TableTypeInfo PartFrameTableType()
        {
            ...
            info.Fields = new TableFieldInfo[]
            {
                new TableFieldInfo { Name = "version", Json = "version", TypeName = "uint64", Id = 0xbb62c62c9808ea37, Kind = 9, IsArray = false, Counted = false, Optional = false, ArrayBound = 0, ElemWidth = 8, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = -1, EnumName = null, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = null, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetRaw = delegate(object o, int i) { return (ulong)((PartFrame)o).Version; }, SetRaw = delegate(object o, int i, ulong r) { ((PartFrame)o).Version = unchecked((ulong)r); }, MessageSlot = 14, NativeOffset = 0, NativeElementSize = 8, NativeCountOffset = -1, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (PartFrame)o; value.Version = 0; }, DefaultRaw = (ulong)0, ClampRaw = delegate(ulong raw, TableReport r) { ulong v = unchecked((ulong)raw); return (ulong)v; } },
                new TableFieldInfo { Name = "parts", Json = "parts", TypeName = "PartRow", Id = 0x0c519da7a1f958c5, Kind = 13, IsArray = true, Counted = true, Optional = false, ArrayBound = 32, ElemWidth = 0, HasRange = false, RangeMin = 0.0, RangeMax = 0.0, EnumMax = -1, EnumName = null, VariantId = null, KeyTypeName = null, KeyName = null, KeyId = null, Guard = "", TableRef = delegate { return PartRowTableType(); }, Arms = null, Doc = TableDocNone, NumTags = 0, Tags = null, GetChild = delegate(object o, int i) { return ((PartFrame)o).Parts[i]; }, GetCount = delegate(object o) { return ((PartFrame)o).PartsCount; }, SetCount = delegate(object o, int n) { ((PartFrame)o).PartsCount = n; }, MessageSlot = 15, NativeOffset = 8, NativeElementSize = 352, NativeCountOffset = 11272, NativePresentOffset = -1, ResetField = delegate(object o) { var value = (PartFrame)o; for (int i = 0; i < value.Parts.Length; i++) { TableReset(value.Parts[i]); } value.PartsCount = 0; } },
            };
