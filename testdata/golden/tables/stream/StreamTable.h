                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    if ( hash != HeaderFixedHash )
    {
        ...
        else
        {
            ...
            const int32_t made = TableFixedCompile( parsed, HeaderFixedLayout, (int32_t) HeaderFixedLayoutBytes, HeaderFixedDst, dest, dest_capacity, &compiled_guarded, report );
    ...
    {
        HeaderReset( values[k] ); // the declared defaults, one prefill
