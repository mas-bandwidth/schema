...
constexpr TableFixedGuard HeaderFixedGuards[] = {
    { 0u, 0u, 0u, 1u }, // no union in this type: the pool names no condition
};
constexpr int32_t HeaderFixedGuardCount = 0;
...
constexpr TableFixedEntry HeaderFixedPlan[] = {
    { 0u, 20u, 16u, 0u, 0u, 0, kTableFixedText, 1, 0, 0 }, // name
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const uint8_t * guard_pool = (const uint8_t *) HeaderFixedGuards;
