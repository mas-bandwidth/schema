                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != HeaderFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, HeaderFixedLayout, (int32_t) HeaderFixedLayoutBytes, HeaderFixedDst, plan, plan_capacity, &compiled_guarded, report );
