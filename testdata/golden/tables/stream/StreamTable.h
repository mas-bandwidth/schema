...
{
    return 1 + 4 + HeaderFixedLayoutBytes + count * HeaderFixedRecordBytes;
}
...
inline int64_t HeaderFixedSave( const Header * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    TableFixedPut32( buffer + 1, (uint32_t) HeaderFixedLayoutBytes );
    memcpy( buffer + 5, HeaderFixedLayout, (size_t) HeaderFixedLayoutBytes );
    uint8_t * at = buffer + 5 + HeaderFixedLayoutBytes;
