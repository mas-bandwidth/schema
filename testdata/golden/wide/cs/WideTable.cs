...
namespace Wide
{
    ...
    public static partial class Schema
    {
        ...
        // TableReset(Body) restores None and every arm in place, reusing buffers.
        public static void TableReset(Body value)
        {
            value.Type = BodyType.None;
            Array.Clear(value.Wide, 0, value.Wide.Length);
            value.WideLength = 0;
            Array.Clear(value.Narrow, 0, value.Narrow.Length);
            value.NarrowLength = 0;
            value.Tally = 0;
        }
    }
