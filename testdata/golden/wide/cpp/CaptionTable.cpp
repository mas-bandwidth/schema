...
// package wide — the TABLE wire's text form (docs/SPEC-TABLES.md §16).
...
// The guard is not vestigial. Several wide Table.cpp files may be
...
#ifndef WIDE_SCHEMA_TABLE_JSON
#define WIDE_SCHEMA_TABLE_JSON
