...
#ifndef SCHEMA_WIDE_VIEW_H
#define SCHEMA_WIDE_VIEW_H
#include <stdint.h>
#include <stddef.h>
#include <string.h>
#include "WideText.h"
#ifndef SCHEMA_WIDE_TABLE_PRIMITIVES
#define SCHEMA_WIDE_TABLE_PRIMITIVES
...
#ifndef SCHEMA_WIDE_TABLE_INLINE
#if defined( _MSC_VER )
#define SCHEMA_WIDE_TABLE_INLINE __forceinline
#elif defined( __GNUC__ ) || defined( __clang__ )
#define SCHEMA_WIDE_TABLE_INLINE inline __attribute__(( always_inline ))
#else
#define SCHEMA_WIDE_TABLE_INLINE inline
#endif
#endif
...
#endif /* SCHEMA_WIDE_TABLE_PRIMITIVES */
...
static SCHEMA_UNUSED void narrow_fifteen_reset( NarrowFifteen * value );
static SCHEMA_UNUSED void schema_wide_narrow_fifteen_reset_raw_( void * storage );
static SCHEMA_UNUSED void wide_four_reset( WideFour * value );
static SCHEMA_UNUSED void schema_wide_wide_four_reset_raw_( void * storage );
static SCHEMA_UNUSED void wide_interop_reset( WideInterop * value );
static SCHEMA_UNUSED void schema_wide_wide_interop_reset_raw_( void * storage );
static SCHEMA_UNUSED void wide_seven_reset( WideSeven * value );
static SCHEMA_UNUSED void schema_wide_wide_seven_reset_raw_( void * storage );
...
static SCHEMA_UNUSED void schema_wide_narrow_fifteen_reset_raw_( void * storage ) { narrow_fifteen_reset( (NarrowFifteen *) storage ); }

extern const TableTypeInfo schema_wide_narrow_fifteen_info_;
static SCHEMA_UNUSED const TableTypeInfo * narrow_fifteen_table_type(void) { return &schema_wide_narrow_fifteen_info_; }
static SCHEMA_UNUSED void wide_four_reset( WideFour * value )
{
    memset( value->text, 0, sizeof( value->text ) );
    value->text_length = 0;
...
static SCHEMA_UNUSED void schema_wide_wide_four_reset_raw_( void * storage ) { wide_four_reset( (WideFour *) storage ); }

extern const TableTypeInfo schema_wide_wide_four_info_;
static SCHEMA_UNUSED const TableTypeInfo * wide_four_table_type(void) { return &schema_wide_wide_four_info_; }
static SCHEMA_UNUSED void wide_interop_reset( WideInterop * value )
{
    memset( value->caption, 0, sizeof( value->caption ) );
    value->caption_length = 0;
}

static SCHEMA_UNUSED void schema_wide_wide_interop_reset_raw_( void * storage ) { wide_interop_reset( (WideInterop *) storage ); }

extern const TableTypeInfo schema_wide_wide_interop_info_;
static SCHEMA_UNUSED const TableTypeInfo * wide_interop_table_type(void) { return &schema_wide_wide_interop_info_; }
static SCHEMA_UNUSED void wide_seven_reset( WideSeven * value )
{
    memset( value->text, 0, sizeof( value->text ) );
    value->text_length = 0;
...
static SCHEMA_UNUSED void schema_wide_wide_seven_reset_raw_( void * storage ) { wide_seven_reset( (WideSeven *) storage ); }

extern const TableTypeInfo schema_wide_wide_seven_info_;
static SCHEMA_UNUSED const TableTypeInfo * wide_seven_table_type(void) { return &schema_wide_wide_seven_info_; }
const UnitViewInfo * schema_wide_unit_view_(void);
static SCHEMA_UNUSED const UnitViewInfo * unit_view(void) { return schema_wide_unit_view_(); }
#ifdef __cplusplus
}
#endif
#endif
