...
| **[MATRIX.md](docs/MATRIX.md)** | The published matrix: the feature-by-language cells and one maturity state per language, generated from `docs/matrix.json` and printed with each release. |
