...
int main()
{
    ...
    //   deep:    position/velocity 3 x 34, rotation 4 x 32 = 332 bits = 42 bytes
    {
        ...
        uint8_t hostile[sizeof( expected_shallow ) + 8];  // + 8: read buffer allocations extend 8 bytes past the data
        std::memcpy( hostile, expected_shallow, sizeof( expected_shallow ) );
        set_bits( hostile, 0, 26 );
        NarrowBodyData_Shallow hOut;
        serialize::ReadStream hrs( hostile, sizeof( expected_shallow ) );
