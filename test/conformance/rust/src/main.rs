...
fn codecs() -> Vec<Codec> {
    vec![
        ...
        codec!(
            ...
            tblf1,
            tblf1::Floats,
            tblf1::floats_measure,
            tblf1::floats_save,
            tblf1::floats_load,
            tblf1::floats_from_json,
            tblf1::floats_to_json_measure,
            tblf1::floats_to_json
        ),
        codec!(
            "tblf2",
            "Floats",
            tblf2,
            tblf2::Floats,
            tblf2::floats_measure,
            tblf2::floats_save,
            tblf2::floats_load,
            tblf2::floats_from_json,
            tblf2::floats_to_json_measure,
            tblf2::floats_to_json
        ),
        codec!(
            "tbla1",
            "Root",
            ...
            tbla1::root_save,
            tbla1::root_load,
            tbla1::root_from_json,
            tbla1::root_to_json_measure,
            tbla1::root_to_json
        ),
        codec!(
            "tbla2",
            ...
            tbla2::root_save,
            tbla2::root_load,
            tbla2::root_from_json,
            tbla2::root_to_json_measure,
            tbla2::root_to_json
        ),
        codec!(
            "tblk1",
