/* Code generated by the schema compiler from Bench.schema. DO NOT EDIT.
   ...
   package bench — the TABLE wire's reflection descriptors and text form
...
static const TableVariantInfo schema_bench_mixed_entity_weapon_variants_[] = {
    { "None", 0x0000000000000000ull },
    { "Fists", 0xa790eee12766cf0cull },
    { "Pistol", 0x9fbfefa835da8476ull },
    { "Shotgun", 0x188bbb1783928a95ull },
    { "Rifle", 0x2c3667b9c2f272f1ull },
    { "Sniper", 0x0ca8b41b00d755f6ull },
    { "Smg", 0x985fc819fab21a4eull },
    { "Rocket", 0x229d0447c3086a55ull },
    { "Grenade", 0x011c7b49a7228f9dull },
    { "Plasma", 0x89f7566e1123e15full },
    { "Railgun", 0x8d7f25318b3b4469ull },
    { "Flamer", 0xd9cd0dcc285b7816ull },
    { "Mine", 0x04dc16aea8ff5276ull },
    { "Turret", 0x35e53bc341129217ull },
    { "Drone", 0x2cc8282fb0de8831ull },
    { "Repair", 0x20bada21bc8cb334ull },
};
static const TableVariantInfo schema_bench_mixed_entity_damage_variants_[] = {
    { "Bleeding", 0 },
    { "Burning", 0 },
    { "Stunned", 0 },
    { "Slowed", 0 },
...
static const TableFieldInfo schema_bench_mixed_entity_fields_[] = {
    { "entity_id", "entity_id", "bits(12)", 0x23fcfd6678e36712ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, entity_id ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->entity_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "pos_x", "pos_x", "int32", 0xcb4b37357667310eull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, pos_x ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->pos_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "pos_y", "pos_y", "int32", 0xcb4b3835766732c1ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, pos_y ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->pos_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "pos_z", "pos_z", "int32", 0xcb4b353576672da8ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, pos_z ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->pos_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "yaw", "yaw", "bits(9)", 0xb54d8e19798e16e8ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, yaw ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->yaw ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 511.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "pitch", "pitch", "bits(9)", 0x53a9f665a90cc1b1ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, pitch ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->pitch ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 511.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "vel_x", "vel_x", "int32", 0x6cede6b6eb60ee67ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, vel_x ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->vel_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "vel_y", "vel_y", "int32", 0x6cede5b6eb60ecb4ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, vel_y ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->vel_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "vel_z", "vel_z", "int32", 0x6cede8b6eb60f1cdull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, vel_z ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->vel_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "health", "health", "int32", 0x7f69d4b5288ba9cfull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, health ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->health ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1000.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "weapon", "weapon", "MixedWeapon", 0xa0b610205f2c6e01ull, 30, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, weapon ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->weapon ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 15, schema_bench_mixed_entity_weapon_variants_, 1, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "damage", "damage", "MixedDamage", 0x7f6308be8ab37fc0ull, 9, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, damage ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->damage ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 7, schema_bench_mixed_entity_damage_variants_, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "moving", "moving", "bool", 0x11a44fc1d1243da7ull, 1, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, moving ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->moving ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "firing", "firing", "bool", 0x7674cfd19b9031caull, 1, 0, 0, 0, 0, (uint32_t) offsetof( MixedEntity, firing ), (uint32_t) sizeof( ( (MixedEntity *) 0 )->firing ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableFieldInfo schema_bench_mixed_stat_fields_[] = {
    { "stat_id", "stat_id", "bits(8)", 0x80ab75f0866dbf65ull, 6, 0, 0, 0, 0, (uint32_t) offsetof( MixedStat, stat_id ), (uint32_t) sizeof( ( (MixedStat *) 0 )->stat_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "delta", "delta", "int32", 0x52076675ec13a0c1ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedStat, delta ), (uint32_t) sizeof( ( (MixedStat *) 0 )->delta ), 0xffffffffu, 0xffffffffu, NULL, 1, -512.0, 511.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableFieldInfo schema_bench_mixed_hit_event_fields_[] = {
    { "target_id", "target_id", "bits(12)", 0xb7bc9ac015a25050ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedHitEvent, target_id ), (uint32_t) sizeof( ( (MixedHitEvent *) 0 )->target_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "damage", "damage", "int32", 0x7f6308be8ab37fc0ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedHitEvent, damage ), (uint32_t) sizeof( ( (MixedHitEvent *) 0 )->damage ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "hit_kind", "hit_kind", "int32", 0x01fbc365b059b925ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedHitEvent, hit_kind ), (uint32_t) sizeof( ( (MixedHitEvent *) 0 )->hit_kind ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 7.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "crit", "crit", "bool", 0x126167908c9aa52dull, 1, 0, 0, 0, 0, (uint32_t) offsetof( MixedHitEvent, crit ), (uint32_t) sizeof( ( (MixedHitEvent *) 0 )->crit ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableFieldInfo schema_bench_mixed_chat_event_fields_[] = {
    { "channel", "channel", "int32", 0xa5013e9ad5caeda4ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedChatEvent, channel ), (uint32_t) sizeof( ( (MixedChatEvent *) 0 )->channel ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 3.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "speaker", "speaker", "bits(12)", 0xfbf1ac4d96ebd022ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedChatEvent, speaker ), (uint32_t) sizeof( ( (MixedChatEvent *) 0 )->speaker ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableFieldInfo schema_bench_mixed_pickup_event_fields_[] = {
    { "item_id", "item_id", "bits(10)", 0x9e7fd06d864fbd56ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( MixedPickupEvent, item_id ), (uint32_t) sizeof( ( (MixedPickupEvent *) 0 )->item_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1023.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "amount", "amount", "int32", 0x8113fe7ea2b16969ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( MixedPickupEvent, amount ), (uint32_t) sizeof( ( (MixedPickupEvent *) 0 )->amount ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
...
static const TableWideRange schema_bench_bench_mixed_server_time_range_ = { { 0ull, 0ull }, { 16776960ull, 0ull } };
static const TableVariantInfo schema_bench_bench_mixed_game_event_variants_[] = {
    { "None", 0 },
    { "hit", 0x33732819300680aaull },
    { "chat", 0xf2a38d910b5b348bull },
    { "pickup", 0x9fa3a41c86ecb765ull },
};
static const TableUnionArmInfo schema_bench_bench_mixed_game_event_arms_[] = {
    { 0, NULL, NULL, 0 },
...
static const TableUnionInfo schema_bench_bench_mixed_game_event_union_ = { (uint32_t) offsetof( MixedEvent, type ), (uint32_t) sizeof( ( (MixedEvent *) 0 )->type ), schema_bench_bench_mixed_game_event_arms_ };
static const TableWideRange schema_bench_bench_mixed_wide_key_range_ = { { 0ull, 0ull }, { 18446744073709551615ull, 18446744073709551615ull } };
static const TableWideRange schema_bench_bench_mixed_flux_range_ = { { 0ull, 18446744004990074880ull }, { 0ull, 68719476736ull } };
static const TableWideRange schema_bench_bench_mixed_ping_range_ = { { 0ull, 0ull }, { 64000ull, 0ull } };
static const TableFieldInfo schema_bench_bench_mixed_fields_[] = {
    { "sequence", "sequence", "bits(16)", 0xaa38aca481f528a8ull, 7, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, sequence ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->sequence ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "ack_sequence", "ack_sequence", "int32", 0x0dbe005c56697c3eull, 4, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, ack_sequence ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->ack_sequence ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "ack_bits", "ack_bits", "bits(32)", 0x9bae0da8b829ee03ull, 8, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, ack_bits ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->ack_bits ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4.294967295e+09, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "session_id", "session_id", "uint64", 0xb7d7b5650a590b05ull, 9, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, session_id ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->session_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "client_id", "client_id", "uint32", 0x6d7b98e2d095967eull, 8, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, client_id ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->client_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "nonce", "nonce", "uint64", 0x73a94c71d60dc0d8ull, 9, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, nonce ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->nonce ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.8446744073709552e+19, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "world_time", "world_time", "int64", 0x3eee6b51be54fc85ull, 5, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, world_time ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->world_time ), 0xffffffffu, 0xffffffffu, NULL, 1, -1e+12, 1e+12, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "frame_tick", "frame_tick", "bits(48)", 0x7bbc035f7b6d0112ull, 9, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, frame_tick ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->frame_tick ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 2.81474976710655e+14, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "server_time", "server_time", "fixed(24, 8)", 0x3c460475f9be69c6ull, 22, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, server_time ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->server_time ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, &schema_bench_bench_mixed_server_time_range_, 8, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "entities", "entities", "MixedEntity", 0x935d0fb07bb3822aull, 13, 1, 1, 0, 8, (uint32_t) offsetof( BenchMixed, entities ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->entities[0] ), (uint32_t) offsetof( BenchMixed, entities_count ), 0xffffffffu, &schema_bench_mixed_entity_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "stats", "stats", "MixedStat", 0xee639cad45b1994cull, 13, 1, 1, 0, 80, (uint32_t) offsetof( BenchMixed, stats ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->stats[0] ), (uint32_t) offsetof( BenchMixed, stats_count ), 0xffffffffu, &schema_bench_mixed_stat_info_, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "game_event", "game_event", "MixedEvent", 0x2e35dc5321aa5790ull, 15, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, game_event ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->game_event ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, 3, schema_bench_bench_mixed_game_event_variants_, 1, NULL, NULL, -1, &schema_bench_bench_mixed_game_event_union_, "", TableDocNone, 0, NULL, 0, NULL },
    { "loadout", "loadout", "uint8", 0x5759ce7586bbb5a3ull, 6, 1, 0, 0, 4, (uint32_t) offsetof( BenchMixed, loadout ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->loadout[0] ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "player_name", "player_name", "string", 0x13a62f542cf8e86eull, 12, 0, 1, 0, 15, (uint32_t) offsetof( BenchMixed, player_name ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->player_name ), (uint32_t) offsetof( BenchMixed, player_name_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "payload", "payload", "bytes", 0xcfb8a9d063b5e9e5ull, 6, 1, 1, 0, 16, (uint32_t) offsetof( BenchMixed, payload ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->payload[0] ), (uint32_t) offsetof( BenchMixed, payload_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "aim_x", "aim_x", "float32", 0xdbaf7be5e24296c9ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, aim_x ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->aim_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "aim_y", "aim_y", "float32", 0xdbaf7ae5e2429516ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, aim_y ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->aim_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "aim_z", "aim_z", "float32", 0xdbaf79e5e2429363ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, aim_z ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->aim_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "recoil", "recoil", "float32", 0x9cef31fff7e2e457ull, 10, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, recoil ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->recoil ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "drift", "drift", "float64", 0x5ab3f9c9341f6c04ull, 11, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, drift ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->drift ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "wide_key", "wide_key", "uint128", 0xa3348580461faf16ull, 19, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, wide_key ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->wide_key ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, &schema_bench_bench_mixed_wide_key_range_, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "flux", "flux", "int128", 0xd61bdd7908af2642ull, 18, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, flux ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->flux ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.2676506002282294e+30, 1.2676506002282294e+30, &schema_bench_bench_mixed_flux_range_, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "ping", "ping", "ufixed(8, 8)", 0xbf30e00dc53307a9ull, 26, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, ping ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->ping ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 250.0, &schema_bench_bench_mixed_ping_range_, 8, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "crc_hint", "crc_hint", "bits(24)", 0x560d6527ccd8515full, 8, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, crc_hint ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->crc_hint ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.6777215e+07, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "has_extra", "has_extra", "bool", 0xc08292176cfd8672ull, 1, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, has_extra ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->has_extra ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "extra", "extra", "int32", 0xfd29ee12a979cb69ull, 4, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, extra ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->extra ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
    { "idle_ticks", "idle_ticks", "int32", 0x78101ac0aa8cbcfeull, 4, 0, 0, 0, 0, (uint32_t) offsetof( BenchMixed, idle_ticks ), (uint32_t) sizeof( ( (BenchMixed *) 0 )->idle_ticks ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 15.0, NULL, 0, -1, NULL, 0, NULL, NULL, -1, NULL, "", TableDocNone, 0, NULL, 0, NULL },
};
