...
#ifndef BENCH_SCHEMA_TABLE_PRIMITIVES
#define BENCH_SCHEMA_TABLE_PRIMITIVES
...
#if defined( _MSC_VER )
#define BENCH_TABLE_INLINE __forceinline
#elif defined( __GNUC__ ) || defined( __clang__ )
#define BENCH_TABLE_INLINE inline __attribute__(( always_inline ))
#else
#define BENCH_TABLE_INLINE inline
#endif
...
struct TableWriter
{
    ...
    BENCH_TABLE_INLINE void raw( const void * data, int64_t bytes )
    {
    ...
    BENCH_TABLE_INLINE void put128( uint64_t lo, uint64_t hi )
    {
    ...
    BENCH_TABLE_INLINE void header( uint64_t ref, uint8_t kind )
    {
        if ( ref < 128 )
        {
...
struct TableIds
{
    static const int32_t kCapacity = 79;
    ...
    static BENCH_TABLE_INLINE uint32_t bucket_of( uint64_t id )
    {
    ...
    BENCH_TABLE_INLINE uint64_t ref( uint64_t id )
    {
    ...
    BENCH_TABLE_INLINE uint64_t ref_at( int32_t ordinal, uint64_t id )
    {
...
struct TableReader
{
    ...
    BENCH_TABLE_INLINE bool has( int64_t bytes ) const { return offset + bytes <= size; }
    ...
    BENCH_TABLE_INLINE bool room( uint64_t bytes ) const { return bytes <= (uint64_t) ( size - offset ); }
    BENCH_TABLE_INLINE uint8_t get8()   { return buffer[offset++]; }
    BENCH_TABLE_INLINE uint16_t get16() { uint16_t v = uint16_t( buffer[offset] ) | uint16_t( buffer[offset+1] ) << 8; offset += 2; return v; }
    BENCH_TABLE_INLINE uint32_t get32() { uint32_t v = uint32_t( buffer[offset] ) | uint32_t( buffer[offset+1] ) << 8 | uint32_t( buffer[offset+2] ) << 16 | uint32_t( buffer[offset+3] ) << 24; offset += 4; return v; }
    BENCH_TABLE_INLINE uint64_t get64() { uint64_t lo = get32(); uint64_t hi = get32(); return lo | ( hi << 32 ); }
    BENCH_TABLE_INLINE void get128( uint64_t & lo, uint64_t & hi ) { lo = get64(); hi = get64(); }
...
// THE UNIT'S ANNOUNCEMENT, byte for byte: 75 entries and 932 bytes. It is an
...
static const uint8_t kTableAnnounce[ kTableAnnounceBytes ] = {
    ...
    ,
    ...
    ,
...
#endif // BENCH_SCHEMA_TABLE_PRIMITIVES

#ifndef BENCH_SCHEMA_BUILD_VERSION
#define BENCH_SCHEMA_BUILD_VERSION
...
#endif // BENCH_SCHEMA_BUILD_VERSION

#ifndef BENCH_SCHEMA_TABLE_COOK
#define BENCH_SCHEMA_TABLE_COOK
...
#endif // BENCH_SCHEMA_TABLE_COOK

namespace bench {

// table FixedTable — TABLE-wire storage: relocatable, bounded, defaults in the
...
inline void FixedTableReset( FixedTable & value );
...
inline int64_t FixedTableMeasureMessageBody( int64_t at, const FixedTable & value );
inline bool FixedTableSaveMessageBody( TableBitWriter & w, const FixedTable & value );
inline bool FixedTableLoadMessageBody( TableBitReader & r, const TableVocabulary & vocabulary, TableReport * report, int64_t index_bits, FixedTable & value );
...
BENCH_TABLE_INLINE bool FixedTableLoadBody( TableReader & r, FixedTable & value );
...
inline int64_t FixedTableMeasure( const FixedTable & value )
{
    TableIds ids;
    const int64_t body = FixedTableMeasureBody( ids, value );
...
inline int64_t FixedTableSave( const FixedTable & value, uint8_t * buffer, int64_t capacity )
{
    TableWriter w( buffer, capacity );
    TableIds ids;
    w.put8( kTableWireForm ); // the FORM BYTE is the whole header (§3)
    if ( !FixedTableSaveBody( w, ids, value ) || ids.overflow ) { return -1; }
    TableIdsWrite( w, ids ); // the ID TABLE is the last thing in the file
    if ( w.overflow ) { return -1; }
    return w.offset; // == FixedTableMeasure( value )
}

BENCH_TABLE_INLINE bool FixedTableLoadBody( TableReader & r, FixedTable & value )
{
    FixedTableReset( value ); // prefill declared defaults in place, then overlay
    for ( ;; )
    {
...
inline TableOpenVerdict FixedTableLoadVerdict( FixedTable & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    TableIdTable table;
    ...
    if ( !FixedTableLoadBody( r, value ) ) { return TableOpenBodyStopped; }
    return TableOpenOk;
}
...
inline bool FixedTableLoad( FixedTable & value, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    return FixedTableLoadVerdict( value, buffer, bytes, report ) == TableOpenOk;
}
...
inline int64_t FixedTableMeasureMessageBody( int64_t at, const FixedTable & value )
{
    int64_t bits = 0;
    {
        const int64_t body_value = BenchMixedMeasureMessageBody( at + bits, value.value );
        if ( body_value < 0 ) { return -1; }
        if ( body_value > kTableMessageRefBitsHere ) // an all-default nested table elides
        {
            bits += kTableMessageRefBitsHere;
            bits += BenchMixedMeasureMessageBody( at + bits, value.value );
        }
    }
...
{
    {
        const int64_t body_value = BenchMixedMeasureMessageBody( 0, value.value );
        if ( body_value < 0 ) { return false; }
        if ( body_value > kTableMessageRefBitsHere ) // an all-default nested table elides
        {
            w.put( 28, kTableMessageRefBitsHere );
            if ( !BenchMixedSaveMessageBody( w, value.value ) ) { return false; }
        }
    }
    ...
    for ( ;; )
    {
        ...
        switch ( entry.id )
        {
            case 0x7ce4fd9430e80ceaull: // value
            {
                ...
                if ( !BenchMixedLoadMessageBody( r, vocabulary, report, index_bits, value.value ) ) { return false; }
                break;
            }
            default:
                report->unknown++;
...
inline int64_t FixedTableMeasureMessages( const FixedTable * values, int64_t count, TableReport * report )
{
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        const int64_t body = FixedTableMeasureMessageBody( bits, values[i] );
        if ( body < 0 ) { return -1; }
        bits += body;
    }
...
inline int64_t FixedTableSaveMessages( const FixedTable * values, int64_t count, uint8_t * buffer, int64_t capacity, TableReport * report )
{
    if ( values == NULL || count < 1 ) { return -1; }
    if ( count > kTableMessageBatchMax ) { TableMessageRefuseBatch( report ); return -1; }
    ...
    for ( int64_t i = 0; i < count; i++ )
    {
        if ( !FixedTableSaveMessageBody( batch.w, values[i] ) ) { return -1; }
        batch.written++;
    }
    return TableMessageBatchEnd( batch ); // == FixedTableMeasureMessages( values, count, report )
}
...
inline bool FixedTableLoadMessages( FixedTable * values, int64_t * count, const TableVocabulary & vocabulary, const uint8_t * buffer, int64_t bytes, TableReport * report )
{
    TableReport ignored;
    TableReport * to = report != NULL ? report : &ignored;
    ...
    *count = 0;
    ...
    {
        if ( !FixedTableLoadMessageBody( br.r, vocabulary, to, 0, values[i] ) ) { *count = i; return false; } // a fixed root numbers no node: no index width
        br.remaining--;
    }
    *count = bodies;
...
static_assert( sizeof( MixedEntity ) == 64, "MixedEntity: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, entity_id ) == 0, "MixedEntity.entity_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, pos_x ) == 4, "MixedEntity.pos_x: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, pos_y ) == 8, "MixedEntity.pos_y: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, pos_z ) == 12, "MixedEntity.pos_z: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, yaw ) == 16, "MixedEntity.yaw: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, pitch ) == 20, "MixedEntity.pitch: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, vel_x ) == 24, "MixedEntity.vel_x: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, vel_y ) == 28, "MixedEntity.vel_y: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, vel_z ) == 32, "MixedEntity.vel_z: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, health ) == 36, "MixedEntity.health: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, weapon ) == 40, "MixedEntity.weapon: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, damage ) == 48, "MixedEntity.damage: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, moving ) == 56, "MixedEntity.moving: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEntity, firing ) == 57, "MixedEntity.firing: the fixed form's plan lands here" );
static_assert( sizeof( MixedStat ) == 8, "MixedStat: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedStat, stat_id ) == 0, "MixedStat.stat_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedStat, delta ) == 4, "MixedStat.delta: the fixed form's plan lands here" );
static_assert( sizeof( MixedHitEvent ) == 16, "MixedHitEvent: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedHitEvent, target_id ) == 0, "MixedHitEvent.target_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedHitEvent, damage ) == 4, "MixedHitEvent.damage: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedHitEvent, hit_kind ) == 8, "MixedHitEvent.hit_kind: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedHitEvent, crit ) == 12, "MixedHitEvent.crit: the fixed form's plan lands here" );
static_assert( sizeof( MixedChatEvent ) == 8, "MixedChatEvent: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedChatEvent, channel ) == 0, "MixedChatEvent.channel: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedChatEvent, speaker ) == 4, "MixedChatEvent.speaker: the fixed form's plan lands here" );
static_assert( sizeof( MixedPickupEvent ) == 8, "MixedPickupEvent: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedPickupEvent, item_id ) == 0, "MixedPickupEvent.item_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( MixedPickupEvent, amount ) == 4, "MixedPickupEvent.amount: the fixed form's plan lands here" );
static_assert( sizeof( BenchMixed ) == 1376, "BenchMixed: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, sequence ) == 0, "BenchMixed.sequence: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, ack_sequence ) == 4, "BenchMixed.ack_sequence: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, ack_bits ) == 8, "BenchMixed.ack_bits: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, session_id ) == 16, "BenchMixed.session_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, client_id ) == 24, "BenchMixed.client_id: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, nonce ) == 32, "BenchMixed.nonce: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, world_time ) == 40, "BenchMixed.world_time: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, frame_tick ) == 48, "BenchMixed.frame_tick: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, server_time ) == 56, "BenchMixed.server_time: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, entities ) == 64, "BenchMixed.entities: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, entities_count ) == 576, "BenchMixed.entities_count: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, stats ) == 580, "BenchMixed.stats: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, stats_count ) == 1220, "BenchMixed.stats_count: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, game_event ) == 1224, "BenchMixed.game_event: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, loadout ) == 1244, "BenchMixed.loadout: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, player_name ) == 1248, "BenchMixed.player_name: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, player_name_length ) == 1264, "BenchMixed.player_name_length: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, payload ) == 1268, "BenchMixed.payload: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, payload_length ) == 1284, "BenchMixed.payload_length: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, aim_x ) == 1288, "BenchMixed.aim_x: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, aim_y ) == 1292, "BenchMixed.aim_y: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, aim_z ) == 1296, "BenchMixed.aim_z: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, recoil ) == 1300, "BenchMixed.recoil: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, drift ) == 1304, "BenchMixed.drift: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, wide_key ) == 1312, "BenchMixed.wide_key: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, flux ) == 1328, "BenchMixed.flux: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, ping ) == 1344, "BenchMixed.ping: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, crc_hint ) == 1348, "BenchMixed.crc_hint: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, has_extra ) == 1352, "BenchMixed.has_extra: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, extra ) == 1356, "BenchMixed.extra: the fixed form's plan lands here" );
static_assert( (uint32_t) __builtin_offsetof( BenchMixed, idle_ticks ) == 1360, "BenchMixed.idle_ticks: the fixed form's plan lands here" );
static_assert( sizeof( MixedEvent ) == 20, "MixedEvent: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( MixedEvent, type ) == 0, "MixedEvent: the tag leads the union storage" );
static_assert( (uint32_t) __builtin_offsetof( MixedEvent, hit ) == 4, "MixedEvent.hit: every arm is overlaid here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEvent, chat ) == 4, "MixedEvent.chat: every arm is overlaid here" );
static_assert( (uint32_t) __builtin_offsetof( MixedEvent, pickup ) == 4, "MixedEvent.pickup: every arm is overlaid here" );
static_assert( sizeof( FixedTable ) == 1376, "FixedTable: the fixed form's plan is laid out for this size" );
static_assert( (uint32_t) __builtin_offsetof( FixedTable, value ) == 0, "FixedTable.value: the fixed form's plan lands here" );

// MixedEntity's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void MixedEntityFixedWriteBody( uint8_t * b, const MixedEntity & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.entity_id );
    TableFixedPut32( b + 4, (uint32_t) value.pos_x );
    TableFixedPut32( b + 8, (uint32_t) value.pos_y );
    TableFixedPut32( b + 12, (uint32_t) value.pos_z );
    TableFixedPut32( b + 16, (uint32_t) value.yaw );
    TableFixedPut32( b + 20, (uint32_t) value.pitch );
    TableFixedPut32( b + 24, (uint32_t) value.vel_x );
    TableFixedPut32( b + 28, (uint32_t) value.vel_y );
    TableFixedPut32( b + 32, (uint32_t) value.vel_z );
    TableFixedPut32( b + 36, (uint32_t) value.health );
    TableFixedPut8( b + 40, (uint8_t) value.weapon );
    TableFixedPut64( b + 41, (uint64_t) value.damage );
    TableFixedPut8( b + 49, value.moving ? 1 : 0 );
    TableFixedPut8( b + 50, value.firing ? 1 : 0 );
}

// MixedStat's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void MixedStatFixedWriteBody( uint8_t * b, const MixedStat & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.stat_id );
    TableFixedPut32( b + 4, (uint32_t) value.delta );
}

// MixedHitEvent's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void MixedHitEventFixedWriteBody( uint8_t * b, const MixedHitEvent & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.target_id );
    TableFixedPut32( b + 4, (uint32_t) value.damage );
    TableFixedPut32( b + 8, (uint32_t) value.hit_kind );
    TableFixedPut8( b + 12, value.crit ? 1 : 0 );
}

// MixedChatEvent's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void MixedChatEventFixedWriteBody( uint8_t * b, const MixedChatEvent & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.channel );
    TableFixedPut32( b + 4, (uint32_t) value.speaker );
}

// MixedPickupEvent's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void MixedPickupEventFixedWriteBody( uint8_t * b, const MixedPickupEvent & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.item_id );
    TableFixedPut32( b + 4, (uint32_t) value.amount );
}

// BenchMixed's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void BenchMixedFixedWriteBody( uint8_t * b, const BenchMixed & value )
{
    (void) b; (void) value;
    TableFixedPut32( b + 0, (uint32_t) value.sequence );
    TableFixedPut32( b + 4, (uint32_t) value.ack_sequence );
    TableFixedPut32( b + 8, (uint32_t) value.ack_bits );
    TableFixedPut64( b + 12, (uint64_t) value.session_id );
    TableFixedPut32( b + 20, (uint32_t) value.client_id );
    TableFixedPut64( b + 24, (uint64_t) value.nonce );
    ...
    TableFixedPut8( b + 1108, (uint8_t) value.game_event.type );
    switch ( value.game_event.type )
    {
        case MixedEventType::Hit:
        {
            MixedHitEventFixedWriteBody( b + 1109, value.game_event.hit );
            break;
        }
        case MixedEventType::Chat:
        {
            MixedChatEventFixedWriteBody( b + 1109, value.game_event.chat );
            break;
        }
        case MixedEventType::Pickup:
        {
            MixedPickupEventFixedWriteBody( b + 1109, value.game_event.pickup );
            break;
        }
        default: break;
    }
    ...
    TableFixedPut128( b + 1189, value.wide_key );
    TableFixedPut128( b + 1205, value.flux );
    TableFixedPut16( b + 1221, (uint16_t) value.ping );
    TableFixedPut32( b + 1223, (uint32_t) value.crc_hint );
    TableFixedPut8( b + 1227, value.has_extra ? 1 : 0 );
    TableFixedPut32( b + 1228, (uint32_t) value.extra );
    TableFixedPut32( b + 1232, (uint32_t) value.idle_ticks );
}

// FixedTable's stores. The prefill — the hash, then zeros — is memcpy'd first,
// which is also what zero-fills every byte of declared slack.
inline void FixedTableFixedWriteBody( uint8_t * b, const FixedTable & value )
{
    (void) b; (void) value;
...
constexpr uint64_t FixedTableFixedHash = 0x32f1c4a302a224ebull; // fnv1a64 over the layout's bytes
...
constexpr uint8_t FixedTableFixedLayout[] = {
...
constexpr int64_t FixedTableFixedLayoutBytes = (int64_t) sizeof( FixedTableFixedLayout );
...
// guard at all.
constexpr TableFixedEntry FixedTableFixedPlan[] = {
    { 0u, 0u, 12u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // sequence
    { 12u, 16u, 12u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // session_id
    { 24u, 32u, 28u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // nonce
    { 52u, 576u, 8u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0, 0, 1 }, // entities count
    { 56u, 64u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 97u, 112u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 105u, 120u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 107u, 128u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 148u, 176u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 156u, 184u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 158u, 192u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 199u, 240u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 207u, 248u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 209u, 256u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 250u, 304u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 258u, 312u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 260u, 320u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 301u, 368u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 309u, 376u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 311u, 384u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 352u, 432u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 360u, 440u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 362u, 448u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 403u, 496u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 411u, 504u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 413u, 512u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // entity_id
    { 454u, 560u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // damage
    { 462u, 568u, 2u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // moving
    { 464u, 1220u, 80u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0, 0, 1 }, // stats count
    { 468u, 580u, 640u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // stats, whole
    { 1108u, 1224u, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // game_event tag
    { 1122u, 1244u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // loadout, whole
    { 1126u, 1264u, 15u, 1248u, kTableFixedNoGuard, kTableFixedText, 0, 1, 0, 0, 1 }, // player_name
    { 1145u, 1284u, 16u, 1268u, kTableFixedNoGuard, kTableFixedText, 0, 3, 0, 0, 1 }, // payload
    { 1165u, 1288u, 58u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // aim_x
    { 1223u, 1348u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // crc_hint
    { 1227u, 1352u, 1u, 0u, kTableFixedNoGuard, kTableFixedBool, 0, 0, 0, 0, 1 }, // has_extra
    { 1228u, 1356u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0, 0, 1 }, // extra
    { 1109u, 1228u, 12u, 0u, 1108u, kTableFixedCopy, 1, 0, 0, 0, 1 }, // target_id
    { 1121u, 1240u, 1u, 0u, 1108u, kTableFixedBool, 1, 0, 0, 0, 1 }, // crit
    { 1109u, 1228u, 8u, 0u, 1108u, kTableFixedCopy, 2, 0, 0, 0, 1 }, // channel
    { 1109u, 1228u, 8u, 0u, 1108u, kTableFixedCopy, 3, 0, 0, 0, 1 }, // item_id
};
constexpr int32_t FixedTableFixedPlanCount = 42;
constexpr int32_t FixedTableFixedPlanGuarded = 38;
...
constexpr TableFixedFill FixedTableFixedCover[] = {
    { 0u, 12u },
    { 16u, 12u },
    { 32u, 28u },
    { 64u, 41u },
...
constexpr int64_t FixedTableFixedMeasure( int64_t count )
{
    return kTableFixedHeaderBytes + 4 + FixedTableFixedLayoutBytes + count * FixedTableFixedRecordBytes;
}

inline int64_t FixedTableFixedSave( const FixedTable * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    const int64_t need = FixedTableFixedMeasure( count );
    ...
    TableFixedPut64( buffer + kTableFixedHashAt, FixedTableFixedHash );
    TableFixedPut32( buffer + kTableFixedHeaderBytes, (uint32_t) FixedTableFixedLayoutBytes );
    memcpy( buffer + kTableFixedHeaderBytes + 4, FixedTableFixedLayout, (size_t) FixedTableFixedLayoutBytes );
    uint8_t * at = buffer + kTableFixedHeaderBytes + 4 + FixedTableFixedLayoutBytes;
    for ( int64_t k = 0; k < count; ++k )
    {
        TableFixedPut64( at, FixedTableFixedHash );
        memset( at + 8, 0, (size_t) FixedTableFixedBodyBytes ); // the prefill's zeros
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableFixedPlanCache * cache, TableReport * report )
{
    ...
    const TableFixedEntry * entries = FixedTableFixedPlan;
...
template <typename... Args>
inline void FixedTableSaveRetain( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "FixedTable is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void FixedTableLoadRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "FixedTable is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
template <typename... Args>
inline void FixedTableSaveRetainMessages( Args &&... )
{
    static_assert( sizeof...( Args ) == (size_t) -1,
        "FixedTable is a FIXED-class root (docs/SPEC-TABLES.md §6.1): it is a value with no region and no node directory, so retain-unknown has no anchor for a path's first step. LoadRetain, MeasureRetain and SaveRetain, and the message form's LoadRetainMessages and SaveRetainMessages beside them (§3.3), are refused by name on a fixed-class root (§6.6). Retention is a REGION round trip: load a variable-class root, or save without it." );
}
...
// FixedTableOpen: match the header and POINT. On a match the bytes ARE what this
...
// parameter on a load.
inline const FixedTable * FixedTableOpen( const void * bytes, uint64_t length, TableRefuseReason * reason = NULL )
{
    return (const FixedTable *) TableCookOpen( bytes, length, (uint64_t) sizeof( FixedTable ), (uint64_t) alignof( FixedTable ), reason );
}
...
inline void FixedTableCookBody( uint8_t * at, const FixedTable & value, TableByteOrder order );

inline void FixedTableCookBody( uint8_t * at, const FixedTable & value, TableByteOrder order )
{
    BenchMixedCookBody( at + 0, value.value, order );
}

// FixedTableCookMeasure: the whole cooked file's bytes — the header, the data part
...
//
// FixedTable IS FIXED-SIZE, so the answer does not depend on the value: its cook is
...
inline int64_t FixedTableCookMeasure( const FixedTable & value )
{
    (void) value;
    return 1456; // 64 header + 1376 data + 16 attribution
}

// FixedTableCook: write one cooked file for the build this code is compiled into,
...
// the same contract FixedTableMeasure/FixedTableSave has on the wire (§6.1).
//
...
inline bool FixedTableCook( const FixedTable & value, void * out, uint64_t capacity, TableByteOrder order )
{
    if ( out == NULL ) { return false; }
    const uint64_t need = (uint64_t) FixedTableCookMeasure( value );
    ...
    table_cook_put( raw + 24, 1376, 8, order ); // data_length, rounded to the region's alignment
    ...
    FixedTableCookBody( raw + 64, value, order );
    ...
    table_cook_put( raw + 1440, 0, 8, order );
    table_cook_put( raw + 1448, 0x85df369cdca746b3ull, 8, order );
    return true;
}
...
// include at all.
static_assert( __is_trivially_copyable( FixedTable ), "FixedTable must stay relocatable" );
static_assert( __is_standard_layout( FixedTable ), "FixedTable must stay standard-layout for offsetof" );
...
// rather than assumed.
static_assert( sizeof( FixedTable ) == 1376, "FixedTable's sizeof moved: the build version was taken over 1376, so a cook of it would not be this build's file (docs/SPEC-TABLES.md §20.3)" );
static_assert( alignof( FixedTable ) == 16, "FixedTable's alignof moved: the build version was taken over 16 (docs/SPEC-TABLES.md §20.3)" );
static_assert( offsetof( FixedTable, value ) == 0, "FixedTable's field value moved: the build version was taken over offset 0 (docs/SPEC-TABLES.md §20.3)" );

// ---- reflection descriptors (tables only, docs/SPEC-TABLES.md) ----

inline const TableTypeInfo * FixedTableTableType();

inline const TableTypeInfo * FixedTableTableType()
{
    static const TableFieldInfo fields[] = {
        { "value", "value", "BenchMixed", 0x7ce4fd9430e80ceaull, 13, false, false, false, 0, (uint32_t) offsetof( FixedTable, value ), (uint32_t) sizeof( FixedTable::value ), 0xffffffffu, 0xffffffffu, BenchMixedTableType(), false, 0.0, 0.0, 0, NULL, -1, NULL, NULL, NULL, NULL, NULL, NULL, "", TableDocNone, 0, NULL },
    };
    static const TableTypeInfo info = { "FixedTable", (uint32_t) sizeof( FixedTable ), 1, fields, +[]( void * p ) { FixedTableReset( *(FixedTable *) p ); }, TableDocNone, 0, NULL };
    return &info;
}
...
// FixedTableTable.cpp; link it to use them.
bool FixedTableFromJson( FixedTable & value, const char * text, int64_t bytes, TableReport * report );
int64_t FixedTableToJsonMeasure( const FixedTable & value );
int64_t FixedTableToJson( const FixedTable & value, char * buffer, int64_t capacity );
