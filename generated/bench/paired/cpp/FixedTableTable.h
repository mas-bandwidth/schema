...
constexpr int MixedEntityFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int MixedStatFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int MixedHitEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int MixedChatEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int MixedPickupEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int BenchMixedFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );
constexpr int FixedTableFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst );

// MixedEntity's LEAVES: one entry per run of bytes that lands, at a base the caller
...
constexpr int MixedEntityFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    ...
    (void) out; (void) src; (void) dst;
    {
        ...
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, entity_id );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, pos_x );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 8u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, pos_y );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 12u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, pos_z );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 16u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, yaw );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 20u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, pitch );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 24u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, vel_x );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 28u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, vel_y );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 32u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, vel_z );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 36u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, health );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 40u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, weapon );
        out[n++] = TableFixedEntry{ es, ed, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 41u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, damage );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 49u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, moving );
        out[n++] = TableFixedEntry{ es, ed, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 50u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedEntity, firing );
        out[n++] = TableFixedEntry{ es, ed, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// MixedStat's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int MixedStatFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedStat, stat_id );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedStat, delta );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// MixedHitEvent's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int MixedHitEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedHitEvent, target_id );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedHitEvent, damage );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 8u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedHitEvent, hit_kind );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 12u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedHitEvent, crit );
        out[n++] = TableFixedEntry{ es, ed, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// MixedChatEvent's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int MixedChatEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedChatEvent, channel );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedChatEvent, speaker );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// MixedPickupEvent's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int MixedPickupEventFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedPickupEvent, item_id );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( MixedPickupEvent, amount );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// BenchMixed's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int BenchMixedFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, sequence );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 4u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, ack_sequence );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 8u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, ack_bits );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 12u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, session_id );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 20u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, client_id );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 24u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, nonce );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 32u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, world_time );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 40u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, frame_tick );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 48u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, server_time );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    out[n++] = TableFixedEntry{ src + 52u, dst + (uint32_t) __builtin_offsetof( BenchMixed, entities_count ), 8u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0 }; // entities count
    for ( uint32_t i = 0; i < 8u; ++i )
    {
        const uint32_t es = src + 56u + i * 51u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, entities ) + i * (uint32_t) sizeof( MixedEntity );
        n += MixedEntityFixedLeaves( out + n, es, ed );
    }
    out[n++] = TableFixedEntry{ src + 464u, dst + (uint32_t) __builtin_offsetof( BenchMixed, stats_count ), 80u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0 }; // stats count
    static_assert( sizeof( MixedStat ) == 8, "BenchMixed.stats: a flat element's storage IS its wire image" );
    out[n++] = TableFixedEntry{ src + 468u, dst + (uint32_t) __builtin_offsetof( BenchMixed, stats ), 640u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 }; // stats, whole
    {
        const uint32_t es = src + 1108u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, game_event );
        out[n++] = TableFixedEntry{ es, ed + (uint32_t) __builtin_offsetof( MixedEvent, type ), 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 }; // the tag
        { // arm hit, ordinal 1 — guarded on the tag
            const int guard_at = n;
            n += MixedHitEventFixedLeaves( out + n, ( es + 1u ), ( ed + (uint32_t) __builtin_offsetof( MixedEvent, hit ) ) );
            for ( int q = guard_at; q < n; ++q ) { out[q].guard = es; out[q].arg = 1; }
        }
        { // arm chat, ordinal 2 — guarded on the tag
            const int guard_at = n;
            n += MixedChatEventFixedLeaves( out + n, ( es + 1u ), ( ed + (uint32_t) __builtin_offsetof( MixedEvent, chat ) ) );
            for ( int q = guard_at; q < n; ++q ) { out[q].guard = es; out[q].arg = 2; }
        }
        { // arm pickup, ordinal 3 — guarded on the tag
            const int guard_at = n;
            n += MixedPickupEventFixedLeaves( out + n, ( es + 1u ), ( ed + (uint32_t) __builtin_offsetof( MixedEvent, pickup ) ) );
            for ( int q = guard_at; q < n; ++q ) { out[q].guard = es; out[q].arg = 3; }
        }
    }
    static_assert( sizeof( uint8_t ) == 1, "BenchMixed.loadout: a flat element's storage IS its wire image" );
    out[n++] = TableFixedEntry{ src + 1122u, dst + (uint32_t) __builtin_offsetof( BenchMixed, loadout ), 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 }; // loadout, whole
    out[n++] = TableFixedEntry{ src + 1126u, dst + (uint32_t) __builtin_offsetof( BenchMixed, player_name_length ), 15u, dst + (uint32_t) __builtin_offsetof( BenchMixed, player_name ), kTableFixedNoGuard, kTableFixedText, 1, 0 }; // player_name
    out[n++] = TableFixedEntry{ src + 1145u, dst + (uint32_t) __builtin_offsetof( BenchMixed, payload_length ), 16u, dst + (uint32_t) __builtin_offsetof( BenchMixed, payload ), kTableFixedNoGuard, kTableFixedText, 3, 0 }; // payload
    {
        const uint32_t es = src + 1165u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, aim_x );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1169u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, aim_y );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1173u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, aim_z );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1177u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, recoil );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1181u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, drift );
        out[n++] = TableFixedEntry{ es, ed, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1189u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, wide_key );
        out[n++] = TableFixedEntry{ es, ed, 16u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1205u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, flux );
        out[n++] = TableFixedEntry{ es, ed, 16u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1221u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, ping );
        out[n++] = TableFixedEntry{ es, ed, 2u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1223u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, crc_hint );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1227u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, has_extra );
        out[n++] = TableFixedEntry{ es, ed, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1228u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, extra );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    {
        const uint32_t es = src + 1232u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( BenchMixed, idle_ticks );
        out[n++] = TableFixedEntry{ es, ed, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0 };
    }
    return n;
}
...
// FixedTable's LEAVES: one entry per run of bytes that lands, at a base the caller
// gives. TableFixedBuildPlan coalesces the adjacent ones, at compile time.
constexpr int FixedTableFixedLeaves( TableFixedEntry * out, uint32_t src, uint32_t dst )
{
    int n = 0;
    ...
    {
        const uint32_t es = src + 0u;
        const uint32_t ed = dst + (uint32_t) __builtin_offsetof( FixedTable, value );
...
inline constexpr int64_t FixedTableFixedBodyBytes = 1236;
inline constexpr int64_t FixedTableFixedRecordBytes = 8 + FixedTableFixedBodyBytes; // the hash and the body
inline constexpr uint64_t FixedTableFixedHash = 0x32f1c4a302a224ebull; // fnv1a64 over the layout's bytes
...
inline constexpr uint8_t FixedTableFixedLayout[] = {
...
inline constexpr int64_t FixedTableFixedLayoutBytes = (int64_t) sizeof( FixedTableFixedLayout );
...
inline constexpr TableFixedDst FixedTableFixedDst[] = {
...
// THE IDENTITY PLAN, coalesced at COMPILE TIME out of 148 leaves.
inline constexpr auto FixedTableFixedPlan = TableFixedBuildPlan<148>( FixedTableFixedLeaves );
...
inline constexpr int64_t FixedTableFixedMeasure( int64_t count )
{
...
inline int64_t FixedTableFixedSave( const FixedTable * values, int64_t count, uint8_t * buffer, int64_t capacity )
{
    ...
    for ( int64_t k = 0; k < count; ++k )
    {
        ...
        memset( at + 8, 0, (size_t) FixedTableFixedBodyBytes ); // the template's zeros
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    const TableFixedEntry * entries = FixedTableFixedPlan.entries;
    int32_t entry_count = FixedTableFixedPlan.count;
    ...
    if ( hash != FixedTableFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, FixedTableFixedLayout, (int32_t) FixedTableFixedLayoutBytes, FixedTableFixedDst, plan, plan_capacity, report );
