...
BENCH_TABLE_INLINE bool BenchMixedSaveBody( TableWriter & w, TableIds & ids, const BenchMixed & value )
{
    ...
    {
        w.putleb( ids.ref( 0x3c460475f9be69c6ull ) ); w.put8( 22 ); // server_time
    ...
    if ( value.wide_key != 0 )
    {
        w.putleb( ids.ref( 0xa3348580461faf16ull ) ); w.put8( 19 ); // wide_key
    ...
    if ( value.ping != 0 )
    {
        w.putleb( ids.ref( 0xbf30e00dc53307a9ull ) ); w.put8( 26 ); // ping
