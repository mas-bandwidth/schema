...
{
    return TableJsonRead( &value, FixedTableTableType(), text, bytes, report );
}

int64_t FixedTableToJsonMeasure( const FixedTable & value )
{
    return TableJsonWrite( &value, FixedTableTableType(), NULL, 0 );
}

int64_t FixedTableToJson( const FixedTable & value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( &value, FixedTableTableType(), buffer, capacity );
}
