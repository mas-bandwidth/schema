...
// package bench — THE UNIT REGISTRY (docs/SPEC-TABLES.md §8.3): one entry point
...
void BenchBitsReset( BenchBits & value );
const TableTypeInfo * BenchBitsTableType();
void BenchIntsReset( BenchInts & value );
const TableTypeInfo * BenchIntsTableType();
void BenchPacketReset( BenchPacket & value );
