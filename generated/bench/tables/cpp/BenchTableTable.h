...
inline void TableMixedFixedWriteBody( uint8_t * b, const TableMixed & value )
{
    ...
    memcpy( b + 1132, value.player_name, 15 );
    TableFixedPut32( b + 1147, (uint32_t) value.payload_length );
    memcpy( b + 1151, value.payload, 16 );
...
constexpr TableFixedEntry TableEntityFixedPlan[] = {
    { 0u, 0u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 41u, 48u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != TableEntityFixedHash )
    {
        ...
        const int32_t made = TableFixedCompile( parsed, TableEntityFixedLayout, (int32_t) TableEntityFixedLayoutBytes, TableEntityFixedDst, plan, plan_capacity, &compiled_guarded, report );
    ...
    {
        TableEntityReset( values[k] ); // the declared defaults, one prefill
...
constexpr TableFixedEntry TableStatFixedPlan[] = {
    { 0u, 0u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // stat_id
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != TableStatFixedHash )
    {
        ...
        if ( !TableFixedParseLayout( layout, layout_bytes, parsed, why ) ) { report->refused = true; report->reason = why; return -1; }
        int32_t compiled_guarded = 0;
        const int32_t made = TableFixedCompile( parsed, TableStatFixedLayout, (int32_t) TableStatFixedLayoutBytes, TableStatFixedDst, plan, plan_capacity, &compiled_guarded, report );
        if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_malformed : plan_too_large; return -1; }
        entries = plan;
        entry_count = made;
        entry_guarded = compiled_guarded;
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        TableStatReset( values[k] ); // the declared defaults, one prefill
        if ( TableFixedGet64( at ) != hash ) { report->refused = true; report->reason = no_layout; return -1; }
        TableFixedRun( entries, entry_count, entry_guarded, at + 8, (uint8_t *) &values[k], report );
        at += record_bytes;
    }
...
constexpr TableFixedDst TableMixedFixedDst[] = {
    ...
    { (uint32_t) __builtin_offsetof( TableMixed, payload_length ), 1, (uint32_t) __builtin_offsetof( TableMixed, payload ), 1, 3 }, // payload
    { 0, 0, 0, 0, 0 }, // u8
...
constexpr TableFixedEntry TableMixedFixedPlan[] = {
    { 0u, 0u, 2u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // protocol_magic
    { 2u, 4u, 24u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // sequence
    { 26u, 32u, 28u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // nonce
    { 54u, 576u, 8u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0 }, // entities count
    { 58u, 64u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 99u, 112u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 109u, 128u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 150u, 176u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 160u, 192u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 201u, 240u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 211u, 256u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 252u, 304u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 262u, 320u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 303u, 368u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 313u, 384u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 354u, 432u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 364u, 448u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 405u, 496u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 415u, 512u, 41u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // entity_id
    { 456u, 560u, 10u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // damage
    { 466u, 1220u, 80u, 0u, kTableFixedNoGuard, kTableFixedCount, 0, 0, 0 }, // stats count
    { 470u, 580u, 640u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // stats, whole
    { 1110u, 1224u, 1u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // game_event tag
    { 1124u, 1244u, 4u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // loadout, whole
    { 1128u, 1264u, 15u, 1248u, kTableFixedNoGuard, kTableFixedText, 1, 0, 0 }, // player_name
    { 1147u, 1284u, 16u, 1268u, kTableFixedNoGuard, kTableFixedText, 3, 0, 0 }, // payload
    { 1167u, 1288u, 49u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // aim_x
    { 1216u, 1340u, 8u, 0u, kTableFixedNoGuard, kTableFixedCopy, 0, 0, 0 }, // extra
    { 1111u, 1228u, 13u, 0u, 1110u, kTableFixedCopy, 1, 0, 0 }, // target_id
    { 1111u, 1228u, 8u, 0u, 1110u, kTableFixedCopy, 2, 0, 0 }, // channel
    { 1111u, 1228u, 8u, 0u, 1110u, kTableFixedCopy, 3, 0, 0 }, // item_id
};
                            ...
                            TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( hash != TableMixedFixedHash )
    {
        ...
        if ( !TableFixedParseLayout( layout, layout_bytes, parsed, why ) ) { report->refused = true; report->reason = why; return -1; }
        int32_t compiled_guarded = 0;
        const int32_t made = TableFixedCompile( parsed, TableMixedFixedLayout, (int32_t) TableMixedFixedLayoutBytes, TableMixedFixedDst, plan, plan_capacity, &compiled_guarded, report );
        if ( made < 0 ) { report->refused = true; report->reason = ( made == -2 ) ? layout_malformed : plan_too_large; return -1; }
        entries = plan;
        entry_count = made;
        entry_guarded = compiled_guarded;
    ...
    for ( int64_t k = 0; k < n; ++k )
    {
        TableMixedReset( values[k] ); // the declared defaults, one prefill
        if ( TableFixedGet64( at ) != hash ) { report->refused = true; report->reason = no_layout; return -1; }
        TableFixedRun( entries, entry_count, entry_guarded, at + 8, (uint8_t *) &values[k], report );
        at += record_bytes;
    }
