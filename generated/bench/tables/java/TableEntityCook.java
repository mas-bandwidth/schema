...
// TableEntity's cook: an array and an offset, and then the root where it lies. Opening
...
// functions — TableEntityOpen, TableEntityAt — and Java spells them as MEMBERS of this type,
...
public final class TableEntityCook {
    ...
    private TableEntityCook(byte[] data, int region, long regionLength) {
        this.data = data;
        this.region = region;
    ...
    public static final long rootSize = 64L;
    public static final long rootAlign = 8L;
    ...
    public static TableEntityCook open(byte[] data, int offset, long length) {
        ...
        return new TableEntityCook(data, offset + (int) dataOffset, dataLength);
    }

    /** the whole array as the file, which is how a consumer that read one spells
     *  it. */
    public static TableEntityCook open(byte[] data) { return open(data, 0, data == null ? 0 : data.length); }
    ...
    public static TableCookInfo type() { return TableEntityRow.cookInfo(); }
}
