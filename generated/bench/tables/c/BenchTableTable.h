...
static SCHEMA_UNUSED int TableEntitySaveBody( TableWriter * w, const TableEntity * value );
static SCHEMA_UNUSED int TableEntityLoadBody( TableReader * r, TableEntity * value );
static SCHEMA_UNUSED int64_t TableStatMeasure( const TableStat * value );
static SCHEMA_UNUSED int TableStatSaveBody( TableWriter * w, const TableStat * value );
static SCHEMA_UNUSED int TableStatLoadBody( TableReader * r, TableStat * value );
static SCHEMA_UNUSED int64_t TableMixedMeasure( const TableMixed * value );
static SCHEMA_UNUSED int TableMixedSaveBody( TableWriter * w, const TableMixed * value );
static SCHEMA_UNUSED int TableMixedLoadBody( TableReader * r, TableMixed * value );
static SCHEMA_UNUSED int64_t TableHitEventMeasure( const TableHitEvent * value );
static SCHEMA_UNUSED int TableHitEventSaveBody( TableWriter * w, const TableHitEvent * value );
static SCHEMA_UNUSED int TableHitEventLoadBody( TableReader * r, TableHitEvent * value );
static SCHEMA_UNUSED int64_t TableChatEventMeasure( const TableChatEvent * value );
static SCHEMA_UNUSED int TableChatEventSaveBody( TableWriter * w, const TableChatEvent * value );
static SCHEMA_UNUSED int TableChatEventLoadBody( TableReader * r, TableChatEvent * value );
static SCHEMA_UNUSED int64_t TablePickupEventMeasure( const TablePickupEvent * value );
static SCHEMA_UNUSED int TablePickupEventSaveBody( TableWriter * w, const TablePickupEvent * value );
static SCHEMA_UNUSED int TablePickupEventLoadBody( TableReader * r, TablePickupEvent * value );
