                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( identity )
    {
        ...
        for ( k = 0; k < count; ++k )
        {
            ...
            schema_benchtable_table_entity_fixed_clamp_( values + k, report ); /* the bounds the scatter does not hold (§3.4) */
            at += 8 + 51;
        }
        return count;
    }
                                 ...
                                 TableFixedEntry * plan, int32_t plan_capacity, TableReport * report )
{
    ...
    if ( identity )
    {
        ...
        for ( k = 0; k < count; ++k )
        {
            ...
            schema_benchtable_table_stat_fixed_clamp_( values + k, report ); /* the bounds the copy does not hold (§3.4) */
            at += 8 + 8;
        }
        return count;
    }
