...
{
    return TableJsonRead( value, &schema_benchtable_table_pickup_event_info_, text, bytes, report );
}

int64_t schema_benchtable_table_pickup_event_to_json_( const TablePickupEvent * value, char * buffer, int64_t capacity )
{
    return TableJsonWrite( value, &schema_benchtable_table_pickup_event_info_, buffer, capacity );
}
