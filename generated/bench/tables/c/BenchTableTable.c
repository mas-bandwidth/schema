...
static const TableFieldInfo schema_benchtable_table_entity_fields_[] = {
    { "entity_id", "entity_id", "bits(12)", 0x5a13, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, entity_id ), (uint32_t) sizeof( ( (TableEntity *) 0 )->entity_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "pos_x", "pos_x", "int32", 0xaaa3, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, pos_x ), (uint32_t) sizeof( ( (TableEntity *) 0 )->pos_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "pos_y", "pos_y", "int32", 0xa5cc, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, pos_y ), (uint32_t) sizeof( ( (TableEntity *) 0 )->pos_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "pos_z", "pos_z", "int32", 0xa985, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, pos_z ), (uint32_t) sizeof( ( (TableEntity *) 0 )->pos_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -16383.0, 16383.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "yaw", "yaw", "bits(9)", 0x80c1, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, yaw ), (uint32_t) sizeof( ( (TableEntity *) 0 )->yaw ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 511.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "pitch", "pitch", "bits(9)", 0xf783, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, pitch ), (uint32_t) sizeof( ( (TableEntity *) 0 )->pitch ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 511.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "vel_x", "vel_x", "int32", 0x03e2, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, vel_x ), (uint32_t) sizeof( ( (TableEntity *) 0 )->vel_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "vel_y", "vel_y", "int32", 0x0151, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, vel_y ), (uint32_t) sizeof( ( (TableEntity *) 0 )->vel_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "vel_z", "vel_z", "int32", 0x0e88, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, vel_z ), (uint32_t) sizeof( ( (TableEntity *) 0 )->vel_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -2048.0, 2047.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "health", "health", "int32", 0x8617, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, health ), (uint32_t) sizeof( ( (TableEntity *) 0 )->health ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1000.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "weapon", "weapon", "TableWeapon", 0x4f72, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, weapon ), (uint32_t) sizeof( ( (TableEntity *) 0 )->weapon ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 15, schema_benchtable_table_entity_weapon_variants_, 1, NULL, NULL, -1, NULL, "" },
    { "damage", "damage", "TableDamage", 0x15a9, 9, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, damage ), (uint32_t) sizeof( ( (TableEntity *) 0 )->damage ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 7, schema_benchtable_table_entity_damage_variants_, 0, NULL, NULL, -1, NULL, "" },
    { "moving", "moving", "bool", 0xa4b2, 1, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, moving ), (uint32_t) sizeof( ( (TableEntity *) 0 )->moving ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "firing", "firing", "bool", 0x2302, 1, 0, 0, 0, 0, (uint32_t) offsetof( TableEntity, firing ), (uint32_t) sizeof( ( (TableEntity *) 0 )->firing ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_benchtable_table_entity_info_ = { "TableEntity", (uint32_t) sizeof( TableEntity ), 14, schema_benchtable_table_entity_fields_, schema_benchtable_table_entity_reset_raw_ };

static const TableFieldInfo schema_benchtable_table_stat_fields_[] = {
    { "stat_id", "stat_id", "bits(8)", 0xfb6c, 6, 0, 0, 0, 0, (uint32_t) offsetof( TableStat, stat_id ), (uint32_t) sizeof( ( (TableStat *) 0 )->stat_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "delta", "delta", "int32", 0x1720, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableStat, delta ), (uint32_t) sizeof( ( (TableStat *) 0 )->delta ), 0xffffffffu, 0xffffffffu, NULL, 1, -512.0, 511.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_benchtable_table_stat_info_ = { "TableStat", (uint32_t) sizeof( TableStat ), 2, schema_benchtable_table_stat_fields_, schema_benchtable_table_stat_reset_raw_ };
...
static const TableFieldInfo schema_benchtable_table_mixed_fields_[] = {
    { "protocol_magic", "protocol_magic", "uint16", 0xae30, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, protocol_magic ), (uint32_t) sizeof( ( (TableMixed *) 0 )->protocol_magic ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "sequence", "sequence", "bits(16)", 0xd32b, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, sequence ), (uint32_t) sizeof( ( (TableMixed *) 0 )->sequence ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "ack_sequence", "ack_sequence", "int32", 0x3363, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, ack_sequence ), (uint32_t) sizeof( ( (TableMixed *) 0 )->ack_sequence ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "ack_bits", "ack_bits", "bits(32)", 0xebb9, 8, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, ack_bits ), (uint32_t) sizeof( ( (TableMixed *) 0 )->ack_bits ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4.294967295e+09, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "session_id", "session_id", "uint64", 0x8790, 9, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, session_id ), (uint32_t) sizeof( ( (TableMixed *) 0 )->session_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "client_id", "client_id", "uint32", 0xd443, 8, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, client_id ), (uint32_t) sizeof( ( (TableMixed *) 0 )->client_id ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "nonce", "nonce", "uint64", 0x80f0, 9, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, nonce ), (uint32_t) sizeof( ( (TableMixed *) 0 )->nonce ), 0xffffffffu, 0xffffffffu, NULL, 1, 1.0, 9.223372036854776e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "world_time", "world_time", "int64", 0x77f2, 5, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, world_time ), (uint32_t) sizeof( ( (TableMixed *) 0 )->world_time ), 0xffffffffu, 0xffffffffu, NULL, 1, -1e+12, 1e+12, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "frame_tick", "frame_tick", "bits(48)", 0xcbc2, 9, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, frame_tick ), (uint32_t) sizeof( ( (TableMixed *) 0 )->frame_tick ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 2.81474976710655e+14, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "server_time", "server_time", "float32", 0x27f9, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, server_time ), (uint32_t) sizeof( ( (TableMixed *) 0 )->server_time ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 65535.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "entities", "entities", "TableEntity", 0x25e3, 13, 1, 1, 0, 8, (uint32_t) offsetof( TableMixed, entities ), (uint32_t) sizeof( ( (TableMixed *) 0 )->entities[0] ), (uint32_t) offsetof( TableMixed, entities_count ), 0xffffffffu, &schema_benchtable_table_entity_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "stats", "stats", "TableStat", 0x76dd, 13, 1, 1, 0, 80, (uint32_t) offsetof( TableMixed, stats ), (uint32_t) sizeof( ( (TableMixed *) 0 )->stats[0] ), (uint32_t) offsetof( TableMixed, stats_count ), 0xffffffffu, &schema_benchtable_table_stat_info_, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "game_event", "game_event", "TableEvent", 0xa17e, 15, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, game_event ), (uint32_t) sizeof( ( (TableMixed *) 0 )->game_event ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, 3, schema_benchtable_table_mixed_game_event_variants_, 1, NULL, NULL, -1, &schema_benchtable_table_mixed_game_event_union_, "" },
    { "loadout", "loadout", "uint8", 0x9f78, 6, 1, 0, 0, 4, (uint32_t) offsetof( TableMixed, loadout ), (uint32_t) sizeof( ( (TableMixed *) 0 )->loadout[0] ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "player_name", "player_name", "string", 0x2d3e, 12, 0, 1, 0, 15, (uint32_t) offsetof( TableMixed, player_name ), (uint32_t) sizeof( ( (TableMixed *) 0 )->player_name ), (uint32_t) offsetof( TableMixed, player_name_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "payload", "payload", "bytes", 0x44aa, 6, 1, 1, 0, 16, (uint32_t) offsetof( TableMixed, payload ), (uint32_t) sizeof( ( (TableMixed *) 0 )->payload[0] ), (uint32_t) offsetof( TableMixed, payload_length ), 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "aim_x", "aim_x", "float32", 0x84e9, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, aim_x ), (uint32_t) sizeof( ( (TableMixed *) 0 )->aim_x ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "aim_y", "aim_y", "float32", 0x8d96, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, aim_y ), (uint32_t) sizeof( ( (TableMixed *) 0 )->aim_y ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "aim_z", "aim_z", "float32", 0x8e03, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, aim_z ), (uint32_t) sizeof( ( (TableMixed *) 0 )->aim_z ), 0xffffffffu, 0xffffffffu, NULL, 1, -1.0, 1.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "recoil", "recoil", "float32", 0x2d04, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, recoil ), (uint32_t) sizeof( ( (TableMixed *) 0 )->recoil ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "drift", "drift", "float64", 0xc023, 11, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, drift ), (uint32_t) sizeof( ( (TableMixed *) 0 )->drift ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "wide_key", "wide_key", "uint64", 0x272f, 9, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, wide_key ), (uint32_t) sizeof( ( (TableMixed *) 0 )->wide_key ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "flux", "flux", "int64", 0x196a, 5, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, flux ), (uint32_t) sizeof( ( (TableMixed *) 0 )->flux ), 0xffffffffu, 0xffffffffu, NULL, 1, -1e+18, 1e+18, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "ping", "ping", "float32", 0xe6d4, 10, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, ping ), (uint32_t) sizeof( ( (TableMixed *) 0 )->ping ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 250.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "crc_hint", "crc_hint", "bits(24)", 0xd3dc, 8, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, crc_hint ), (uint32_t) sizeof( ( (TableMixed *) 0 )->crc_hint ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1.6777215e+07, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "has_extra", "has_extra", "bool", 0xb023, 1, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, has_extra ), (uint32_t) sizeof( ( (TableMixed *) 0 )->has_extra ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "extra", "extra", "int32", 0xb579, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, extra ), (uint32_t) sizeof( ( (TableMixed *) 0 )->extra ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "has_extra" },
    { "idle_ticks", "idle_ticks", "int32", 0x9555, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableMixed, idle_ticks ), (uint32_t) sizeof( ( (TableMixed *) 0 )->idle_ticks ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 15.0, -1, NULL, 0, NULL, NULL, -1, NULL, "!has_extra" },
};

const TableTypeInfo schema_benchtable_table_mixed_info_ = { "TableMixed", (uint32_t) sizeof( TableMixed ), 28, schema_benchtable_table_mixed_fields_, schema_benchtable_table_mixed_reset_raw_ };

static const TableFieldInfo schema_benchtable_table_hit_event_fields_[] = {
    { "target_id", "target_id", "bits(12)", 0xdf6a, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableHitEvent, target_id ), (uint32_t) sizeof( ( (TableHitEvent *) 0 )->target_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "damage", "damage", "int32", 0x15a9, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableHitEvent, damage ), (uint32_t) sizeof( ( (TableHitEvent *) 0 )->damage ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "hit_kind", "hit_kind", "int32", 0xaf83, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableHitEvent, hit_kind ), (uint32_t) sizeof( ( (TableHitEvent *) 0 )->hit_kind ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 7.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "crit", "crit", "bool", 0x93d9, 1, 0, 0, 0, 0, (uint32_t) offsetof( TableHitEvent, crit ), (uint32_t) sizeof( ( (TableHitEvent *) 0 )->crit ), 0xffffffffu, 0xffffffffu, NULL, 0, 0.0, 0.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_benchtable_table_hit_event_info_ = { "TableHitEvent", (uint32_t) sizeof( TableHitEvent ), 4, schema_benchtable_table_hit_event_fields_, schema_benchtable_table_hit_event_reset_raw_ };

static const TableFieldInfo schema_benchtable_table_chat_event_fields_[] = {
    { "channel", "channel", "int32", 0x7366, 4, 0, 0, 0, 0, (uint32_t) offsetof( TableChatEvent, channel ), (uint32_t) sizeof( ( (TableChatEvent *) 0 )->channel ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 3.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "speaker", "speaker", "bits(12)", 0xce0b, 7, 0, 0, 0, 0, (uint32_t) offsetof( TableChatEvent, speaker ), (uint32_t) sizeof( ( (TableChatEvent *) 0 )->speaker ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 4095.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_benchtable_table_chat_event_info_ = { "TableChatEvent", (uint32_t) sizeof( TableChatEvent ), 2, schema_benchtable_table_chat_event_fields_, schema_benchtable_table_chat_event_reset_raw_ };

static const TableFieldInfo schema_benchtable_table_pickup_event_fields_[] = {
    { "item_id", "item_id", "bits(10)", 0xec67, 7, 0, 0, 0, 0, (uint32_t) offsetof( TablePickupEvent, item_id ), (uint32_t) sizeof( ( (TablePickupEvent *) 0 )->item_id ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 1023.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
    { "amount", "amount", "int32", 0x39cc, 4, 0, 0, 0, 0, (uint32_t) offsetof( TablePickupEvent, amount ), (uint32_t) sizeof( ( (TablePickupEvent *) 0 )->amount ), 0xffffffffu, 0xffffffffu, NULL, 1, 0.0, 255.0, -1, NULL, 0, NULL, NULL, -1, NULL, "" },
};

const TableTypeInfo schema_benchtable_table_pickup_event_info_ = { "TablePickupEvent", (uint32_t) sizeof( TablePickupEvent ), 2, schema_benchtable_table_pickup_event_fields_, schema_benchtable_table_pickup_event_reset_raw_ };
