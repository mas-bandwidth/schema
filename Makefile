...
test: build/schema_test build/schema_test_guard build/schema_test_tables build/schema_test_block build/schema_test_block_asan build/schema_test_block_fuzz build/schema_test_block_fuzz_asan build/pack-text/.stamp build/schema_test_hostile build/schema_test_hostile_asan build/hostile-values/.stamp build/schema_test_pack build/schema_test_pack_asan build/tables-pack.bin build/tables-pack-root.bin build/schema_test_tables_asan build/tables-generated-cs/.stamp build/schema_test_random build/schema_test_ludicrous build/schema_test_c build/schema_test_c_ludicrous build/schema_test_bench build/schema_test_bench_c build/schema_test_bench_table build/conformance-harness build/conformance-c build/conformance-c-asan build/schema_test_c_fuzz build/schema_test_c_soak build/schema_test_c_variable build/schema_test_c_variable_asan generated/bench/tables/cs/.stamp generated/bench/tables/dart/.stamp generated/bench/tables/go/.stamp generated/bench/tables/elixir/.stamp generated/go/.stamp generated/rust/.stamp generated/cs/.stamp generated/js/.stamp generated/dart/.stamp generated/java/.stamp generated/elixir/.stamp generated/go-ludicrous/.stamp generated/rust-ludicrous/.stamp generated/cs-ludicrous/.stamp generated/js-ludicrous/.stamp generated/dart-ludicrous/.stamp generated/java-ludicrous/.stamp generated/elixir-ludicrous/.stamp generated/bench/go/.stamp generated/bench/rust/.stamp generated/bench/cs/.stamp generated/bench/js/.stamp generated/bench/dart/.stamp generated/bench/java/.stamp generated/bench/elixir/.stamp build/java-test/.stamp build/java-test-ludicrous/.stamp build/java-bench/.stamp generated/bench/tables/js/.stamp
	./build/schema_test
	...
	# because `make test` has no budget for them (see that target).
	...
	# THE DART PORT's own instruments (docs/SPEC-TABLES.md): the emitted sources
	# held to what `dart format` writes and what the analyzer accepts, the
	# allocation gate at a tenth of its release length and its two planted
	# controls, the name-claim control, the page's own example run verbatim,
	# the forgery fuzzer, a few seconds of the soak and the byte its control
	# corrupts, and the harness's own Dart control. The long soak and the
	# full-length allocation gate are `make tables-dart-release`.
...
# which one it is.
bench-tables: generated/bench/tables/cpp/.stamp generated/bench/tables/cs/.stamp generated/bench/tables/c/.stamp generated/bench/tables/dart/.stamp generated/bench/tables/go/.stamp generated/bench/tables/rust/.stamp generated/bench/tables/java/.stamp generated/bench/tables/elixir/.stamp bench-table-check generated/bench/tables/js/.stamp
	bench/tables/run.sh
...
conformance: build/conformance-harness build/conformance-cpp build/conformance-c build/schema_test_cook \
		build-conformance-cs build-cs-cook build/conformance-dart build/conformance-go build/conformance-rust \
		build-conformance-java build-conformance-elixir build/tables-generated-js/.stamp
...
.PHONY: conformance conformance-generate conformance-pin conformance-negative-control conformance-negative-control-block-dump conformance-negative-control-cs conformance-negative-control-go conformance-negative-control-go-walk build-conformance-cs tables-dart-clean tables-dart-soak tables-dart-soak-negative-control tables-dart-fuzz tables-dart-fuzz-negative-control tables-dart-alloc tables-dart-alloc-negative-control tables-dart-names-negative-control tables-dart-usage tables-dart-json-walk tables-dart-standalone tables-dart-standalone-negative-control tables-dart-release conformance-negative-control-dart
