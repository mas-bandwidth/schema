...
Java, JavaScript, Dart and Elixir generate fixed-class tables in the form that
...
and build version check are current. The rows above mark that honestly, and
#514 to #518 carry each of those columns forward.
