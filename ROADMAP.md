...
Java, Dart and Elixir generate fixed-class tables in the form that preceded the
id-table wire; their cook and block readers, descriptors and build version check
are current. Rust's and JavaScript's table wire and descriptors have been pruned
in preparation for the fresh id-table ports (#518, #516); their cook and block
readers and build version check are current. The rows above mark that honestly,
and #514 to #518 carry each of those columns forward.
