...
Elixir still generates fixed-class tables in the form that preceded the
...
Java emit no table wire or descriptors today, only their block and cook
readers and build-version checks. #514 to #518 carry those columns forward to
