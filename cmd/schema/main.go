...
func main() {
	...
	case "generate":
		...
		lang := fs.String("lang", "cpp", "target language (c, cpp, cs, dart, go, java, js, rust)")
...
func usage() {
  ...
  schema generate   [--lang c|cpp|cs|dart|go|java|js|rust] [--out generated] [--verbose] [dir|files...]
  schema id         [dir|files...]
