...
# this stamp did not.
build/tables-generated-go-fixed/.stamp: bin/schema test/tables/FU1.schema test/tables/FU2.schema make/go.mk
	@mkdir -p build/tables-generated-go-fixed
	./bin/schema generate --lang go --out build/tables-generated-go-fixed/fu1 test/tables/FU1.schema
	./bin/schema generate --lang go --out build/tables-generated-go-fixed/fu2 test/tables/FU2.schema
	$(call go_fixed_module,fu1,tblfu1)
	$(call go_fixed_module,fu2,tblfu2)
	@touch $@

define go_fixed_module
@printf 'module %s\n\ngo 1.23\n\nrequire github.com/mas-bandwidth/serialize.go v0.0.0\n\nreplace github.com/mas-bandwidth/serialize.go => ../../../$(SERIALIZE_GO)\n' $(2) > build/tables-generated-go-fixed/$(1)/go.mod
endef

.PHONY: tables-go-fixedform
tables-go-fixedform: build/tables-generated-go-fixed/.stamp
	@set -e; for d in build/tables-generated-go-fixed/fu1 build/tables-generated-go-fixed/fu2; do \
...
# held on this leg by TestFixedFormPlanPath in tables-go-fixedform. FU1/FU2,
# the TEXT-UNDER-AN-ARM pair, is generated by tables-go-fixedform and pinned
# by TestFixedFormFU1FU2.
