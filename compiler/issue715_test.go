...
`
	...
	t.Run("emitted_text", func(t *testing.T) {
		...
		// Rust, Dart, JavaScript and Java emit no text form: their previous-form table wire
		// was removed; only the block and cook readers remain (#518, #514, #516, #517).
		for _, lang := range []string{"cpp", "c", "go", "cs", "elixir"} {
