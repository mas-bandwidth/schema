...
(:schema 1 :root "schema/fixed-tables-goal" :inventory-status
 ...
 ((:id "schema/fixed-tables-goal" :type :work-set :children ("fixed-tables" "shared" "integration"))
  ...
  (:id "cpp/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
  ...
  (:id "cpp/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "cpp/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "c/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "owed" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "c/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "owed" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "c/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3" :reported-state
  ...
  (:id "cs/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "cs/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "owed" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "cs/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3" :reported-state
  ...
  (:id "go/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "weak" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "go/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "weak" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "go/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3" :reported-state
   "weak" :reported-source "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "rust/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "rust/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "rust/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648020292" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "java/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "weak" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "java/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "java/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5650042470" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "js/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "weak" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "js/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "weak" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "js/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3" :reported-state
   "weak" :reported-source "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "dart/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "dart/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "dart/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  ...
  (:id "elixir/F1" :type :task :title "previous_form" :state :unknown :evidence nil :audit-item "F1"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "elixir/F2" :type :task :title "message_form_as_file" :state :unknown :evidence nil :audit-item "F2"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
  (:id "elixir/F3" :type :task :title "newer_form" :state :unknown :evidence nil :audit-item "F3"
   :reported-state "implemented-asserted" :reported-source
   "https://github.com/mas-bandwidth/schema/issues/898#issuecomment-5648012854" :note
   "Historical report at b7ab66a8; current completion has not been reconciled.")
