...
**Backend status.** C++ carries wide text on both wires. C, Rust and Go also carry the
packet storage, groups and read refusals below; the other five ports refuse
