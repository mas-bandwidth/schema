...
| `Objects.schema` | every `object` | **the worked Ship** — one definition driving ShipState / Deep / Shallow / Interpolate + Quantize, view markers `[interpolated]`/`[local]` (deep is the default) |
