...
After this sitting, the lint follow-up rewrote the C++ emitter's three-way
comment-selection conditional as a `switch`. The mixed/all-void/empty fixture
regenerated byte-identically and the compiler/C++ emitter tests passed. The
measured revision and hashes below remain the actual benchmark inputs; the
post-lint `cpp.go` hash is
`b533a0f6ca6a102d1280f7691ee1a1ed4631ea444b7d80f3de84fae4a30ffc7a`.
